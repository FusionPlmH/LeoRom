...
.method static synthetic access$500(Lcom/android/systemui/usb/StorageNotification;Landroid/os/storage/VolumeInfo;)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$600(Lcom/android/systemui/usb/StorageNotification;)Landroid/content/SharedPreferences;
    .locals 1
...
.method static synthetic access$700(Lcom/android/systemui/usb/StorageNotification;Landroid/os/storage/VolumeInfo;)Landroid/app/Notification;
    .locals 1
...
.method static synthetic access$800(Lcom/android/systemui/usb/StorageNotification;)Ljava/util/Map;
    .locals 1
...
.method static synthetic access$900(Lcom/android/systemui/usb/StorageNotification;Z)V
    .locals 0
...
.method private onPublicVolumeStateChangedInternal(Landroid/os/storage/VolumeInfo;)V
    ...
    invoke-direct {v0, v6}, Lcom/android/systemui/usb/StorageNotification;->showSDcardErrorNoti(Z)V
    ...
    const-string v10, "cancelAsUser_1: tag="
    ...
    invoke-virtual {v6, v4, v7, v9}, Landroid/app/NotificationManager;->cancelAsUser(Ljava/lang/String;ILandroid/os/UserHandle;)V
    ...
    const-string v10, "current SD Card UUID is ["

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v9, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v10, "] to cancelAsUser"
    ...
    const-string v11, "notifyAsUser_1: tag="
    ...
    iget-object v9, v0, Lcom/android/systemui/usb/StorageNotification;->activeVolumeMap:Ljava/util/Map;
    ...
    invoke-direct {v0, v12}, Lcom/android/systemui/usb/StorageNotification;->getTagForVolumeInfo(Landroid/os/storage/VolumeInfo;)Ljava/lang/String;

    move-result-object v14

    const-string v15, "StorageNotification"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "notifyAsUser_2: memoVolId="
    ...
    iget-object v6, v0, Lcom/android/systemui/usb/StorageNotification;->activeVolumeMap:Ljava/util/Map;
    ...
    invoke-virtual {v6, v14, v15, v7}, Landroid/app/NotificationManager;->cancelAsUser(Ljava/lang/String;ILandroid/os/UserHandle;)V
    ...
    invoke-static {v7, v11, v6, v11, v10}, Landroid/app/PendingIntent;->getBroadcastAsUser(Landroid/content/Context;ILandroid/content/Intent;ILandroid/os/UserHandle;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v7, v4, v11, v5, v10}, Landroid/app/NotificationManager;->notifyAsUser(Ljava/lang/String;ILandroid/app/Notification;Landroid/os/UserHandle;)V
    ...
    const-string v7, "Set STORAGE_NOTIFICATION_SD_CARD_UUID as NONE"
    ...
    invoke-virtual {v6, v4, v8, v7}, Landroid/app/NotificationManager;->cancelAsUser(Ljava/lang/String;ILandroid/os/UserHandle;)V
