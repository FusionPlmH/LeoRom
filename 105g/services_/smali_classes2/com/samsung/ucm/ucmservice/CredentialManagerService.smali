...
.field private static final UCM_VERSION:Ljava/lang/String; = "1.1"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    const-string/jumbo v0, "security.ucm_ese_applet_installed"
...
.method static synthetic access$1600(Lcom/samsung/ucm/ucmservice/CredentialManagerService;Ljava/lang/String;Lcom/samsung/ucm/ucmservice/UcmAgentWrapper;)Lcom/samsung/android/knox/ucm/core/ucmRetParcelable;
    .locals 1
...
.method static synthetic access$1700(Lcom/samsung/ucm/ucmservice/CredentialManagerService;Ljava/lang/String;[BLcom/samsung/ucm/ucmservice/UcmAgentWrapper;)Lcom/samsung/android/knox/ucm/core/ucmRetParcelable;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method static synthetic access$1800(Lcom/samsung/ucm/ucmservice/CredentialManagerService;I[B)Lcom/samsung/android/knox/ucm/core/ucmRetParcelable;
    .locals 1
...
.method static synthetic access$1900(Lcom/samsung/ucm/ucmservice/CredentialManagerService;)Lcom/samsung/ucm/ucmservice/UcmAgentWrapper;
    .locals 1
...
.method private enforceLockType(ILjava/lang/String;)V
    ...
    invoke-virtual {v0, p1, v1, p1}, Lcom/android/server/enterprise/security/PasswordPolicy;->setPwdChangeRequestedForUser(III)Z
    ...
    const-string v5, "com.android.settings.password.ConfirmUCMLockPassword"
    ...
    const-string v4, "lockscreen.ucscredentialstoragename"
    ...
    invoke-virtual {v4, v3, v2}, Landroid/content/Context;->startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private generateDek(Ljava/lang/String;Lcom/samsung/ucm/ucmservice/UcmAgentWrapper;)Lcom/samsung/android/knox/ucm/core/ucmRetParcelable;
    ...
    const-string v2, "ERROR: Null Response received from agent"
...
.method private getDek(Ljava/lang/String;Lcom/samsung/ucm/ucmservice/UcmAgentWrapper;)Lcom/samsung/android/knox/ucm/core/ucmRetParcelable;
    ...
    const-string/jumbo v3, "no agent found for Source = com.samsung.ucs.agent.boot:com.samsung.ucs.agent.boot"
...
.method private getKeyguardStorageOwnerForCurrentUser(I)Ljava/lang/String;
    ...
    const-string/jumbo v3, "system/users/"
    ...
    :try_start_0
    iget-object v5, p0, Lcom/samsung/ucm/ucmservice/CredentialManagerService;->mPersistentKeyguardInfoFile:Landroid/util/AtomicFile;
...
.method private saveDataToFile([BLjava/lang/String;Ljava/lang/String;)Z
    .locals 7
    ...
    const-string v6, "failed to delete the existing dek file"
...
.method private saveTempOdeKey(Lcom/samsung/ucm/ucmservice/UcmAgentWrapper;Ljava/lang/String;)I
    ...
    invoke-interface {v2, p2}, Lcom/samsung/ucm/ucmservice/CredentialManagerService$UcmVendorSpecific;->getDeks(Ljava/lang/String;)Lcom/samsung/ucm/ucmservice/CredentialManagerService$_DekData;

    move-result-object v2

    iget v3, v2, Lcom/samsung/ucm/ucmservice/CredentialManagerService$_DekData;->errorCode:I
    ...
    :cond_0
    iget-object v4, v2, Lcom/samsung/ucm/ucmservice/CredentialManagerService$_DekData;->wrappedDek:[B

    iget-object v5, v2, Lcom/samsung/ucm/ucmservice/CredentialManagerService$_DekData;->dek:[B
    ...
    :cond_1
    invoke-virtual {v0, v5}, Lcom/sec/esecomm/EsecommAdapter;->saveODEKey([B)[B
    ...
    const-string/jumbo v8, "security.ucm_ese_applet_installed"
    ...
    :cond_2
    invoke-virtual {v0, v4}, Lcom/sec/esecomm/EsecommAdapter;->saveODEKey([B)[B
    ...
    const-string/jumbo v9, "security.ucm_ese_applet_installed"
    ...
    :cond_3
    const-string v9, "/efs/sec_efs/tz_esecomm"

    const-string/jumbo v10, "ucm_ode_key"

    invoke-direct {p0, v7, v9, v10}, Lcom/samsung/ucm/ucmservice/CredentialManagerService;->saveDataToFile([BLjava/lang/String;Ljava/lang/String;)Z
    ...
    const-string/jumbo v10, "ucm_ode_key2"

    invoke-direct {p0, v8, v9, v10}, Lcom/samsung/ucm/ucmservice/CredentialManagerService;->saveDataToFile([BLjava/lang/String;Ljava/lang/String;)Z
...
.method private unwrapDek(Ljava/lang/String;[BLcom/samsung/ucm/ucmservice/UcmAgentWrapper;)Lcom/samsung/android/knox/ucm/core/ucmRetParcelable;
    ...
    const-string/jumbo v4, "unwrapDek Response from plugin:  error code = "
...
.method public configureODESettings(Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;)I
    ...
    :try_start_2
    invoke-direct {v1, v12, v2}, Lcom/samsung/ucm/ucmservice/CredentialManagerService;->saveTempOdeKey(Lcom/samsung/ucm/ucmservice/UcmAgentWrapper;Ljava/lang/String;)I
    ...
    :try_start_4
    const-string v9, "failed saveTempOdeKey. ["
...
.method public getDekForVoldInternalKey(Ljava/lang/String;[B)Lcom/samsung/android/knox/ucm/core/ucmRetParcelable;
    ...
    const-string v1, "getDekForVoldInternalKey. key is empty"
...
.method public getODEConfigurationForVold(Ljava/lang/String;)Lcom/samsung/android/knox/ucm/core/ucmRetParcelable;
    ...
    iget v2, v0, Lcom/samsung/ucm/ucmservice/EFSProperties$ODEProperties;->enabledWrap:I
    ...
    invoke-static {v8, v7, v3, v4, v9}, Ljava/lang/System;->arraycopy([BI[BII)V
    ...
    :cond_2
    invoke-direct {p0, v7, v3}, Lcom/samsung/ucm/ucmservice/CredentialManagerService;->getResponseParcel(I[B)Lcom/samsung/android/knox/ucm/core/ucmRetParcelable;
