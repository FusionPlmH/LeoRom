...
.method addWindow(Lcom/android/server/wm/WindowState;)V
    ...
    invoke-interface {v1}, Lcom/android/server/policy/WindowManagerPolicy;->isInDexOnPc()Z

    move-result v1

    if-eqz v1, :cond_2

    invoke-virtual {p0}, Lcom/android/server/wm/AppWindowToken;->isDexMode()Z
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/wm/WindowManagerService;->isSecureLocked(Lcom/android/server/wm/WindowState;)Z
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/wm/MultiDisplayManagerInternal;->notifySecureWindowAddedLocked(Lcom/android/server/wm/WindowState;)V
...
.method layoutLetterbox(Lcom/android/server/wm/WindowState;)V
    ...
    iget-object v6, p0, Lcom/android/server/wm/AppWindowToken;->mTmpBounds:Landroid/graphics/Rect;

    iget-object v7, v0, Lcom/android/server/wm/WindowState;->mContainingFrame:Landroid/graphics/Rect;

    invoke-virtual {v5, v6, v7}, Lcom/android/server/wm/Letterbox;->layout(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v5}, Lcom/android/server/wm/Letterbox;->hide()V
    ...
    iget-object v7, p0, Lcom/android/server/wm/AppWindowToken;->mDisplayContent:Lcom/android/server/wm/DisplayContent;

    iget-object v7, v7, Lcom/android/server/wm/DisplayContent;->mBaseDisplayCutout:Landroid/view/DisplayCutout;
    ...
    iget-object v8, v8, Lcom/android/server/wm/DisplayContent;->mLetterboxTspInsets:Landroid/graphics/Rect;

    iget-object v9, p0, Lcom/android/server/wm/AppWindowToken;->mLetterbox:Lcom/android/server/wm/Letterbox;
    ...
    invoke-virtual {v2}, Lcom/android/server/wm/Letterbox;->getInsets()Landroid/graphics/Rect;
    ...
    invoke-virtual {v9}, Lcom/android/server/wm/Letterbox;->getInsets()Landroid/graphics/Rect;
    ...
    invoke-virtual {v3}, Lcom/android/server/wm/Letterbox;->getInsets()Landroid/graphics/Rect;
