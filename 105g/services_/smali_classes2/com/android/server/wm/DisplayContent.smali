...
.method constructor <init>(Landroid/view/Display;Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/WallpaperController;Lcom/android/server/wm/DisplayWindowController;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/wm/DisplayContent;->mForcedDisplaySizeRequested:Z
    ...
    iput-boolean v0, p0, Lcom/android/server/wm/DisplayContent;->mSwitchingDisplay:Z
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;Z)V
    ...
    const-string/jumbo v5, "mLastStatusBarVisibility=0x"
    ...
    :cond_a
    iget-boolean v4, p0, Lcom/android/server/wm/DisplayContent;->mForcedDisplaySizeRequested:Z
    ...
    const-string v5, "mForcedDisplaySizeRequested=true"
    ...
    :cond_b
    iget-boolean v4, p0, Lcom/android/server/wm/DisplayContent;->mUseBlackScreenshot:Z
    ...
    const-string/jumbo v5, "mUseBlackScreenshot="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v5, p0, Lcom/android/server/wm/DisplayContent;->mUseBlackScreenshot:Z
...
.method prepareSurfaces()V
    ...
    iget-boolean v1, v0, Lcom/android/server/wm/ScreenRotationAnimation;->mNonScreenShot:Z

    if-eqz v1, :cond_1

    iget-object v2, p0, Lcom/android/server/wm/DisplayContent;->mPendingTransaction:Landroid/view/SurfaceControl$Transaction;
...
.method setForcedDisplaySizeRequested(Z)V
    .locals 3

    iget-boolean v0, p0, Lcom/android/server/wm/DisplayContent;->mForcedDisplaySizeRequested:Z

    if-eq v0, p1, :cond_0

    iput-boolean p1, p0, Lcom/android/server/wm/DisplayContent;->mForcedDisplaySizeRequested:Z
    ...
    const-string/jumbo v2, "setForcedDisplaySizeRequested: "
...
.method updateRotationUnchecked(Z)Z
    ...
    const-string v13, ", mayRotateSeamlessly="

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v12, v5}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v13, ", forceRotateSeamlessly="
