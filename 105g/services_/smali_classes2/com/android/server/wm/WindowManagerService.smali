...
.method public addWindow(Lcom/android/server/wm/Session;Landroid/view/IWindow;ILandroid/view/WindowManager$LayoutParams;IILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/DisplayCutout$ParcelableWrapper;Landroid/view/InputChannel;Landroid/os/Bundle;)I
    ...
    :try_start_2
    invoke-virtual {v13, v5}, Lcom/android/server/wm/WindowManagerService;->getDisplayContentOrCreate(I)Lcom/android/server/wm/DisplayContent;
    ...
    invoke-virtual {v2, v3, v5}, Landroid/hardware/display/DisplayManagerInternal;->isUidPresentOnDisplay(II)Z
    ...
    invoke-virtual {v13, v3, v2, v5}, Lcom/android/server/wm/WindowManagerService;->windowForClientLocked(Lcom/android/server/wm/Session;Landroid/os/IBinder;Z)Lcom/android/server/wm/WindowState;
    ...
    iget-object v5, v15, Landroid/view/WindowManager$LayoutParams;->token:Landroid/os/IBinder;
    ...
    const-string v5, "Attempted to add QS dialog window with unknown token "
    ...
    const-string v5, "Attempted to add a toast window with unknown token "
...
.method public clearForcedDisplaySize(I)V
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/wm/DisplayContent;->setForcedDisplaySizeRequested(Z)V
...
.method public displayReady()V
    ...
    invoke-virtual {v3, v2}, Lcom/android/server/wm/SamsungWindowManagerService;->updateForcedDisplaySizeRequestedStateLocked(Lcom/android/server/wm/DisplayContent;)V
...
.method public getSideScreenInternal()Lcom/android/server/wm/SideScreenManagerInternal;
    .locals 1
...
.method public hadHandledStartTransition()Z
    ...
    invoke-interface {v1}, Lcom/android/server/policy/WindowManagerPolicy;->hadHandledStartTransition()Z
...
.method public setForcedDisplayDensityForUser(III)V
    ...
    invoke-virtual {v3, p2}, Lcom/android/server/wm/SamsungWindowManagerService;->notifyWmForcedDisplayDensityChanged(I)V
    ...
    iget-object v4, p0, Lcom/android/server/wm/WindowManagerService;->mSamsungWindowManager:Lcom/android/server/wm/SamsungWindowManagerService;

    invoke-virtual {v4, p2}, Lcom/android/server/wm/SamsungWindowManagerService;->notifyWmForcedDisplayDensityChanged(I)V
...
.method public setForcedDisplaySize(III)V
    ...
    invoke-virtual {v6, v7}, Lcom/android/server/wm/DisplayContent;->setForcedDisplaySizeRequested(Z)V
    ...
    invoke-virtual {v2, p2, p3}, Lcom/android/server/wm/SamsungWindowManagerService;->notifyWmForcedDisplaySizeChanged(II)V
    ...
    invoke-virtual {v3, p2, p3}, Lcom/android/server/wm/SamsungWindowManagerService;->notifyWmForcedDisplaySizeChanged(II)V
...
.method startFreezingDisplayLocked(IILcom/android/server/wm/DisplayContent;)V
    ...
    iget-boolean v2, v10, Lcom/android/server/wm/DisplayContent;->mUseBlackScreenshot:Z
    ...
    iput-boolean v2, v10, Lcom/android/server/wm/DisplayContent;->mUseBlackScreenshot:Z

    iget-object v3, v7, Lcom/android/server/wm/WindowManagerService;->mAnimator:Lcom/android/server/wm/WindowAnimator;

    iget v4, v7, Lcom/android/server/wm/WindowManagerService;->mFrozenDisplayId:I
    ...
    iget-boolean v4, v3, Lcom/android/server/wm/ScreenRotationAnimation;->mNonScreenShot:Z

    if-nez v4, :cond_0

    const/4 v1, 0x1

    iput-boolean v2, v7, Lcom/android/server/wm/WindowManagerService;->mDisplayFrozen:Z
    ...
    iget-boolean v0, v7, Lcom/android/server/wm/WindowManagerService;->mDisplayFrozen:Z
    ...
    iget-boolean v0, v7, Lcom/android/server/wm/WindowManagerService;->mRotatingSeamlessly:Z
    ...
    :cond_2
    invoke-virtual/range {p3 .. p3}, Lcom/android/server/wm/DisplayContent;->getDisplay()Landroid/view/Display;
    ...
    iget-object v0, v7, Lcom/android/server/wm/WindowManagerService;->mScreenFrozenLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-wide v2, v7, Lcom/android/server/wm/WindowManagerService;->mDisplayFreezeTime:J

    const/4 v0, 0x0

    iput-object v0, v7, Lcom/android/server/wm/WindowManagerService;->mLastFinishedFreezeSource:Ljava/lang/Object;

    invoke-virtual/range {p3 .. p3}, Lcom/android/server/wm/DisplayContent;->getDisplayId()I

    move-result v2

    iput v2, v7, Lcom/android/server/wm/WindowManagerService;->mFrozenDisplayId:I

    iget-object v2, v7, Lcom/android/server/wm/WindowManagerService;->mInputMonitor:Lcom/android/server/wm/InputMonitor;

    invoke-virtual {v2}, Lcom/android/server/wm/InputMonitor;->freezeInputDispatchingLw()V

    iget-object v2, v7, Lcom/android/server/wm/WindowManagerService;->mPolicy:Lcom/android/server/policy/WindowManagerPolicy;

    invoke-interface {v2, v0, v0}, Lcom/android/server/policy/WindowManagerPolicy;->setLastInputMethodWindowLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/policy/WindowManagerPolicy$WindowState;)V
    ...
    iput-object v0, v7, Lcom/android/server/wm/WindowManagerService;->mDisplayFrozenReasonForDebug:Ljava/lang/String;

    iget-object v0, v7, Lcom/android/server/wm/WindowManagerService;->mLatencyTracker:Lcom/android/internal/util/LatencyTracker;
    ...
    iget-object v0, v7, Lcom/android/server/wm/WindowManagerService;->mMultiDisplayInternal:Lcom/android/server/wm/MultiDisplayManagerInternal;
    ...
    :cond_6
    iput v8, v7, Lcom/android/server/wm/WindowManagerService;->mExitAnimId:I

    iput v9, v7, Lcom/android/server/wm/WindowManagerService;->mEnterAnimId:I

    iget-object v0, v7, Lcom/android/server/wm/WindowManagerService;->mAnimator:Lcom/android/server/wm/WindowAnimator;

    iget v1, v7, Lcom/android/server/wm/WindowManagerService;->mFrozenDisplayId:I
    ...
    :cond_7
    invoke-virtual/range {p3 .. p3}, Lcom/android/server/wm/DisplayContent;->hasSecureWindowOnScreen()Z

    move-result v16

    invoke-virtual/range {p3 .. p3}, Lcom/android/server/wm/DisplayContent;->updateDisplayInfo()V

    new-instance v17, Lcom/android/server/wm/ScreenRotationAnimation;

    iget-object v1, v7, Lcom/android/server/wm/WindowManagerService;->mContext:Landroid/content/Context;

    iget-object v0, v7, Lcom/android/server/wm/WindowManagerService;->mPolicy:Lcom/android/server/policy/WindowManagerPolicy;

    invoke-interface {v0}, Lcom/android/server/policy/WindowManagerPolicy;->isDefaultOrientationForced()Z
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/wm/ScreenRotationAnimation;-><init>(Landroid/content/Context;Lcom/android/server/wm/DisplayContent;ZZLcom/android/server/wm/WindowManagerService;Z)V

    iget-object v1, v7, Lcom/android/server/wm/WindowManagerService;->mAnimator:Lcom/android/server/wm/WindowAnimator;

    iget v2, v7, Lcom/android/server/wm/WindowManagerService;->mFrozenDisplayId:I
    ...
    const-string/jumbo v3, "startFreezingDisplayLocked: Failed to make blackScreenshot, okToAnimate="
    ...
    const-string/jumbo v4, "startFreezingDisplayLocked is returned, mRotationSeamlessly="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v4, v7, Lcom/android/server/wm/WindowManagerService;->mRotatingSeamlessly:Z
    ...
    const-string/jumbo v1, "startFreezingDisplayLocked: Failed to make blackScreenshot, Seamlessly"
