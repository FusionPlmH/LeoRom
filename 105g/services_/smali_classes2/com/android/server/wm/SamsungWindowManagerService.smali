...
.field private static final MIN_SMALLEST_SCREEN_WIDTH_DP:I = 0x140
...
.method private checkValidForcedDisplaySizeLocked(Lcom/android/server/wm/DisplayContent;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/SamsungWindowManagerService;->getForcedDisplaySizeLocked()Landroid/graphics/Point;
    ...
    const-string v12, "checkValidForcedDisplaySizeLocked:forced="
    ...
    const-string v11, "display_size_forced"

    const-string v12, ""

    invoke-static {v10, v11, v12}, Landroid/provider/Settings$Global;->putString(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;)Z
...
.method private getForcedDisplayDensityLocked()I
    .locals 3
...
.method private getForcedDisplaySizeLocked()Landroid/graphics/Point;
    .locals 5
...
.method private isValidDisplaySizeAndDensity(III)Z
    .locals 7
    ...
    const-string/jumbo v5, "wrong parameter app="
    ...
    invoke-virtual {v2, v5}, Landroid/app/ActivityManager;->getPackageFromAppProcesses(I)Ljava/lang/String;
...
.method private updateForcedDisplaySizeDensityLocked(Lcom/android/server/wm/DisplayContent;IIIZ)V
    .locals 4
    ...
    iput p4, p1, Lcom/android/server/wm/DisplayContent;->mRequestedBaseDisplayDensity:I

    invoke-virtual {p1, p2, p3, p4, p5}, Lcom/android/server/wm/DisplayContent;->updateBaseDisplayMetrics(IIIZ)V
...
.method public clearForcedDisplaySizeDensity(I)V
    ...
    iget-object v0, v7, Lcom/android/server/wm/SamsungWindowManagerService;->mContext:Landroid/content/Context;
    ...
    :try_start_0
    iget-object v0, v7, Lcom/android/server/wm/SamsungWindowManagerService;->mService:Lcom/android/server/wm/WindowManagerService;
    ...
    invoke-virtual {v0, v11}, Lcom/android/server/wm/DisplayContent;->setForcedDisplaySizeRequested(Z)V
    ...
    const-string v6, "clearForcedDisplaySizeDensity :: initial , w="
    ...
    iget-object v4, v12, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->sizeStr:Ljava/lang/String;

    move-object v13, v4

    iget-object v4, v12, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->densityStr:Ljava/lang/String;

    move-object v14, v4

    iget-boolean v4, v12, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->hasSize:Z

    if-eqz v4, :cond_0

    iget v4, v12, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->width:I

    move v1, v4

    iget v4, v12, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->height:I
    ...
    iget-boolean v1, v12, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->hasDensity:Z

    if-eqz v1, :cond_1

    iget v1, v12, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->density:I
    ...
    :goto_0
    invoke-direct/range {p0 .. p0}, Lcom/android/server/wm/SamsungWindowManagerService;->clearForcedHideNotch()Z
    ...
    iput-boolean v4, v0, Lcom/android/server/wm/DisplayContent;->mUseBlackScreenshot:Z
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/server/wm/SamsungWindowManagerService;->updateForcedDisplaySizeDensityLocked(Lcom/android/server/wm/DisplayContent;IIIZ)V

    invoke-direct {v7, v11, v13, v11, v14}, Lcom/android/server/wm/SamsungWindowManagerService;->updateDisplaySettings(ZLjava/lang/String;ZLjava/lang/String;)V

    invoke-direct {v7, v0}, Lcom/android/server/wm/SamsungWindowManagerService;->updateTouchableArea(Lcom/android/server/wm/DisplayContent;)V
...
.method public notifyEmergencyModeEnabled(Z)V
    .locals 1

    iget-object v0, p0, Lcom/android/server/wm/SamsungWindowManagerService;->mAspectRatioController:Lcom/android/server/wm/AspectRatioController;

    invoke-virtual {v0, p1}, Lcom/android/server/wm/AspectRatioController;->onEmergencyModeEnabled(Z)V
...
.method notifyWmForcedDisplayDensityChanged(I)V
    .locals 2
...
.method notifyWmForcedDisplaySizeChanged(II)V
    .locals 2
...
.method public readForcedDisplayPropertiesLocked(Lcom/android/server/wm/DisplayContent;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/SamsungWindowManagerService;->getForcedDisplayDensityLocked()I
...
.method public restoreSizeDensityIfNeededLocked(Lcom/android/server/wm/DisplayContent;)V
    ...
    const-string/jumbo v4, "restoreSizeDensityIfNeededLocked forcedDisplaySize=["
    ...
    const-string/jumbo v4, "restoreSizeDensityIfNeeded: forcedDisplayDensity=["
    ...
    const-string v9, "density is null, currentRatio = "
...
.method public setDisplaySizeDensity()V
    ...
    const-string/jumbo v2, "setDisplaySizeDensity, Cannot found defualt displayContent!"
    ...
    iget v4, v0, Lcom/android/server/wm/DisplayContent;->mBaseDisplayDensity:I
    ...
    invoke-static {v5, v6, v4, v7}, Landroid/provider/Settings$Secure;->putStringForUser(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;I)Z

    sget-boolean v5, Lcom/samsung/android/rune/CoreRune;->FW_HIGH_PERFORMANCE_MODE:Z

    if-eqz v5, :cond_3

    const-string v5, "SamsungWindowManager"

    const-string/jumbo v6, "setDisplaySizeDensity, set vzw requirement"
    ...
    iget v8, v0, Lcom/android/server/wm/DisplayContent;->mBaseDisplayDensity:I
    ...
    invoke-static {v5, v6, v3, v7}, Landroid/provider/Settings$Secure;->putStringForUser(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;I)Z
...
.method public setForcedDisplaySizeDensity(IIIIZZI)V
    ...
    iget-object v4, v7, Lcom/android/server/wm/SamsungWindowManagerService;->mService:Lcom/android/server/wm/WindowManagerService;
    ...
    iget-object v5, v7, Lcom/android/server/wm/SamsungWindowManagerService;->mService:Lcom/android/server/wm/WindowManagerService;
    ...
    const-string/jumbo v12, "setForcedDisplaySizeDensity: d"

    invoke-virtual {v6, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v6, v8}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v12, " is not attached"
    ...
    iget v6, v5, Lcom/android/server/wm/DisplayContent;->mBaseDisplayHeight:I
    ...
    iget v13, v5, Lcom/android/server/wm/DisplayContent;->mBaseDisplayDensity:I
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    const-string/jumbo v5, "setForcedDisplaySizeDensity d"
    ...
    const-string v5, " forcedDisplaySizeRequested="
    ...
    const-string v5, " forcedHideNotch="

    invoke-virtual {v0, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v10}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v5, " keepDisplaySize="
    ...
    invoke-direct {v7, v1, v2, v13}, Lcom/android/server/wm/SamsungWindowManagerService;->isValidDisplaySizeAndDensity(III)Z
    ...
    const-string v4, "input illegalArgument(wrong size="
    ...
    iput-object v0, v7, Lcom/android/server/wm/SamsungWindowManagerService;->mLastChangedDisplaySize:Ljava/lang/String;

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v3, v7, Lcom/android/server/wm/SamsungWindowManagerService;->mLastChangedDisplaySize:Ljava/lang/String;
    ...
    iget-object v12, v0, Lcom/android/server/wm/WindowManagerService;->mWindowMap:Lcom/android/server/wm/WindowHashMap;
    ...
    invoke-virtual {v0, v8}, Lcom/android/server/wm/RootWindowContainer;->getDisplayContent(I)Lcom/android/server/wm/DisplayContent;
    ...
    const-string/jumbo v3, "setForcedDisplaySizeDensity d"

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, v8}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v3, " size is adjusted to w="
    ...
    :try_start_c
    invoke-virtual {v0, v1}, Lcom/android/server/wm/DisplayContent;->setForcedDisplaySizeRequested(Z)V
    ...
    iput-boolean v1, v0, Lcom/android/server/wm/DisplayContent;->mUseBlackScreenshot:Z
    :try_end_c
    ...
    :try_start_d
    invoke-direct {v7, v10, v11, v5, v14}, Lcom/android/server/wm/SamsungWindowManagerService;->setForcedHideNotch(IIIZ)Z
    ...
    :try_start_e
    iget-object v2, v7, Lcom/android/server/wm/SamsungWindowManagerService;->mPendingHideDisplayCutout:Lcom/android/server/wm/SamsungWindowManagerService$PendingHideDisplayCutout;
    :try_end_e
    ...
    invoke-direct {v7, v3, v1, v3, v2}, Lcom/android/server/wm/SamsungWindowManagerService;->updateDisplaySettings(ZLjava/lang/String;ZLjava/lang/String;)V
    ...
    iget-boolean v2, v1, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->hasDensity:Z

    if-eqz v2, :cond_13

    iget v2, v1, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->density:I
    ...
    invoke-direct {v7, v6, v3, v5, v4}, Lcom/android/server/wm/SamsungWindowManagerService;->updateDisplaySettings(ZLjava/lang/String;ZLjava/lang/String;)V
    ...
    const-string v4, "input illegalArgument(displayId="
...
.method updateForcedDisplaySizeForInitialDisplayChanged(Lcom/android/server/wm/DisplayContent;II)Z
    ...
    iput v11, v1, Lcom/android/server/wm/DisplayContent;->mBaseDisplayHeight:I
...
.method updateForcedDisplaySizeRequestedStateLocked(Lcom/android/server/wm/DisplayContent;)V
    .locals 4
    ...
    iget-boolean v2, v1, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->hasSize:Z
    ...
    :cond_0
    iget v2, v1, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->width:I

    iget v3, v1, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->height:I
    ...
    invoke-virtual {p1, v2}, Lcom/android/server/wm/DisplayContent;->setForcedDisplaySizeRequested(Z)V
...
.method public updateLetterboxTspStatePolicy(I)V
    ...
    iget-object v2, v1, Lcom/android/server/wm/DisplayContent;->mBaseDisplayCutout:Landroid/view/DisplayCutout;
