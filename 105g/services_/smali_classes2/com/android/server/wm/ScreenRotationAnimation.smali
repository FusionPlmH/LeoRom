...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/DisplayContent;ZZLcom/android/server/wm/WindowManagerService;Z)V
    .locals 29
    ...
    iget v12, v2, Lcom/android/server/wm/DisplayContent;->mPrevDisplayWidth:I

    if-eqz v12, :cond_2

    iget v12, v2, Lcom/android/server/wm/DisplayContent;->mPrevDisplayHeight:I
    ...
    :cond_1
    iget-object v12, v1, Lcom/android/server/wm/ScreenRotationAnimation;->mDisplayContent:Lcom/android/server/wm/DisplayContent;

    invoke-virtual {v12}, Lcom/android/server/wm/DisplayContent;->getRotation()I
    ...
    iget v10, v2, Lcom/android/server/wm/DisplayContent;->mPrevDisplayWidth:I
    ...
    :cond_4
    sget-boolean v12, Lcom/samsung/android/rune/CoreRune;->FW_DYNAMIC_RESOLUTION_CONTROL:Z
    ...
    :cond_6
    :goto_0
    sget-boolean v12, Lcom/samsung/android/rune/CoreRune;->MD_DEX_EMULATOR:Z

    if-eqz v12, :cond_7

    iget-object v12, v1, Lcom/android/server/wm/ScreenRotationAnimation;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-object v12, v12, Lcom/android/server/wm/WindowManagerService;->mDisplayManagerInternal:Landroid/hardware/display/DisplayManagerInternal;

    invoke-virtual {v12}, Landroid/hardware/display/DisplayManagerInternal;->isDesktopSwitched()Z
    ...
    :goto_2
    iput v12, v1, Lcom/android/server/wm/ScreenRotationAnimation;->mOriginalRotation:I
    ...
    const-string v13, "BlackScreenshotSurface"
    ...
    invoke-virtual {v0, v13, v13}, Landroid/view/SurfaceControl$Builder;->setSize(II)Landroid/view/SurfaceControl$Builder;

    move-result-object v0

    invoke-virtual {v0, v8}, Landroid/view/SurfaceControl$Builder;->setColorLayer(Z)Landroid/view/SurfaceControl$Builder;
    ...
    invoke-virtual {v7, v0, v14}, Landroid/view/SurfaceControl$Transaction;->setLayer(Landroid/view/SurfaceControl;I)Landroid/view/SurfaceControl$Transaction;

    iget-object v0, v1, Lcom/android/server/wm/ScreenRotationAnimation;->mSurfaceControl:Landroid/view/SurfaceControl;

    const/4 v13, 0x0

    invoke-virtual {v7, v0, v13}, Landroid/view/SurfaceControl$Transaction;->setAlpha(Landroid/view/SurfaceControl;F)Landroid/view/SurfaceControl$Transaction;
    ...
    iput-boolean v8, v1, Lcom/android/server/wm/ScreenRotationAnimation;->mNonScreenShot:Z
    :try_end_0
    ...
    invoke-virtual {v14, v0, v8}, Landroid/view/SurfaceControl$Transaction;->setOverrideScalingMode(Landroid/view/SurfaceControl;I)Landroid/view/SurfaceControl$Transaction;

    invoke-virtual {v14, v8}, Landroid/view/SurfaceControl$Transaction;->apply(Z)V
    ...
    invoke-virtual {v3, v0}, Landroid/hardware/display/DisplayManagerInternal;->getDisplayToken(I)Landroid/os/IBinder;
    ...
    invoke-static/range {v17 .. v24}, Landroid/view/SurfaceControl;->screenshotToBufferWithSecureLayersUnsafe(Landroid/os/IBinder;Landroid/graphics/Rect;IIIIZI)Landroid/graphics/GraphicBuffer;

    move-result-object v0
    :try_end_5
    .catch Landroid/view/Surface$OutOfResourcesException; {:try_start_5 .. :try_end_5} :catch_4
    ...
    const-string v9, "Failed to attach screenshot - "
    ...
    :try_end_8
    .catch Landroid/view/Surface$OutOfResourcesException; {:try_start_8 .. :try_end_8} :catch_5
    ...
    :cond_12
    invoke-direct {v1, v7, v12}, Lcom/android/server/wm/ScreenRotationAnimation;->setRotation(Landroid/view/SurfaceControl$Transaction;I)V
...
.method private startAnimation(Landroid/view/SurfaceControl$Transaction;JFIIZII)Z
    ...
    :cond_1
    iget-boolean v0, v1, Lcom/android/server/wm/ScreenRotationAnimation;->mNonScreenShot:Z

    if-eqz v0, :cond_2

    const-string v0, "WindowManager"

    const-string/jumbo v10, "skip startAnimation while use blackScreenshot"
