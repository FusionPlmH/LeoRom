...
.method notifyDropLocked(FFI)V
    ...
    iget-object v2, v1, Lcom/android/server/wm/DragState;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-object v2, v2, Lcom/android/server/wm/WindowManagerService;->mPolicy:Lcom/android/server/policy/WindowManagerPolicy;

    invoke-interface {v2}, Lcom/android/server/policy/WindowManagerPolicy;->isInDexOnPc()Z
    ...
    iget v3, v1, Lcom/android/server/wm/DragState;->mUid:I

    invoke-virtual {v13}, Lcom/android/server/wm/WindowState;->getOwningPackage()Ljava/lang/String;

    move-result-object v20

    iget v4, v1, Lcom/android/server/wm/DragState;->mFlags:I

    and-int/lit16 v4, v4, 0xc3

    iget v5, v1, Lcom/android/server/wm/DragState;->mSourceUserId:I
    ...
    invoke-direct/range {v17 .. v23}, Lcom/android/server/wm/DragAndDropPermissionsHandler;-><init>(Landroid/content/ClipData;ILjava/lang/String;III)V
    ...
    const-string v6, "can\'t send drop notification to win "
