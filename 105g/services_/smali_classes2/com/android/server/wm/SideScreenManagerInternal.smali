...
# static fields
.field private static final AUTO_NOTCH_ALIGNMENT_SIZE:I = 0x32
...
# instance fields
.field private mBottomNotchSideAlignedBounds:Landroid/graphics/Rect;
...
.field private mGestureDetectorWindow:Lcom/android/server/wm/WindowState;
...
.field private mMinimalSizeResizableTask:I
...
.field private mShouldRecovery:Z
...
.field private mTopNotchSideAlignedBounds:Landroid/graphics/Rect;
...
.method public constructor <init>(Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput-object v0, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mGestureDetectorWindow:Lcom/android/server/wm/WindowState;
    ...
    iput-object v1, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mTmpInsets:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mPrimaryMenuTouchRegion:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mSecondaryMenuTouchRegion:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Matrix;

    invoke-direct {v1}, Landroid/graphics/Matrix;-><init>()V

    iput-object v1, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mTmpMatrix:Landroid/graphics/Matrix;

    new-instance v1, Landroid/graphics/RectF;

    invoke-direct {v1}, Landroid/graphics/RectF;-><init>()V

    iput-object v1, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mTmpRectF:Landroid/graphics/RectF;

    iput-boolean v0, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mShouldRecovery:Z

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mTopNotchSideAlignedBounds:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mBottomNotchSideAlignedBounds:Landroid/graphics/Rect;
...
.method private calculateNotchSideAlignedBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    .locals 12
    ...
    iget-object v7, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mTmpRect2:Landroid/graphics/Rect;
    ...
    iget v4, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mMinimalSizeResizableTask:I
...
.method public static synthetic lambda$notifyDockedStackMinimizedChanged$6(Lcom/android/server/wm/SideScreenManagerInternal;Z)V
    .locals 1
...
.method public static synthetic lambda$scheduleHideSideScreen$4(Lcom/android/server/wm/SideScreenManagerInternal;)V
    .locals 1
...
.method public static synthetic lambda$scheduleShowSideScreen$3(Lcom/android/server/wm/SideScreenManagerInternal;)V
    .locals 1
    ...
    invoke-interface {v0}, Lcom/samsung/android/multiwindow/IMultiWindowManager;->showSideScreen()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static synthetic lambda$setAdjustedForIme$7(Lcom/android/server/wm/SideScreenManagerInternal;I)V
    .locals 2
...
.method public static synthetic lambda$setMinimizedDockedStack$5(Lcom/android/server/wm/SideScreenManagerInternal;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    .locals 1
...
.method private loadDimension()V
    ...
    iput v1, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mMinimalSizeResizableTask:I
...
.method private notifyDockedStackMinimizedChanged(Z)V
    ...
    new-instance v1, Lcom/android/server/wm/-$$Lambda$SideScreenManagerInternal$3Q_MfQJjVHLzYyue1_VDiL-erU4;

    invoke-direct {v1, p0, p1}, Lcom/android/server/wm/-$$Lambda$SideScreenManagerInternal$3Q_MfQJjVHLzYyue1_VDiL-erU4;-><init>(Lcom/android/server/wm/SideScreenManagerInternal;Z)V
...
.method private setMinimizedDockedStack(ZZ)V
    ...
    new-instance v4, Lcom/android/server/wm/-$$Lambda$SideScreenManagerInternal$e9K4J-X-sHSL7Xlz_OTaBEDYh_U;

    invoke-direct {v4, p0, v2, v3}, Lcom/android/server/wm/-$$Lambda$SideScreenManagerInternal$e9K4J-X-sHSL7Xlz_OTaBEDYh_U;-><init>(Lcom/android/server/wm/SideScreenManagerInternal;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method getGestureDetectorWindow()Lcom/android/server/wm/WindowState;
    .locals 1

    iget-object v0, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mGestureDetectorWindow:Lcom/android/server/wm/WindowState;
...
.method public getNotchSideAlignedBounds(Landroid/graphics/Rect;)I
    .locals 2

    invoke-virtual {p0, p1}, Lcom/android/server/wm/SideScreenManagerInternal;->needNotchSideAlignedBounds(Landroid/graphics/Rect;)Z
    ...
    iget-object v1, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mTopNotchSideAlignedBounds:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->bottom:I

    if-gt v0, v1, :cond_0

    iget-object v0, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mTopNotchSideAlignedBounds:Landroid/graphics/Rect;
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mBottomNotchSideAlignedBounds:Landroid/graphics/Rect;
...
.method public needNotchSideAlignedBounds(Landroid/graphics/Rect;)Z
    .locals 2
...
.method onConfigurationChanged(ILandroid/content/res/Configuration;)V
    ...
    iget-object v3, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mService:Lcom/android/server/wm/WindowManagerService;
    ...
    :cond_0
    iget-object v4, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mLastConfig:Landroid/content/res/Configuration;

    invoke-virtual {v4, v2}, Landroid/content/res/Configuration;->updateFrom(Landroid/content/res/Configuration;)I
    ...
    iget v6, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mRotation:I
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/wm/SideScreenManagerInternal;->loadDimension()V

    invoke-direct/range {p0 .. p0}, Lcom/android/server/wm/SideScreenManagerInternal;->setSnapAlgorithm()V

    iget-object v10, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mSideScreenInnerRect:Landroid/graphics/Rect;

    invoke-virtual {v0, v7}, Lcom/android/server/wm/SideScreenManagerInternal;->getSideScreenBounds(Z)Landroid/graphics/Rect;

    move-result-object v7

    invoke-virtual {v10, v7}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iget-object v7, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mSideScreenOuterRect:Landroid/graphics/Rect;

    invoke-virtual {v0, v8}, Lcom/android/server/wm/SideScreenManagerInternal;->getSideScreenBounds(Z)Landroid/graphics/Rect;
    ...
    iget v12, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mScreenWidth:I

    if-ne v12, v10, :cond_6

    iget v12, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mScreenHeight:I
    ...
    iget v14, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mScreenWidth:I
    ...
    :goto_5
    iget v14, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mScreenHeight:I
    ...
    :goto_6
    iget v14, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mRotation:I
    ...
    :cond_9
    iget-object v7, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mSideScreenBounds:Landroid/graphics/Rect;

    iget-object v14, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mSideScreenBounds:Landroid/graphics/Rect;

    iget v14, v14, Landroid/graphics/Rect;->left:I

    int-to-float v14, v14

    iget-object v8, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mSideScreenBounds:Landroid/graphics/Rect;
    ...
    :goto_8
    iput v10, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mScreenWidth:I

    iput v11, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mScreenHeight:I
    ...
    iput v7, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mOrientation:I

    invoke-virtual/range {p0 .. p0}, Lcom/android/server/wm/SideScreenManagerInternal;->isSideScreenVisible()Z
    ...
    invoke-virtual {v0, v7}, Lcom/android/server/wm/SideScreenManagerInternal;->switchDockSide(Z)V

    goto :goto_9

    :cond_c
    invoke-direct/range {p0 .. p0}, Lcom/android/server/wm/SideScreenManagerInternal;->resetDockSide()V

    :cond_d
    :goto_9
    if-eqz v6, :cond_f

    iget v7, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mRotation:I

    iget-object v8, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mSideScreenBounds:Landroid/graphics/Rect;

    invoke-virtual {v3, v7, v5, v8}, Lcom/android/server/wm/DisplayContent;->rotateBounds(IILandroid/graphics/Rect;)V

    iget-object v7, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mTmpRect:Landroid/graphics/Rect;

    invoke-virtual {v3, v7}, Lcom/android/server/wm/DisplayContent;->getBounds(Landroid/graphics/Rect;)V

    iget v7, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mDockSide:I

    if-nez v7, :cond_e

    iget-object v7, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mTmpRect:Landroid/graphics/Rect;

    iget-object v8, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mTmpRect:Landroid/graphics/Rect;

    iget v8, v8, Landroid/graphics/Rect;->right:I

    iget-object v12, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mSideScreenBounds:Landroid/graphics/Rect;
    ...
    iput v5, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mRotation:I

    :cond_f
    invoke-direct/range {p0 .. p0}, Lcom/android/server/wm/SideScreenManagerInternal;->updateCurrentBoundsAndSnapTarget()V

    iget-object v7, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mTopNotchSideAlignedBounds:Landroid/graphics/Rect;

    iget-object v8, v0, Lcom/android/server/wm/SideScreenManagerInternal;->mBottomNotchSideAlignedBounds:Landroid/graphics/Rect;

    invoke-direct {v0, v7, v8}, Lcom/android/server/wm/SideScreenManagerInternal;->calculateNotchSideAlignedBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;)V

    :cond_10
    return-void
.end method

.method public onSideScreenStackRemoved()V
    .locals 1
...
.method reevaluateMenuVisibility(IZ)V
    ...
    invoke-virtual {v0, p2}, Lcom/android/server/wm/SideScreenManagerInternal$SideScreenMenuState;->reevaluateVisibility(Z)Z
...
.method public rotateNotchSideAlignedBounds(ILandroid/graphics/Rect;)V
    .locals 1
    ...
    :pswitch_0
    invoke-direct {p0, v0, p2}, Lcom/android/server/wm/SideScreenManagerInternal;->calculateNotchSideAlignedBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;)V

    goto :goto_0

    :pswitch_1
    invoke-direct {p0, p2, v0}, Lcom/android/server/wm/SideScreenManagerInternal;->calculateNotchSideAlignedBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method scheduleHideSideScreen()V
    ...
    new-instance v1, Lcom/android/server/wm/-$$Lambda$SideScreenManagerInternal$TQf-8y-YcNcDFg-729z5R96V1iU;

    invoke-direct {v1, p0}, Lcom/android/server/wm/-$$Lambda$SideScreenManagerInternal$TQf-8y-YcNcDFg-729z5R96V1iU;-><init>(Lcom/android/server/wm/SideScreenManagerInternal;)V
...
.method scheduleShowSideScreen()V
    .locals 2

    iget-boolean v0, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mSideScreenVisible:Z

    if-nez v0, :cond_0

    iget-boolean v0, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mShouldRecovery:Z
    ...
    new-instance v1, Lcom/android/server/wm/-$$Lambda$SideScreenManagerInternal$Q9nn8_5COUaskvG_YN2ThDbj7ak;

    invoke-direct {v1, p0}, Lcom/android/server/wm/-$$Lambda$SideScreenManagerInternal$Q9nn8_5COUaskvG_YN2ThDbj7ak;-><init>(Lcom/android/server/wm/SideScreenManagerInternal;)V
...
.method setAdjustedForIme(IZI)V
    ...
    new-instance v5, Lcom/android/server/wm/-$$Lambda$SideScreenManagerInternal$7vZK9KfA9jz3IRndz-ruLaWt1L0;

    invoke-direct {v5, p0, v0}, Lcom/android/server/wm/-$$Lambda$SideScreenManagerInternal$7vZK9KfA9jz3IRndz-ruLaWt1L0;-><init>(Lcom/android/server/wm/SideScreenManagerInternal;I)V
...
.method setGestureDetectorWindow(Lcom/android/server/wm/WindowState;)V
    .locals 0

    iput-object p1, p0, Lcom/android/server/wm/SideScreenManagerInternal;->mGestureDetectorWindow:Lcom/android/server/wm/WindowState;
...
.method setMenuWindow(ILcom/android/server/wm/WindowState;)V
    ...
    invoke-virtual {v1, v0}, Lcom/android/server/wm/SideScreenManagerInternal$SideScreenMenuState;->reevaluateVisibility(Z)Z
