...
.field private mLastNavBarCanMove:Z
...
.method public constructor <init>(Lcom/android/server/policy/ImmersiveModeConfirmation;Landroid/content/Context;Ljava/lang/Runnable;)V
    ...
    invoke-static {p1}, Lcom/android/server/policy/ImmersiveModeConfirmation;->access$900(Lcom/android/server/policy/ImmersiveModeConfirmation;)Lcom/android/server/policy/PhoneWindowManager;

    move-result-object v0

    iget-boolean v0, v0, Lcom/android/server/policy/PhoneWindowManager;->mNavigationBarCanMove:Z

    if-eqz v0, :cond_0

    invoke-static {p1}, Lcom/android/server/policy/ImmersiveModeConfirmation;->access$1000(Lcom/android/server/policy/ImmersiveModeConfirmation;)Landroid/view/WindowManager;
    ...
    iget-boolean p1, p1, Lcom/android/server/policy/PhoneWindowManager;->mNavigationBarCanMove:Z

    iput-boolean p1, p0, Lcom/android/server/policy/ImmersiveModeConfirmation$ClingWindowView;->mLastNavBarCanMove:Z

    return-void
.end method

.method static synthetic access$1100(Lcom/android/server/policy/ImmersiveModeConfirmation$ClingWindowView;)Landroid/view/animation/Interpolator;
    .locals 1
...
.method static synthetic access$1200(Lcom/android/server/policy/ImmersiveModeConfirmation$ClingWindowView;)Landroid/animation/ValueAnimator;
    .locals 1
...
.method static synthetic access$1202(Lcom/android/server/policy/ImmersiveModeConfirmation$ClingWindowView;Landroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    .locals 0
...
.method static synthetic access$1300(Lcom/android/server/policy/ImmersiveModeConfirmation$ClingWindowView;)Landroid/graphics/drawable/ColorDrawable;
    .locals 1
...
.method public static synthetic lambda$onConfigurationChanged$5(Lcom/android/server/policy/ImmersiveModeConfirmation$ClingWindowView;)V
    .locals 0
...
.method private updateLayout()V
    ...
    invoke-static {v1}, Lcom/android/server/policy/ImmersiveModeConfirmation;->access$900(Lcom/android/server/policy/ImmersiveModeConfirmation;)Lcom/android/server/policy/PhoneWindowManager;

    move-result-object v1

    iget-boolean v1, v1, Lcom/android/server/policy/PhoneWindowManager;->mNavigationBarCanMove:Z
    ...
    invoke-static {v3}, Lcom/android/server/policy/ImmersiveModeConfirmation;->access$900(Lcom/android/server/policy/ImmersiveModeConfirmation;)Lcom/android/server/policy/PhoneWindowManager;

    move-result-object v3

    iget-boolean v3, v3, Lcom/android/server/policy/PhoneWindowManager;->mNavigationBarCanMove:Z
...
.method public onAttachedToWindow()V
    ...
    invoke-static {v1}, Lcom/android/server/policy/ImmersiveModeConfirmation;->access$1000(Lcom/android/server/policy/ImmersiveModeConfirmation;)Landroid/view/WindowManager;
    ...
    invoke-static {v2}, Lcom/android/server/policy/ImmersiveModeConfirmation;->access$900(Lcom/android/server/policy/ImmersiveModeConfirmation;)Lcom/android/server/policy/PhoneWindowManager;

    move-result-object v2

    iget-boolean v2, v2, Lcom/android/server/policy/PhoneWindowManager;->mNavigationBarCanMove:Z

    if-eqz v2, :cond_0

    const/4 v2, 0x1

    iput-boolean v2, p0, Lcom/android/server/policy/ImmersiveModeConfirmation$ClingWindowView;->mRotationWatcherRegistered:Z
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/ImmersiveModeConfirmation$ClingWindowView;->mLastNavBarCanMove:Z
    ...
    invoke-static {v0}, Lcom/android/server/policy/ImmersiveModeConfirmation;->access$900(Lcom/android/server/policy/ImmersiveModeConfirmation;)Lcom/android/server/policy/PhoneWindowManager;

    move-result-object v0

    iget-boolean v0, v0, Lcom/android/server/policy/PhoneWindowManager;->mNavigationBarCanMove:Z

    iput-boolean v0, p0, Lcom/android/server/policy/ImmersiveModeConfirmation$ClingWindowView;->mLastNavBarCanMove:Z

    iget-object v0, p0, Lcom/android/server/policy/ImmersiveModeConfirmation$ClingWindowView;->mClingHandler:Landroid/os/Handler;

    new-instance v1, Lcom/android/server/policy/-$$Lambda$ImmersiveModeConfirmation$ClingWindowView$HDXCyYFnMnkApsiilxAij3S5Q1s;

    invoke-direct {v1, p0}, Lcom/android/server/policy/-$$Lambda$ImmersiveModeConfirmation$ClingWindowView$HDXCyYFnMnkApsiilxAij3S5Q1s;-><init>(Lcom/android/server/policy/ImmersiveModeConfirmation$ClingWindowView;)V
...
.method public onDetachedFromWindow()V
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/ImmersiveModeConfirmation$ClingWindowView;->mRotationWatcherRegistered:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/server/policy/ImmersiveModeConfirmation$ClingWindowView;->mRotationWatcherRegistered:Z
