...
.field private static final MSG_NOTIFICATION_LISTENER_CONNECTED:I = 0x2bc

.field private static final MSG_NOTIFICATION_LISTENER_DISCONNECTED:I = 0x2bd

.field private static final MSG_NOTIFICATION_POSTED:I = 0x2be

.field private static final MSG_NOTIFICATION_REMOVED:I = 0x2bf
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/NSLocationMonitor$ServiceCallback;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/NSLocationMonitor;->mRegisteredNotificationListener:Z
    ...
    new-instance v0, Lcom/android/server/NSLocationMonitor$3;

    invoke-direct {v0, p0}, Lcom/android/server/NSLocationMonitor$3;-><init>(Lcom/android/server/NSLocationMonitor;)V

    iput-object v0, p0, Lcom/android/server/NSLocationMonitor;->mNotificationListener:Landroid/service/notification/NotificationListenerService;
...
.method static synthetic access$1000(Lcom/android/server/NSLocationMonitor;)Ljava/util/HashSet;
    .locals 1
...
.method static synthetic access$1100(Lcom/android/server/NSLocationMonitor;)Ljava/util/HashSet;
    .locals 1
...
.method static synthetic access$1200(Lcom/android/server/NSLocationMonitor;)Landroid/util/ArraySet;
    .locals 1
...
.method static synthetic access$1302(Lcom/android/server/NSLocationMonitor;Landroid/location/INSLocationManager;)Landroid/location/INSLocationManager;
    .locals 0
...
.method static synthetic access$1402(Lcom/android/server/NSLocationMonitor;Z)Z
    .locals 0
...
.method static synthetic access$500(Lcom/android/server/NSLocationMonitor;)Landroid/service/notification/NotificationListenerService;
    .locals 1

    iget-object v0, p0, Lcom/android/server/NSLocationMonitor;->mNotificationListener:Landroid/service/notification/NotificationListenerService;

    return-object v0
.end method

.method static synthetic access$600(Lcom/android/server/NSLocationMonitor;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/NSLocationMonitor;->mRegisteredNotificationListener:Z

    return v0
.end method

.method static synthetic access$602(Lcom/android/server/NSLocationMonitor;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/NSLocationMonitor;->mRegisteredNotificationListener:Z

    return p1
.end method

.method static synthetic access$700(Lcom/android/server/NSLocationMonitor;)Landroid/content/Context;
    .locals 1
...
.method static synthetic access$800(Lcom/android/server/NSLocationMonitor;)Lcom/android/server/NSLocationMonitor$ServiceCallback;
    .locals 1
...
.method static synthetic access$900(Lcom/android/server/NSLocationMonitor;)Ljava/util/HashSet;
    .locals 1
