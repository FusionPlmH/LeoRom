...
.field private static final MESSAGE_CHECK_TOKEN_DATE:I = 0x3
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/EngineeringModeService;->mDoInitCore:Z
    ...
    iput-object v1, p0, Lcom/android/server/EngineeringModeService;->mHandler:Landroid/os/Handler;

    new-instance v1, Lcom/android/server/EngineeringModeService$2;

    invoke-direct {v1, p0}, Lcom/android/server/EngineeringModeService$2;-><init>(Lcom/android/server/EngineeringModeService;)V
    ...
    iput-object v2, p0, Lcom/android/server/EngineeringModeService;->mWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    new-instance v6, Lcom/android/server/EngineeringModeService$EngineeringModeServiceSocket;

    invoke-direct {v6, p0}, Lcom/android/server/EngineeringModeService$EngineeringModeServiceSocket;-><init>(Lcom/android/server/EngineeringModeService;)V

    invoke-direct {v5, v6}, Ljava/lang/Thread;-><init>(Ljava/lang/Runnable;)V

    iput-object v5, p0, Lcom/android/server/EngineeringModeService;->mThreadSocket:Ljava/lang/Thread;

    iget-object v5, p0, Lcom/android/server/EngineeringModeService;->mThreadSocket:Ljava/lang/Thread;
    ...
    :goto_0
    iget-object v5, p0, Lcom/android/server/EngineeringModeService;->mHandler:Landroid/os/Handler;

    iget-object v6, p0, Lcom/android/server/EngineeringModeService;->mHandler:Landroid/os/Handler;
    ...
    const-string v3, "EM Service is started, state = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v3, p0, Lcom/android/server/EngineeringModeService;->mTokenState:Ljava/lang/String;
    ...
    const-string v3, "EM Service is started as version "
...
.method static synthetic access$000(Lcom/android/server/EngineeringModeService;)Landroid/os/Handler;
    .locals 1

    iget-object v0, p0, Lcom/android/server/EngineeringModeService;->mHandler:Landroid/os/Handler;

    return-object v0
.end method

.method static synthetic access$100(Lcom/android/server/EngineeringModeService;)Landroid/os/PowerManager$WakeLock;
    .locals 1

    iget-object v0, p0, Lcom/android/server/EngineeringModeService;->mWakeLock:Landroid/os/PowerManager$WakeLock;

    return-object v0
.end method

.method static synthetic access$1000(Lcom/android/server/EngineeringModeService;)V
    .locals 0
...
.method static synthetic access$1100(Lcom/android/server/EngineeringModeService;Ljava/lang/String;I)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/EngineeringModeService;->showToast(Ljava/lang/String;I)V

    return-void
.end method

.method static synthetic access$1200(Lcom/android/server/EngineeringModeService;I)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$1300(Lcom/android/server/EngineeringModeService;)I
    .locals 1
...
.method static synthetic access$202(Lcom/android/server/EngineeringModeService;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method static synthetic access$302(Lcom/android/server/EngineeringModeService;Z)Z
    .locals 0
...
.method static synthetic access$500(Lcom/android/server/EngineeringModeService;)V
    .locals 0
...
.method static synthetic access$600(Lcom/android/server/EngineeringModeService;)Ljava/lang/Object;
    .locals 1
...
.method static synthetic access$800(Lcom/android/server/EngineeringModeService;)I
    ...
    invoke-direct {p0}, Lcom/android/server/EngineeringModeService;->nativeEM20DoInitCoreData()I
...
.method static synthetic access$900(Lcom/android/server/EngineeringModeService;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/EngineeringModeService;->mDoInitCore:Z

    return v0
.end method

.method static synthetic access$902(Lcom/android/server/EngineeringModeService;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/EngineeringModeService;->mDoInitCore:Z
...
.method private makeTimeReq()[B
    ...
    :cond_0
    iget-object v1, p0, Lcom/android/server/EngineeringModeService;->mHandler:Landroid/os/Handler;

    iget-object v2, p0, Lcom/android/server/EngineeringModeService;->mHandler:Landroid/os/Handler;
...
.method private native nativeEM20DoInitCoreData()I
.end method
...
.method private showToast(Ljava/lang/String;I)V
    ...
    new-instance v1, Lcom/android/server/EngineeringModeService$3;

    invoke-direct {v1, p0, p1, p2}, Lcom/android/server/EngineeringModeService$3;-><init>(Lcom/android/server/EngineeringModeService;Ljava/lang/String;I)V
...
.method private updateTime([B)Ljava/lang/String;
    ...
    const-string/jumbo v2, "updateTime isn\'t supported in EM version 1.0"
    ...
    iget-object v3, p0, Lcom/android/server/EngineeringModeService;->mHandler:Landroid/os/Handler;
...
.method public getLastTokenStatus()Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/server/EngineeringModeService;->mHandler:Landroid/os/Handler;
...
.method public getStatus(I)I
    ...
    iget-object v12, v10, Lcom/android/server/EngineeringModeService;->mLock:Ljava/lang/Object;
    ...
    :try_start_0
    invoke-direct {v10, v0}, Lcom/android/server/EngineeringModeService;->updateTokenState(Z)V

    invoke-direct {v10}, Lcom/android/server/EngineeringModeService;->checkTokenExist()Z
    ...
    invoke-direct {v10, v1, v2, v11}, Lcom/android/server/EngineeringModeService;->isEmClient(III)Ljava/lang/String;
    ...
    invoke-virtual {v10}, Lcom/android/server/EngineeringModeService;->getServerTime()J
    ...
    const-string/jumbo v2, "getStatus(i) Failed to get EM Server time. Use current value"

    invoke-static {v1, v2}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;)I

    :cond_2
    iget-object v1, v10, Lcom/android/server/EngineeringModeService;->mHandler:Landroid/os/Handler;

    iget-object v2, v10, Lcom/android/server/EngineeringModeService;->mHandler:Landroid/os/Handler;
    ...
    invoke-direct {v10, v2, v14}, Lcom/android/server/EngineeringModeService;->showToast(Ljava/lang/String;I)V
    ...
    :cond_6
    invoke-direct {v10, v1, v13}, Lcom/android/server/EngineeringModeService;->isOkToUseDevCert(ILjava/lang/String;)Z
...
.method public getStatus(ILjava/lang/String;)I
    ...
    iget-object v3, v10, Lcom/android/server/EngineeringModeService;->mHandler:Landroid/os/Handler;
    ...
    invoke-direct {v10, v2}, Lcom/android/server/EngineeringModeService;->updateTokenState(Z)V
...
.method public makeTokenReq(Ljava/lang/String;Ljava/lang/String;[BLjava/lang/String;)[B
    ...
    invoke-direct/range {v3 .. v8}, Lcom/android/server/EngineeringModeService;->nativeEM20MakeTokenReq(Ljava/lang/String;Ljava/lang/String;[BLjava/lang/String;Ljava/lang/String;)[B
