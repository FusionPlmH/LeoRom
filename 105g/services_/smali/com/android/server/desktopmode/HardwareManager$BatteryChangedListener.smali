...
.method private updateWiredChargingStatus(Lcom/android/server/desktopmode/State;Landroid/content/Intent;)V
    ...
    const-string/jumbo v6, "isWiredCharging="
    ...
    :cond_3
    iget-object v4, p0, Lcom/android/server/desktopmode/HardwareManager$BatteryChangedListener;->this$0:Lcom/android/server/desktopmode/HardwareManager;

    invoke-static {v4}, Lcom/android/server/desktopmode/HardwareManager;->access$200(Lcom/android/server/desktopmode/HardwareManager;)Lcom/android/server/desktopmode/IStateManager;

    move-result-object v4

    invoke-interface {v4, v3}, Lcom/android/server/desktopmode/IStateManager;->setWiredCharging(Z)V
    ...
    const-string/jumbo v6, "isWiredFastCharging="

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v5, v1}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v6, ", chargerType="
    ...
    :cond_6
    iget-object v2, p0, Lcom/android/server/desktopmode/HardwareManager$BatteryChangedListener;->this$0:Lcom/android/server/desktopmode/HardwareManager;
    ...
    invoke-interface {v2, v1}, Lcom/android/server/desktopmode/IStateManager;->setWiredFastCharging(Z)V
...
.method register()V
    ...
    invoke-static {v0}, Lcom/android/server/desktopmode/HardwareManager;->access$1800(Lcom/android/server/desktopmode/HardwareManager;)Landroid/content/Context;
