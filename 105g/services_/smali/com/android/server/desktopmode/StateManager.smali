...
.method private copyInternalStateLocked(Lcom/android/server/desktopmode/StateManager$InternalState;)Lcom/android/server/desktopmode/State;
    ...
    invoke-static {p1}, Lcom/android/server/desktopmode/StateManager$InternalState;->access$2308(Lcom/android/server/desktopmode/StateManager$InternalState;)I
...
.method public static synthetic lambda$setLaunchPolicyDatabaseCreated$18(Lcom/android/server/desktopmode/StateManager;Lcom/android/server/desktopmode/State;)V
    .locals 2
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/desktopmode/StateManager$StateListener;->onLaunchPolicyDatabaseCreated(Lcom/android/server/desktopmode/State;)V
...
.method public notifyDexOnPcDisplayDisconnectionRequest()V
    .locals 2
    ...
    const-string/jumbo v1, "notifyDexOnPcDisplayDisconnectionRequest()"
    ...
    invoke-virtual {v1}, Lcom/android/server/desktopmode/StateManager$StateListener;->onDexOnPcDisplayDisconnectionRequested()V
...
.method public setLaunchPolicyDatabaseCreated(Z)V
    .locals 4
    ...
    const-string/jumbo v2, "setLaunchPolicyDatabaseCreated(launchPolicyDatabaseCreated="
    ...
    invoke-static {v1}, Lcom/android/server/desktopmode/StateManager$InternalState;->access$2200(Lcom/android/server/desktopmode/StateManager$InternalState;)Z
    ...
    invoke-static {v1, p1}, Lcom/android/server/desktopmode/StateManager$InternalState;->access$2202(Lcom/android/server/desktopmode/StateManager$InternalState;Z)Z
    ...
    new-instance v3, Lcom/android/server/desktopmode/-$$Lambda$StateManager$jjq9eOI-l5PSI3P5W1vxpfp_uCQ;

    invoke-direct {v3, p0, v1}, Lcom/android/server/desktopmode/-$$Lambda$StateManager$jjq9eOI-l5PSI3P5W1vxpfp_uCQ;-><init>(Lcom/android/server/desktopmode/StateManager;Lcom/android/server/desktopmode/State;)V
