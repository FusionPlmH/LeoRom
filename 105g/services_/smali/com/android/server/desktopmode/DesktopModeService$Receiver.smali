...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {}, Lcom/android/server/desktopmode/DesktopModeService;->access$300()Ljava/lang/String;
    ...
    invoke-static {v2, p2}, Lcom/android/server/desktopmode/DesktopModeService;->access$2200(Lcom/android/server/desktopmode/DesktopModeService;Landroid/content/Intent;)V
    ...
    const-string v5, "com.android.server.desktopmode.extra.DESKTOP_MODE_STATE"
    ...
    invoke-static {v3}, Lcom/android/server/desktopmode/DesktopModeService;->access$2400(Lcom/android/server/desktopmode/DesktopModeService;)Lcom/android/server/desktopmode/DockManager;

    move-result-object v3

    const-string/jumbo v4, "notification"

    invoke-virtual {v3, v6, v4}, Lcom/android/server/desktopmode/DockManager;->updateDockFastChargingState(ILjava/lang/String;)V
    ...
    invoke-virtual {v3, v7}, Lcom/android/server/desktopmode/DockManager;->setFastChargingEnable(Z)V
    ...
    invoke-static {v3}, Lcom/android/server/desktopmode/DesktopModeService;->access$2300(Lcom/android/server/desktopmode/DesktopModeService;)Landroid/app/StatusBarManager;
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/desktopmode/DockManager;->setFastChargingEnable(Z)V

    iget-object v3, p0, Lcom/android/server/desktopmode/DesktopModeService$Receiver;->this$0:Lcom/android/server/desktopmode/DesktopModeService;

    invoke-virtual {v3, v4}, Lcom/android/server/desktopmode/DesktopModeService;->setHdmiSettings(Z)V
    ...
    invoke-interface {v1}, Lcom/android/server/desktopmode/State;->isDexOnPcConnected()Z
    ...
    invoke-interface {v3}, Lcom/android/server/desktopmode/IStateManager;->notifyDexOnPcDisplayDisconnectionRequest()V
    ...
    invoke-static {v3}, Lcom/android/server/desktopmode/DesktopModeService;->access$900(Lcom/android/server/desktopmode/DesktopModeService;)Lcom/android/server/desktopmode/SettingsHelper;

    move-result-object v3

    invoke-virtual {v3}, Lcom/android/server/desktopmode/SettingsHelper;->getHdmiSettings()I
    ...
    invoke-static {v5}, Lcom/android/server/desktopmode/DesktopModeService;->access$2300(Lcom/android/server/desktopmode/DesktopModeService;)Landroid/app/StatusBarManager;
    ...
    invoke-static {v5}, Lcom/android/server/desktopmode/DesktopModeService;->access$2400(Lcom/android/server/desktopmode/DesktopModeService;)Lcom/android/server/desktopmode/DockManager;

    move-result-object v5

    invoke-virtual {v5, v4}, Lcom/android/server/desktopmode/DockManager;->setFastChargingEnable(Z)V

    :cond_4
    iget-object v4, p0, Lcom/android/server/desktopmode/DesktopModeService$Receiver;->this$0:Lcom/android/server/desktopmode/DesktopModeService;

    invoke-static {v4}, Lcom/android/server/desktopmode/DesktopModeService;->access$900(Lcom/android/server/desktopmode/DesktopModeService;)Lcom/android/server/desktopmode/SettingsHelper;

    move-result-object v4

    invoke-virtual {v4}, Lcom/android/server/desktopmode/SettingsHelper;->getHdmiSettings()I
    ...
    invoke-virtual {v3, v7}, Lcom/android/server/desktopmode/DesktopModeService;->scheduleUpdateDesktopMode(Z)V
    ...
    invoke-static {v3}, Lcom/android/server/desktopmode/DesktopModeService;->access$2500(Lcom/android/server/desktopmode/DesktopModeService;)V
    ...
    invoke-virtual {v3, v7}, Lcom/android/server/desktopmode/DesktopModeService;->setHdmiSettings(Z)V
    ...
    invoke-static {v2, v5}, Lcom/android/server/desktopmode/DesktopModeService;->access$2600(Lcom/android/server/desktopmode/DesktopModeService;I)V
    ...
    invoke-static {v2}, Lcom/android/server/desktopmode/DesktopModeService;->access$2300(Lcom/android/server/desktopmode/DesktopModeService;)Landroid/app/StatusBarManager;
    ...
    invoke-static {v3, v2, v1}, Lcom/android/server/desktopmode/DesktopModeService;->access$2700(Lcom/android/server/desktopmode/DesktopModeService;Landroid/content/Intent;Lcom/android/server/desktopmode/State;)V
    ...
    invoke-static {v3, v5}, Lcom/android/server/desktopmode/Utils;->getMuseUrl(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6}, Lcom/android/server/desktopmode/DesktopModeService;->access$1100(Lcom/android/server/desktopmode/DesktopModeService;)Landroid/content/Context;

    move-result-object v6

    iget-object v7, p0, Lcom/android/server/desktopmode/DesktopModeService$Receiver;->this$0:Lcom/android/server/desktopmode/DesktopModeService;

    invoke-static {v7}, Lcom/android/server/desktopmode/DesktopModeService;->access$800(Lcom/android/server/desktopmode/DesktopModeService;)I

    move-result v7

    invoke-static {v6, v2, v3, v7}, Lcom/android/server/desktopmode/DesktopModeService;->access$2800(Landroid/content/Context;Landroid/content/Intent;II)V
    ...
    invoke-static {v2, v4}, Lcom/android/server/desktopmode/DesktopModeService;->access$2902(Lcom/android/server/desktopmode/DesktopModeService;Z)Z
