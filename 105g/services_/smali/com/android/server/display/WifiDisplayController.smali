...
.method static synthetic access$1200(Lcom/android/server/display/WifiDisplayController;)Lcom/android/server/display/WifiDisplayController$Listener;
    .locals 1
...
.method static synthetic access$1300(Lcom/android/server/display/WifiDisplayController;I)V
    .locals 0
...
.method static synthetic access$1400(Lcom/android/server/display/WifiDisplayController;)Z
    .locals 1
...
.method static synthetic access$302(Landroid/widget/Toast;)Landroid/widget/Toast;
    ...
    sput-object p0, Lcom/android/server/display/WifiDisplayController;->mToast:Landroid/widget/Toast;
...
.method static synthetic access$400(Lcom/android/server/display/WifiDisplayController;)Landroid/content/Context;
    .locals 1
...
.method static synthetic access$500(Lcom/android/server/display/WifiDisplayController;)Landroid/hardware/display/SemDeviceInfo;
    .locals 1
...
.method static synthetic access$7600(Lcom/android/server/display/WifiDisplayController;II)V
    .locals 0
...
.method static synthetic access$7700(Lcom/android/server/display/WifiDisplayController;I)V
    .locals 0
...
.method static synthetic access$7800(Lcom/android/server/display/WifiDisplayController;)Lcom/android/server/display/WifiDisplayController$WfdAppMonitor;
    .locals 1
...
.method static synthetic access$7802(Lcom/android/server/display/WifiDisplayController;Lcom/android/server/display/WifiDisplayController$WfdAppMonitor;)Lcom/android/server/display/WifiDisplayController$WfdAppMonitor;
    .locals 0
...
.method private createConnectConfig(Landroid/net/wifi/p2p/WifiP2pDevice;)Landroid/net/wifi/p2p/WifiP2pConfig;
    ...
    invoke-virtual {v3}, Landroid/hardware/display/SemDeviceInfo;->isWatchCameraMode()Z
...
.method private handleStateChanged(Z)V
    ...
    const-string/jumbo v1, "do not update wfd state in SideSyncMode or DexOnPcMode"
...
.method public requestApDeviceDisconnect()V
    ...
    const-string/jumbo v3, "dexonpc_connection_state"
    ...
    const-string/jumbo v0, "fcdc"

    invoke-static {v1}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v3

    invoke-virtual {p0, v0, v3}, Lcom/android/server/display/WifiDisplayController;->setParam(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-direct {p0, v0, v3}, Lcom/android/server/display/WifiDisplayController;->sendEventToSemDeviceStatusListener(II)V

    iput-boolean v1, p0, Lcom/android/server/display/WifiDisplayController;->mDisconnectByUser:Z
...
.method public sendDeviceVolumeKeyEvent(I)V
    ...
    const-string/jumbo v4, "setParam, sendDeviceVolumeKeyEvent : "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v4, p0, Lcom/android/server/display/WifiDisplayController;->mControllerUtils:Lcom/android/server/display/ControllerUtils;

    invoke-virtual {v4, p1}, Lcom/android/server/display/ControllerUtils;->keyEventToString(I)Ljava/lang/String;
...
.method public updateDeviceState(Landroid/hardware/display/SemDeviceInfo;)V
    ...
    invoke-virtual {v0}, Lcom/android/server/display/ControllerUtils;->isControllerServiceRunning()Z
    ...
    const-string v1, "DLNA pending case switch fail, and still need show float icon"
