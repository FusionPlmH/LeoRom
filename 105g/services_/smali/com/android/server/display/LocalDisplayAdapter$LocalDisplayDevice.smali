...
.method public constructor <init>(Lcom/android/server/display/LocalDisplayAdapter;Landroid/os/IBinder;I[Landroid/view/SurfaceControl$PhysicalDisplayInfo;I[II)V
    ...
    iput p1, p0, Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;->mStateLimit:I
...
.method static synthetic access$100(Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;)Lcom/android/server/lights/Light;
    .locals 1
...
.method public requestDisplayStateLocked(II)Ljava/lang/Runnable;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;->requestDisplayStateLocked(III)Ljava/lang/Runnable;
...
.method public requestDisplayStateLocked(III)Ljava/lang/Runnable;
    .locals 22
    ...
    iget v0, v11, Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;->mBrightness:I

    if-eq v0, v13, :cond_1

    iget-object v0, v11, Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;->mBacklight:Lcom/android/server/lights/Light;
    ...
    iget v0, v11, Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;->mStateLimit:I
    ...
    :cond_4
    :goto_2
    iget v10, v11, Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;->mBuiltInDisplayId:I
    ...
    iget v9, v11, Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;->mState:I
    ...
    iput v13, v11, Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;->mBrightness:I

    :cond_6
    if-eqz v17, :cond_7

    iput v14, v11, Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;->mStateLimit:I

    :cond_7
    new-instance v19, Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice$1;
    ...
    invoke-direct/range {v0 .. v10}, Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice$1;-><init>(Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;ZIZZIIIILandroid/os/IBinder;)V
