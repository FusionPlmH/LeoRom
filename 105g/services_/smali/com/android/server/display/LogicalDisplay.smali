...
.field private static final WAIT_PHYSICAL_STATE_CHANGE_TIMEOUT:I = 0x7d0
...
.method isBlankLayerStackLocked()Z
    .locals 2
    ...
    invoke-virtual {v0}, Lcom/android/server/display/DisplayDevice;->getCurrentLayerStackLocked()I
...
.method setPrimaryDisplayDevice(Lcom/android/server/display/DisplayDevice;Ljava/util/List;Landroid/os/Handler;)V
    .locals 3
    ...
    invoke-virtual {p0, p2, p3}, Lcom/android/server/display/LogicalDisplay;->updateLocked(Ljava/util/List;Landroid/os/Handler;)V
...
.method public updateLocked(Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/server/display/LogicalDisplay;->updateLocked(Ljava/util/List;Landroid/os/Handler;)V

    return-void
.end method

.method public updateLocked(Ljava/util/List;Landroid/os/Handler;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
