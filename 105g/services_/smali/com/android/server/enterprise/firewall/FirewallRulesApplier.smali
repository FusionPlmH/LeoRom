...
.field static final MAX_CMD_SIZE_BYTES:I = 0x30d40
...
.method static synthetic access$100(Lcom/android/server/enterprise/firewall/FirewallRulesApplier;)Landroid/content/Context;
    .locals 1
...
.method static synthetic access$200(Lcom/android/server/enterprise/firewall/FirewallRulesApplier;Ljava/lang/String;)Ljava/lang/String;
    .locals 1

    invoke-direct {p0, p1}, Lcom/android/server/enterprise/firewall/FirewallRulesApplier;->runShellCommand(Ljava/lang/String;)Ljava/lang/String;
...
.method addDomainRules(Ljava/util/List;Lcom/samsung/android/knox/ContextInfo;)Lcom/samsung/android/knox/net/firewall/FirewallResponse;
    ...
    invoke-static {v3, v6}, Lcom/android/server/enterprise/firewall/IptablesCommandBuilder;->getUidForApplication(Ljava/lang/String;I)Ljava/lang/Integer;
    ...
    const-string/jumbo v8, "failed to get uid for "
    ...
    :cond_2
    invoke-virtual {p0, v0}, Lcom/android/server/enterprise/firewall/FirewallRulesApplier;->splitAndConvertCommandsList(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v2, v1}, Lcom/samsung/android/knox/net/firewall/FirewallResponse$Result;->equals(Ljava/lang/Object;)Z
...
.method flushDomainChains(Ljava/lang/Integer;Z)Z
    ...
    invoke-static {p1, p2}, Lcom/android/server/enterprise/firewall/IptablesCommandBuilder;->getDomainFlushBaseChainsCommand(Ljava/lang/Integer;Z)Ljava/util/List;
...
.method reloadDomainFilterOnIptablesRules()V
    ...
    iget-object v4, p0, Lcom/android/server/enterprise/firewall/FirewallRulesApplier;->mEdmStorageProvider:Lcom/android/server/enterprise/storage/EdmStorageProviderBase;
...
.method removeDomainRules(Ljava/util/List;Lcom/samsung/android/knox/ContextInfo;Ljava/util/List;)Lcom/samsung/android/knox/net/firewall/FirewallResponse;
    ...
    invoke-static {v3, v4}, Lcom/android/server/enterprise/firewall/IptablesCommandBuilder;->getUidForApplication(Ljava/lang/String;I)Ljava/lang/Integer;
    ...
    invoke-virtual {v6, v3, v5, v7}, Lcom/android/server/enterprise/firewall/FirewallRulesApplier$DomainFilterApplicationChainsManager;->removeChainForApplication(Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Integer;)Z
...
.method splitAndConvertCommandsList(Ljava/util/List;)Ljava/util/List;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string/jumbo v5, "total number of commands "
