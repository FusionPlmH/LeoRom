...
.method public authenticate(Landroid/os/IBinder;JILandroid/hardware/fingerprint/IFingerprintServiceReceiver;ILjava/lang/String;Landroid/os/Bundle;Landroid/hardware/biometrics/IBiometricPromptReceiver;)V
    ...
    const-string v3, "com.samsung.android.permission.FINGERPRINT_PRIVILEGED"
    ...
    const-string v3, "com.samsung.android.permission.BIOMETRICS_PRIVILEGED"
    ...
    invoke-static {v2, v12}, Lcom/android/server/fingerprint/FingerprintService;->access$2500(Lcom/android/server/fingerprint/FingerprintService;I)Z
    ...
    const-string v3, "authenticate : No FINGERPRINT_PRIVILEGED permission"
    ...
    const-string v9, "authenticate : GRANTED for FINGERPRINT_PRIVILEGED, "
    ...
    invoke-static {v0, v6, v1, v2}, Lcom/android/server/fingerprint/FingerprintService;->access$2700(Lcom/android/server/fingerprint/FingerprintService;Landroid/hardware/fingerprint/IFingerprintServiceReceiver;II)V
    ...
    invoke-static {v0, v14}, Lcom/android/server/fingerprint/FingerprintService;->access$2800(Lcom/android/server/fingerprint/FingerprintService;Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_7

    const-string v0, "WHITELIST_FLAGS"
    ...
    new-instance v4, Lcom/android/server/fingerprint/FingerprintService$FingerprintServiceWrapper$3;
...
.method public request(Landroid/os/IBinder;I[B[BIILandroid/hardware/fingerprint/IFingerprintServiceReceiver;)I
    ...
    iget-object v4, v1, Lcom/android/server/fingerprint/FingerprintService$FingerprintServiceWrapper;->this$0:Lcom/android/server/fingerprint/FingerprintService;

    const-string v5, "android.permission.MANAGE_FINGERPRINT"

    invoke-virtual {v4, v5}, Lcom/android/server/fingerprint/FingerprintService;->checkPermission(Ljava/lang/String;)V
    ...
    invoke-static {v3}, Lcom/android/server/fingerprint/FingerprintService;->access$4400(Lcom/android/server/fingerprint/FingerprintService;)Lcom/android/server/fingerprint/FingerprintService$SemAlphaMaskViewManager;
    ...
    new-instance v4, Lcom/android/server/fingerprint/FingerprintService$SemAlphaMaskViewManager;

    iget-object v5, v1, Lcom/android/server/fingerprint/FingerprintService$FingerprintServiceWrapper;->this$0:Lcom/android/server/fingerprint/FingerprintService;

    invoke-direct {v4, v5}, Lcom/android/server/fingerprint/FingerprintService$SemAlphaMaskViewManager;-><init>(Lcom/android/server/fingerprint/FingerprintService;)V

    invoke-static {v3, v4}, Lcom/android/server/fingerprint/FingerprintService;->access$4402(Lcom/android/server/fingerprint/FingerprintService;Lcom/android/server/fingerprint/FingerprintService$SemAlphaMaskViewManager;)Lcom/android/server/fingerprint/FingerprintService$SemAlphaMaskViewManager;
    ...
    invoke-static {v3, v10, v4}, Lcom/android/server/fingerprint/FingerprintService$SemAlphaMaskViewManager;->access$4500(Lcom/android/server/fingerprint/FingerprintService$SemAlphaMaskViewManager;Landroid/os/IBinder;I)V
    ...
    invoke-static {v3, v10, v4}, Lcom/android/server/fingerprint/FingerprintService$SemAlphaMaskViewManager;->access$4600(Lcom/android/server/fingerprint/FingerprintService$SemAlphaMaskViewManager;Landroid/os/IBinder;I)V
    ...
    invoke-static {v2}, Lcom/android/server/fingerprint/FingerprintService;->access$2400(Lcom/android/server/fingerprint/FingerprintService;)Ljava/lang/Object;
    ...
    instance-of v5, v4, Lcom/android/server/fingerprint/AuthenticationClient;

    if-eqz v5, :cond_10

    invoke-virtual {v4}, Lcom/android/server/fingerprint/ClientMonitor;->getStatus()I
    ...
    invoke-virtual {v0, v12}, Lcom/android/server/fingerprint/AuthenticationClient;->semScreenStatus(I)V
    ...
    invoke-virtual {v0}, Lcom/android/server/fingerprint/AuthenticationClient;->semGetRemainTimeFingerIcon()J
    ...
    invoke-virtual {v0, v14}, Lcom/android/server/fingerprint/FingerprintService;->checkPermission(Ljava/lang/String;)V
    ...
    invoke-static/range {v2 .. v9}, Lcom/android/server/fingerprint/FingerprintService;->access$4700(Lcom/android/server/fingerprint/FingerprintService;Landroid/os/IBinder;I[B[BIILandroid/hardware/fingerprint/IFingerprintServiceReceiver;)I
...
.method public semGetFingerIconRectInDisplay()Landroid/graphics/Rect;
    ...
    invoke-static {v0}, Lcom/android/server/fingerprint/FingerprintService;->access$4800(Lcom/android/server/fingerprint/FingerprintService;)Landroid/graphics/Rect;
...
.method public semGetIconBottomMargin()I
    ...
    const-string/jumbo v2, "semGetIconBottomMargin called from pid="
    ...
    invoke-static {v0}, Lcom/android/server/fingerprint/FingerprintService;->access$5200(Lcom/android/server/fingerprint/FingerprintService;)I
...
.method public semGetSensorAreaInDisplay()Landroid/graphics/Rect;
    ...
    invoke-static {v3}, Lcom/android/server/fingerprint/FingerprintService;->access$4900(Lcom/android/server/fingerprint/FingerprintService;)Ljava/lang/String;
    ...
    invoke-static {v5}, Lcom/android/server/fingerprint/FingerprintService;->access$5000(Lcom/android/server/fingerprint/FingerprintService;)Ljava/lang/String;
    ...
    invoke-static {v5}, Lcom/android/server/fingerprint/FingerprintService;->access$5100(Lcom/android/server/fingerprint/FingerprintService;)Ljava/lang/String;
...
.method public semRegisterFingerprintViewListener(Landroid/os/IBinder;Landroid/hardware/fingerprint/ISemFingerprintViewCallback;)V
    ...
    invoke-static {v0, p2}, Lcom/android/server/fingerprint/FingerprintService;->access$1802(Lcom/android/server/fingerprint/FingerprintService;Landroid/hardware/fingerprint/ISemFingerprintViewCallback;)Landroid/hardware/fingerprint/ISemFingerprintViewCallback;
...
.method public semUnregisterFingerprintViewListener(Landroid/os/IBinder;)V
    ...
    invoke-static {v0, v1}, Lcom/android/server/fingerprint/FingerprintService;->access$1802(Lcom/android/server/fingerprint/FingerprintService;Landroid/hardware/fingerprint/ISemFingerprintViewCallback;)Landroid/hardware/fingerprint/ISemFingerprintViewCallback;
