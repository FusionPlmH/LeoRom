...
.method public injectInputEvent(Landroid/view/InputEvent;II)Z
    ...
    invoke-static {v0, p1, p2, p3}, Lcom/android/server/input/InputManagerService;->access$4200(Lcom/android/server/input/InputManagerService;Landroid/view/InputEvent;II)Z
...
.method public onInputMethodSubtypeChanged(ILandroid/view/inputmethod/InputMethodInfo;Landroid/view/inputmethod/InputMethodSubtype;)V
    ...
    invoke-static {v1}, Lcom/android/server/input/InputManagerService;->access$4500(Lcom/android/server/input/InputManagerService;)Lcom/android/server/input/InputManagerService$InputManagerHandler;
...
.method public setDisplayViewports(Landroid/hardware/display/DisplayViewport;Landroid/hardware/display/DisplayViewport;Ljava/util/List;)V
    ...
    invoke-static {v0, p1, p2, p3}, Lcom/android/server/input/InputManagerService;->access$4100(Lcom/android/server/input/InputManagerService;Landroid/hardware/display/DisplayViewport;Landroid/hardware/display/DisplayViewport;Ljava/util/List;)V
...
.method public setInputViewports(Ljava/util/List;)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/input/InputManagerService;->access$5000(Lcom/android/server/input/InputManagerService;Ljava/util/List;)V
...
.method public setInteractiveForInternalDisplay(Z)V
    ...
    invoke-static {v0, v1, p1}, Lcom/android/server/input/InputManagerService;->access$4400(JZ)V
...
.method public setMouseControlType(I)V
    ...
    invoke-static {v0, v1, p1}, Lcom/android/server/input/InputManagerService;->access$4800(JI)V
...
.method public setMouseCursorVisibility(Z)V
    ...
    invoke-static {v0, v1, p1}, Lcom/android/server/input/InputManagerService;->access$4700(JZ)V
...
.method public setPulseGestureEnabled(Z)V
    ...
    invoke-static {v0}, Lcom/android/server/input/InputManagerService;->access$4900(Lcom/android/server/input/InputManagerService;)Ljava/io/File;
    ...
    invoke-static {v2}, Lcom/android/server/input/InputManagerService;->access$4900(Lcom/android/server/input/InputManagerService;)Ljava/io/File;
...
.method public toggleCapsLock(I)V
    ...
    invoke-static {v0, v1, p1}, Lcom/android/server/input/InputManagerService;->access$4600(JI)V
