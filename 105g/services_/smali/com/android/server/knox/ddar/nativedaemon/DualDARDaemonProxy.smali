...
.method private fetchDumpStateInfo(Lcom/samsung/android/knox/ddar/FileInfo;)Z
    ...
    const-string/jumbo v1, "fetchDumpStateInfo()"
    ...
    iget-object v0, p1, Lcom/samsung/android/knox/ddar/FileInfo;->fd:Landroid/os/ParcelFileDescriptor;

    const-string v1, "/data/log/ddar_log.txt"

    invoke-static {v0, v1}, Lcom/android/server/knox/ddar/nativedaemon/DualDARDaemonProxy;->fileCopy(Landroid/os/ParcelFileDescriptor;Ljava/lang/String;)Z

    const-string v0, "DualDARDaemonProxy"

    const-string/jumbo v1, "fetchDumpStateInfo() successfullly read the log file"
...
.method public static fileCopy(Landroid/os/ParcelFileDescriptor;Ljava/lang/String;)Z
    ...
    :goto_1
    invoke-virtual {v2, v9, v4, v8}, Ljava/io/FileInputStream;->read([BII)I

    move-result v10

    move v6, v10

    invoke-virtual {v1, v9, v4, v6}, Ljava/io/FileOutputStream;->write([BII)V
    :try_end_0
    ...
    invoke-static {v6, v7, v4}, Lcom/android/server/knox/ddar/DDLog;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    const-string v8, "DualDARDaemonProxy"

    invoke-static {v8, v7, v4}, Lcom/android/server/knox/ddar/DDLog;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
...
.method public dumpSecret(ILjava/lang/String;)Z
    ...
    const-string/jumbo v2, "dumpSecret failed! Error: native interface not yet connected failed"
    ...
    :cond_0
    const-string v0, "DualDARDaemonProxy.DUALDAR"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v3, "dumpSecret() - userId : "
...
.method public onMessage(ILjava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    const-string/jumbo v6, "dualdard daemon already running! "
    ...
    :sswitch_data_0
    .sparse-switch
        -0x74c33360 -> :sswitch_a
        -0x41169e9f -> :sswitch_9
        -0x39e32f38 -> :sswitch_8
        -0x398c663c -> :sswitch_7
        0x432f76a -> :sswitch_6
        0xd454d21 -> :sswitch_5
        0x132d527c -> :sswitch_4
...
.method public pushSecret(ILjava/util/List;Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object v4, p0, Lcom/android/server/knox/ddar/nativedaemon/DualDARDaemonProxy;->mSecureClientForInAPI:Lcom/samsung/android/knox/ddar/securesession/SecureClient;

    iget-object v5, v2, Lcom/samsung/android/knox/ddar/Secret;->data:[B

    invoke-virtual {v4, p3, v5}, Lcom/samsung/android/knox/ddar/securesession/SecureClient;->decryptMessageFrom(Ljava/lang/String;[B)[B
    ...
    iget-object v6, p0, Lcom/android/server/knox/ddar/nativedaemon/DualDARDaemonProxy;->mConnector:Lcom/android/server/knox/ddar/nativedaemon/DualDarDaemonConnector;
    ...
    iget-object v10, v2, Lcom/samsung/android/knox/ddar/Secret;->alias:Ljava/lang/String;
    ...
    invoke-virtual {v6, v7, v8, v9}, Lcom/android/server/knox/ddar/nativedaemon/DualDarDaemonConnector;->executeSync(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Lcom/android/server/knox/ddar/nativedaemon/NativeDaemonEvent;
    ...
    invoke-static {v4}, Lcom/samsung/android/knox/ddar/securesession/Wiper;->wipe([B)V
    ...
    invoke-static {v0, v3, v6}, Lcom/android/server/knox/ddar/DDLog;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setEviction(IZ)Z
    ...
    const-string/jumbo v2, "setEviction failed!"
