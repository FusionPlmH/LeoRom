...
.method private maybeUnlockDualDARUser(II)Z
    ...
    new-instance v2, Lcom/android/server/locksettings/EncryptedPasswordManager;

    invoke-direct {v2}, Lcom/android/server/locksettings/EncryptedPasswordManager;-><init>()V
    ...
    const-string v7, "Password2Auth has already been completed for: "
    ...
    const-string v7, "Do Password2Auth with null credential for: "
    ...
    invoke-direct {p0, p1, v5}, Lcom/android/server/am/UserController;->onPassword2Auth(ILjava/lang/String;)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    invoke-virtual {v2, v1}, Lcom/android/server/locksettings/EncryptedPasswordManager;->encryptPassword([B)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v3}, Lcom/android/server/am/UserController;->maybeUnlockUser(I[B)Z
...
.method finishUserStopped(Lcom/android/server/am/UserState;)V
    ...
    invoke-virtual {v3, v0}, Lcom/samsung/android/knox/ddar/DualDARController;->onUserStopped(I)V
...
.method startUser(IZLandroid/os/IProgressListener;)Z
    ...
    iget-object v2, v1, Lcom/android/server/am/UserController;->mService:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-virtual {v2, v15}, Lcom/samsung/android/knox/ddar/DualDARController;->onUserStart(I)V
