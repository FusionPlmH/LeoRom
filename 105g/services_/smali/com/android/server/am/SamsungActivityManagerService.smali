...
.method private getTopStackWithStandardActivityType(Lcom/android/server/am/ActivityDisplay;I)Lcom/android/server/am/ActivityStack;
    .locals 3
...
.method public bringTaskToForeground(III)V
    ...
    const-string v4, "bringTaskToForeground(), auto_open_last_app is forcibly disabled by Knox Custom SDK"
    ...
    const-string v3, "bringTaskToForeground(), auto_open_last_app is not enabled"
    ...
    invoke-virtual {v3}, Lcom/android/server/am/TaskRecord;->isActivityTypeStandard()Z
    ...
    invoke-virtual {v0, v4}, Lcom/samsung/android/knox/custom/PrivateCustomDeviceManager;->stayInForeground(Landroid/content/ComponentName;)Z
    ...
    const-string v6, "bringTaskToForeground(), task="

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v5, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v6, " is not whitelisted."
    ...
    const-string v6, "bringTaskToForeground(), taskId="
    ...
    const-string v6, ", targetDisplayId="

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v5, p2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v6, ", targetWindowingMode="
    ...
    const-string v6, "bringTaskToForeground(): rootActivity is null."
    ...
    invoke-virtual {v5, v3}, Lcom/android/server/am/MultiDisplayManagerService;->getNonStartableActivityInDexMode(Lcom/android/server/am/TaskRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    const-string v7, "bringTaskToForeground(): getLaunchPolicyRunnable=false, "
    ...
    invoke-virtual {v5, p3}, Landroid/app/ActivityOptions;->setLaunchWindowingMode(I)V

    iget-object v6, v4, Lcom/android/server/am/ActivityRecord;->processName:Ljava/lang/String;

    invoke-virtual {v4}, Lcom/android/server/am/ActivityRecord;->getUid()I

    move-result v7

    iget-object v8, v4, Lcom/android/server/am/ActivityRecord;->appInfo:Landroid/content/pm/ApplicationInfo;

    invoke-static {v6, v7, v8, v3, v5}, Lcom/android/server/am/DisplayChooserInfo;->createStartActivityFromRecentsType(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;Lcom/android/server/am/TaskRecord;Landroid/app/ActivityOptions;)Lcom/android/server/am/DisplayChooserInfo;
    ...
    invoke-virtual {v7, v6, p2}, Lcom/android/server/am/MultiDisplayManagerService;->moveTasksBackAndStartPendingActivity(Lcom/android/server/am/DisplayChooserInfo;I)V
...
.method public getForegroundTaskId(I)I
    ...
    invoke-virtual {v3, p1}, Lcom/android/server/am/ActivityStackSupervisor;->getActivityDisplay(I)Lcom/android/server/am/ActivityDisplay;
    ...
    :goto_0
    invoke-direct {p0, v3, v4}, Lcom/android/server/am/SamsungActivityManagerService;->getTopStackWithStandardActivityType(Lcom/android/server/am/ActivityDisplay;I)Lcom/android/server/am/ActivityStack;
    ...
    const-string/jumbo v6, "getForegroundTaskId(displayId="
...
.method public hasPackageTask(ILjava/lang/String;I)Z
    ...
    const-string/jumbo v8, "hasPackageTask(), displayId="
