...
.method static synthetic access$400(Lcom/android/server/am/MultiDisplayManagerService;)Z
    .locals 1
...
.method static synthetic access$402(Lcom/android/server/am/MultiDisplayManagerService;Z)Z
    .locals 0
...
.method static synthetic access$500(Lcom/android/server/am/MultiDisplayManagerService;)Landroid/os/RemoteCallbackList;
    .locals 1
...
.method static synthetic access$600(Lcom/android/server/am/MultiDisplayManagerService;)Lcom/android/server/am/MultiDisplayManagerService$PendingActivityInfo;
    .locals 1
...
.method static synthetic access$700(Lcom/android/server/am/MultiDisplayManagerService;)Lcom/android/server/am/ActivityStackSupervisor;
    .locals 1
...
.method static synthetic access$800(Lcom/android/server/am/MultiDisplayManagerService;Z)V
    .locals 0
...
.method private moveProcessTasksToBackLocked(Ljava/lang/String;II)V
    ...
    invoke-static {v2, v3}, Lcom/android/server/am/MultiDisplayManagerService$FindTaskResult;->access$900(Lcom/android/server/am/MultiDisplayManagerService$FindTaskResult;Ljava/lang/String;)V
...
.method private moveTasksToFreeformLocked(II)V
    ...
    :try_start_2
    invoke-virtual {v0, v5, v6}, Lcom/android/server/am/ActivityDisplay;->getStacks(II)Ljava/util/ArrayList;
    ...
    const-string/jumbo v13, "moveTasksToFreeformLocked: "
    ...
    sget-boolean v13, Lcom/android/server/am/MultiDisplayManagerService;->SAFE_DEBUG:Z

    if-eqz v13, :cond_3

    const-string v13, "MultiDisplayManager"

    new-instance v14, Ljava/lang/StringBuilder;

    invoke-direct {v14}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v15, "moveTasksToFreeformLocked: task="
    ...
    const-string/jumbo v15, "moveTasksToFreeformLocked: prev overrideConfig="

    invoke-virtual {v14, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v12}, Lcom/android/server/am/TaskRecord;->getOverrideConfiguration()Landroid/content/res/Configuration;
    ...
    :cond_3
    invoke-virtual {v12}, Lcom/android/server/am/TaskRecord;->isActivityTypeStandardOrUndefined()Z
    ...
    invoke-virtual {v15}, Lcom/android/server/am/ActivityRecord;->isActivityTypeStandardOrUndefined()Z
    ...
    :cond_5
    invoke-direct {v1, v12}, Lcom/android/server/am/MultiDisplayManagerService;->isExcludedTaskOrNonRecentTask(Lcom/android/server/am/TaskRecord;)Z

    move-result v13

    if-nez v13, :cond_8

    invoke-virtual {v1, v12}, Lcom/android/server/am/MultiDisplayManagerService;->getNonStartableActivityInDexMode(Lcom/android/server/am/TaskRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    iget-object v13, v15, Lcom/android/server/am/ActivityRecord;->app:Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v14, v15, Lcom/android/server/am/ActivityRecord;->app:Lcom/android/server/am/ProcessRecord;
    ...
    invoke-virtual {v14, v3}, Landroid/app/ActivityOptions;->setLaunchDisplayId(I)Landroid/app/ActivityOptions;

    const/4 v13, 0x5

    invoke-virtual {v14, v13}, Landroid/app/ActivityOptions;->setLaunchWindowingMode(I)V
    ...
    invoke-virtual {v13}, Lcom/android/server/am/ActivityStackSupervisor;->getLaunchParamsController()Lcom/android/server/am/LaunchParamsController;
    ...
    invoke-virtual/range {v13 .. v18}, Lcom/android/server/am/LaunchParamsController;->layoutTask(Lcom/android/server/am/TaskRecord;Landroid/content/pm/ActivityInfo$WindowLayout;Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Landroid/app/ActivityOptions;)Z
    ...
    const-string/jumbo v15, "moveTasksToFreeformLocked: new overrideConfig="
    ...
    const-string/jumbo v15, "moveTasksToFreeformLocked"

    invoke-virtual {v13, v14, v5, v6, v15}, Lcom/android/server/am/ActivityStackSupervisor;->removeTaskByIdLocked(IZZLjava/lang/String;)Z
    ...
    iget-object v9, v1, Lcom/android/server/am/MultiDisplayManagerService;->mStackSupervisor:Lcom/android/server/am/ActivityStackSupervisor;

    invoke-virtual {v9, v8}, Lcom/android/server/am/ActivityStackSupervisor;->scheduleUpdateMultiWindowMode(Lcom/android/server/am/TaskRecord;)V
    ...
    iget-object v4, v1, Lcom/android/server/am/MultiDisplayManagerService;->mStackSupervisor:Lcom/android/server/am/ActivityStackSupervisor;

    const-string/jumbo v6, "moveTasksToFreeformLocked"

    invoke-virtual {v4, v6, v3}, Lcom/android/server/am/ActivityStackSupervisor;->moveHomeStackTaskToTop(Ljava/lang/String;I)Z
    :try_end_2
...
.method public getDexTaskInfoFlags(Landroid/os/IBinder;)I
    ...
    invoke-virtual {v4}, Lcom/android/server/am/TaskRecord;->getDexMetadataLaunchSize()Landroid/graphics/Point;
...
.method public setForcedDefaultDisplayDevice(Landroid/os/IBinder;IZ)V
    .locals 0
...
.method updateDexModeIfNeededLocked(Ljava/lang/String;)V
    ...
    const-string/jumbo v6, "desktop_on"
    ...
    :cond_2
    :goto_1
    const-string/jumbo v6, "desktop_off"
