...
.method private getRecentTaskBound(Lcom/android/server/am/TaskRecord;)Landroid/graphics/Rect;
    ...
    invoke-virtual {v3}, Lcom/android/server/am/TaskRecord;->isDexCompatEnabled()Z

    move-result v7

    if-eqz v7, :cond_9

    iget v7, v3, Lcom/android/server/am/TaskRecord;->mDexCompatUiMode:I
    ...
    const-string/jumbo v9, "getRecentTaskBound: task="
...
.method public onCalculate(Lcom/android/server/am/TaskRecord;Landroid/content/pm/ActivityInfo$WindowLayout;Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Landroid/app/ActivityOptions;Lcom/android/server/am/LaunchParamsController$LaunchParams;Lcom/android/server/am/LaunchParamsController$LaunchParams;)I
    ...
    invoke-direct {v10, v9}, Lcom/android/server/am/TaskLaunchParamsModifier;->getFreeformTasks(I)Ljava/util/ArrayList;
    ...
    :try_start_0
    invoke-direct {v10, v11, v9, v7}, Lcom/android/server/am/TaskLaunchParamsModifier;->getDexBounds(Lcom/android/server/am/TaskRecord;ILandroid/graphics/Rect;)I
    ...
    invoke-virtual {v1, v15}, Lcom/android/server/am/ActivityStackSupervisor;->getActivityDisplay(I)Lcom/android/server/am/ActivityDisplay;
    ...
    iget-object v8, v10, Lcom/android/server/am/TaskLaunchParamsModifier;->mService:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-virtual {v8, v0}, Lcom/android/server/wm/WindowManagerService;->getInitialDisplayDensity(I)I

    move-result v8

    int-to-float v8, v8

    iget v0, v15, Landroid/content/res/Configuration;->densityDpi:I

    int-to-float v0, v0

    div-float/2addr v0, v8

    iput v0, v10, Lcom/android/server/am/TaskLaunchParamsModifier;->mDensityConverter:F
