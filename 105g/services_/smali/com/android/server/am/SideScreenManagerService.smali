...
.method public static synthetic lambda$dismissSideScreen$4(Lcom/android/server/am/SideScreenManagerService;I)V
    ...
    :cond_3
    invoke-virtual {p0, v1, v1}, Lcom/android/server/am/SideScreenManagerService;->hideSideScreen(ZZ)V
...
.method public static synthetic lambda$getSideScreenStacksMovementAnimator$8(Lcom/android/server/am/SideScreenManagerService;Landroid/animation/ValueAnimator;ILandroid/animation/ValueAnimator;)V
    ...
    iget-object v1, p0, Lcom/android/server/am/SideScreenManagerService;->mAnimatingRect:Landroid/graphics/Rect;

    const/4 v2, 0x0

    invoke-virtual {p0, p2, v1, v2}, Lcom/android/server/am/SideScreenManagerService;->resizeSideScreenStacksLocked(ILandroid/graphics/Rect;Z)Z
...
.method public static synthetic lambda$hideSideScreen$2(Lcom/android/server/am/SideScreenManagerService;Z)V
    .locals 3
...
.method private moveSideScreenTasksToBackLocked()V
    .locals 5
...
.method hideSideScreen(ZZ)V
    ...
    new-instance v1, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$VR0uOjdYJmxPBSZtoyoNGHmM9_k;

    invoke-direct {v1, p0, p2}, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$VR0uOjdYJmxPBSZtoyoNGHmM9_k;-><init>(Lcom/android/server/am/SideScreenManagerService;Z)V
...
.method public onSideScreenStackRemoved()V
    ...
    invoke-virtual {v1}, Lcom/android/server/wm/SideScreenManagerInternal;->onSideScreenStackRemoved()V
...
.method swapTaskWindowingModeFromSubWindowHandler(II)V
    ...
    const-string v3, "abort swapTaskWindowingModeFromSubWindowHandler : not found task."
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v1}, Lcom/android/server/am/TaskRecord;->inSideScreenWindowingMode()Z
    ...
    const-string v3, "abort swapTaskWindowingModeFromSubWindowHandler : task isn\'t in SideScreen."
    ...
    const-string v4, "abort swapTaskWindowingModeFromSubWindowHandler : same windowingMode."
    ...
    const-string v4, "SideScreenManagerService"

    const-string v5, "abort swapTaskWindowingModeFromSubWindowHandler : display is not exist."
    ...
    :cond_3
    :try_start_4
    invoke-virtual {v3, p2}, Lcom/android/server/am/ActivityDisplay;->getTopStackInWindowingMode(I)Lcom/android/server/am/ActivityStack;
    ...
    invoke-virtual {v11}, Lcom/android/server/am/ActivityRecord;->inSideScreenWindowingMode()Z
    ...
    invoke-virtual {v4}, Lcom/android/server/am/TaskRecord;->isActivityTypeStandard()Z
    ...
    invoke-direct {p0, v3, v4}, Lcom/android/server/am/SideScreenManagerService;->getNextStackInWindowingMode(Lcom/android/server/am/ActivityDisplay;Lcom/android/server/am/ActivityStack;)Lcom/android/server/am/ActivityStack;

    move-result-object v4

    invoke-virtual {v3}, Lcom/android/server/am/ActivityDisplay;->getSideScreenRecentsStack()Lcom/android/server/am/ActivityStack;
    ...
    new-instance v12, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$FK4MgWKnHPr8vFqr9LUSMG6tNE4;
    ...
    invoke-direct/range {v4 .. v9}, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$FK4MgWKnHPr8vFqr9LUSMG6tNE4;-><init>(Lcom/android/server/am/SideScreenManagerService;ZLcom/android/server/am/ActivityDisplay;ILcom/android/server/am/ActivityRecord;)V
