...
.method final moveTaskToBackLocked(ILandroid/os/Bundle;ZZ)Z
    ...
    invoke-virtual {v0, v1, v10}, Lcom/android/server/am/SamsungActivityManagerService;->moveTaskToBackVS(Lcom/android/server/am/ActivityStack;Lcom/android/server/am/TaskRecord;)Z
    ...
    invoke-virtual {v0}, Lcom/android/server/am/FreeformController;->resetToggleFreeformList()V
    ...
    invoke-virtual {v1, v3}, Lcom/android/server/am/ActivityStack;->adjustFocusToNextFocusableStack(Ljava/lang/String;)Z

    iget-object v3, v1, Lcom/android/server/am/ActivityStack;->mStackSupervisor:Lcom/android/server/am/ActivityStackSupervisor;

    invoke-virtual {v3, v13, v11, v11}, Lcom/android/server/am/ActivityStackSupervisor;->ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;IZ)V
...
.method removeTask(Lcom/android/server/am/TaskRecord;Ljava/lang/String;I)V
    ...
    const-string v5, " leftTaskHistoryEmpty"
    ...
    invoke-virtual {v5, v1}, Lcom/android/server/am/ActivityStackSupervisor;->moveHomeStackToFront(Ljava/lang/String;)V
    ...
    const-string v7, "FallbackHome is finished, resume home. task="
    ...
    invoke-virtual {v5, v4, v6}, Lcom/android/server/am/ActivityStackSupervisor;->resumeHomeStackTask(Lcom/android/server/am/ActivityRecord;Ljava/lang/String;)Z

    :cond_d
    :goto_2
    invoke-virtual {p1, v4}, Lcom/android/server/am/TaskRecord;->setStack(Lcom/android/server/am/ActivityStack;)V
