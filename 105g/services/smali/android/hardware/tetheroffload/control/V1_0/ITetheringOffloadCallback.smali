...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/tetheroffload/control/V1_0/ITetheringOffloadCallback;
    ...
    check-cast v0, Landroid/hardware/tetheroffload/control/V1_0/ITetheringOffloadCallback;

    return-object v0

    :cond_1
    new-instance v2, Landroid/hardware/tetheroffload/control/V1_0/ITetheringOffloadCallback$Proxy;

    invoke-direct {v2, p0}, Landroid/hardware/tetheroffload/control/V1_0/ITetheringOffloadCallback$Proxy;-><init>(Landroid/os/IHwBinder;)V

    :try_start_0
    invoke-interface {v2}, Landroid/hardware/tetheroffload/control/V1_0/ITetheringOffloadCallback;->interfaceChain()Ljava/util/ArrayList;
    ...
    const-string v5, "android.hardware.tetheroffload.control@1.0::ITetheringOffloadCallback"
