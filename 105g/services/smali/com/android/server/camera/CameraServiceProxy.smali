...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/camera/CameraServiceProxy;->SAMSUNG_CAMERA_PACKAGES:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/camera/CameraServiceProxy;->mEnableSurveyMode:Z
...
.method private notifyDeviceChangeLocked(J)Z
    .locals 5
    ...
    const-string v3, "NotifyDeviceStateChange "
    ...
    invoke-interface {v0, p1, p2}, Landroid/hardware/ICameraService;->notifyDeviceStateChange(J)V
    :try_end_1
    ...
    const-string v4, "Could not notify device state change, remote exception: "
...
.method private updateActivityCount(Ljava/lang/String;IILjava/lang/String;I)V
    ...
    :pswitch_0
    iget-boolean v2, p0, Lcom/android/server/camera/CameraServiceProxy;->mEnableSurveyMode:Z

    if-eqz v2, :cond_0

    invoke-virtual {p0, p4}, Lcom/android/server/camera/CameraServiceProxy;->isSamsungCameraApp(Ljava/lang/String;)Z

    move-result v2

    if-nez v2, :cond_0

    const-string v2, "7502"
    ...
    invoke-virtual {p0, v2, p4, v3}, Lcom/android/server/camera/CameraServiceProxy;->insertDMALog(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Long;)V
...
.method isSamsungCameraApp(Ljava/lang/String;)Z
    ...
    sget-object v0, Lcom/android/server/camera/CameraServiceProxy;->SAMSUNG_CAMERA_PACKAGES:[Ljava/lang/String;
...
.method public notifyDeviceChange(J)V
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, Lcom/android/server/camera/CameraServiceProxy;->notifyDeviceChangeLocked(J)Z
