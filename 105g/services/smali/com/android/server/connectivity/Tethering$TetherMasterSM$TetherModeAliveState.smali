...
.method private setDVFS()V
    ...
    invoke-static {v1}, Lcom/android/server/connectivity/Tethering;->access$2000(Lcom/android/server/connectivity/Tethering;)Landroid/util/ArrayMap;

    move-result-object v1

    const-string/jumbo v2, "rndis0"
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/Tethering;->access$6100(Lcom/android/server/connectivity/Tethering;)Lcom/samsung/android/os/SemDvfsManager;
    ...
    invoke-static {v2, v4}, Lcom/android/server/connectivity/Tethering;->access$6102(Lcom/android/server/connectivity/Tethering;Lcom/samsung/android/os/SemDvfsManager;)Lcom/samsung/android/os/SemDvfsManager;
    ...
    invoke-static {v4}, Lcom/android/server/connectivity/Tethering;->access$6100(Lcom/android/server/connectivity/Tethering;)Lcom/samsung/android/os/SemDvfsManager;
    ...
    invoke-static {v2, v4}, Lcom/android/server/connectivity/Tethering;->access$6202(Lcom/android/server/connectivity/Tethering;[I)[I

    iget-object v2, p0, Lcom/android/server/connectivity/Tethering$TetherMasterSM$TetherModeAliveState;->this$1:Lcom/android/server/connectivity/Tethering$TetherMasterSM;

    iget-object v2, v2, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->this$0:Lcom/android/server/connectivity/Tethering;

    invoke-static {v2}, Lcom/android/server/connectivity/Tethering;->access$6200(Lcom/android/server/connectivity/Tethering;)[I
    ...
    const-string v5, "UsbTethering supportedCPUCoreTable : "
    ...
    invoke-static {v5}, Lcom/android/server/connectivity/Tethering;->access$6200(Lcom/android/server/connectivity/Tethering;)[I
    ...
    invoke-static {v3}, Lcom/android/server/connectivity/Tethering;->access$6100(Lcom/android/server/connectivity/Tethering;)Lcom/samsung/android/os/SemDvfsManager;
    ...
    invoke-virtual {v4, v3}, Lcom/samsung/android/os/SemDvfsManager;->setDvfsValue(I)V
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/Tethering;->access$6300(Lcom/android/server/connectivity/Tethering;)Lcom/samsung/android/os/SemDvfsManager;
    ...
    invoke-static {v2, v3}, Lcom/android/server/connectivity/Tethering;->access$6302(Lcom/android/server/connectivity/Tethering;Lcom/samsung/android/os/SemDvfsManager;)Lcom/samsung/android/os/SemDvfsManager;
    ...
    invoke-static {v3}, Lcom/android/server/connectivity/Tethering;->access$6300(Lcom/android/server/connectivity/Tethering;)Lcom/samsung/android/os/SemDvfsManager;

    move-result-object v3

    const-wide v4, 0x3fe6666666666666L    # 0.7

    invoke-virtual {v3, v4, v5}, Lcom/samsung/android/os/SemDvfsManager;->getApproximateFrequencyByPercent(D)I
    ...
    invoke-static {v5}, Lcom/android/server/connectivity/Tethering;->access$6300(Lcom/android/server/connectivity/Tethering;)Lcom/samsung/android/os/SemDvfsManager;
    ...
    invoke-static {v6}, Lcom/android/server/connectivity/Tethering;->access$6300(Lcom/android/server/connectivity/Tethering;)Lcom/samsung/android/os/SemDvfsManager;

    move-result-object v6

    invoke-virtual {v6, v4}, Lcom/samsung/android/os/SemDvfsManager;->getApproximateFrequency(I)I
    ...
    invoke-static {v5, v6}, Lcom/android/server/connectivity/Tethering;->access$6302(Lcom/android/server/connectivity/Tethering;Lcom/samsung/android/os/SemDvfsManager;)Lcom/samsung/android/os/SemDvfsManager;
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/Tethering;->access$6400(Lcom/android/server/connectivity/Tethering;)Lcom/samsung/android/os/SemDvfsManager;
    ...
    invoke-static {v2, v3}, Lcom/android/server/connectivity/Tethering;->access$6402(Lcom/android/server/connectivity/Tethering;Lcom/samsung/android/os/SemDvfsManager;)Lcom/samsung/android/os/SemDvfsManager;
...
.method private updateUpstreamWanted()Z
    ...
    invoke-static {v1}, Lcom/android/server/connectivity/Tethering;->access$5600(Lcom/android/server/connectivity/Tethering;)Z
    ...
    invoke-static {v1}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$5700(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Lcom/android/server/connectivity/Tethering$TetherMasterSM$OffloadWrapper;
...
.method public enter()V
    ...
    invoke-static {v0}, Lcom/android/server/connectivity/Tethering;->access$5500(Lcom/android/server/connectivity/Tethering;)Lcom/android/server/connectivity/tethering/SimChangeListener;
    ...
    invoke-static {v0}, Lcom/android/server/connectivity/Tethering;->access$5600(Lcom/android/server/connectivity/Tethering;)Z
    ...
    invoke-direct {p0}, Lcom/android/server/connectivity/Tethering$TetherMasterSM$TetherModeAliveState;->setDVFS()V
...
.method public exit()V
    ...
    invoke-static {v0}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$5700(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Lcom/android/server/connectivity/Tethering$TetherMasterSM$OffloadWrapper;
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$5700(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Lcom/android/server/connectivity/Tethering$TetherMasterSM$OffloadWrapper;
    ...
    invoke-static {v1, v2, v3}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$6000(Lcom/android/server/connectivity/Tethering$TetherMasterSM;ILjava/lang/Object;)V
    ...
    invoke-static {v4}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$5900(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Ljava/util/ArrayList;
    ...
    invoke-static {v6}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$5900(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Lcom/android/server/connectivity/Tethering;->access$5800(Lcom/android/server/connectivity/Tethering;)Lcom/android/server/connectivity/tethering/OffloadController;

    move-result-object v3

    invoke-virtual {v3}, Lcom/android/server/connectivity/tethering/OffloadController;->started()Z
