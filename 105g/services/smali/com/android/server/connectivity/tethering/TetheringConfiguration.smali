...
.method public constructor <init>(Landroid/content/Context;Landroid/net/util/SharedLog;)V
    ...
    const-string v4, "ETHERNET_TETHERING_MODE"
    ...
    const-string/jumbo v3, "usb\\d"

    const-string/jumbo v4, "rndis\\d"

    const-string/jumbo v5, "ncm\\d"

    const-string/jumbo v6, "eth\\d"
    ...
    const-string/jumbo v5, "wifi.dualconcurrent.interface"
    ...
    const-string v5, "CscFeature_BT_DisableNAP"
    ...
    const-string v7, "NAP is disabled by Sprint limitation"
    ...
    const-string v6, "NAP is enabled on Sprint"

    invoke-static {v4, v6}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    const-string v4, "bt-pan"
    ...
    const-string v4, "NAP is enabled by CSCfeature"
    ...
    const-string v5, "NAP is disabled by CSCfeature or this model is Wi-Fi-Only model."
    ...
    const-string v4, "DUN check returned: "
    ...
    invoke-static {p1, v3}, Lcom/android/server/connectivity/tethering/TetheringConfiguration;->getResourceStringArray(Landroid/content/Context;I)[Ljava/lang/String;
