...
.field private static final EMULATE_FBE_SUPPORTED:Z = false
...
.method private isSimSdBlock()Z
    ...
    const-string/jumbo v5, "LeoSimSdBlock"
...
.method public addUserKeyAuth(II[B[B)V
    ...
    invoke-interface {v2, p1, p2, v3, v1}, Landroid/os/IVold;->addUserKeyAuth(IILjava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public isFbeSecure(I)Z
    ...
    const-string/jumbo v1, "fbeIsSecure"
    ...
    invoke-interface {v0, p1}, Landroid/os/IVold;->isFbeSecure(I)Z
...
.method public setDebugFlags(II)V
    ...
    invoke-virtual {v4, v1}, Lcom/android/server/StorageManagerService$StorageManagerServiceHandler;->obtainMessage(I)Landroid/os/Message;
    ...
    const-string v1, "Emulation not supported on this device"
...
.method public unlockUserKey(II[B[B)V
    ...
    invoke-virtual {v4, p1}, Lcom/android/internal/widget/LockPatternUtils;->isCredentialRequiredToUnlockUser(I)Z
    ...
    const-string/jumbo v6, "try to unlock multiuser with empty token and secret"
    ...
    invoke-interface {v5, p1, p2, v7, v6}, Landroid/os/IVold;->unlockUserKey(IILjava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v7, "fail to unlock multiuser with empty token and secret"
