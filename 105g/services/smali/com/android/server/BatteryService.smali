...
.field private static final ADAPTIVE_FAST_CHARGING_DISABLE_SYSFS_PATH:Ljava/lang/String;
...
.field private static final CALL_START_DELEY:I = 0x7d0
...
.method static constructor <clinit>()V
    ...
    const-string v1, "SEC_FLOATING_FEATURE_COMMON_SUPPORT_QC_ADAPTIVE_FAST_CHARGING"
    ...
    const-string/jumbo v0, "sys/class/sec/afc/afc_disable"
    ...
    :goto_0
    sput-object v0, Lcom/android/server/BatteryService;->ADAPTIVE_FAST_CHARGING_DISABLE_SYSFS_PATH:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    new-instance v1, Lcom/android/server/BatteryService$ExtraHealthInfo;

    invoke-direct {v1, p0}, Lcom/android/server/BatteryService$ExtraHealthInfo;-><init>(Lcom/android/server/BatteryService;)V

    iput-object v1, p0, Lcom/android/server/BatteryService;->mExtraHealthInfo:Lcom/android/server/BatteryService$ExtraHealthInfo;

    new-instance v1, Lcom/android/server/BatteryService$ExtraHealthInfo;

    invoke-direct {v1, p0}, Lcom/android/server/BatteryService$ExtraHealthInfo;-><init>(Lcom/android/server/BatteryService;)V

    iput-object v1, p0, Lcom/android/server/BatteryService;->mLastExtraHealthInfo:Lcom/android/server/BatteryService$ExtraHealthInfo;
    ...
    iput-boolean v0, p0, Lcom/android/server/BatteryService;->mChargingError:Z
    ...
    iput-object v2, p0, Lcom/android/server/BatteryService;->mWirelessPowerSharingReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v2, p0, Lcom/android/server/BatteryService;->mDexReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v2, p0, Lcom/android/server/BatteryService;->mAudioModeChangeReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-direct {v2, p0}, Lcom/android/server/BatteryService$32;-><init>(Lcom/android/server/BatteryService;)V

    iput-object v2, p0, Lcom/android/server/BatteryService;->mSaveBatteryUsageRunnable:Ljava/lang/Runnable;

    new-instance v2, Lcom/android/server/BatteryService$33;

    invoke-direct {v2, p0}, Lcom/android/server/BatteryService$33;-><init>(Lcom/android/server/BatteryService;)V

    iput-object v2, p0, Lcom/android/server/BatteryService;->mSaveBatteryMaxTempRunnable:Ljava/lang/Runnable;

    new-instance v2, Lcom/android/server/BatteryService$34;

    invoke-direct {v2, p0}, Lcom/android/server/BatteryService$34;-><init>(Lcom/android/server/BatteryService;)V

    iput-object v2, p0, Lcom/android/server/BatteryService;->mSaveBatteryMaxCurrentRunnable:Ljava/lang/Runnable;

    new-instance v2, Lcom/android/server/BatteryService$35;

    invoke-direct {v2, p0}, Lcom/android/server/BatteryService$35;-><init>(Lcom/android/server/BatteryService;)V

    iput-object v2, p0, Lcom/android/server/BatteryService;->mUpdateBatteryAsocRunnable:Ljava/lang/Runnable;

    new-instance v2, Lcom/android/server/BatteryService$36;

    invoke-direct {v2, p0}, Lcom/android/server/BatteryService$36;-><init>(Lcom/android/server/BatteryService;)V

    iput-object v2, p0, Lcom/android/server/BatteryService;->mUpdateBatteryUsageOnDockRunnable:Ljava/lang/Runnable;

    new-instance v2, Lcom/android/server/BatteryService$37;

    invoke-direct {v2, p0}, Lcom/android/server/BatteryService$37;-><init>(Lcom/android/server/BatteryService;)V

    iput-object v2, p0, Lcom/android/server/BatteryService;->mUpdateBatteryUsageExtenderRunnable:Ljava/lang/Runnable;

    iput-object p1, p0, Lcom/android/server/BatteryService;->mContext:Landroid/content/Context;

    new-instance v2, Landroid/os/Handler;

    invoke-direct {v2, v1}, Landroid/os/Handler;-><init>(Z)V
    ...
    iput-object v2, p0, Lcom/android/server/BatteryService;->mLedsHandlerThread:Lcom/android/server/ServiceThread;

    iget-object v0, p0, Lcom/android/server/BatteryService;->mLedsHandlerThread:Lcom/android/server/ServiceThread;

    invoke-virtual {v0}, Lcom/android/server/ServiceThread;->start()V

    new-instance v0, Lcom/android/server/BatteryService$BatteryServiceHandler;
    ...
    invoke-direct {v0, p0, v2}, Lcom/android/server/BatteryService$BatteryServiceHandler;-><init>(Lcom/android/server/BatteryService;Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/android/server/BatteryService;->mLedsHandler:Lcom/android/server/BatteryService$BatteryServiceHandler;
    ...
    new-instance v0, Lcom/android/server/BatteryService$LedSettingsObserver;

    invoke-direct {v0, p0}, Lcom/android/server/BatteryService$LedSettingsObserver;-><init>(Lcom/android/server/BatteryService;)V

    iput-object v0, p0, Lcom/android/server/BatteryService;->mLedSettingsObserver:Lcom/android/server/BatteryService$LedSettingsObserver;

    new-instance v0, Lcom/android/server/BatteryService$AdaptiveFastChargingSettingsObserver;

    invoke-direct {v0, p0}, Lcom/android/server/BatteryService$AdaptiveFastChargingSettingsObserver;-><init>(Lcom/android/server/BatteryService;)V

    iput-object v0, p0, Lcom/android/server/BatteryService;->mAdaptiveFastChargingSettingsObserver:Lcom/android/server/BatteryService$AdaptiveFastChargingSettingsObserver;

    new-instance v0, Lcom/android/server/BatteryService$WirelessFastChargingSettingsObserver;

    invoke-direct {v0, p0}, Lcom/android/server/BatteryService$WirelessFastChargingSettingsObserver;-><init>(Lcom/android/server/BatteryService;)V

    iput-object v0, p0, Lcom/android/server/BatteryService;->mWirelessFastChargingSettingsObserver:Lcom/android/server/BatteryService$WirelessFastChargingSettingsObserver;

    sget-boolean v0, Lcom/android/server/power/PowerManagerUtil;->SEC_FEATURE_BATTERY_LIFE_EXTENDER:Z

    if-eqz v0, :cond_0

    new-instance v0, Lcom/android/server/BatteryService$LifeExtenderSettingsObserver;

    invoke-direct {v0, p0}, Lcom/android/server/BatteryService$LifeExtenderSettingsObserver;-><init>(Lcom/android/server/BatteryService;)V

    iput-object v0, p0, Lcom/android/server/BatteryService;->mLifeExtenderSettingsObserver:Lcom/android/server/BatteryService$LifeExtenderSettingsObserver;
    ...
    iput-object v2, p0, Lcom/android/server/BatteryService;->tm:Landroid/telephony/TelephonyManager;
...
.method static synthetic access$1400(Lcom/android/server/BatteryService;Z)V
    .locals 0
...
.method static synthetic access$1500(Lcom/android/server/BatteryService;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic access$1800(Lcom/android/server/BatteryService;Z)V
    .locals 0
...
.method static synthetic access$2000(Lcom/android/server/BatteryService;)Ljava/lang/Runnable;
    .locals 1
...
.method static synthetic access$3200(Lcom/android/server/BatteryService;)Landroid/app/ActivityManagerInternal;
    .locals 1
...
.method static synthetic access$4500(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V
    .locals 0
...
.method static synthetic access$4700(Lcom/android/server/BatteryService;)Lcom/android/server/BatteryService$ExtraHealthInfo;
    .locals 1
...
.method static synthetic access$4900(Lcom/android/server/BatteryService;)Lcom/android/internal/app/IBatteryStats;
    .locals 1
...
.method static synthetic access$5100(Lcom/android/server/BatteryService;)Ljava/lang/Object;
    .locals 1
...
.method static synthetic access$5214(Lcom/android/server/BatteryService;J)J
    .locals 2
...
.method static synthetic access$5222(Lcom/android/server/BatteryService;J)J
    .locals 2
...
.method static synthetic access$5400(Lcom/android/server/BatteryService;Ljava/lang/String;J)I
    .locals 1
...
.method static synthetic access$5500(Ljava/lang/String;I)V
    .locals 0
...
.method static synthetic access$5602(Lcom/android/server/BatteryService;J)J
    .locals 0
...
.method static synthetic access$6400(Lcom/android/server/BatteryService;)Landroid/hardware/health/V1_0/HealthInfo;
    .locals 1
...
.method static synthetic access$6600(Lcom/android/server/BatteryService;)J
    .locals 2
...
.method static synthetic access$6800(Lcom/android/server/BatteryService;Ljava/lang/String;)J
    .locals 2
...
.method static synthetic access$6900(Lcom/android/server/BatteryService;)J
    .locals 2
...
.method static synthetic access$6902(Lcom/android/server/BatteryService;J)J
    .locals 0
...
.method static synthetic access$6908(Lcom/android/server/BatteryService;)J
    .locals 4
...
.method static synthetic access$7000(Lcom/android/server/BatteryService;)V
    .locals 0
...
.method static synthetic access$7100(Lcom/android/server/BatteryService;)I
    .locals 1
...
.method static synthetic access$7200(Lcom/android/server/BatteryService;)Lcom/android/server/lights/Light;
    .locals 1
...
.method static synthetic access$7300(Lcom/android/server/BatteryService;)Lcom/android/server/BatteryService$BatteryServiceHandler;
    .locals 1
...
.method static synthetic access$7400(Lcom/android/server/BatteryService;Lvendor/samsung/hardware/exthealth/V1_0/ExtHealthInfo;)V
    .locals 0
...
.method static synthetic access$7700(Lcom/android/server/BatteryService;Ljava/io/FileDescriptor;)V
    .locals 0
...
.method static synthetic access$7800(Lcom/android/server/BatteryService;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    .locals 0
...
.method static synthetic access$7900(Lcom/android/server/BatteryService;)Lcom/android/server/BatteryService$HealthServiceWrapper;
    .locals 1
...
.method static synthetic access$8000(Lcom/android/server/BatteryService;I)Z
    .locals 1
...
.method static synthetic access$8100(Lcom/android/server/BatteryService;)I
    .locals 1
...
.method static synthetic access$8200(Lcom/android/server/BatteryService;)Z
    .locals 1
...
.method static synthetic access$8300(Lcom/android/server/BatteryService;)Z
    .locals 1
...
.method private dumpInternal(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {v3}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$4300(Lcom/android/server/BatteryService$ExtraHealthInfo;)Z
    ...
    invoke-static {v3}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3700(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
    ...
    invoke-static {v2}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$4200(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
    ...
    invoke-static {v4}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$4200(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
...
.method private processValuesLocked(Z)V
    ...
    invoke-static {v0}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3400(Lcom/android/server/BatteryService$ExtraHealthInfo;)Z
    ...
    invoke-static {v8}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3700(Lcom/android/server/BatteryService$ExtraHealthInfo;)I

    move-result v21

    iget-object v8, v1, Lcom/android/server/BatteryService;->mExtraHealthInfo:Lcom/android/server/BatteryService$ExtraHealthInfo;

    invoke-static {v8}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3800(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
    ...
    invoke-static {v0}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3900(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
    ...
    invoke-static {v0}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$4000(Lcom/android/server/BatteryService$ExtraHealthInfo;)Z
    ...
    invoke-static {v0}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$4100(Lcom/android/server/BatteryService$ExtraHealthInfo;)I

    move-result v0

    iget v7, v1, Lcom/android/server/BatteryService;->mLastBatteryHighVoltageCharger:I
    ...
    invoke-static {v0}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$4200(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
    ...
    invoke-static {v0}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$4300(Lcom/android/server/BatteryService$ExtraHealthInfo;)Z
    ...
    invoke-direct {v9, v1, v0}, Lcom/android/server/BatteryService$18;-><init>(Lcom/android/server/BatteryService;Landroid/content/Intent;)V
    ...
    invoke-direct {v8, v1, v0}, Lcom/android/server/BatteryService$21;-><init>(Lcom/android/server/BatteryService;Landroid/content/Intent;)V
    ...
    invoke-static {v8}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3000(Lcom/android/server/BatteryService$ExtraHealthInfo;)Z
    ...
    invoke-static {v7}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3500(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
...
.method private registerContentObserver(Landroid/content/ContentResolver;)V
    ...
    sget-object v0, Lcom/android/server/BatteryService;->ADAPTIVE_FAST_CHARGING_DISABLE_SYSFS_PATH:Ljava/lang/String;
...
.method private registerHealthCallback()V
    ...
    invoke-direct {v3, p0}, Lcom/android/server/BatteryService$14;-><init>(Lcom/android/server/BatteryService;)V
...
.method private sendBatteryChangedIntentLocked()V
    ...
    invoke-static {v7}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3000(Lcom/android/server/BatteryService$ExtraHealthInfo;)Z
    ...
    iget v10, p0, Lcom/android/server/BatteryService;->mPogoDockIntent:I
    ...
    invoke-direct {v10, p0, v1}, Lcom/android/server/BatteryService$24;-><init>(Lcom/android/server/BatteryService;Landroid/content/Intent;)V
    ...
    invoke-static {v7, v10}, Lcom/android/server/power/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v10, "BatteryService : SendIntentLocked() - pogo"

    const-wide/16 v11, 0xa

    invoke-virtual {v7, v10, v11, v12}, Lcom/android/server/power/PowerManagerUtil$TimeMeasurement;->printLapTime(Ljava/lang/String;J)V
    ...
    iget-object v10, p0, Lcom/android/server/BatteryService;->mExtraHealthInfo:Lcom/android/server/BatteryService$ExtraHealthInfo;

    invoke-static {v10}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$4100(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
    ...
    iget v10, p0, Lcom/android/server/BatteryService;->mSequence:I
    ...
    iget v10, v10, Landroid/hardware/health/V1_0/HealthInfo;->batteryStatus:I
    ...
    iget v10, v10, Landroid/hardware/health/V1_0/HealthInfo;->batteryHealth:I
    ...
    iget-boolean v10, v10, Landroid/hardware/health/V1_0/HealthInfo;->batteryPresent:Z
    ...
    iget v10, v10, Landroid/hardware/health/V1_0/HealthInfo;->batteryLevel:I

    invoke-virtual {v0, v9, v10}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string v9, "battery_low"

    iget-boolean v10, p0, Lcom/android/server/BatteryService;->mSentLowBatteryBroadcast:Z
    ...
    iget v10, p0, Lcom/android/server/BatteryService;->mPlugType:I
    ...
    iget v10, v10, Landroid/hardware/health/V1_0/HealthInfo;->batteryTemperature:I
    ...
    iget-object v10, v10, Landroid/hardware/health/V1_0/HealthInfo;->batteryTechnology:Ljava/lang/String;

    invoke-virtual {v0, v9, v10}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    const-string/jumbo v9, "invalid_charger"

    iget v10, p0, Lcom/android/server/BatteryService;->mInvalidCharger:I

    invoke-virtual {v0, v9, v10}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string/jumbo v9, "max_charging_current"

    iget-object v10, p0, Lcom/android/server/BatteryService;->mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget v10, v10, Landroid/hardware/health/V1_0/HealthInfo;->maxChargingCurrent:I

    invoke-virtual {v0, v9, v10}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string/jumbo v9, "max_charging_voltage"

    iget-object v10, p0, Lcom/android/server/BatteryService;->mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    iget v10, v10, Landroid/hardware/health/V1_0/HealthInfo;->maxChargingVoltage:I
    ...
    iget v10, v10, Landroid/hardware/health/V1_0/HealthInfo;->batteryChargeCounter:I
    ...
    invoke-static {v10}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3600(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
    ...
    invoke-static {v10}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3900(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
    ...
    invoke-static {v10}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$4000(Lcom/android/server/BatteryService$ExtraHealthInfo;)Z
    ...
    const-string v9, "current_now"

    iget-object v10, p0, Lcom/android/server/BatteryService;->mExtraHealthInfo:Lcom/android/server/BatteryService$ExtraHealthInfo;

    invoke-static {v10}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$4200(Lcom/android/server/BatteryService$ExtraHealthInfo;)I

    move-result v10

    invoke-virtual {v0, v9, v10}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string/jumbo v9, "pogo_plugged"

    invoke-virtual {v0, v9, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string/jumbo v9, "self_discharging"

    iget-object v10, p0, Lcom/android/server/BatteryService;->mExtraHealthInfo:Lcom/android/server/BatteryService$ExtraHealthInfo;

    invoke-static {v10}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$4300(Lcom/android/server/BatteryService$ExtraHealthInfo;)Z

    move-result v10

    invoke-virtual {v0, v9, v10}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string/jumbo v9, "misc_event"

    iget-object v10, p0, Lcom/android/server/BatteryService;->mExtraHealthInfo:Lcom/android/server/BatteryService$ExtraHealthInfo;

    invoke-static {v10}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3500(Lcom/android/server/BatteryService$ExtraHealthInfo;)I

    move-result v10

    invoke-virtual {v0, v9, v10}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    sget-boolean v9, Lcom/android/server/power/PowerManagerUtil$Sales;->CHINA:Z

    if-eqz v9, :cond_7

    const-string v9, "current_event"

    iget-object v10, p0, Lcom/android/server/BatteryService;->mExtraHealthInfo:Lcom/android/server/BatteryService$ExtraHealthInfo;

    invoke-static {v10}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3700(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
    ...
    const-string v13, "Sending ACTION_BATTERY_CHANGED. scale:100, info:"

    invoke-virtual {v10, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v13, p0, Lcom/android/server/BatteryService;->mHealthInfo:Landroid/hardware/health/V1_0/HealthInfo;

    invoke-virtual {v13}, Landroid/hardware/health/V1_0/HealthInfo;->toString()Ljava/lang/String;
    ...
    iget-object v13, p0, Lcom/android/server/BatteryService;->mExtraHealthInfo:Lcom/android/server/BatteryService$ExtraHealthInfo;

    invoke-static {v13}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3600(Lcom/android/server/BatteryService$ExtraHealthInfo;)I

    move-result v13

    invoke-virtual {v10, v13}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v13, ", current avg:"

    invoke-virtual {v10, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v13, p0, Lcom/android/server/BatteryService;->mExtraHealthInfo:Lcom/android/server/BatteryService$ExtraHealthInfo;

    invoke-static {v13}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3100(Lcom/android/server/BatteryService$ExtraHealthInfo;)I

    move-result v13

    invoke-virtual {v10, v13}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v13, ", charge type:"

    invoke-virtual {v10, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v13, p0, Lcom/android/server/BatteryService;->mExtraHealthInfo:Lcom/android/server/BatteryService$ExtraHealthInfo;

    invoke-static {v13}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3900(Lcom/android/server/BatteryService$ExtraHealthInfo;)I

    move-result v13

    invoke-virtual {v10, v13}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v13, ", POGO powered:"

    invoke-virtual {v10, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v13, p0, Lcom/android/server/BatteryService;->mExtraHealthInfo:Lcom/android/server/BatteryService$ExtraHealthInfo;

    invoke-static {v13}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3000(Lcom/android/server/BatteryService$ExtraHealthInfo;)Z

    move-result v13

    invoke-virtual {v10, v13}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v13, ", power sharing:"

    invoke-virtual {v10, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v13, p0, Lcom/android/server/BatteryService;->mExtraHealthInfo:Lcom/android/server/BatteryService$ExtraHealthInfo;

    invoke-static {v13}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$4000(Lcom/android/server/BatteryService$ExtraHealthInfo;)Z

    move-result v13

    invoke-virtual {v10, v13}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v13, ", high voltage charger:"
    ...
    invoke-static {v13}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$4100(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
    ...
    iget v13, p0, Lcom/android/server/BatteryService;->mBatteryCapacity:I

    invoke-virtual {v10, v13}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v13, ", batterySWSelfDischarging:"

    invoke-virtual {v10, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v13, p0, Lcom/android/server/BatteryService;->mExtraHealthInfo:Lcom/android/server/BatteryService$ExtraHealthInfo;

    invoke-static {v13}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$4300(Lcom/android/server/BatteryService$ExtraHealthInfo;)Z
    ...
    invoke-static {v13}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3500(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
    ...
    invoke-static {v13}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3700(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
    ...
    invoke-static {v13}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$4200(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
    ...
    invoke-virtual {v9, v10, v11, v12}, Lcom/android/server/power/PowerManagerUtil$TimeMeasurement;->printLapTime(Ljava/lang/String;J)V
...
.method private sendSecEventIntentLocked()V
    ...
    new-instance v4, Lcom/android/server/BatteryService$25;

    invoke-direct {v4, p0, v0, v1}, Lcom/android/server/BatteryService$25;-><init>(Lcom/android/server/BatteryService;ZLandroid/content/Intent;)V
    ...
    invoke-static {v1}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3500(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
...
.method private sendWirelessPowerSharingIntentLocked()V
    ...
    invoke-static {v0}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3800(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
    ...
    new-instance v6, Lcom/android/server/BatteryService$28;

    invoke-direct {v6, p0, v0, v3}, Lcom/android/server/BatteryService$28;-><init>(Lcom/android/server/BatteryService;ZLandroid/content/Intent;)V
    ...
    invoke-static {v3}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3800(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
    ...
    new-instance v5, Lcom/android/server/BatteryService$29;

    invoke-direct {v5, p0, v1, v2}, Lcom/android/server/BatteryService$29;-><init>(Lcom/android/server/BatteryService;ZLandroid/content/Intent;)V
    ...
    invoke-static {v2}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3800(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
    ...
    invoke-static {v5}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3800(Lcom/android/server/BatteryService$ExtraHealthInfo;)I
    ...
    invoke-direct {v4, p0, v2}, Lcom/android/server/BatteryService$30;-><init>(Lcom/android/server/BatteryService;Landroid/content/Intent;)V
...
.method private shutdownIfOverTempLocked()V
    ...
    invoke-direct {v2, p0}, Lcom/android/server/BatteryService$16;-><init>(Lcom/android/server/BatteryService;)V
...
.method private startCallThread()V
    ...
    iget-object v0, p0, Lcom/android/server/BatteryService;->mCallHandlerThread:Landroid/os/HandlerThread;
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/BatteryService$6;-><init>(Lcom/android/server/BatteryService;Landroid/os/Looper;)V
...
.method private update(Lvendor/samsung/hardware/exthealth/V1_0/ExtHealthInfo;)V
    ...
    invoke-static {v1, p1}, Lcom/android/server/BatteryService$ExtraHealthInfo;->access$3300(Lcom/android/server/BatteryService$ExtraHealthInfo;Lvendor/samsung/hardware/exthealth/V1_0/ExtHealthInfo;)V
...
.method public onBootPhase(I)V
    ...
    invoke-direct {v0, p0, v2}, Lcom/android/server/BatteryService$9;-><init>(Lcom/android/server/BatteryService;Landroid/os/Handler;)V
...
.method setAdaptiveFastCharging(Z)Z
    ...
    sget-object v1, Lcom/android/server/BatteryService;->ADAPTIVE_FAST_CHARGING_DISABLE_SYSFS_PATH:Ljava/lang/String;
