...
.field private static final CHAIN_DOMAIN_FILTER_INPUT:Ljava/lang/String; = "domain_filter-input"

.field private static final CHAIN_DOMAIN_FILTER_INPUT_ALL:Ljava/lang/String; = "domain_input-all"

.field private static final CHAIN_DOMAIN_FILTER_INPUT_UID:Ljava/lang/String; = "domain_input-uid"

.field private static final CHAIN_DOMAIN_FILTER_OUTPUT:Ljava/lang/String; = "domain_filter-output"

.field private static final CHAIN_DOMAIN_FILTER_OUTPUT_ALL:Ljava/lang/String; = "domain_output-all"

.field private static final CHAIN_DOMAIN_FILTER_OUTPUT_UID:Ljava/lang/String; = "domain_output-uid"
...
.method static createAppendDeleteDomainCommands(Lcom/samsung/android/knox/net/firewall/DomainFilterRule;Ljava/lang/String;Lcom/samsung/android/knox/ContextInfo;)Ljava/util/List;
    ...
    :cond_0
    invoke-static {v1, v2}, Lcom/android/server/enterprise/firewall/IptablesCommandBuilder;->getUidForApplication(Ljava/lang/String;I)Ljava/lang/Integer;
    ...
    const-string v6, "Failed to get uid for "
    ...
    invoke-static {v1, v3, v5, v6}, Lcom/android/server/enterprise/firewall/IptablesCommandBuilder;->getDomainFilterChainNameForApp(Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Integer;Z)Ljava/lang/String;
    ...
    const-string v10, "/system/bin/iptables -w "
    ...
    const-string v10, " -m domainfilter --whitelist "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v9, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v10, " -j ACCEPT"
    ...
    sget-boolean v9, Lcom/android/server/enterprise/firewall/Firewall;->mHasIpv6FilterSupport:Z
    ...
    const-string v10, "/system/bin/ip6tables -w "
...
.method private static getAppOrUserUid(Ljava/lang/String;IZ)Ljava/lang/String;
    .locals 5
    ...
    :cond_3
    sget-object v1, Lcom/android/server/enterprise/firewall/IptablesCommandBuilder;->EXEMPT_PACKAGE_LIST:Ljava/util/Map;
    ...
    :cond_4
    invoke-static {p0, p1}, Lcom/android/server/enterprise/firewall/IptablesCommandBuilder;->getUidForApplication(Ljava/lang/String;I)Ljava/lang/Integer;
...
.method private static getAppOrUserUid(Ljava/lang/String;Lcom/samsung/android/knox/ContextInfo;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1}, Lcom/android/server/enterprise/firewall/IptablesCommandBuilder;->getAppOrUserUid(Ljava/lang/String;IZ)Ljava/lang/String;
...
.method static getCreateChainsCommands(Landroid/content/Context;Ljava/lang/Integer;)[Ljava/lang/String;
    ...
    const-string v6, "/system/bin/iptables -w -N domain_filter-input"
    ...
    const-string v6, "/system/bin/iptables -w -N domain_filter-output"
    ...
    const-string v6, "/system/bin/iptables -w  -A INPUT -j domain_filter-input"
    ...
    const-string v6, "/system/bin/iptables -w  -A OUTPUT -j domain_filter-output"
    ...
    const-string v6, "/system/bin/ip6tables -w -N domain_filter-input"
    ...
    const-string v6, "/system/bin/ip6tables -w -N domain_filter-output"
    ...
    const-string v6, "/system/bin/ip6tables -w  -A INPUT -j domain_filter-input"
    ...
    const-string v6, "/system/bin/ip6tables -w  -A OUTPUT -j domain_filter-output"
...
.method static getCreateDomainFilterChainsForUidCommands(Ljava/lang/String;II)Ljava/util/List;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v7, "/system/bin/iptables -w -N "
    ...
    sget-boolean v6, Lcom/android/server/enterprise/firewall/Firewall;->mHasIpv6FilterSupport:Z
    ...
    const-string v7, "/system/bin/ip6tables -w -N "
    ...
    :cond_0
    invoke-static {p0, p2, v3}, Lcom/android/server/enterprise/firewall/IptablesCommandBuilder;->getAppOrUserUid(Ljava/lang/String;IZ)Ljava/lang/String;
...
.method static getCreateDomainFilterExceptionUidRules(I)Ljava/util/List;
    ...
    invoke-static {v3, v4, v5, v6}, Lcom/android/server/enterprise/firewall/IptablesCommandBuilder;->getDomainFilterChainNameForApp(Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Integer;Z)Ljava/lang/String;
    ...
    invoke-static {v4, v5, v6, v7}, Lcom/android/server/enterprise/firewall/IptablesCommandBuilder;->getDomainFilterChainNameForApp(Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Integer;Z)Ljava/lang/String;
    ...
    const-string v6, "/system/bin/iptables -w -I "
    ...
    const-string v6, "/system/bin/ip6tables -w -I "
...
.method static getDomainFilterBaseChainNameForUser(IZ)Ljava/lang/String;
    ...
    const-string/jumbo v2, "domain_filter-input"
    ...
    const-string/jumbo v2, "domain_filter-output"
...
.method static getDomainFilterChainNameForApp(Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Integer;Z)Ljava/lang/String;
    ...
    const-string/jumbo v3, "domain_input-all"
    ...
    const-string/jumbo v3, "domain_output-all"
    ...
    const-string/jumbo v3, "domain_input-uid"
    ...
    const-string/jumbo v3, "domain_output-uid"
...
.method static getDomainFlushBaseChainsCommand(Ljava/lang/Integer;Z)Ljava/util/List;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v4, "/system/bin/iptables -w -F "
    ...
    const-string v4, "/system/bin/iptables -w  -D INPUT -j "
    ...
    const-string v4, "/system/bin/iptables -w  -D OUTPUT -j "
    ...
    const-string v4, "/system/bin/iptables -w  -X "
    ...
    const-string v4, "/system/bin/ip6tables -w -F "
    ...
    const-string v4, "/system/bin/ip6tables -w  -D INPUT -j "
    ...
    const-string v4, "/system/bin/ip6tables -w  -D OUTPUT -j "
    ...
    const-string v4, "/system/bin/ip6tables -w  -X "
...
.method static getRemoveDomainFilterChainsForUidCommands(Ljava/lang/String;II)Ljava/util/List;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v7, p2, v3}, Lcom/android/server/enterprise/firewall/IptablesCommandBuilder;->getAppOrUserUid(Ljava/lang/String;IZ)Ljava/lang/String;
    ...
    const-string v7, "/system/bin/iptables -w -F "
    ...
    const-string v7, "/system/bin/iptables -w -D "
    ...
    const-string v7, "/system/bin/iptables -w -X "
    ...
    const-string v7, "/system/bin/ip6tables -w -F "
    ...
    const-string v7, "/system/bin/ip6tables -w -D "
    ...
    const-string v7, "/system/bin/ip6tables -w -X "
...
.method public static getUidForApplication(Ljava/lang/String;I)Ljava/lang/Integer;
    ...
    :try_start_1
    const-string v5, "FirewallCommandBuilder"
