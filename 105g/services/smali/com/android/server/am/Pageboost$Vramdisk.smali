...
.method private checkMlockLimit()V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/am/Pageboost$Vramdisk;->getMlockEnabled()Z
    ...
    invoke-direct {v0, v1, v2, v14, v15}, Lcom/android/server/am/Pageboost$Vramdisk;->updateMlockLimit(JJ)V
    ...
    invoke-static {v13}, Lcom/android/server/am/Pageboost$BigDataProxy;->updateMlockDisabledInfo(Z)V
    ...
    sget-wide v19, Lcom/android/server/am/Pageboost$Vramdisk;->MAX_QUOTA:J
    ...
    invoke-static {v9}, Lcom/android/server/am/Pageboost$BigDataProxy;->updateMlockDisabledInfo(Z)V
...
# virtual methods
.method public add(Lcom/android/server/am/Pageboost$PageboostAppInfo;ZZ)Z
    .locals 10
    ...
    invoke-virtual {p0}, Lcom/android/server/am/Pageboost$Vramdisk;->getMlockEnabled()Z
    ...
    invoke-static {v5}, Lcom/android/server/am/Pageboost$BigDataProxy;->updateMlockResult(Z)V
    ...
    invoke-static {v2}, Lcom/android/server/am/Pageboost$BigDataProxy;->updateMlockResult(Z)V
...
.method public applyFixedApp(Lcom/android/server/am/Pageboost$PageboostAppInfo;)V
    ...
    :goto_0
    invoke-virtual {p0, p1, v0, v2}, Lcom/android/server/am/Pageboost$Vramdisk;->add(Lcom/android/server/am/Pageboost$PageboostAppInfo;ZZ)Z
...
.method public applyFixedAppList(Ljava/util/LinkedList;)V
    ...
    :goto_1
    invoke-virtual {p0, v2, v3, v5}, Lcom/android/server/am/Pageboost$Vramdisk;->add(Lcom/android/server/am/Pageboost$PageboostAppInfo;ZZ)Z
...
.method public getMlockEnabled()Z
    .locals 4
...
.method public getMlockLimitSize()J
    .locals 2
