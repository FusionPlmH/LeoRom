...
.method getHomeActivityForUser(II)Lcom/android/server/am/ActivityRecord;
    ...
    invoke-virtual {v9, v10, p1}, Lcom/android/server/am/UserController;->isSameProfileGroup(II)Z
...
.method handleNonResizableTaskIfNeeded(Lcom/android/server/am/TaskRecord;IILcom/android/server/am/ActivityStack;Z)V
    ...
    const-string v12, "Dismiss split view"
...
.method moveActivityToPinnedStackLocked(Lcom/android/server/am/ActivityRecord;Landroid/graphics/Rect;FLjava/lang/String;)V
    ...
    invoke-virtual {v9, v1, v11}, Lcom/android/server/am/ActivityStackSupervisor;->moveTasksToFullscreenStackLocked(Lcom/android/server/am/ActivityStack;Z)V
    ...
    invoke-virtual {v0, v2, v3, v12}, Lcom/android/server/am/ActivityDisplay;->getOrCreateStack(IIZ)Lcom/android/server/am/ActivityStack;
    ...
    invoke-virtual {v13}, Lcom/android/server/am/TaskRecord;->getOverrideBounds()Landroid/graphics/Rect;
    ...
    invoke-virtual {v13}, Lcom/android/server/am/TaskRecord;->isSnapWindowTarget()Z
    ...
    invoke-virtual {v1, v11, v2, v3, v4}, Lcom/android/server/am/SnapWindowManager;->setSnapWindowLocked(ZLandroid/graphics/Rect;Ljava/lang/String;Ljava/lang/String;)V

    :cond_1
    iget-object v1, v13, Lcom/android/server/am/TaskRecord;->mActivities:Ljava/util/ArrayList;
    ...
    invoke-virtual/range {v13 .. v20}, Lcom/android/server/am/TaskRecord;->reparent(Lcom/android/server/am/ActivityStack;ZIZZZLjava/lang/String;)Z
    ...
    invoke-virtual {v9, v1}, Lcom/android/server/am/ActivityStackSupervisor;->getNextTaskIdForUserLocked(I)I

    move-result v23

    iget-object v1, v10, Lcom/android/server/am/ActivityRecord;->info:Landroid/content/pm/ActivityInfo;
    ...
    invoke-virtual/range {v22 .. v28}, Lcom/android/server/am/ActivityStack;->createTaskRecord(ILandroid/content/pm/ActivityInfo;Landroid/content/Intent;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;Z)Lcom/android/server/am/TaskRecord;

    move-result-object v1

    const v5, 0x7fffffff

    const-string/jumbo v6, "moveActivityToStack"

    invoke-virtual {v10, v1, v5, v6}, Lcom/android/server/am/ActivityRecord;->reparent(Lcom/android/server/am/TaskRecord;ILjava/lang/String;)V
    ...
    :goto_0
    iput-boolean v11, v10, Lcom/android/server/am/ActivityRecord;->supportsEnterPipOnTaskSwitch:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v0, v4, v1, v3, v12}, Lcom/android/server/am/PinnedActivityStack;->animateResizePinnedStack(Landroid/graphics/Rect;Landroid/graphics/Rect;IZ)V

    invoke-virtual {v9, v2, v11, v11}, Lcom/android/server/am/ActivityStackSupervisor;->ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;IZ)V

    invoke-virtual/range {p0 .. p0}, Lcom/android/server/am/ActivityStackSupervisor;->resumeFocusedStackTopActivityLocked()Z

    iget-object v2, v9, Lcom/android/server/am/ActivityStackSupervisor;->mService:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-virtual {v2, v10}, Lcom/android/server/am/TaskChangeNotificationController;->notifyActivityPinned(Lcom/android/server/am/ActivityRecord;)V
...
.method reportActivityLaunchedLocked(ZLcom/android/server/am/ActivityRecord;JJ)V
    ...
    invoke-static {v1}, Lcom/samsung/android/nextapp/IPkgPredictor$Stub;->asInterface(Landroid/os/IBinder;)Lcom/samsung/android/nextapp/IPkgPredictor;
    ...
    invoke-interface {v1, v2, v3, p3, p4}, Lcom/samsung/android/nextapp/IPkgPredictor;->reportToNAP(Ljava/lang/String;Ljava/lang/String;J)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method restoreRecentTaskLocked(Lcom/android/server/am/TaskRecord;Landroid/app/ActivityOptions;Z)Z
    ...
    invoke-virtual {v2, p1, v4, v3}, Lcom/android/server/am/ActivityStack;->removeTask(Lcom/android/server/am/TaskRecord;Ljava/lang/String;I)V
    ...
    iget-boolean v4, v4, Lcom/android/server/am/FreeformController;->mIsForcedResized:Z

    if-nez v4, :cond_2

    iget v4, p1, Lcom/android/server/am/TaskRecord;->mDexCompatUiMode:I
    ...
    iput v4, p1, Lcom/android/server/am/TaskRecord;->mDexCompatUiMode:I

    invoke-virtual {p1, v0, p2}, Lcom/android/server/am/TaskRecord;->updateDexCompatModeLocked(Landroid/content/pm/ActivityInfo;Landroid/app/ActivityOptions;)V

    :cond_2
    const-string/jumbo v0, "restoreRecentTask"

    invoke-virtual {v1, p1, p3, v0}, Lcom/android/server/am/ActivityStack;->addTask(Lcom/android/server/am/TaskRecord;ZLjava/lang/String;)V

    invoke-virtual {p1, p3, v3}, Lcom/android/server/am/TaskRecord;->createWindowContainer(ZZ)V
...
.method startActivityFromRecents(IIILcom/android/server/am/SafeActivityOptions;)I
    ...
    const-string v5, "Popup view recent task"

    invoke-static {v0, v3, v4, v5}, Lcom/samsung/android/multiwindow/MultiWindowLogger;->insertLogForMW(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_8
    ...
    const-string v6, "Dock an app"

    invoke-static {v3, v4, v6}, Lcom/samsung/android/multiwindow/MultiWindowLogger;->insertLogForMW(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v6, "Select app on bottom"

    const-string v13, "Recents"

    invoke-static {v3, v4, v6, v13}, Lcom/samsung/android/multiwindow/MultiWindowLogger;->insertLogForMW(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget v0, v1, Lcom/android/server/am/TaskRecord;->userId:I
    ...
    const-string v11, "Open app in pop-up view"

    const-string v12, "Popup view recent task"

    invoke-static {v0, v10, v11, v12}, Lcom/samsung/android/multiwindow/MultiWindowLogger;->insertLogForMW(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_e
    ...
    invoke-virtual {v7, v10}, Lcom/android/server/am/ActivityStackSupervisor;->moveHomeStackToFront(Ljava/lang/String;)V

    iget-object v10, v7, Lcom/android/server/am/ActivityStackSupervisor;->mWindowManager:Lcom/android/server/wm/WindowManagerService;
    ...
    iget-object v2, v7, Lcom/android/server/am/ActivityStackSupervisor;->mWindowManager:Lcom/android/server/wm/WindowManagerService;
    ...
    const-string v10, "Dock an app"

    invoke-static {v2, v3, v10}, Lcom/samsung/android/multiwindow/MultiWindowLogger;->insertLogForMW(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v10, "Select app on bottom"

    const-string v11, "Recents"

    invoke-static {v2, v3, v10, v11}, Lcom/samsung/android/multiwindow/MultiWindowLogger;->insertLogForMW(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, v11, v2}, Lcom/samsung/android/multiwindow/MultiWindowLogger;->insertLogForMW(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2, v5}, Lcom/android/server/am/PersonaActivityHelper;->notifyStartActivityFromRecents(II)V
    ...
    invoke-virtual {v4, v3}, Lcom/android/server/am/ActivityDisplay;->getTopStackInWindowingMode(I)Lcom/android/server/am/ActivityStack;
    ...
    invoke-virtual {v7, v9}, Lcom/android/server/am/ActivityStackSupervisor;->moveHomeStackToFront(Ljava/lang/String;)V

    iget-object v9, v7, Lcom/android/server/am/ActivityStackSupervisor;->mWindowManager:Lcom/android/server/wm/WindowManagerService;
    ...
    invoke-static {v2, v4, v9}, Lcom/samsung/android/multiwindow/MultiWindowLogger;->insertLogForMW(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v2, v4, v9, v12}, Lcom/samsung/android/multiwindow/MultiWindowLogger;->insertLogForMW(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
