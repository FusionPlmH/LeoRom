...
.method private positionChildAt(Lcom/android/server/am/ActivityStack;I)V
    ...
    iget-object v6, p0, Lcom/android/server/am/ActivityDisplay;->mStacks:Ljava/util/ArrayList;

    invoke-virtual {v6}, Ljava/util/ArrayList;->size()I

    move-result v6

    invoke-virtual {v4, v5, v3, v0, v6}, Lcom/android/server/wm/DisplayWindowController;->positionChildAt(Lcom/android/server/wm/StackWindowController;IZI)V
...
.method getStacks(II)Ljava/util/ArrayList;
    ...
    :cond_1
    invoke-virtual {v3, p1, p2}, Lcom/android/server/am/ActivityStack;->isCompatible(II)Z
...
.method resolveWindowingMode(Lcom/android/server/am/ActivityRecord;Landroid/app/ActivityOptions;Lcom/android/server/am/TaskRecord;I)I
    ...
    invoke-virtual {v7, v9}, Lcom/android/server/am/ActivityDisplay;->getWindowingMode(I)I
    ...
    iget-object v11, v2, Lcom/android/server/am/ActivityStackSupervisor;->mService:Lcom/android/server/am/ActivityManagerService;

    iget-boolean v2, v11, Lcom/android/server/am/ActivityManagerService;->mSupportsMultiWindow:Z

    iget-boolean v3, v11, Lcom/android/server/am/ActivityManagerService;->mSupportsSplitScreenMultiWindow:Z

    iget-boolean v4, v11, Lcom/android/server/am/ActivityManagerService;->mSupportsFreeformWindowManagement:Z

    iget-boolean v5, v11, Lcom/android/server/am/ActivityManagerService;->mSupportsPictureInPicture:Z
