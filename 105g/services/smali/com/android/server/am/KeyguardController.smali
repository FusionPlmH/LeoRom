...
.field private mRequestedToUpdateRapidVisibility:Z
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ActivityStackSupervisor;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/am/KeyguardController;->mRequestedToUpdateRapidVisibility:Z

    const/4 v1, -0x1

    iput v1, p0, Lcom/android/server/am/KeyguardController;->mSecondaryDisplayShowing:I
...
.method isRequestedToUpdateRapidVisibility()Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/am/KeyguardController;->mRequestedToUpdateRapidVisibility:Z
...
.method keyguardGoingAway(I)V
    ...
    iget-object v4, p0, Lcom/android/server/am/KeyguardController;->mWindowManager:Lcom/android/server/wm/WindowManagerService;
    ...
    invoke-virtual {v4, v5, v3, v6, v3}, Lcom/android/server/wm/WindowManagerService;->prepareAppTransition(IZIZ)V

    invoke-virtual {p0, v0}, Lcom/android/server/am/KeyguardController;->setRequestToUpdateRapidVisibility(Z)V
    ...
    invoke-virtual {v4, v5, v3, v3}, Lcom/android/server/am/ActivityStackSupervisor;->ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;IZ)V
    ...
    invoke-virtual {v4, v0}, Lcom/android/server/am/ActivityStackSupervisor;->addStartingWindowsForVisibleActivities(Z)V
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/am/KeyguardController;->setRequestToUpdateRapidVisibility(Z)V
...
.method setRequestToUpdateRapidVisibility(Z)V
    .locals 3
    ...
    iput-boolean p1, p0, Lcom/android/server/am/KeyguardController;->mRequestedToUpdateRapidVisibility:Z
    ...
    const-string/jumbo v2, "setRequestToUpdateRapidVisibility, mKeyguardGoingAway="
    ...
    const-string v2, ", mRequestedToUpdateRapidVisibility="

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v2, p0, Lcom/android/server/am/KeyguardController;->mRequestedToUpdateRapidVisibility:Z
