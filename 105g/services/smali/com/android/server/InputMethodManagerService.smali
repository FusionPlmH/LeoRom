...
.method private showInputMethodMenu(Z)V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/InputMethodManagerService;->hasNavigationBarGesture()Z
...
.method private updateSystemUiLocked(Landroid/os/IBinder;II)V
    ...
    :goto_3
    iget-object v9, v1, Lcom/android/server/InputMethodManagerService;->mImeSwitcherNotification:Landroid/app/Notification$Builder;
    ...
    iget-object v12, v1, Lcom/android/server/InputMethodManagerService;->mImeSwitchPendingIntent:Landroid/app/PendingIntent;
    ...
    :try_start_4
    iget-object v9, v1, Lcom/android/server/InputMethodManagerService;->mNotificationManager:Landroid/app/NotificationManager;

    if-eqz v9, :cond_8

    iget-object v9, v1, Lcom/android/server/InputMethodManagerService;->mIWindowManager:Landroid/view/IWindowManager;
    ...
    :cond_6
    iget-object v9, v1, Lcom/android/server/InputMethodManagerService;->mNotificationChannel:Landroid/app/NotificationChannel;

    if-nez v9, :cond_7

    new-instance v9, Landroid/app/NotificationChannel;

    sget-object v12, Lcom/android/internal/notification/SystemNotificationChannels;->VIRTUAL_KEYBOARD:Ljava/lang/String;

    invoke-direct {v9, v12, v7, v14}, Landroid/app/NotificationChannel;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;I)V

    iput-object v9, v1, Lcom/android/server/InputMethodManagerService;->mNotificationChannel:Landroid/app/NotificationChannel;
    ...
    const-string v12, "IMMS createNotificationChannel"
    ...
    invoke-virtual {v9, v5, v0, v12, v15}, Landroid/app/NotificationManager;->notifyAsUser(Ljava/lang/String;ILandroid/app/Notification;Landroid/os/UserHandle;)V

    iput-boolean v14, v1, Lcom/android/server/InputMethodManagerService;->mNotificationShown:Z
    :try_end_4
