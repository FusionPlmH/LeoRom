...
.field final mDelaycancelNotificationList:Ljava/util/ArrayList;
    .annotation build Lcom/android/internal/annotations/GuardedBy;
        value = "mNotificationLock"
    .end annotation
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/server/notification/NotificationManagerService;->mDelaycancelNotificationList:Ljava/util/ArrayList;
...
.method private updateNotificationChannelInt(Ljava/lang/String;ILandroid/app/NotificationChannel;Z)V
    ...
    const-string v2, " channel already deleted. no update for "
...
.method buzzBeepBlinkLocked(Lcom/android/server/notification/NotificationRecord;)V
    ...
    invoke-virtual {v0, v5, v1}, Lcom/android/server/notification/NotificationManagerService;->sendAccessibilityEvent(Landroid/app/Notification;Lcom/android/server/notification/NotificationRecord;)V
...
.method cancelNotification(IILjava/lang/String;Ljava/lang/String;IIIZIIIILcom/android/server/notification/ManagedServices$ManagedServiceInfo;)V
    ...
    new-instance v16, Lcom/android/server/notification/NotificationManagerService$18;
    ...
    iget-object v1, v15, Lcom/android/server/notification/NotificationManagerService;->mDelaycancelNotificationList:Ljava/util/ArrayList;
    ...
    iget-object v1, v15, Lcom/android/server/notification/NotificationManagerService;->mHandler:Lcom/android/server/notification/NotificationManagerService$WorkerHandler;

    invoke-virtual {v1, v6}, Lcom/android/server/notification/NotificationManagerService$WorkerHandler;->post(Ljava/lang/Runnable;)Z
    ...
    invoke-virtual {v1, v6, v2, v3}, Lcom/android/server/notification/NotificationManagerService$WorkerHandler;->postDelayed(Ljava/lang/Runnable;J)Z
...
.method enqueueNotificationInternal(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;ILandroid/app/Notification;I)V
    ...
    iget-object v0, v8, Lcom/android/server/notification/NotificationManagerService;->mRankingHelper:Lcom/android/server/notification/RankingHelper;

    invoke-virtual {v0, v15, v5, v3, v4}, Lcom/android/server/notification/RankingHelper;->getNotificationChannel(Ljava/lang/String;ILjava/lang/String;Z)Landroid/app/NotificationChannel;
    ...
    invoke-direct {v1, v10, v9, v2}, Lcom/android/server/notification/NotificationRecord;-><init>(Landroid/content/Context;Landroid/service/notification/StatusBarNotification;Landroid/app/NotificationChannel;)V
    ...
    invoke-virtual {v1, v5, v7}, Lcom/android/server/enterprise/application/ApplicationPolicy;->isStatusBarNotificationAllowedAsUser(Ljava/lang/String;I)Z

    move-result v11

    if-nez v11, :cond_a

    invoke-virtual {v1, v5, v7, v4}, Lcom/android/server/enterprise/application/ApplicationPolicy;->handleStatusBarNotificationNotAllowedAsUser(Ljava/lang/String;ILandroid/app/Notification;)Z
    ...
    invoke-virtual {v1, v5, v3}, Lcom/android/server/notification/RankingHelper;->getIsAppImportanceLocked(Ljava/lang/String;I)Z

    move-result v1

    invoke-virtual {v10, v1}, Lcom/android/server/notification/NotificationRecord;->setIsAppImportanceLocked(Z)V
    ...
    invoke-virtual {v2, v0}, Landroid/app/NotificationChannel;->setFgServiceShown(Z)V

    invoke-virtual {v10, v2}, Lcom/android/server/notification/NotificationRecord;->updateNotificationChannel(Landroid/app/NotificationChannel;)V
    ...
    invoke-virtual {v2, v12}, Landroid/app/NotificationChannel;->unlockFields(I)V
    ...
    invoke-virtual {v12, v5, v13, v2, v15}, Lcom/android/server/notification/RankingHelper;->updateNotificationChannel(Ljava/lang/String;ILandroid/app/NotificationChannel;Z)V
    ...
    invoke-virtual {v10, v14, v12}, Lcom/android/server/notification/NotificationRecord;->setImportance(ILjava/lang/CharSequence;)V
    ...
    invoke-static {}, Lcom/android/server/am/ActivityManagerService;->getAppLaunchFlag()Z

    move-result v0

    if-eqz v0, :cond_18

    iget-object v1, v8, Lcom/android/server/notification/NotificationManagerService;->mNotificationLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_3
    iget-object v0, v8, Lcom/android/server/notification/NotificationManagerService;->mDelaycancelNotificationList:Ljava/util/ArrayList;
    ...
    const-string v3, "This notification is delayed for app launch, notification = "
    ...
    invoke-direct {v1, v8, v15, v10}, Lcom/android/server/notification/NotificationManagerService$EnqueueNotificationRunnable;-><init>(Lcom/android/server/notification/NotificationManagerService;ILcom/android/server/notification/NotificationRecord;)V
...
.method sendAccessibilityEvent(Landroid/app/Notification;Lcom/android/server/notification/NotificationRecord;)V
    .locals 7
    ...
    invoke-virtual {p1}, Landroid/app/Notification;->clone()Landroid/app/Notification;
    ...
    :cond_1
    invoke-virtual {v1, v3}, Landroid/view/accessibility/AccessibilityEvent;->setParcelableData(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v3, v1}, Landroid/view/accessibility/AccessibilityManager;->sendAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
