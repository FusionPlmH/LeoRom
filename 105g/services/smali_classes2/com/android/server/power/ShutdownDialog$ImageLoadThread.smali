...
.method private frameLoadLoop(Lcom/android/server/power/LibQmg;)V
    ...
    invoke-static {v2}, Lcom/android/server/power/ShutdownDialog;->access$1900(Lcom/android/server/power/ShutdownDialog;)I
    ...
    invoke-static {v2}, Lcom/android/server/power/ShutdownDialog;->access$2000(Lcom/android/server/power/ShutdownDialog;)Ljava/lang/Object;
    ...
    invoke-static {v4}, Lcom/android/server/power/ShutdownDialog;->access$1900(Lcom/android/server/power/ShutdownDialog;)I
    ...
    invoke-static {v3, v4}, Lcom/android/server/power/ShutdownDialog;->access$1902(Lcom/android/server/power/ShutdownDialog;I)I

    iget-object v3, p0, Lcom/android/server/power/ShutdownDialog$ImageLoadThread;->this$0:Lcom/android/server/power/ShutdownDialog;

    invoke-static {v3}, Lcom/android/server/power/ShutdownDialog;->access$1900(Lcom/android/server/power/ShutdownDialog;)I
    ...
    invoke-static {v3}, Lcom/android/server/power/ShutdownDialog;->access$2000(Lcom/android/server/power/ShutdownDialog;)Ljava/lang/Object;
...
.method public run()V
    ...
    invoke-static {v4}, Lcom/android/server/power/ShutdownDialog;->access$1600(Lcom/android/server/power/ShutdownDialog;)[Ljava/lang/String;
    ...
    const-string v3, "/media/video/shutdown/"

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v3, p0, Lcom/android/server/power/ShutdownDialog$ImageLoadThread;->this$0:Lcom/android/server/power/ShutdownDialog;

    invoke-static {v3}, Lcom/android/server/power/ShutdownDialog;->access$1600(Lcom/android/server/power/ShutdownDialog;)[Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/android/server/power/ShutdownDialog;->access$1700(Lcom/android/server/power/ShutdownDialog;)Z
    ...
    invoke-static {v3, v0}, Lcom/android/server/power/ShutdownDialog;->access$1800(Lcom/android/server/power/ShutdownDialog;Ljava/lang/String;)Z
    ...
    invoke-virtual {v1, v3}, Lcom/android/server/power/ShutdownDialog$DrawHandler;->sendEmptyMessage(I)Z
