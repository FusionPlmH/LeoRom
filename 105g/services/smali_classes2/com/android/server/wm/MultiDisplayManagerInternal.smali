...
.field private mForcedDisplayAppToken:Lcom/android/server/wm/AppWindowToken;

.field private final mHandler:Lcom/android/server/wm/MultiDisplayManagerInternal$H;

.field private mKeepForcedDisplay:Z
...
.method public constructor <init>(Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput v1, p0, Lcom/android/server/wm/MultiDisplayManagerInternal;->mDefaultBuiltInDisplayId:I
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/MultiDisplayManagerInternal;->mLidOpen:Z

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/server/wm/MultiDisplayManagerInternal;->mForcedDisplayAppToken:Lcom/android/server/wm/AppWindowToken;

    iput-boolean v0, p0, Lcom/android/server/wm/MultiDisplayManagerInternal;->mKeepForcedDisplay:Z
...
.method private synthetic lambda$setDefaultDisplayDevice$1()V
    .locals 0
...
.method public isForcedDefaultDisplay()Z
    ...
    iget v0, p0, Lcom/android/server/wm/MultiDisplayManagerInternal;->mDefaultBuiltInDisplayId:I
...
.method public lidOpened(Z)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/wm/MultiDisplayManagerInternal;->setDefaultDisplayDevice(I)V
...
.method notifySecureWindowAddedLocked(Lcom/android/server/wm/WindowState;)V
    ...
    iget-object v2, p0, Lcom/android/server/wm/MultiDisplayManagerInternal;->mHandler:Lcom/android/server/wm/MultiDisplayManagerInternal$H;
    ...
    invoke-virtual {v2, v3, v4, v5, v1}, Lcom/android/server/wm/MultiDisplayManagerInternal$H;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;

    move-result-object v2

    iget-object v3, p0, Lcom/android/server/wm/MultiDisplayManagerInternal;->mHandler:Lcom/android/server/wm/MultiDisplayManagerInternal$H;

    invoke-virtual {v3, v2}, Lcom/android/server/wm/MultiDisplayManagerInternal$H;->sendMessage(Landroid/os/Message;)Z
    ...
    const-string/jumbo v5, "notifySecureWindowAdded: "
...
.method public registerForcedDisplayAppToken(Landroid/os/IBinder;Z)V
    .locals 5
    ...
    const-string/jumbo v2, "registerForcedDisplayAppToken: token is null"
    ...
    const-string/jumbo v4, "registerForcedDisplayAppToken: appToken is null, token="
    ...
    const-string/jumbo v4, "registerForcedDisplayAppToken: token="
    ...
    const-string/jumbo v4, "registerForcedDisplayAppToken: keep="
    ...
    iput-boolean p2, p0, Lcom/android/server/wm/MultiDisplayManagerInternal;->mKeepForcedDisplay:Z
...
.method public releaseForcedDisplayLocked(Lcom/android/server/wm/AppWindowToken;)V
    .locals 3

    iget-object v0, p0, Lcom/android/server/wm/MultiDisplayManagerInternal;->mForcedDisplayAppToken:Lcom/android/server/wm/AppWindowToken;
    ...
    const-string/jumbo v2, "releaseForcedDisplayLocked: token="

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v2, p0, Lcom/android/server/wm/MultiDisplayManagerInternal;->mForcedDisplayAppToken:Lcom/android/server/wm/AppWindowToken;
    ...
    invoke-virtual {p0}, Lcom/android/server/wm/MultiDisplayManagerInternal;->releaseKeepForcedDisplay()V
    ...
    :goto_0
    invoke-virtual {p0, v0}, Lcom/android/server/wm/MultiDisplayManagerInternal;->setDefaultDisplayDevice(I)V

    :cond_1
    return-void
.end method

.method public releaseKeepForcedDisplay()V
    .locals 2

    const-string v0, "MultiDisplayManagerInternal"

    const-string/jumbo v1, "releaseKeepForcedDisplay: possible to set default display device"
    ...
    iput-object v0, p0, Lcom/android/server/wm/MultiDisplayManagerInternal;->mForcedDisplayAppToken:Lcom/android/server/wm/AppWindowToken;
...
.method public setDefaultDisplayDevice(I)V
    .locals 0
