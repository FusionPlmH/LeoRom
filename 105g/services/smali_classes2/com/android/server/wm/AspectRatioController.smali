...
.field private mIsEmergencyModeEnabled:Z
...
.method public constructor <init>()V
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/AspectRatioController;->mIsEmergencyModeEnabled:Z
...
.method private isFixedOnMode()Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/wm/AspectRatioController;->mIsEmergencyModeEnabled:Z
...
.method private isMaxAspectInner(Landroid/content/pm/ApplicationInfo;)I
    ...
    invoke-direct {p0}, Lcom/android/server/wm/AspectRatioController;->isFixedOnMode()Z
    ...
    iget-boolean v2, p0, Lcom/android/server/wm/AspectRatioController;->mHasDisplayCutout:Z

    if-nez v2, :cond_2

    iget v2, p1, Landroid/content/pm/ApplicationInfo;->privateFlags:I

    invoke-direct {p0, v2}, Lcom/android/server/wm/AspectRatioController;->isResizeableApp(I)Z
    ...
    iget v7, p1, Landroid/content/pm/ApplicationInfo;->targetSdkVersion:I
...
.method onEmergencyModeEnabled(Z)V
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/wm/AspectRatioController;->mIsEmergencyModeEnabled:Z
...
.method public updateMaxAspectRatioIfNeeded(Landroid/content/pm/ActivityInfo;)F
    ...
    invoke-direct {p0, v2, v0}, Lcom/android/server/wm/AspectRatioController;->getMaxAspectRatioSetValue(ILjava/lang/String;)I
    ...
    invoke-direct {p0, v2}, Lcom/android/server/wm/AspectRatioController;->getMaxAspectRatio(Landroid/content/pm/ApplicationInfo;)F
    ...
    invoke-virtual {v3}, Lcom/samsung/android/game/GamePkgData;->getAspectRatio()F
    ...
    :cond_6
    :goto_1
    iget v1, p1, Landroid/content/pm/ActivityInfo;->maxAspectRatio:F
