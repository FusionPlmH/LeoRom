...
.method public computeFrameLw(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Lcom/android/server/wm/utils/WmDisplayCutout;Z)V
    ...
    invoke-static {v2, v11}, Lcom/android/server/wm/WindowManagerService;->dipToPixel(ILandroid/util/DisplayMetrics;)I
    ...
    invoke-static {v1, v11}, Lcom/android/server/wm/WindowManagerService;->dipToPixel(ILandroid/util/DisplayMetrics;)I
    ...
    invoke-virtual {v9, v2, v6, v11, v1}, Landroid/graphics/Rect;->set(IIII)V
    ...
    iget-object v6, v10, Lcom/android/server/wm/WindowState;->mVisibleInsets:Landroid/graphics/Rect;
    ...
    iget-object v6, v6, Lcom/android/server/wm/SamsungWindowManagerService;->mTmpRectForCustomFrame:Landroid/graphics/Rect;

    invoke-virtual {v10, v6}, Lcom/android/server/wm/WindowState;->getCustomAspectRatioFrame(Landroid/graphics/Rect;)V
    ...
    iget-object v8, v10, Lcom/android/server/wm/WindowState;->mConventionalModeBarSizes:Landroid/graphics/Rect;

    invoke-interface {v7, v8, v6}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->computeConventionalModeBarSize(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    iget-object v7, v10, Lcom/android/server/wm/WindowState;->mDecorFrame:Landroid/graphics/Rect;
    ...
    iget-object v7, v10, Lcom/android/server/wm/WindowState;->mConventionalModeBarSizes:Landroid/graphics/Rect;
    ...
    invoke-interface {v7}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->clearConventionalModeBarSize()V
    ...
    invoke-interface {v7}, Lcom/android/server/policy/WindowManagerPolicy;->getNavBarPosition()I
    ...
    iget-object v8, v10, Lcom/android/server/wm/WindowState;->mParentFrame:Landroid/graphics/Rect;
    ...
    invoke-virtual {v3, v6, v8, v9, v2}, Landroid/graphics/Rect;->set(IIII)V
    ...
    :goto_25
    invoke-virtual {v1, v7, v8, v9, v11}, Landroid/graphics/Rect;->set(IIII)V
    ...
    invoke-virtual {v3, v6}, Landroid/graphics/Rect;->inset(Landroid/graphics/Rect;)V

    iget-object v3, v10, Lcom/android/server/wm/WindowState;->mTmpRect:Landroid/graphics/Rect;

    iget-object v6, v10, Lcom/android/server/wm/WindowState;->mStableFrame:Landroid/graphics/Rect;

    invoke-virtual {v3, v6}, Landroid/graphics/Rect;->intersectUnchecked(Landroid/graphics/Rect;)V
    ...
    iget-object v11, v10, Lcom/android/server/wm/WindowState;->mDisplayFrame:Landroid/graphics/Rect;
    ...
    invoke-virtual {v3, v6, v8, v9, v11}, Landroid/graphics/Rect;->set(IIII)V
    ...
    invoke-virtual {v6, v10, v7, v8, v9}, Lcom/android/server/wm/WallpaperController;->updateWallpaperOffset(Lcom/android/server/wm/WindowState;IIZ)Z
    ...
    iget-object v8, v10, Lcom/android/server/wm/WindowState;->mVisibleInsets:Landroid/graphics/Rect;
    ...
    iget-object v8, v10, Lcom/android/server/wm/WindowState;->mStableInsets:Landroid/graphics/Rect;
    ...
    iget-object v8, v10, Lcom/android/server/wm/WindowState;->mOutsets:Landroid/graphics/Rect;
...
.method getTouchableRegion(Landroid/graphics/Region;ILandroid/graphics/Region;)I
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/wm/WindowState;->getCustomAspectRatioFrame(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v5, v6}, Lcom/android/server/wm/MultiDisplayManagerInternal;->getDecorCaptionHeight(I)I
...
.method handleWindowMovedIfNeeded()V
    ...
    invoke-virtual {v7}, Landroid/app/WindowConfiguration;->hasMovementAnimations()Z
    ...
    iget-boolean v7, v7, Lcom/android/server/wm/WindowStateAnimator;->mLastHidden:Z

    if-nez v7, :cond_6

    iget-boolean v7, p0, Lcom/android/server/wm/WindowState;->mSeamlesslyRotated:Z

    if-nez v7, :cond_6

    if-nez v5, :cond_6

    iget-boolean v7, p0, Lcom/android/server/wm/WindowState;->mIsChildWindow:Z
    ...
    invoke-direct {v7}, Lcom/android/server/wm/WindowState;->hasMoved()Z
    ...
    invoke-virtual {v7}, Lcom/android/server/wm/AccessibilityController;->onSomeWindowResizedOrMovedLocked()V

    :cond_7
    :try_start_0
    iget-object v7, p0, Lcom/android/server/wm/WindowState;->mClient:Landroid/view/IWindow;

    invoke-interface {v7, v0, v1}, Landroid/view/IWindow;->moved(II)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
