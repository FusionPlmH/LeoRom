...
.method public constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/DisplayContent;Landroid/graphics/Rect;I)V
    ...
    iget-object v0, v1, Lcom/android/server/wm/MultiWindowFreezeAnimation;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-object v0, v0, Lcom/android/server/wm/WindowManagerService;->mDisplayManagerInternal:Landroid/hardware/display/DisplayManagerInternal;

    invoke-virtual {v0, v14}, Landroid/hardware/display/DisplayManagerInternal;->getDisplayToken(I)Landroid/os/IBinder;
    ...
    :cond_3
    :try_start_2
    invoke-static {v13}, Landroid/view/SurfaceControl;->getBuiltInDisplay(I)Landroid/os/IBinder;
    ...
    iget-object v4, v1, Lcom/android/server/wm/MultiWindowFreezeAnimation;->mSurfaceControl:Landroid/view/SurfaceControl;
    ...
    const-string v4, "Screenshot to screenshotTargetLayer as maxLayer"
    ...
    invoke-virtual {v4, v0}, Landroid/view/Surface;->attachAndQueueBuffer(Landroid/graphics/GraphicBuffer;)V
    ...
    invoke-virtual {v6, v12, v13, v14}, Landroid/view/SurfaceControl$Transaction;->setRelativeLayer(Landroid/view/SurfaceControl;Landroid/view/SurfaceControl;I)Landroid/view/SurfaceControl$Transaction;
    ...
    :try_start_6
    invoke-virtual {v4, v12}, Landroid/view/Surface;->attachAndQueueBuffer(Landroid/graphics/GraphicBuffer;)V

    iget-object v0, v1, Lcom/android/server/wm/MultiWindowFreezeAnimation;->mSurfaceControl:Landroid/view/SurfaceControl;

    const v13, 0x1eab8f

    invoke-virtual {v6, v0, v13}, Landroid/view/SurfaceControl$Transaction;->setLayer(Landroid/view/SurfaceControl;I)Landroid/view/SurfaceControl$Transaction;
    :try_end_6
    ...
    invoke-virtual {v6, v0, v8}, Landroid/view/SurfaceControl$Transaction;->setLayerStack(Landroid/view/SurfaceControl;I)Landroid/view/SurfaceControl$Transaction;
    ...
    invoke-static {v0, v4}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_7
    .catch Landroid/view/Surface$OutOfResourcesException; {:try_start_7 .. :try_end_7} :catch_2
    ...
    :goto_9
    const-string v4, "MultiWindowFreezeAnimation"
    ...
    invoke-direct {v1, v0, v4, v5, v3}, Lcom/android/server/wm/MultiWindowFreezeAnimation;->rotate(IFFLandroid/graphics/Rect;)V

    iget-object v0, v1, Lcom/android/server/wm/MultiWindowFreezeAnimation;->mSurfaceControl:Landroid/view/SurfaceControl;

    invoke-virtual {v6, v0, v3}, Landroid/view/SurfaceControl$Transaction;->setWindowCrop(Landroid/view/SurfaceControl;Landroid/graphics/Rect;)Landroid/view/SurfaceControl$Transaction;

    :cond_b
    iget-object v0, v1, Lcom/android/server/wm/MultiWindowFreezeAnimation;->mSurfaceControl:Landroid/view/SurfaceControl;

    invoke-direct {v1, v6, v0}, Lcom/android/server/wm/MultiWindowFreezeAnimation;->setRotationTransformation(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;)V
