...
.method public checkNotchSideAlignment(Landroid/graphics/Rect;)V
    .locals 3
    ...
    invoke-virtual {v1}, Lcom/android/server/wm/Task;->isNotchSideAligned()Z
    ...
    invoke-virtual {v2}, Lcom/android/server/wm/WindowManagerService;->getSideScreenInternal()Lcom/android/server/wm/SideScreenManagerInternal;

    move-result-object v2

    invoke-virtual {v2, p1}, Lcom/android/server/wm/SideScreenManagerInternal;->getNotchSideAlignedBounds(Landroid/graphics/Rect;)I

    move-result v2

    iput v2, v1, Lcom/android/server/wm/Task;->mNotchSideAlignmentMode:I
