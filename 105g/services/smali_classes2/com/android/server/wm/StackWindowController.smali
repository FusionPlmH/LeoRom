...
.method public adjustConfigurationForBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;ZZFLandroid/content/res/Configuration;Landroid/content/res/Configuration;I)V
    ...
    iget-object v2, v8, Lcom/android/server/wm/StackWindowController;->mTmpStableInsets:Landroid/graphics/Rect;

    invoke-virtual {v12, v2}, Landroid/graphics/Rect;->inset(Landroid/graphics/Rect;)V

    iget-object v2, v8, Lcom/android/server/wm/StackWindowController;->mTmpNonDecorInsets:Landroid/graphics/Rect;

    invoke-virtual {v11, v2}, Landroid/graphics/Rect;->inset(Landroid/graphics/Rect;)V

    iget-object v2, v14, Landroid/content/res/Configuration;->windowConfiguration:Landroid/app/WindowConfiguration;

    invoke-virtual {v2, v10}, Landroid/app/WindowConfiguration;->setBounds(Landroid/graphics/Rect;)V

    iget-object v2, v14, Landroid/content/res/Configuration;->windowConfiguration:Landroid/app/WindowConfiguration;

    invoke-virtual {v2, v10}, Landroid/app/WindowConfiguration;->setAppBounds(Landroid/graphics/Rect;)V

    :cond_3
    iget v2, v14, Landroid/content/res/Configuration;->dexCompatEnabled:I
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/wm/MultiDisplayManagerInternal;->getDecorCaptionHeight(I)I

    move-result v2

    const/4 v5, 0x0

    invoke-virtual {v9, v5, v2, v5, v5}, Landroid/graphics/Rect;->inset(IIII)V

    invoke-virtual {v12, v5, v2, v5, v5}, Landroid/graphics/Rect;->inset(IIII)V

    invoke-virtual {v11, v5, v2, v5, v5}, Landroid/graphics/Rect;->inset(IIII)V

    iget-object v5, v14, Landroid/content/res/Configuration;->windowConfiguration:Landroid/app/WindowConfiguration;
    ...
    invoke-virtual {v5, v10, v2, v10, v10}, Landroid/graphics/Rect;->inset(IIII)V
