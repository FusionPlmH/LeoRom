...
.annotation system Ldalvik/annotation/MemberClasses;
	...
	Lcom/android/server/policy/PhoneWindowManager$LeoObserver;,
        Lcom/android/server/policy/PhoneWindowManager$SkipTracks;,
        Lcom/android/server/policy/PhoneWindowManager$ActionReceiver;
    }
.end annotation
...
.field private mLeoObserver:Lcom/android/server/policy/PhoneWindowManager$LeoObserver;

.field private mSkipTracks:Lcom/android/server/policy/PhoneWindowManager$SkipTracks;
...
.method private getNavigationBarWidth(II)I
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/PhoneWindowManager;->mLeoNavBarHeightLandscape:Z

    if-eqz v0, :cond_0

    iget v0, p0, Lcom/android/server/policy/PhoneWindowManager;->mLeoNavBarLandscape:I
...
.method private hasMultiDisplayPolicy(IZ)Z
    .locals 3
    ...
    invoke-virtual {v0}, Lcom/android/server/policy/MultiDisplayPolicyManager$DisplayPolicy;->isDisplayEnabled()Z
...
.method public static synthetic lambda$new$3(Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    invoke-virtual {v1}, Lcom/android/server/policy/MultiDisplayPolicyManager;->getDexModeTi()I
    ...
    invoke-virtual {v1, v2, v0}, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;->bindDexService(Landroid/content/Context;I)V
...
.method private powerLongPress()V
    ...
    :cond_3
     invoke-virtual {p0}, Lcom/android/server/policy/PhoneWindowManager;->setLeoLongPressOnPowerAction()V
...
.method private powerPress(Landroid/view/KeyEvent;ZI)V
    ...
    invoke-direct {p0, v0, v1, p2, v2}, Lcom/android/server/policy/PhoneWindowManager;->setLeoPowerDoubleAction(JZI)V
...
.method public beginDefaultDisplayLayoutLw(Lcom/android/server/wm/DisplayFrames;I)V
    ...
    invoke-interface {v3, v4, v5, v6, v2}, Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;->createInputConsumer(Landroid/os/Looper;Ljava/lang/String;Landroid/view/InputEventReceiver$Factory;I)Lcom/android/server/policy/WindowManagerPolicy$InputConsumer;
    ...
    :cond_b
    :goto_9
    iget-object v2, v15, Lcom/android/server/policy/PhoneWindowManager;->mInputConsumer:Lcom/android/server/policy/WindowManagerPolicy$InputConsumer;
    ...
    iput-object v2, v15, Lcom/android/server/policy/PhoneWindowManager;->mInputConsumer:Lcom/android/server/policy/WindowManagerPolicy$InputConsumer;
...
.method public finishPostLayoutPolicyLw()I
    ...
    :cond_8
    iget-object v8, p0, Lcom/android/server/policy/PhoneWindowManager;->mSamsungPolicy:Lcom/android/server/policy/SamsungPhoneWindowManager;

    iget-boolean v8, v8, Lcom/android/server/policy/SamsungPhoneWindowManager;->mForceStatusBarFromSViewCover:Z
    ...
    const-string v9, "Showing status bar: forced svc"
    ...
    const-string v8, "** HIDING status bar : Dex (stand-alone)"
    ...
    iget-object v8, p0, Lcom/android/server/policy/PhoneWindowManager;->mMultiWindowPolicy:Lcom/android/server/policy/MultiPhoneWindowManager;

    invoke-virtual {v8}, Lcom/android/server/policy/MultiPhoneWindowManager;->isMinimizedDock()Z

    move-result v8

    if-eqz v8, :cond_10

    iget-object v8, p0, Lcom/android/server/policy/PhoneWindowManager;->mSystemGestures:Lcom/android/server/policy/SystemGesturesPointerEventListener;

    iget v8, v8, Lcom/android/server/policy/SystemGesturesPointerEventListener;->screenWidth:I
    ...
    iget v9, v9, Lcom/android/server/policy/SystemGesturesPointerEventListener;->screenHeight:I
...
.method public getConfigDisplayHeight(IIIIILandroid/view/DisplayCutout;)I
    ...
    invoke-direct {p0, p5, v0}, Lcom/android/server/policy/PhoneWindowManager;->hasMultiDisplayPolicy(IZ)Z
...
.method public getNavigationBarHeight(II)I
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/PhoneWindowManager;->mLeoNavBarHeightPortrait:Z

    if-eqz v0, :cond_0

    iget v0, p0, Lcom/android/server/policy/PhoneWindowManager;->mLeoNavBarPortrait:I
...
.method public hadHandledStartTransition()Z
    .locals 1
...
.method hasMultiDisplayPolicy(I)Z
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/policy/PhoneWindowManager;->hasMultiDisplayPolicy(IZ)Z
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    invoke-direct {v4, v5, v1}, Lcom/android/server/policy/ImmersiveModeConfirmation;-><init>(Landroid/content/Context;Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    invoke-direct {v0}, Lcom/android/server/policy/PhoneWindowManager;->setLeoWindowManager()V
    return-void
.end method
...
.method public interceptKeyBeforeDispatching(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    invoke-virtual {v1, v8}, Lcom/android/server/policy/PhoneWindowManager;->LongPressOnHome(I)V
    ...
    :try_start_0
    invoke-interface {v10, v14}, Lcom/android/internal/statusbar/IStatusBarService;->expandNotificationsPanelToType(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v1, v13}, Lcom/android/server/policy/PhoneWindowManager;->handleLongPressOnRecent(I)V
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;I)I
    ...
    :cond_0
	#### PAY ATTENTION HERE!!! Just before the first return you find in this method add the next line
	
	:goto_exit ### add this line, and now go to about the end of the method to look for where keys 0x18 and 0x19 are proceessed. Look for it in the sswtich and pswitch
    ...
    :pswitch_0
    :sswitch_4
  	##### Once we now what v numbers we can use (v0 and v3) (you could do this in other ways, this is a general explanation to avoid verify errors in runtime) add this block of code !!!
	...
	iget-boolean v0, v0, Lcom/android/server/policy/PhoneWindowManager;->mSkipTrackEnabled:Z	
	
	if-eqz v0, :cond_goon
	
	move-object/from16 v0, p0
	
	iget-object v0, v0, Lcom/android/server/policy/PhoneWindowManager;->mSkipTracks:Lcom/android/server/policy/PhoneWindowManager$SkipTracks;	
	
	move-object/from16 v3, p1
	
	invoke-virtual {v0, v3}, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->shouldKeyBeStopped(Landroid/view/KeyEvent;)Z
    ...
    iget-object v3, v1, Lcom/android/server/policy/PhoneWindowManager;->mSamsungPolicy:Lcom/android/server/policy/SamsungPhoneWindowManager;

    iget-boolean v3, v3, Lcom/android/server/policy/SamsungPhoneWindowManager;->mIsSupportDoubleTapToWakeUp:Z

    if-eqz v3, :cond_40

    iget-object v3, v1, Lcom/android/server/policy/PhoneWindowManager;->mSamsungPolicy:Lcom/android/server/policy/SamsungPhoneWindowManager;

    iget-boolean v3, v3, Lcom/android/server/policy/SamsungPhoneWindowManager;->mIsDoubleTapToWakeUp:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/policy/PhoneWindowManager;->mAllowTheaterModeWakeFromKey:Z

    invoke-virtual {v1, v3, v4, v5, v0}, Lcom/android/server/policy/PhoneWindowManager;->wakeUp(JZI)Z
...
.method public isInDexOnPc()Z
    ...
    invoke-virtual {v0}, Lcom/android/server/policy/SamsungPhoneWindowManager;->isInDexOnPc()Z
...
.method public layoutWindowLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/wm/DisplayFrames;)V
    ...
    invoke-direct {v12, v1, v11}, Lcom/android/server/policy/PhoneWindowManager;->hasMultiDisplayPolicy(IZ)Z
    ...
    :cond_7
    iget v7, v9, Landroid/view/WindowManager$LayoutParams;->type:I

    invoke-static {v13, v9}, Lcom/android/server/policy/PolicyControl;->getWindowFlags(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;)I

    move-result v6

    iget v5, v9, Landroid/view/WindowManager$LayoutParams;->privateFlags:I

    iget v4, v9, Landroid/view/WindowManager$LayoutParams;->softInputMode:I

    invoke-static {v13, v9}, Lcom/android/server/policy/PolicyControl;->getSystemUiVisibility(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;)I

    move-result v18

    invoke-direct {v12, v9}, Lcom/android/server/policy/PhoneWindowManager;->getImpliedSysUiFlagsForLayout(Landroid/view/WindowManager$LayoutParams;)I
    ...
    sget-object v8, Lcom/android/server/policy/PhoneWindowManager;->mTmpVisibleFrame:Landroid/graphics/Rect;

    sget-object v14, Lcom/android/server/policy/PhoneWindowManager;->mTmpDecorFrame:Landroid/graphics/Rect;

    move-object/from16 v22, v10

    sget-object v10, Lcom/android/server/policy/PhoneWindowManager;->mTmpStableFrame:Landroid/graphics/Rect;
    ...
    invoke-virtual {v9, v0}, Landroid/view/WindowManager$LayoutParams;->isFullscreen(Z)Z
    ...
    iget v1, v10, Landroid/view/WindowManager$LayoutParams;->samsungFlags:I
    ...
    :cond_31
    :goto_1a
    invoke-direct {v12, v5, v9, v3, v15}, Lcom/android/server/policy/PhoneWindowManager;->applyStableConstraints(IILandroid/graphics/Rect;Lcom/android/server/wm/DisplayFrames;)V
    ...
    const-string v14, "layoutWindowLw("
    ...
    invoke-direct {v12, v11, v13, v10, v15}, Lcom/android/server/policy/PhoneWindowManager;->applyStableConstraints(IILandroid/graphics/Rect;Lcom/android/server/wm/DisplayFrames;)V
    ...
    :cond_53
    invoke-virtual {v14, v10}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V
    ...
    iget v3, v5, Landroid/view/WindowManager$LayoutParams;->layoutInDisplayCutoutMode:I
    ...
    iget-object v5, v15, Lcom/android/server/wm/DisplayFrames;->mDisplayCutoutSafe:Landroid/graphics/Rect;
    ...
    iget v5, v12, Lcom/android/server/policy/PhoneWindowManager;->mNavigationBarPosition:I
    ...
    invoke-virtual {v6, v2}, Landroid/graphics/Rect;->intersectUnchecked(Landroid/graphics/Rect;)V
    ...
    invoke-interface/range {p1 .. p1}, Lcom/android/server/policy/WindowManagerPolicy$WindowState;->isDexCompatModeLw()Z

    move-result v0

    if-eqz v0, :cond_62

    invoke-interface/range {p1 .. p1}, Lcom/android/server/policy/WindowManagerPolicy$WindowState;->isFullscreenFreeformLw()Z
    ...
    iget-object v0, v0, Lcom/android/server/policy/MultiDisplayPolicyManager;->mMultiDisplayInternal:Lcom/android/server/policy/IMultiDisplayPolicy$MultiDisplayManagerInternalFuncs;

    iget v1, v15, Lcom/android/server/wm/DisplayFrames;->mDisplayId:I

    invoke-interface {v0, v1}, Lcom/android/server/policy/IMultiDisplayPolicy$MultiDisplayManagerInternalFuncs;->getDecorCaptionHeight(I)I
    ...
    :goto_37
    invoke-direct {v12, v6, v13}, Lcom/android/server/policy/PhoneWindowManager;->shouldUseOutsets(Landroid/view/WindowManager$LayoutParams;I)Z
    ...
    const-string v12, "applying bottom outset of "

    invoke-virtual {v4, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v4, v1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v12, " with rotation "
    ...
    iget-object v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mFocusedWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    if-eqz v2, :cond_70

    iget-object v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mFocusedWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    invoke-interface {v2}, Lcom/android/server/policy/WindowManagerPolicy$WindowState;->getWindowingMode()I
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/policy/PhoneWindowManager;->setLastInputMethodWindowLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/policy/WindowManagerPolicy$WindowState;)V

    move-object/from16 v2, p1

    invoke-direct {v1, v2, v15}, Lcom/android/server/policy/PhoneWindowManager;->offsetInputMethodWindowLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/wm/DisplayFrames;)V
    ...
    invoke-direct {v1, v2, v15}, Lcom/android/server/policy/PhoneWindowManager;->offsetVoiceInputWindowLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/wm/DisplayFrames;)V
...
.method public screenTurnedOff()V
    ...
    invoke-direct {p0, v1, v0}, Lcom/android/server/policy/PhoneWindowManager;->hasMultiDisplayPolicy(IZ)Z
...
.method public setInitialDefaultDisplaySize(Landroid/view/Display;III)V
    ...
    :goto_0
    mul-int/lit16 v1, v6, 0xa0

    div-int/2addr v1, p4

    mul-int/lit16 v2, v7, 0xa0
    ...
    iput v3, p0, Lcom/android/server/policy/PhoneWindowManager;->mDemoHdmiRotation:I
    ...
    :goto_1
    const-string/jumbo v3, "persist.demo.hdmirotationlock"

    invoke-static {v3, v4}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v3

    iput-boolean v3, p0, Lcom/android/server/policy/PhoneWindowManager;->mDemoHdmiRotationLock:Z
    ...
    iput v3, p0, Lcom/android/server/policy/PhoneWindowManager;->mDemoRotation:I
    ...
    :goto_2
    const-string/jumbo v3, "persist.demo.rotationlock"

    invoke-static {v3, v4}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v3

    iput-boolean v3, p0, Lcom/android/server/policy/PhoneWindowManager;->mDemoRotationLock:Z
    ...
    :cond_8
    iput-boolean v4, p0, Lcom/android/server/policy/PhoneWindowManager;->mForceDefaultOrientation:Z
...
.method showGlobalActionsInternal()V
    ...
    sget-boolean v1, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLeoGlobalEnablePowerGlobalActionsStyle:Z

    invoke-static {}, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->getSafetyVersion()Ljava/lang/String;

    move-result-object v2

    sget-object v3, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->SecurityCode:Ljava/lang/String;
    ...
    sget-boolean v2, Lcom/fusionleo/LeoX/server/LeoConfig;->EnablePowerGlobalService:Z
    ...
    sget v3, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLeoGlobalPowerGlobalActionsStyle:I

    invoke-static {v2, v3}, Lcom/fusionleo/LeoX/server/LeoConfig;->PowerMenuService(Landroid/content/Context;I)V
...
.method private setLeoWindowManager()V
    ...
    new-instance v0, Lcom/android/server/policy/PhoneWindowManager$ActionReceiver;

    const/4 v1, 0x0

    invoke-direct {v0, p0, p0, v1}, Lcom/android/server/policy/PhoneWindowManager$ActionReceiver;-><init>(Lcom/android/server/policy/PhoneWindowManager;Lcom/android/server/policy/PhoneWindowManager;Lcom/android/server/policy/PhoneWindowManager$ActionReceiver;)V

    new-instance v1, Landroid/content/IntentFilter;

    invoke-direct {v1}, Landroid/content/IntentFilter;-><init>()V

    sget-object v2, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->mLeoGlobalService:Ljava/lang/String;
    ...
    new-instance v2, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;

    iget-object v3, p0, Lcom/android/server/policy/PhoneWindowManager;->mContext:Landroid/content/Context;

    invoke-direct {v2, p0, v3}, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;-><init>(Lcom/android/server/policy/PhoneWindowManager;Landroid/content/Context;)V

    iput-object v2, p0, Lcom/android/server/policy/PhoneWindowManager;->mSkipTracks:Lcom/android/server/policy/PhoneWindowManager$SkipTracks;

    new-instance v2, Lcom/android/server/policy/PhoneWindowManager$LeoObserver;

    new-instance v3, Landroid/os/Handler;

    invoke-direct {v3}, Landroid/os/Handler;-><init>()V

    invoke-direct {v2, p0, v3}, Lcom/android/server/policy/PhoneWindowManager$LeoObserver;-><init>(Lcom/android/server/policy/PhoneWindowManager;Landroid/os/Handler;)V

    iput-object v2, p0, Lcom/android/server/policy/PhoneWindowManager;->mLeoObserver:Lcom/android/server/policy/PhoneWindowManager$LeoObserver;

    iget-object v2, p0, Lcom/android/server/policy/PhoneWindowManager;->mLeoObserver:Lcom/android/server/policy/PhoneWindowManager$LeoObserver;

    invoke-virtual {v2}, Lcom/android/server/policy/PhoneWindowManager$LeoObserver;->observe()V

    invoke-virtual {p0}, Lcom/android/server/policy/PhoneWindowManager;->updateLeoPhoneWindow()V

    return-void
.end method

.method public updateLeoPhoneWindow()V
    .locals 2
    ...
    sget-object v1, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->SecurityCode:Ljava/lang/String;
    ...
    sget-boolean v0, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setGlobalAmberLeoNavBarHeightLandscape:Z

    iput-boolean v0, p0, Lcom/android/server/policy/PhoneWindowManager;->mLeoNavBarHeightLandscape:Z

    sget-boolean v0, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setGlobalAmberLeoNavBarHeightPortrait:Z

    iput-boolean v0, p0, Lcom/android/server/policy/PhoneWindowManager;->mLeoNavBarHeightPortrait:Z

    sget v0, Lcom/fusionleo/LeoX/server/LeoConfig;->mNavBar:F

    sget v1, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setGlobalAmberLeoLandscapeNavBarHeight:I
    ...
    sget v1, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setGlobalAmberLeoPortraitNavBarHeight:I
...
.method public launchBixbyHome()V
    ...
    const-string v0, "com.samsung.android.app.spage/com.samsung.android.app.spage.service.SpageService"
    ...
    const-string/jumbo v2, "from_bixby_agent_button"

    const/4 v3, 0x1

    invoke-virtual {v1, v2, v3}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string/jumbo v2, "from_bixby_agent"
...
.method public setLeoNavKeypressAction(Ljava/lang/String;I)V
    .locals 1
...
.method public setLeoBixbyClickAction()I
    ...
    sget v1, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLeoGlobalBixbyClickKeyguardAction:I
    ...
    sget v1, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLeoGlobalBixbyClickAction:I
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, v0, v1}, Lcom/android/server/policy/PhoneWindowManager;->setLeoNavKeypressAction(Ljava/lang/String;I)V
...
.method public setLeoBixbyCustomAction()I
    ...
    sget v1, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLeoGlobalBixbyEnableAction:I
...
.method public setLeoBixbyLongPressAction()I
    ...
    sget v2, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLeoGlobalBixbyLongPressKeyguardAction:I
    ...
    :cond_0
    sget-object v1, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setBixbyLongAction:Ljava/lang/String;

    sget v2, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLeoGlobalBixbyLongPressAction:I
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, v1, v2}, Lcom/android/server/policy/PhoneWindowManager;->setLeoNavKeypressAction(Ljava/lang/String;I)V
...
.method public setLeoLongPressOnPowerAction()V
    ...
    sget-boolean v0, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLeoGlobalPowerEnableAction:Z
    ...
    sget v1, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLeoGlobalPowerLongPressKeyguardAction:I
    ...
    :cond_0
    sget-object v0, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setPowerLongPressAction:Ljava/lang/String;

    sget v1, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLeoGlobalPowerLongPressAction:I
...
.method private setLeoPowerDoubleAction(JZI)V
    ...
    sget v1, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLeoGlobalPowerDoubleKeyguardAction:I
    ...
    :cond_0
    sget-object v0, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setPowerDoubleAction:Ljava/lang/String;

    sget v1, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLeoGlobalPowerDoubleAction:I
...
.method public handleLongPressOnRecent(I)V
    ...
    sget-boolean v1, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLeoGlobalHwKeysEnableAction:Z

    if-eqz v1, :cond_0

    sget-object v1, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLongPressOnRecentAction:Ljava/lang/String;

    sget v2, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLeoGlobalLongPressOnRecentAction:I

    invoke-virtual {p0, v1, v2}, Lcom/android/server/policy/PhoneWindowManager;->setLeoNavKeypressAction(Ljava/lang/String;I)V

    sget v3, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLeowGlobalHwKyesVibratorEnable:I

    sget v4, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLeoGlobalHwKyesVibratorLevel:I

    invoke-virtual {p0, v0, v3, v4}, Lcom/android/server/policy/PhoneWindowManager;->intVibrator(Landroid/content/Context;II)V
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/policy/SamsungPhoneWindowManager;->handleLongPressOnRecent(I)V
...
.method LongPressOnHome(I)V
    ...
    sget-object v1, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLongPressOnHomeAction:Ljava/lang/String;

    sget v2, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLeoGlobalLongPressOnHomeAction:I
...
.method private backLongPress()V
    ...
    sget-object v1, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLongPressOnBackAction:Ljava/lang/String;

    sget v2, Lcom/fusionleo/LeoProvider/LeoGlobalSetting;->setLeoGlobalLongPressOnBackAction:I
