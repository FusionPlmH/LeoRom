...
.field private static final BIXBY_INTERACTIVE:Ljava/lang/String; = "INTERACTIVE"
...
.field private static final SETTING_DEX_ON_PC_STATE_DISABLED:I = 0x0

.field private static final SETTING_DEX_ON_PC_STATE_ENABLED:I = 0x3
...
.field private mBixLongPressed:Z
...
.field mIsSupportDoubleTapToWakeUp:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/policy/WindowManagerPolicy;Lcom/android/server/policy/SamsungWindowManagerPolicy$SamsungWindowManagerFuncs;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mEmergencyModeEnabled:Z

    iput-boolean v0, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mRequestedToApplyAodPolicy:Z

    iput v0, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mDexOnPcState:I
    ...
    iput-boolean v0, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mIsDoubleTapToWakeUp:Z

    iput-boolean v0, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mIsSupportDoubleTapToWakeUp:Z
...
.method private isSupportCoverApp()Z
    .locals 2
...
.method private startBixbyService(Landroid/view/KeyEvent;ZZ)V
    .locals 5
...
.method private startCustomApp()Z
    ...
    const-string/jumbo v2, "mKnoxCustomSystemManager null"
...
.method public applyPostLayoutPolicyLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;)V
    ...
    :cond_c
    invoke-direct {p0}, Lcom/android/server/policy/SamsungPhoneWindowManager;->isSupportCoverApp()Z
...
.method public dump(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mEmergencyModeEnabled:Z

    if-eqz v0, :cond_6

    invoke-virtual {p2, p1}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    const-string v0, "mEmergencyModeEnabled="
    ...
    const-string v0, "mIsSupportDoubleTapToWakeUp="

    invoke-virtual {p2, v0}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-boolean v0, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mIsSupportDoubleTapToWakeUp:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mIsDoubleTapToWakeUp:Z
...
.method public init()V
    ...
    const-string v3, "com.sec.feature.findo"
    ...
    invoke-direct {v0, p0, v3}, Lcom/android/server/policy/SamsungPhoneWindowManager$SFinderLaunchPolicy;-><init>(Lcom/android/server/policy/SamsungPhoneWindowManager;Lcom/android/server/policy/SamsungPhoneWindowManager$1;)V
    ...
    :cond_c
    iput-boolean v1, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mIsSupportDoubleTapToWakeUp:Z
...
move-object/from16 v0, p0
    ...
    invoke-virtual {v0}, Lcom/android/server/policy/PhoneWindowManager;->setLeoBixbyCustomAction()I

    move-result v0

    if-eqz v0, :cond_14leo
    ...
    :goto_4leo
    if-eqz v0, :cond_11leo

    if-nez v5, :cond_10leo

    const/4 v6, 0x0

    move-object/from16 v0, p0

    iput-boolean v6, v0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mBixLongPressed:Z
    ...
    invoke-virtual {v0}, Lcom/android/server/policy/PhoneWindowManager;->setLeoBixbyLongPressAction()I
    ...
    iget-boolean v0, v0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mBixLongPressed:Z

    if-eqz v0, :cond_12leo
    ...
    if-nez v0, :cond_13leo

    move-object/from16 v0, p0

    iget-object v6, v0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mPolicy:Lcom/android/server/policy/PhoneWindowManager;

    invoke-virtual {v6}, Lcom/android/server/policy/PhoneWindowManager;->setLeoBixbyClickAction()I
    ...
    :cond_13
    invoke-direct {v1, v3, v8, v10}, Lcom/android/server/policy/SamsungPhoneWindowManager;->startBixbyService(Landroid/view/KeyEvent;ZZ)V
    ...
    :cond_4a
    :goto_16
    sget-boolean v0, Lcom/samsung/android/rune/CoreRune;->MD_DEX_USAGE_LOGGING:Z
    ...
    const-string v8, "Maximize_popup view"

    const-string v9, "MaximizedByArrowKey"

    invoke-static {v0, v7, v8, v9}, Lcom/samsung/android/multiwindow/MultiWindowLogger;->insertLogForDeX(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;I)I
    ...
    invoke-direct {v1, v2, v5, v6}, Lcom/android/server/policy/SamsungPhoneWindowManager;->startBixbyService(Landroid/view/KeyEvent;ZZ)V
    ...
    invoke-direct {v1, v2, v4, v6}, Lcom/android/server/policy/SamsungPhoneWindowManager;->startBixbyService(Landroid/view/KeyEvent;ZZ)V
...
.method isInDexOnPc()Z
    .locals 2

    iget v0, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mDexOnPcState:I
...
.method public updateSettings()V
    ...
    invoke-static {v5, v8, v4, v3}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    :goto_16
    iget-boolean v8, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mEmergencyModeEnabled:Z

    if-eq v8, v5, :cond_21

    iput-boolean v5, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mEmergencyModeEnabled:Z

    iget-object v8, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mSamsungWindowManagerFuncs:Lcom/android/server/policy/SamsungWindowManagerPolicy$SamsungWindowManagerFuncs;

    iget-boolean v9, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mEmergencyModeEnabled:Z

    invoke-interface {v8, v9}, Lcom/android/server/policy/SamsungWindowManagerPolicy$SamsungWindowManagerFuncs;->notifyEmergencyModeEnabled(Z)V
    ...
    const-string v8, "double_tab_to_wake_up"
    ...
    :goto_17
    iput-boolean v5, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mIsDoubleTapToWakeUp:Z
    ...
    const-string v8, "CscFeature_Common_ConfigYuva"

    invoke-virtual {v5, v8}, Lcom/samsung/android/feature/SemCscFeature;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    const-string v8, "ADAPTIVE_BRIGHTNESS"
    ...
    :goto_19
    iput-boolean v5, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mIsAdaptiveBrightnessValue:Z
    ...
    iget-boolean v6, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mOutdoorModeSetting:Z
    ...
    iget v4, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mDexOnPcState:I

    if-eq v3, v4, :cond_28

    iput v3, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mDexOnPcState:I
    ...
    const-string v6, "mDexOnPcState :"

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v6, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mDexOnPcState:I
