...
.method public clearAttributes(II)Z
    ...
    invoke-static {v3}, Lcom/android/server/pm/UserManagerService;->access$3300(Lcom/android/server/pm/UserManagerService;)Landroid/util/SparseArray;
    ...
    invoke-static {v5}, Lcom/android/server/pm/UserManagerService;->access$3300(Lcom/android/server/pm/UserManagerService;)Landroid/util/SparseArray;
...
.method public clearVolatiles(II)Z
    ...
    invoke-static {v2}, Lcom/android/server/pm/UserManagerService;->access$3300(Lcom/android/server/pm/UserManagerService;)Landroid/util/SparseArray;
...
.method public createUserEvenWhenDisallowed(Ljava/lang/String;I[Ljava/lang/String;)Landroid/content/pm/UserInfo;
    ...
    invoke-static {v0, p1, p2, v1, p3}, Lcom/android/server/pm/UserManagerService;->access$2800(Lcom/android/server/pm/UserManagerService;Ljava/lang/String;II[Ljava/lang/String;)Landroid/content/pm/UserInfo;
...
.method public exists(I)Z
    ...
    invoke-static {v0, p1}, Lcom/android/server/pm/UserManagerService;->access$3100(Lcom/android/server/pm/UserManagerService;I)Landroid/content/pm/UserInfo;
...
.method public getBaseUserRestrictions(I)Landroid/os/Bundle;
    ...
    invoke-static {v1}, Lcom/android/server/pm/UserManagerService;->access$1700(Lcom/android/server/pm/UserManagerService;)Landroid/util/SparseArray;
...
.method public getProfileParentId(I)I
    ...
    invoke-static {v1, p1}, Lcom/android/server/pm/UserManagerService;->access$3200(Lcom/android/server/pm/UserManagerService;I)Landroid/content/pm/UserInfo;
...
.method public isProfileAccessible(IILjava/lang/String;Z)Z
    ...
    invoke-static {v3, p2}, Lcom/android/server/pm/UserManagerService;->access$2700(Lcom/android/server/pm/UserManagerService;I)Landroid/content/pm/UserInfo;
...
.method public isUserRunning(I)Z
    ...
    invoke-static {v0}, Lcom/android/server/pm/UserManagerService;->access$3000(Lcom/android/server/pm/UserManagerService;)Landroid/util/SparseIntArray;
    ...
    invoke-static {v1}, Lcom/android/server/pm/UserManagerService;->access$3000(Lcom/android/server/pm/UserManagerService;)Landroid/util/SparseIntArray;
...
.method public isUserUnlocked(I)Z
    ...
    invoke-static {v2}, Lcom/android/server/pm/UserManagerService;->access$3000(Lcom/android/server/pm/UserManagerService;)Landroid/util/SparseIntArray;
...
.method public removeAllUsers()V
    ...
    invoke-static {v0}, Lcom/android/server/pm/UserManagerService;->access$2500(Lcom/android/server/pm/UserManagerService;)V
    ...
    invoke-static {v4}, Lcom/android/server/pm/UserManagerService;->access$2600(Lcom/android/server/pm/UserManagerService;)Landroid/os/Handler;
...
.method public setBaseUserRestrictionsByDpmsForMigration(ILandroid/os/Bundle;)V
    ...
    invoke-static {v3}, Lcom/android/server/pm/UserManagerService;->access$1700(Lcom/android/server/pm/UserManagerService;)Landroid/util/SparseArray;

    move-result-object v3

    invoke-static {v1, p1, v2, v3}, Lcom/android/server/pm/UserManagerService;->access$1800(Lcom/android/server/pm/UserManagerService;ILandroid/os/Bundle;Landroid/util/SparseArray;)Z
...
.method public setDeviceManaged(Z)V
    ...
    invoke-static {v1, p1}, Lcom/android/server/pm/UserManagerService;->access$2002(Lcom/android/server/pm/UserManagerService;Z)Z
...
.method public setDevicePolicyUserRestrictions(ILandroid/os/Bundle;ZI)V
    ...
    invoke-static {v0, p1, p2, p3, p4}, Lcom/android/server/pm/UserManagerService;->access$1600(Lcom/android/server/pm/UserManagerService;ILandroid/os/Bundle;ZI)V
...
.method public setForceEphemeralUsers(Z)V
    ...
    invoke-static {v1, p1}, Lcom/android/server/pm/UserManagerService;->access$2402(Lcom/android/server/pm/UserManagerService;Z)Z
...
.method public setUserIcon(ILandroid/graphics/Bitmap;)V
    ...
    invoke-static {v4, v5, p2}, Lcom/android/server/pm/UserManagerService;->access$2200(Lcom/android/server/pm/UserManagerService;Landroid/content/pm/UserInfo;Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v2, p1}, Lcom/android/server/pm/UserManagerService;->access$2300(Lcom/android/server/pm/UserManagerService;I)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1
...
.method public setUserManaged(IZ)V
    ...
    invoke-static {v1}, Lcom/android/server/pm/UserManagerService;->access$2100(Lcom/android/server/pm/UserManagerService;)Landroid/util/SparseBooleanArray;
