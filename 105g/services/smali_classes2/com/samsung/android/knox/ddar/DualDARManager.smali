...
.method private declared-synchronized fetchDumpState(Ljava/lang/String;)Z
    ...
    iget-object v4, v0, Lcom/samsung/android/knox/ddar/FileInfo;->fd:Landroid/os/ParcelFileDescriptor;
    ...
    const-string v6, "Fetch DumpState failed !!"
    ...
    :cond_4
    :try_start_4
    sget-boolean v6, Lcom/samsung/android/knox/ddar/DualDARManager;->DEBUG:Z

    if-eqz v6, :cond_5

    const-string v6, "DualDarManager"

    const-string v7, "Fetch DumpState Success"
    ...
    :try_start_5
    iget-object v1, v0, Lcom/samsung/android/knox/ddar/FileInfo;->fd:Landroid/os/ParcelFileDescriptor;
    :try_end_5
    ...
    const-string v3, "Error: Not able to open the Log files"
    ...
    const-string v5, "Exception at fetchDumpState - "
...
.method private processCommandSecurely(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    iget-object v6, p0, Lcom/samsung/android/knox/ddar/DualDARManager;->mSecureClientOutAPI:Lcom/samsung/android/knox/ddar/securesession/SecureClient;

    move-object v4, p1

    move-object v5, p2

    invoke-virtual/range {v1 .. v6}, Lcom/samsung/android/knox/ddar/proxy/KnoxProxyManager;->relayMessageSecurely(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Lcom/samsung/android/knox/ddar/securesession/SecureClient;)Landroid/os/Bundle;
...
.method establishSecureSession()V
    ...
    const-string v2, "Failed to establish secure connection from SDK to KnoxCore"
...
.method public declared-synchronized setSecret(ILjava/util/List;)V
    ...
    :try_start_2
    iget-object v5, p0, Lcom/samsung/android/knox/ddar/DualDARManager;->mSecureClientOutAPI:Lcom/samsung/android/knox/ddar/securesession/SecureClient;

    const-string v6, "DUALDAR_MGR_SERVICE"

    iget-object v7, v3, Lcom/samsung/android/knox/ddar/Secret;->data:[B

    invoke-virtual {v5, v6, v7}, Lcom/samsung/android/knox/ddar/securesession/SecureClient;->encryptMessageFor(Ljava/lang/String;[B)[B
    ...
    iget-object v6, v3, Lcom/samsung/android/knox/ddar/Secret;->alias:Ljava/lang/String;

    invoke-direct {v5, v6, v4}, Lcom/samsung/android/knox/ddar/Secret;-><init>(Ljava/lang/String;[B)V
    ...
    invoke-direct {p0, v2, v0}, Lcom/samsung/android/knox/ddar/DualDARManager;->processCommandSecurely(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    check-cast v4, Lcom/samsung/android/knox/ddar/Secret;

    iget-object v5, v4, Lcom/samsung/android/knox/ddar/Secret;->data:[B
...
.method teardownSecureSession()V
    ...
    const-string v2, "Failed to teardown secure connection from SDK to KnoxCore"
