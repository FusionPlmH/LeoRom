...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v1, p0, Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;->mLastDensityDpi:I

    const/4 v2, 0x2

    new-array v2, v2, [I

    iput-object v2, p0, Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;->mAppShortcutCenterPos:[I

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;->mShortcutViewList:Ljava/util/ArrayList;

    iput v0, p0, Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;->mStatusBarState:I

    iput-boolean v1, p0, Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;->mIsExpanded:Z

    iput v1, p0, Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;->mLastUpdatedRotation:I
    ...
    iput-object v0, p0, Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;->mDisplayObserver:Lcom/android/systemui/keyguard/DisplayLifecycle$Observer;
    ...
    new-instance v0, Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView$4;

    invoke-direct {v0, p0}, Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView$4;-><init>(Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;)V
...
.method static synthetic access$300(Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;)I
    .locals 1
...
.method static synthetic access$302(Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;I)I
    .locals 0
...
.method static synthetic access$400(Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;)Landroid/view/View;
    .locals 1
...
.method static synthetic access$500(Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;)Lcom/android/systemui/statusbar/floating/ShortcutLocationCalculator;
    .locals 1
...
.method static synthetic access$600(Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;)Ljava/util/ArrayList;
    .locals 1
...
.method static synthetic access$702(Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;Z)Z
    .locals 0
...
.method static synthetic access$800(Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;)V
    .locals 0
...
.method public static synthetic lambda$new$1(Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;Landroid/net/Uri;)V
    ...
    invoke-direct {p0}, Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;->updateAppShortcutIcon()V
...
.method private updateAppShortcutIcon()V
    .locals 3

    iget-object v0, p0, Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;->mAppShortcutIconImageView:Lcom/android/systemui/widget/SystemUIImageView;

    if-nez v0, :cond_0

    sget-object v0, Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;->TAG:Ljava/lang/String;

    const-string/jumbo v1, "updateAppShortcutIcon() mAppShortcutIconImageView is null"
...
.method private updateEnableState()V
    ...
    invoke-virtual {v7}, Lcom/android/systemui/lockstar/PluginLockStarManager;->isShortcutInvisible()Z
    ...
    :goto_2
    sget-object v9, Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;->TAG:Ljava/lang/String;

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v11, "updateEnableState() currentState = "

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v11, p0, Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;->mShortcutState:Lcom/android/systemui/statusbar/floating/ShortcutState;

    invoke-virtual {v11}, Lcom/android/systemui/statusbar/floating/ShortcutState;->getName()Ljava/lang/String;

    move-result-object v11

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v11, ", isFloatingShortcutEnabled="

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v10, v8}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v11, ", isSettingEnabled="
    ...
    const-string v11, ", isMoreThanOneShortcutEnabled="

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v10, v2}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v11, ", isEmergencyModeDisabled="

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v10, v5}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v11, ", isUPSMDisabled="

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v10, v6}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v11, ", isDLSShortcutEnabled="
    ...
    iget-object v9, p0, Lcom/android/systemui/statusbar/floating/FloatingShortcutAreaView;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v9}, Lcom/android/keyguard/KeyguardUpdateMonitor;->isFingerprintDetectionRunning()Z
...
.method launchFocusedApp(Lcom/android/systemui/statusbar/floating/FloatingShortcutView;)Z
    ...
    invoke-virtual {v0}, Lcom/android/systemui/statusbar/floating/ShortcutState;->sendAppLaunchLogging()V
