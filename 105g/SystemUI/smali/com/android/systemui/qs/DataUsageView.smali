...
.method public setDataUsageView()V
    ...
    sget v0, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoQSDataUsageOrientation:I
    ...
    :goto_0
    sget v3, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoQSDataUsageSize:I

    sget v4, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoQSDataUsageFont:I

    int-to-float v5, v3

    invoke-virtual {p0, v5}, Lcom/android/systemui/qs/DataUsageView;->setTextSize(F)V

    iget-object v5, p0, Lcom/android/systemui/qs/DataUsageView;->mContext:Landroid/content/Context;

    const/4 v6, 0x0

    const-string v7, "sec-roboto-condensed"

    invoke-static {v5, v4, v7, v6}, Lcom/fusionleo/LeoX/systemui/LeoConfig;->setLeoFonts(Landroid/content/Context;ILjava/lang/String;I)Landroid/graphics/Typeface;

    move-result-object v5

    invoke-virtual {p0, v5}, Lcom/android/systemui/qs/DataUsageView;->setTypeface(Landroid/graphics/Typeface;)V

    or-int/lit8 v5, v2, 0x10

    or-int/2addr v1, v5

    invoke-virtual {p0, v1}, Lcom/android/systemui/qs/DataUsageView;->setGravity(I)V

    sget-boolean v1, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoQsDataUsageBarEnabled:Z
    ...
    :goto_1
    invoke-virtual {p0, v6}, Lcom/android/systemui/qs/DataUsageView;->setVisibility(I)V
