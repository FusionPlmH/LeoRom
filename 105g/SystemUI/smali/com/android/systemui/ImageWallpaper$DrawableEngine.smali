...
.method constructor <init>(Lcom/android/systemui/ImageWallpaper;)V
    ...
    iput-object v0, p0, Lcom/android/systemui/ImageWallpaper$DrawableEngine;->mDisplayListener:Lcom/android/systemui/keyguard/DisplayLifecycle$Observer;
...
.method static synthetic access$1600(Lcom/android/systemui/ImageWallpaper$DrawableEngine;Z)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/systemui/ImageWallpaper$DrawableEngine;->unloadWallpaper(Z)V
...
.method private scheduleUnloadWallpaper()V
    ...
    const-string/jumbo v1, "scheduleUnloadWallpaper: unLoadWallpaper after 5000ms"
...
.method private unloadWallpaper(Z)V
    ...
    const-string/jumbo v2, "unloadWallpaper: forgetSize="
...
.method private updateSmartCropRect()V
    ...
    const-string v13, "ImageWallpaper"
    ...
    const-string v10, ", landBitmapWidth : "

    invoke-virtual {v14, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v14, v11}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v10, ", landBitmapHeight : "
    ...
    invoke-virtual {v0, v13, v6, v15, v10}, Lcom/samsung/android/saiv/imageprocessing/SmartCropper;->setImage([IIII)Z

    move-result v10

    if-eqz v10, :cond_b

    iget-object v10, v1, Lcom/android/systemui/ImageWallpaper$DrawableEngine;->mBackground:Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v14, v10, v2}, Lcom/samsung/android/media/face/SemFaceDetection;->run(Landroid/graphics/Bitmap;Ljava/util/ArrayList;)I
    ...
    invoke-direct {v2, v3, v3, v11, v12}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    :cond_a
    :goto_4
    iput-object v2, v1, Lcom/android/systemui/ImageWallpaper$DrawableEngine;->mSmartCroppedResult:Landroid/graphics/Rect;
    ...
    iget-object v2, v1, Lcom/android/systemui/ImageWallpaper$DrawableEngine;->mSmartCroppedResult:Landroid/graphics/Rect;
...
.method public onCreate(Landroid/view/SurfaceHolder;)V
    ...
    :goto_0
    invoke-static {v1, v4}, Lcom/android/systemui/ImageWallpaper;->access$302(Lcom/android/systemui/ImageWallpaper;Z)Z
    ...
    iget-object v4, p0, Lcom/android/systemui/ImageWallpaper$DrawableEngine;->mDisplayListener:Lcom/android/systemui/keyguard/DisplayLifecycle$Observer;

    invoke-virtual {v2, v4}, Lcom/android/systemui/keyguard/DisplayLifecycle;->addObserver(Ljava/lang/Object;)V
...
.method public onDestroy()V
    ...
    iget-object v1, p0, Lcom/android/systemui/ImageWallpaper$DrawableEngine;->mDisplayListener:Lcom/android/systemui/keyguard/DisplayLifecycle$Observer;
...
.method setWhiteBgSettings(Landroid/app/WallpaperColors;)V
    ...
    invoke-virtual {v1, v0}, Landroid/app/WallpaperManager;->getWallpaperColors(I)Landroid/app/WallpaperColors;
    ...
    const-string/jumbo v2, "setWhiteBgSettings: primaryColor is null"
    ...
    const-string/jumbo v5, "setWhiteBgSettings: no extraHints, hints ="
    ...
    invoke-virtual {v8}, Lcom/android/systemui/ImageWallpaper;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v8

    const-string v9, "need_dark_statusbar"
    ...
    invoke-virtual {v9}, Lcom/android/systemui/ImageWallpaper;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v9

    const-string v10, "need_dark_font"
    ...
    invoke-virtual {v10}, Lcom/android/systemui/ImageWallpaper;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v10

    const-string v11, "need_dark_navigationbar"
    ...
    :goto_6
    const-string v11, "ImageWallpaper"
    ...
    const-string v13, ", [oldValStatusBar="

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v12, v8}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v13, ", newValStatusBar="

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v12, v3}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v13, "] [oldValBody="

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v12, v9}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v13, ", newValBody="

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v12, v6}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v13, "] [oldValNaviBar="

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v12, v10}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v13, ", newValNaviBar="
    ...
    const-string v12, "need_dark_font"
    ...
    :cond_c
    sget-boolean v11, Lcom/android/systemui/Rune;->NAVBAR_ENABLED:Z
    ...
    const-string v12, "need_dark_navigationbar"
    ...
    invoke-virtual {v5, v4}, Lcom/android/systemui/ImageWallpaper;->sendBroadcast(Landroid/content/Intent;)V
