...
.field private final mTouchLockHandler:Landroid/os/Handler;

.field private final mTouchLockRunnable:Ljava/lang/Runnable;
...
.method public constructor <init>()V
    ...
    iput-object v3, p0, Lcom/android/systemui/keyguard/KeyguardViewMediator;->mTouchLockHandler:Landroid/os/Handler;

    new-instance v3, Lcom/android/systemui/keyguard/-$$Lambda$KeyguardViewMediator$8r3SMMiUPzcUGDl0PliCUu6loyA;

    invoke-direct {v3, p0}, Lcom/android/systemui/keyguard/-$$Lambda$KeyguardViewMediator$8r3SMMiUPzcUGDl0PliCUu6loyA;-><init>(Lcom/android/systemui/keyguard/KeyguardViewMediator;)V

    iput-object v3, p0, Lcom/android/systemui/keyguard/KeyguardViewMediator;->mTouchLockRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$2100(Lcom/android/systemui/keyguard/KeyguardViewMediator;)Lcom/android/systemui/KnoxStateMonitor;
    .locals 1
...
.method static synthetic access$2600(Lcom/android/systemui/keyguard/KeyguardViewMediator;)Lcom/android/systemui/UiOffloadThread;
    .locals 1
...
.method private handleNotifyScreenTurningOn(Lcom/android/internal/policy/IKeyguardDrawnCallback;)V
    ...
    invoke-virtual {v0}, Lcom/android/keyguard/KeyguardUpdateMonitor;->onScreenTurningOn()V
...
.method private handleSystemReady()V
    ...
    invoke-static {v1}, Lcom/android/systemui/util/DeviceState;->isSubDisplay(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/keyguard/KeyguardUpdateMonitor;->notifyFolderStateChanged(Z)V
...
.method public static synthetic lambda$8r3SMMiUPzcUGDl0PliCUu6loyA(Lcom/android/systemui/keyguard/KeyguardViewMediator;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/systemui/keyguard/KeyguardViewMediator;->showTouchLockScreen()V
...
.method private setupLocked()V
    ...
    iput v7, p0, Lcom/android/systemui/keyguard/KeyguardViewMediator;->mTrustedSoundId:I

    :cond_8
    if-eqz v1, :cond_9

    iget v7, p0, Lcom/android/systemui/keyguard/KeyguardViewMediator;->mTrustedSoundId:I
    ...
    :cond_a
    const-string v1, "/system/media/audio/ui/Unlock_VA_Mode.ogg"
    ...
    const-string v8, "failed to load lock stay sound from "
...
.method private showTouchLockScreen()V
    .locals 0
