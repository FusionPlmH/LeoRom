...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;->mPackageRemovedReceiver:Landroid/content/BroadcastReceiver;

    iput-object v0, p0, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;->mBootCompletedReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$200(Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;)Landroid/content/Context;
    .locals 1
...
.method private isInappropriateNotification(Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/Notification;)Z
    ...
    const-string v3, "isInappropriateNotification pending intent not exist"
...
.method private registerBootCompletedReceiver()V
    ...
    new-instance v0, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener$2;

    invoke-direct {v0, p0}, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener$2;-><init>(Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;)V
    ...
    iget-object v1, p0, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;->mBootCompletedReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {p0, v1, v0}, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
...
.method private registerPackageRemoveReceiver()V
    ...
    iget-object v1, p0, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;->mPackageRemovedReceiver:Landroid/content/BroadcastReceiver;
...
.method private registerReceivers()V
    ...
    invoke-direct {p0}, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;->registerPackageRemoveReceiver()V
    ...
    invoke-virtual {v0}, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/state/FloatingNotificationStateManager;->isRemoveErasedPackageNeeded()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0}, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;->registerBootCompletedReceiver()V
...
.method private unRegisterReceivers()V
    ...
    iget-object v0, p0, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;->mPackageRemovedReceiver:Landroid/content/BroadcastReceiver;
    ...
    :cond_0
    iget-object v0, p0, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;->mBootCompletedReceiver:Landroid/content/BroadcastReceiver;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v2}, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/state/FloatingNotificationStateManager;->getActiveDisplayId()I
    ...
    invoke-virtual {v1, v2}, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/state/FloatingNotificationStateManager;->setActiveDisplayId(I)V
    ...
    const-string v4, "onConfigurationChanged newConfig.semDisplayDeviceType : "
...
.method public onCreate()V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;->registerReceivers()V
...
.method public onDestroy()V
    ...
    invoke-direct {p0}, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;->unRegisterReceivers()V
...
.method public onNotificationPosted(Landroid/service/notification/StatusBarNotification;)V
    ...
    iget-object v8, v7, Landroid/app/Notification;->contentIntent:Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, v6, v8, v7}, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;->isInappropriateNotification(Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/Notification;)Z
...
.method public onNotificationRemoved(Landroid/service/notification/StatusBarNotification;)V
    ...
    invoke-direct {p0, v0, v2, v1}, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;->isInappropriateNotification(Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/Notification;)Z
    ...
    new-instance v3, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/floatingnoticontainer/FloatingNotificationContainerManager;

    iget-object v4, p0, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;->mContext:Landroid/content/Context;

    invoke-direct {v3, v4}, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/floatingnoticontainer/FloatingNotificationContainerManager;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;->mFloatingNotificationContainerManager:Lcom/samsung/android/systemui/smartpopupview/floatingactivity/floatingnoticontainer/FloatingNotificationContainerManager;

    :cond_1
    :try_start_0
    iget-object v3, p0, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;->mLogWrapper:Lcom/samsung/android/systemui/smartpopupview/floatingactivity/util/LogWrapper;

    sget-object v4, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/service/NotificationListener;->TAG:Ljava/lang/String;

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "onNotificationRemovedsbn.packageName : "
    ...
    const-string v6, "onNotificationRemovedsbn.key : "
    ...
    const-string v6, "onNotificationRemovednotification.category : "
    ...
    invoke-virtual {v3, v0}, Lcom/samsung/android/systemui/smartpopupview/floatingactivity/floatingnoticontainer/FloatingNotificationContainerManager;->removeFloatingNotificationView(Ljava/lang/String;)V
