...
.field private mCarrierLabelMaxWidth:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v1, p0, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->mCarrierLabelMaxWidth:I
    ...
    iput-boolean v1, p0, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->mForceThisVisibleFlag:Z

    iput-boolean v0, p0, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->mIsCenterDisplayCutOut:Z
...
.method public static synthetic lambda$onApplyWindowInsets$0(Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;)V
    .locals 1
...
.method static synthetic lambda$onAttachedToWindow$1()V
    .locals 1
...
.method public static synthetic lambda$onLayout$2(Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->updateMaxWidthOfCarrierLabelAndContainer()V
...
.method private loadDimens()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->isCenterDisplayCutOut(Landroid/content/Context;)Z
...
.method private updateLayoutConsideringCutout()Z
    ...
    iget-object v7, p0, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->mKeyguardStatusBarAreaView:Landroid/view/ViewGroup;
    ...
    :cond_0
    sget-boolean v8, Lcom/android/systemui/Rune;->STATBAR_SUPPORT_LOCKSCREEN_MUM_BUTTON:Z
    ...
    :goto_1
    invoke-virtual {p0, v6}, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    const-string v4, "updateLayoutConsideringCutout - height = "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, v5}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v4, " mCameraTopMargin = "
...
.method private updateMaxWidthOfCarrierLabelAndContainer()V
    .locals 5

    iget-boolean v0, p0, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->mIsCenterDisplayCutOut:Z
    ...
    invoke-virtual {v2, v1}, Lcom/android/systemui/statusbar/phone/StatusIconContainer;->setMaxWidth(I)V
    ...
    iget v3, p0, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->mOrientation:I
    ...
    :cond_2
    iget v3, p0, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->mCarrierLabelMaxWidth:I

    if-eq v2, v3, :cond_3

    iput v2, p0, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->mCarrierLabelMaxWidth:I

    iget-object v3, p0, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->mCarrierLabel:Lcom/android/keyguard/CarrierText;

    iget v4, p0, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->mCarrierLabelMaxWidth:I

    invoke-virtual {v3, v4}, Lcom/android/keyguard/CarrierText;->setMaxWidth(I)V
...
.method private updateVisibilities()V
    ...
    :cond_7
    :goto_1
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->updateLeoKeyguardStatusBarViewVisibilities()V
    return-void
.end method
...
.method public isCenterDisplayCutOut(Landroid/content/Context;)Z
    ...
    :goto_1
    iput-boolean v4, p0, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->mIsCenterDisplayCutOut:Z
    :try_end_0
    ...
    const-string v4, "Can not update mIsCenterDisplayCutOut. "
    ...
    const-string v2, "mIsCenterDisplayCutOut: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v2, p0, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->mIsCenterDisplayCutOut:Z
...
.method public onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-virtual {p0, v0}, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->post(Ljava/lang/Runnable;)Z
...
.method protected onAttachedToWindow()V
    ...
    sget-object v1, Lcom/android/systemui/statusbar/phone/-$$Lambda$KeyguardStatusBarView$XO0a43YKkmP7Ax423rjtE8u01U4;->INSTANCE:Lcom/android/systemui/statusbar/phone/-$$Lambda$KeyguardStatusBarView$XO0a43YKkmP7Ax423rjtE8u01U4;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->isCenterDisplayCutOut(Landroid/content/Context;)Z
...
.method protected onFinishInflate()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-object v1, p0, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->mKeyguardStatusBarAreaView:Landroid/view/ViewGroup;
    ...
    invoke-virtual {p0, v0}, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->isCenterDisplayCutOut(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_7

    iget v0, p0, Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;->mOrientation:I
...
.method protected onLayout(ZIIII)V
    ...
    new-instance v0, Lcom/android/systemui/statusbar/phone/-$$Lambda$KeyguardStatusBarView$rgzNfH89CJGr2HY8lH7wYDilOtY;

    invoke-direct {v0, p0}, Lcom/android/systemui/statusbar/phone/-$$Lambda$KeyguardStatusBarView$rgzNfH89CJGr2HY8lH7wYDilOtY;-><init>(Lcom/android/systemui/statusbar/phone/KeyguardStatusBarView;)V
...
.method public setForceVisibility(ZZZ)I
    .locals 4
...
.method public updateOperatorLogoVisibility(Z)V
    ...
    return-void
.end method
.method public updateLeoKeyguardStatusBarViewVisibilities()V
    .locals 1
    ...
    sget-boolean v0, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoKeyguardStatusBarViewVisibilities:Z
