...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/systemui/statusbar/phone/PhoneStatusBarView$LayoutBugDetector;,
...
.field private mIsCenterDisplayCutOut:Z
...
.field private mLayoutBugDetector:Lcom/android/systemui/statusbar/phone/PhoneStatusBarView$LayoutBugDetector;

.field private mLeftCutOutPadding:I

.field private mLeoManager:Lcom/android/systemui/fusionleo/LeoStatusBarController;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    new-instance v1, Lcom/android/systemui/statusbar/phone/-$$Lambda$PhoneStatusBarView$k5HPJ-E4_9yyFizL8TGtlKz166I;

    invoke-direct {v1, p0}, Lcom/android/systemui/statusbar/phone/-$$Lambda$PhoneStatusBarView$k5HPJ-E4_9yyFizL8TGtlKz166I;-><init>(Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;)V

    iput-object v1, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mSetStausIconMaxWidthRunnable:Ljava/lang/Runnable;

    const/high16 v1, 0x3f800000    # 1.0f

    iput v1, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mBarAlpha:F

    new-instance v1, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView$OperationLogoHelper;

    invoke-direct {v1, p0}, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView$OperationLogoHelper;-><init>(Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;)V

    iput-object v1, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mOperationLogoHelper:Lcom/android/systemui/statusbar/phone/PhoneStatusBarView$OperationLogoHelper;

    iput-boolean v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mIsCenterDisplayCutOut:Z
    ...
    new-instance v0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView$LayoutBugDetector;

    invoke-direct {v0, p0, p0}, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView$LayoutBugDetector;-><init>(Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;Landroid/view/ViewGroup;)V

    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mLayoutBugDetector:Lcom/android/systemui/statusbar/phone/PhoneStatusBarView$LayoutBugDetector;
...
.method static synthetic access$1400(Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;)I
    .locals 1

    iget v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mLeftCutOutPadding:I

    return v0
.end method

.method static synthetic access$1500(Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;)I
    .locals 1

    iget v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mRightCutOutPadding:I

    return v0
.end method

.method static synthetic access$1600(Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;)Landroid/util/Pair;
    .locals 1
...
.method static synthetic access$1700(Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;)I
    .locals 1

    iget v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mCameraTopMargin:I

    return v0
.end method

.method static synthetic access$1800(Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;)I
    .locals 1

    iget v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mCameraPadding:I

    return v0
.end method

.method static synthetic access$1900(Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mIsCenterDisplayCutOut:Z
...
.method static synthetic access$2000(Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;)Landroid/view/DisplayCutout;
    .locals 1
...
.method static synthetic access$2600(Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;)Lcom/android/systemui/statusbar/phone/StatusIconContainer;
    .locals 1
...
.method static synthetic access$2700(Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;)Lcom/android/systemui/BatteryMeterView;
    .locals 1

    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mBatteryMeterView:Lcom/android/systemui/BatteryMeterView;

    return-object v0
.end method

.method static synthetic access$2800(Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;)Landroid/view/ViewGroup;
    .locals 1
...
.method public static synthetic lambda$new$2(Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;)V
    ...
    invoke-virtual {p0, v3}, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->isCenterDisplayCutOut(Landroid/content/Context;)Z
    ...
    iget-object v4, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mBatteryMeterView:Lcom/android/systemui/BatteryMeterView;

    invoke-virtual {v4}, Lcom/android/systemui/BatteryMeterView;->getMeasuredWidth()I

    move-result v4

    sub-int/2addr v3, v4

    iget-object v4, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mCutoutSpace:Landroid/view/View;
...
.method private updateLayoutForCutout()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->isCenterDisplayCutOut(Landroid/content/Context;)Z
...
.method private updateSidePadding(Landroid/util/Pair;)V
    ...
    const-string v5, ", mIsCenterDisplayCutOut = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v5, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mIsCenterDisplayCutOut:Z
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mLayoutBugDetector:Lcom/android/systemui/statusbar/phone/PhoneStatusBarView$LayoutBugDetector;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mLayoutBugDetector:Lcom/android/systemui/statusbar/phone/PhoneStatusBarView$LayoutBugDetector;

    invoke-virtual {v0, p1}, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView$LayoutBugDetector;->dumpBugViews(Ljava/io/PrintWriter;)V
    ...
    const-string v1, "mCornerCutoutMargins ="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v1, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mCornerCutoutMargins:Landroid/util/Pair;

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v1, ", mIsCenterDisplayCutOut ="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v1, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mIsCenterDisplayCutOut:Z
    ...
    const-string v1, "mLeftCutOutPadding ="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v1, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mLeftCutOutPadding:I

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v1, ", mRightCutOutPadding ="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v1, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mRightCutOutPadding:I
...
.method public getLeoGesture()V
    ...
    new-instance v0, Lcom/android/systemui/fusionleo/LeoStatusBarController;

    iget-object v1, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mContext:Landroid/content/Context;

    invoke-direct {v0, v1, p0}, Lcom/android/systemui/fusionleo/LeoStatusBarController;-><init>(Landroid/content/Context;Landroid/view/ViewGroup;)V

    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mLeoManager:Lcom/android/systemui/fusionleo/LeoStatusBarController;
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual {v0}, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView$LayoutBugDetector;->init()V

    :cond_3
    
        iget-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mLeoManager:Lcom/android/systemui/fusionleo/LeoStatusBarController;

    if-eqz v0, :cond_3leo

    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView;->mLeoManager:Lcom/android/systemui/fusionleo/LeoStatusBarController;

    invoke-virtual {v0}, Lcom/android/systemui/fusionleo/LeoStatusBarController;->onAttachedToWindow()V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Lcom/android/systemui/statusbar/phone/PhoneStatusBarView$LayoutBugDetector;->destroy()V
    ...
    invoke-virtual {v0}, Lcom/android/systemui/fusionleo/LeoStatusBarController;->onDetachedFromWindow()V
...
.method public onLeoTouchEvent(Landroid/view/MotionEvent;)V
    ...
    sget v0, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoStatusBarSlideGestureEnabled:I

    const/4 v1, 0x1

    if-eq v0, v1, :cond_0

    sget v0, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoStatusBarLongPressGestureEnabled:I
