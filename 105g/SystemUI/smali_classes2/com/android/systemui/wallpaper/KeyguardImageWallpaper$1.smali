...
.method protected onPostExecute(Lcom/android/systemui/wallpaper/KeyguardImageWallpaper$LoaderResult;)V
    ...
    invoke-static {v2}, Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;->access$100(Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;)I
    ...
    invoke-static {v0, v2}, Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;->access$200(Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;Landroid/graphics/Bitmap;)V

    iget-object v0, p0, Lcom/android/systemui/wallpaper/KeyguardImageWallpaper$1;->this$0:Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;

    invoke-static {v0}, Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;->access$100(Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;)I
    ...
    invoke-static {v0}, Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;->access$300(Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;)Z
    ...
    invoke-static {v0}, Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;->access$400(Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;)V

    :cond_2
    iget-object v0, p0, Lcom/android/systemui/wallpaper/KeyguardImageWallpaper$1;->this$0:Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;

    invoke-static {v0}, Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;->access$500(Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;)Z
    ...
    invoke-static {v0}, Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;->access$600(Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v1}, Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;->access$602(Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;

    :cond_3
    const-string v0, "KeyguardImageWallpaper"

    const-string v2, "updateWallpaper() DONE"
    ...
    invoke-static {v2}, Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;->access$800(Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;)Ljava/lang/String;
    ...
    const-string v3, "updateWallpaper() no last command, send WAKE_LOCK instead"
    ...
    invoke-virtual {v2, v3, v1}, Lcom/android/systemui/wallpaper/KeyguardImageWallpaper;->onCommand(Ljava/lang/String;Landroid/os/Bundle;)V
