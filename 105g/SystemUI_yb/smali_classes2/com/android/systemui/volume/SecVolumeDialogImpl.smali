...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0}, Lcom/android/systemui/volume/SecVolumeDialogImpl;->setCutoutSpec()V
    ...
    iget-object v2, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mScreenOnOffCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
    ...
    new-instance v0, Lcom/android/systemui/volume/SecVolumeDialogImpl$2;

    invoke-direct {v0, p0}, Lcom/android/systemui/volume/SecVolumeDialogImpl$2;-><init>(Lcom/android/systemui/volume/SecVolumeDialogImpl;)V

    iput-object v0, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mCoverStateListener:Lcom/samsung/android/sdk/cover/ScoverManager$StateListener;

    iget-object v0, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mContext:Landroid/content/Context;

    invoke-direct {p0, v0}, Lcom/android/systemui/volume/SecVolumeDialogImpl;->initCoverManager(Landroid/content/Context;)V
    ...
    new-instance v0, Lcom/android/systemui/volume/SecVolumeDialogImpl$3;

    invoke-direct {v0, p0}, Lcom/android/systemui/volume/SecVolumeDialogImpl$3;-><init>(Lcom/android/systemui/volume/SecVolumeDialogImpl;)V
    ...
    iget-object v3, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mDisplayManager:Landroid/hardware/display/DisplayManager;
    ...
    invoke-virtual {v3, v1, v4}, Landroid/hardware/display/DisplayManager;->semRegisterDisplayVolumeListener(Landroid/hardware/display/SemDisplayVolumeListener;Landroid/os/Handler;)V
    ...
    iput-object v3, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mDesktopManager:Lcom/android/systemui/util/DesktopManager;
...
.method static synthetic access$12400(Lcom/android/systemui/volume/SecVolumeDialogImpl;)Z
    .locals 1

    invoke-direct {p0}, Lcom/android/systemui/volume/SecVolumeDialogImpl;->isTalkbackEnabled()Z
...
.method static synthetic access$12500(Lcom/android/systemui/volume/SecVolumeDialogImpl;)Ljava/util/List;
    .locals 1
...
.method static synthetic access$12600(Lcom/android/systemui/volume/SecVolumeDialogImpl;)Z
    .locals 1
...
.method static synthetic access$12702(Lcom/android/systemui/volume/SecVolumeDialogImpl;I)I
    .locals 0
...
.method static synthetic access$12800(Lcom/android/systemui/volume/SecVolumeDialogImpl;Z)V
    .locals 0
...
.method static synthetic access$12900(Lcom/android/systemui/volume/SecVolumeDialogImpl;)Landroid/app/KeyguardManager;
    .locals 1
...
.method static synthetic access$13000(Lcom/android/systemui/volume/SecVolumeDialogImpl;)Lcom/android/systemui/statusbar/phone/StatusBar;
    .locals 1
...
.method private adjustSmallDialogViewPadding()V
    ...
    iget-object v7, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mSmallDialog:Lcom/android/systemui/volume/SecVolumeDialogImpl$CustomDialog;
    ...
    :goto_0
    iget-object v10, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mSmallDialog:Lcom/android/systemui/volume/SecVolumeDialogImpl$CustomDialog;

    invoke-virtual {v10}, Lcom/android/systemui/volume/SecVolumeDialogImpl$CustomDialog;->getWindow()Landroid/view/Window;

    move-result-object v10

    const/16 v11, 0x30

    iget v12, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mSmallDialogPaddingLeft:I
    ...
    iget v11, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mSmallDialogPaddingLeft:I

    iget v12, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mSmallDialogPaddingRight:I

    invoke-static {v8, v10, v1, v11, v12}, Lcom/android/systemui/volume/purefunction/layout/MinimizedPanel;->getSmallDialogSidePadding(IIIII)I
    ...
    :goto_3
    iget-object v8, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mSmallDialog:Lcom/android/systemui/volume/SecVolumeDialogImpl$CustomDialog;
    ...
    iget-object v8, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mSmallDialogView:Landroid/view/ViewGroup;

    iget v10, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mSmallDialogPaddingTop:I

    add-int/2addr v10, v3

    invoke-virtual {v8, v9, v10, v9, v9}, Landroid/view/ViewGroup;->setPadding(IIII)V

    iget-object v8, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mSmallDialogContentParent:Landroid/view/ViewGroup;
...
.method private initRow(Lcom/android/systemui/volume/SecVolumeDialogImpl$VolumeRow;IIIZ)V
    ...
    invoke-virtual {v3, v1}, Landroid/widget/SeekBar;->setClickable(Z)V
...
.method private onStateChangedH(Lcom/android/systemui/plugins/VolumeDialogController$State;)V
    ...
    invoke-virtual {v5}, Landroid/media/AudioManager;->semGetPinDevice()I

    move-result v5

    iput v5, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mPinDevice:I
    ...
    iput-boolean v5, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mIsSafeMediaVolumeDeviceOn:Z

    iget-object v5, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mAudioManager:Landroid/media/AudioManager;

    iget v6, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mPinDevice:I

    invoke-virtual {v5, v6}, Landroid/media/AudioManager;->isSafeMediaVolumeDeviceOn(I)Z

    move-result v5

    iput-boolean v5, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mIsSafeMediaVolumeDeviceOnForMultiSound:Z

    iget v5, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mActiveStream:I

    iget v6, p1, Lcom/android/systemui/plugins/VolumeDialogController$State;->activeStream:I
    ...
    check-cast v5, Lcom/android/systemui/volume/SecVolumeDialogImpl$VolumeRow;

    iget v6, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mActiveStream:I
    ...
    :cond_9
    invoke-static {v5}, Lcom/android/systemui/volume/SecVolumeDialogImpl$VolumeRow;->access$3100(Lcom/android/systemui/volume/SecVolumeDialogImpl$VolumeRow;)Landroid/view/View;
    ...
    :cond_b
    invoke-direct {p0, v5}, Lcom/android/systemui/volume/SecVolumeDialogImpl;->updateSmallVolumeRowH(Lcom/android/systemui/volume/SecVolumeDialogImpl$VolumeRow;)V
...
.method private recheckH(Lcom/android/systemui/volume/SecVolumeDialogImpl$VolumeRow;)V
    ...
    invoke-direct {p0, v1}, Lcom/android/systemui/volume/SecVolumeDialogImpl;->updateSmallVolumeRowH(Lcom/android/systemui/volume/SecVolumeDialogImpl$VolumeRow;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/systemui/volume/SecVolumeDialogImpl;->updateSmallVolumeRowH(Lcom/android/systemui/volume/SecVolumeDialogImpl$VolumeRow;)V
...
.method private setCutoutSpec()V
    ...
    :goto_0
    iput-object v3, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mCutoutSpec:Ljava/lang/String;

    iget-object v3, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mCutoutSpec:Ljava/lang/String;
    ...
    :goto_1
    iput-boolean v3, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mHasCutOutDisplay:Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v5, "Can not update mCutoutSpec, mHasCutOutDisplay. "
    ...
    iput-object v1, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mCutoutSpec:Ljava/lang/String;

    iput-boolean v0, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mHasCutOutDisplay:Z
...
.method private updatePaddingForSmallDialog()V
    ...
    iget-object v6, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mCutoutSpec:Ljava/lang/String;
    ...
    invoke-direct {p0, v6, v0, v0}, Lcom/android/systemui/volume/SecVolumeDialogImpl;->setSmallDialogPaddings(III)V
    ...
    invoke-direct {p0, v0, v0, v6}, Lcom/android/systemui/volume/SecVolumeDialogImpl;->setSmallDialogPaddings(III)V
    ...
    invoke-direct {p0, v0, v6, v0}, Lcom/android/systemui/volume/SecVolumeDialogImpl;->setSmallDialogPaddings(III)V
...
.method private updateSmallVolumeRowH(Lcom/android/systemui/volume/SecVolumeDialogImpl$VolumeRow;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/systemui/volume/SecVolumeDialogImpl;->getStreamLabelH(Lcom/android/systemui/plugins/VolumeDialogController$StreamState;)Ljava/lang/String;
    ...
    :cond_7
    iget-object v2, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mState:Lcom/android/systemui/plugins/VolumeDialogController$State;
    ...
    iget-boolean v5, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mIsAllSoundOff:Z
    ...
    invoke-direct {p0, p1, v3}, Lcom/android/systemui/volume/SecVolumeDialogImpl;->updateSmallVolumeRowSliderH(Lcom/android/systemui/volume/SecVolumeDialogImpl$VolumeRow;I)V
...
.method private updateSmallVolumeRowSliderH(Lcom/android/systemui/volume/SecVolumeDialogImpl$VolumeRow;I)V
    ...
    :cond_2
    invoke-static {p1}, Lcom/android/systemui/volume/SecVolumeDialogImpl$VolumeRow;->access$5300(Lcom/android/systemui/volume/SecVolumeDialogImpl$VolumeRow;)Z
    ...
    invoke-static {p1}, Lcom/android/systemui/volume/SecVolumeDialogImpl$VolumeRow;->access$5100(Lcom/android/systemui/volume/SecVolumeDialogImpl$VolumeRow;)J
    ...
    invoke-virtual {v2, v3, p1}, Lcom/android/systemui/volume/SecVolumeDialogImpl$H;->removeMessages(ILjava/lang/Object;)V
    ...
    invoke-virtual {v6, v3, p1}, Lcom/android/systemui/volume/SecVolumeDialogImpl$H;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v2, v3, v6, v7}, Lcom/android/systemui/volume/SecVolumeDialogImpl$H;->sendMessageAtTime(Landroid/os/Message;J)Z
    ...
    invoke-static {v2}, Lcom/android/systemui/volume/SecVolumeDialogImpl;->getImpliedMediaVolumeLevel(I)I
    ...
    invoke-static {v3, v2}, Lcom/android/systemui/volume/SecVolumeDialogImpl;->getImpliedLevel(Landroid/widget/SeekBar;I)I
...
.method private updateVolumeRowH(Lcom/android/systemui/volume/SecVolumeDialogImpl$VolumeRow;)V
    ...
    iget-object v3, v0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mState:Lcom/android/systemui/plugins/VolumeDialogController$State;

    iget-boolean v3, v3, Lcom/android/systemui/plugins/VolumeDialogController$State;->fixedSCOVolume:Z
    ...
    :goto_14
    iget v6, v0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mZenMode:I
    ...
    iget-boolean v6, v0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mVoiceCapable:Z
    ...
    iget-boolean v4, v2, Lcom/android/systemui/plugins/VolumeDialogController$StreamState;->routedToBluetooth:Z

    if-eqz v4, :cond_27

    iget-object v4, v0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mA2dp:Landroid/bluetooth/BluetoothA2dp;
    ...
    iput-object v4, v0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mBTDeviceName:Ljava/lang/String;
    ...
    iget-object v4, v0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mBTDeviceName:Ljava/lang/String;
    ...
    :cond_2a
    iget v4, v0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mPinDevice:I
    ...
    invoke-virtual {v4, v7}, Landroid/media/AudioManager;->getPinDeviceName(I)Ljava/lang/String;
    ...
    iget-object v4, v0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mHfp:Landroid/bluetooth/BluetoothHeadset;
    ...
    :cond_2f
    iget-boolean v4, v0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mAutomute:Z
    ...
    iget-boolean v3, v0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mIsSafeMediaVolumeDeviceOnForMultiSound:Z

    if-eqz v3, :cond_48

    :goto_2c
    iget v3, v0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mEarProtectLevel:I
    ...
    invoke-virtual {v3, v12}, Landroid/widget/ImageButton;->setImageTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v1, v3}, Lcom/android/systemui/volume/SecVolumeDialogImpl$VolumeRow;->access$4302(Lcom/android/systemui/volume/SecVolumeDialogImpl$VolumeRow;I)I
    ...
    const v12, 0x7f120cbe

    invoke-virtual {v4, v12, v7}, Landroid/content/Context;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {v4, v7}, Landroid/media/AudioManager;->semGetFineVolume(I)I
...
.method private updateWindowWidthH()V
    ...
    sget-boolean v2, Lcom/android/systemui/volume/SecVolumeDialogImpl;->IS_TABLET_DEVICE:Z
    ...
    iget-object v7, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mResources:Landroid/content/res/Resources;
    ...
    invoke-static/range {v2 .. v7}, Lcom/android/systemui/volume/purefunction/layout/BasicPanel;->getPanelWindowWidth(ZIIIII)I
...
.method public init(ILcom/android/systemui/plugins/VolumeDialog$Callback;)V
    ...
    iput v1, p0, Lcom/android/systemui/volume/SecVolumeDialogImpl;->mCutOutHeight:I
