...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/systemui/wallpaper/WallpaperViewController;->mSemDisplaySolutionManager:Lcom/samsung/android/displaysolution/SemDisplaySolutionManager;
...
.method static synthetic access$000(Lcom/android/systemui/wallpaper/WallpaperViewController;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/systemui/wallpaper/WallpaperViewController;->onLiveWallpaperChanged()V

    return-void
.end method

.method static synthetic access$302(Lcom/android/systemui/wallpaper/WallpaperViewController;Z)Z
    .locals 0
...
.method private onLiveWallpaperChanged()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/systemui/lockstar/PluginLockStarManager;->notifyWallpaperChanged(I)V
...
.method protected handleDlsViewMode(IZ)V
    .locals 0
...
.method public onPause()V
    ...
    iget-object v0, p0, Lcom/android/systemui/wallpaper/WallpaperViewController;->mSemDisplaySolutionManager:Lcom/samsung/android/displaysolution/SemDisplaySolutionManager;

    if-eqz v0, :cond_0

    const-string v0, "WallpaperViewController"

    const-string v1, "mSemDisplaySolutionManager is called : false"
...
.method public onWallpaperHintUpdate()V
    .locals 4
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/systemui/wallpaper/WallpaperEventNotifier;->update(ILandroid/graphics/Bitmap;Z)V
...
.method public onWallpaperUpdate()V
    ...
    const-string v2, "onWallpaperUpdate: DLS"
    ...
    const-string v3, "onWallpaperUpdate: WMS"
    ...
    const-string v3, "onWallpaperUpdate(): mWallpaperType:"
    ...
    invoke-virtual {v1}, Lcom/android/systemui/statusbar/NotificationColorPicker;->onWallpaperChanged()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public sendWallpaperCommand(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-interface {v1, p1, p2}, Lcom/android/systemui/wallpaper/SystemUIWallpaperBase;->onCommand(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method protected setBackground(Lcom/android/systemui/wallpaper/SystemUIWallpaperBase;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/systemui/wallpaper/WallpaperViewController;->setBackground(Lcom/android/systemui/wallpaper/SystemUIWallpaperBase;Z)V

    return-void
.end method

.method protected setBackground(Lcom/android/systemui/wallpaper/SystemUIWallpaperBase;Z)V
    .locals 3
