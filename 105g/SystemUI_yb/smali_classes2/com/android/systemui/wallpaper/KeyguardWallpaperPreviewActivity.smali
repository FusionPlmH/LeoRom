...
.method static constructor <clinit>()V
    ...
    sput-boolean v2, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->sConfigured:Z
...
.method private doSetAsWallpaper()V
    ...
    :cond_2
    :goto_1
    const-string v4, "Theme Store downloaded contents"
    ...
    invoke-direct {p0, v5, v3, v0}, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->setSystemSettings(Ljava/lang/String;II)Z
    ...
    invoke-direct {p0, v5, v0, v3}, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->setSystemSettingsForUser(Ljava/lang/String;II)Z
    ...
    const-string v5, "white_lockscreen_navigationbar"
    ...
    const-string v6, "need_dark_statusbar"
    ...
    invoke-direct {p0, v7, v0, v3}, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->setSystemSettings(Ljava/lang/String;II)Z
    ...
    const-string v9, "com.sec.android.intent.action.WALLPAPER_CHANGED"
    ...
    invoke-virtual {p0, v7}, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->sendBroadcast(Landroid/content/Intent;)V

    :cond_4
    move v7, v3

    :goto_2
    sget-object v9, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->INFINITY_COLOR_LIST:[Ljava/lang/String;
    ...
    iget-object v10, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mColorInfo:Ljava/lang/String;
    ...
    iget-object v9, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mWallpaperManager:Landroid/app/WallpaperManager;

    sget-object v10, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->INFINITY_COMPONENT_LIST:[Landroid/content/ComponentName;

    aget-object v10, v10, v7

    invoke-virtual {v9, v10}, Landroid/app/WallpaperManager;->setWallpaperComponent(Landroid/content/ComponentName;)Z
    ...
    :cond_6
    :goto_3
    iget-boolean v7, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mIsAodAvailable:Z
    ...
    :goto_4
    const-string v4, "Theme Store default wallpaper"
    ...
    iget-object v9, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mPackageName:Ljava/lang/String;
    ...
    :goto_5
    invoke-direct {p0, v5, v0, v6}, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->setSystemSettings(Ljava/lang/String;II)Z

    const-string v5, "lockscreen_wallpaper"

    invoke-direct {p0, v5, v3, v0}, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->setSystemSettingsForUser(Ljava/lang/String;II)Z
    ...
    const-string v6, "doSetAsWallpaper: which = "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v6, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mCurrentWhich:I
    ...
    invoke-virtual {v0, v5, v6}, Landroid/app/WallpaperManager;->setAnimatedLockscreenWallpaper(Ljava/lang/String;I)V
    :try_end_2
    ...
    invoke-virtual {v0, v5, v6}, Landroid/app/WallpaperManager;->setPreloadWallpaper(ILjava/lang/String;)Z
    ...
    invoke-virtual {v0, v5, v6}, Landroid/app/WallpaperManager;->setMotionWallpaper(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v4}, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->sendAnalyticsEventLogs(Ljava/lang/String;)V
...
.method private sendAnalyticsEventLogs(Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lcom/android/systemui/wallpaper/WallpaperUtils;->getWallpaperTypeToString(I)Ljava/lang/String;
    ...
    iget v4, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mCurrentWhich:I

    invoke-virtual {v3, v4}, Landroid/app/WallpaperManager;->semGetWallpaperType(I)I

    move-result v3

    invoke-static {v3}, Lcom/android/systemui/wallpaper/WallpaperUtils;->getWallpaperTypeToString(I)Ljava/lang/String;

    move-result-object v4

    iget-object v5, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mContext:Landroid/content/Context;

    const-string v6, "wallpaper_pref"
    ...
    const-string v5, "AOD on & AOD calendar off & AOD image clock off"

    goto :goto_3

    :cond_4
    const-string v5, "AOD off / AOD calendar on / AOD image clock on"

    :goto_3
    const-string v6, "0006"

    invoke-static {v1, v6, v5}, Lcom/android/systemui/util/SystemUIAnalytics;->sendEventLog(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v8, "enableInfinityAOD : "
...
.method private updateWallpaperView()Z
    ...
    iget v10, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mCurrentWhich:I

    move-object v3, v0

    invoke-direct/range {v3 .. v10}, Lcom/android/systemui/wallpaper/KeyguardAnimatedWallpaper;-><init>(Landroid/content/Context;Ljava/lang/String;ZIILcom/android/systemui/wallpaper/WallpaperUtils$UpdateBitmapCallback;I)V
    ...
    invoke-direct/range {v3 .. v10}, Lcom/android/systemui/wallpaper/KeyguardMotionWallpaper;-><init>(Landroid/content/Context;Landroid/app/IWallpaperManager;Lcom/android/systemui/wallpaper/WallpaperUtils$UpdateBitmapCallback;Ljava/lang/String;Ljava/lang/String;ZI)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v1, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mContextThemeWrapper:Landroid/view/ContextThemeWrapper;
    ...
    invoke-virtual {p0, v4}, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->findViewById(I)Landroid/view/View;

    move-result-object v4

    check-cast v4, Landroid/widget/FrameLayout;

    iput-object v4, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mRootView:Landroid/widget/FrameLayout;
    ...
    iput-object v4, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mPreviewArea:Landroid/view/ViewGroup;
    ...
    iput-object v4, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mTitleTextView:Landroid/widget/TextView;
    ...
    iput-object v4, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mCapturedImageView:Landroid/widget/ImageView;
    ...
    iput-object v4, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mBackgroundImageView:Landroid/widget/ImageView;
    ...
    iput-object v4, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mBackgroundImageViewLock:Landroid/widget/ImageView;
    ...
    iput-object v4, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mBackgroundImageViewHome:Landroid/widget/ImageView;
    ...
    iput-object v4, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mBottomContainer:Landroid/view/ViewGroup;
    ...
    iput-object v4, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mWallpaperDescription:Landroid/widget/TextView;
    ...
    iput-object v4, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mSetAsWallpaperButton:Landroid/widget/Button;
    ...
    iput-object v4, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mCheckBoxMotionEffect:Landroid/widget/CheckBox;
    ...
    iput-object v4, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mTextMotionEffect:Landroid/widget/TextView;

    new-instance v4, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity$RoundPreviewContainer;

    invoke-direct {v4, p0, p0}, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity$RoundPreviewContainer;-><init>(Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;Landroid/content/Context;)V

    iput-object v4, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mRoundContainer:Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity$RoundPreviewContainer;

    const/4 v4, 0x0

    iput-boolean v4, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mSetAsWallpaper:Z
    ...
    sget-boolean v4, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->sConfigured:Z

    if-nez v4, :cond_1

    nop

    invoke-virtual {p0}, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->getApplication()Landroid/app/Application;

    move-result-object v4

    invoke-static {v4}, Lcom/android/systemui/util/SystemUIAnalytics;->initSystemUIAnalyticsStates(Landroid/app/Application;)V
...
.method protected onResume()V
    ...
    invoke-virtual {p0}, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->isInMultiWindowMode()Z
    ...
    invoke-virtual {p0}, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->semExitMultiWindowMode()Z
    ...
    iput v1, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mCurrentWhich:I
    ...
    const-string v3, "onResume() folderState = "
    ...
    iget-boolean v2, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mIsAodAvailable:Z

    if-eq v2, v1, :cond_4

    iput-boolean v1, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mIsAodAvailable:Z

    if-eqz v1, :cond_3

    iget-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mWallpaperDescription:Landroid/widget/TextView;
    ...
    :goto_0
    iget-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mInfinityView:Lcom/android/systemui/infinity/preview/KeyguardInfinityPreview;

    invoke-virtual {v2, v1}, Lcom/android/systemui/infinity/preview/KeyguardInfinityPreview;->setIsAodAvailable(Z)V

    :cond_4
    iget-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardWallpaperPreviewActivity;->mInfinityView:Lcom/android/systemui/infinity/preview/KeyguardInfinityPreview;

    invoke-virtual {v2}, Lcom/android/systemui/infinity/preview/KeyguardInfinityPreview;->onResume()V
