...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/KeyguardBottomAreaShortcutView;->mPluginLockMgr:Lcom/android/systemui/lockstar/PluginLockStarManager;
...
.method private shouldDisableShortcut()Z
    ...
    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/KeyguardBottomAreaShortcutView;->mPluginLockMgr:Lcom/android/systemui/lockstar/PluginLockStarManager;
...
.method private showShortcutsIfPossible()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/systemui/statusbar/KeyguardCircleAffordanceView;->setVisibility(I)V
...
.method private updateIndicationPosition()V
    ...
    invoke-static {v3}, Lcom/android/systemui/Rune;->isInDisplayFpSensorPositionHigh(Landroid/content/Context;)Z

    move-result v3

    if-eqz v3, :cond_2

    iget-object v3, p0, Lcom/android/systemui/statusbar/phone/KeyguardBottomAreaShortcutView;->mDisplay:Landroid/view/Display;
    ...
    sget v5, Lcom/android/systemui/Rune;->SECURITY_SUPPORT_SEC_IN_DISPLAY_FINGERPRINT_IMAGE_SIZE:I
    ...
    sget v7, Lcom/android/systemui/Rune;->SECURITY_SUPPORT_SEC_IN_DISPLAY_FINGERPRINT_IMAGE_SIZE:I
    ...
    invoke-virtual {v5, v3}, Lcom/android/systemui/statusbar/phone/KeyguardIndicationTextView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v5, p0, Lcom/android/systemui/statusbar/phone/KeyguardBottomAreaShortcutView;->mUpperFPIndication:Lcom/android/systemui/statusbar/phone/KeyguardIndicationTextView;

    const/4 v6, 0x0

    invoke-virtual {v5, v6}, Lcom/android/systemui/statusbar/phone/KeyguardIndicationTextView;->setVisibility(I)V
    ...
    invoke-virtual {v3, v5}, Lcom/android/systemui/statusbar/phone/KeyguardIndicationTextView;->setVisibility(I)V
    ...
    :goto_3
    iget-object v3, p0, Lcom/android/systemui/statusbar/phone/KeyguardBottomAreaShortcutView;->mPluginLockMgr:Lcom/android/systemui/lockstar/PluginLockStarManager;
    ...
    iget-object v4, p0, Lcom/android/systemui/statusbar/phone/KeyguardBottomAreaShortcutView;->mPluginLockMgr:Lcom/android/systemui/lockstar/PluginLockStarManager;
...
.method private updateLockIconPosition()V
    ...
    :goto_2
    iget-object v1, p0, Lcom/android/systemui/statusbar/phone/KeyguardBottomAreaShortcutView;->mPluginLockMgr:Lcom/android/systemui/lockstar/PluginLockStarManager;
...
.method private updateUsimTextArea()V
    .locals 5
...
.method protected updateLayout()V
    ...
    invoke-direct {p0}, Lcom/android/systemui/statusbar/phone/KeyguardBottomAreaShortcutView;->updateUsimTextArea()V
