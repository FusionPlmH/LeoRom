...
.method private init()V
    ...
    iput-boolean v0, p0, Lcom/android/systemui/statusbar/preview/NotificationPreviewIconSlotView;->mIsShadowShown:Z
...
.method private isOpenThemeAndThemeWallpaper()Z
    .locals 2
    ...
    sget-boolean v1, Lcom/android/systemui/Rune;->NOTI_SUPPORT_ONEUI_1_5:Z

    if-eqz v1, :cond_0

    invoke-virtual {v0}, Lcom/android/systemui/statusbar/NotificationColorPicker;->isOpenThemeWallpaperChanged()Z
...
.method private setChildProperty(Landroid/view/View;)V
    ...
    invoke-direct {p0}, Lcom/android/systemui/statusbar/preview/NotificationPreviewIconSlotView;->isOpenThemeAndThemeWallpaper()Z
    ...
    iget-boolean v6, p0, Lcom/android/systemui/statusbar/preview/NotificationPreviewIconSlotView;->mIsShadowShown:Z
...
.method private updateShadowAndTintColor(Landroid/widget/ImageView;)V
    ...
    invoke-virtual {v12, v0}, Landroid/widget/ImageView;->getTag(I)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v13}, Lcom/android/internal/util/NotificationColorUtil;->isGrayscaleIcon(Landroid/graphics/drawable/Drawable;)Z
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/systemui/statusbar/preview/NotificationPreviewIconSlotView;->isOpenThemeAndThemeWallpaper()Z
    ...
    invoke-direct {v11, v13}, Lcom/android/systemui/statusbar/preview/NotificationPreviewIconSlotView;->drawableToBitmap(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    :cond_0
    iget-boolean v0, v11, Lcom/android/systemui/statusbar/preview/NotificationPreviewIconSlotView;->mIsShadowShown:Z

    if-eqz v0, :cond_3

    invoke-virtual {v12, v2}, Landroid/widget/ImageView;->getTag(I)Ljava/lang/Object;
    ...
    invoke-direct/range {v0 .. v10}, Lcom/android/systemui/statusbar/preview/NotificationPreviewIconSlotView;->imgShadow(Landroid/graphics/Bitmap;IIIIIFFZLandroid/view/View;)Landroid/graphics/Bitmap;
    ...
    iget-boolean v0, v11, Lcom/android/systemui/statusbar/preview/NotificationPreviewIconSlotView;->mIsWallpaperWhite:Z
...
.method public getHorizontalContainerPadding()I
    .locals 2
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    const-string v7, "Tap icon only"

    invoke-static {v5, v6, v7}, Lcom/android/systemui/util/SystemUIAnalytics;->sendEventLog(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public refreshAllIcons()V
    .locals 3
...
.method public setDimens()V
    ...
    invoke-static {v0}, Lcom/android/systemui/Rune;->isWhiteStatusbarOrWallpaperOn(Landroid/content/Context;)Z
