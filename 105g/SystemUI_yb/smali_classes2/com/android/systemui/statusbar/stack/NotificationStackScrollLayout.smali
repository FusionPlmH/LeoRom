...
.field mDumpScreenCapture:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<",
            "Ljava/lang/String;",
...
.method private initView(Landroid/content/Context;)V
    ...
    iput v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mSidePaddings:I
...
.method private ncpDump(Ljava/io/PrintWriter;)V
    .locals 6
    ...
    const-string v5, " th notification : "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v3}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->getKey()Ljava/lang/String;
    ...
    invoke-virtual {v3, v5}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->getTag(I)Ljava/lang/Object;
...
.method private onInterceptTouchEventScroll(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v2, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mIsBeingDragged:Z
    ...
    :pswitch_0
    iget v1, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mActivePointerId:I
    ...
    iget v6, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mLastMotionY:I
    ...
    iget v7, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDownX:I
    ...
    iget v8, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mTouchSlop:I
    ...
    iput v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mLastMotionY:I

    iput v5, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDownX:I

    invoke-direct {p0}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->initVelocityTrackerIfNotExists()V
    ...
    const-string v6, " in onInterceptTouchEventScroll"
    ...
    :pswitch_1
    invoke-direct {p0, v1}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->setIsBeingDragged(Z)V
    ...
    iget v7, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mScrollX:I
    ...
    invoke-direct {p0, v4, v5, v1}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->getChildAtPosition(FFZ)Lcom/android/systemui/statusbar/ExpandableView;
    ...
    :cond_5
    iput v2, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mLastMotionY:I
    ...
    iput v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDownX:I
    ...
    invoke-direct {p0}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->initOrResetVelocityTracker()V

    iget-object v1, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    :cond_6
    invoke-direct {p0, p1}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->onSecondaryPointerUp(Landroid/view/MotionEvent;)V

    :cond_7
    :goto_1
    iget-boolean v1, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mIsBeingDragged:Z
...
.method private onScrollTouch(Landroid/view/MotionEvent;)Z
    ...
    const-string v8, " in onScrollTouch.MotionEvent.ACTION_POINTER_UP"
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v5}, Lcom/android/systemui/statusbar/stack/AmbientState;->isQsCustomizerShowing()Z
    ...
    invoke-virtual {v5}, Lcom/android/systemui/statusbar/stack/AmbientState;->getScrollY()I
    ...
    iget v5, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mMaxTopPadding:I
    ...
    iget-boolean v5, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mShouldShowShelfOnly:Z
    ...
    invoke-direct {p0, p2}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->ncpDump(Ljava/io/PrintWriter;)V

    iget-object v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDumpScreenCapture:Ljava/util/ArrayList;
    ...
    const-string v1, "\n\nStackScroller screenshot\n"

    invoke-virtual {p2, v1}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v1, "Captured ambient state"
    ...
    iget-object v2, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDumpScreenCapture:Ljava/util/ArrayList;
    ...
    const-string v3, " th notification : "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v3, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDumpScreenCapture:Ljava/util/ArrayList;
...
.method public getNotificationViewState(Lcom/android/systemui/statusbar/ExpandableNotificationRow;)Lcom/android/systemui/statusbar/stack/ViewState;
    .locals 1
...
.method public makeScreeShot()V
    ...
    iput-object v6, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDumpScreenCapture:Ljava/util/ArrayList;

    iget-object v6, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDumpScreenCapture:Ljava/util/ArrayList;
    ...
    iget-object v8, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mAmbientState:Lcom/android/systemui/statusbar/stack/AmbientState;

    invoke-virtual {v8}, Lcom/android/systemui/statusbar/stack/AmbientState;->getAmbientStateDump()Ljava/lang/String;
    ...
    iget-object v14, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mCurrentStackScrollState:Lcom/android/systemui/statusbar/stack/StackScrollState;

    invoke-virtual {v14, v9}, Lcom/android/systemui/statusbar/stack/StackScrollState;->getViewStateForView(Landroid/view/View;)Lcom/android/systemui/statusbar/stack/ExpandableViewState;

    move-result-object v14

    const-string v15, "    key:%s | x:%s | y:%s | a:%s | v:%s | ih:%s"

    const/4 v10, 0x6

    new-array v10, v10, [Ljava/lang/Object;

    invoke-virtual {v9}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->getKey()Ljava/lang/String;

    move-result-object v16

    aput-object v16, v10, v8

    invoke-virtual {v9}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->getX()F
    ...
    invoke-virtual {v9}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->getY()F
    ...
    invoke-virtual {v9}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->getAlpha()F
    ...
    invoke-virtual {v9}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->getIntrinsicHeight()I
    ...
    const-string v10, " | l:%s | is:%s | hs:%s | g:%s | d:%s"

    new-array v15, v11, [Ljava/lang/Object;

    iget v11, v14, Lcom/android/systemui/statusbar/stack/ExpandableViewState;->location:I
    ...
    iget-boolean v11, v14, Lcom/android/systemui/statusbar/stack/ExpandableViewState;->inShelf:Z
    ...
    iget-boolean v11, v14, Lcom/android/systemui/statusbar/stack/ExpandableViewState;->hideSensitive:Z
    ...
    iget-boolean v11, v14, Lcom/android/systemui/statusbar/stack/ExpandableViewState;->gone:Z
    ...
    iget-boolean v11, v14, Lcom/android/systemui/statusbar/stack/ExpandableViewState;->dimmed:Z
    ...
    :cond_0
    iget-object v10, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDumpScreenCapture:Ljava/util/ArrayList;

    invoke-virtual {v10, v6, v8}, Ljava/util/ArrayList;->add(ILjava/lang/Object;)V

    :cond_1
    instance-of v8, v7, Lcom/android/systemui/statusbar/NotificationShelf;

    if-eqz v8, :cond_2

    move-object v8, v7

    check-cast v8, Lcom/android/systemui/statusbar/NotificationShelf;

    const-string v9, "    SHELF | x:%s | y:%s | a:%s | v:%s | ih:%s"

    const/4 v10, 0x5

    new-array v10, v10, [Ljava/lang/Object;

    invoke-virtual {v8}, Lcom/android/systemui/statusbar/NotificationShelf;->getX()F
    ...
    invoke-virtual {v8}, Lcom/android/systemui/statusbar/NotificationShelf;->getY()F
    ...
    invoke-virtual {v8}, Lcom/android/systemui/statusbar/NotificationShelf;->getAlpha()F
...
.method public setAlpha(F)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/systemui/statusbar/stack/AmbientState;->setStackAlpha(F)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/systemui/statusbar/stack/AmbientState;->setStackAlphaLog(Ljava/lang/String;)V
