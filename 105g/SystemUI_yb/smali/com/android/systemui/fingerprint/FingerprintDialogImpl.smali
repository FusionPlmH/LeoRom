...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/systemui/fingerprint/FingerprintDialogImpl$SemDisplayBrightnessListener;,
        Lcom/android/systemui/fingerprint/FingerprintDialogImpl$OnBrightnessListener;,
...
.field protected static SENSOR_BOTTOM_MARGIN_BOUNDARY_RECENT_HOME_KEY:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->SENSOR_BOTTOM_MARGIN_BOUNDARY_RECENT_HOME_KEY:Ljava/lang/String;
...
.method static synthetic access$1000(Lcom/android/systemui/fingerprint/FingerprintDialogImpl;I)V
    .locals 0
...
.method static synthetic access$1100(Lcom/android/systemui/fingerprint/FingerprintDialogImpl;IILjava/lang/String;)V
    .locals 0
...
.method static synthetic access$700(Lcom/android/systemui/fingerprint/FingerprintDialogImpl;)Landroid/os/IBinder;
    .locals 1

    iget-object v0, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mToken:Landroid/os/IBinder;
...
.method static synthetic access$900(Lcom/android/systemui/fingerprint/FingerprintDialogImpl;)V
    .locals 0
...
.method private handleFingerprintEvent(IILjava/lang/String;)V
    ...
    :cond_0
    invoke-virtual {v2, v0}, Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;->handleSensorView(Z)V
    ...
    :cond_1
    invoke-virtual {v2, v0}, Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;->handleOverlayMaskView(Z)V
    ...
    sget v4, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mMaxMovingHalfSize:I

    sub-int/2addr v3, v4

    iget v4, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mIconLocationY:I

    sget v5, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mMaxMovingHalfSize:I
    ...
    :cond_6
    invoke-direct {p0, p2}, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->handleMaskViewStandAloneMode(I)V
...
.method private handleFingerprintHelp(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p1}, Lcom/android/systemui/fingerprint/SemFingerprintPromptView;->showHelpMessage(ILjava/lang/String;)V
...
.method private handleHideDialog(Z)V
    ...
    invoke-virtual {v0}, Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;->isKeepInstance()Z
    ...
    const-string v3, "handleHideDialog: Keep instance"

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v3, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mSemMakViewManager:Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;
...
.method private handleMaskViewStandAloneMode(I)V
    .locals 3
    ...
    const-string v1, "handleMaskViewStandAloneMode: ViewManager is NULL"
    ...
    invoke-virtual {v0}, Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;->removeSensorIcon()V

    iget-object v0, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mSemMakViewManager:Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;

    invoke-virtual {v0}, Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;->removeGreenIcon()V

    iget-object v0, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mSemMakViewManager:Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;

    invoke-virtual {v0}, Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;->removeAlphaMask()V

    iget-object v0, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mSemMakViewManager:Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;

    const/16 v1, 0x20

    invoke-virtual {v0, v1}, Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;->clearMaskType(I)V
    ...
    const-string v2, "handleMaskViewStandAloneMode: Keep instance"
    ...
    iput-object v0, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mSemMakViewManager:Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;
...
.method private handleShowDialog(Lcom/android/internal/os/SomeArgs;)V
    ...
    invoke-virtual {v0}, Lcom/android/systemui/fingerprint/SemFingerprintPromptView;->getIsHideNavigation()Z
    ...
    invoke-virtual {v0}, Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;->show()Z
    ...
    const-string v2, "handleShowDialog: Failed to show"
...
.method public showFingerprintDialog(Landroid/os/Bundle;Landroid/hardware/biometrics/IBiometricPromptReceiver;)V
    ...
    const-string/jumbo v0, "sem_ux_type"
    ...
    new-instance v1, Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;
    ...
    invoke-direct/range {v4 .. v11}, Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;-><init>(Landroid/content/Context;Landroid/os/Handler;Landroid/view/WindowManager;Landroid/os/Bundle;ILandroid/hardware/biometrics/IBiometricPromptReceiver;Z)V

    iput-object v1, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mSemMakViewManager:Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;

    iget-object v1, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mSemMakViewManager:Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;

    invoke-virtual {v1}, Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;->showAlphaSA()V
    ...
    const-string/jumbo v2, "showFingerprintDialog :[SA] view already exist"

    invoke-static {v1, v2}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v1, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mSemMakViewManager:Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;

    invoke-virtual {v1, v3}, Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;->addMaskType(I)V

    iget-object v1, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mSemMakViewManager:Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;

    invoke-virtual {v1}, Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;->addAlphaMask()V
    ...
    const-string v5, "FingerprintDialogImpl"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v7, "showFingerprintDialog: start, current token =  "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v7, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mToken:Landroid/os/IBinder;
    ...
    iget-object v5, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mToken:Landroid/os/IBinder;
    ...
    invoke-direct {p0, v4}, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->handleHideDialog(Z)V
    ...
    const-string/jumbo v6, "showFingerprintDialog: prompt = "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v6, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mIsPrompt:Z
    ...
    sget-boolean v5, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->DEBUG:Z

    if-eqz v5, :cond_8

    const-string/jumbo v5, "sem_debug_aosp_ux"
    ...
    invoke-direct {v2, v4, v5}, Lcom/android/systemui/fingerprint/FingerprintDialogView;-><init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    :cond_8
    sput-boolean v4, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->USE_AOSP_PROMPT:Z
    ...
    invoke-direct {v2, v4, v5, v6, v7}, Lcom/android/systemui/fingerprint/SemFingerprintPromptView;-><init>(Landroid/content/Context;Landroid/os/Handler;Landroid/view/WindowManager;Landroid/os/IBinder;)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;->hasMaskType(I)Z
    ...
    const-string/jumbo v3, "showFingerprintDialog: AlphaMask SA mode"
    ...
    invoke-virtual {v2, p1, v3, v4, p2}, Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;->updaterClientInfo(Landroid/os/Bundle;IZLandroid/hardware/biometrics/IBiometricPromptReceiver;)V

    iget-object v2, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mSemMakViewManager:Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;

    invoke-virtual {v2}, Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;->show()Z
    ...
    const-string/jumbo v3, "showFingerprintDialog : MaskView already showing"
    ...
    const-string/jumbo v6, "showFingerprintDialog : MASK = "
    ...
    sput v4, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mMaxMovingSize:I

    sget v4, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mMaxMovingSize:I
    ...
    iget-object v6, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mContext:Landroid/content/Context;

    iget-object v7, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mHandler:Landroid/os/Handler;

    iget-object v8, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mWindowManager:Landroid/view/WindowManager;

    iget-boolean v12, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mIsPrompt:Z
    ...
    invoke-direct/range {v5 .. v12}, Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;-><init>(Landroid/content/Context;Landroid/os/Handler;Landroid/view/WindowManager;Landroid/os/Bundle;ILandroid/hardware/biometrics/IBiometricPromptReceiver;Z)V
    ...
    iget-boolean v3, p0, Lcom/android/systemui/fingerprint/FingerprintDialogImpl;->mIsPrompt:Z

    invoke-virtual {v2, p1, v1, v3, p2}, Lcom/android/systemui/fingerprint/SemFingerprintMaskViewManager;->updaterClientInfo(Landroid/os/Bundle;IZLandroid/hardware/biometrics/IBiometricPromptReceiver;)V
