...
.method private getClockType(Z)I
    ...
    invoke-direct {p0}, Lcom/android/systemui/servicebox/pages/clock/KeyguardClockPage;->isDynamicClockEnabled()Z
...
.method private isClockGravityStart()Z
    .locals 2
    ...
    invoke-virtual {v0}, Lcom/android/systemui/lockstar/PluginLockStarManager;->getClockGravity()I
...
.method private isDynamicClockEnabled()Z
    .locals 1
    ...
    invoke-direct {p0}, Lcom/android/systemui/servicebox/pages/clock/KeyguardClockPage;->isRoamClock()Z
...
.method private updateScaleMode(Z)V
    ...
    iget-object v1, p0, Lcom/android/systemui/servicebox/pages/clock/KeyguardClockPage;->mOwnerInfoMgr:Lcom/android/systemui/servicebox/KeyguardServiceBoxOwnerInfoMgr;

    invoke-virtual {v1}, Lcom/android/systemui/servicebox/KeyguardServiceBoxOwnerInfoMgr;->isEnabled()Z

    move-result v5

    iget-object v1, p0, Lcom/android/systemui/servicebox/pages/clock/KeyguardClockPage;->mServiceBoxController:Lcom/android/systemui/servicebox/KeyguardServiceBoxController;

    invoke-interface {v1}, Lcom/android/systemui/servicebox/KeyguardServiceBoxController;->isEnabledBioUnlock()Z

    move-result v6

    iget-object v1, p0, Lcom/android/systemui/servicebox/pages/clock/KeyguardClockPage;->mServiceBoxController:Lcom/android/systemui/servicebox/KeyguardServiceBoxController;

    invoke-interface {v1}, Lcom/android/systemui/servicebox/KeyguardServiceBoxController;->getNotificationCount()I
    ...
    :goto_1
    iget-object v9, p0, Lcom/android/systemui/servicebox/pages/clock/KeyguardClockPage;->mContext:Landroid/content/Context;

    invoke-static/range {v4 .. v9}, Lcom/android/systemui/servicebox/KeyguardServiceBoxAttribute;->getScaleMode(ZZZIZLandroid/content/Context;)I
...
.method public getPaddingRect(Landroid/graphics/Rect;I)Z
    ...
    invoke-direct {p0}, Lcom/android/systemui/servicebox/pages/clock/KeyguardClockPage;->isClockGravityStart()Z
...
.method public prepareTransition(Lcom/android/systemui/servicebox/utils/SecTransition;)V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/systemui/servicebox/pages/clock/KeyguardClockPage;->isDynamicClockEnabled()Z
...
.method public runDetermineClockType(Lcom/android/systemui/servicebox/pages/clock/KeyguardClockPage$ClockTypeResult;Z)V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/systemui/servicebox/pages/clock/KeyguardClockPage;->needToShowHorizontalClock()Z
