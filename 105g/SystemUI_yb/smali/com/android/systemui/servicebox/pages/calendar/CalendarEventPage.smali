...
.method protected onChangedSidePadding()V
    ...
    invoke-virtual {p0}, Lcom/android/systemui/servicebox/pages/calendar/CalendarEventPage;->getPaddingStart()I

    move-result v1

    sub-int/2addr v1, v0

    invoke-virtual {p0}, Lcom/android/systemui/servicebox/pages/calendar/CalendarEventPage;->getPaddingTop()I

    move-result v2

    invoke-virtual {p0}, Lcom/android/systemui/servicebox/pages/calendar/CalendarEventPage;->getPaddingEnd()I

    move-result v3

    sub-int/2addr v3, v0

    invoke-virtual {p0}, Lcom/android/systemui/servicebox/pages/calendar/CalendarEventPage;->getPaddingBottom()I

    move-result v4

    invoke-virtual {p0, v1, v2, v3, v4}, Lcom/android/systemui/servicebox/pages/calendar/CalendarEventPage;->setPadding(IIII)V
