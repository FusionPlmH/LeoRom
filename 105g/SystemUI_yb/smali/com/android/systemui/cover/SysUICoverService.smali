...
.method public static synthetic lambda$new$0(Lcom/android/systemui/cover/SysUICoverService;)V
    .locals 3
    ...
    const-string/jumbo v1, "updateCoverWindowLp: CWD is null"
    ...
    sget-object v1, Lcom/android/systemui/cover/SysUICoverService;->TAG:Ljava/lang/String;

    const-string/jumbo v2, "updateCoverWindowLp: lp is null"
    ...
    :cond_1
    iget-boolean v1, p0, Lcom/android/systemui/cover/SysUICoverService;->mIsNeedSleepToken:Z
    ...
    invoke-virtual {v1, v0}, Lcom/android/systemui/cover/CoverWindowDelegate;->setLayoutParams(Landroid/view/WindowManager$LayoutParams;)V
...
.method private updateCoverWindowLp(Lcom/samsung/android/cover/CoverState;Z)V
    ...
    const-string/jumbo v1, "updateCoverWindowLp: CS is null"
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/systemui/cover/SysUICoverService;->mIsNeedSleepToken:Z

    iget-object v0, p0, Lcom/android/systemui/cover/SysUICoverService;->mHandler:Landroid/os/Handler;

    iget-object v1, p0, Lcom/android/systemui/cover/SysUICoverService;->mUpdateCoverWindowLpTask:Ljava/lang/Runnable;
...
.method public onCoverStateUpdated(Lcom/samsung/android/cover/CoverState;)V
    ...
    const-string/jumbo v1, "onCoverStateUpdated need to register mScreenLifecycle.Observer"
...
.method public bridge synthetic onPluginDisconnected(Lcom/samsung/systemui/splugins/SPlugin;I)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/systemui/cover/SysUICoverService;->onPluginDisconnected(Lcom/samsung/systemui/splugins/cover/PluginViewCover;I)V

    return-void
.end method

.method public onPluginDisconnected(Lcom/samsung/systemui/splugins/cover/PluginViewCover;I)V
    .locals 2
