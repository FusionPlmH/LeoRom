...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    const-string v1, "Unable to onConfigurationChanged in a managed profile "
...
.method public start()V
    ...
    const-string v2, "Unable to run in a managed profile "
    ...
    new-instance v4, Lcom/android/systemui/recents/RecentsDebugFlags;

    invoke-direct {v4}, Lcom/android/systemui/recents/RecentsDebugFlags;-><init>()V

    sput-object v4, Lcom/android/systemui/recents/Recents;->sDebugFlags:Lcom/android/systemui/recents/RecentsDebugFlags;
    ...
    sput-object v4, Lcom/android/systemui/recents/Recents;->sSystemServicesProxy:Lcom/android/systemui/recents/misc/SystemServicesProxy;

    new-instance v4, Lcom/android/systemui/recents/RecentsConfiguration;

    iget-object v5, p0, Lcom/android/systemui/recents/Recents;->mContext:Landroid/content/Context;

    invoke-direct {v4, v5}, Lcom/android/systemui/recents/RecentsConfiguration;-><init>(Landroid/content/Context;)V

    sput-object v4, Lcom/android/systemui/recents/Recents;->sConfiguration:Lcom/android/systemui/recents/RecentsConfiguration;

    new-instance v4, Lcom/android/systemui/recents/TaskLockPreference;

    iget-object v5, p0, Lcom/android/systemui/recents/Recents;->mContext:Landroid/content/Context;

    invoke-direct {v4, v5}, Lcom/android/systemui/recents/TaskLockPreference;-><init>(Landroid/content/Context;)V

    sput-object v4, Lcom/android/systemui/recents/Recents;->sTaskLockPreference:Lcom/android/systemui/recents/TaskLockPreference;
    ...
    invoke-direct {v4, v5, v6, v7, v8}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;-><init>(Landroid/content/Context;III)V

    sput-object v4, Lcom/android/systemui/recents/Recents;->sTaskLoader:Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;

    sget-object v4, Lcom/android/systemui/recents/Recents;->sTaskLoader:Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;

    invoke-virtual {v4, v2, v3}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;->setDefaultColors(II)V

    new-instance v4, Landroid/os/Handler;

    invoke-direct {v4}, Landroid/os/Handler;-><init>()V

    iput-object v4, p0, Lcom/android/systemui/recents/Recents;->mHandler:Landroid/os/Handler;

    new-instance v4, Lcom/android/systemui/recents/RecentsImpl;

    iget-object v5, p0, Lcom/android/systemui/recents/Recents;->mContext:Landroid/content/Context;

    invoke-direct {v4, v5}, Lcom/android/systemui/recents/RecentsImpl;-><init>(Landroid/content/Context;)V

    iput-object v4, p0, Lcom/android/systemui/recents/Recents;->mImpl:Lcom/android/systemui/recents/RecentsImpl;
    ...
    iput-object v4, p0, Lcom/android/systemui/recents/Recents;->mOverviewProxyService:Lcom/android/systemui/OverviewProxyService;
    ...
    sget-object v6, Lcom/android/systemui/recents/Recents;->sSystemServicesProxy:Lcom/android/systemui/recents/misc/SystemServicesProxy;

    invoke-virtual {v4, v6, v5}, Lcom/android/systemui/recents/events/EventBus;->register(Ljava/lang/Object;I)V

    invoke-static {}, Lcom/android/systemui/recents/events/EventBus;->getDefault()Lcom/android/systemui/recents/events/EventBus;

    move-result-object v4

    sget-object v6, Lcom/android/systemui/recents/Recents;->sTaskLoader:Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;
    ...
    invoke-virtual {v5, v4}, Lcom/android/systemui/recents/misc/SystemServicesProxy;->isSystemUser(I)Z
    ...
    new-instance v5, Lcom/android/systemui/recents/RecentsSystemUser;

    iget-object v6, p0, Lcom/android/systemui/recents/Recents;->mContext:Landroid/content/Context;

    iget-object v7, p0, Lcom/android/systemui/recents/Recents;->mImpl:Lcom/android/systemui/recents/RecentsImpl;

    invoke-direct {v5, v6, v7}, Lcom/android/systemui/recents/RecentsSystemUser;-><init>(Landroid/content/Context;Lcom/android/systemui/recents/RecentsImpl;)V

    iput-object v5, p0, Lcom/android/systemui/recents/Recents;->mSystemToUserCallbacks:Lcom/android/systemui/recents/RecentsSystemUser;
    ...
    :goto_0
    const-class v5, Lcom/android/systemui/recents/Recents;

    invoke-virtual {p0, v5, p0}, Lcom/android/systemui/recents/Recents;->putComponent(Ljava/lang/Class;Ljava/lang/Object;)V
    ...
    iput-object v5, p0, Lcom/android/systemui/recents/Recents;->mTrustManager:Landroid/app/trust/TrustManager;
