...
.field mPadding:Landroid/util/Pair;
...
.method private getDisplayHeight()I
    ...
    :goto_0
    invoke-direct {p0, v0}, Lcom/android/systemui/qs/QSContainerImpl;->getDisplayHeight(Z)I
...
.method private getDisplayHeight(Z)I
    ...
    const-string v3, "getDisplayHeight portrait? "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, p1}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v3, "  mSizePoint.y= "
...
.method public onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    iget-object v2, p0, Lcom/android/systemui/qs/QSContainerImpl;->mPadding:Landroid/util/Pair;
    ...
    iput-object v1, p0, Lcom/android/systemui/qs/QSContainerImpl;->mPadding:Landroid/util/Pair;
...
.method protected onMeasure(II)V
    ...
    iget v4, p0, Lcom/android/systemui/qs/QSContainerImpl;->mSystemIconsHeight:I

    add-int/2addr v3, v4

    iget v4, p0, Lcom/android/systemui/qs/QSContainerImpl;->mHeaderIconsHeight:I

    add-int/2addr v3, v4

    iget v4, p0, Lcom/android/systemui/qs/QSContainerImpl;->mHeaderBottomMargin:I

    add-int/2addr v3, v4

    iget v4, p0, Lcom/android/systemui/qs/QSContainerImpl;->mExtendedAppBarHeight:I
    ...
    :cond_2
    iget-object v6, p0, Lcom/android/systemui/qs/QSContainerImpl;->mContext:Landroid/content/Context;

    invoke-static {v6}, Lcom/android/systemui/util/DeviceState;->isMobileKeyboardConnected(Landroid/content/Context;)Z
    ...
    iget v7, p0, Lcom/android/systemui/qs/QSContainerImpl;->mNaviBarHeight:I
    ...
    iget-object v5, p0, Lcom/android/systemui/qs/QSContainerImpl;->mQSCustomizer:Lcom/android/systemui/qs/customize/SecQSCustomizer;
    ...
    invoke-virtual {v5, p1, v4}, Lcom/android/systemui/qs/customize/SecQSCustomizer;->measure(II)V
...
.method public updateResources()V
    ...
    :goto_0
    iget-object v5, p0, Lcom/android/systemui/qs/QSContainerImpl;->mServiceBox:Lcom/android/systemui/qs/QSServiceBox;

    invoke-virtual {v5}, Lcom/android/systemui/qs/QSServiceBox;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;

    move-result-object v5

    check-cast v5, Landroid/widget/FrameLayout$LayoutParams;

    iput v4, p0, Lcom/android/systemui/qs/QSContainerImpl;->mSystemIconsHeight:I

    iget-object v6, p0, Lcom/android/systemui/qs/QSContainerImpl;->mDisplayCutout:Landroid/view/DisplayCutout;
    ...
    iget-object v7, p0, Lcom/android/systemui/qs/QSContainerImpl;->mDisplayCutout:Landroid/view/DisplayCutout;
    ...
    iput v6, p0, Lcom/android/systemui/qs/QSContainerImpl;->mSystemIconsHeight:I

    :cond_1
    iget v6, p0, Lcom/android/systemui/qs/QSContainerImpl;->mSystemIconsHeight:I
    ...
    invoke-virtual {v2, v5}, Lcom/android/systemui/qs/QSServiceBox;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    goto/16 :goto_5

    :cond_4
    :goto_1
    iget-boolean v6, p0, Lcom/android/systemui/qs/QSContainerImpl;->mIsCenterCutoutDevice:Z
    ...
    iget-object v6, p0, Lcom/android/systemui/qs/QSContainerImpl;->mQSDetailHeaderContainer:Landroid/view/View;
    ...
    iget-object v7, p0, Lcom/android/systemui/qs/QSContainerImpl;->mQSEmptyButtonsContainer:Landroid/view/View;
    ...
    :goto_2
    iget-object v9, p0, Lcom/android/systemui/qs/QSContainerImpl;->mContext:Landroid/content/Context;

    invoke-virtual {v9}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v9

    const v10, 0x7f0705d5

    invoke-virtual {v9, v10}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v9

    iput v9, p0, Lcom/android/systemui/qs/QSContainerImpl;->mHeaderIconsHeight:I
    ...
    iput v9, p0, Lcom/android/systemui/qs/QSContainerImpl;->mHeaderBottomMargin:I
    ...
    :goto_4
    iget v9, p0, Lcom/android/systemui/qs/QSContainerImpl;->mSystemIconsHeight:I
    ...
    iget v10, p0, Lcom/android/systemui/qs/QSContainerImpl;->mHeaderIconsHeight:I

    sub-int/2addr v9, v10

    iget v10, p0, Lcom/android/systemui/qs/QSContainerImpl;->mHeaderBottomMargin:I

    sub-int/2addr v9, v10

    iput v9, p0, Lcom/android/systemui/qs/QSContainerImpl;->mExtendedAppBarHeight:I

    iget v9, p0, Lcom/android/systemui/qs/QSContainerImpl;->mExtendedAppBarHeight:I
    ...
    iget-object v9, p0, Lcom/android/systemui/qs/QSContainerImpl;->mQSDetailHeaderContainer:Landroid/view/View;

    invoke-virtual {v9, v6}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v9, p0, Lcom/android/systemui/qs/QSContainerImpl;->mQSBigTimeContainer:Landroid/view/View;

    invoke-virtual {v9, v3}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v9, p0, Lcom/android/systemui/qs/QSContainerImpl;->mQSEmptyButtonsContainer:Landroid/view/View;

    invoke-virtual {v9, v7}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v9, p0, Lcom/android/systemui/qs/QSContainerImpl;->mServiceBox:Lcom/android/systemui/qs/QSServiceBox;

    invoke-virtual {v9, v5}, Lcom/android/systemui/qs/QSServiceBox;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
