...
.method private updateResources()V
    ...
    invoke-virtual {v5}, Lcom/android/systemui/statusbar/phone/TwoPhoneModeController;->isTwoPhoneUserCreated()Z

    move-result v5

    if-eqz v5, :cond_6

    iget-object v6, p0, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->mSmallClock:Lcom/android/systemui/statusbar/policy/QSClock;

    iget v7, p0, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->mDefaultTextSize:F

    const v8, 0x3f4ccccd    # 0.8f

    mul-float/2addr v7, v8

    invoke-virtual {v6, v3, v7}, Lcom/android/systemui/statusbar/policy/QSClock;->setTextSize(IF)V

    iget-object v6, p0, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->mSmallDate:Lcom/android/systemui/statusbar/policy/DateView;

    iget v7, p0, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->mDefaultTextSize:F

    mul-float/2addr v7, v8

    invoke-virtual {v6, v3, v7}, Lcom/android/systemui/statusbar/policy/DateView;->setTextSize(IF)V
