...
.field private mSecurityMessage:Lcom/android/keyguard/KeyguardMessageArea;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean v2, p0, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->mIsBiometricLockoutPWView:Z
    ...
    new-instance v0, Lcom/android/keyguard/KeyguardSecAbsKeyInputView$4;

    invoke-direct {v0, p0}, Lcom/android/keyguard/KeyguardSecAbsKeyInputView$4;-><init>(Lcom/android/keyguard/KeyguardSecAbsKeyInputView;)V

    iput-object v0, p0, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->mDisplayListener:Lcom/android/systemui/keyguard/DisplayLifecycle$Observer;
...
.method static synthetic access$1000(Lcom/android/keyguard/KeyguardSecAbsKeyInputView;)Landroid/content/Context;
    .locals 1
...
.method static synthetic access$1200(Lcom/android/keyguard/KeyguardSecAbsKeyInputView;J)V
    .locals 0
...
.method static synthetic access$1300(Lcom/android/keyguard/KeyguardSecAbsKeyInputView;)Z
    ...
    iget-boolean v0, p0, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->mIsBiometricLockoutPWView:Z

    return v0
.end method

.method static synthetic access$1302(Lcom/android/keyguard/KeyguardSecAbsKeyInputView;Z)Z
    .locals 0
...
.method static synthetic access$1400(Lcom/android/keyguard/KeyguardSecAbsKeyInputView;)Lcom/android/keyguard/KeyguardHintTextArea;
    .locals 1
...
.method static synthetic access$1500(Lcom/android/keyguard/KeyguardSecAbsKeyInputView;)Z
    .locals 1
...
.method static synthetic access$1600(Lcom/android/keyguard/KeyguardSecAbsKeyInputView;)V
    .locals 0
...
.method static synthetic access$1700(Lcom/android/keyguard/KeyguardSecAbsKeyInputView;)V
    .locals 0
...
.method static synthetic access$1800(Lcom/android/keyguard/KeyguardSecAbsKeyInputView;)Ljava/lang/Runnable;
    .locals 1
...
.method static synthetic access$1900(Lcom/android/keyguard/KeyguardSecAbsKeyInputView;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic access$2000(Lcom/android/keyguard/KeyguardSecAbsKeyInputView;)Z
    .locals 1
...
.method static synthetic access$2002(Lcom/android/keyguard/KeyguardSecAbsKeyInputView;Z)Z
    .locals 0
...
.method static synthetic access$600(Lcom/android/keyguard/KeyguardSecAbsKeyInputView;)Z
    .locals 1
...
.method static synthetic access$700(Lcom/android/keyguard/KeyguardSecAbsKeyInputView;I)Z
    .locals 1
...
.method static synthetic access$800(Lcom/android/keyguard/KeyguardSecAbsKeyInputView;)Lcom/android/keyguard/KeyguardMessageArea;
    .locals 1
...
.method static synthetic access$900(Lcom/android/keyguard/KeyguardSecAbsKeyInputView;)Landroid/content/Context;
    .locals 1
...
.method private updateLandscapeLayout(I)V
    ...
    invoke-virtual {v9, v8, v3, v8, v8}, Landroid/widget/LinearLayout;->setPadding(IIII)V
    ...
    invoke-virtual {v6}, Lcom/android/systemui/keyguard/DisplayLifecycle;->getSize()Landroid/graphics/Point;
...
.method private updateLayout(I)V
    ...
    invoke-direct {p0, v0}, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->updateRotationSize(I)V
...
.method private updatePortraitLayout(I)V
    ...
    :goto_1
    iget-object v7, p0, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->mPasswordEntryBoxLayout:Landroid/view/ViewGroup;
    ...
    invoke-virtual {v1, v4}, Lcom/android/keyguard/KeyguardMessageArea;->setVisibility(I)V
    ...
    :goto_6
    iget-object v2, p0, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->mSecurityMessage:Lcom/android/keyguard/KeyguardMessageArea;
...
.method private updateRotationSize(I)V
    .locals 5
...
.method private updateTabletLayout(II)V
    ...
    invoke-direct {p0, v7}, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->isSimSecurityView(I)Z
...
.method protected onPasswordChecked(IZIZLjava/lang/String;)V
    ...
    iget-object v9, v1, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->mKnoxStateMonitor:Lcom/android/systemui/KnoxStateMonitor;

    invoke-virtual {v9}, Lcom/android/systemui/KnoxStateMonitor;->isPwdChangeRequested()Z
    ...
    iget-object v9, v1, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    const-string v14, "android.app.action.CHANGE_DEVICE_PASSWORD"

    invoke-direct {v13, v14}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    const-string v14, "com.android.settings"

    const-string v15, "com.android.settings.password.ChooseLockPassword"
    ...
    invoke-virtual {v13, v14, v10}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string v14, "lockscreen.password_min"

    invoke-virtual {v13, v14, v11}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string v14, "lockscreen.password_max"

    invoke-virtual {v13, v14, v12}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string v14, "lockscreen.password_old"

    iget-object v15, v1, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->mEntry:Ljava/lang/String;
    ...
    const-string v14, "confirm_credentials"

    invoke-virtual {v13, v14, v5}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string v14, "isRecovery"
    ...
    const-string v15, "KeyguardSecAbsKeyInputView"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v6, "resetPassword : encyptionStatus is "
    ...
    invoke-virtual {v0, v13, v5}, Landroid/content/Context;->startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
    :try_end_0
    ...
    const-string v8, "Can\'t find the component "
    ...
    invoke-interface {v0, v2, v5, v6}, Lcom/android/keyguard/KeyguardSecurityCallback;->reportUnlockAttempt(IZI)V

    if-eqz v7, :cond_5

    iput-boolean v5, v1, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->mDismissing:Z

    iget-object v0, v1, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->mCallback:Lcom/android/keyguard/KeyguardSecurityCallback;

    invoke-interface {v0, v5, v2}, Lcom/android/keyguard/KeyguardSecurityCallback;->dismiss(ZI)V
    ...
    iget-object v5, v1, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->mVibrator:Landroid/os/Vibrator;

    invoke-virtual {v5}, Landroid/os/Vibrator;->semGetSupportedVibrationType()I
    ...
    invoke-static {v0, v6, v5}, Landroid/os/VibrationEffect;->semCreateHaptic(IILandroid/os/VibrationEffect$SemMagnitudeType;)Landroid/os/VibrationEffect;
    ...
    invoke-interface {v0, v2, v6, v4}, Lcom/android/keyguard/KeyguardSecurityCallback;->reportUnlockAttempt(IZI)V
    ...
    iget-object v6, v1, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->mHintText:Lcom/android/keyguard/KeyguardHintTextArea;

    invoke-virtual {v6}, Lcom/android/keyguard/KeyguardHintTextArea;->getVisibility()I
    ...
    iget-object v0, v1, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->mHintText:Lcom/android/keyguard/KeyguardHintTextArea;

    const/4 v6, 0x0

    invoke-virtual {v0, v6}, Lcom/android/keyguard/KeyguardHintTextArea;->setVisibility(I)V
    ...
    sget-boolean v6, Lcom/android/systemui/Rune;->SECURITY_SUPPORT_PASSWORD_HINT:Z
    ...
    invoke-virtual {v6, v0}, Lcom/android/keyguard/KeyguardHintTextArea;->setVisibility(I)V

    :cond_b
    iget-object v0, v1, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    invoke-virtual {v0, v2, v4}, Lcom/android/internal/widget/LockPatternUtils;->setLockoutAttemptDeadline(II)J

    move-result-wide v9

    invoke-virtual {v1, v9, v10}, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->handleAttemptLockout(J)V
    ...
    invoke-direct {v1, v2, v6}, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->reportAuditLog(ILjava/lang/String;)V
    ...
    invoke-virtual {v0, v8}, Lcom/android/keyguard/KeyguardUpdateMonitor;->getAddRemainingAttempt(I)I
    ...
    invoke-direct {v1, v8}, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->getStringFromId(I)Ljava/lang/String;

    move-result-object v8

    if-lez v0, :cond_f

    iget-object v9, v1, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->mSecurityMessageDisplay:Lcom/android/keyguard/SecurityMessageDisplay;
    ...
    invoke-interface {v9, v10}, Lcom/android/keyguard/SecurityMessageDisplay;->setMessage(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v9, v8}, Lcom/android/keyguard/SecurityMessageDisplay;->setMessage(Ljava/lang/CharSequence;)V

    :goto_9
    iget-object v9, v1, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->mSecurityMessageDisplay:Lcom/android/keyguard/SecurityMessageDisplay;

    invoke-interface {v9}, Lcom/android/keyguard/SecurityMessageDisplay;->displayFailedAnimation()V
    ...
    invoke-virtual {v1, v8, v0}, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->resetPasswordText(ZZ)V
...
.method protected setSubSecurityMessage(II)V
    ...
    invoke-virtual {v0}, Lcom/android/keyguard/KeyguardMessageArea;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {v2, v0}, Lcom/android/keyguard/KeyguardMessageArea;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v2, p0, Lcom/android/keyguard/KeyguardSecAbsKeyInputView;->mSubSecurityMessage:Lcom/android/keyguard/KeyguardMessageArea;

    invoke-virtual {v2, v1}, Lcom/android/keyguard/KeyguardMessageArea;->setVisibility(I)V
