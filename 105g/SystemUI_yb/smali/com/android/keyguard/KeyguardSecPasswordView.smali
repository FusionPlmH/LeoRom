...
.method protected displayDefaultSecurityMessage()V
    ...
    invoke-virtual {p0}, Lcom/android/keyguard/KeyguardSecPasswordView;->isBiometricsCondition()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/keyguard/KeyguardSecPasswordView;->mDisplay:Landroid/view/Display;
    ...
    invoke-virtual {p0}, Lcom/android/keyguard/KeyguardSecPasswordView;->getReversePortraitStringForTablet()Ljava/lang/String;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v4, v0, Lcom/android/keyguard/KeyguardSecPasswordView;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v4}, Lcom/android/systemui/util/SettingsHelper;->isNavigationBarForceHide()Z
    ...
    invoke-static {v4}, Lcom/android/systemui/Rune;->shouldEnableKeyguardScreenRotation(Landroid/content/Context;)Z
    ...
    iget-object v4, v0, Lcom/android/keyguard/KeyguardSecPasswordView;->mEcaView:Landroid/view/View;
    ...
    :cond_a
    iget-object v3, v0, Lcom/android/keyguard/KeyguardSecPasswordView;->mSwitchImeButton:Landroid/view/View;
    ...
    iget-object v3, v0, Lcom/android/keyguard/KeyguardSecPasswordView;->mKeyguardUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    invoke-virtual {v3}, Lcom/android/keyguard/KeyguardUpdateMonitor;->isFingerprintOptionEnabled()Z
    ...
    iget-boolean v3, v0, Lcom/android/keyguard/KeyguardSecPasswordView;->mBouncerShowing:Z

    if-eqz v3, :cond_c

    iget-object v3, v0, Lcom/android/keyguard/KeyguardSecPasswordView;->mKeyguardUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    invoke-virtual {v3}, Lcom/android/keyguard/KeyguardUpdateMonitor;->stopListeningForFingerprint()V
    ...
    invoke-virtual {v3}, Lcom/android/keyguard/KeyguardUpdateMonitor;->updateFingerprintListeningState()V
