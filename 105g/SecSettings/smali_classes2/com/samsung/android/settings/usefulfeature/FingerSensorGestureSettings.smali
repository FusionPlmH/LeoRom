...
.method static synthetic access$500(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/samsung/android/settings/usefulfeature/FingerSensorGestureSettings;->mSpayPackage(Landroid/content/Context;)Ljava/lang/String;
...
.method private createFingerGestureView()V
    ...
    invoke-static {v0}, Lcom/samsung/android/settings/usefulfeature/FingerSensorGestureSettings;->mSpayPackage(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    const-string v2, "spaymini"
    ...
    invoke-virtual {v0, v2}, Landroid/support/v14/preference/SecSwitchPreference;->setTitle(I)V
...
.method private static mSpayPackage(Landroid/content/Context;)Ljava/lang/String;
    .locals 2
...
.method private static mSupportSpay(Landroid/content/Context;)Z
    ...
    const-string v4, "FingerSensorGestureSettings"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "Samsung Pay supports finger gesture : "
    ...
    const-string v3, "FingerSensorGestureSettings"
