...
.method private createPreferenceHierarchy()Landroid/support/v7/preference/PreferenceScreen;
    ...
    iput-object v1, p0, Lcom/samsung/android/settings/nfc/NfcSettings;->mPreviewPreference:Lcom/android/settings/applications/LayoutPreference;
    ...
    invoke-virtual {v1, v3}, Landroid/support/v7/preference/SecPreferenceCategory;->seslSetSubheaderRoundedBg(I)V
    ...
    invoke-virtual {v1, v3}, Lcom/samsung/android/settings/widget/SecInsetCategoryPreference;->seslSetSubheaderRoundedBg(I)V
    ...
    iget-object v2, p0, Lcom/samsung/android/settings/nfc/NfcSettings;->preferredSimCard:Landroid/support/v7/preference/SecPreferenceCategory;
    ...
    iget-object v5, p0, Lcom/samsung/android/settings/nfc/NfcSettings;->mSwitchBar:Lcom/android/settings/widget/SwitchBar;

    iget-object v6, p0, Lcom/samsung/android/settings/nfc/NfcSettings;->androidBeam:Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreferenceScreen;

    iget-object v7, p0, Lcom/samsung/android/settings/nfc/NfcSettings;->tapPay:Landroid/support/v7/preference/SecPreferenceScreen;

    iget-object v8, p0, Lcom/samsung/android/settings/nfc/NfcSettings;->mPaymentSim:Lcom/samsung/android/settings/nfc/PaymentDropDownPreference;

    iget-object v9, p0, Lcom/samsung/android/settings/nfc/NfcSettings;->nfcSettingPref:Landroid/support/v7/preference/PreferenceScreen;

    iget-object v10, p0, Lcom/samsung/android/settings/nfc/NfcSettings;->mCardMode:Lcom/samsung/android/settings/nfc/NfcRadioButtonPreference;

    iget-object v11, p0, Lcom/samsung/android/settings/nfc/NfcSettings;->mStandardMode:Lcom/samsung/android/settings/nfc/NfcRadioButtonPreference;

    move-object v3, v1

    invoke-direct/range {v3 .. v11}, Lcom/samsung/android/settings/nfc/NfcEnabler;-><init>(Landroid/content/Context;Lcom/android/settings/widget/SwitchBar;Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreferenceScreen;Landroid/support/v7/preference/SecPreferenceScreen;Landroid/support/v7/preference/SecPreference;Landroid/support/v7/preference/PreferenceScreen;Lcom/samsung/android/settings/nfc/NfcRadioButtonPreference;Lcom/samsung/android/settings/nfc/NfcRadioButtonPreference;)V
    ...
    invoke-virtual {p0, v1}, Lcom/samsung/android/settings/nfc/NfcSettings;->setAutoRemoveInsetCategory(Z)V
    ...
    invoke-virtual {v3, v1}, Lcom/samsung/android/settings/widget/SecInsetCategoryPreference;->setHeight(I)V
    ...
    invoke-virtual {v4, v2}, Lcom/samsung/android/settings/widget/SecInsetCategoryPreference;->setHeight(I)V

    invoke-virtual {v4, v1}, Lcom/samsung/android/settings/widget/SecInsetCategoryPreference;->seslSetSubheaderRoundedBg(I)V

    iget-object v1, p0, Lcom/samsung/android/settings/nfc/NfcSettings;->mPreviewPreference:Lcom/android/settings/applications/LayoutPreference;

    invoke-virtual {v1}, Lcom/android/settings/applications/LayoutPreference;->getOrder()I

    move-result v1

    sub-int/2addr v1, v2

    invoke-virtual {v4, v1}, Lcom/samsung/android/settings/widget/SecInsetCategoryPreference;->setOrder(I)V
...
.method private populateViewForOrientation()V
    ...
    iget-object v0, p0, Lcom/samsung/android/settings/nfc/NfcSettings;->mPreviewPreference:Lcom/android/settings/applications/LayoutPreference;
    ...
    iget-object v3, p0, Lcom/samsung/android/settings/nfc/NfcSettings;->mPreviewPreference:Lcom/android/settings/applications/LayoutPreference;
...
.method private startAnimation()V
    ...
    iget-object v2, p0, Lcom/samsung/android/settings/nfc/NfcSettings;->mPreviewPreference:Lcom/android/settings/applications/LayoutPreference;
