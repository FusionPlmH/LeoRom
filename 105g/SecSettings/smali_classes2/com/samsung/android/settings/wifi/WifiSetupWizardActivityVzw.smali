...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v3, v0}, Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw;->setContentView(IZ)V
    ...
    const-string v3, "usesSoftNavigationKeys"
    ...
    const-string v3, "isKmeSupported"
    ...
    const-string v3, "isSingleSkuPrepaid"
    ...
    invoke-direct {v0, p0, v2}, Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw$WifiSetupVoiceGuideHelper;-><init>(Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw;Z)V
    ...
    iget-object v2, p0, Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw;->mVoiceGuideHelper:Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw$WifiSetupVoiceGuideHelper;

    invoke-virtual {v2}, Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw$WifiSetupVoiceGuideHelper;->getListener()Lcom/android/settings/wifi/WifiSettings$WifiSettingsListener;

    move-result-object v2

    invoke-virtual {v0, v2}, Lcom/android/settings/wifi/WifiSettings;->setWifiSettingsListener(Lcom/android/settings/wifi/WifiSettings$WifiSettingsListener;)V
    ...
    invoke-direct {v0, p0, v2}, Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw$WifiActionButtonUpdater;-><init>(Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw;Landroid/content/Intent;)V
    ...
    new-instance v2, Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw$1;

    invoke-direct {v2, p0}, Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw$1;-><init>(Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw;)V

    invoke-virtual {p0, v0, v2}, Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw;->setMainActionButton(ILandroid/view/View$OnClickListener;)V
    ...
    new-instance v2, Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw$2;

    invoke-direct {v2, p0}, Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw$2;-><init>(Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw;)V

    invoke-virtual {p0, v0, v2}, Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw;->setManualSetupButton(ILandroid/view/View$OnClickListener;)V
    ...
    iget-object v2, p0, Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw;->mReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {p0, v2, v0}, Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    iput-boolean v1, p0, Lcom/samsung/android/settings/wifi/WifiSetupWizardActivityVzw;->mIsRegistered:Z
