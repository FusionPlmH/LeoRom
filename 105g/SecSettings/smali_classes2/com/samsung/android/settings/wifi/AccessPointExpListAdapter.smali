...
.method public addPreferenceGroup(ILcom/samsung/android/settingslib/wifi/AccessPointPreferenceGroup;)Z
    ...
    const-string v3, "addPreferenceGroup "
    ...
    invoke-virtual {p2}, Lcom/samsung/android/settingslib/wifi/AccessPointPreferenceGroup;->getTitle()Ljava/lang/String;
...
.method public getGroupPosition(Lcom/samsung/android/settingslib/wifi/AccessPointPreferenceGroup;)I
    ...
    const-string v2, "getGroupPosition "
...
.method public getGroupView(IZLandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-static {v3, p4}, Lcom/android/settings/Utils;->inflateCategoryHeader(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v0

    new-instance v4, Lcom/samsung/android/settings/wifi/AccessPointExpListAdapter$ViewHolder;

    invoke-direct {v4, v2}, Lcom/samsung/android/settings/wifi/AccessPointExpListAdapter$ViewHolder;-><init>(Lcom/samsung/android/settings/wifi/AccessPointExpListAdapter$1;)V

    iput-object v4, p0, Lcom/samsung/android/settings/wifi/AccessPointExpListAdapter;->mViewHolder:Lcom/samsung/android/settings/wifi/AccessPointExpListAdapter$ViewHolder;
    ...
    iput-object v5, v4, Lcom/samsung/android/settings/wifi/AccessPointExpListAdapter$ViewHolder;->title:Landroid/widget/TextView;

    iget-object v4, p0, Lcom/samsung/android/settings/wifi/AccessPointExpListAdapter;->mViewHolder:Lcom/samsung/android/settings/wifi/AccessPointExpListAdapter$ViewHolder;

    iget-object v4, v4, Lcom/samsung/android/settings/wifi/AccessPointExpListAdapter$ViewHolder;->title:Landroid/widget/TextView;

    iget-object v5, p0, Lcom/samsung/android/settings/wifi/AccessPointExpListAdapter;->mContext:Landroid/content/Context;
    ...
    iget-object v4, p0, Lcom/samsung/android/settings/wifi/AccessPointExpListAdapter;->mContext:Landroid/content/Context;
    ...
    iget-boolean v3, p0, Lcom/samsung/android/settings/wifi/AccessPointExpListAdapter;->mInSetupWizardActivity:Z

    if-nez v3, :cond_2

    iget-boolean v3, p0, Lcom/samsung/android/settings/wifi/AccessPointExpListAdapter;->mInWifiPickerActivity:Z
...
.method public getSmartTetheringPreferenceGroup()Lcom/samsung/android/settingslib/wifi/AccessPointPreferenceGroup;
    .locals 3
    ...
    invoke-virtual {p0, v1}, Lcom/samsung/android/settings/wifi/AccessPointExpListAdapter;->isSmartTetheringPreferenceGroup(Lcom/samsung/android/settingslib/wifi/AccessPointPreferenceGroup;)Z
...
.method public isSmartTetheringPreferenceGroup(Lcom/samsung/android/settingslib/wifi/AccessPointPreferenceGroup;)Z
    .locals 3
