...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    const-string v5, "SHARING_LITE_WIFI_ENABLE_WARNING_DO_NOTSHOW_AGAIN"
    ...
    iget-object v3, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    :cond_b
    iput v9, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->mDialogTheme:I

    :goto_1
    new-instance v5, Landroid/app/AlertDialog$Builder;

    iget v6, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->mDialogTheme:I
    ...
    const v12, 0x7f121ed1

    const v13, 0x7f121e4e

    const v9, 0x7f121e4f

    if-ne v6, v11, :cond_10

    iget-object v6, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->mContext:Landroid/content/Context;

    const v11, 0x7f0d02bd

    invoke-static {v6, v11, v3}, Landroid/view/View;->inflate(Landroid/content/Context;ILandroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget v14, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->extra_type:I
    ...
    :cond_c
    iget v9, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->extra_type:I
    ...
    iput-object v7, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->mCheckBox:Landroid/widget/CheckBox;

    iget-object v7, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->mCheckBox:Landroid/widget/CheckBox;

    iget-boolean v8, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->mWifiEnableCheck:Z
    ...
    invoke-virtual {v5, v12}, Landroid/app/AlertDialog$Builder;->setTitle(I)Landroid/app/AlertDialog$Builder;

    invoke-virtual {v5, v15}, Landroid/app/AlertDialog$Builder;->setMessage(I)Landroid/app/AlertDialog$Builder;
    ...
    new-instance v6, Lcom/samsung/android/settings/wifi/WifiWarning$2;

    invoke-direct {v6, v0}, Lcom/samsung/android/settings/wifi/WifiWarning$2;-><init>(Lcom/samsung/android/settings/wifi/WifiWarning;)V
    ...
    invoke-direct {v6, v0}, Lcom/samsung/android/settings/wifi/WifiWarning$4;-><init>(Lcom/samsung/android/settings/wifi/WifiWarning;)V
    ...
    invoke-direct {v6, v0}, Lcom/samsung/android/settings/wifi/WifiWarning$6;-><init>(Lcom/samsung/android/settings/wifi/WifiWarning;)V
