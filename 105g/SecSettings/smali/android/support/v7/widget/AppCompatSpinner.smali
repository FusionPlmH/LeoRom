...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    invoke-virtual {v1, v3, v0}, Landroid/support/v7/widget/TintTypedArray;->getResourceId(II)I
    ...
    invoke-static {v5, p2, v6, p3, v0}, Landroid/support/v7/widget/TintTypedArray;->obtainStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/TintTypedArray;
    ...
    invoke-virtual {v0, v5, v6}, Landroid/support/v7/widget/TintTypedArray;->getLayoutDimension(II)I
    ...
    invoke-virtual {v1, v5}, Landroid/support/v7/widget/TintTypedArray;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/TintTypedArray;->getTextArray(I)[Ljava/lang/CharSequence;
    ...
    invoke-direct {v3, p1, v5, v0}, Landroid/widget/ArrayAdapter;-><init>(Landroid/content/Context;I[Ljava/lang/Object;)V
...
.method static synthetic access$300(Landroid/support/v7/widget/AppCompatSpinner;)I
    ...
    iget v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->mSpinnerDropdownHorizontalOffset:I
...
.method private semGetCurrentContentWidth(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    iget-object v4, p0, Landroid/support/v7/widget/AppCompatSpinner;->mTempRect:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, Landroid/support/v7/widget/AppCompatSpinner;->mTempRect:Landroid/graphics/Rect;
...
.method protected onMeasure(II)V
    ...
    invoke-direct {p0, v1, v2}, Landroid/support/v7/widget/AppCompatSpinner;->semGetCurrentContentWidth(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    invoke-virtual {p0, v2, v3}, Landroid/support/v7/widget/AppCompatSpinner;->setMeasuredDimension(II)V
