...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v2, p0, Landroid/support/v4/view/ViewPager;->mIsMouseWheelEventSupport:Z

    iput v2, p0, Landroid/support/v4/view/ViewPager;->mSeslTouchSlop:I

    iput v2, p0, Landroid/support/v4/view/ViewPager;->mSeslPagingTouchSlop:I

    iput-boolean v2, p0, Landroid/support/v4/view/ViewPager;->mUsePagingTouchSlopForStylus:Z

    const/high16 v3, 0x3f000000    # 0.5f

    iput v3, p0, Landroid/support/v4/view/ViewPager;->mTouchSlopRatio:F
    ...
    iput-boolean v2, p0, Landroid/support/v4/view/ViewPager;->mConfigurationChanged:Z
...
.method private performDrag(F)Z
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->getLayoutDirection()I
    ...
    iput-boolean v3, v0, Landroid/support/v4/view/ViewPager;->mConfigurationChanged:Z

    :cond_0
    const/4 v2, 0x0

    iget v5, v0, Landroid/support/v4/view/ViewPager;->mLastMotionX:F
    ...
    iget v10, v0, Landroid/support/v4/view/ViewPager;->mFirstOffset:F
    ...
    :cond_1
    iget v14, v13, Landroid/support/v4/view/ViewPager$ItemInfo;->position:I
    ...
    iget v4, v13, Landroid/support/v4/view/ViewPager$ItemInfo;->offset:F
    ...
    iget-object v14, v0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Landroid/support/v4/widget/SeslEdgeEffect;
    ...
    invoke-virtual {v14, v15}, Landroid/support/v4/widget/SeslEdgeEffect;->onPull(F)V
    ...
    iget-object v4, v0, Landroid/support/v4/view/ViewPager;->mRightEdge:Landroid/support/v4/widget/SeslEdgeEffect;
    ...
    invoke-virtual {v4, v14}, Landroid/support/v4/widget/SeslEdgeEffect;->onPull(F)V
    ...
    invoke-virtual {v0, v1, v4}, Landroid/support/v4/view/ViewPager;->scrollTo(II)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/SeslEdgeEffect;->finish()V
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/SeslEdgeEffect;->isFinished()Z
    ...
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Landroid/support/v4/widget/SeslEdgeEffect;

    invoke-virtual {v5, v3, v4}, Landroid/support/v4/widget/SeslEdgeEffect;->setSize(II)V
    ...
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->mRightEdge:Landroid/support/v4/widget/SeslEdgeEffect;

    invoke-virtual {v5, v4, v3}, Landroid/support/v4/widget/SeslEdgeEffect;->setSize(II)V
...
.method initViewPager()V
    ...
    new-instance v4, Landroid/support/v4/widget/SeslEdgeEffect;

    invoke-direct {v4, v1}, Landroid/support/v4/widget/SeslEdgeEffect;-><init>(Landroid/content/Context;)V

    iput-object v4, p0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Landroid/support/v4/widget/SeslEdgeEffect;

    new-instance v4, Landroid/support/v4/widget/SeslEdgeEffect;

    invoke-direct {v4, v1}, Landroid/support/v4/widget/SeslEdgeEffect;-><init>(Landroid/content/Context;)V

    iput-object v4, p0, Landroid/support/v4/view/ViewPager;->mRightEdge:Landroid/support/v4/widget/SeslEdgeEffect;

    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Landroid/support/v4/widget/SeslEdgeEffect;

    invoke-virtual {v4, p0}, Landroid/support/v4/widget/SeslEdgeEffect;->setSeslHostView(Landroid/view/View;)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v1, v6, Landroid/support/v4/view/ViewPager;->mUsePagingTouchSlopForStylus:Z
    ...
    iget v1, v6, Landroid/support/v4/view/ViewPager;->mSeslPagingTouchSlop:I

    iput v1, v6, Landroid/support/v4/view/ViewPager;->mTouchSlop:I

    goto :goto_2

    :cond_c
    iget v1, v6, Landroid/support/v4/view/ViewPager;->mSeslTouchSlop:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, v6, Landroid/support/v4/view/ViewPager;->mFakeDragging:Z
    ...
    :cond_1
    iget-object v0, v6, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/PagerAdapter;
    ...
    iget v0, v6, Landroid/support/v4/view/ViewPager;->mCurItem:I

    invoke-direct {v6, v0, v8, v1, v1}, Landroid/support/v4/view/ViewPager;->scrollToItem(IZIZ)V
    ...
    iget v4, v6, Landroid/support/v4/view/ViewPager;->mLastMotionY:F
    ...
    iget v5, v6, Landroid/support/v4/view/ViewPager;->mTouchSlop:I
    ...
    invoke-direct {v6, v8}, Landroid/support/v4/view/ViewPager;->requestParentDisallowInterceptTouchEvent(Z)V

    iget v5, v6, Landroid/support/v4/view/ViewPager;->mInitialMotionX:F
    ...
    iget v11, v6, Landroid/support/v4/view/ViewPager;->mTouchSlop:I
    ...
    :goto_0
    iput v5, v6, Landroid/support/v4/view/ViewPager;->mLastMotionX:F

    iput v3, v6, Landroid/support/v4/view/ViewPager;->mLastMotionY:F

    invoke-virtual {v6, v8}, Landroid/support/v4/view/ViewPager;->setScrollState(I)V

    invoke-direct {v6, v8}, Landroid/support/v4/view/ViewPager;->setScrollingCacheEnabled(Z)V
    ...
    invoke-direct {v6, v1}, Landroid/support/v4/view/ViewPager;->performDrag(F)Z
    ...
    iget-object v11, v6, Landroid/support/v4/view/ViewPager;->mVelocityTracker:Landroid/view/VelocityTracker;

    const/16 v0, 0x3e8

    iget v1, v6, Landroid/support/v4/view/ViewPager;->mMaximumVelocity:I

    int-to-float v1, v1

    invoke-virtual {v11, v0, v1}, Landroid/view/VelocityTracker;->computeCurrentVelocity(IF)V
    ...
    iget v0, v6, Landroid/support/v4/view/ViewPager;->mPageMargin:I
    ...
    iget v5, v15, Landroid/support/v4/view/ViewPager$ItemInfo;->position:I
    ...
    iget v1, v15, Landroid/support/v4/view/ViewPager$ItemInfo;->offset:F

    sub-float/2addr v0, v1

    iget v1, v15, Landroid/support/v4/view/ViewPager$ItemInfo;->widthFactor:F
    ...
    invoke-direct {v6, v5, v4, v12, v2}, Landroid/support/v4/view/ViewPager;->determineTargetPage(IFII)I
    ...
    iput-boolean v1, v6, Landroid/support/v4/view/ViewPager;->mPopulatePending:Z
...
.method populate(I)V
    ...
    :goto_14
    invoke-virtual {v2, v1, v4, v11}, Landroid/support/v4/view/PagerAdapter;->setPrimaryItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
