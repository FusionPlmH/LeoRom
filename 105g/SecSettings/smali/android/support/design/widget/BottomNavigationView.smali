...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iget-object v5, p0, Landroid/support/design/widget/BottomNavigationView;->mMenuView:Landroid/support/design/internal/BottomNavigationMenuView;

    move-object v6, v4

    check-cast v6, Landroid/graphics/drawable/ColorDrawable;

    invoke-virtual {v5, v6}, Landroid/support/design/internal/BottomNavigationMenuView;->setBackgroundColorDrawable(Landroid/graphics/drawable/ColorDrawable;)V

    :cond_3
    sget v5, Landroid/support/design/R$styleable;->BottomNavigationView_menu:I
    ...
    invoke-virtual {v1, v5, v3}, Landroid/support/v7/widget/TintTypedArray;->getResourceId(II)I
    ...
    new-instance v5, Landroid/support/design/widget/BottomNavigationView$1;

    invoke-direct {v5, p0}, Landroid/support/design/widget/BottomNavigationView$1;-><init>(Landroid/support/design/widget/BottomNavigationView;)V

    invoke-virtual {v3, v5}, Landroid/support/v7/view/menu/MenuBuilder;->setCallback(Landroid/support/v7/view/menu/MenuBuilder$Callback;)V
...
.method private addCompatibilityTopDivider(Landroid/content/Context;)V
    ...
    sget v3, Landroid/support/design/R$dimen;->sesl_bottom_navigation_shadow_height:I
