...
.method public getNonIndexableKeys(Landroid/content/Context;)Ljava/util/List;
    ...
    const-string/jumbo v1, "show_network_info"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    :cond_0
    const-string v1, "StatusBar_Settings"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "getNonIndexableKeys() showing ? "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    sget-boolean v3, Lcom/samsung/android/settings/display/StatusBar;->STATBAR_NETWORK_INFO_IS_SHOWING:Z
    ...
    invoke-static {}, Lcom/samsung/android/settings/display/StatusBar;->access$400()Z
