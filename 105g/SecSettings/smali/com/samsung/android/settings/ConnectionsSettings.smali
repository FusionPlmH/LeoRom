...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/samsung/android/settings/ConnectionsSettings;->SEARCH_INDEX_DATA_PROVIDER:Lcom/samsung/android/settings/search/SecIndexable$SecSearchIndexProvider;
...
.method private setLinkedDataView()V
    ...
    invoke-static {v5}, Lcom/android/settings/system/ResetDashboardFragment;->isResetEnabled(Landroid/content/Context;)Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    :cond_2
    iget-object v9, v0, Lcom/samsung/android/settings/ConnectionsSettings;->mCmcSettings:Landroid/support/v14/preference/SecSwitchPreferenceScreen;
    ...
    :cond_16
    :goto_9
    invoke-static {v1}, Lcom/samsung/android/settings/ConnectionsUtils;->isDisplaySimMgr(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v5}, Lcom/samsung/android/settings/ConnectionsSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v9, v0, Lcom/samsung/android/settings/ConnectionsSettings;->mTetheringHotspot:Lcom/samsung/android/settings/widget/SecRestrictedPreference;

    const v10, 0x7f121a5a

    invoke-virtual {v9, v10}, Lcom/samsung/android/settings/widget/SecRestrictedPreference;->setTitle(I)V

    iget-object v9, v0, Lcom/samsung/android/settings/ConnectionsSettings;->mTetheringHotspot:Lcom/samsung/android/settings/widget/SecRestrictedPreference;

    const-string/jumbo v10, "tethering_and_hotspot_jpn"

    invoke-virtual {v9, v10}, Lcom/samsung/android/settings/widget/SecRestrictedPreference;->setKey(Ljava/lang/String;)V
    ...
    const-string v10, "ConnectionsSettings"

    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "mTetheredData: "
    ...
    const-string v12, "cm.isTetheringSupported: "
    ...
    invoke-static {v10}, Lcom/samsung/android/settings/Rune;->supportTetheringHotspot(Landroid/app/Activity;)Z
    ...
    :cond_24
    iget-object v10, v0, Lcom/samsung/android/settings/ConnectionsSettings;->mUm:Landroid/os/UserManager;
    ...
    iget-object v6, v0, Lcom/samsung/android/settings/ConnectionsSettings;->mTetheringHotspot:Lcom/samsung/android/settings/widget/SecRestrictedPreference;

    invoke-virtual {v6}, Lcom/samsung/android/settings/widget/SecRestrictedPreference;->getKey()Ljava/lang/String;
    ...
    invoke-virtual {v10, v6}, Lcom/samsung/android/settings/widget/SecRestrictedPreference;->setEnabled(Z)V
    ...
    invoke-static {v5}, Lcom/samsung/android/settings/ConnectionsUtils;->getSPRTetheringEnableStatus(Landroid/net/ConnectivityManager;)Z
