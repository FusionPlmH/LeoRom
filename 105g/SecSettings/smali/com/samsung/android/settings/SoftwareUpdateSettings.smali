...
.method private applySoftwareUpdatePolicy()V
    ...
    sget-object v3, Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;->DOWNLOAD_AND_INSTALL:Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;

    invoke-virtual {v3}, Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;->getKey()Ljava/lang/String;
    ...
    :cond_0
    sget-object v4, Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;->AUTO_DOWNLOAD_OVER_WIFI:Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;

    invoke-virtual {v4}, Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;->getKey()Ljava/lang/String;
...
.method private handleGetSimLockResponse(Landroid/os/Message;)V
    ...
    :goto_0
    sget-object v3, Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;->UICC_UNLOCK:Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;
...
.method private initSoftwareUpdateMenuCategory()V
    ...
    invoke-virtual {v1}, Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;->getKey()Ljava/lang/String;
...
.method private intializeAndUpdateSprMenus()V
    ...
    :cond_0
    sget-object v0, Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;->UPDATE_PROFILE:Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;

    invoke-virtual {v0}, Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;->getKey()Ljava/lang/String;
    ...
    sget-object v0, Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;->UPDATE_PRL:Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;
    ...
    sget-object v0, Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;->UICC_UNLOCK:Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;
...
.method private updateWifiAutoDownloadMenu()V
    ...
    sget-object v0, Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;->AUTO_DOWNLOAD_OVER_WIFI:Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;

    invoke-virtual {p0}, Lcom/samsung/android/settings/SoftwareUpdateSettings;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/samsung/android/settings/SoftwareUpdateSettings$SoftwareUpdateMenu;->shouldEnable(Landroid/content/Context;)Z
