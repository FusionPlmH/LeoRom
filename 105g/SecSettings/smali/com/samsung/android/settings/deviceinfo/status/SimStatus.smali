...
.field private mEIDPreference:Landroid/support/v7/preference/Preference;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/samsung/android/settings/deviceinfo/status/SimStatus;->mSupportESim:Z
...
.method private initialize()V
    ...
    iget-boolean v0, p0, Lcom/samsung/android/settings/deviceinfo/status/SimStatus;->mSupportESim:Z
...
.method private isEidVisible()Z
    .locals 5

    iget-object v0, p0, Lcom/samsung/android/settings/deviceinfo/status/SimStatus;->mContext:Landroid/content/Context;

    invoke-static {v0}, Lcom/samsung/android/settings/deviceinfo/SecDeviceInfoUtils;->getESimId(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    iget-boolean v1, p0, Lcom/samsung/android/settings/deviceinfo/status/SimStatus;->mSupportESim:Z
    ...
    invoke-static {v1}, Lcom/samsung/android/settings/deviceinfo/SecDeviceInfoUtils;->getESimSlotId(Landroid/content/Context;)I
...
.method private updateEid()V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/samsung/android/settings/deviceinfo/status/SimStatus;->isEidVisible()Z

    move-result v0

    iget-object v1, p0, Lcom/samsung/android/settings/deviceinfo/status/SimStatus;->mEIDPreference:Landroid/support/v7/preference/Preference;

    invoke-virtual {v1, v0}, Landroid/support/v7/preference/Preference;->setVisible(Z)V

    if-eqz v0, :cond_1

    const-string/jumbo v1, "status_esim_id"

    iget-object v2, p0, Lcom/samsung/android/settings/deviceinfo/status/SimStatus;->mContext:Landroid/content/Context;

    invoke-static {v2}, Lcom/samsung/android/settings/deviceinfo/SecDeviceInfoUtils;->getESimId(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v2

    invoke-direct {p0, v1, v2}, Lcom/samsung/android/settings/deviceinfo/status/SimStatus;->setSummaryText(Ljava/lang/String;Ljava/lang/String;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/android/settings/deviceinfo/status/SimStatus;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;

    move-result-object v0

    iput-object v0, p0, Lcom/samsung/android/settings/deviceinfo/status/SimStatus;->mEIDPreference:Landroid/support/v7/preference/Preference;
