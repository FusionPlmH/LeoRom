...
.method public onBindViewHolder(Landroid/support/v7/preference/PreferenceViewHolder;)V
    ...
    instance-of v4, v4, Landroid/support/v7/widget/SwitchCompat;
    ...
    invoke-virtual {v3, p0}, Landroid/widget/CompoundButton;->setTag(Ljava/lang/Object;)V

    invoke-virtual {v3, v5}, Landroid/widget/CompoundButton;->setClickable(Z)V

    invoke-virtual {v3, v5}, Landroid/widget/CompoundButton;->setFocusable(Z)V

    new-instance v4, Lcom/android/settings/users/AppRestrictionsFragment$AppRestrictionsPreference$1;

    invoke-direct {v4, p0}, Lcom/android/settings/users/AppRestrictionsFragment$AppRestrictionsPreference$1;-><init>(Lcom/android/settings/users/AppRestrictionsFragment$AppRestrictionsPreference;)V

    invoke-virtual {v3, v4}, Landroid/widget/CompoundButton;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    new-instance v4, Lcom/android/settings/users/AppRestrictionsFragment$AppRestrictionsPreference$2;

    invoke-direct {v4, p0, v3}, Lcom/android/settings/users/AppRestrictionsFragment$AppRestrictionsPreference$2;-><init>(Lcom/android/settings/users/AppRestrictionsFragment$AppRestrictionsPreference;Landroid/widget/CompoundButton;)V
