...
.method constructor <init>(Lcom/android/settings/users/EditUserInfoController;Landroid/widget/EditText;Ljava/lang/CharSequence;Lcom/android/settings/users/EditUserInfoController$OnContentChangedCallback;Landroid/graphics/drawable/Drawable;Landroid/app/Fragment;)V
    ...
    iput-object p6, p0, Lcom/android/settings/users/EditUserInfoController$3;->val$fragment:Landroid/app/Fragment;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object v0, p0, Lcom/android/settings/users/EditUserInfoController$3;->val$userNameView:Landroid/widget/EditText;
    ...
    iget-object v1, p0, Lcom/android/settings/users/EditUserInfoController$3;->val$currentUserName:Ljava/lang/CharSequence;
    ...
    iget-object v2, p0, Lcom/android/settings/users/EditUserInfoController$3;->val$currentUserName:Ljava/lang/CharSequence;
    ...
    :cond_0
    iget-object v1, p0, Lcom/android/settings/users/EditUserInfoController$3;->val$callback:Lcom/android/settings/users/EditUserInfoController$OnContentChangedCallback;
    ...
    :cond_1
    iget-object v1, p0, Lcom/android/settings/users/EditUserInfoController$3;->this$0:Lcom/android/settings/users/EditUserInfoController;

    invoke-static {v1}, Lcom/android/settings/users/EditUserInfoController;->access$400(Lcom/android/settings/users/EditUserInfoController;)Landroid/os/UserManager;

    move-result-object v1

    iget-object v2, p0, Lcom/android/settings/users/EditUserInfoController$3;->this$0:Lcom/android/settings/users/EditUserInfoController;

    invoke-static {v2}, Lcom/android/settings/users/EditUserInfoController;->access$300(Lcom/android/settings/users/EditUserInfoController;)Landroid/os/UserHandle;
    ...
    invoke-static {v1}, Lcom/android/settings/users/EditUserInfoController;->access$500(Lcom/android/settings/users/EditUserInfoController;)Lcom/android/settings/users/EditUserPhotoController;
    ...
    iget-object v3, p0, Lcom/android/settings/users/EditUserInfoController$3;->val$currentUserIcon:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, p0, Lcom/android/settings/users/EditUserInfoController$3;->val$callback:Lcom/android/settings/users/EditUserInfoController$OnContentChangedCallback;
    ...
    :cond_3
    new-instance v3, Lcom/android/settings/users/EditUserInfoController$3$1;

    invoke-direct {v3, p0}, Lcom/android/settings/users/EditUserInfoController$3$1;-><init>(Lcom/android/settings/users/EditUserInfoController$3;)V
    ...
    invoke-virtual {v3, v4, v5}, Lcom/android/settings/users/EditUserInfoController$3$1;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;

    :cond_4
    iget-object v3, p0, Lcom/android/settings/users/EditUserInfoController$3;->val$fragment:Landroid/app/Fragment;
