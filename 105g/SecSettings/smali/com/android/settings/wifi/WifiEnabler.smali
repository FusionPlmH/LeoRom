...
.method private onSwitchChanged(Z)Z
    ...
    invoke-static {v1}, Lcom/samsung/android/settings/wifi/WifiDevicePolicyManager;->isAllowedWifiStateChange(Landroid/content/Context;)Z
...
.method private setSwitchBarChecked(Z)V
    ...
    :goto_0
    iget-boolean v2, p0, Lcom/android/settings/wifi/WifiEnabler;->mIsConnectedState:Z
    ...
    invoke-static {v3}, Lcom/android/settings/wifi/WifiEnabler;->removeDoubleQuotes(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_2
    iget-object v2, p0, Lcom/android/settings/wifi/WifiEnabler;->mSwitchPreference:Landroid/support/v7/preference/SwitchPreferenceCompat;
