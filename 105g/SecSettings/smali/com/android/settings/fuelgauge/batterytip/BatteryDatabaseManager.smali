...
.method public declared-synchronized queryAllAnomalies(JI)Ljava/util/List;
    ...
    const-string/jumbo v0, "time_stamp_ms DESC"
    ...
    const-string/jumbo v0, "time_stamp_ms > ? AND anomaly_state = ? "
    ...
    const-string/jumbo v6, "time_stamp_ms > ? AND anomaly_state = ? "

    const/4 v8, 0x0

    const/4 v9, 0x0

    const-string/jumbo v10, "time_stamp_ms DESC"
