...
.field private mDeviceCareManager:Lcom/samsung/android/settings/fuelguage/DeviceCareManager;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    new-instance v0, Lcom/samsung/android/settings/fuelguage/DeviceCareManager;

    iget-object v1, p0, Lcom/android/settings/fuelgauge/BatteryUtils;->mContext:Landroid/content/Context;

    invoke-direct {v0, v1}, Lcom/samsung/android/settings/fuelguage/DeviceCareManager;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/settings/fuelgauge/BatteryUtils;->mDeviceCareManager:Lcom/samsung/android/settings/fuelguage/DeviceCareManager;
...
.method public getDeviceCareManager()Lcom/samsung/android/settings/fuelguage/DeviceCareManager;
    .locals 2

    iget-object v0, p0, Lcom/android/settings/fuelgauge/BatteryUtils;->mDeviceCareManager:Lcom/samsung/android/settings/fuelguage/DeviceCareManager;
...
.method public setForceAppStandby(ILjava/lang/String;I)V
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, p3, v0}, Lcom/android/settings/fuelgauge/BatteryUtils;->setForceAppStandby(ILjava/lang/String;II)V
...
.method public setForceAppStandby(ILjava/lang/String;II)V
    ...
    iget-object v1, p0, Lcom/android/settings/fuelgauge/BatteryUtils;->mDeviceCareManager:Lcom/samsung/android/settings/fuelguage/DeviceCareManager;

    invoke-virtual {v1, p2, p1, p3, p4}, Lcom/samsung/android/settings/fuelguage/DeviceCareManager;->updateDatabase(Ljava/lang/String;III)V
...
.method public shouldHideSipper(Lcom/android/internal/os/BatterySipper;)Z
    ...
    const-string v5, "getPackageUid(\"com.att.iqi\", 0) is failed"

    invoke-static {v4, v5}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    :goto_0
    iget-object v3, p0, Lcom/android/settings/fuelgauge/BatteryUtils;->mPowerUsageFeatureProvider:Lcom/android/settings/fuelgauge/PowerUsageFeatureProvider;

    invoke-interface {v3, p1}, Lcom/android/settings/fuelgauge/PowerUsageFeatureProvider;->isTypeOem(Lcom/android/internal/os/BatterySipper;)Z
    ...
    :cond_1
    sget-object v3, Lcom/android/internal/os/BatterySipper$DrainType;->IDLE:Lcom/android/internal/os/BatterySipper$DrainType;
    ...
    sget-object v3, Lcom/android/internal/os/BatterySipper$DrainType;->BLUETOOTH:Lcom/android/internal/os/BatterySipper$DrainType;

    if-eq v0, v3, :cond_3

    sget-object v3, Lcom/android/internal/os/BatterySipper$DrainType;->WIFI:Lcom/android/internal/os/BatterySipper$DrainType;
    ...
    invoke-interface {v3, p1}, Lcom/android/settings/fuelgauge/PowerUsageFeatureProvider;->isTypeService(Lcom/android/internal/os/BatterySipper;)Z
    ...
    invoke-interface {v3, p1}, Lcom/android/settings/fuelgauge/PowerUsageFeatureProvider;->isTypeSystem(Lcom/android/internal/os/BatterySipper;)Z
