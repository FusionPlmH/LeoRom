...
.method private onRegionZoneChanged(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, "onRegionZoneChanged : "
    ...
    const-string v3, "mSelectedTimeZoneId : "
...
.method private saveTimeZone(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->getContentResolver()Landroid/content/ContentResolver;
...
.method private setDisplayedTimeZoneInfo(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, "setDisplayedTimeZoneInfo : "
...
.method private setPreferenceCategoryVisible(Landroid/support/v7/preference/SecPreferenceCategory;Z)V
    .locals 2

    if-eqz p1, :cond_0

    invoke-virtual {p1, p2}, Landroid/support/v7/preference/SecPreferenceCategory;->setVisible(Z)V

    const/4 v0, 0x1

    invoke-virtual {p1, v0}, Landroid/support/v7/preference/SecPreferenceCategory;->setEmptyHeight(I)V

    const/4 v0, 0x0

    :goto_0
    invoke-virtual {p1}, Landroid/support/v7/preference/SecPreferenceCategory;->getPreferenceCount()I

    move-result v1

    if-ge v0, v1, :cond_0

    invoke-virtual {p1, v0}, Landroid/support/v7/preference/SecPreferenceCategory;->getPreference(I)Landroid/support/v7/preference/Preference;
...
.method private setSelectByRegion(Z)V
    ...
    const-string/jumbo v2, "setSelectByRegion : "
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->setPreferenceCategoryVisible(Landroid/support/v7/preference/SecPreferenceCategory;Z)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->setPreferenceCategoryVisible(Landroid/support/v7/preference/SecPreferenceCategory;Z)V
    ...
    :cond_2
    iget-boolean v4, p0, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->mIsHomeCity:Z
...
.method private setupForCurrentTimeZone()V
    ...
    const-string/jumbo v3, "setupForCurrentTimeZone > HOMECITY_TIMEZONE : "
    ...
    const-string/jumbo v2, "setupForCurrentTimeZone > mSelectedTimeZoneId : "
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->getArguments()Landroid/os/Bundle;
    ...
    iput-boolean v1, p0, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->mIsHomeCity:Z

    iget-boolean v1, p0, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->mIsHomeCity:Z
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->setPreferenceCategoryVisible(Landroid/support/v7/preference/SecPreferenceCategory;Z)V
    ...
    new-instance v4, Lcom/android/settings/datetime/timezone/model/TimeZoneDataLoader$LoaderCreator;

    invoke-virtual {p0}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->getContext()Landroid/content/Context;

    move-result-object v5

    new-instance v6, Lcom/android/settings/datetime/timezone/-$$Lambda$TimeZoneSettings$CFHMJtb3KFCwNTuhyOFedUZcT20;

    invoke-direct {v6, p0}, Lcom/android/settings/datetime/timezone/-$$Lambda$TimeZoneSettings$CFHMJtb3KFCwNTuhyOFedUZcT20;-><init>(Lcom/android/settings/datetime/timezone/TimeZoneSettings;)V

    invoke-direct {v4, v5, v6}, Lcom/android/settings/datetime/timezone/model/TimeZoneDataLoader$LoaderCreator;-><init>(Landroid/content/Context;Lcom/android/settings/datetime/timezone/model/TimeZoneDataLoader$OnDataReadyCallback;)V
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)V
    ...
    iget-boolean v1, p0, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->mSelectByRegion:Z
...
.method public onResume()V
    ...
    invoke-virtual {p0}, Lcom/android/settings/datetime/timezone/TimeZoneSettings;->getListView()Landroid/support/v7/widget/RecyclerView;
