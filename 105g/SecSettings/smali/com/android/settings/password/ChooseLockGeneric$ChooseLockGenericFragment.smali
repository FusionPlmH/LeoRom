...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIsEnterpriseUser:Z
...
.method private getIntentForUnlockMethod(I)Landroid/content/Intent;
    ...
    iget-boolean v4, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIsEnterpriseUser:Z
    ...
    const-string v10, "getIntentForUnlock - Secured password required for user "
    ...
    iget-object v4, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;
    ...
    iget-object v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;

    invoke-virtual {v10}, Lcom/samsung/android/settings/knox/StreamCipher;->getPublicHandle()J

    move-result-wide v5

    invoke-virtual {v4, v9, v5, v6}, Lcom/samsung/android/settings/knox/StreamCipher;->getEncodedCipher(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iget-object v5, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->oldPassword:Ljava/lang/String;
    ...
    invoke-virtual {v4, v7, v5}, Landroid/app/admin/DevicePolicyManager;->getPasswordMinimumSymbols(Landroid/content/ComponentName;I)I
    ...
    invoke-virtual {v5, v7, v6}, Landroid/app/admin/DevicePolicyManager;->getPasswordMinimumNumeric(Landroid/content/ComponentName;I)I
    ...
    iget-object v6, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mDPM:Landroid/app/admin/DevicePolicyManager;

    iget v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mUserId:I

    invoke-virtual {v6, v7, v9}, Landroid/app/admin/DevicePolicyManager;->getPasswordMinimumLetters(Landroid/content/ComponentName;I)I
    ...
    invoke-virtual {v9, v7, v10}, Landroid/app/admin/DevicePolicyManager;->getPasswordMinimumUpperCase(Landroid/content/ComponentName;I)I
    ...
    invoke-virtual {v10, v7, v13}, Landroid/app/admin/DevicePolicyManager;->getPasswordMinimumLowerCase(Landroid/content/ComponentName;I)I
    ...
    invoke-virtual {v13, v7, v11}, Landroid/app/admin/DevicePolicyManager;->getPasswordMinimumNonLetter(Landroid/content/ComponentName;I)I
...
.method private removeEncryptionPopup(Ljava/lang/String;)V
    ...
    invoke-static {v2, v3, v1, v4, v5}, Lcom/samsung/android/settings/logging/LoggingHelper;->insertEventLogging(IILjava/lang/String;J)V
...
.method private updateBiometricsPreferences()V
    ...
    const v14, 0x7f121949

    const v15, 0x7f1216a7
...
.method protected getLockPasswordIntent(III)Landroid/content/Intent;
    ...
    iget-boolean v1, p0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIsEnterpriseUser:Z
    ...
    const-string v3, "getPwdIntent - Secured password required for user "
    ...
    iget-object v1, p0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;

    iget-object v2, p0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mUserPassword:Ljava/lang/String;

    iget-object v3, p0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;
...
.method protected getLockPatternIntent()Landroid/content/Intent;
    ...
    const-string v3, "getPtnIntent - Secured password required for user "
    ...
    invoke-virtual {v0, v2}, Lcom/android/settings/password/ChooseLockPattern$IntentBuilder;->setKnoxPasswordSecured(Z)Lcom/android/settings/password/ChooseLockPattern$IntentBuilder;
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    iget-boolean v5, v1, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIsEnterpriseUser:Z
    ...
    iget-boolean v7, v1, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIsEnterpriseUser:Z
    ...
    const-string v9, "onActivityResult - Password secured for user "
    ...
    iget-object v7, v1, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;
    ...
    iget-object v9, v1, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;

    invoke-virtual {v9}, Lcom/samsung/android/settings/knox/StreamCipher;->getPublicHandle()J

    move-result-wide v9

    invoke-virtual {v7, v8, v9, v10}, Lcom/samsung/android/settings/knox/StreamCipher;->restoreEncodedCipher(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iput-object v7, v1, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mUserPassword:Ljava/lang/String;
    ...
    iput-object v7, v1, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->oldPassword:Ljava/lang/String;
    ...
    iput-object v6, v1, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mUserPassword:Ljava/lang/String;

    iput-object v6, v1, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->oldPassword:Ljava/lang/String;
    ...
    iget-object v7, v1, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mUserPassword:Ljava/lang/String;
    ...
    invoke-direct {v1, v7, v0}, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->maybeEnableEncryption(IZ)V
    ...
    invoke-static {v10, v11, v0}, Lcom/samsung/android/settings/knox/KnoxUtils;->setTwoFactorValue(Landroid/content/Context;II)V
    ...
    invoke-static {v10, v11}, Lcom/samsung/android/settings/lockscreen/LockUtils;->updateSetUpCredentialIfNeeded(Landroid/content/Context;I)Z
    ...
    invoke-static {v5, v8}, Lcom/samsung/android/settings/security/SecurityUtils;->isIrisDisabled(Landroid/content/Context;I)Z
    ...
    invoke-virtual {v5, v10, v0, v8}, Lcom/android/internal/widget/LockPatternUtils;->setBiometricLockscreen(III)V
    ...
    invoke-static {v0, v5, v8}, Lcom/android/settings/Utils$KnoxLogging;->send(Landroid/content/Context;Ljava/util/ArrayList;I)V

    :cond_25
    iget-boolean v0, v1, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIsEnterpriseUser:Z
    ...
    invoke-virtual {v5, v6}, Lcom/samsung/android/settings/SettingsApplication$KnoxInfo;->setHasChooseLockResult(Z)V

    const-string v5, "ChooseLockGenericFragment.SDP"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "onActivityResult() - ChooseLock result updated("
    ...
    invoke-virtual {v8}, Lcom/samsung/android/settings/SettingsApplication$KnoxInfo;->hasChooseLockResult()Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    :cond_4
    iput-boolean v5, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIsEnterpriseUser:Z

    :cond_5
    iget-object v7, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;
    ...
    iput-object v7, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;

    iget-object v7, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;

    invoke-virtual {v7}, Lcom/samsung/android/settings/knox/StreamCipher;->issueKeyStream()J

    move-result-wide v7

    const-string v9, "ChooseLockGenericFragment.SDP"

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    const-string v11, "onCreate - StreamCipher initialized with handle("
    ...
    check-cast v7, Lcom/samsung/android/settings/SettingsApplication;

    if-eqz v7, :cond_7

    invoke-virtual {v7}, Lcom/samsung/android/settings/SettingsApplication;->getKnoxInfo()Lcom/samsung/android/settings/SettingsApplication$KnoxInfo;

    move-result-object v8

    invoke-virtual {v8, v6}, Lcom/samsung/android/settings/SettingsApplication$KnoxInfo;->setHasChooseLockResult(Z)V

    const-string v8, "ChooseLockGenericFragment.SDP"

    const-string v9, "onCreate() - KnoxInfo initialized"
    ...
    instance-of v9, v9, Lcom/android/settings/password/ChooseLockGeneric$InternalActivity;

    if-eqz v9, :cond_a

    xor-int/lit8 v9, v8, 0x1

    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mPasswordConfirmed:Z

    iget-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIsEnterpriseUser:Z
    ...
    const-string v10, "is_knox_password_secured"
    ...
    :goto_2
    iget-boolean v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIsEnterpriseUser:Z

    if-eqz v10, :cond_9

    const-string v10, "ChooseLockGenericFragment.SDP"

    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "onCreate - Password secured for user "
    ...
    iget-object v12, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;

    invoke-virtual {v12}, Lcom/samsung/android/settings/knox/StreamCipher;->getPublicHandle()J

    move-result-wide v12

    invoke-virtual {v10, v11, v12, v13}, Lcom/samsung/android/settings/knox/StreamCipher;->restoreEncodedCipher(Ljava/lang/String;J)Ljava/lang/String;

    move-result-object v10

    iput-object v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mUserPassword:Ljava/lang/String;
    ...
    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mHideDrawer:Z
    ...
    const-string v10, "has_challenge"

    invoke-virtual {v9, v10, v6}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z

    move-result v9

    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mHasChallenge:Z
    ...
    iput-wide v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mChallenge:J
    ...
    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mForFingerprint:Z
    ...
    const-string v10, "for_face"

    invoke-virtual {v9, v10, v6}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z

    move-result v9

    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mForFace:Z
    ...
    const-string v10, "for_smartscan"

    invoke-virtual {v9, v10, v6}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z

    move-result v9

    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mForSmartScan:Z
    ...
    const-string v10, "fromSetupwizard"

    invoke-virtual {v9, v10, v6}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z

    move-result v9

    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->fromSetupwizard:Z
    ...
    const-string v10, "for_iris"

    invoke-virtual {v9, v10, v6}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z

    move-result v9

    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mForIris:Z
    ...
    const-string v10, "for_cred_req_boot"
    ...
    :goto_3
    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mForChangeCredRequiredForBoot:Z
    ...
    iput-object v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mUserManager:Landroid/os/UserManager;
    ...
    const-string v10, "forPrivateBackupKey"

    invoke-virtual {v9, v10, v6}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z

    move-result v9

    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mForPrivateModeBackupKey:Z
    ...
    const-string v10, "forAppLockBackupKey"

    invoke-virtual {v9, v10}, Landroid/content/Intent;->getStringExtra(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v9

    iput-object v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mAppLockBackupKey:Ljava/lang/String;

    iget-object v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mAppLockBackupKey:Ljava/lang/String;
    ...
    :goto_4
    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mForAppLockBackupKey:Z
    ...
    const-string v10, "fromChinaSUW"

    invoke-virtual {v9, v10, v6}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z

    move-result v9

    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->fromChinaSUW:Z
    ...
    const-string v10, "screen_lock_bio"

    invoke-virtual {v9, v10, v6}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z

    move-result v9

    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mFromBioScreenLock:Z
    ...
    const-string/jumbo v10, "settings_bio"

    invoke-virtual {v9, v10, v6}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z

    move-result v9

    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mFromBioSettings:Z

    const-string v9, "ChooseLockGenericFragment"

    const-string v10, "GetIntentExtra"
    ...
    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIdentifyBiometrics:Z

    iget-object v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mWasSecureBefore:Z
    ...
    iput-object v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mStatusBarManager:Landroid/app/StatusBarManager;
    ...
    iput-object v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->multiWindowManager:Lcom/samsung/android/app/SemMultiWindowManager;
    ...
    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mFromKnoxSetDigitalLock:Z
    ...
    const-string v11, "mFromKnoxSetDigitalLock:"
    ...
    const-string v10, "isEnforcedPwdChanged"
    ...
    invoke-static {v9, v10}, Lcom/samsung/android/settings/knox/KnoxUtils;->isPwdSetupOrChangeRequested(Landroid/content/Context;I)Z
    ...
    :goto_6
    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIsEnforcedPwdChanged:Z
    ...
    const-string v10, "isFromSecureFolderReset"

    invoke-virtual {v9, v10, v6}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z

    move-result v9

    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIsFromSecureFolderReset:Z

    iget-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIsEnforcedPwdChanged:Z

    xor-int/2addr v9, v5

    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mShouldFinishForKnox:Z
    ...
    const-string v10, "oneLockOngoing"

    invoke-virtual {v9, v10, v6}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z

    move-result v9

    iput-boolean v9, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIsOnelockOngoing:Z
    ...
    const-string v10, "fromScreenLock"
    ...
    :goto_8
    iput-boolean v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mUseBioSession:Z
    ...
    :cond_11
    iget-boolean v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mForFingerprint:Z
    ...
    instance-of v10, v10, Lcom/android/settings/password/ChooseLockGeneric$InternalActivity;

    if-eqz v10, :cond_12

    xor-int/lit8 v10, v8, 0x1

    iput-boolean v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mPasswordConfirmed:Z

    xor-int/lit8 v10, v8, 0x1

    iput-boolean v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIdentifyBiometrics:Z
    ...
    const-string v11, "disable_systemkey"

    invoke-virtual {v10, v11, v6}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z

    move-result v10

    iput-boolean v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mDisableSystemKey:Z
    ...
    invoke-virtual {v10, v11}, Landroid/app/Activity;->setTitle(I)V
    ...
    iget-boolean v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->fromSetupwizard:Z
    ...
    iput v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->SCREEN_ID_CHOOSELOCK:I

    invoke-virtual/range {p0 .. p0}, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->getResources()Landroid/content/res/Resources;

    move-result-object v10

    const v11, 0x7f0b022b

    invoke-virtual {v10, v11}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v10

    iput v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->EVENT_ID_PATTERN:I

    invoke-virtual/range {p0 .. p0}, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->getResources()Landroid/content/res/Resources;

    move-result-object v10

    const v11, 0x7f0b022c

    invoke-virtual {v10, v11}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v10

    iput v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->EVENT_ID_PIN:I
    ...
    iput v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->EVENT_ID_PASSWORD:I

    :cond_15
    iget-boolean v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mForIris:Z
    ...
    :cond_17
    iget-boolean v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mForFace:Z
    ...
    :cond_19
    iget-boolean v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mForSmartScan:Z
    ...
    const-string v10, "password_confirmed"
    ...
    const-string/jumbo v10, "waiting_for_confirmation"

    invoke-virtual {v1, v10}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;)Z

    move-result v10

    iput-boolean v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mWaitingForConfirmation:Z

    const-string v10, "encrypt_requested_quality"

    invoke-virtual {v1, v10}, Landroid/os/Bundle;->getInt(Ljava/lang/String;)I

    move-result v10

    iput v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mEncryptionRequestQuality:I

    const-string v10, "encrypt_requested_disabled"

    invoke-virtual {v1, v10}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;)Z

    move-result v10

    iput-boolean v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mEncryptionRequestDisabled:Z

    iget-object v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mUserPassword:Ljava/lang/String;
    ...
    const-string v11, "is_knox_password_secured"
    ...
    :goto_9
    iget-boolean v11, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIsEnterpriseUser:Z

    if-eqz v11, :cond_1d

    const-string v11, "ChooseLockGenericFragment.SDP"

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string v13, "onCreate(savedInst) - Password secured for user "
    ...
    iget-object v11, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;
    ...
    iget-object v13, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;

    invoke-virtual {v13}, Lcom/samsung/android/settings/knox/StreamCipher;->getPublicHandle()J

    move-result-wide v13

    invoke-virtual {v11, v12, v13, v14}, Lcom/samsung/android/settings/knox/StreamCipher;->restoreEncodedCipher(Ljava/lang/String;J)Ljava/lang/String;

    move-result-object v11

    iput-object v11, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mUserPassword:Ljava/lang/String;
    ...
    :cond_1e
    iget-boolean v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mForPrivateModeBackupKey:Z

    if-nez v10, :cond_1f

    iget-boolean v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mForAppLockBackupKey:Z
    ...
    :cond_20
    const v10, 0x7f121394

    invoke-virtual {v0, v10}, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->getText(I)Ljava/lang/CharSequence;
    ...
    :cond_22
    const-string v10, "KEY_USING_TWO_FACTOR"

    invoke-virtual {v1, v10, v6}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;Z)Z

    move-result v10

    sput-boolean v10, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->usingTwoFactor:Z

    const-string v10, "KEY_SELECTED_TWO_FACTOR_TYPE"
    ...
    sput v10, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->selectedTwoFactorType:I

    const-string v10, "KEY_SELECTED_KNOX_SCREEN"

    invoke-virtual {v1, v10, v6}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;Z)Z

    move-result v10

    iput-boolean v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mSelectedKnoxScreen:Z

    :cond_23
    const-string v10, "persona"

    invoke-virtual {v0, v10}, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v10

    check-cast v10, Lcom/samsung/android/knox/SemPersonaManager;

    sput-object v10, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mPm:Lcom/samsung/android/knox/SemPersonaManager;
    ...
    iput-object v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mAlarmManager:Landroid/app/AlarmManager;

    const-string v10, "ChooseLockGenericFragment"

    const-string v11, "getTargetUser"
    ...
    invoke-static {v10, v11, v12, v13}, Lcom/android/settings/Utils;->getSecureTargetUser(Landroid/os/IBinder;Landroid/os/UserManager;Landroid/os/Bundle;Landroid/os/Bundle;)Landroid/os/UserHandle;
    ...
    iput v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mUserId:I

    new-instance v10, Lcom/android/settings/password/ChooseLockGenericController;
    ...
    invoke-direct {v10, v11, v12}, Lcom/android/settings/password/ChooseLockGenericController;-><init>(Landroid/content/Context;I)V

    iput-object v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mController:Lcom/android/settings/password/ChooseLockGenericController;

    iget-object v10, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mController:Lcom/android/settings/password/ChooseLockGenericController;

    iget-boolean v11, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mForFingerprint:Z

    iput-boolean v11, v10, Lcom/android/settings/password/ChooseLockGenericController;->mForFingerprint:Z
    ...
    invoke-static {v11}, Lcom/samsung/android/knox/SemPersonaManager;->isLegacyClId(I)Z
    ...
    invoke-static {v11}, Lcom/samsung/android/knox/SemPersonaManager;->isPremiumContainer(I)Z
    ...
    invoke-static {v11, v12}, Lcom/samsung/android/settings/knox/KnoxUtils;->getKnoxName(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-virtual {v13}, Lcom/android/settings/SettingsActivity;->getSupportActionBar()Landroid/support/v7/app/ActionBar;
    ...
    invoke-virtual {v13, v12}, Landroid/support/v7/app/ActionBar;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v13, v12}, Landroid/app/Activity;->setTitle(Ljava/lang/CharSequence;)V
    ...
    iput-object v11, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mKnoxEventList:Ljava/util/ArrayList;
    ...
    invoke-static {v11, v12}, Lcom/android/settings/password/ManagedLockPasswordProvider;->get(Landroid/content/Context;I)Lcom/android/settings/password/ManagedLockPasswordProvider;

    move-result-object v11

    iput-object v11, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mManagedPasswordProvider:Lcom/android/settings/password/ManagedLockPasswordProvider;
    ...
    invoke-static {v11}, Lcom/android/settings/Utils;->isSharedDeviceEnabled(Landroid/content/Context;)Z

    move-result v11

    if-eqz v11, :cond_2a

    iget-boolean v11, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mPasswordConfirmed:Z
    ...
    iget-boolean v11, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mSelectedKnoxScreen:Z
    ...
    iget-boolean v11, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mForIris:Z

    if-nez v11, :cond_2b

    iget-boolean v11, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mForFace:Z

    if-nez v11, :cond_2b

    iget-boolean v11, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mForSmartScan:Z
    ...
    invoke-virtual {v5, v11}, Lcom/android/internal/widget/LockPatternUtils;->getKeyguardStoredPasswordQuality(I)I
    ...
    :cond_2d
    iget-boolean v11, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIsFromSecureFolderReset:Z
    ...
    :cond_30
    iget-boolean v11, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIsEnforcedMultifactorNReset:Z

    if-eqz v11, :cond_34

    iput-boolean v5, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mPasswordConfirmed:Z

    iget-boolean v11, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIsRestrictedBioDataFromKnox:Z
    ...
    :cond_34
    iget-boolean v11, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mWaitingForConfirmation:Z
    ...
    const-string v12, "isFromKnoxSetDigitalLock"

    invoke-virtual {v11, v12, v5}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;
    ...
    const-string v13, "mFromKnoxSetDigitalLock1:"

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v13, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mFromKnoxSetDigitalLock:Z
    ...
    :goto_f
    new-instance v12, Lcom/android/settings/password/ChooseLockSettingsHelper;

    invoke-virtual/range {p0 .. p0}, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->getActivity()Landroid/app/Activity;

    move-result-object v13

    invoke-direct {v12, v13, v0}, Lcom/android/settings/password/ChooseLockSettingsHelper;-><init>(Landroid/app/Activity;Landroid/app/Fragment;)V
    ...
    invoke-virtual {v13, v11}, Landroid/os/UserManager;->isManagedProfile(I)Z
    ...
    invoke-virtual {v13, v11}, Lcom/android/internal/widget/LockPatternUtils;->isSeparateProfileChallengeEnabled(I)Z
    ...
    :cond_39
    iget-boolean v13, v0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mUseBioSession:Z
    ...
    invoke-virtual/range {v12 .. v17}, Lcom/android/settings/password/ChooseLockSettingsHelper;->launchConfirmationActivity(ILjava/lang/CharSequence;ZZI)Z
...
.method public onDestroy()V
    ...
    invoke-static {v9}, Lcom/android/settings/Utils$KnoxLogging;->getLockType(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v8, p0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mKnoxEventList:Ljava/util/ArrayList;
    ...
    :cond_7
    iget-boolean v0, p0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mIsEnterpriseUser:Z
    ...
    invoke-virtual {v2}, Lcom/samsung/android/settings/SettingsApplication$KnoxInfo;->hasChooseLockResult()Z
    ...
    :cond_a
    iget-object v2, p0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;

    invoke-virtual {v2}, Lcom/samsung/android/settings/knox/StreamCipher;->clearKeyStream()V
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    const-string v0, "ChooseLockGenericFragment.SDP"
    ...
    iget-object v0, p0, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;
