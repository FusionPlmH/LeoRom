...
.method public constructor <init>()V
    ...
    invoke-static {v4, v0}, Lcom/android/internal/widget/LockPatternView$Cell;->of(II)Lcom/android/internal/widget/LockPatternView$Cell;
    ...
    iput-boolean v1, p0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mIsEnterpriseUser:Z
...
.method private insertSALoggingWhenLockSave()V
    ...
    invoke-static {}, Lcom/android/settings/password/ChooseLockPattern;->access$1700()I

    move-result v0

    invoke-static {}, Lcom/android/settings/password/ChooseLockPattern;->access$1800()I

    move-result v1

    iget v2, p0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mEventDetail:I
...
.method private startSaveAndFinish()V
    ...
    invoke-static {}, Lcom/android/settings/password/ChooseLockPattern;->access$1400()Z
    ...
    invoke-static {}, Lcom/android/settings/password/ChooseLockPattern;->access$1500()I
...
.method public onChosenLockSaveFinished(ZLandroid/content/Intent;)V
    ...
    :try_start_0
    iget-boolean v0, p0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mIsEnterpriseUser:Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v2, v0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mIsEnterpriseUser:Z
    ...
    :cond_1
    iget-object v2, v0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;
    ...
    iput-object v2, v0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;

    iget-object v2, v0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;

    invoke-virtual {v2}, Lcom/samsung/android/settings/knox/StreamCipher;->issueKeyStream()J
    ...
    const-string v7, "onCreate - StreamCipher initialized with handle("
    ...
    :goto_0
    iput-boolean v2, v0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mIsUnlockRecovery:Z
    ...
    invoke-static {v2, v4}, Lcom/android/settings/password/ChooseLockPattern;->access$600(Lcom/android/settings/password/ChooseLockPattern;Z)V
    ...
    iput v2, v0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mEventDetail:I

    goto :goto_1

    :cond_7
    iput v3, v0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mEventDetail:I
...
.method public onDestroy()V
    ...
    iget-object v2, p0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mCurrentPattern:Ljava/lang/String;
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    iget-boolean v7, p0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mIsEnterpriseUser:Z
    ...
    const-string v8, "is_knox_password_secured"
    ...
    :goto_2
    iget-boolean v8, p0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mIsEnterpriseUser:Z

    if-eqz v8, :cond_9

    const-string v8, "ChooseLockPattern.SDP"

    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "onViewCreated - Password secured for user "
    ...
    iget-object v8, p0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;
    ...
    iget-object v10, p0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mStreamCipher:Lcom/samsung/android/settings/knox/StreamCipher;

    invoke-virtual {v10}, Lcom/samsung/android/settings/knox/StreamCipher;->getPublicHandle()J

    move-result-wide v10

    invoke-virtual {v8, v9, v10, v11}, Lcom/samsung/android/settings/knox/StreamCipher;->restoreEncodedCipher(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iput-boolean v8, p0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mHasChallenge:Z
    ...
    const-string v10, "mHasChallenge"

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v10, p0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mHasChallenge:Z
    ...
    iput-wide v8, p0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mChallenge:J
    ...
    iget-wide v10, p0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mChallenge:J
    ...
    sget-object v8, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment$Stage;->NeedToConfirm:Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment$Stage;
    ...
    iget-object v8, p0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mChooseLockSettingsHelper:Lcom/android/settings/password/ChooseLockSettingsHelper;

    const/16 v9, 0x37

    const v10, 0x7f121b0d

    invoke-virtual {p0, v10}, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->getString(I)Ljava/lang/String;

    move-result-object v10

    invoke-virtual {v8, v9, v10, v3}, Lcom/android/settings/password/ChooseLockSettingsHelper;->launchConfirmationActivity(ILjava/lang/CharSequence;Z)Z

    move-result v8

    if-nez v8, :cond_b

    sget-object v9, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment$Stage;->Introduction:Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment$Stage;

    invoke-virtual {p0, v9}, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->updateStage(Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment$Stage;)V
    ...
    iput-object v9, p0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mChosenPattern:Ljava/util/List;

    :cond_f
    iget-object v9, p0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mCurrentPattern:Ljava/lang/String;

    if-nez v9, :cond_10

    const-string v9, "currentPattern"

    invoke-virtual {p2, v9}, Landroid/os/Bundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v9

    iput-object v9, p0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mCurrentPattern:Ljava/lang/String;
    ...
    const-string/jumbo v10, "uiStage"
    ...
    check-cast v9, Lcom/android/settings/password/ChooseLockPattern$SaveAndFinishWorker;

    iput-object v9, p0, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->mSaveAndFinishWorker:Lcom/android/settings/password/ChooseLockPattern$SaveAndFinishWorker;
    ...
    sget-boolean v9, Lcom/android/settings/password/ChooseLockPattern;->mForFingerprint:Z
    ...
    invoke-static {v10, v11}, Lcom/samsung/android/settings/knox/KnoxUtils;->getKnoxName(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v10

    aput-object v10, v3, v1

    invoke-virtual {p0, v9, v3}, Lcom/android/settings/password/ChooseLockPattern$ChooseLockPatternFragment;->getString(I[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v8, v1}, Lcom/android/settings/SettingsActivity;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v1, v3, v8}, Landroid/widget/LinearLayout;->semSetRoundedCornerColor(II)V
