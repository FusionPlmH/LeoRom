...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    const-string v5, ", mForSmartscan : "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    sget-boolean v5, Lcom/android/settings/password/ChooseLockPattern;->mForSmartScan:Z
    ...
    sget v6, Lcom/android/settings/password/ChooseLockPattern;->mKnoxUserId:I

    invoke-static {p0, v6}, Lcom/samsung/android/settings/knox/KnoxUtils;->getKnoxName(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v6

    aput-object v6, v5, v3

    invoke-virtual {p0, v4, v5}, Lcom/android/settings/password/ChooseLockPattern;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings/password/ChooseLockPattern;->getText(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Lcom/android/settings/password/ChooseLockPattern;->getApplicationContext()Landroid/content/Context;
    ...
    :cond_b
    invoke-virtual {p0, v2}, Lcom/android/settings/password/ChooseLockPattern;->hideAppBar(Z)V
    ...
    invoke-virtual {p0, v6}, Lcom/android/settings/password/ChooseLockPattern;->findViewById(I)Landroid/view/View;
