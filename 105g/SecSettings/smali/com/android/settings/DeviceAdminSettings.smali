...
.method private addActiveAdminsForProfile(Ljava/util/List;I)V
    ...
    invoke-direct {v8, v6}, Lcom/android/settings/DeviceAdminSettings$DeviceAdminListItem;-><init>(Lcom/android/settings/DeviceAdminSettings$1;)V

    move-object v6, v8

    iput-object v7, v6, Lcom/android/settings/DeviceAdminSettings$DeviceAdminListItem;->info:Landroid/app/admin/DeviceAdminInfo;
    ...
    iput-object v8, v6, Lcom/android/settings/DeviceAdminSettings$DeviceAdminListItem;->name:Ljava/lang/String;

    const/4 v8, 0x1

    iput-boolean v8, v6, Lcom/android/settings/DeviceAdminSettings$DeviceAdminListItem;->active:Z
...
.method public onResume()V
    ...
    iget-object v2, p0, Lcom/android/settings/DeviceAdminSettings;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    :goto_0
    iput-object v2, p0, Lcom/android/settings/DeviceAdminSettings;->mDeviceOwnerPkg:Ljava/lang/String;

    iget-object v2, p0, Lcom/android/settings/DeviceAdminSettings;->mProfileOwnerComponents:Landroid/util/SparseArray;

    invoke-virtual {v2}, Landroid/util/SparseArray;->clear()V

    iget-object v2, p0, Lcom/android/settings/DeviceAdminSettings;->mUm:Landroid/os/UserManager;
    ...
    iget-object v6, p0, Lcom/android/settings/DeviceAdminSettings;->mProfileOwnerComponents:Landroid/util/SparseArray;

    iget-object v8, p0, Lcom/android/settings/DeviceAdminSettings;->mDPM:Landroid/app/admin/DevicePolicyManager;

    invoke-virtual {v8, v5}, Landroid/app/admin/DevicePolicyManager;->getProfileOwnerAsUser(I)Landroid/content/ComponentName;
...
.method updateList()V
    ...
    :cond_4
    iget-object v1, p0, Lcom/android/settings/DeviceAdminSettings;->mAdmins:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v3}, Landroid/widget/ListView;->semSetRoundedCorners(I)V
    ...
    invoke-virtual {v1, v3, v5}, Landroid/widget/ListView;->semSetRoundedCornerColor(II)V
    ...
    invoke-virtual {v1, v3}, Landroid/widget/ListView;->semSetBottomColor(I)V
    ...
    invoke-virtual {v1, v4}, Landroid/widget/ListView;->setNestedScrollingEnabled(Z)V
