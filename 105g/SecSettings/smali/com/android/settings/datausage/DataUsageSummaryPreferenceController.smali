...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mSelectDisplayUnit:I
...
.method public constructor <init>(Landroid/app/Activity;Lcom/android/settingslib/core/lifecycle/Lifecycle;Lcom/android/settings/datausage/DataUsageSummary;)V
    ...
    const-string v3, "data_usage_display_unit"
    ...
    sput v2, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mSelectDisplayUnit:I
...
.method public updateState(Landroid/support/v7/preference/Preference;)V
    ...
    check-cast v10, Lcom/android/settings/datausage/DataUsageSummaryPreference;
    ...
    invoke-virtual {v0, v11, v2}, Lcom/android/settings/datausage/DataUsageInfoController;->updateDataLimit(Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;Landroid/net/NetworkPolicy;)V

    invoke-virtual {v10, v7, v1}, Lcom/android/settings/datausage/DataUsageSummaryPreference;->setWifiMode(ZLjava/lang/String;)V

    iget-object v0, p0, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mSubscriptionManager:Landroid/telephony/SubscriptionManager;

    if-eqz v0, :cond_0

    invoke-direct {p0, v11}, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->refreshDataplanInfo(Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;)V
    ...
    sget v0, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mSelectDisplayUnit:I

    if-eqz v0, :cond_4

    iget-wide v12, v11, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->warningLevel:J

    cmp-long v0, v12, v8

    if-lez v0, :cond_1

    iget-wide v12, v11, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->limitLevel:J
    ...
    sget v3, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mSelectDisplayUnit:I

    iget-wide v12, v11, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->warningLevel:J

    invoke-static {v2, v3, v12, v13}, Lcom/samsung/android/settings/ConnectionsUtils;->getDataUsageFormatFileSize(Landroid/content/Context;IJ)Ljava/lang/String;
    ...
    invoke-virtual {v10, v0}, Lcom/android/settings/datausage/DataUsageSummaryPreference;->setLimitInfo(Ljava/lang/String;)V
    ...
    :cond_2
    iget-wide v3, v11, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->limitLevel:J
    ...
    sget v4, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mSelectDisplayUnit:I

    iget-wide v12, v11, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->limitLevel:J

    invoke-static {v3, v4, v12, v13}, Lcom/samsung/android/settings/ConnectionsUtils;->getDataUsageFormatFileSize(Landroid/content/Context;IJ)Ljava/lang/String;
    ...
    :cond_3
    invoke-virtual {v10, v1}, Lcom/android/settings/datausage/DataUsageSummaryPreference;->setLimitInfo(Ljava/lang/String;)V
    ...
    iget-wide v3, v11, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->warningLevel:J
    ...
    invoke-static {v2, v12, v13}, Lcom/android/settings/datausage/DataUsageUtils;->formatDataUsage(Landroid/content/Context;J)Ljava/lang/CharSequence;
    ...
    iget-wide v4, v11, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->limitLevel:J
    ...
    invoke-virtual {v10, v7}, Lcom/android/settings/datausage/DataUsageSummaryPreference;->setChartEnabled(Z)V

    goto :goto_2

    :cond_8
    invoke-virtual {v10, v6}, Lcom/android/settings/datausage/DataUsageSummaryPreference;->setChartEnabled(Z)V
    ...
    sget v1, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mSelectDisplayUnit:I

    invoke-static {v0, v1, v8, v9}, Lcom/samsung/android/settings/ConnectionsUtils;->getDataUsageFormatFileSize(Landroid/content/Context;IJ)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mContext:Landroid/content/Context;

    sget v2, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mSelectDisplayUnit:I

    iget-wide v3, p0, Lcom/android/settings/datausage/DataUsageSummaryPreferenceController;->mDataBarSize:J

    invoke-static {v1, v2, v3, v4}, Lcom/samsung/android/settings/ConnectionsUtils;->getDataUsageFormatFileSize(Landroid/content/Context;IJ)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v10, v0, v1}, Lcom/android/settings/datausage/DataUsageSummaryPreference;->setLabels(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v10, v0}, Lcom/android/settings/datausage/DataUsageSummaryPreference;->setProgress(F)V
    ...
    iget-object v0, v11, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->period:Ljava/lang/String;

    invoke-virtual {v10, v6, v0}, Lcom/android/settings/datausage/DataUsageSummaryPreference;->setWifiMode(ZLjava/lang/String;)V

    invoke-virtual {v10, v1}, Lcom/android/settings/datausage/DataUsageSummaryPreference;->setLimitInfo(Ljava/lang/String;)V

    iget-wide v1, v11, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->usageLevel:J
    ...
    iget-wide v1, v11, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->cycleStart:J

    iget-wide v3, v11, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->cycleEnd:J
