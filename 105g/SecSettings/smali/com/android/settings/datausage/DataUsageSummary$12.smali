...
.method public getNonIndexableKeys(Landroid/content/Context;)Ljava/util/List;
    ...
    const-string v5, "alert_at_warning"
    ...
    const-string v5, "confirm_at_boot"
    ...
    invoke-virtual {v5}, Lcom/android/settings/overlay/FeatureFactory;->getDataUsageFeatureProvider()Lcom/samsung/android/settings/datausage/DataUsageFeatureProvider;

    move-result-object v5

    invoke-interface {v5}, Lcom/samsung/android/settings/datausage/DataUsageFeatureProvider;->isSupportATTMobileData()Z

    move-result v6

    if-nez v6, :cond_b

    const-string v6, "mobile_data_att"

    invoke-interface {v0, v6}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    :cond_b
    invoke-interface {v5}, Lcom/samsung/android/settings/datausage/DataUsageFeatureProvider;->isSupportInternationalDataRoaming()Z

    move-result v6

    if-nez v6, :cond_c

    const-string v6, "roaming_att"
