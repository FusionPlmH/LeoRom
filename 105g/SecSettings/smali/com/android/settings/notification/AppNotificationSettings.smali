...
.method private populateGroupList()V
    ...
    new-instance v2, Landroid/support/v7/preference/SecPreferenceCategory;

    invoke-virtual {p0}, Lcom/android/settings/notification/AppNotificationSettings;->getPrefContext()Landroid/content/Context;

    move-result-object v3

    invoke-direct {v2, v3}, Landroid/support/v7/preference/SecPreferenceCategory;-><init>(Landroid/content/Context;)V

    const/4 v3, 0x1

    invoke-virtual {v2, v3}, Landroid/support/v7/preference/SecPreferenceCategory;->setOrderingAsAdded(Z)V
    ...
    invoke-virtual {v2, v3}, Landroid/support/v7/preference/SecPreferenceCategory;->setKey(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Landroid/support/v7/preference/SecPreferenceCategory;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, v2, v6, v7}, Lcom/android/settings/notification/AppNotificationSettings;->populateSingleChannelPrefs(Landroid/support/v7/preference/PreferenceGroup;Landroid/app/NotificationChannel;Z)Lcom/android/settings/widget/MasterSwitchPreference;
...
.method private populateList()V
    ...
    new-instance v0, Landroid/support/v7/preference/SecPreferenceCategory;

    invoke-virtual {p0}, Lcom/android/settings/notification/AppNotificationSettings;->getPrefContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1}, Landroid/support/v7/preference/SecPreferenceCategory;-><init>(Landroid/content/Context;)V

    const v1, 0x7f120fef

    invoke-virtual {v0, v1}, Landroid/support/v7/preference/SecPreferenceCategory;->setTitle(I)V

    sget-object v1, Lcom/android/settings/notification/AppNotificationSettings;->KEY_GENERAL_CATEGORY:Ljava/lang/String;

    invoke-virtual {v0, v1}, Landroid/support/v7/preference/SecPreferenceCategory;->setKey(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/preference/SecPreferenceCategory;->addPreference(Landroid/support/v7/preference/Preference;)Z
...
.method protected createPreferenceControllers(Landroid/content/Context;)Ljava/util/List;
    ...
    new-instance v1, Lcom/samsung/android/settings/notification/SecMoreSettingPreferenceController;

    invoke-direct {v1, p1}, Lcom/samsung/android/settings/notification/SecMoreSettingPreferenceController;-><init>(Landroid/content/Context;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/settings/notification/AppNotificationSettings;->getIntent()Landroid/content/Intent;
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings/notification/AppNotificationSettings;->setArguments(Landroid/os/Bundle;)V

    const/4 v2, 0x1

    invoke-virtual {p0, v2}, Lcom/android/settings/notification/AppNotificationSettings;->highlightPreferenceIfNeeded(Z)V
...
.method protected onGroupBlockStateChanged(Landroid/app/NotificationChannelGroup;)V
    ...
    invoke-virtual {p0, v0, v4, v5}, Lcom/android/settings/notification/AppNotificationSettings;->populateSingleChannelPrefs(Landroid/support/v7/preference/PreferenceGroup;Landroid/app/NotificationChannel;Z)Lcom/android/settings/widget/MasterSwitchPreference;
...
.method public onResume()V
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings/notification/AppNotificationSettings;->setAutoRemoveInsetCategory(Z)V
