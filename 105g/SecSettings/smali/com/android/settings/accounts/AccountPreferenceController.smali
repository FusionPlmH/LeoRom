...
.method private getAccountTypePreferences(Lcom/android/settingslib/accounts/AuthenticatorHelper;Landroid/os/UserHandle;Landroid/util/ArrayMap;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v3}, Lcom/android/settingslib/accounts/AuthenticatorHelper;->getAuthoritiesForAccountType(Ljava/lang/String;)Ljava/util/ArrayList;

    move-result-object v3

    iget-object v5, v0, Lcom/android/settings/accounts/AccountPreferenceController;->mAuthorities:[Ljava/lang/String;

    invoke-static {v5, v3}, Lcom/android/settings/accounts/AccountRestrictionHelper;->showAccount([Ljava/lang/String;Ljava/util/ArrayList;)Z
    ...
    invoke-virtual {v5, v3, v11}, Landroid/os/Bundle;->putParcelable(Ljava/lang/String;Landroid/os/Parcelable;)V
...
.method private newManagedProfileSettings()Landroid/support/v7/preference/Preference;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/preference/Preference;->setLayoutResource(I)V
...
.method private updateProfileUi(Landroid/content/pm/UserInfo;)V
    ...
    iput-object v5, v3, Lcom/android/settings/accounts/AccountPreferenceController$ProfileData;->removeWorkProfilePreference:Lcom/android/settingslib/RestrictedPreference;
...
.method public onPreferenceClick(Landroid/support/v7/preference/Preference;)Z
    ...
    const-string v6, "extra_fragment_mode"

    invoke-virtual {v4, v6, v5}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v6, "android.intent.extra.USER"

    iget-object v7, v3, Lcom/android/settings/accounts/AccountPreferenceController$ProfileData;->userInfo:Landroid/content/pm/UserInfo;
    ...
    iget-object v7, p0, Lcom/android/settings/accounts/AccountPreferenceController;->mAuthorities:[Ljava/lang/String;
    ...
    invoke-virtual {v7}, Lcom/android/settings/SettingsPreferenceFragment;->getMetricsCategory()I
    ...
    const-string v7, "com.android.settings.accounts.ChooseAccountActivity"
    ...
    invoke-virtual {v6, v7, v1}, Lcom/android/settings/core/SubSettingLauncher;->setResultListener(Landroid/app/Fragment;I)Lcom/android/settings/core/SubSettingLauncher;

    move-result-object v1

    const v6, 0x7f1200b0

    invoke-virtual {v1, v6}, Lcom/android/settings/core/SubSettingLauncher;->setTitle(I)Lcom/android/settings/core/SubSettingLauncher;

    move-result-object v1

    invoke-virtual {v1, v4}, Lcom/android/settings/core/SubSettingLauncher;->setArguments(Landroid/os/Bundle;)Lcom/android/settings/core/SubSettingLauncher;
