...
.method public static formatBytes(Landroid/content/res/Resources;JI)Lcom/android/settingslib/applications/AppFileSizeFormatter$BytesResult;
    ...
    iget v2, v0, Lcom/android/settingslib/applications/AppFileSizeFormatter$RoundedBytesResult;->fractionDigits:I

    invoke-static {v1, v2}, Lcom/android/settingslib/applications/AppFileSizeFormatter;->getNumberFormatter(Ljava/util/Locale;I)Landroid/icu/text/NumberFormat;

    move-result-object v2

    iget v3, v0, Lcom/android/settingslib/applications/AppFileSizeFormatter$RoundedBytesResult;->value:F
    ...
    iget-object v4, v0, Lcom/android/settingslib/applications/AppFileSizeFormatter$RoundedBytesResult;->units:Landroid/icu/util/MeasureUnit;

    invoke-static {v4}, Lcom/android/settingslib/applications/AppFileSizeFormatter;->isFileSize(Landroid/icu/util/MeasureUnit;)Z
    ...
    invoke-static {p0, v4}, Lcom/android/settingslib/applications/AppFileSizeFormatter;->getSuffixOverride(Landroid/content/res/Resources;Landroid/icu/util/MeasureUnit;)Ljava/lang/String;
    ...
    :cond_0
    iget v4, v0, Lcom/android/settingslib/applications/AppFileSizeFormatter$RoundedBytesResult;->value:F

    iget-object v5, v0, Lcom/android/settingslib/applications/AppFileSizeFormatter$RoundedBytesResult;->units:Landroid/icu/util/MeasureUnit;

    invoke-static {v1, v2, v4, v5}, Lcom/android/settingslib/applications/AppFileSizeFormatter;->formatMeasureShort(Ljava/util/Locale;Landroid/icu/text/NumberFormat;FLandroid/icu/util/MeasureUnit;)Ljava/lang/String;

    move-result-object v4

    invoke-static {v4, v3}, Lcom/android/settingslib/applications/AppFileSizeFormatter;->deleteFirstFromString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    sget-object v6, Lcom/android/settingslib/applications/AppFileSizeFormatter;->SPACES_AND_CONTROLS:Landroid/icu/text/UnicodeSetSpanner;
    ...
    :goto_0
    new-instance v5, Lcom/android/settingslib/applications/AppFileSizeFormatter$BytesResult;

    iget-wide v6, v0, Lcom/android/settingslib/applications/AppFileSizeFormatter$RoundedBytesResult;->roundedBytes:J

    invoke-direct {v5, v3, v4, v6, v7}, Lcom/android/settingslib/applications/AppFileSizeFormatter$BytesResult;-><init>(Ljava/lang/String;Ljava/lang/String;J)V
