...
.method public run()V
    ...
    invoke-static {v0}, Landroid/sec/clipboard/data/file/FileManager$ConnectFileSystem;->access$100(Landroid/sec/clipboard/data/file/FileManager$ConnectFileSystem;)Z
    ...
    invoke-static {v0}, Landroid/sec/clipboard/data/file/FileManager$ConnectFileSystem;->access$300(Landroid/sec/clipboard/data/file/FileManager$ConnectFileSystem;)Landroid/sec/clipboard/util/FileHelper;
    ...
    invoke-static {v1}, Landroid/sec/clipboard/data/file/FileManager$ConnectFileSystem;->access$200(Landroid/sec/clipboard/data/file/FileManager$ConnectFileSystem;)Ljava/io/File;
    ...
    invoke-static {v0}, Landroid/sec/clipboard/data/file/FileManager$ConnectFileSystem;->access$400(Landroid/sec/clipboard/data/file/FileManager$ConnectFileSystem;)I

    move-result v0

    iget-object v1, p0, Landroid/sec/clipboard/data/file/FileManager$ConnectFileSystem$1;->this$1:Landroid/sec/clipboard/data/file/FileManager$ConnectFileSystem;

    invoke-static {v1}, Landroid/sec/clipboard/data/file/FileManager$ConnectFileSystem;->access$300(Landroid/sec/clipboard/data/file/FileManager$ConnectFileSystem;)Landroid/sec/clipboard/util/FileHelper;
    ...
    invoke-static {v2}, Landroid/sec/clipboard/data/file/FileManager$ConnectFileSystem;->access$200(Landroid/sec/clipboard/data/file/FileManager$ConnectFileSystem;)Ljava/io/File;
    ...
    invoke-static {v0}, Landroid/sec/clipboard/data/file/FileManager$ConnectFileSystem;->access$500(Landroid/sec/clipboard/data/file/FileManager$ConnectFileSystem;)Z
