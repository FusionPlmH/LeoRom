...
.method public static downloadSimpleBitmap(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    ...
    :try_start_0
    const-string v7, "ClipboardDataBitmapUrl"
    ...
    const-string v6, "Return null because received bitmap size is invalid. bitmapOption.outWidth :"
    ...
    const-string v6, ", bitmapOption.outHeight :"
...
.method private static findImageDegree(Landroid/content/ContentResolver;Landroid/net/Uri;)I
    ...
    :cond_6
    :try_start_4
    invoke-static {v1}, Landroid/sec/clipboard/util/ClipboardDataBitmapUrl;->getExifOrientation(Ljava/lang/String;)I
...
.method public static getUriPathBitmap(Landroid/content/ContentResolver;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v3}, Landroid/sec/clipboard/util/ClipboardDataBitmapUrl;->rotateBitmap(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
