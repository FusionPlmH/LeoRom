...
.method public cancelFrequencyRequestImpl()V
    ...
    iget-object v0, p0, Landroid/os/CustomFrequencyManager$CpuSetRequest;->mToken:Landroid/os/IBinder;
    ...
    iget-object v2, p0, Landroid/os/CustomFrequencyManager$CpuSetRequest;->mCpuSetReleaser:Ljava/lang/Runnable;
    ...
    iget-object v3, p0, Landroid/os/CustomFrequencyManager$CpuSetRequest;->mPkgName:Ljava/lang/String;

    invoke-interface {v1, v2, v3}, Landroid/os/ICustomFrequencyManager;->disableCpuSet(Landroid/os/IBinder;Ljava/lang/String;)V
    :try_end_0
...
.method public doFrequencyRequestImpl()V
    ...
    const-string v2, "CpuSetRequest : doFrequencyRequest::  = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v2, p0, Landroid/os/CustomFrequencyManager$CpuSetRequest;->mFrequency:I
    ...
    iget-wide v2, p0, Landroid/os/CustomFrequencyManager$CpuSetRequest;->mTimeoutMs:J
    ...
    invoke-interface {v1, v2, v3}, Landroid/os/ICustomFrequencyManager;->enableCpuSet(Landroid/os/IBinder;Ljava/lang/String;)V

    iget-wide v1, p0, Landroid/os/CustomFrequencyManager$CpuSetRequest;->mTimeoutMs:J
    ...
    iget-wide v3, p0, Landroid/os/CustomFrequencyManager$CpuSetRequest;->mTimeoutMs:J
