...
.method public cancelFrequencyRequestImpl()V
    ...
    iget-object v0, p0, Landroid/os/CustomFrequencyManager$SchedTunePolicyRequest;->mToken:Landroid/os/IBinder;
    ...
    iput-boolean v2, v1, Landroid/os/CustomFrequencyManager$SchedTunePolicyRequest$SchedTunePolicyReleaser;->stop:Z
    ...
    iget-object v3, p0, Landroid/os/CustomFrequencyManager$SchedTunePolicyRequest;->mPkgName:Ljava/lang/String;

    invoke-interface {v1, v2, v3}, Landroid/os/ICustomFrequencyManager;->disableSchedTunePolicy(Landroid/os/IBinder;Ljava/lang/String;)V
    :try_end_0
...
.method public doFrequencyRequestImpl()V
    ...
    const-string v2, "SchedTunePolicyRequest : doFrequencyRequest::  = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v2, p0, Landroid/os/CustomFrequencyManager$SchedTunePolicyRequest;->mFrequency:I
    ...
    iget-wide v2, p0, Landroid/os/CustomFrequencyManager$SchedTunePolicyRequest;->mTimeoutMs:J
    ...
    invoke-interface {v1, v2, v3}, Landroid/os/ICustomFrequencyManager;->enableSchedTunePolicy(Landroid/os/IBinder;Ljava/lang/String;)V

    iget-wide v1, p0, Landroid/os/CustomFrequencyManager$SchedTunePolicyRequest;->mTimeoutMs:J
    ...
    iget-object v2, p0, Landroid/os/CustomFrequencyManager$SchedTunePolicyRequest;->mSchedTunePolicyReleaser:Landroid/os/CustomFrequencyManager$SchedTunePolicyRequest$SchedTunePolicyReleaser;

    iget-wide v3, p0, Landroid/os/CustomFrequencyManager$SchedTunePolicyRequest;->mTimeoutMs:J
