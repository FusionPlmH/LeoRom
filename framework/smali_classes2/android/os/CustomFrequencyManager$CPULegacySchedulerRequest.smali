...
.method public cancelFrequencyRequestImpl()V
    ...
    iget-object v0, p0, Landroid/os/CustomFrequencyManager$CPULegacySchedulerRequest;->mToken:Landroid/os/IBinder;
    ...
    iput-boolean v2, v1, Landroid/os/CustomFrequencyManager$CPULegacySchedulerRequest$CPULegacySchedulerReleaser;->stop:Z
    ...
    iget-object v3, p0, Landroid/os/CustomFrequencyManager$CPULegacySchedulerRequest;->mPkgName:Ljava/lang/String;

    invoke-interface {v1, v2, v3}, Landroid/os/ICustomFrequencyManager;->disableLegacyScheduler(Landroid/os/IBinder;Ljava/lang/String;)V
    :try_end_0
...
.method public doFrequencyRequestImpl()V
    ...
    const-string v2, "CPULegacySchedulerRequest : doFrequencyRequest::  = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v2, p0, Landroid/os/CustomFrequencyManager$CPULegacySchedulerRequest;->mFrequency:I
    ...
    iget-wide v2, p0, Landroid/os/CustomFrequencyManager$CPULegacySchedulerRequest;->mTimeoutMs:J
    ...
    invoke-interface {v1, v2, v3}, Landroid/os/ICustomFrequencyManager;->enableLegacyScheduler(Landroid/os/IBinder;Ljava/lang/String;)V

    iget-wide v1, p0, Landroid/os/CustomFrequencyManager$CPULegacySchedulerRequest;->mTimeoutMs:J
    ...
    iget-object v2, p0, Landroid/os/CustomFrequencyManager$CPULegacySchedulerRequest;->mCPULegacySchedulerReleaser:Landroid/os/CustomFrequencyManager$CPULegacySchedulerRequest$CPULegacySchedulerReleaser;

    iget-wide v3, p0, Landroid/os/CustomFrequencyManager$CPULegacySchedulerRequest;->mTimeoutMs:J
