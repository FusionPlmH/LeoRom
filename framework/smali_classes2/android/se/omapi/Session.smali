...
# static fields
.field private static final TAG:Ljava/lang/String; = "SES_OMAPI.Session"
...
# direct methods
.method constructor <init>(Landroid/se/omapi/SEService;Landroid/se/omapi/ISecureElementSession;Landroid/se/omapi/Reader;Landroid/content/Context;)V
    .locals 2
    ...
    iput-object p4, p0, Landroid/se/omapi/Session;->mContext:Landroid/content/Context;
...
.method public close()V
    ...
    const-string v0, "SES_OMAPI.Session"
    ...
    :try_start_1
    const-string v2, "SES_OMAPI.Session"
...
.method public openBasicChannel([BB)Landroid/se/omapi/Channel;
    ...
    iget-object v2, p0, Landroid/se/omapi/Session;->mContext:Landroid/content/Context;

    invoke-virtual {v2}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v2

    iget-object v3, p0, Landroid/se/omapi/Session;->mReader:Landroid/se/omapi/Reader;

    invoke-virtual {v3}, Landroid/se/omapi/Reader;->getSEService()Landroid/se/omapi/SEService;

    move-result-object v3

    invoke-virtual {v3}, Landroid/se/omapi/SEService;->getListener()Landroid/se/omapi/ISecureElementListener;

    move-result-object v3

    invoke-interface {v1, p1, p2, v2, v3}, Landroid/se/omapi/ISecureElementSession;->openBasicChannel([BBLjava/lang/String;Landroid/se/omapi/ISecureElementListener;)Landroid/se/omapi/ISecureElementChannel;
...
.method public openLogicalChannel([BB)Landroid/se/omapi/Channel;
    ...
    invoke-interface {v1, p1, p2, v2, v3}, Landroid/se/omapi/ISecureElementSession;->openLogicalChannel([BBLjava/lang/String;Landroid/se/omapi/ISecureElementListener;)Landroid/se/omapi/ISecureElementChannel;
