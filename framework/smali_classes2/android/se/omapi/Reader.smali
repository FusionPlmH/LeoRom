...
# static fields
.field private static final TAG:Ljava/lang/String; = "SES_OMAPI.Reader"
...
# direct methods
.method constructor <init>(Landroid/se/omapi/SEService;Landroid/content/Context;Ljava/lang/String;Landroid/se/omapi/ISecureElementReader;)V
    .locals 2
    ...
    iput-object p3, p0, Landroid/se/omapi/Reader;->mName:Ljava/lang/String;

    iput-object p2, p0, Landroid/se/omapi/Reader;->mContext:Landroid/content/Context;

    iput-object p1, p0, Landroid/se/omapi/Reader;->mService:Landroid/se/omapi/SEService;

    iput-object p4, p0, Landroid/se/omapi/Reader;->mReader:Landroid/se/omapi/ISecureElementReader;
...
.method public closeSessions()V
    ...
    const-string v0, "SES_OMAPI.Reader"
...
.method public openSession()Landroid/se/omapi/Session;
    ...
    iget-object v4, p0, Landroid/se/omapi/Reader;->mContext:Landroid/content/Context;

    invoke-direct {v2, v3, v1, p0, v4}, Landroid/se/omapi/Session;-><init>(Landroid/se/omapi/SEService;Landroid/se/omapi/ISecureElementSession;Landroid/se/omapi/Reader;Landroid/content/Context;)V
