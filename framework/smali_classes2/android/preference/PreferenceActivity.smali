...
.method static synthetic access$800(Landroid/preference/PreferenceActivity;)Landroid/view/ViewGroup;
    .locals 1
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v4, v3, v6, v5}, Landroid/preference/PreferenceActivity;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v0, v6}, Landroid/preference/PreferenceActivity;->setContentView(I)V
    ...
    invoke-virtual {v13, v14, v5}, Landroid/content/Intent;->getIntExtra(Ljava/lang/String;I)I
    ...
    iget-object v14, v0, Landroid/preference/PreferenceActivity;->mSplitBarView:Landroid/view/View;
    ...
    sget v17, Landroid/preference/PreferenceActivity;->mSplitBarMovedLeftWeight:F
    ...
    iget-object v2, v0, Landroid/preference/PreferenceActivity;->mSplitBarView:Landroid/view/View;
    ...
    invoke-virtual {v0, v5}, Landroid/preference/PreferenceActivity;->setSelectedHeader(Landroid/preference/PreferenceActivity$Header;)V
    ...
    invoke-virtual {v0, v5}, Landroid/preference/PreferenceActivity;->switchToHeader(Landroid/preference/PreferenceActivity$Header;)V
    ...
    invoke-virtual {v0, v4, v5}, Landroid/preference/PreferenceActivity;->showBreadCrumbs(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
    ...
    iget v5, v0, Landroid/preference/PreferenceActivity;->mPreferenceHeaderItemResId:I

    iget-boolean v14, v0, Landroid/preference/PreferenceActivity;->mPreferenceHeaderRemoveEmptyIcon:Z

    invoke-direct {v2, v0, v4, v5, v14}, Landroid/preference/PreferenceActivity$HeaderAdapter;-><init>(Landroid/content/Context;Ljava/util/List;IZ)V
    ...
    iput-object v5, v0, Landroid/preference/PreferenceActivity;->mFragmentBreadCrumbs:Landroid/app/FragmentBreadCrumbs;
    ...
    :goto_8
    invoke-virtual {v0, v2, v5}, Landroid/preference/PreferenceActivity;->showBreadCrumbs(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v2, v0, v5}, Landroid/preference/PreferenceManager;-><init>(Landroid/app/Activity;I)V

    iput-object v2, v0, Landroid/preference/PreferenceActivity;->mPreferenceManager:Landroid/preference/PreferenceManager;

    iget-object v2, v0, Landroid/preference/PreferenceActivity;->mPreferenceManager:Landroid/preference/PreferenceManager;
    ...
    :goto_f
    iput-boolean v5, v0, Landroid/preference/PreferenceActivity;->mIsRTL:Z

    iget-boolean v5, v0, Landroid/preference/PreferenceActivity;->mIsDeviceDefault:Z
    ...
    iget-object v5, v0, Landroid/preference/PreferenceActivity;->mSplitBarView:Landroid/view/View;

    if-eqz v5, :cond_1e

    iget-object v5, v0, Landroid/preference/PreferenceActivity;->mSplitBarLayoutChangeListner:Landroid/view/View$OnLayoutChangeListener;

    if-nez v5, :cond_1d

    new-instance v5, Landroid/preference/PreferenceActivity$5;

    invoke-direct {v5, v0}, Landroid/preference/PreferenceActivity$5;-><init>(Landroid/preference/PreferenceActivity;)V

    iput-object v5, v0, Landroid/preference/PreferenceActivity;->mSplitBarLayoutChangeListner:Landroid/view/View$OnLayoutChangeListener;
    ...
    iput-boolean v5, v0, Landroid/preference/PreferenceActivity;->mInsideOnCreate:Z
