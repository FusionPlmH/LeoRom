...
.field public static final DND_CHECK_BY_CHANNEL_BYPASS:I = 0x100
...
.field public static final TW_SCHEDULED_DEFAULT_RULE:Ljava/lang/String; = "SCHEDULED_DEFAULT_RULE"
...
.method static constructor <clinit>()V
    ...
    const-string v0, "SCHEDULED_DEFAULT_RULE"
...
.method private diff(Landroid/service/notification/ZenModeConfig;)Landroid/service/notification/ZenModeConfig$Diff;
    ...
    invoke-static {v0, v8, v6, v7}, Landroid/service/notification/ZenModeConfig$ZenRule;->access$100(Landroid/service/notification/ZenModeConfig$Diff;Ljava/lang/String;Landroid/service/notification/ZenModeConfig$ZenRule;Landroid/service/notification/ZenModeConfig$ZenRule;)V
    ...
    iget-object v10, v6, Landroid/service/notification/ZenModeConfig$ZenRule;->name:Ljava/lang/String;
    ...
    invoke-virtual {v0}, Landroid/service/notification/ZenModeConfig$Diff;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v0, v10}, Landroid/service/notification/ZenModeConfig$Diff;->getLine(Ljava/lang/String;)Z

    move-result v10

    if-eqz v10, :cond_10

    iget v10, v0, Landroid/service/notification/ZenModeConfig$Diff;->diffBit:I

    or-int/2addr v9, v10

    iput v9, v0, Landroid/service/notification/ZenModeConfig$Diff;->diffBit:I

    :cond_10
    const-string/jumbo v9, "zenMode"

    invoke-virtual {v0, v9}, Landroid/service/notification/ZenModeConfig$Diff;->getLine(Ljava/lang/String;)Z

    move-result v9

    if-eqz v9, :cond_11

    iget v9, v0, Landroid/service/notification/ZenModeConfig$Diff;->diffBit:I
    ...
    invoke-virtual {v0, v3}, Landroid/service/notification/ZenModeConfig$Diff;->getLine(Ljava/lang/String;)Z
    ...
    const-string v3, "allowWhenScreenOff"
    ...
    const-string v3, "allowWhenScreenOn"
    ...
    :cond_14
    iget v3, v0, Landroid/service/notification/ZenModeConfig$Diff;->diffBit:I

    or-int/lit16 v3, v3, 0x80

    iput v3, v0, Landroid/service/notification/ZenModeConfig$Diff;->diffBit:I
    ...
    const-string v5, "diffBit : "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v5, v0, Landroid/service/notification/ZenModeConfig$Diff;->diffBit:I
...
.method public static readXml(Lorg/xmlpull/v1/XmlPullParser;)Landroid/service/notification/ZenModeConfig;
    ...
    iget-object v9, v8, Landroid/service/notification/ZenModeConfig$ZenRule;->component:Landroid/content/ComponentName;
    ...
    const-string v11, "Bad component in rule xml: "

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v11, v8, Landroid/service/notification/ZenModeConfig$ZenRule;->name:Ljava/lang/String;
