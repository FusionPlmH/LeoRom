...
.method public getAidSizeForServiceInPercent(Landroid/content/ComponentName;)I
    ...
    invoke-interface {v1, v3, p1}, Landroid/nfc/INfcCardEmulation;->getAidSizeForServiceInPercent(ILandroid/content/ComponentName;)I
...
.method public getPaymentDefaultServiceInfo()Landroid/nfc/cardemulation/ApduServiceInfo;
    ...
    invoke-interface {v1, v3}, Landroid/nfc/INfcCardEmulation;->getPaymentDefaultServiceInfo(I)Landroid/nfc/cardemulation/ApduServiceInfo;
...
.method public getPaymentPriority()Landroid/content/ComponentName;
    ...
    invoke-interface {v1, v3}, Landroid/nfc/INfcCardEmulation;->getPaymentPriority(I)Landroid/content/ComponentName;
...
.method public getUsedAidTableSizeInPercent(Ljava/lang/String;)I
    ...
    invoke-interface {v1, v3, p1}, Landroid/nfc/INfcCardEmulation;->getUsedAidTableSizeInPercent(ILjava/lang/String;)I
...
.method public initializePaymentDefault(I)V
    ...
    invoke-interface {v1, v2, p1}, Landroid/nfc/INfcCardEmulation;->initializePaymentDefault(II)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_1
...
.method public isRegisteredService(Landroid/content/ComponentName;Ljava/lang/String;)Z
    ...
    invoke-interface {v1, v3, p1, p2}, Landroid/nfc/INfcCardEmulation;->isRegisteredService(ILandroid/content/ComponentName;Ljava/lang/String;)Z
...
.method public registerService(Landroid/content/ComponentName;Ljava/lang/String;)I
    ...
    invoke-interface {v2, v4, p1, p2, v0}, Landroid/nfc/INfcCardEmulation;->registerService(ILandroid/content/ComponentName;Ljava/lang/String;I)I
...
.method public registerService(Landroid/content/ComponentName;Ljava/lang/String;I)V
    ...
    invoke-interface {v0, v1, p1, p2, p3}, Landroid/nfc/INfcCardEmulation;->registerService(ILandroid/content/ComponentName;Ljava/lang/String;I)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {v1, v2, p1, p2, p3}, Landroid/nfc/INfcCardEmulation;->registerService(ILandroid/content/ComponentName;Ljava/lang/String;I)I
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_1
...
.method public setOtherService(Landroid/content/ComponentName;)Z
    ...
    invoke-interface {v0, v1, p1}, Landroid/nfc/INfcCardEmulation;->setOtherService(ILandroid/content/ComponentName;)Z
    ...
    invoke-interface {v1, v3, p1}, Landroid/nfc/INfcCardEmulation;->setOtherService(ILandroid/content/ComponentName;)Z
...
.method public unsetOtherService(Landroid/content/ComponentName;)Z
    ...
    invoke-interface {v0, v1, p1}, Landroid/nfc/INfcCardEmulation;->unsetOtherService(ILandroid/content/ComponentName;)Z
    ...
    invoke-interface {v1, v3, p1}, Landroid/nfc/INfcCardEmulation;->unsetOtherService(ILandroid/content/ComponentName;)Z
