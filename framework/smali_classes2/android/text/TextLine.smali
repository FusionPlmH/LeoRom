...
.method private handleText(Landroid/text/TextPaint;IIIIZLandroid/graphics/Canvas;FIIILandroid/graphics/Paint$FontMetricsInt;ZILjava/util/ArrayList;)F
    ...
    invoke-virtual {v9, v0}, Landroid/text/TextPaint;->setWordSpacing(F)V

    if-eqz v13, :cond_0

    invoke-static {v13, v9}, Landroid/text/TextLine;->expandMetricsFromPaint(Landroid/graphics/Paint$FontMetricsInt;Landroid/text/TextPaint;)V
    ...
    iget v0, v9, Landroid/text/TextPaint;->bgColor:I
    ...
    invoke-virtual {v9, v0}, Landroid/text/TextPaint;->setStyle(Landroid/graphics/Paint$Style;)V
    ...
    invoke-virtual {v9, v7}, Landroid/text/TextPaint;->setStyle(Landroid/graphics/Paint$Style;)V
    ...
    sub-float v0, v21, v28

    sub-float v1, v21, v27
    ...
    add-float v1, v20, v28

    goto :goto_7

    :goto_8
    iget v0, v13, Landroid/text/TextLine$DecorationInfo;->underlineColor:I

    if-eqz v0, :cond_9

    iget v2, v13, Landroid/text/TextLine$DecorationInfo;->underlineColor:I

    invoke-virtual/range {p1 .. p1}, Landroid/text/TextPaint;->getUnderlinePosition()F

    move-result v3

    iget v4, v13, Landroid/text/TextLine$DecorationInfo;->underlineThickness:F
    ...
    :cond_9
    iget-boolean v0, v13, Landroid/text/TextLine$DecorationInfo;->isUnderlineText:Z
    ...
    invoke-static/range {v11 .. v18}, Landroid/text/TextLine;->drawStroke(Landroid/text/TextPaint;Landroid/graphics/Canvas;IFFFFF)V
    ...
    :goto_9
    iget-boolean v0, v5, Landroid/text/TextLine$DecorationInfo;->isStrikeThruText:Z
    ...
    iget v0, v9, Landroid/text/TextPaint;->baselineShift:I
