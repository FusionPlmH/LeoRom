.class Landroid/telephony/SemTelephoneManager$2;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/telephony/SemTelephoneManager;->lambda$setIccEpsLoci$23(I[BLandroid/telephony/SemTelephoneManager$OnCompleteListener;)V
.end annotation
...
.method constructor <init>(Landroid/telephony/SemTelephoneManager;Landroid/telephony/SemTelephoneManager$OnCompleteListener;)V
    ...
    iput-object p1, p0, Landroid/telephony/SemTelephoneManager$2;->this$0:Landroid/telephony/SemTelephoneManager;

    iput-object p2, p0, Landroid/telephony/SemTelephoneManager$2;->val$listener:Landroid/telephony/SemTelephoneManager$OnCompleteListener;
...
.method public onResult(ZLjava/lang/String;)V
    ...
    iget-object v0, p0, Landroid/telephony/SemTelephoneManager$2;->val$listener:Landroid/telephony/SemTelephoneManager$OnCompleteListener;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/telephony/SemTelephoneManager$2;->val$listener:Landroid/telephony/SemTelephoneManager$OnCompleteListener;

    new-instance v1, Landroid/telephony/-$$Lambda$SemTelephoneManager$2$Y_BNkBn5pa8gV2FGolCSLWtppTk;

    invoke-direct {v1, v0, p1, p2}, Landroid/telephony/-$$Lambda$SemTelephoneManager$2$Y_BNkBn5pa8gV2FGolCSLWtppTk;-><init>(Landroid/telephony/SemTelephoneManager$OnCompleteListener;ZLjava/lang/String;)V
