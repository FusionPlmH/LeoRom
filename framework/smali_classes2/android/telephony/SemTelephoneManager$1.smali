.class Landroid/telephony/SemTelephoneManager$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/telephony/SemTelephoneManager;->lambda$setIccFdnEnabled$21(IZLjava/lang/String;Landroid/telephony/SemTelephoneManager$OnCompleteListener;)V
.end annotation
...
.method constructor <init>(Landroid/telephony/SemTelephoneManager;Landroid/telephony/SemTelephoneManager$OnCompleteListener;)V
    ...
    iput-object p1, p0, Landroid/telephony/SemTelephoneManager$1;->this$0:Landroid/telephony/SemTelephoneManager;

    iput-object p2, p0, Landroid/telephony/SemTelephoneManager$1;->val$listener:Landroid/telephony/SemTelephoneManager$OnCompleteListener;
...
.method public onResult(ZLjava/lang/String;)V
    ...
    iget-object v0, p0, Landroid/telephony/SemTelephoneManager$1;->val$listener:Landroid/telephony/SemTelephoneManager$OnCompleteListener;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/telephony/SemTelephoneManager$1;->val$listener:Landroid/telephony/SemTelephoneManager$OnCompleteListener;

    new-instance v1, Landroid/telephony/-$$Lambda$SemTelephoneManager$1$zm2mJO9Zfp6PFzsSrn7SPtaxm_E;

    invoke-direct {v1, v0, p1, p2}, Landroid/telephony/-$$Lambda$SemTelephoneManager$1$zm2mJO9Zfp6PFzsSrn7SPtaxm_E;-><init>(Landroid/telephony/SemTelephoneManager$OnCompleteListener;ZLjava/lang/String;)V
