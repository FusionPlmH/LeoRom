.class Landroid/telephony/SemTelephoneManager$7;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/telephony/SemTelephoneManager;->lambda$setCallWaitingEnabled$42(IZLandroid/telephony/SemTelephoneManager$OnCompleteListener;)V
.end annotation
...
.method constructor <init>(Landroid/telephony/SemTelephoneManager;Landroid/telephony/SemTelephoneManager$OnCompleteListener;)V
    ...
    iput-object p1, p0, Landroid/telephony/SemTelephoneManager$7;->this$0:Landroid/telephony/SemTelephoneManager;

    iput-object p2, p0, Landroid/telephony/SemTelephoneManager$7;->val$listener:Landroid/telephony/SemTelephoneManager$OnCompleteListener;
...
.method public onResult(ZLjava/lang/String;)V
    ...
    iget-object v0, p0, Landroid/telephony/SemTelephoneManager$7;->val$listener:Landroid/telephony/SemTelephoneManager$OnCompleteListener;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/telephony/SemTelephoneManager$7;->val$listener:Landroid/telephony/SemTelephoneManager$OnCompleteListener;

    new-instance v1, Landroid/telephony/-$$Lambda$SemTelephoneManager$7$m03cE7vDD2XFH6Q5qkgYivCzbpk;

    invoke-direct {v1, v0, p1, p2}, Landroid/telephony/-$$Lambda$SemTelephoneManager$7$m03cE7vDD2XFH6Q5qkgYivCzbpk;-><init>(Landroid/telephony/SemTelephoneManager$OnCompleteListener;ZLjava/lang/String;)V
