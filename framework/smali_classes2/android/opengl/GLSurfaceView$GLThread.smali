...
.method private guardedRun()V
    ...
    iget-boolean v14, v1, Landroid/opengl/GLSurfaceView$GLThread;->mHaveEglContext:Z
    :try_end_3
    ...
    :try_start_5
    iput-boolean v14, v1, Landroid/opengl/GLSurfaceView$GLThread;->mHaveEglContext:Z
    ...
    iget-boolean v14, v1, Landroid/opengl/GLSurfaceView$GLThread;->mHaveEglSurface:Z

    if-nez v14, :cond_f

    const/4 v14, 0x1

    iput-boolean v14, v1, Landroid/opengl/GLSurfaceView$GLThread;->mHaveEglSurface:Z
    ...
    iget-boolean v14, v1, Landroid/opengl/GLSurfaceView$GLThread;->mSizeChanged:Z

    if-eqz v14, :cond_10

    const/4 v7, 0x1

    iget v14, v1, Landroid/opengl/GLSurfaceView$GLThread;->mWidth:I
    ...
    iput-boolean v14, v1, Landroid/opengl/GLSurfaceView$GLThread;->mWantRenderNotification:Z

    const/4 v15, 0x1

    const/4 v14, 0x0

    iput-boolean v14, v1, Landroid/opengl/GLSurfaceView$GLThread;->mSizeChanged:Z

    :cond_10
    const/4 v14, 0x0

    iput-boolean v14, v1, Landroid/opengl/GLSurfaceView$GLThread;->mRequestRender:Z
    ...
    invoke-static {v0, v14, v5}, Landroid/opengl/GLSurfaceView$EglHelper;->logEglErrorAsWarning(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    const-string v14, "Warning, !readyToDraw() but waiting for draw finished! Early reporting draw finished."
