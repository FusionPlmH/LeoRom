...
.method public createFromParcel(Landroid/os/Parcel;)Landroid/net/wifi/ScanResult;
    ...
    iput v4, v2, Landroid/net/wifi/ScanResult;->beaconInterval:I
    ...
    iput v4, v2, Landroid/net/wifi/ScanResult;->wifiMode:I

    invoke-virtual/range {p1 .. p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v4

    iput-object v4, v2, Landroid/net/wifi/ScanResult;->semVendorSpecificInfo:Ljava/lang/String;

    invoke-virtual/range {p1 .. p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v4

    iput-object v4, v2, Landroid/net/wifi/ScanResult;->semBssLoadElement:Ljava/lang/String;

    invoke-virtual/range {p1 .. p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v4

    iput-object v4, v2, Landroid/net/wifi/ScanResult;->semKtVendorSpecificInfo:Ljava/lang/String;
