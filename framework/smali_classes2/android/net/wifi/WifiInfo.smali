...
.field public static final MODE_11AX:I = 0x6
...
.method public constructor <init>()V
    ...
    iput-object v2, p0, Landroid/net/wifi/WifiInfo;->mSupplicantState:Landroid/net/wifi/SupplicantState;

    const/16 v2, -0x7f

    iput v2, p0, Landroid/net/wifi/WifiInfo;->mRssi:I
    ...
    iput-boolean v1, p0, Landroid/net/wifi/WifiInfo;->mNotAskAgainCheck:Z

    iput-boolean v1, p0, Landroid/net/wifi/WifiInfo;->mChnKeepConnection:Z
    ...
    iput-boolean v1, p0, Landroid/net/wifi/WifiInfo;->mGigaAp:Z

    iput-object v0, p0, Landroid/net/wifi/WifiInfo;->mVenueName:Ljava/lang/String;

    iput v1, p0, Landroid/net/wifi/WifiInfo;->mSnr:I
    ...
    iput v1, p0, Landroid/net/wifi/WifiInfo;->mWifiMode:I
...
.method public constructor <init>(Landroid/net/wifi/WifiInfo;)V
    ...
    iget-boolean v0, p1, Landroid/net/wifi/WifiInfo;->mNotAskAgainCheck:Z

    iput-boolean v0, p0, Landroid/net/wifi/WifiInfo;->mNotAskAgainCheck:Z
    ...
    iget v0, p1, Landroid/net/wifi/WifiInfo;->mWifiMode:I

    iput v0, p0, Landroid/net/wifi/WifiInfo;->mWifiMode:I
...
.method public getNotAskAgainCheck()Z
    .locals 1

    iget-boolean v0, p0, Landroid/net/wifi/WifiInfo;->mNotAskAgainCheck:Z
...
.method public getWifiMode()I
    ...
    iget v0, p0, Landroid/net/wifi/WifiInfo;->mWifiMode:I
...
.method public reset()V
    ...
    invoke-virtual {p0, v1}, Landroid/net/wifi/WifiInfo;->setChnKeepConnection(Z)V
    ...
    invoke-virtual {p0, v0}, Landroid/net/wifi/WifiInfo;->setLoginUrl(Ljava/lang/String;)V

    invoke-virtual {p0, v1}, Landroid/net/wifi/WifiInfo;->setGigaAp(Z)V

    invoke-virtual {p0, v0}, Landroid/net/wifi/WifiInfo;->setVenueName(Ljava/lang/String;)V

    const-wide/16 v2, 0x0

    iput-wide v2, p0, Landroid/net/wifi/WifiInfo;->txBad:J

    iput-wide v2, p0, Landroid/net/wifi/WifiInfo;->txSuccess:J

    iput-wide v2, p0, Landroid/net/wifi/WifiInfo;->rxSuccess:J
    ...
    invoke-virtual {p0, v1}, Landroid/net/wifi/WifiInfo;->semSetSnr(I)V

    const/16 v2, 0xff

    invoke-virtual {p0, v2}, Landroid/net/wifi/WifiInfo;->semSetLqcmRx(I)V

    invoke-virtual {p0, v2}, Landroid/net/wifi/WifiInfo;->semSetLqcmTx(I)V

    invoke-virtual {p0, v0}, Landroid/net/wifi/WifiInfo;->setVenueName(Ljava/lang/String;)V

    invoke-virtual {p0, v1}, Landroid/net/wifi/WifiInfo;->setWifiMode(I)V

    return-void
.end method

.method public semGetLqcmRx()I
    .locals 1
...
.method public semSetLqcmRx(I)V
    .locals 0
...
.method public semSetLqcmTx(I)V
    .locals 0
...
.method public setNotAskAgainCheck(Z)V
    .locals 0

    iput-boolean p1, p0, Landroid/net/wifi/WifiInfo;->mNotAskAgainCheck:Z
...
.method public setWifiMode(I)V
    ...
    iput p1, p0, Landroid/net/wifi/WifiInfo;->mWifiMode:I
...
.method public toString()Ljava/lang/String;
    ...
    const-string v2, ", GigaAp: "

    invoke-virtual {v0, v2}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    iget-boolean v2, p0, Landroid/net/wifi/WifiInfo;->mGigaAp:Z
    ...
    iget-object v2, p0, Landroid/net/wifi/WifiInfo;->mVenueName:Ljava/lang/String;

    invoke-virtual {v0, v2}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    const-string v2, ", WifiMode: "

    invoke-virtual {v0, v2}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    iget v2, p0, Landroid/net/wifi/WifiInfo;->mWifiMode:I
