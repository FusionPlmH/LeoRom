...
.field private static final NTP_RESOLVE_TIMEOUT:I = 0x14
...
.method public requestTime(Ljava/lang/String;ILandroid/net/Network;Z)I
    .locals 9
    ...
    :try_start_0
    new-instance v3, Landroid/net/SntpClient$DnsResolveTask;

    invoke-direct {v3, p0, v0}, Landroid/net/SntpClient$DnsResolveTask;-><init>(Landroid/net/SntpClient;Landroid/net/SntpClient$1;)V
    ...
    invoke-virtual {v0, v3, v5}, Landroid/net/SntpClient$DnsResolveTask;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;

    const-wide/16 v7, 0x14

    sget-object v3, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v0, v7, v8, v3}, Landroid/net/SntpClient$DnsResolveTask;->get(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    ...
    const-string v4, "[BigData] request resolve failed in DnsResolveTask()"
    ...
    invoke-virtual {p0, v1, v0, p2, p3}, Landroid/net/SntpClient;->requestTime(Ljava/net/InetAddress;IILandroid/net/Network;)Z
    ...
    const-string v4, "[BigData] request time failed : host = "
    ...
    const-string v5, "[BigData] request resolve failed: host = "
    ...
    const-string v5, "[BigData] request resolve timeout: host = "
...
.method public requestTime(Ljava/lang/String;ILandroid/net/Network;)Z
    ...
    :try_start_0
    new-instance v4, Landroid/net/SntpClient$DnsResolveTask;

    invoke-direct {v4, p0, v1}, Landroid/net/SntpClient$DnsResolveTask;-><init>(Landroid/net/SntpClient;Landroid/net/SntpClient$1;)V
    ...
    invoke-virtual {v1, v4, v5}, Landroid/net/SntpClient$DnsResolveTask;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;

    const-wide/16 v4, 0x14

    sget-object v0, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v1, v4, v5, v0}, Landroid/net/SntpClient$DnsResolveTask;->get(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    ...
    const-string/jumbo v4, "request time failed in DnsResolveTask()"
    ...
    invoke-virtual {p0, v2, v0, p2, p3}, Landroid/net/SntpClient;->requestTime(Ljava/net/InetAddress;IILandroid/net/Network;)Z
    ...
    invoke-static {p1, v1}, Landroid/net/EventLogTags;->writeNtpFailure(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v5, "request resolve timeout: host = "
