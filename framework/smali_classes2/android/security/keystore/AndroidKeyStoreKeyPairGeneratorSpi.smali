...
.method private constructKeyGenerationArguments()Landroid/security/keymaster/KeymasterArguments;
    ...
    iget-boolean v1, p0, Landroid/security/keystore/AndroidKeyStoreKeyPairGeneratorSpi;->isKnoxObjectProtectionRequired:Z
    ...
    invoke-static/range {v1 .. v11}, Landroid/security/keystore/KeymasterUtils;->addKnoxArgs(Landroid/security/keymaster/KeymasterArguments;Ljava/util/List;Ljava/util/List;[Z[Ljava/lang/String;Ljava/lang/String;Z[BLjavax/security/auth/x500/X500Principal;[BZ)V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/security/keymaster/KeymasterArguments;->addDateIfNotNull(ILjava/util/Date;)V
...
.method private createCertificateChain(Ljava/lang/String;Ljava/security/KeyPair;)Ljava/lang/Iterable;
    ...
    iget-object v3, p0, Landroid/security/keystore/AndroidKeyStoreKeyPairGeneratorSpi;->mAttestationRoot:Ljava/lang/String;
...
.method public generateKeyPair()Ljava/security/KeyPair;
    ...
    iget-boolean v5, p0, Landroid/security/keystore/AndroidKeyStoreKeyPairGeneratorSpi;->mKnoxCsrResponseRequired:Z
    :try_end_0
    ...
    invoke-direct {p0, v5}, Landroid/security/keystore/AndroidKeyStoreKeyPairGeneratorSpi;->generateSelfSignedCertificateWithFakeSignature(Ljava/security/PublicKey;)Ljava/security/cert/X509Certificate;
    ...
    const-string v7, "failed to generate and store self signed certificate with fake signature bytes"
...
.method public initialize(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    :cond_6
    instance-of v6, v2, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;

    if-eqz v6, :cond_d

    move-object v6, v2

    check-cast v6, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;

    invoke-virtual {v6}, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->getKeyGenParameterSpec()Landroid/security/keystore/KeyGenParameterSpec;

    move-result-object v6

    move-object v9, v2

    check-cast v9, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;

    invoke-virtual {v9}, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->isKnoxObjectProtectionRequired()Z

    move-result v9

    iput-boolean v9, v1, Landroid/security/keystore/AndroidKeyStoreKeyPairGeneratorSpi;->isKnoxObjectProtectionRequired:Z

    move-object v9, v2

    check-cast v9, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;

    invoke-virtual {v9}, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->getAccessorIds()Ljava/util/List;

    move-result-object v9

    iput-object v9, v1, Landroid/security/keystore/AndroidKeyStoreKeyPairGeneratorSpi;->accessorIds:Ljava/util/List;

    move-object v9, v2

    check-cast v9, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;

    invoke-virtual {v9}, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->getAdministratorIds()Ljava/util/List;

    move-result-object v9

    iput-object v9, v1, Landroid/security/keystore/AndroidKeyStoreKeyPairGeneratorSpi;->administratorIds:Ljava/util/List;

    move-object v9, v2

    check-cast v9, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;

    invoke-virtual {v9}, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->getKeyUsage()[Z

    move-result-object v9

    iput-object v9, v1, Landroid/security/keystore/AndroidKeyStoreKeyPairGeneratorSpi;->mKeyUsage:[Z

    move-object v9, v2

    check-cast v9, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;

    invoke-virtual {v9}, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->getExtendedKeyUsage()[Ljava/lang/String;

    move-result-object v9

    iput-object v9, v1, Landroid/security/keystore/AndroidKeyStoreKeyPairGeneratorSpi;->mExtendedKeyUsage:[Ljava/lang/String;

    move-object v9, v2

    check-cast v9, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;

    invoke-virtual {v9}, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->getAttestationRoot()Ljava/lang/String;

    move-result-object v9

    iput-object v9, v1, Landroid/security/keystore/AndroidKeyStoreKeyPairGeneratorSpi;->mAttestationRoot:Ljava/lang/String;

    move-object v9, v2

    check-cast v9, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;

    invoke-virtual {v9}, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->isKnoxCsrResponseRequired()Z

    move-result v9

    iput-boolean v9, v1, Landroid/security/keystore/AndroidKeyStoreKeyPairGeneratorSpi;->mKnoxCsrResponseRequired:Z

    move-object v9, v2

    check-cast v9, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;

    invoke-virtual {v9}, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->getSubjectAlternativeName()[B

    move-result-object v9

    iput-object v9, v1, Landroid/security/keystore/AndroidKeyStoreKeyPairGeneratorSpi;->mSubjectAlternativeName:[B

    invoke-virtual {v6}, Landroid/security/keystore/KeyGenParameterSpec;->getAttestationChallenge()[B

    move-result-object v9

    iput-object v9, v1, Landroid/security/keystore/AndroidKeyStoreKeyPairGeneratorSpi;->mAttestationChallenge:[B

    invoke-virtual {v6}, Landroid/security/keystore/KeyGenParameterSpec;->getCertificateSubject()Ljavax/security/auth/x500/X500Principal;

    move-result-object v9

    iput-object v9, v1, Landroid/security/keystore/AndroidKeyStoreKeyPairGeneratorSpi;->mCertificateSubject:Ljavax/security/auth/x500/X500Principal;
