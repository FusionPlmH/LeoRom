...
.method protected constructor <init>(III)V
    ...
    iput-boolean v0, p0, Landroid/security/keystore/AndroidKeyStoreKeyGeneratorSpi;->isKnoxObjectProtectionRequired:Z
...
.method protected engineGenerateKey()Ljavax/crypto/SecretKey;
    ...
    :cond_0
    iget-boolean v2, p0, Landroid/security/keystore/AndroidKeyStoreKeyGeneratorSpi;->isKnoxObjectProtectionRequired:Z

    if-eqz v2, :cond_1

    iget-object v3, p0, Landroid/security/keystore/AndroidKeyStoreKeyGeneratorSpi;->accessorIds:Ljava/util/List;

    iget-object v4, p0, Landroid/security/keystore/AndroidKeyStoreKeyGeneratorSpi;->administratorIds:Ljava/util/List;
    ...
    invoke-static/range {v2 .. v12}, Landroid/security/keystore/KeymasterUtils;->addKnoxArgs(Landroid/security/keymaster/KeymasterArguments;Ljava/util/List;Ljava/util/List;[Z[Ljava/lang/String;Ljava/lang/String;Z[BLjavax/security/auth/x500/X500Principal;[BZ)V
    ...
    invoke-direct {v4, v11, v5, v3}, Landroid/security/keystore/AndroidKeyStoreSecretKey;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    :try_end_2
    ...
    invoke-static {v6, v7, v12}, Landroid/security/Credentials;->deleteAllTypesForAlias(Landroid/security/KeyStore;Ljava/lang/String;I)Z
...
.method protected engineInit(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    instance-of v2, p1, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;
    ...
    check-cast v3, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;
    ...
    const-class v3, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;
