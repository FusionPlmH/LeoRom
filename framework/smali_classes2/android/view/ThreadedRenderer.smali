...
.method constructor <init>(Landroid/content/Context;ZLjava/lang/String;)V
    ...
    const-string v5, "ThreadedRenderer"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "Caught non-fatal exception while retrieving value: "
    ...
    invoke-static {v4, v5}, Landroid/view/RenderNode;->adopt(J)Landroid/view/RenderNode;

    move-result-object v6

    iput-object v6, p0, Landroid/view/ThreadedRenderer;->mRootNode:Landroid/view/RenderNode;

    iget-object v6, p0, Landroid/view/ThreadedRenderer;->mRootNode:Landroid/view/RenderNode;

    invoke-virtual {v6, v0}, Landroid/view/RenderNode;->setClipToBounds(Z)Z

    xor-int/lit8 v0, p2, 0x1

    iput-boolean v0, p0, Landroid/view/ThreadedRenderer;->mIsOpaque:Z

    invoke-static {p2, v4, v5, v3}, Landroid/view/ThreadedRenderer;->nCreateProxy(ZJI)J

    move-result-wide v6

    iput-wide v6, p0, Landroid/view/ThreadedRenderer;->mNativeProxy:J

    iget-wide v6, p0, Landroid/view/ThreadedRenderer;->mNativeProxy:J

    invoke-static {v6, v7, p3}, Landroid/view/ThreadedRenderer;->nSetName(JLjava/lang/String;)V
    ...
    invoke-virtual {v0, p1, v6, v7}, Landroid/view/ThreadedRenderer$ProcessInitializer;->init(Landroid/content/Context;J)V
...
.method static synthetic access$100(ZJI)J
    .locals 2

    invoke-static {p0, p1, p2, p3}, Landroid/view/ThreadedRenderer;->nCreateProxy(ZJI)J
...
.method public static isHighContrastTextEnabled()Z
    ...
    invoke-static {}, Landroid/view/ThreadedRenderer;->nIsHighContrastTextEnabled()Z
...
.method private static native nCreateProxy(ZJI)J
.end method
