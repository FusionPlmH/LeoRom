...
.method public addToDisplayForTranslate(Landroid/view/IWindow;ILandroid/view/WindowManager$LayoutParams;IILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/DisplayCutout$ParcelableWrapper;Landroid/view/InputChannel;Landroid/os/Bundle;)I
    ...
    :try_start_b
    invoke-virtual {v14, v3}, Landroid/os/Bundle;->readFromParcel(Landroid/os/Parcel;)V
    :try_end_b
...
.method public relayoutForTranslate(Landroid/view/IWindow;ILandroid/view/WindowManager$LayoutParams;IIIIJLandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/DisplayCutout$ParcelableWrapper;Landroid/util/MergedConfiguration;Landroid/view/Surface;Landroid/graphics/PointF;Lcom/samsung/android/view/ConventionalModeBar$Info;)I
    ...
    invoke-virtual {v1, v3}, Landroid/graphics/PointF;->readFromParcel(Landroid/os/Parcel;)V
    ...
    :try_start_b
    invoke-virtual {v1, v3}, Lcom/samsung/android/view/ConventionalModeBar$Info;->readFromParcel(Landroid/os/Parcel;)V
    :try_end_b
    .catchall {:try_start_b .. :try_end_b} :catchall_3
