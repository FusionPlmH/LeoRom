...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput v1, p0, Landroid/view/NotificationHeaderView;->mPaddingBetweenElements:I
...
.method private decreasePaddingRelative()V
    .locals 4
    ...
    invoke-virtual {p0}, Landroid/view/NotificationHeaderView;->getPaddingTop()I
    ...
    invoke-virtual {p0}, Landroid/view/NotificationHeaderView;->getPaddingBottom()I

    move-result v3

    div-int/lit8 v3, v3, 0x2

    invoke-virtual {p0, v0, v1, v2, v3}, Landroid/view/NotificationHeaderView;->setPaddingRelative(IIII)V
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, Landroid/view/NotificationHeaderView;->mOverFlowNumber:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Landroid/view/NotificationHeaderView;->mTime:Landroid/widget/TextView;
...
.method protected onLayout(ZIIII)V
    ...
    :cond_3
    iget-object v4, v0, Landroid/view/NotificationHeaderView;->mOverFlowNumber:Landroid/widget/TextView;
    ...
    iget v4, v0, Landroid/view/NotificationHeaderView;->mPaddingBetweenElements:I
    ...
    iget-boolean v4, v0, Landroid/view/NotificationHeaderView;->mShowWorkBadgeAtEnd:Z
    ...
    iget v1, v0, Landroid/view/NotificationHeaderView;->mPaddingBetweenElements:I
...
.method protected onMeasure(II)V
    ...
    invoke-static {v4, v10, v11}, Landroid/view/NotificationHeaderView;->getChildMeasureSpec(III)I
    ...
    invoke-static {v3, v11, v12}, Landroid/view/NotificationHeaderView;->getChildMeasureSpec(III)I
    ...
    invoke-direct/range {p0 .. p0}, Landroid/view/NotificationHeaderView;->decreasePaddingRelative()V
    ...
    iget-object v8, v0, Landroid/view/NotificationHeaderView;->mAppName:Landroid/view/View;

    iget v9, v0, Landroid/view/NotificationHeaderView;->mChildMinWidth:I

    invoke-direct {v0, v3, v5, v8, v9}, Landroid/view/NotificationHeaderView;->shrinkViewForOverflow(IILandroid/view/View;I)I

    move-result v5

    iget-object v8, v0, Landroid/view/NotificationHeaderView;->mHeaderText:Landroid/view/View;

    invoke-direct {v0, v3, v5, v8, v6}, Landroid/view/NotificationHeaderView;->shrinkViewForOverflow(IILandroid/view/View;I)I

    move-result v5

    iget-object v8, v0, Landroid/view/NotificationHeaderView;->mSecondaryHeaderText:Landroid/view/View;

    invoke-direct {v0, v3, v5, v8, v6}, Landroid/view/NotificationHeaderView;->shrinkViewForOverflow(IILandroid/view/View;I)I

    move-result v5

    iget-object v8, v0, Landroid/view/NotificationHeaderView;->mTime:Landroid/widget/TextView;
    ...
    iput v5, v0, Landroid/view/NotificationHeaderView;->mTotalWidth:I

    invoke-virtual {v0, v1, v2}, Landroid/view/NotificationHeaderView;->setMeasuredDimension(II)V
...
.method public setOverFlowNumber(Ljava/lang/String;Ljava/lang/String;)V
    .locals 2

    iget-object v0, p0, Landroid/view/NotificationHeaderView;->mOverFlowNumber:Landroid/widget/TextView;
