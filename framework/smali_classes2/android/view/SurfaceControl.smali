...
# static fields
.field public static final BUILT_IN_DISPLAY_ID_EXT_FIRST:I = 0x5

.field public static final BUILT_IN_DISPLAY_ID_EXT_MAX:I = 0x7

.field public static final BUILT_IN_DISPLAY_ID_EXT_MIN:I = 0x5

.field public static final BUILT_IN_DISPLAY_ID_EXT_SECOND:I = 0x6

.field public static final BUILT_IN_DISPLAY_ID_EXT_THIRD:I = 0x7
...
.field public static final IGNORE_PARENT_CROP:I = 0x4000
...
.field private static final SURFACE_IGNORE_PARENT_CROP:I = 0x4
...
.method private constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-boolean v0, p0, Landroid/view/SurfaceControl;->mIsLeash:Z
...
.method public constructor <init>(Landroid/view/SurfaceControl;)V
    ...
    iget-boolean v0, p1, Landroid/view/SurfaceControl;->mIsLeash:Z
...
.method private constructor <init>(Landroid/view/SurfaceSession;Ljava/lang/String;IIIILandroid/view/SurfaceControl;IIZ)V
    .locals 16
    ...
    iput-boolean v1, v0, Landroid/view/SurfaceControl;->mIsLeash:Z
    ...
    iget-wide v2, v0, Landroid/view/SurfaceControl;->mNativeObject:J

    cmp-long v2, v2, v14

    if-eqz v2, :cond_2

    iget-object v2, v0, Landroid/view/SurfaceControl;->mCloseGuard:Ldalvik/system/CloseGuard;
...
.method synthetic constructor <init>(Landroid/view/SurfaceSession;Ljava/lang/String;IIIILandroid/view/SurfaceControl;IIZLandroid/view/SurfaceControl$1;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/view/Surface$OutOfResourcesException;,
    ...
    invoke-direct/range {p0 .. p10}, Landroid/view/SurfaceControl;-><init>(Landroid/view/SurfaceSession;Ljava/lang/String;IIIILandroid/view/SurfaceControl;IIZ)V
...
.method static synthetic access$1700(JJLjava/lang/String;)V
    .locals 0
...
.method static synthetic access$1900(JJIIII)V
    .locals 0
...
.method static synthetic access$2000(JJI)V
    .locals 0
...
.method static synthetic access$2100(JJLandroid/os/IBinder;J)V
    .locals 0
...
.method static synthetic access$2200(JJJJ)V
    .locals 0
...
.method static synthetic access$2400(JJLandroid/os/IBinder;)V
    .locals 0
...
.method static synthetic access$2500(JJ)V
    .locals 0
...
.method static synthetic access$2700(JJ[F)V
    .locals 0
...
.method static synthetic access$2800(JJ)V
    .locals 0
...
.method static synthetic access$2900(Landroid/view/SurfaceControl;)Z
    .locals 1

    iget-boolean v0, p0, Landroid/view/SurfaceControl;->mIsLeash:Z
...
.method static synthetic access$3000(Landroid/view/SurfaceControl;)Ldalvik/system/CloseGuard;
    .locals 1
...
.method static synthetic access$3200(Landroid/view/SurfaceControl;)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$3300(JLandroid/os/IBinder;J)V
    .locals 0
...
.method static synthetic access$3400(JLandroid/os/IBinder;I)V
    .locals 0
...
.method static synthetic access$3500(JLandroid/os/IBinder;IIIIIIIII)V
    .locals 0
...
.method static synthetic access$3600(JLandroid/os/IBinder;II)V
    .locals 0
...
.method static synthetic access$3700(J)V
    .locals 0
...
.method static synthetic access$3900(JJ)V
    .locals 0
...
.method private static native nativeZorderScreenshotBitmap(Landroid/os/IBinder;Landroid/graphics/Rect;Landroid/os/IBinder;IIZI)Landroid/graphics/Bitmap;
.end method

.method private static native nativeZorderScreenshotToBuffer(Landroid/os/IBinder;Landroid/graphics/Rect;Landroid/os/IBinder;IIZIZ)Landroid/graphics/GraphicBuffer;
.end method
...
.method public static screenshot(Landroid/os/IBinder;Landroid/graphics/Rect;IIIIZI)Landroid/graphics/Bitmap;
    .locals 9
    ...
    invoke-static/range {v0 .. v8}, Landroid/view/SurfaceControl;->screenshot(Landroid/os/IBinder;Landroid/graphics/Rect;IIIIZZI)Landroid/graphics/Bitmap;
...
.method private static screenshot(Landroid/os/IBinder;Landroid/graphics/Rect;IIIIZZI)Landroid/graphics/Bitmap;
    .locals 1

    invoke-static/range {p0 .. p8}, Landroid/view/SurfaceControl;->nativeScreenshot(Landroid/os/IBinder;Landroid/graphics/Rect;IIIIZZI)Landroid/graphics/Bitmap;
...
.method public static screenshotToBufferWithSecureLayersUnsafe(Landroid/os/IBinder;Landroid/graphics/Rect;IIIIZI)Landroid/graphics/GraphicBuffer;
    .locals 10
    ...
    invoke-static/range {v0 .. v9}, Landroid/view/SurfaceControl;->nativeScreenshotToBuffer(Landroid/os/IBinder;Landroid/graphics/Rect;IIIIZZIZ)Landroid/graphics/GraphicBuffer;
...
.method public static sec_screenshot(ILandroid/graphics/Rect;IILandroid/os/IBinder;ZI)Landroid/graphics/Bitmap;
    .locals 8
    ...
    invoke-static/range {v0 .. v6}, Landroid/view/SurfaceControl;->nativeZorderScreenshotBitmap(Landroid/os/IBinder;Landroid/graphics/Rect;Landroid/os/IBinder;IIZI)Landroid/graphics/Bitmap;
...
.method public static sec_screenshot(Landroid/graphics/Rect;IILandroid/os/IBinder;ZI)Landroid/graphics/Bitmap;
    .locals 7
    ...
    invoke-static/range {v0 .. v6}, Landroid/view/SurfaceControl;->sec_screenshot(ILandroid/graphics/Rect;IILandroid/os/IBinder;ZI)Landroid/graphics/Bitmap;
...
.method public static sec_screenshotToBuffer(ILandroid/graphics/Rect;IILandroid/os/IBinder;ZI)Landroid/graphics/GraphicBuffer;
    .locals 8
    ...
    invoke-static/range {v0 .. v7}, Landroid/view/SurfaceControl;->sec_screenshotToBuffer(ILandroid/graphics/Rect;IILandroid/os/IBinder;ZIZ)Landroid/graphics/GraphicBuffer;
...
.method public static sec_screenshotToBuffer(ILandroid/graphics/Rect;IILandroid/os/IBinder;ZIZ)Landroid/graphics/GraphicBuffer;
    .locals 9
    ...
    invoke-static/range {v0 .. v7}, Landroid/view/SurfaceControl;->nativeZorderScreenshotToBuffer(Landroid/os/IBinder;Landroid/graphics/Rect;Landroid/os/IBinder;IIZIZ)Landroid/graphics/GraphicBuffer;
...
.method public static sec_screenshotToBuffer(Landroid/graphics/Rect;IILandroid/os/IBinder;ZI)Landroid/graphics/GraphicBuffer;
    .locals 7
    ...
    invoke-static/range {v0 .. v6}, Landroid/view/SurfaceControl;->sec_screenshotToBuffer(ILandroid/graphics/Rect;IILandroid/os/IBinder;ZI)Landroid/graphics/GraphicBuffer;
...
.method public destroy()V
    ...
    const-string v3, "Destroy is called in public, prevent to destroy animationLeash from other side, sc="
    ...
    invoke-static {v2, v3}, Landroid/view/SurfaceControl;->nativeDestroy(J)V
    ...
    const-string v3, "destroy(public), animation-leash is destroyed, sc="
...
.method protected finalize()V
    ...
    const-string v1, "animation-leash"
    ...
    const-string v2, "finalize(protected), animation-leash is released by finalize, sc="
...
.method public release()V
    ...
    const-string v3, "Release is called in public, prevent to release animationLeash from other side, sc="
    ...
    invoke-static {v2, v3}, Landroid/view/SurfaceControl;->nativeRelease(J)V
    ...
    const-string/jumbo v3, "release(public), animation-leash is released, sc="
...
.method public setIgnoreParentCrop(Z)V
    .locals 2
    ...
    invoke-virtual {v1, p0, p1}, Landroid/view/SurfaceControl$Transaction;->setIgnoreParentCrop(Landroid/view/SurfaceControl;Z)Landroid/view/SurfaceControl$Transaction;
...
.method public setInternalPresentationOnly(Z)V
    ...
    invoke-virtual {v1, p0, p1}, Landroid/view/SurfaceControl$Transaction;->setInternalPresentationOnly(Landroid/view/SurfaceControl;Z)Landroid/view/SurfaceControl$Transaction;
...
.method public startSurfaceAnimation(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p0, p1}, Landroid/view/SurfaceControl$Transaction;->startSurfaceAnimation(Landroid/view/SurfaceControl;Ljava/lang/String;)Landroid/view/SurfaceControl$Transaction;
