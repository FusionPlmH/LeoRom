...
.field public static final ADD_RES_DEXCOMPAT_MODE:I = 0x20000
...
.field public static final RELAYOUT_RES_DEXCOMPAT_MODE:I = 0x20000
...
.method public addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;Landroid/view/Display;Landroid/view/Window;)V
    ...
    :goto_3
    iput-object v8, v3, Landroid/view/ViewRootImpl;->mParentDecorView:Landroid/view/View;
    ...
    iget-object v8, v1, Landroid/view/View;->mAttachInfo:Landroid/view/View$AttachInfo;
    ...
    iget-object v7, v3, Landroid/view/ViewRootImpl;->mWindowAttributes:Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-virtual {v7}, Landroid/view/ViewRootImpl;->semIncreaseChildWindow()V
    :try_end_1
    ...
    invoke-direct {p0, v4, v5}, Landroid/view/WindowManagerGlobal;->removeViewLocked(IZ)V
...
.method doRemoveView(Landroid/view/ViewRootImpl;)V
    ...
    iget-object v2, p1, Landroid/view/ViewRootImpl;->mMWBGParentDecorView:Landroid/view/View;
    ...
    iget-object v2, p1, Landroid/view/ViewRootImpl;->mWindowAttributes:Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-virtual {v2}, Landroid/view/ViewRootImpl;->semDecreaseChildWindow()V
...
.method public dumpGfxInfo(Ljava/io/FileDescriptor;[Ljava/lang/String;)V
    ...
    const-string/jumbo v8, "threadConfig: "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v6}, Landroid/app/ActivityThread;->getConfiguration()Landroid/content/res/Configuration;
...
.method setChildWindowStopped(Landroid/os/IBinder;Z)V
    .locals 5
