...
.method public constructor <init>(FF)V
    ...
    iput-boolean v0, p0, Landroid/view/animation/PathInterpolator;->mQuadSaved:Z

    iput-boolean v0, p0, Landroid/view/animation/PathInterpolator;->mCubicSaved:Z
...
.method private initPath(Landroid/graphics/Path;)V
    ...
    const-string/jumbo v7, "initPath: pointComponents["
    ...
    :cond_6
    iget-boolean v3, p0, Landroid/view/animation/PathInterpolator;->mQuadSaved:Z
    ...
    const-string/jumbo v6, "initPath: mQuadX = "

    invoke-virtual {v4, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v6, p0, Landroid/view/animation/PathInterpolator;->mQuadX:F

    invoke-virtual {v4, v6}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    const-string v6, ", mQuadY = "

    invoke-virtual {v4, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v6, p0, Landroid/view/animation/PathInterpolator;->mQuadY:F
    ...
    :cond_7
    iget-boolean v3, p0, Landroid/view/animation/PathInterpolator;->mCubicSaved:Z
    ...
    const-string/jumbo v4, "initPath: mCubicX[0] = "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v4, p0, Landroid/view/animation/PathInterpolator;->mCubicX:[F

    aget v4, v4, v5

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    const-string v4, ", mCubicY[0] = "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v4, p0, Landroid/view/animation/PathInterpolator;->mCubicY:[F

    aget v4, v4, v5

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    const-string v4, ", mCubicX[1] = "
