...
.method public onVsyncSS()V
    .locals 3

    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/view/Choreographer$FrameDisplayEventReceiver;->mNeedRepeat:Z

    invoke-static {}, Ljava/lang/System;->nanoTime()J

    move-result-wide v1

    iput-wide v1, p0, Landroid/view/Choreographer$FrameDisplayEventReceiver;->mTimestampNanos:J

    const/4 v1, 0x0

    iput v1, p0, Landroid/view/Choreographer$FrameDisplayEventReceiver;->mFrame:I
    ...
    invoke-static {v0}, Landroid/view/Choreographer;->access$400(Landroid/view/Choreographer;)Landroid/view/Choreographer$FrameHandler;

    move-result-object v0

    invoke-virtual {v0, v1}, Landroid/view/Choreographer$FrameHandler;->sendMessage(Landroid/os/Message;)Z
...
.method public run()V
    ...
    iget v4, p0, Landroid/view/Choreographer$FrameDisplayEventReceiver;->mFrame:I

    invoke-virtual {v1, v2, v3, v4}, Landroid/view/Choreographer;->doFrame(JI)V

    iget-boolean v1, p0, Landroid/view/Choreographer$FrameDisplayEventReceiver;->mNeedRepeat:Z
    ...
    invoke-static {v1, v2}, Landroid/view/Choreographer;->access$502(Landroid/view/Choreographer;Z)Z
