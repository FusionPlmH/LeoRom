...
.method private constructor <init>(Landroid/database/sqlite/SQLiteConnectionPool;Landroid/database/sqlite/SQLiteDatabaseConfiguration;IZ)V
    ...
    invoke-direct {v0, p1, p0, v1}, Landroid/database/sqlite/SQLiteConnection$OperationLog;-><init>(Landroid/database/sqlite/SQLiteConnectionPool;Landroid/database/sqlite/SQLiteConnection;Landroid/database/sqlite/SQLiteDatabaseConfiguration;)V
...
.method static synthetic access$500(Landroid/database/sqlite/SQLiteConnection;Ljava/lang/String;)V
    .locals 0
...
.method static synthetic access$600(Landroid/database/sqlite/SQLiteConnection;Ljava/lang/String;)Ljava/lang/String;
    .locals 1
...
.method private analyzeSql(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, p1}, Landroid/database/sqlite/SQLiteConnection;->nativeExpertAnalyze(JLjava/lang/String;)Ljava/lang/String;
...
.method private dispose(Z)V
    ...
    sget-boolean v1, Landroid/database/sqlite/SQLiteDebug;->DEBUG_ENABLE:Z
...
.method public static native nativeBackup(Ljava/lang/String;Ljava/lang/String;)I
.end method
...
.method private open()V
    ...
    const-string v2, "This connection is forced to be a read-only connection. Ignore SQLiteReadOnlyDatabaseException."
...
.method private open([B)V
    ...
    invoke-virtual {v1, v0}, Landroid/database/sqlite/SQLiteConnectionPool;->saveConnectionKey([B)V
...
.method private printQueryPlan(Ljava/lang/String;)V
    ...
    iget-boolean v0, v1, Landroid/database/sqlite/SQLiteConnection;->mIsOpen:Z
    ...
    invoke-direct {v0, v8}, Landroid/database/CursorWindow;-><init>(Ljava/lang/String;)V
    ...
    const-string v10, "EXPLAIN QUERY PLAN "
    ...
    invoke-static {v8, v9, v0}, Landroid/database/sqlite/SQLiteConnection;->nativePrepareStatement(JLjava/lang/String;)J
    ...
    invoke-virtual {v5, v11, v10}, Landroid/database/CursorWindow;->getInt(II)I
    ...
    iget-object v10, v1, Landroid/database/sqlite/SQLiteConnection;->mConfiguration:Landroid/database/sqlite/SQLiteDatabaseConfiguration;

    iget-object v10, v10, Landroid/database/sqlite/SQLiteDatabaseConfiguration;->path:Ljava/lang/String;
    ...
    const-string v10, "SQLiteQueryPlan"
...
.method private setBusyTimeoutFromConfiguration()V
    ...
    iget-wide v0, v0, Landroid/database/sqlite/SQLiteDatabaseConfiguration;->busyTimeout:J
...
.method private setWalModeFromConfiguration()V
    ...
    invoke-virtual {v2}, Landroid/database/sqlite/SQLiteDatabaseSharedConfiguration;->getDefaultSyncMode()Ljava/lang/String;
    ...
    iget-boolean v2, v2, Landroid/database/sqlite/SQLiteDatabaseSharedConfiguration;->useWalModeByDefault:Z
...
.method reconfigure(Landroid/database/sqlite/SQLiteDatabaseConfiguration;)V
    ...
    :goto_2
    iget-object v5, p1, Landroid/database/sqlite/SQLiteDatabaseConfiguration;->locale:Ljava/util/Locale;
    ...
    iget-boolean v6, p1, Landroid/database/sqlite/SQLiteDatabaseConfiguration;->automaticIndexEnabled:Z
    ...
    :goto_3
    iget-wide v7, p1, Landroid/database/sqlite/SQLiteDatabaseConfiguration;->busyTimeout:J
    ...
    :goto_4
    iget v8, p1, Landroid/database/sqlite/SQLiteDatabaseConfiguration;->cacheSize:I
    ...
    :goto_5
    iget-boolean v9, p1, Landroid/database/sqlite/SQLiteDatabaseConfiguration;->caseSensitiveLikeEnabled:Z
    ...
    invoke-virtual {v4, v9}, Landroid/database/sqlite/SQLiteConnection$PreparedStatementCache;->resize(I)V
