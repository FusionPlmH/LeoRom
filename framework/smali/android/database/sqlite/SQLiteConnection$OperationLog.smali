...
.method private endOperationDeferLogLocked(I)Z
    ...
    invoke-static {v0}, Landroid/database/sqlite/SQLiteConnection$Operation;->access$400(Landroid/database/sqlite/SQLiteConnection$Operation;)Ljava/lang/String;
    ...
    iget-boolean v3, v3, Landroid/database/sqlite/SQLiteDatabaseSharedConfiguration;->shouldSendQueryLog:Z
    ...
    invoke-static {v3, v4, v0}, Landroid/database/sqlite/SQLiteSlowQueryCollector;->sendSlowQueryLog(Landroid/database/sqlite/SQLiteConnectionPool;Ljava/lang/String;Landroid/database/sqlite/SQLiteConnection$Operation;)V
    :try_end_0
    ...
    sget-boolean v4, Landroid/database/sqlite/SQLiteDebug;->DEBUG_ENABLE:Z
...
.method private logOperationLocked(ILjava/lang/String;)V
    ...
    invoke-static {v2, v4}, Landroid/database/sqlite/SQLiteConnection;->access$500(Landroid/database/sqlite/SQLiteConnection;Ljava/lang/String;)V
...
.method public beginOperation(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    new-instance v4, Landroid/database/sqlite/SQLiteConnection$Operation;

    invoke-direct {v4}, Landroid/database/sqlite/SQLiteConnection$Operation;-><init>()V
    ...
    iput-wide v4, v2, Landroid/database/sqlite/SQLiteConnection$Operation;->mExecutionTime:J
    ...
    iput v4, v2, Landroid/database/sqlite/SQLiteConnection$Operation;->mPid:I
    ...
    invoke-static {}, Landroid/database/sqlite/SQLiteConnection;->access$300()[B
    ...
    invoke-static {v2}, Landroid/database/sqlite/SQLiteConnection$Operation;->access$400(Landroid/database/sqlite/SQLiteConnection$Operation;)Ljava/lang/String;
