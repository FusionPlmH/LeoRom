...
.method private constructor <init>(Landroid/database/sqlite/SQLiteDatabase;Landroid/database/sqlite/SQLiteDatabaseConfiguration;)V
    ...
    invoke-virtual {p0, v0, v3, v4}, Landroid/database/sqlite/SQLiteConnectionPool;->setupIdleConnectionHandler(Landroid/os/Looper;J)V
...
.method private tryAcquireNonPrimaryConnectionLocked(Ljava/lang/String;I)Landroid/database/sqlite/SQLiteConnection;
    ...
    invoke-direct {p0, v3, v1, v5}, Landroid/database/sqlite/SQLiteConnectionPool;->openSecureConnectionLocked(Landroid/database/sqlite/SQLiteDatabaseConfiguration;Z[B)Landroid/database/sqlite/SQLiteConnection;
...
.method public getConnectionKey()[B
    .locals 3
...
.method public reOpen()V
    ...
    const-string/jumbo v1, "try reOpen Connection(s)..."
...
.method public reconfigure(Landroid/database/sqlite/SQLiteDatabaseConfiguration;)V
    ...
    const-string v5, "Could not reconfigure SQLiteConnectionPool due to the lack of password,"
    ...
    iget-wide v7, p0, Landroid/database/sqlite/SQLiteConnectionPool;->mRandArrPtr:J

    invoke-static {v7, v8}, Landroid/database/sqlite/SQLiteGlobal;->getRandArray(J)[C

    move-result-object v7

    invoke-virtual {v6, v7}, Landroid/database/sqlite/SQLiteConnectionPool$SecureData;->decryptAndGet([C)[B

    move-result-object v6

    invoke-direct {p0, p1, v3, v6}, Landroid/database/sqlite/SQLiteConnectionPool;->openSecureConnectionLocked(Landroid/database/sqlite/SQLiteDatabaseConfiguration;Z[B)Landroid/database/sqlite/SQLiteConnection;
