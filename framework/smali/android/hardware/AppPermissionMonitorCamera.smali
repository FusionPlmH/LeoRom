.class public Landroid/hardware/AppPermissionMonitorCamera;
.super Ljava/lang/Thread;
.source "AppPermissionMonitorCamera.java"
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/hardware/AppPermissionMonitorCamera;->mCallingCacheCamera:Landroid/util/LruCache;
    ...
    iput-object v0, p0, Landroid/hardware/AppPermissionMonitorCamera;->mAPM:Landroid/os/IPermissionMonitor;
...
.method private isCalledPackage(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v0, v1}, Landroid/hardware/AppPermissionMonitorCamera;->isExpired(Ljava/lang/String;J)Z

    move-result v2

    if-eqz v2, :cond_0

    iget-object v2, p0, Landroid/hardware/AppPermissionMonitorCamera;->mCallingCacheCamera:Landroid/util/LruCache;
...
.method private isExpired(Ljava/lang/String;J)Z
    ...
    iget-object v0, p0, Landroid/hardware/AppPermissionMonitorCamera;->mCallingCacheCamera:Landroid/util/LruCache;
...
.method public run()V
    ...
    invoke-virtual {p0, v1, v0}, Landroid/hardware/AppPermissionMonitorCamera;->sendNotificationForAppPermissionMonitor(II)V
...
.method public sendNotificationForAppPermissionMonitor(II)V
    ...
    invoke-direct {p0, v4}, Landroid/hardware/AppPermissionMonitorCamera;->isCalledPackage(Ljava/lang/String;)Z
    ...
    :try_start_3
    iget-object v6, p0, Landroid/hardware/AppPermissionMonitorCamera;->mAPM:Landroid/os/IPermissionMonitor;
    ...
    iput-object v6, p0, Landroid/hardware/AppPermissionMonitorCamera;->mAPM:Landroid/os/IPermissionMonitor;
