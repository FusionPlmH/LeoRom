...
.field public static final ACTION_WIFI_DISPLAY_SINK_STATUS_CHANGED:Ljava/lang/String; = "com.samsung.intent.action.WIFI_DISPLAY_SINK_STATE"
...
.field public static final SEM_BLUETOOTH_MIRRORING_CONNECTION_CHANGED:Ljava/lang/String; = "com.samsung.intent.action.BLUETOOTH_MIRRORING_CONNECTION_CHANGED"

.field public static final SEM_BLUETOOTH_RECEIVER_CONNECTION_CHANGED:Ljava/lang/String; = "com.samsung.intent.action.BLUETOOTH_RECEIVER_CONNECTION_CHANGED"
...
.field public static final SEM_CONNECT_STATE_INITIATE_MIRRORING:I = 0xe
...
.field public static final VIRTUAL_DISPLAY_FLAG_DESKTOP:I = 0x400
...
.field public static final VIRTUAL_DISPLAY_FLAG_VIRTUAL_SPACE:I = 0x4000

.field public static final WIFIDISPLAY_CPU_1GHZ:I = 0xf4240

.field public static final WIFIDISPLAY_CPU_1_2GHZ:I = 0x124f80

.field public static final WIFIDISPLAY_CPU_NONE:I = -0x1
...
.method private addDexpDisplaysLocked(Ljava/util/ArrayList;[II)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public enableWifiDisplay(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2}, Landroid/hardware/display/SemDeviceInfo;->setConnectType(I)V
    ...
    invoke-virtual {v1, v2}, Landroid/hardware/display/SemDeviceInfo;->setKey(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2}, Landroid/hardware/display/SemDeviceInfo;->setIpAddress(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2}, Landroid/hardware/display/SemDeviceInfo;->setP2pMacAddress(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2}, Landroid/hardware/display/SemDeviceInfo;->setDeviceName(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2}, Landroid/hardware/display/SemDeviceInfo;->setPendingRequest(Z)V
    ...
    invoke-virtual {v1, v2}, Landroid/hardware/display/SemDeviceInfo;->setUri(Ljava/lang/String;)V

    invoke-virtual {p0, v1}, Landroid/hardware/display/DisplayManager;->semConnectDevice(Landroid/hardware/display/SemDeviceInfo;)V
    :try_end_0
...
.method public getDisplays(Ljava/lang/String;)[Landroid/view/Display;
    ...
    const-string v5, "getDisplays: dexManager is null, category="
    ...
    invoke-direct {p0, v3, v0}, Landroid/hardware/display/DisplayManager;->addAllDisplaysLocked(Ljava/util/ArrayList;[I)V
    ...
    invoke-direct {p0, v3, v0, v5}, Landroid/hardware/display/DisplayManager;->addPresentationDisplaysLocked(Ljava/util/ArrayList;[II)V
    ...
    invoke-direct {p0, v3, v0, v4}, Landroid/hardware/display/DisplayManager;->addPresentationDisplaysLocked(Ljava/util/ArrayList;[II)V
    ...
    invoke-direct {p0, v3, v0, v4}, Landroid/hardware/display/DisplayManager;->addDexpDisplaysLocked(Ljava/util/ArrayList;[II)V
...
.method public semEnableWifiDisplay(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-direct {v1, v0}, Landroid/hardware/display/SemDeviceInfo;-><init>(I)V

    invoke-virtual {v1, v0}, Landroid/hardware/display/SemDeviceInfo;->setConnectType(I)V

    invoke-virtual {v1, p1}, Landroid/hardware/display/SemDeviceInfo;->setIpAddress(Ljava/lang/String;)V

    const-string v0, "SideSync"

    invoke-virtual {v1, v0}, Landroid/hardware/display/SemDeviceInfo;->setDeviceName(Ljava/lang/String;)V
    ...
    invoke-direct {v1, v2}, Landroid/hardware/display/SemDeviceInfo;-><init>(I)V
    ...
    invoke-virtual {v1, p2}, Landroid/hardware/display/SemDeviceInfo;->setPort(Ljava/lang/String;)V
...
.method public semGetActiveSinkDisplay()Landroid/hardware/display/SemWifiDisplay;
    .locals 1

    iget-object v0, p0, Landroid/hardware/display/DisplayManager;->mGlobal:Landroid/hardware/display/DisplayManagerGlobal;

    invoke-virtual {v0}, Landroid/hardware/display/DisplayManagerGlobal;->getActiveSinkDisplay()Landroid/hardware/display/SemWifiDisplay;
...
.method public semIsScreenInSinkConnected()Z
    .locals 1

    iget-object v0, p0, Landroid/hardware/display/DisplayManager;->mGlobal:Landroid/hardware/display/DisplayManagerGlobal;

    invoke-virtual {v0}, Landroid/hardware/display/DisplayManagerGlobal;->isScreenInSinkConnected()Z
...
.method public semIsWifiDisplaySinkConnected()Z
    .locals 1

    iget-object v0, p0, Landroid/hardware/display/DisplayManager;->mGlobal:Landroid/hardware/display/DisplayManagerGlobal;

    invoke-virtual {v0}, Landroid/hardware/display/DisplayManagerGlobal;->isWifiDisplaySinkConnected()Z
...
.method public semSetTemporaryAutoBrightnessAdjustment(F)V
    .locals 1
...
.method public setSaturationLevel(F)V
    ...
    invoke-virtual {v0, p1}, Landroid/hardware/display/DisplayManagerGlobal;->setSaturationLevel(F)V
...
.method public setTemporaryBrightness(IZ)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/hardware/display/DisplayManagerGlobal;->setTemporaryBrightnessForSlowChange(IZ)V
...
.method public setWifiDisplayCPUBoost(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/hardware/display/DisplayManagerGlobal;->setWifiDisplayCPUBoost(I)V
