...
.method static constructor <clinit>()V
    ...
    sput-object v1, Landroid/hardware/SystemSensorManager;->sLock:Ljava/lang/Object;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;)V
    ...
    invoke-virtual {v1}, Lcom/samsung/android/knox/custom/CustomDeviceManagerProxy;->getSensorDisabled()I
    ...
    invoke-static {v3, v4, v2, v1}, Landroid/hardware/SystemSensorManager;->nativeGetSensorAtIndex(JLandroid/hardware/Sensor;I)Z
    ...
    invoke-static {v3}, Landroid/hardware/SystemSensorManager;->getKnoxCustomSensorMask(I)I
    ...
    const-string v5, "disable the sensor index = "
...
.method protected cancelTriggerSensorImpl(Landroid/hardware/TriggerEventListener;Landroid/hardware/Sensor;Z)Z
    ...
    invoke-static {v1}, Landroid/hardware/SystemSensorManager;->EncodeLog(Ljava/lang/String;)Ljava/lang/String;
    ...
    check-cast v3, Landroid/hardware/SystemSensorManager$TriggerEventQueue;

    if-eqz v3, :cond_5

    if-nez p2, :cond_1

    invoke-virtual {v3}, Landroid/hardware/SystemSensorManager$TriggerEventQueue;->removeAllSensors()Z
    ...
    :cond_1
    invoke-virtual {v3, p2, p3}, Landroid/hardware/SystemSensorManager$TriggerEventQueue;->removeSensor(Landroid/hardware/Sensor;Z)Z
    ...
    invoke-virtual {v3}, Landroid/hardware/SystemSensorManager$TriggerEventQueue;->hasSensors()Z
...
.method protected registerListenerImpl(Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;ILandroid/os/Handler;II)Z
    ...
    const-string/jumbo v7, "listener is null"
    ...
    const-string/jumbo v7, "sensor is null"
    ...
    :cond_3
    iget-object v6, v1, Landroid/hardware/SystemSensorManager;->mSensorListeners:Ljava/util/HashMap;
    ...
    invoke-static {v0}, Landroid/hardware/SystemSensorManager;->EncodeLog(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    iget-object v8, v1, Landroid/hardware/SystemSensorManager;->mSensorListeners:Ljava/util/HashMap;
    ...
    :cond_5
    iget-object v10, v1, Landroid/hardware/SystemSensorManager;->mMainLooper:Landroid/os/Looper;
    ...
    invoke-virtual {v11}, Ljava/lang/Class;->getEnclosingClass()Ljava/lang/Class;
    ...
    iget-object v14, v1, Landroid/hardware/SystemSensorManager;->mContext:Landroid/content/Context;

    invoke-virtual {v14}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v14

    invoke-virtual {v14, v13}, Landroid/content/pm/PackageManager;->getNameForUid(I)Ljava/lang/String;
    ...
    :cond_8
    new-instance v13, Landroid/hardware/SystemSensorManager$SensorEventQueue;

    invoke-direct {v13, v2, v10, v1, v9}, Landroid/hardware/SystemSensorManager$SensorEventQueue;-><init>(Landroid/hardware/SensorEventListener;Landroid/os/Looper;Landroid/hardware/SystemSensorManager;Ljava/lang/String;)V

    move-object v0, v13

    invoke-virtual {v0, v3, v7, v4}, Landroid/hardware/SystemSensorManager$SensorEventQueue;->addSensor(Landroid/hardware/Sensor;II)Z
    ...
    const-string/jumbo v5, "registerListener fail (1) :: "
    ...
    const-string/jumbo v11, "registerListener fail (2) :: "
    ...
    const-string/jumbo v11, "registerListener :: "
    ...
    const-string/jumbo v6, "register failed, the sensor listeners size has exceeded the maximum limit 128"
...
.method protected requestTriggerSensorImpl(Landroid/hardware/TriggerEventListener;Landroid/hardware/Sensor;)Z
    ...
    :goto_0
    new-instance v5, Landroid/hardware/SystemSensorManager$TriggerEventQueue;

    iget-object v6, p0, Landroid/hardware/SystemSensorManager;->mMainLooper:Landroid/os/Looper;

    invoke-direct {v5, p1, v6, p0, v4}, Landroid/hardware/SystemSensorManager$TriggerEventQueue;-><init>(Landroid/hardware/TriggerEventListener;Landroid/os/Looper;Landroid/hardware/SystemSensorManager;Ljava/lang/String;)V
    ...
    const-string/jumbo v7, "requestTrigger :: fail (1) :: "
    ...
    const-string/jumbo v6, "requestTrigger :: fail (2) :: "
...
.method protected unregisterListenerImpl(Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;)V
    ...
    invoke-virtual {v2}, Landroid/hardware/SystemSensorManager$SensorEventQueue;->removeAllSensors()Z
    ...
    invoke-virtual {v2, p2, v3}, Landroid/hardware/SystemSensorManager$SensorEventQueue;->removeSensor(Landroid/hardware/Sensor;Z)Z
    ...
    invoke-virtual {v2}, Landroid/hardware/SystemSensorManager$SensorEventQueue;->hasSensors()Z
