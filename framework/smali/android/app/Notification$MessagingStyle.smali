...
.method private fixTitleAndTextExtras(Landroid/os/Bundle;)V
    ...
    invoke-static {v4}, Landroid/app/Notification$Builder;->access$3100(Landroid/app/Notification$Builder;)Landroid/content/Context;
...
.method private makeMessagingView(ZZ)Landroid/widget/RemoteViews;
    ...
    invoke-static {v10}, Landroid/app/Notification$Builder;->access$3400(Landroid/app/Notification$Builder;)I
    ...
    invoke-static {v9, v10, v3, v7}, Landroid/app/Notification$Builder;->access$3500(Landroid/app/Notification$Builder;ILandroid/app/Notification$StandardTemplateParams;Landroid/app/Notification$TemplateBindResult;)Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v3, v8, v4}, Landroid/widget/RemoteViews;->setViewLayoutMarginEnd(II)V

    if-eqz p1, :cond_6

    const-string/jumbo v4, "setMaxDisplayedLines"

    const/4 v9, 0x4

    invoke-virtual {v3, v8, v4, v9}, Landroid/widget/RemoteViews;->setInt(ILjava/lang/String;I)V
    ...
    invoke-static {v8}, Landroid/app/Notification$Builder;->access$3600(Landroid/app/Notification$Builder;)Z
