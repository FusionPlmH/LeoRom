...
.field private static final KEY_MULTI_LAUNCH_WINDOWING_MODE:Ljava/lang/String; = "android:activity.MultiLaunchWindowingMode"
...
.field private mMultiLaunchWindowingModes:[I
...
.method private constructor <init>()V
    ...
    iput v0, p0, Landroid/app/ActivityOptions;->mDockedStackSizeType:I
...
.method public constructor <init>(Landroid/os/Bundle;)V
    ...
    :cond_3
    const-string v1, "edm:activity.startedByMDMAdmin"

    invoke-virtual {p1, v1, v0}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;Z)Z

    move-result v1

    iput-boolean v1, p0, Landroid/app/ActivityOptions;->mStartedByMDMAdmin:Z
    ...
    iput-boolean v1, p0, Landroid/app/ActivityOptions;->mIsActiveApplaunch:Z
    ...
    iput-boolean v1, p0, Landroid/app/ActivityOptions;->mIsMlLaunch:Z
    ...
    const-string v1, "android:activity.DockSizeType"
    ...
    :cond_4
    const-string v1, "android.activity.forceWindowingMode"
...
.method private convertSideScreenModeToWindowingMode(I)I
    .locals 1
...
.method public static makeRemoteAnimation(Landroid/view/RemoteAnimationAdapter;)Landroid/app/ActivityOptions;
    ...
    const-string/jumbo v4, "makeRemoteAnimation, duration="
    ...
    const-string/jumbo v4, "makeRemoteAnimation, remoteAnimationAdapter is null, caller="
...
.method public static semMakeCustomScaleDownAnimation(IIII)Landroid/app/ActivityOptions;
    ...
    const-string/jumbo v2, "semMakeCustomScaleDownAnimation,  startX : "
...
.method public static semMakeCustomScaleUpAnimation(Landroid/view/View;II)Landroid/app/ActivityOptions;
    ...
    const-string/jumbo v3, "semMakeCustomScaleUpAnimation, width : "
...
.method public static semMakeCustomScaleUpAnimation(Landroid/view/View;IIZ)Landroid/app/ActivityOptions;
    ...
    const-string v3, ", opts.mIsHomeItem : "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v3, v0, Landroid/app/ActivityOptions;->mIsHomeItem:Z
...
.method public getMultiLaunchSideScreenModes()[I
    .locals 1

    iget-object v0, p0, Landroid/app/ActivityOptions;->mMultiLaunchWindowingModes:[I
...
.method public isMlLaunch()Z
    ...
    iget-boolean v0, p0, Landroid/app/ActivityOptions;->mIsMlLaunch:Z
...
.method public setLaunchSideScreenMode(I)V
    .locals 0
...
.method public setMlLaunch(Z)V
    ...
    iput-boolean p1, p0, Landroid/app/ActivityOptions;->mIsMlLaunch:Z

    return-void
.end method

.method public setMultiLaunchSideScreenMode([I)V
    .locals 0
...
.method public toBundle()Landroid/os/Bundle;
    ...
    iget-boolean v2, p0, Landroid/app/ActivityOptions;->mIsMlLaunch:Z
    ...
    iget v2, p0, Landroid/app/ActivityOptions;->mDockedStackSizeType:I

    invoke-virtual {v0, v1, v2}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "android.activity.forceWindowingMode"

    iget v2, p0, Landroid/app/ActivityOptions;->mForceLaunchWindowingMode:I
