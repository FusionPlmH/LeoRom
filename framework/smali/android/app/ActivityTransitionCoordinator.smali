...
.method private setSharedElementState(Landroid/view/View;Ljava/lang/String;Landroid/os/Bundle;Landroid/graphics/Matrix;Landroid/graphics/RectF;[I)V
    ...
    invoke-direct {v15, v0, v1}, Landroid/app/ActivityTransitionCoordinator;->getSharedElementParentMatrix(Landroid/view/View;Landroid/graphics/Matrix;)V
    ...
    invoke-virtual {v13}, Lcom/android/internal/policy/DecorView;->getMultiWindowDecorSupport()Lcom/android/internal/policy/MultiWindowDecorSupport;

    move-result-object v13

    if-eqz v13, :cond_3

    invoke-virtual {v13}, Lcom/android/internal/policy/MultiWindowDecorSupport;->isInMultiWindow()Z

    move-result v17

    if-eqz v17, :cond_3

    invoke-virtual {v14}, Landroid/view/ViewGroup;->getLocationOnScreen()[I
    ...
    invoke-virtual {v4, v1}, Landroid/view/ViewGroup;->transformMatrixToLocal(Landroid/graphics/Matrix;)V
    ...
    invoke-virtual {v2, v13, v13, v5, v6}, Landroid/graphics/RectF;->set(FFFF)V
...
.method protected captureSharedElementState(Landroid/view/View;Ljava/lang/String;Landroid/os/Bundle;Landroid/graphics/Matrix;Landroid/graphics/RectF;)V
    ...
    const-string/jumbo v2, "shared_element:windowPositionY"
...
.method protected moveSharedElementsToOverlay()V
    ...
    invoke-virtual {v4}, Lcom/android/internal/policy/MultiWindowDecorSupport;->isFreeform()Z
    ...
    invoke-virtual {v1, v5}, Landroid/view/ViewGroup;->setOutlineProvider(Landroid/view/ViewOutlineProvider;)V
