...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;)V
    ...
    iput-boolean v0, p0, Landroid/app/Notification$Builder;->mShowBadge:Z
...
.method static synthetic access$3400(Landroid/app/Notification$Builder;)I
    .locals 1
...
.method static synthetic access$3500(Landroid/app/Notification$Builder;ILandroid/app/Notification$StandardTemplateParams;Landroid/app/Notification$TemplateBindResult;)Landroid/widget/RemoteViews;
    .locals 1
...
.method static synthetic access$3800(Landroid/app/Notification$Builder;)Z
    .locals 1
...
.method static synthetic access$3900(Landroid/app/Notification$Builder;IZLandroid/app/Notification$TemplateBindResult;)Landroid/widget/RemoteViews;
    .locals 1
...
.method static synthetic access$4000(Landroid/app/Notification$Builder;)I
    .locals 1
...
.method static synthetic access$4200(Landroid/app/Notification$Builder;ILandroid/app/Notification$TemplateBindResult;)Landroid/widget/RemoteViews;
    .locals 1
...
.method static synthetic access$4400(Landroid/app/Notification$Builder;Ljava/lang/CharSequence;Z)Ljava/lang/CharSequence;
    .locals 1
...
.method private applyStandardTemplateWithActions(ILandroid/app/Notification$StandardTemplateParams;Landroid/app/Notification$TemplateBindResult;)Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v0, v7, v6}, Landroid/widget/RemoteViews;->setViewLayoutMarginBottomDimen(II)V
    ...
    invoke-direct {p0, v8}, Landroid/app/Notification$Builder;->hasValidRemoteInput(Landroid/app/Notification$Action;)Z

    move-result v9

    or-int/2addr v7, v9

    iget-boolean v10, p2, Landroid/app/Notification$StandardTemplateParams;->ambient:Z

    invoke-direct {p0, v8, v3, v10}, Landroid/app/Notification$Builder;->generateActionButton(Landroid/app/Notification$Action;ZZ)Landroid/widget/RemoteViews;

    move-result-object v10

    nop

    invoke-virtual {v0, v5, v10}, Landroid/widget/RemoteViews;->addView(ILandroid/widget/RemoteViews;)V
    ...
    const-string v7, "android.remoteInputHistory"

    invoke-virtual {v5, v7}, Landroid/os/Bundle;->getCharSequenceArray(Ljava/lang/String;)[Ljava/lang/CharSequence;

    move-result-object v5

    iget-boolean v7, p2, Landroid/app/Notification$StandardTemplateParams;->ambient:Z
    ...
    iget v7, p2, Landroid/app/Notification$StandardTemplateParams;->maxRemoteInputHistory:I
    ...
    invoke-direct {p0, v0, v9}, Landroid/app/Notification$Builder;->setTextViewColorSecondary(Landroid/widget/RemoteViews;I)V
    ...
    invoke-virtual {v0, v8, v4}, Landroid/widget/RemoteViews;->setProgressIndeterminateTintList(ILandroid/content/res/ColorStateList;)V
    ...
    iget v4, p2, Landroid/app/Notification$StandardTemplateParams;->maxRemoteInputHistory:I
    ...
    invoke-virtual {v0, v4, v8}, Landroid/widget/RemoteViews;->setTextViewText(ILjava/lang/CharSequence;)V
...
.method private bindHeaderAppName(Landroid/widget/RemoteViews;Z)V
    ...
    invoke-static {v0, v2}, Lcom/android/internal/util/NotificationColorUtil;->resolveDefaultColor(Landroid/content/Context;I)I
...
.method private bindReplyIcon(Landroid/widget/RemoteViews;Z)Z
    ...
    invoke-virtual {p1, v4, v3, v5, v6}, Landroid/widget/RemoteViews;->setDrawableTint(IZILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {p1, v4, v3}, Landroid/widget/RemoteViews;->setRemoteInputs(I[Landroid/app/RemoteInput;)V
...
.method private generateActionButton(Landroid/app/Notification$Action;ZZ)Landroid/widget/RemoteViews;
    ...
    :goto_5
    invoke-virtual {v3, v4, v10, v11}, Landroid/widget/RemoteViews;->setBoolean(ILjava/lang/String;Z)V
    ...
    invoke-direct {p0, v5}, Landroid/app/Notification$Builder;->processLegacyText(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    iget-boolean v5, p0, Landroid/app/Notification$Builder;->mTintActionButtons:Z
    ...
    iget v5, v5, Landroid/content/res/Configuration;->semButtonShapeEnabled:I
    ...
    invoke-virtual {v3, v4, v1, v5}, Landroid/widget/RemoteViews;->setInt(ILjava/lang/String;I)V

    :cond_e
    const-string/jumbo v1, "semSetHoverPopupType"

    invoke-virtual {v3, v4, v1, v2}, Landroid/widget/RemoteViews;->setInt(ILjava/lang/String;I)V
...
.method private getProfileBadgeDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-boolean v0, p0, Landroid/app/Notification$Builder;->mShowBadge:Z
...
.method private processSmallIconColor(Landroid/graphics/drawable/Icon;Landroid/widget/RemoteViews;Z)V
    ...
    invoke-virtual {v3, v4, p1}, Lcom/android/internal/util/NotificationColorUtil;->isGrayscaleIcon(Landroid/content/Context;Landroid/graphics/drawable/Icon;)Z
...
.method public setShowProfileBadge(Z)Landroid/app/Notification$Builder;
    .locals 0

    iput-boolean p1, p0, Landroid/app/Notification$Builder;->mShowBadge:Z
