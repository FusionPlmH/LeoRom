...
.method public matchesMessageFilter(Landroid/os/Bundle;)Z
    ...
    :try_start_0
    invoke-interface {v0, p1}, Landroid/app/INotificationManager;->matchesMessageFilter(Landroid/os/Bundle;)Z
...
.method public notifyAsUser(Ljava/lang/String;ILandroid/app/Notification;Landroid/os/UserHandle;)V
    ...
    const-string/jumbo v1, "samsung.people.notify_to_edge"
    ...
    const-string/jumbo v2, "samsung.people.cancel_to_edge"
    ...
    invoke-virtual {v0, p2, p3}, Landroid/app/NotificationManager$EdgeNotificationManager;->postEdgeNotificationByNormal(ILandroid/app/Notification;)V
    ...
    invoke-static {v1, p3}, Landroid/app/Notification;->addFieldsFromContext(Landroid/content/Context;Landroid/app/Notification;)V

    iget-object v1, p3, Landroid/app/Notification;->sound:Landroid/net/Uri;
    ...
    iput-object v1, p3, Landroid/app/Notification;->sound:Landroid/net/Uri;
    ...
    :cond_3
    invoke-direct {p0, p3, v8}, Landroid/app/NotificationManager;->fixLegacySmallIcon(Landroid/app/Notification;Ljava/lang/String;)V
    ...
    invoke-virtual {p3, v1}, Landroid/app/Notification;->reduceImageSizes(Landroid/content/Context;)V
    ...
    invoke-static {p3, v10, v1}, Landroid/app/Notification$Builder;->maybeCloneStrippedForDelivery(Landroid/app/Notification;ZLandroid/content/Context;)Landroid/app/Notification;
