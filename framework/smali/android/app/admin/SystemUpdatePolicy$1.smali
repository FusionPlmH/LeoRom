...
.method public createFromParcel(Landroid/os/Parcel;)Landroid/app/admin/SystemUpdatePolicy;
    ...
    invoke-static {v0, v1}, Landroid/app/admin/SystemUpdatePolicy;->access$502(Landroid/app/admin/SystemUpdatePolicy;I)I

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v1

    invoke-static {v0, v1}, Landroid/app/admin/SystemUpdatePolicy;->access$602(Landroid/app/admin/SystemUpdatePolicy;I)I

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v1

    invoke-static {v0}, Landroid/app/admin/SystemUpdatePolicy;->access$700(Landroid/app/admin/SystemUpdatePolicy;)Ljava/util/ArrayList;
