...
.method static synthetic access$1100(Landroid/app/ActivityThread$ApplicationThread;Landroid/content/res/Configuration;)V
    .locals 0
...
.method static synthetic lambda$scheduleTrimMemory$0(Ljava/lang/Object;I)V
    ...
    invoke-static {v0, p1}, Landroid/app/ActivityThread;->access$1000(Landroid/app/ActivityThread;I)V
...
.method public final bindApplication(Ljava/lang/String;Landroid/content/pm/ApplicationInfo;Ljava/util/List;Landroid/content/ComponentName;Landroid/app/ProfilerInfo;Landroid/os/Bundle;Landroid/app/IInstrumentationWatcher;Landroid/app/IUiAutomationConnection;IZZZZLandroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;Ljava/util/Map;Landroid/os/Bundle;IFLjava/lang/String;Z)V
    ...
    invoke-static {v0, v4}, Landroid/app/servertransaction/ClientTransaction;->obtain(Landroid/app/IApplicationThread;Landroid/os/IBinder;)Landroid/app/servertransaction/ClientTransaction;

    move-result-object v4

    invoke-static {v3}, Landroid/app/servertransaction/CoreStatesChangeItem;->obtain(Landroid/os/Bundle;)Landroid/app/servertransaction/CoreStatesChangeItem;
    ...
    invoke-virtual {v0, v4}, Landroid/app/ActivityThread$ApplicationThread;->scheduleTransaction(Landroid/app/servertransaction/ClientTransaction;)V
    :try_end_0
    ...
    invoke-static/range {p18 .. p18}, Landroid/app/ActivityThread;->access$302(I)I
    ...
    iput-object v5, v0, Landroid/app/ActivityThread$AppBindData;->providers:Ljava/util/List;

    move-object/from16 v6, p4

    iput-object v6, v0, Landroid/app/ActivityThread$AppBindData;->instrumentationName:Landroid/content/ComponentName;

    move-object/from16 v7, p6

    iput-object v7, v0, Landroid/app/ActivityThread$AppBindData;->instrumentationArgs:Landroid/os/Bundle;

    move-object/from16 v8, p7

    iput-object v8, v0, Landroid/app/ActivityThread$AppBindData;->instrumentationWatcher:Landroid/app/IInstrumentationWatcher;

    move-object/from16 v9, p8

    iput-object v9, v0, Landroid/app/ActivityThread$AppBindData;->instrumentationUiAutomationConnection:Landroid/app/IUiAutomationConnection;

    move/from16 v10, p9

    iput v10, v0, Landroid/app/ActivityThread$AppBindData;->debugMode:I

    move/from16 v11, p10

    iput-boolean v11, v0, Landroid/app/ActivityThread$AppBindData;->enableBinderTracking:Z

    move/from16 v12, p11

    iput-boolean v12, v0, Landroid/app/ActivityThread$AppBindData;->trackAllocation:Z

    move/from16 v13, p12

    iput-boolean v13, v0, Landroid/app/ActivityThread$AppBindData;->restrictedBackupMode:Z

    move/from16 v14, p13

    iput-boolean v14, v0, Landroid/app/ActivityThread$AppBindData;->persistent:Z
    ...
    iput-boolean v2, v0, Landroid/app/ActivityThread$AppBindData;->autofillCompatibilityEnabled:Z
...
.method public scheduleApplicationInfoChangedAndNoRelaunch(Landroid/content/pm/ApplicationInfo;)V
    .locals 3
...
.method public scheduleLetActivityStayFocus(Landroid/os/IBinder;)V
    .locals 3
...
.method public scheduleReleaseActivityFocus(Landroid/os/IBinder;)V
    .locals 3
