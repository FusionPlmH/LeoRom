...
.field private mPendingThreadConfig:Landroid/content/res/Configuration;
...
.field private mTopActivityClient:Landroid/app/ActivityThread$ActivityClientRecord;
...
.method constructor <init>()V
    ...
    iput-object v1, p0, Landroid/app/ActivityThread;->mTopActivityClient:Landroid/app/ActivityThread$ActivityClientRecord;

    iput-object v1, p0, Landroid/app/ActivityThread;->mThemeAppIconMap:Ljava/util/HashMap;

    sget-object v0, Landroid/content/res/Configuration;->EMPTY:Landroid/content/res/Configuration;

    iput-object v0, p0, Landroid/app/ActivityThread;->mPendingThreadConfig:Landroid/content/res/Configuration;
...
.method static synthetic access$1000(Landroid/app/ActivityThread;I)V
    .locals 0
...
.method static synthetic access$1300(Landroid/app/ActivityThread;Landroid/app/ActivityThread$ReceiverData;)V
    .locals 0
...
.method static synthetic access$1400(Landroid/app/ActivityThread;Landroid/app/ActivityThread$CreateServiceData;)V
    .locals 0
...
.method static synthetic access$1500(Landroid/app/ActivityThread;Landroid/app/ActivityThread$BindServiceData;)V
    .locals 0
...
.method static synthetic access$1700(Landroid/app/ActivityThread;Landroid/app/ActivityThread$ServiceArgsData;)V
    .locals 0
...
.method static synthetic access$1800(Landroid/app/ActivityThread;Landroid/os/IBinder;)V
    .locals 0
...
.method static synthetic access$1900(Landroid/app/ActivityThread;Landroid/app/ActivityThread$DumpComponentInfo;)V
    .locals 0
...
.method static synthetic access$2000(Landroid/app/ActivityThread;Landroid/app/ActivityThread$CreateBackupAgentData;)V
    .locals 0
...
.method static synthetic access$2400(Landroid/app/ActivityThread;Landroid/os/IBinder;Z)V
    .locals 0
...
.method static synthetic access$3100(Landroid/app/ActivityThread;Ljava/lang/String;[Ljava/lang/String;)V
    .locals 0
...
.method static synthetic access$3200(Landroid/app/ActivityThread;)Landroid/app/servertransaction/TransactionExecutor;
    .locals 1
...
.method static synthetic access$3400(Landroid/app/ActivityThread;Landroid/os/IBinder;)V
    ...
    invoke-direct {p0, p1}, Landroid/app/ActivityThread;->handleReleaseActivityFocus(Landroid/os/IBinder;)V
...
.method static synthetic access$3500(Landroid/app/ActivityThread;Landroid/os/IBinder;)V
    ...
    invoke-direct {p0, p1}, Landroid/app/ActivityThread;->handleLetActivityStayFocus(Landroid/os/IBinder;)V
...
.method private static addTimaKeyStoreProviderForAppContext()V
    .locals 4
    ...
    const-string/jumbo v2, "ro.config.timaversion"
    ...
    const-string v2, "com.sec.tima.TimaKeyStoreProvider"
    ...
    const-string v2, "Unable to add TimaKeyStore provider"
...
.method private createBaseContextForActivity(Landroid/app/ActivityThread$ActivityClientRecord;)Landroid/app/ContextImpl;
    ...
    invoke-interface {v1, v0}, Landroid/app/IActivityManager;->getActivityDisplayId(Landroid/os/IBinder;)I
...
.method private getThemeResourceFromMappingTable()V
    ...
    iget-object v4, p0, Landroid/app/ActivityThread;->mThemeAppIconMap:Ljava/util/HashMap;
    ...
    const-string v7, "Exception during parsing theme app list"
    ...
    const-string v7, "Exception during parsing theme app list XmlPullParserException"
...
.method private getTopActivityOverrideConfiguration()Landroid/content/res/Configuration;
    .locals 2

    iget-object v0, p0, Landroid/app/ActivityThread;->mTopActivityClient:Landroid/app/ActivityThread$ActivityClientRecord;
...
.method private handleBindApplication(Landroid/app/ActivityThread$AppBindData;)V
    ...
    iget v0, v9, Landroid/app/ActivityThread$AppBindData;->dssScale:F

    iput v0, v8, Landroid/app/ActivityThread;->mDssScale:F

    iput-object v9, v8, Landroid/app/ActivityThread;->mBoundApplication:Landroid/app/ActivityThread$AppBindData;

    new-instance v0, Landroid/content/res/Configuration;

    iget-object v1, v9, Landroid/app/ActivityThread$AppBindData;->config:Landroid/content/res/Configuration;
    ...
    iget-object v1, v9, Landroid/app/ActivityThread$AppBindData;->initProfilerInfo:Landroid/app/ProfilerInfo;
    ...
    iget-object v1, v8, Landroid/app/ActivityThread;->mResourcesManager:Landroid/app/ResourcesManager;
    ...
    iget-object v3, v9, Landroid/app/ActivityThread$AppBindData;->compatInfo:Landroid/content/res/CompatibilityInfo;

    invoke-virtual {v0, v2, v3}, Landroid/app/ResourcesManager;->applyConfigurationToResourcesLocked(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)Z
    ...
    iget-object v1, v9, Landroid/app/ActivityThread$AppBindData;->compatInfo:Landroid/content/res/CompatibilityInfo;

    invoke-virtual {v8, v0, v1}, Landroid/app/ActivityThread;->getPackageInfoNoCheck(Landroid/content/pm/ApplicationInfo;Landroid/content/res/CompatibilityInfo;)Landroid/app/LoadedApk;
    ...
    invoke-static {v11, v0}, Landroid/app/ActivityThread;->handleAttachAgent(Ljava/lang/String;Landroid/app/LoadedApk;)V
    ...
    invoke-static {v14}, Ljava/text/DateFormat;->set24HourTimePref(Ljava/lang/Boolean;)V
    ...
    iget-object v2, v9, Landroid/app/ActivityThread$AppBindData;->buildSerial:Ljava/lang/String;
    ...
    invoke-interface {v2, v0, v15}, Landroid/app/IActivityManager;->showWaitingForDebugger(Landroid/app/IApplicationThread;Z)V
    :try_end_3
    ...
    invoke-static {v7}, Landroid/os/Trace;->setAppTracingAllowed(Z)V
    ...
    :try_start_4
    invoke-interface {v3, v12}, Landroid/net/IConnectivityManager;->getProxyForNetwork(Landroid/net/Network;)Landroid/net/ProxyInfo;
    ...
    invoke-direct {v0, v12, v3}, Landroid/app/ApplicationPackageManager;-><init>(Landroid/app/ContextImpl;Landroid/content/pm/IPackageManager;)V

    iget-object v3, v9, Landroid/app/ActivityThread$AppBindData;->instrumentationName:Landroid/content/ComponentName;

    invoke-virtual {v0, v3, v15}, Landroid/app/ApplicationPackageManager;->getInstrumentationInfo(Landroid/content/ComponentName;I)Landroid/content/pm/InstrumentationInfo;
    ...
    iget-object v4, v0, Landroid/content/pm/InstrumentationInfo;->primaryCpuAbi:Ljava/lang/String;
    ...
    iget-object v4, v0, Landroid/content/pm/InstrumentationInfo;->secondaryCpuAbi:Ljava/lang/String;
    ...
    iput-object v3, v8, Landroid/app/ActivityThread;->mInstrumentationPackageName:Ljava/lang/String;

    iget-object v3, v0, Landroid/content/pm/InstrumentationInfo;->sourceDir:Ljava/lang/String;

    iput-object v3, v8, Landroid/app/ActivityThread;->mInstrumentationAppDir:Ljava/lang/String;

    iget-object v3, v0, Landroid/content/pm/InstrumentationInfo;->splitSourceDirs:[Ljava/lang/String;

    iput-object v3, v8, Landroid/app/ActivityThread;->mInstrumentationSplitAppDirs:[Ljava/lang/String;

    iget-object v3, v9, Landroid/app/ActivityThread$AppBindData;->appInfo:Landroid/content/pm/ApplicationInfo;

    invoke-direct {v8, v3, v0}, Landroid/app/ActivityThread;->getInstrumentationLibrary(Landroid/content/pm/ApplicationInfo;Landroid/content/pm/InstrumentationInfo;)Ljava/lang/String;

    move-result-object v3

    iput-object v3, v8, Landroid/app/ActivityThread;->mInstrumentationLibDir:Ljava/lang/String;
    ...
    iput-object v3, v8, Landroid/app/ActivityThread;->mInstrumentedAppDir:Ljava/lang/String;

    iget-object v3, v9, Landroid/app/ActivityThread$AppBindData;->info:Landroid/app/LoadedApk;

    invoke-virtual {v3}, Landroid/app/LoadedApk;->getSplitAppDirs()[Ljava/lang/String;

    move-result-object v3

    iput-object v3, v8, Landroid/app/ActivityThread;->mInstrumentedSplitAppDirs:[Ljava/lang/String;

    iget-object v3, v9, Landroid/app/ActivityThread$AppBindData;->info:Landroid/app/LoadedApk;

    invoke-virtual {v3}, Landroid/app/LoadedApk;->getLibDir()Ljava/lang/String;

    move-result-object v3

    iput-object v3, v8, Landroid/app/ActivityThread;->mInstrumentedLibDir:Ljava/lang/String;
    ...
    invoke-virtual {v0, v4, v12}, Landroid/app/LoadedApk;->makeApplication(ZLandroid/app/Instrumentation;)Landroid/app/Application;
    ...
    const-string v10, "Exception thrown in onCreate() of "

    invoke-virtual {v7, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v10, v9, Landroid/app/ActivityThread$AppBindData;->instrumentationName:Landroid/content/ComponentName;
...
.method private handleConfigurationChanged(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    invoke-direct {p0, v6}, Landroid/app/ActivityThread;->updatePackageInfosLocked(Landroid/util/ArrayMap;)V
...
.method private handleLetActivityStayFocus(Landroid/os/IBinder;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/app/ActivityThread;->performLetActivityStayFocus(Landroid/os/IBinder;)V
...
.method private handleReceiver(Landroid/app/ActivityThread$ReceiverData;)V
    ...
    invoke-virtual {v1, v4, v3}, Landroid/app/LoadedApk;->makeApplication(ZLandroid/app/Instrumentation;)Landroid/app/Application;
    ...
    invoke-virtual {v9, v4}, Landroid/hardware/display/DisplayManagerGlobal;->getRealDisplay(I)Landroid/view/Display;

    move-result-object v4

    invoke-virtual {v5, v4}, Landroid/app/ContextImpl;->createDisplayContext(Landroid/view/Display;)Landroid/content/Context;
    ...
    const-string v12, "Performing receive of AppWidgetProvider ("
    ...
    invoke-virtual {v6, v4, v8}, Landroid/content/BroadcastReceiver;->onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    :try_end_1
    ...
    invoke-virtual {v8, v6, v4}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    :goto_0
    sget-object v4, Landroid/app/ActivityThread;->sCurrentBroadcastIntent:Ljava/lang/ThreadLocal;
...
.method private handleReleaseActivityFocus(Landroid/os/IBinder;)V
    .locals 0
...
.method private handleSleeping(Landroid/os/IBinder;Z)V
    ...
    invoke-static {v0}, Landroid/app/ActivityThread$ActivityClientRecord;->access$3700(Landroid/app/ActivityThread$ActivityClientRecord;)Z
    ...
    invoke-interface {v1, v2, v3}, Landroid/app/IActivityManager;->activitySlept(Landroid/os/IBinder;Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static isInDesktopDisplay()Z
    .locals 1
...
.method public static main([Ljava/lang/String;)V
    ...
    :cond_1
    invoke-static {}, Landroid/app/ActivityThread;->addTimaKeyStoreProviderForAppContext()V
...
.method private onCoreSettingsChange()V
    ...
    instance-of v4, v4, Lcom/android/internal/policy/PhoneWindow;

    if-eqz v4, :cond_2

    iget-object v4, p0, Landroid/app/ActivityThread;->mCoreSettings:Landroid/os/Bundle;
    ...
    invoke-virtual {v6}, Lcom/android/internal/policy/PhoneWindow;->getDeviceDefaultNavBarColor()I
    ...
    iget-object v5, v3, Landroid/app/ActivityThread$ActivityClientRecord;->window:Landroid/view/Window;

    check-cast v5, Lcom/android/internal/policy/PhoneWindow;

    invoke-virtual {v5, v4}, Lcom/android/internal/policy/PhoneWindow;->setSettingsNavBarColor(I)V

    iget-object v5, v3, Landroid/app/ActivityThread$ActivityClientRecord;->window:Landroid/view/Window;

    check-cast v5, Lcom/android/internal/policy/PhoneWindow;

    invoke-virtual {v5}, Lcom/android/internal/policy/PhoneWindow;->updateDefaultNavigationBarColor()V
...
.method private performActivityConfigurationChanged(Landroid/app/Activity;Landroid/content/res/Configuration;Landroid/content/res/Configuration;IZ)Landroid/content/res/Configuration;
    ...
    iget-object v3, p1, Landroid/app/Activity;->mCurrentConfig:Landroid/content/res/Configuration;
    ...
    invoke-virtual {v4, v0, p3}, Landroid/app/ResourcesManager;->isSameResourcesOverrideConfig(Landroid/os/IBinder;Landroid/content/res/Configuration;)Z
    ...
    :cond_2
    iget-boolean v4, p0, Landroid/app/ActivityThread;->mUpdatingSystemConfig:Z

    if-eqz v4, :cond_3

    iget-object v4, p1, Landroid/app/Activity;->mActivityInfo:Landroid/content/pm/ActivityInfo;
    ...
    instance-of v6, v5, Lcom/android/internal/policy/PhoneWindow;
    ...
    iget-object v7, p1, Landroid/app/Activity;->mCurrentConfig:Landroid/content/res/Configuration;

    iput-object v7, v6, Lcom/android/internal/policy/PhoneWindow;->mActivityCurrentConfig:Landroid/content/res/Configuration;
...
.method private performConfigurationChangedForActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/res/Configuration;IZ)Landroid/content/res/Configuration;
    ...
    invoke-static {p1}, Landroid/app/ActivityThread$ActivityClientRecord;->access$3900(Landroid/app/ActivityThread$ActivityClientRecord;)Landroid/content/res/Configuration;
...
.method private performLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)Landroid/app/Activity;
    ...
    iput-object v14, v15, Landroid/app/ActivityThread;->mTopActivityClient:Landroid/app/ActivityThread$ActivityClientRecord;
    ...
    invoke-virtual {v1}, Landroid/app/LoadedApk;->getResources()Landroid/content/res/Resources;
    ...
    iget-object v0, v14, Landroid/app/ActivityThread$ActivityClientRecord;->packageInfo:Landroid/app/LoadedApk;
    :try_end_1
    .catch Landroid/util/SuperNotCalledException; {:try_start_1 .. :try_end_1} :catch_14
    ...
    invoke-virtual {v0, v4, v1}, Landroid/app/LoadedApk;->makeApplication(ZLandroid/app/Instrumentation;)Landroid/app/Application;
    ...
    iget-object v0, v14, Landroid/app/ActivityThread$ActivityClientRecord;->overrideConfig:Landroid/content/res/Configuration;
    :try_end_2
    .catch Landroid/util/SuperNotCalledException; {:try_start_2 .. :try_end_2} :catch_12
    ...
    :try_end_4
    .catch Landroid/util/SuperNotCalledException; {:try_start_4 .. :try_end_4} :catch_12
    ...
    :try_end_6
    .catch Landroid/util/SuperNotCalledException; {:try_start_6 .. :try_end_6} :catch_12
    ...
    :try_start_8
    invoke-virtual {v8, v5}, Landroid/app/ContextImpl;->setOuterContext(Landroid/content/Context;)V
    ...
    :try_end_8
    .catch Landroid/util/SuperNotCalledException; {:try_start_8 .. :try_end_8} :catch_12
    ...
    iget-object v7, v14, Landroid/app/ActivityThread$ActivityClientRecord;->lastNonConfigurationInstances:Landroid/app/Activity$NonConfigurationInstances;
    ...
    :try_end_b
    .catch Landroid/util/SuperNotCalledException; {:try_start_b .. :try_end_b} :catch_b
    ...
    instance-of v3, v2, Lcom/android/internal/policy/PhoneWindow;
    :try_end_c
    .catch Landroid/util/SuperNotCalledException; {:try_start_c .. :try_end_c} :catch_9
    ...
    iput-object v4, v3, Lcom/android/internal/policy/PhoneWindow;->mActivityCurrentConfig:Landroid/content/res/Configuration;
    :try_end_d
    .catch Landroid/util/SuperNotCalledException; {:try_start_d .. :try_end_d} :catch_5
    ...
    invoke-virtual {v5, v4}, Lcom/android/internal/policy/PhoneWindow;->setSettingsNavBarColor(I)V
    :try_end_e
    .catch Landroid/util/SuperNotCalledException; {:try_start_e .. :try_end_e} :catch_4
    ...
    :try_end_f
    .catch Landroid/util/SuperNotCalledException; {:try_start_f .. :try_end_f} :catch_7
    ...
    invoke-virtual {v6, v1, v9, v11}, Landroid/app/Instrumentation;->callActivityOnCreate(Landroid/app/Activity;Landroid/os/Bundle;Landroid/os/PersistableBundle;)V
    ...
    invoke-virtual {v6, v1, v9}, Landroid/app/Instrumentation;->callActivityOnCreate(Landroid/app/Activity;Landroid/os/Bundle;)V
    ...
    invoke-direct {v6, v9}, Landroid/util/SuperNotCalledException;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v2}, Landroid/app/ActivityThread$ActivityClientRecord;->setState(I)V

    iget-object v0, v3, Landroid/app/ActivityThread;->mActivities:Landroid/util/ArrayMap;

    iget-object v2, v5, Landroid/app/ActivityThread$ActivityClientRecord;->token:Landroid/os/IBinder;

    invoke-virtual {v0, v2, v5}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_10
    .catch Landroid/util/SuperNotCalledException; {:try_start_10 .. :try_end_10} :catch_11
...
.method private performLetActivityStayFocus(Landroid/os/IBinder;)V
    .locals 2
    ...
    invoke-virtual {v1}, Landroid/app/Activity;->applyActivityStayFocus()V
...
.method private updateConfigurationForDexCompatIfNeeded(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v0, p2}, Landroid/content/res/Configuration;->updateFromDexCompatTaskConfig(Landroid/content/res/Configuration;)I
...
.method public final acquireProvider(Landroid/content/Context;Ljava/lang/String;IZ)Landroid/content/IContentProvider;
    ...
    :try_start_0
    invoke-direct {v12, v1, v2}, Landroid/app/ActivityThread;->getGetProviderLock(Ljava/lang/String;I)Ljava/lang/Object;
    ...
    :try_start_2
    invoke-interface {v6, v7, v1, v2, v13}, Landroid/app/IActivityManager;->getContentProvider(Landroid/app/IApplicationThread;Ljava/lang/String;IZ)Landroid/app/ContentProviderHolder;
    ...
    const-string v7, "Failed to find provider info for "
    ...
    iget-boolean v10, v4, Landroid/app/ContentProviderHolder;->noReleaseNeeded:Z
    ...
    invoke-direct/range {v5 .. v11}, Landroid/app/ActivityThread;->installProvider(Landroid/content/Context;Landroid/app/ContentProviderHolder;Landroid/content/pm/ProviderInfo;ZZZ)Landroid/app/ContentProviderHolder;

    move-result-object v0

    iget-object v4, v0, Landroid/app/ContentProviderHolder;->provider:Landroid/content/IContentProvider;
...
.method public applyConventionalModeBoundsIfNeeded(Landroid/view/DisplayInfo;)V
    .locals 5

    invoke-direct {p0}, Landroid/app/ActivityThread;->getTopActivityOverrideConfiguration()Landroid/content/res/Configuration;
    ...
    iget v1, v1, Landroid/app/WindowConfiguration;->mConventionalMode:I
    ...
    iput v3, p1, Landroid/view/DisplayInfo;->appHeight:I

    iput v3, p1, Landroid/view/DisplayInfo;->logicalHeight:I
    ...
    iput v3, p1, Landroid/view/DisplayInfo;->appWidth:I

    iput v3, p1, Landroid/view/DisplayInfo;->logicalWidth:I
...
.method public checkAID(Ljava/lang/String;)Z
    .locals 3
    ...
    invoke-interface {v0, p1}, Landroid/app/IActivityManager;->checkAIDInternal(Ljava/lang/String;)Z
    ...
    const-string v2, "Failed to get AID"
...
.method public getConfiguration()Landroid/content/res/Configuration;
    ...
    iget-object v0, p0, Landroid/app/ActivityThread;->mPendingThreadConfig:Landroid/content/res/Configuration;
...
.method public getTopActivityToken()Landroid/os/IBinder;
    .locals 2
...
.method getTopLevelResources(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;ILandroid/app/LoadedApk;Ljava/lang/String;)Landroid/content/res/Resources;
    .locals 13
...
.method public handleActivityConfigurationChanged(Landroid/os/IBinder;Landroid/content/res/Configuration;I)V
    ...
    invoke-virtual {v3}, Landroid/app/WindowConfiguration;->hasWindowDecorCaption()Z

    move-result v3

    if-eqz p2, :cond_2

    invoke-direct {p0, v0, p2}, Landroid/app/ActivityThread;->updateConfigurationForDexCompatIfNeeded(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/res/Configuration;)V
    ...
    invoke-direct {p0, v0, v5, p3, v2}, Landroid/app/ActivityThread;->performConfigurationChangedForActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/res/Configuration;IZ)Landroid/content/res/Configuration;

    move-result-object v5

    if-eqz v4, :cond_4

    invoke-virtual {v4, p3, v5}, Landroid/view/ViewRootImpl;->onMovedToDisplay(ILandroid/content/res/Configuration;)V
    ...
    invoke-direct {p0, v0, v5}, Landroid/app/ActivityThread;->performConfigurationChangedForActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/res/Configuration;)V

    :goto_2
    if-eqz v4, :cond_6

    invoke-virtual {v4, p3}, Landroid/view/ViewRootImpl;->updateConfiguration(I)V
    ...
    iget-object v5, p2, Landroid/content/res/Configuration;->windowConfiguration:Landroid/app/WindowConfiguration;
    ...
    invoke-virtual {v5}, Landroid/view/Window;->onMultiWindowModeChanged()V
...
.method handleApplicationInfoChanged(Landroid/content/pm/ApplicationInfo;)V
    ...
    invoke-virtual {p0, p1, v0}, Landroid/app/ActivityThread;->handleApplicationInfoChanged(Landroid/content/pm/ApplicationInfo;Z)V

    return-void
.end method

.method handleApplicationInfoChanged(Landroid/content/pm/ApplicationInfo;Z)V
    .locals 7
...
.method public handleResumeActivity(Landroid/os/IBinder;ZZLjava/lang/String;)V
    ...
    :cond_a
    iget-object v3, p0, Landroid/app/ActivityThread;->mNewActivities:Landroid/app/ActivityThread$ActivityClientRecord;

    iput-object v3, v1, Landroid/app/ActivityThread$ActivityClientRecord;->nextIdle:Landroid/app/ActivityThread$ActivityClientRecord;
    ...
    new-instance v4, Landroid/app/ActivityThread$Idler;

    invoke-direct {v4, p0, v7}, Landroid/app/ActivityThread$Idler;-><init>(Landroid/app/ActivityThread;Landroid/app/ActivityThread$1;)V

    invoke-virtual {v3, v4}, Landroid/os/MessageQueue;->addIdleHandler(Landroid/os/MessageQueue$IdleHandler;)V

    sget-boolean v3, Landroid/app/ActivityThread;->sDisableAID:Z
    ...
    invoke-virtual {v8, v9}, Landroid/app/ActivityThread;->checkAID(Ljava/lang/String;)Z

    move-result v8

    if-eqz v8, :cond_b

    invoke-virtual {v3}, Landroid/view/View;->isFrameMetricsObservers()Z

    move-result v8

    if-nez v8, :cond_b

    invoke-virtual {v4}, Landroid/view/Choreographer;->scheduleVsyncSSLocked()V
    :try_end_1
...
.method public isDexCompatMode()Z
    ...
    invoke-direct {p0}, Landroid/app/ActivityThread;->isDesktopMode()Z
...
.method public mayStayActivityFocus(Landroid/view/Window$Callback;)Z
    .locals 3
...
.method public onCoreStatesChange(Landroid/os/Bundle;)Ljava/util/HashMap;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method performDestroyActivity(Landroid/os/IBinder;ZIZLjava/lang/String;)Landroid/app/ActivityThread$ActivityClientRecord;
    ...
    iget-object v2, p0, Landroid/app/ActivityThread;->mTopActivityClient:Landroid/app/ActivityThread$ActivityClientRecord;

    if-ne v2, v0, :cond_7

    const/4 v2, 0x0

    iput-object v2, p0, Landroid/app/ActivityThread;->mTopActivityClient:Landroid/app/ActivityThread$ActivityClientRecord;
...
.method public performResumeActivity(Landroid/os/IBinder;ZLjava/lang/String;)Landroid/app/ActivityThread$ActivityClientRecord;
    ...
    :cond_0
    iput-object v0, p0, Landroid/app/ActivityThread;->mTopActivityClient:Landroid/app/ActivityThread$ActivityClientRecord;
...
.method public updatePendingConfiguration(Landroid/content/res/Configuration;)V
    ...
    invoke-static {v0, p1}, Landroid/app/ActivityThread$ApplicationThread;->access$1100(Landroid/app/ActivityThread$ApplicationThread;Landroid/content/res/Configuration;)V
