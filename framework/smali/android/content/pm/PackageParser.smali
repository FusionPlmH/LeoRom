...
.method public static generatePackageInfo(Landroid/content/pm/PackageParser$Package;[IIJJLjava/util/Set;Landroid/content/pm/PackageUserState;I)Landroid/content/pm/PackageInfo;
    ...
    iget-boolean v7, v0, Landroid/content/pm/PackageParser$Package;->mIsSamsungThemeOverlay:Z

    iput-boolean v7, v5, Landroid/content/pm/PackageInfo;->isSamsungThemeOverlay:Z
...
.method private getCachedResult(Ljava/io/File;I)Landroid/content/pm/PackageParser$Package;
    ...
    :cond_3
    invoke-direct {p0, v4, p1}, Landroid/content/pm/PackageParser;->isCacheInvalid(Landroid/content/pm/PackageParser$Package;Ljava/io/File;)Z
    ...
    const-string v6, "invalid cache, delete!"
...
.method public static declared-synchronized getHashValueOfPackage(Ljava/io/File;Ljava/lang/StringBuilder;)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/content/pm/PackageParser$PackageParserException;
    ...
    invoke-direct {v6, v3, v5}, Ljava/security/DigestInputStream;-><init>(Ljava/io/InputStream;Ljava/security/MessageDigest;)V
    ...
    invoke-direct {v6, v4, v7, v5}, Landroid/content/pm/PackageParser$PackageParserException;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
...
.method private isCacheInvalid(Landroid/content/pm/PackageParser$Package;Ljava/io/File;)Z
    .locals 3
...
.method private isSamsungOverlayComponent(Ljava/util/List;)Z
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private parseActivity(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;I[Ljava/lang/String;Landroid/content/pm/PackageParser$CachedComponentArgs;ZZ)Landroid/content/pm/PackageParser$Activity;
    ...
    invoke-virtual {v1, v15, v10}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z
    ...
    iget v13, v15, Landroid/content/pm/ActivityInfo;->flags:I

    or-int/lit16 v13, v13, 0x200

    iput v13, v15, Landroid/content/pm/ActivityInfo;->flags:I
    ...
    iput v15, v13, Landroid/content/pm/ActivityInfo;->launchMode:I
    ...
    iput v15, v13, Landroid/content/pm/ActivityInfo;->documentLaunchMode:I
    ...
    invoke-virtual {v1, v13, v15}, Landroid/content/res/TypedArray;->getInt(II)I
    ...
    invoke-static {v15, v0}, Landroid/content/pm/PackageParser;->getActivityConfigChanges(II)I

    move-result v0

    iput v0, v11, Landroid/content/pm/ActivityInfo;->configChanges:I
    ...
    iput v11, v0, Landroid/content/pm/ActivityInfo;->softInputMode:I
    ...
    iput v11, v0, Landroid/content/pm/ActivityInfo;->persistableMode:I
    ...
    iput v11, v0, Landroid/content/pm/ActivityInfo;->screenOrientation:I
    ...
    iput v11, v0, Landroid/content/pm/ActivityInfo;->lockTaskLaunchMode:I
    ...
    iput-boolean v15, v11, Landroid/content/pm/ActivityInfo;->directBootAware:Z

    iput-boolean v15, v0, Landroid/content/pm/ActivityInfo;->encryptionAware:Z
    ...
    iput-object v11, v0, Landroid/content/pm/ActivityInfo;->requestedVrComponent:Ljava/lang/String;
    ...
    iput v11, v0, Landroid/content/pm/ActivityInfo;->rotationAnimation:I
    ...
    iput v11, v0, Landroid/content/pm/ActivityInfo;->colorMode:I
    ...
    iput v11, v0, Landroid/content/pm/ActivityInfo;->launchMode:I

    iget-object v0, v9, Landroid/content/pm/PackageParser$Activity;->info:Landroid/content/pm/ActivityInfo;

    iput v11, v0, Landroid/content/pm/ActivityInfo;->configChanges:I
    ...
    iget-object v15, v6, Landroid/content/pm/PackageParser$Package;->packageName:Ljava/lang/String;
    ...
    :cond_29
    invoke-virtual {v15}, Landroid/content/pm/PackageParser$ActivityIntentInfo;->countActions()I
    ...
    :cond_2a
    invoke-virtual {v15}, Landroid/content/pm/PackageParser$ActivityIntentInfo;->getOrder()I
    ...
    invoke-direct {v7, v15}, Landroid/content/pm/PackageParser;->isImplicitlyExposedIntent(Landroid/content/pm/PackageParser$IntentInfo;)Z
    ...
    :goto_b
    invoke-virtual {v15, v0}, Landroid/content/pm/PackageParser$ActivityIntentInfo;->setVisibilityToInstantApp(I)V

    invoke-virtual {v15}, Landroid/content/pm/PackageParser$ActivityIntentInfo;->isVisibleToInstantApp()Z
    ...
    :cond_2d
    invoke-virtual {v15}, Landroid/content/pm/PackageParser$ActivityIntentInfo;->isImplicitlyVisibleToInstantApp()Z
    ...
    const-string v15, "Problem in package "

    invoke-virtual {v6, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v15, v7, Landroid/content/pm/PackageParser;->mArchiveSourcePath:Ljava/lang/String;
    ...
    const-string v15, "Unknown element under <receiver>: "
    ...
    const-string v15, "Unknown element under <activity>: "
    ...
    iget-object v5, v9, Landroid/content/pm/PackageParser$Activity;->metaData:Landroid/os/Bundle;

    invoke-direct {v7, v0, v3, v5, v1}, Landroid/content/pm/PackageParser;->parseRuntimeManifest(Landroid/content/pm/PackageItemInfo;Ljava/lang/String;Landroid/os/Bundle;Landroid/content/res/Resources;)V
...
.method private parseActivityAlias(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;I[Ljava/lang/String;Landroid/content/pm/PackageParser$CachedComponentArgs;)Landroid/content/pm/PackageParser$Activity;
    ...
    const-string v4, "com.samsung.android.dex.transient_bar_delay"
    ...
    iput v0, v4, Landroid/content/pm/ActivityInfo;->requestTransientBarDelay:I
...
.method private parseActivitySalesCode(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;[Ljava/lang/String;)I
    ...
    sget-object v5, Landroid/content/pm/PackageParser;->mSalesCode:Ljava/lang/String;
    ...
    sget-object v7, Landroid/content/pm/PackageParser;->mSalesCode:Ljava/lang/String;
    ...
    invoke-virtual {v2, v5, v7}, Landroid/content/res/TypedArray;->getNonConfigurationString(II)Ljava/lang/String;
    ...
    const-string v8, "<activity-salescode> does not specify android:targetActivity"
    ...
    invoke-static {v8, v5, v1}, Landroid/content/pm/PackageParser;->buildClassName(Ljava/lang/String;Ljava/lang/CharSequence;[Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_2
    const-string v8, "<activity-salescode>"

    const/4 v9, 0x0

    iget-object v10, v0, Landroid/content/pm/PackageParser$Package;->activities:Ljava/util/ArrayList;
    ...
    iget-object v12, v0, Landroid/content/pm/PackageParser$Package;->activities:Ljava/util/ArrayList;
    ...
    const-string v12, " target activity "
    ...
    invoke-virtual {v2, v11, v6}, Landroid/content/res/TypedArray;->getNonConfigurationString(II)Ljava/lang/String;
    ...
    const-string v13, " does not specify android:name"
    ...
    :cond_6
    sget-object v12, Landroid/content/pm/PackageParser;->mSalesCode:Ljava/lang/String;
    ...
    iput v12, v13, Landroid/content/pm/ActivityInfo;->icon:I
    ...
    iput v13, v14, Landroid/content/pm/ActivityInfo;->logo:I
    ...
    iput v14, v15, Landroid/content/pm/ActivityInfo;->banner:I
    ...
    iget-object v7, v9, Landroid/content/pm/PackageParser$Activity;->info:Landroid/content/pm/ActivityInfo;

    iget v6, v15, Landroid/util/TypedValue;->resourceId:I

    iput v6, v7, Landroid/content/pm/ActivityInfo;->labelRes:I

    if-nez v6, :cond_b

    iget-object v6, v9, Landroid/content/pm/PackageParser$Activity;->info:Landroid/content/pm/ActivityInfo;

    invoke-virtual {v15}, Landroid/util/TypedValue;->coerceToString()Ljava/lang/CharSequence;

    move-result-object v7

    iput-object v7, v6, Landroid/content/pm/ActivityInfo;->nonLocalizedLabel:Ljava/lang/CharSequence;
    ...
    iput-boolean v0, v6, Landroid/content/pm/ActivityInfo;->enabled:Z
...
.method private parseApplicationSalesCode(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;[Ljava/lang/String;)Z
    ...
    iget-object v4, v0, Landroid/content/pm/PackageParser;->mAiReplacement:Landroid/content/pm/ApplicationInfo;

    const-string v5, "<application-salescode>"
    ...
    invoke-virtual {v1, v6, v8}, Landroid/content/res/TypedArray;->getNonConfigurationString(II)Ljava/lang/String;
    ...
    :cond_1
    sget-object v10, Landroid/content/pm/PackageParser;->mSalesCode:Ljava/lang/String;
    ...
    iget-object v10, v0, Landroid/content/pm/PackageParser;->mAiReplacementItems:Ljava/util/ArrayList;
    ...
    iput-object v11, v4, Landroid/content/pm/ApplicationInfo;->nonLocalizedLabel:Ljava/lang/CharSequence;

    iput v8, v4, Landroid/content/pm/ApplicationInfo;->labelRes:I
    ...
    iput v11, v4, Landroid/content/pm/ApplicationInfo;->labelRes:I

    :goto_0
    iget-object v11, v0, Landroid/content/pm/PackageParser;->mAiReplacementItems:Ljava/util/ArrayList;
    ...
    iput v11, v4, Landroid/content/pm/ApplicationInfo;->icon:I

    iget-object v12, v0, Landroid/content/pm/PackageParser;->mAiReplacementItems:Ljava/util/ArrayList;
    ...
    iput v12, v4, Landroid/content/pm/ApplicationInfo;->logo:I

    iget-object v13, v0, Landroid/content/pm/PackageParser;->mAiReplacementItems:Ljava/util/ArrayList;

    const-string/jumbo v14, "logo"
    ...
    iput v8, v4, Landroid/content/pm/ApplicationInfo;->banner:I
    ...
    iget-object v14, v0, Landroid/content/pm/PackageParser;->mAiReplacementItems:Ljava/util/ArrayList;

    const-string v15, "enabled"

    invoke-virtual {v14, v15}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-boolean v14, v4, Landroid/content/pm/ApplicationInfo;->enabled:Z

    invoke-virtual {v1, v13, v14}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v13

    iput-boolean v13, v4, Landroid/content/pm/ApplicationInfo;->enabled:Z
...
.method private parseBaseApkCommon(Landroid/content/pm/PackageParser$Package;Ljava/util/Set;Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;I[Ljava/lang/String;)Landroid/content/pm/PackageParser$Package;
    ...
    invoke-direct {v6, v7, v9, v10, v12}, Landroid/content/pm/PackageParser;->parseApplicationSalesCode(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;[Ljava/lang/String;)Z
    ...
    invoke-direct {v6, v2}, Landroid/content/pm/PackageParser;->isSamsungOverlayComponent(Ljava/util/List;)Z

    move-result v2

    iput-boolean v2, v7, Landroid/content/pm/PackageParser$Package;->mIsSamsungThemeOverlay:Z

    iget-boolean v2, v7, Landroid/content/pm/PackageParser$Package;->mIsSamsungThemeOverlay:Z

    if-eqz v2, :cond_62

    sget-object v2, Landroid/content/om/SamsungThemeConstants;->overlayTargetMap:Ljava/util/HashMap;

    iget-object v4, v7, Landroid/content/pm/PackageParser$Package;->mOverlayTarget:Ljava/lang/String;
    ...
    iput-object v2, v7, Landroid/content/pm/PackageParser$Package;->mOverlayTarget:Ljava/lang/String;
...
.method private parseBaseApplication(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;I[Ljava/lang/String;)Z
    ...
    :cond_2a
    iget-object v0, v15, Landroid/content/pm/PackageParser;->mAiReplacement:Landroid/content/pm/ApplicationInfo;
    ...
    sget-object v1, Landroid/content/pm/PackageParser;->mSalesCode:Ljava/lang/String;
    ...
    iget-object v0, v15, Landroid/content/pm/PackageParser;->mAiReplacementItems:Ljava/util/ArrayList;
    ...
    iput-object v0, v9, Landroid/content/pm/ApplicationInfo;->nonLocalizedLabel:Ljava/lang/CharSequence;

    iget-object v0, v15, Landroid/content/pm/PackageParser;->mAiReplacement:Landroid/content/pm/ApplicationInfo;

    iget v0, v0, Landroid/content/pm/ApplicationInfo;->labelRes:I

    iput v0, v9, Landroid/content/pm/ApplicationInfo;->labelRes:I
    ...
    iput v0, v9, Landroid/content/pm/ApplicationInfo;->icon:I
    ...
    iput v0, v9, Landroid/content/pm/ApplicationInfo;->logo:I
    ...
    iput v0, v9, Landroid/content/pm/ApplicationInfo;->banner:I
    ...
    :cond_3e
    const-string/jumbo v4, "provider-salescode"
    ...
    invoke-direct {v0, v14, v4, v15, v13}, Landroid/content/pm/PackageParser;->parseProviderSalesCode(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;[Ljava/lang/String;)I
    ...
    :cond_41
    iget v8, v7, Landroid/content/pm/PackageParser$Activity;->order:I
    ...
    iget-object v9, v14, Landroid/content/pm/PackageParser$Package;->activities:Ljava/util/ArrayList;
    ...
    :cond_43
    const-string v7, "activity-salescode"
    ...
    invoke-direct {v0, v14, v4, v15, v7}, Landroid/content/pm/PackageParser;->parseActivitySalesCode(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;[Ljava/lang/String;)I
    ...
    const-string/jumbo v9, "meta-data"
    ...
    iget-object v8, v14, Landroid/content/pm/PackageParser$Package;->mAppMetaData:Landroid/os/Bundle;

    invoke-direct {v0, v4, v15, v8, v7}, Landroid/content/pm/PackageParser;->parseMetaData(Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;Landroid/os/Bundle;[Ljava/lang/String;)Landroid/os/Bundle;

    move-result-object v8

    iput-object v8, v14, Landroid/content/pm/PackageParser$Package;->mAppMetaData:Landroid/os/Bundle;
    ...
    :cond_46
    const-string/jumbo v8, "static-library"
    ...
    sget-object v8, Lcom/android/internal/R$styleable;->AndroidManifestStaticLibrary:[I

    invoke-virtual {v4, v15, v8}, Landroid/content/res/Resources;->obtainAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v8, v10, v2}, Landroid/content/res/TypedArray;->getInt(II)I
    ...
    :cond_47
    iget-object v10, v14, Landroid/content/pm/PackageParser$Package;->mSharedUserId:Ljava/lang/String;
    ...
    :cond_48
    iget-object v10, v14, Landroid/content/pm/PackageParser$Package;->staticSharedLibName:Ljava/lang/String;
    ...
    const-string v11, "Multiple static-shared libs for package "
    ...
    iput-object v11, v14, Landroid/content/pm/PackageParser$Package;->staticSharedLibName:Ljava/lang/String;

    if-ltz v12, :cond_4a

    nop

    invoke-static {v13, v12}, Landroid/content/pm/PackageInfo;->composeLongVersionCode(II)J
    ...
    sget-object v8, Lcom/android/internal/R$styleable;->AndroidManifestLibrary:[I
    ...
    invoke-static {v2, v9}, Lcom/android/internal/util/ArrayUtils;->contains(Ljava/util/Collection;Ljava/lang/Object;)Z
    ...
    invoke-static {v2, v9}, Lcom/android/internal/util/ArrayUtils;->add(Ljava/util/ArrayList;Ljava/lang/Object;)Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v14, v4, v15, v7}, Landroid/content/pm/PackageParser;->parseUsesStaticLibrary(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;[Ljava/lang/String;)Z
    ...
    const-string/jumbo v8, "uses-library"
    ...
    sget-object v8, Lcom/android/internal/R$styleable;->AndroidManifestUsesLibrary:[I
    ...
    invoke-virtual {v8, v11, v11}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z
    ...
    iget-object v11, v14, Landroid/content/pm/PackageParser$Package;->usesLibraries:Ljava/util/ArrayList;

    invoke-static {v11, v9}, Lcom/android/internal/util/ArrayUtils;->add(Ljava/util/ArrayList;Ljava/lang/Object;)Ljava/util/ArrayList;

    move-result-object v11

    iput-object v11, v14, Landroid/content/pm/PackageParser$Package;->usesLibraries:Ljava/util/ArrayList;

    goto :goto_17

    :cond_51
    iget-object v11, v14, Landroid/content/pm/PackageParser$Package;->usesOptionalLibraries:Ljava/util/ArrayList;

    invoke-static {v11, v9}, Lcom/android/internal/util/ArrayUtils;->add(Ljava/util/ArrayList;Ljava/lang/Object;)Ljava/util/ArrayList;

    move-result-object v11

    iput-object v11, v14, Landroid/content/pm/PackageParser$Package;->usesOptionalLibraries:Ljava/util/ArrayList;
    ...
    :cond_53
    const-string/jumbo v8, "uses-package"
    ...
    :goto_1b
    iget-object v1, v14, Landroid/content/pm/PackageParser$Package;->mAppMetaData:Landroid/os/Bundle;
    ...
    iget-object v2, v14, Landroid/content/pm/PackageParser$Package;->mAppMetaData:Landroid/os/Bundle;

    invoke-direct {v0, v5, v1, v2, v4}, Landroid/content/pm/PackageParser;->parseRuntimeManifest(Landroid/content/pm/PackageItemInfo;Ljava/lang/String;Landroid/os/Bundle;Landroid/content/res/Resources;)V
...
.method private parseProvider(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;I[Ljava/lang/String;Landroid/content/pm/PackageParser$CachedComponentArgs;)Landroid/content/pm/PackageParser$Provider;
    ...
    invoke-virtual {v4, v2, v0}, Landroid/content/res/Resources;->obtainAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v1

    iget-object v0, v3, Landroid/content/pm/PackageParser$CachedComponentArgs;->mProviderArgs:Landroid/content/pm/PackageParser$ParseComponentArgs;
    ...
    iput-object v0, v3, Landroid/content/pm/PackageParser$CachedComponentArgs;->mProviderArgs:Landroid/content/pm/PackageParser$ParseComponentArgs;
    ...
    iget-object v8, v3, Landroid/content/pm/PackageParser$CachedComponentArgs;->mProviderArgs:Landroid/content/pm/PackageParser$ParseComponentArgs;
    ...
    invoke-virtual {v1, v15, v0}, Landroid/content/res/TypedArray;->getNonConfigurationString(II)Ljava/lang/String;

    move-result-object v15

    iput-object v15, v14, Landroid/content/pm/ProviderInfo;->splitName:Ljava/lang/String;

    iget-object v14, v8, Landroid/content/pm/PackageParser$Provider;->info:Landroid/content/pm/ProviderInfo;

    iput v0, v14, Landroid/content/pm/ProviderInfo;->flags:I

    const/16 v14, 0x10

    invoke-virtual {v1, v14, v0}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z
    ...
    iget v15, v14, Landroid/content/pm/ProviderInfo;->flags:I

    const/high16 v16, 0x40000000    # 2.0f

    or-int v15, v15, v16

    iput v15, v14, Landroid/content/pm/ProviderInfo;->flags:I
    ...
    iput-boolean v10, v15, Landroid/content/pm/ProviderInfo;->directBootAware:Z

    iput-boolean v10, v14, Landroid/content/pm/ProviderInfo;->encryptionAware:Z

    iget-object v10, v8, Landroid/content/pm/PackageParser$Provider;->info:Landroid/content/pm/ProviderInfo;

    iget-boolean v10, v10, Landroid/content/pm/ProviderInfo;->directBootAware:Z
    ...
    iput v14, v10, Landroid/content/pm/ApplicationInfo;->privateFlags:I
    ...
    iput-boolean v14, v5, Landroid/content/pm/PackageParser$Package;->visibleToInstantApps:Z

    :cond_b
    invoke-virtual {v1}, Landroid/content/res/TypedArray;->recycle()V

    iget-object v14, v5, Landroid/content/pm/PackageParser$Package;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    iget-object v14, v14, Landroid/content/pm/ProviderInfo;->processName:Ljava/lang/String;

    iget-object v15, v5, Landroid/content/pm/PackageParser$Package;->packageName:Ljava/lang/String;

    if-ne v14, v15, :cond_c

    const-string v14, "Heavy-weight applications can not have providers in main process"

    aput-object v14, p5, v0
    ...
    iput-object v14, v0, Landroid/content/pm/ProviderInfo;->authority:Ljava/lang/String;
    ...
    :cond_f
    iget-object v0, v8, Landroid/content/pm/PackageParser$Provider;->metaData:Landroid/os/Bundle;
    ...
    iget-object v2, v8, Landroid/content/pm/PackageParser$Provider;->metaData:Landroid/os/Bundle;

    invoke-direct {v6, v0, v1, v2, v15}, Landroid/content/pm/PackageParser;->parseRuntimeManifest(Landroid/content/pm/PackageItemInfo;Ljava/lang/String;Landroid/os/Bundle;Landroid/content/res/Resources;)V
...
.method private parseProviderSalesCode(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;[Ljava/lang/String;)I
    ...
    const-string v8, "<provider-salescode> does not specify android:targetActivity"
    ...
    :cond_2
    const-string v8, "<provider-salescode>"

    const/4 v9, 0x0

    iget-object v10, v0, Landroid/content/pm/PackageParser$Package;->providers:Ljava/util/ArrayList;
    ...
    const-string v12, " target provider "
    ...
    iget-object v13, v9, Landroid/content/pm/PackageParser$Provider;->info:Landroid/content/pm/ProviderInfo;

    iput v12, v13, Landroid/content/pm/ProviderInfo;->icon:I
    ...
    iput v13, v14, Landroid/content/pm/ProviderInfo;->logo:I
    ...
    iget-object v15, v9, Landroid/content/pm/PackageParser$Provider;->info:Landroid/content/pm/ProviderInfo;

    iput v14, v15, Landroid/content/pm/ProviderInfo;->banner:I
    ...
    iget-object v7, v9, Landroid/content/pm/PackageParser$Provider;->info:Landroid/content/pm/ProviderInfo;

    iget v6, v15, Landroid/util/TypedValue;->resourceId:I

    iput v6, v7, Landroid/content/pm/ProviderInfo;->labelRes:I

    if-nez v6, :cond_b

    iget-object v6, v9, Landroid/content/pm/PackageParser$Provider;->info:Landroid/content/pm/ProviderInfo;

    invoke-virtual {v15}, Landroid/util/TypedValue;->coerceToString()Ljava/lang/CharSequence;

    move-result-object v7

    iput-object v7, v6, Landroid/content/pm/ProviderInfo;->nonLocalizedLabel:Ljava/lang/CharSequence;
    ...
    iget-object v0, v9, Landroid/content/pm/PackageParser$Provider;->info:Landroid/content/pm/ProviderInfo;
    ...
    iput-boolean v0, v6, Landroid/content/pm/ProviderInfo;->enabled:Z
...
.method private parseRuntimeManifest(Landroid/content/pm/PackageItemInfo;Ljava/lang/String;Landroid/os/Bundle;Landroid/content/res/Resources;)V
    .locals 23
    ...
    const-string/jumbo v0, "runtimeManifest"
    ...
    :cond_0
    sget-object v0, Landroid/content/pm/PackageParser;->mSalesCode:Ljava/lang/String;
    ...
    const-string v9, "check runtimeManifestResource : "
    ...
    const-string/jumbo v13, "runtime_manifests"
    ...
    invoke-interface {v7, v12, v0}, Landroid/content/res/XmlResourceParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_7
    const-string/jumbo v15, "runtimemanifest"
    ...
    const-string/jumbo v15, "salescode"

    invoke-interface {v7, v12, v15}, Landroid/content/res/XmlResourceParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v15

    const-string v14, "iconstyle"

    invoke-interface {v7, v12, v14}, Landroid/content/res/XmlResourceParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_b
    const-string/jumbo v12, "persist.sys.iconstyle"

    const-string v10, "default"

    invoke-static {v12, v10}, Landroid/os/SystemProperties;->get(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v10

    const-string v12, "ICONSTYLE"
    ...
    sget-object v0, Lcom/android/internal/R$styleable;->runtimemanifest:[I

    invoke-virtual {v3, v7, v0}, Landroid/content/res/Resources;->obtainAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    iget v1, v12, Landroid/util/TypedValue;->resourceId:I

    iput v1, v2, Landroid/content/pm/PackageItemInfo;->labelRes:I
    ...
    iput-object v1, v2, Landroid/content/pm/PackageItemInfo;->nonLocalizedLabel:Ljava/lang/CharSequence;
    ...
    iput v1, v2, Landroid/content/pm/PackageItemInfo;->icon:I
    ...
    iput v1, v2, Landroid/content/pm/PackageItemInfo;->logo:I
    ...
    iput v1, v2, Landroid/content/pm/PackageItemInfo;->banner:I

    :cond_10
    instance-of v3, v2, Landroid/content/pm/ComponentInfo;
    ...
    iput-boolean v1, v3, Landroid/content/pm/ComponentInfo;->enabled:Z
...
.method public setIconStyle(Landroid/content/pm/PackageParser$Package;)V
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/content/pm/PackageParser$PackageParserException;
    ...
    invoke-static {v0, v1}, Landroid/content/pm/PackageParser;->parseClusterPackageLite(Ljava/io/File;I)Landroid/content/pm/PackageParser$PackageLite;

    move-result-object v0

    const/4 v2, 0x0

    iget-boolean v3, v0, Landroid/content/pm/PackageParser$PackageLite;->isolatedSplits:Z

    if-eqz v3, :cond_1

    iget-object v3, v0, Landroid/content/pm/PackageParser$PackageLite;->splitNames:[Ljava/lang/String;
    ...
    invoke-direct {v3, v0, v2, v1}, Landroid/content/pm/split/SplitAssetDependencyLoader;-><init>(Landroid/content/pm/PackageParser$PackageLite;Landroid/util/SparseArray;I)V
    :try_end_0
    .catch Landroid/content/pm/split/SplitDependencyLoader$IllegalDependencyException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v3, v0, v1}, Landroid/content/pm/split/DefaultSplitAssetLoader;-><init>(Landroid/content/pm/PackageParser$PackageLite;I)V
    ...
    invoke-direct {v4, v3, v5, v6}, Landroid/content/res/Resources;-><init>(Landroid/content/res/AssetManager;Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;)V
    ...
    iget-object v9, v6, Landroid/content/pm/PackageParser$Activity;->metaData:Landroid/os/Bundle;

    invoke-direct {p0, v7, v8, v9, v4}, Landroid/content/pm/PackageParser;->parseRuntimeManifest(Landroid/content/pm/PackageItemInfo;Ljava/lang/String;Landroid/os/Bundle;Landroid/content/res/Resources;)V
    ...
    iget-object v9, v6, Landroid/content/pm/PackageParser$Provider;->metaData:Landroid/os/Bundle;
    ...
    iget-object v6, p1, Landroid/content/pm/PackageParser$Package;->codePath:Ljava/lang/String;
    ...
    iget-object v7, p1, Landroid/content/pm/PackageParser$Package;->codePath:Ljava/lang/String;

    invoke-direct {v6, v7}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    invoke-direct {p0, v6, v5}, Landroid/content/pm/PackageParser;->getCacheKey(Ljava/io/File;I)Ljava/lang/String;
    ...
    const-string v10, "Unable to delete cache file: "
