...
.field private final mServiceEx:Landroid/sec/clipboard/IClipboardService;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Landroid/content/ClipboardManager;->mServiceEx:Landroid/sec/clipboard/IClipboardService;
...
.method public getPrimaryClip()Landroid/content/ClipData;
    ...
    invoke-interface {v0, v1}, Landroid/content/IClipboard;->isSEContainerAndIsolated(Ljava/lang/String;)Z
    ...
    :cond_0
    iget-object v0, p0, Landroid/content/ClipboardManager;->mServiceEx:Landroid/sec/clipboard/IClipboardService;
    ...
    invoke-interface {v0}, Landroid/sec/clipboard/IClipboardService;->getCount()I
    ...
    iget-object v2, p0, Landroid/content/ClipboardManager;->mServiceEx:Landroid/sec/clipboard/IClipboardService;

    invoke-interface {v2, v0}, Landroid/sec/clipboard/IClipboardService;->getClipData(I)Lcom/samsung/android/content/clipboard/data/SemClipData;
    ...
    :cond_2
    invoke-virtual {v2}, Lcom/samsung/android/content/clipboard/data/SemClipData;->getClipData()Landroid/content/ClipData;
...
.method public setPrimaryClip(Landroid/content/ClipData;)V
    ...
    invoke-interface {v2, p1, v1}, Landroid/sec/clipboard/IClipboardService;->addClip(Landroid/content/ClipData;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
