...
.method static constructor <clinit>()V
    ...
    sput v1, Landroid/content/res/ResourcesImpl;->sLoadDensityDpi:I
...
.method private loadDrawableForCookie(Landroid/content/res/Resources;Landroid/util/TypedValue;II)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v5, v4, v0, v12}, Landroid/content/res/ResourcesImpl;->loadXmlResourceParser(Ljava/lang/String;IILjava/lang/String;)Landroid/content/res/XmlResourceParser;
    ...
    :try_start_5
    invoke-static {v2, v3, v0, v5, v13}, Landroid/graphics/drawable/Drawable;->createFromResourceStream(Landroid/content/res/Resources;Landroid/util/TypedValue;Ljava/io/InputStream;Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/drawable/Drawable;
    ...
    sget-wide v17, Landroid/graphics/Bitmap;->sPreloadTracingTotalBitmapsSize:J
...
.method loadDrawable(Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    iget v0, v11, Landroid/content/res/Resources;->mAppIconResId:I
    ...
    iget-object v2, v11, Landroid/content/res/Resources;->mPackageName:Ljava/lang/String;

    iget v3, v11, Landroid/content/res/Resources;->mUserId:I

    invoke-virtual {v0, v2, v3}, Landroid/sec/enterprise/ApplicationPolicy;->getApplicationIconFromDb(Ljava/lang/String;I)[B
    ...
    iput v9, v4, Landroid/util/TypedValue;->density:I
    ...
    invoke-static {v11, v4, v3, v6, v5}, Landroid/graphics/drawable/Drawable;->createFromResourceStream(Landroid/content/res/Resources;Landroid/util/TypedValue;Ljava/io/InputStream;Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/drawable/Drawable;
    ...
    const-string/jumbo v9, "loadDrawable() : EDM get Icon from DB : "
    ...
    iget-boolean v2, v10, Landroid/content/res/ResourcesImpl;->mPreloading:Z

    if-nez v2, :cond_7

    if-eqz v16, :cond_7

    invoke-virtual {v0, v7, v8, v11, v15}, Landroid/content/res/DrawableCache;->getInstance(JLandroid/content/res/Resources;Landroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v2, v1}, Landroid/graphics/drawable/Drawable;->setChangingConfigurations(I)V
    ...
    iget-object v3, v10, Landroid/content/res/ResourcesImpl;->mConfiguration:Landroid/content/res/Configuration;
    ...
    const-string v4, "Resources.preload"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "Hit preloaded FW drawable #"
    ...
    :cond_9
    invoke-virtual {v9, v11}, Landroid/graphics/drawable/Drawable$ConstantState;->newDrawable(Landroid/content/res/Resources;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v6, v1}, Landroid/graphics/drawable/Drawable;->setChangingConfigurations(I)V
    :try_end_2
...
.method public updateConfiguration(Landroid/content/res/Configuration;Landroid/util/DisplayMetrics;Landroid/content/res/CompatibilityInfo;)V
    ...
    sget v11, Landroid/content/res/ResourcesImpl;->sLoadDensityDpi:I
    ...
    iget v13, v11, Landroid/content/res/Configuration;->mcc:I

    iget-object v11, v1, Landroid/content/res/ResourcesImpl;->mConfiguration:Landroid/content/res/Configuration;

    iget v14, v11, Landroid/content/res/Configuration;->mnc:I
    ...
    invoke-virtual {v11, v10}, Landroid/os/LocaleList;->get(I)Ljava/util/Locale;
