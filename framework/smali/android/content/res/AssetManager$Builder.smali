...
.method public build()Landroid/content/res/AssetManager;
    ...
    iget-object v6, v5, Landroid/content/res/AssetManager;->mSamsungThemeOverlays:Ljava/util/ArrayList;
    ...
    invoke-virtual {v7}, Landroid/content/res/ApkAssets;->getAssetPath()Ljava/lang/String;

    move-result-object v7

    if-eqz v7, :cond_2

    const-string v8, "/data/overlays"
    ...
    iget-object v8, v5, Landroid/content/res/AssetManager;->mSamsungThemeOverlays:Ljava/util/ArrayList;
