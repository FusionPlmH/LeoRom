...
.method public initialize(Landroid/media/MediaDrm$ProvisionRequest;Ljava/util/UUID;Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$ProvisioningThread;
    ...
    invoke-static {p3}, Landroid/media/MediaPlayer;->access$4800(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnDrmPreparedHandlerDelegate;
...
.method public run()V
    ...
    invoke-static {v4}, Landroid/media/MediaPlayer;->access$4900(Landroid/media/MediaPlayer;)Landroid/media/MediaDrm;
    ...
    invoke-static {v7, v8}, Landroid/media/MediaPlayer;->access$5000(Landroid/media/MediaPlayer;Ljava/util/UUID;)Z
    ...
    invoke-static {v6, v1}, Landroid/media/MediaPlayer;->access$5102(Landroid/media/MediaPlayer;Z)Z

    iget-object v6, p0, Landroid/media/MediaPlayer$ProvisioningThread;->mediaPlayer:Landroid/media/MediaPlayer;

    invoke-static {v6, v1}, Landroid/media/MediaPlayer;->access$5202(Landroid/media/MediaPlayer;Z)Z

    if-nez v4, :cond_3

    iget-object v1, p0, Landroid/media/MediaPlayer$ProvisioningThread;->this$0:Landroid/media/MediaPlayer;

    invoke-static {v1}, Landroid/media/MediaPlayer;->access$5300(Landroid/media/MediaPlayer;)V
    ...
    invoke-static {v5, v7}, Landroid/media/MediaPlayer;->access$5000(Landroid/media/MediaPlayer;Ljava/util/UUID;)Z
    ...
    invoke-static {v5, v1}, Landroid/media/MediaPlayer;->access$5102(Landroid/media/MediaPlayer;Z)Z

    iget-object v5, p0, Landroid/media/MediaPlayer$ProvisioningThread;->mediaPlayer:Landroid/media/MediaPlayer;

    invoke-static {v5, v1}, Landroid/media/MediaPlayer;->access$5202(Landroid/media/MediaPlayer;Z)Z
