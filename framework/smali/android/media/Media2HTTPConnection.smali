...
.method public constructor <init>()V
    ...
    iput-boolean v2, p0, Landroid/media/Media2HTTPConnection;->mAllowCrossDomainRedirect:Z

    iput-boolean v2, p0, Landroid/media/Media2HTTPConnection;->mAllowCrossProtocolRedirect:Z

    const/4 v3, -0x1

    iput v3, p0, Landroid/media/Media2HTTPConnection;->mReadTimeoutMs:I

    iput-boolean v2, p0, Landroid/media/Media2HTTPConnection;->mPartialDownloadSupported:Z

    iput-wide v0, p0, Landroid/media/Media2HTTPConnection;->mMaxOffsetAllowed:J

    iput-wide v0, p0, Landroid/media/Media2HTTPConnection;->mMinOffsetAllowed:J

    iput-boolean v2, p0, Landroid/media/Media2HTTPConnection;->mAvailabeSeekRange:Z

    const/4 v0, 0x0

    iput-boolean v0, p0, Landroid/media/Media2HTTPConnection;->mFullRandomAccess:Z

    iput-boolean v0, p0, Landroid/media/Media2HTTPConnection;->mLimitedRandomAccess:Z

    const-wide/16 v1, 0x0

    iput-wide v1, p0, Landroid/media/Media2HTTPConnection;->mCheckFlag:J

    iput v0, p0, Landroid/media/Media2HTTPConnection;->mResponse:I
...
.method private seekTo(J)V
    ...
    :goto_1
    iget v0, v1, Landroid/media/Media2HTTPConnection;->mReadTimeoutMs:I

    if-lez v0, :cond_1

    const-string v0, "Media2HTTPConnection"

    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v10, "setReadTimeout with "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v10, v1, Landroid/media/Media2HTTPConnection;->mReadTimeoutMs:I
    ...
    iget v9, v1, Landroid/media/Media2HTTPConnection;->mReadTimeoutMs:I
    ...
    :cond_9
    iput v11, v1, Landroid/media/Media2HTTPConnection;->mResponse:I
...
.method public getMIMEType()Ljava/lang/String;
    ...
    iget v1, p0, Landroid/media/Media2HTTPConnection;->mResponse:I
    ...
    iget v3, p0, Landroid/media/Media2HTTPConnection;->mResponse:I
...
.method public setReadTimeOut(I)V
    ...
    iput p1, p0, Landroid/media/Media2HTTPConnection;->mReadTimeoutMs:I
