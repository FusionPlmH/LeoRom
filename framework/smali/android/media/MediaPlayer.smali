...
.method public constructor <init>()V
    ...
    iput-object v3, p0, Landroid/media/MediaPlayer;->mContextAwareUri:Ljava/lang/String;
    ...
    iput v3, p0, Landroid/media/MediaPlayer;->mContextAwareStatus:I
    ...
    sget-boolean v0, Landroid/media/MediaPlayer;->mPmExceptionForContextAware:Z
    ...
    iput v0, p0, Landroid/media/MediaPlayer;->mPid:I
...
.method static synthetic access$100(Landroid/media/MediaPlayer;Z)V
    .locals 0
...
.method static synthetic access$1800(Landroid/media/MediaPlayer;)I
    .locals 1
...
.method static synthetic access$1802(Landroid/media/MediaPlayer;I)I
    .locals 0
...
.method static synthetic access$1900(Landroid/media/MediaPlayer;)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$1902(Landroid/media/MediaPlayer;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method static synthetic access$2200(Landroid/media/MediaPlayer;)I
    .locals 1
...
.method static synthetic access$2202(Landroid/media/MediaPlayer;I)I
    .locals 0
...
.method static synthetic access$2300(Landroid/media/MediaPlayer;)I
    .locals 1
...
.method static synthetic access$2302(Landroid/media/MediaPlayer;I)I
    .locals 0
...
.method static synthetic access$2400(Landroid/media/MediaPlayer;Ljava/lang/String;[Ljava/lang/Object;)Z
    .locals 1
...
.method static synthetic access$2500(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnBufferingUpdateListener;
    .locals 1
...
.method static synthetic access$2600(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnSeekCompleteListener;
    .locals 1
...
.method static synthetic access$2700(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnVideoSizeChangedListener;
    .locals 1
...
.method static synthetic access$2900(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnErrorListener;
    .locals 1
...
.method static synthetic access$3000(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnPlayReadyErrorListener;
    .locals 1
...
.method static synthetic access$3100(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnInfoListener;
    .locals 1
...
.method static synthetic access$3200(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnTimedTextListener;
    .locals 1
...
.method static synthetic access$3300(Landroid/media/MediaPlayer;)Z
    .locals 1
...
.method static synthetic access$3400(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnSubtitleDataListener;
    .locals 1
...
.method static synthetic access$3500(Landroid/media/MediaPlayer;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic access$3600(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnSubtitleDataListener;
    .locals 1
...
.method static synthetic access$3800(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnTimedMetaDataAvailableListener;
    .locals 1
...
.method static synthetic access$3900(Landroid/media/MediaPlayer;)Landroid/util/ArrayMap;
    .locals 1
...
.method static synthetic access$4000(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnMediaTimeDiscontinuityListener;
    .locals 1
...
.method static synthetic access$4100(Landroid/media/MediaPlayer;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic access$4200(Landroid/media/MediaPlayer;)I
    .locals 1
...
.method static synthetic access$4202(Landroid/media/MediaPlayer;I)I
    .locals 0
...
.method static synthetic access$4800(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnDrmPreparedHandlerDelegate;
    .locals 1
...
.method static synthetic access$4900(Landroid/media/MediaPlayer;)Landroid/media/MediaDrm;
    .locals 1
...
.method static synthetic access$5000(Landroid/media/MediaPlayer;Ljava/util/UUID;)Z
    .locals 1
...
.method static synthetic access$5102(Landroid/media/MediaPlayer;Z)Z
    .locals 0
...
.method static synthetic access$5202(Landroid/media/MediaPlayer;Z)Z
    .locals 0
...
.method static synthetic access$5300(Landroid/media/MediaPlayer;)V
    .locals 0
...
.method private isNeedContextAwareInfoBroadCast()Z
    ...
    const-string v4, "Need to enable context aware info"
    ...
    sput-boolean v2, Landroid/media/MediaPlayer;->mPmExceptionForContextAware:Z
...
.method private varargs sendBroadcastingIntent(Ljava/lang/String;[Ljava/lang/Object;)Z
    ...
    const-string/jumbo v5, "sendBroadcastingIntent invailed param - "
    ...
    invoke-virtual {v15, v4, v5}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/io/Serializable;)Landroid/content/Intent;
    ...
    const-string v6, "Invailed Type. Add "
    ...
    const-string v5, "IllegalArgumentException handled"
    ...
    const-string/jumbo v5, "sendBroadcast fail"
    ...
    const-string/jumbo v5, "sendBroadcast(NullPointerException) fail"
    ...
    const-string/jumbo v5, "sendBroadcast(ClassCastException) fail"
...
.method private startImpl()V
    ...
    const-string v0, "com.samsung.intent.videoexist"
    ...
    iget v4, p0, Landroid/media/MediaPlayer;->mPid:I
    ...
    invoke-direct {p0, v0, v3}, Landroid/media/MediaPlayer;->sendBroadcastingIntent(Ljava/lang/String;[Ljava/lang/Object;)Z
    ...
    :cond_1
    iput v1, p0, Landroid/media/MediaPlayer;->mPendingCommand:I
...
.method protected finalize()V
    ...
    iget v4, p0, Landroid/media/MediaPlayer;->mContextAwareDurationMs:I
    ...
    iget v4, p0, Landroid/media/MediaPlayer;->mIsVideo:I
    ...
    iput v2, p0, Landroid/media/MediaPlayer;->mContextAwareStatus:I
...
.method public pause()V
    ...
    sget-boolean v1, Landroid/media/MediaPlayer;->MMFWContextAware:Z

    if-eqz v1, :cond_1

    iget v1, p0, Landroid/media/MediaPlayer;->mContextAwareStatus:I

    const/4 v2, 0x1

    if-ne v1, v2, :cond_0

    const-string v1, "com.samsung.CONTEXT_AWARE_MUSIC_INFO"
    ...
    iget-object v4, p0, Landroid/media/MediaPlayer;->mContextAwareUri:Ljava/lang/String;
    ...
    invoke-direct {p0, v1, v3}, Landroid/media/MediaPlayer;->sendBroadcastingIntent(Ljava/lang/String;[Ljava/lang/Object;)Z
...
.method public release()V
    ...
    invoke-direct {p0, v1, v4}, Landroid/media/MediaPlayer;->sendBroadcastingIntent(Ljava/lang/String;[Ljava/lang/Object;)Z
...
.method public reset()V
    ...
    iget v2, p0, Landroid/media/MediaPlayer;->mContextAwareStatus:I
    ...
    iget v6, p0, Landroid/media/MediaPlayer;->mContextAwareId:I
    ...
    iget v6, p0, Landroid/media/MediaPlayer;->mPid:I
    ...
    iget v6, p0, Landroid/media/MediaPlayer;->mContextAwareDurationMs:I
    ...
    iget v6, p0, Landroid/media/MediaPlayer;->mIsVideo:I
    ...
    invoke-direct {p0, v2, v5}, Landroid/media/MediaPlayer;->sendBroadcastingIntent(Ljava/lang/String;[Ljava/lang/Object;)Z
...
.method public semAddTimedTextSource(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v2}, Landroid/os/Parcel;->writeFileDescriptor(Ljava/io/FileDescriptor;)V
    ...
    invoke-virtual {p0, v3, v4}, Landroid/media/MediaPlayer;->invoke(Landroid/os/Parcel;Landroid/os/Parcel;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public semGetInbandTrackInfoArray()[Landroid/media/MediaPlayer$TrackInfo;
    ...
    const-string v1, "getInbandSubtilteTrackInfo"
...
.method public semGetOutbandSubtilteTrackInfoArray()[Landroid/media/MediaPlayer$TrackInfo;
    ...
    const-string v1, "getOutbandSubtilteTrackInfo"
    ...
    const-string/jumbo v4, "no outband subtitle track"

    invoke-static {v3, v4}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    const/4 v3, 0x0

    new-array v3, v3, [Landroid/media/MediaPlayer$TrackInfo;
    ...
    new-array v4, v2, [Landroid/media/MediaPlayer$TrackInfo;
    ...
    check-cast v7, Landroid/media/SubtitleTrack;

    invoke-virtual {v7}, Landroid/media/SubtitleTrack;->getTrackType()I
    ...
    new-instance v9, Landroid/media/MediaPlayer$TrackInfo;

    invoke-virtual {v7}, Landroid/media/SubtitleTrack;->getTrackType()I

    move-result v10

    invoke-virtual {v7}, Landroid/media/SubtitleTrack;->getFormat()Landroid/media/MediaFormat;

    move-result-object v11

    invoke-direct {v9, v10, v11}, Landroid/media/MediaPlayer$TrackInfo;-><init>(ILandroid/media/MediaFormat;)V
    ...
    const-string v7, "invalid outband subtitle track number - outOfBandSubtitleTrackNum = "
...
.method public semGetOutbandTimedTextTrackInfoArray()[Landroid/media/MediaPlayer$TrackInfo;
    ...
    const-string v1, "getOutbandTimedTextTrackInfo"
...
.method public semRemoveOutbandSubtitleSource()V
    ...
    const-string/jumbo v1, "removeOutbandSubtitleSource"
...
.method public semRemoveOutbandTimedTextSource()V
    ...
    iget-object v5, p0, Landroid/media/MediaPlayer;->mInbandTrackIndices:Ljava/util/BitSet;
    ...
    invoke-virtual {v4}, Landroid/media/SubtitleController;->getTracks()[Landroid/media/SubtitleTrack;
...
.method public stop()V
    ...
    iget v3, p0, Landroid/media/MediaPlayer;->mContextAwareDurationMs:I
    ...
    iget v3, p0, Landroid/media/MediaPlayer;->mIsVideo:I
