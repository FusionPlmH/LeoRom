...
.field private mIsAPM_Audio:Z

.field private mIsAPM_Video:Z
...
.field private mPermissionMonitor:Landroid/media/AppPermissionMonitorMediaRecorder;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Landroid/media/MediaRecorder;->mIsAPM_Audio:Z

    iput-boolean v0, p0, Landroid/media/MediaRecorder;->mIsAPM_Video:Z

    iput-boolean v0, p0, Landroid/media/MediaRecorder;->mIsRecording:Z

    new-instance v0, Landroid/media/AppPermissionMonitorMediaRecorder;

    invoke-direct {v0}, Landroid/media/AppPermissionMonitorMediaRecorder;-><init>()V

    iput-object v0, p0, Landroid/media/MediaRecorder;->mPermissionMonitor:Landroid/media/AppPermissionMonitorMediaRecorder;
...
.method private static checkAudioRecordEnabled()Z
    ...
    invoke-virtual {v2, v0}, Landroid/sec/enterprise/RestrictionPolicy;->isAudioRecordAllowed(Z)Z
...
.method private static checkMicrophoneEnabled()Z
    ...
    invoke-virtual {v2, v0}, Landroid/sec/enterprise/RestrictionPolicy;->isMicrophoneEnabled(Z)Z
...
.method private static checkVideoRecordEnabled()Z
    ...
    invoke-virtual {v2, v0}, Landroid/sec/enterprise/RestrictionPolicy;->isVideoRecordAllowed(Z)Z
...
.method public prepare()V
    ...
    iget-boolean v2, p0, Landroid/media/MediaRecorder;->mIsVideoRecordEnabled:Z
    ...
    const-string v3, "MDM is blocking video recording"
    ...
    :cond_2
    :goto_1
    iget-boolean v2, p0, Landroid/media/MediaRecorder;->mIsAudioRecordEnabled:Z
    ...
    const-string v3, "MDM is blocking audio recording"
    ...
    const-string/jumbo v2, "prepare: mPath = "
    ...
    const-string/jumbo v2, "prepare: mFd = "
    ...
    const-string/jumbo v2, "prepare: mFile = "
...
.method public setOutputFile(Ljava/io/File;)V
    ...
    const-string/jumbo v2, "setOutputFile: file = "
    ...
    iget-boolean v0, p0, Landroid/media/MediaRecorder;->mIsRecording:Z

    if-nez v0, :cond_1

    const/4 v0, -0x1

    iget-boolean v1, p0, Landroid/media/MediaRecorder;->mIsAPM_Video:Z
    ...
    :goto_0
    iget-object v1, p0, Landroid/media/MediaRecorder;->mPermissionMonitor:Landroid/media/AppPermissionMonitorMediaRecorder;
    ...
    invoke-virtual {v1, v2, v3, v0, v4}, Landroid/media/AppPermissionMonitorMediaRecorder;->sendMediaNotificationForAppPermissionMonitor(IIILjava/lang/String;)V
...
.method public setOutputFile(Ljava/io/FileDescriptor;)V
    ...
    iget-object v0, p0, Landroid/media/MediaRecorder;->mPermissionMonitor:Landroid/media/AppPermissionMonitorMediaRecorder;
    ...
    invoke-virtual {v0, v1, v2}, Landroid/media/AppPermissionMonitorMediaRecorder;->sendEnforcingForAppPermissionMonitor(II)V
...
.method public setOutputFile(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "setOutputFile: path = "
    ...
    invoke-virtual {v1, v2, v3, v0, p1}, Landroid/media/AppPermissionMonitorMediaRecorder;->sendMediaNotificationForAppPermissionMonitor(IIILjava/lang/String;)V
...
.method public stop()V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/media/AppPermissionMonitorMediaRecorder;->sendMediaNotificationForAppPermissionMonitor(II)V
