...
.method updateAudioRoutes(Landroid/media/AudioRoutesInfo;)V
    ...
    const-string v3, "force audioRouteschanged true "
...
.method updateClientState()V
    ...
    iget-object v1, v1, Landroid/media/MediaRouterClientState;->routes:Ljava/util/ArrayList;
    ...
    :goto_1
    iget-object v2, p0, Landroid/media/MediaRouter$Static;->mClientState:Landroid/media/MediaRouterClientState;

    if-eqz v2, :cond_2

    iget-object v0, p0, Landroid/media/MediaRouter$Static;->mClientState:Landroid/media/MediaRouterClientState;

    iget-object v0, v0, Landroid/media/MediaRouterClientState;->globallySelectedRouteId:Ljava/lang/String;
    ...
    check-cast v5, Landroid/media/MediaRouterClientState$RouteInfo;

    iget-object v6, v5, Landroid/media/MediaRouterClientState$RouteInfo;->id:Ljava/lang/String;

    invoke-virtual {p0, v6}, Landroid/media/MediaRouter$Static;->findGlobalRoute(Ljava/lang/String;)Landroid/media/MediaRouter$RouteInfo;

    move-result-object v6

    if-nez v6, :cond_4

    invoke-virtual {p0, v5}, Landroid/media/MediaRouter$Static;->makeGlobalRoute(Landroid/media/MediaRouterClientState$RouteInfo;)Landroid/media/MediaRouter$RouteInfo;

    move-result-object v6

    invoke-static {v6}, Landroid/media/MediaRouter;->addRouteStatic(Landroid/media/MediaRouter$RouteInfo;)V

    goto :goto_4

    :cond_4
    invoke-virtual {p0, v6, v5}, Landroid/media/MediaRouter$Static;->updateGlobalRoute(Landroid/media/MediaRouter$RouteInfo;Landroid/media/MediaRouterClientState$RouteInfo;)V
    ...
    invoke-virtual {p0, v0}, Landroid/media/MediaRouter$Static;->findGlobalRoute(Ljava/lang/String;)Landroid/media/MediaRouter$RouteInfo;
    ...
    const-string v7, "Could not find new globally selected route: "
    ...
    const-string v7, "Selecting new globally selected route: "
    ...
    :cond_7
    iget v5, v4, Landroid/media/MediaRouter$RouteInfo;->mSupportedTypes:I

    invoke-static {v5, v4, v2}, Landroid/media/MediaRouter;->selectRouteStatic(ILandroid/media/MediaRouter$RouteInfo;Z)V
    ...
    iget-object v4, v4, Landroid/media/MediaRouter$RouteInfo;->mGlobalRouteId:Ljava/lang/String;
    ...
    const-string v6, "Unselecting previous globally selected route: "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v6, p0, Landroid/media/MediaRouter$Static;->mSelectedRoute:Landroid/media/MediaRouter$RouteInfo;
    ...
    iget-object v6, v4, Landroid/media/MediaRouter$RouteInfo;->mGlobalRouteId:Ljava/lang/String;
    ...
    check-cast v8, Landroid/media/MediaRouterClientState$RouteInfo;

    iget-object v9, v8, Landroid/media/MediaRouterClientState$RouteInfo;->id:Ljava/lang/String;
