...
.field protected mVolumeMultiplier:F
    .annotation build Lcom/android/internal/annotations/GuardedBy;
        value = "mLock"
    .end annotation
.end field
...
.method constructor <init>(Landroid/media/AudioAttributes;I)V
    ...
    iput v0, p0, Landroid/media/PlayerBase;->mVolumeMultiplier:F
...
.method static synthetic access$100(Landroid/media/PlayerBase;F)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/media/PlayerBase;->setVolume(F)V
...
.method private setVolume(F)V
    ...
    :try_start_0
    iput p1, p0, Landroid/media/PlayerBase;->mVolumeMultiplier:F

    monitor-exit v0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget v0, p0, Landroid/media/PlayerBase;->mLeftVolume:F

    iget v1, p0, Landroid/media/PlayerBase;->mRightVolume:F

    invoke-virtual {p0, v0, v1}, Landroid/media/PlayerBase;->baseSetVolume(FF)V
...
.method baseSetVolume(FF)V
    ...
    iget v2, p0, Landroid/media/PlayerBase;->mVolumeMultiplier:F
    ...
    iget v3, p0, Landroid/media/PlayerBase;->mVolumeMultiplier:F
