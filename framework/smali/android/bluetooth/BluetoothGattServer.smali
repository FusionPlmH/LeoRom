...
.method constructor <init>(Landroid/bluetooth/IBluetoothGatt;I)V
    ...
    iput-boolean v0, p0, Landroid/bluetooth/BluetoothGattServer;->isConnectionValid:Z

    new-instance v1, Landroid/bluetooth/BluetoothGattServer$1;

    invoke-direct {v1, p0}, Landroid/bluetooth/BluetoothGattServer$1;-><init>(Landroid/bluetooth/BluetoothGattServer;)V

    iput-object v1, p0, Landroid/bluetooth/BluetoothGattServer;->mBluetoothGattServerCallback:Landroid/bluetooth/IBluetoothGattServerCallback;

    new-instance v1, Landroid/bluetooth/BluetoothGattServer$2;

    invoke-direct {v1, p0}, Landroid/bluetooth/BluetoothGattServer$2;-><init>(Landroid/bluetooth/BluetoothGattServer;)V

    iput-object v1, p0, Landroid/bluetooth/BluetoothGattServer;->mBluetoothStateChangeCallback:Landroid/bluetooth/IBluetoothStateChangeCallback;
    ...
    iput-object v1, p0, Landroid/bluetooth/BluetoothGattServer;->mAdapter:Landroid/bluetooth/BluetoothAdapter;
    ...
    iput-object v0, p0, Landroid/bluetooth/BluetoothGattServer;->mConnectedDevices:Ljava/util/List;
    ...
    :try_start_0
    iget-object v1, p0, Landroid/bluetooth/BluetoothGattServer;->mBluetoothStateChangeCallback:Landroid/bluetooth/IBluetoothStateChangeCallback;
...
.method static synthetic access$700(Landroid/bluetooth/BluetoothGattServer;)Landroid/bluetooth/BluetoothGattService;
    .locals 1
...
.method static synthetic access$702(Landroid/bluetooth/BluetoothGattServer;Landroid/bluetooth/BluetoothGattService;)Landroid/bluetooth/BluetoothGattService;
    .locals 0
...
.method static synthetic access$800(Landroid/bluetooth/BluetoothGattServer;)Ljava/util/List;
    .locals 1
...
.method public close()V
    ...
    :cond_0
    :goto_0
    iget-object v1, p0, Landroid/bluetooth/BluetoothGattServer;->mConnectedDevices:Ljava/util/List;
...
.method public connect(Landroid/bluetooth/BluetoothDevice;Z)Z
    ...
    const-string v2, "connect BLE service is disabled; Security mode disables gatt server connection"
    ...
    iput-object v2, p0, Landroid/bluetooth/BluetoothGattServer;->mDevice:Ljava/lang/String;
    ...
    invoke-interface {v2, v3, v4, v5, v6}, Landroid/bluetooth/IBluetoothGatt;->serverConnect(ILjava/lang/String;ZI)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
