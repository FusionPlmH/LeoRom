...
.field public static final ACTION_SEC_SPP_CONNECTION_STATE_CHANGED:Ljava/lang/String; = "com.samsung.bluetooth.action.GEAR_CONNECTION_STATE_CHANGED"
...
.field public static final EXTRA_PREV_BATTERY_LEVEL:Ljava/lang/String; = "android.bluetooth.device.extra.PREV_BATTERY_LEVEL"
...
.field public static final SEM_ACTION_BOND_STATE_CHANGED_FROM_NEARBY_DEVICE:Ljava/lang/String; = "com.samsung.bluetooth.device.action.BOND_STATE_CHANGED_FROM_NEARBY_DEVICE"
...
.field public static final SEM_BOND_OPTION_NONE:B = 0x0t

.field public static final SEM_BOND_OPTION_NO_AUTO_CONNECTION:B = 0x1t
...
.method constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Landroid/bluetooth/BluetoothDevice;->mPackageName:Ljava/lang/String;

    const/4 v0, -0x1

    iput v0, p0, Landroid/bluetooth/BluetoothDevice;->mMyPid:I
...
.method public static semGetModelHighRssi()I
    ...
    invoke-interface {v0}, Landroid/bluetooth/IBluetooth;->getHighRssi()I
    ...
    const-string/jumbo v1, "semGetModelHighRssi,returning RSSI_ERROR"
...
.method public static semGetModelLowRssi()I
    ...
    invoke-interface {v0}, Landroid/bluetooth/IBluetooth;->getLowRssi()I
    ...
    const-string/jumbo v1, "semGetModelLowRssi,returning RSSI_ERROR"
...
.method public static semGetModelMidRssi()I
    ...
    invoke-interface {v0}, Landroid/bluetooth/IBluetooth;->getMidRssi()I
    ...
    const-string/jumbo v1, "semGetModelMidRssi,returning RSSI_ERROR"
...
.method public cancelPairingUserInput()Z
    ...
    const-string v1, "BluetoothDevice -- cancelPairingUserInput() for dev "
    ...
    iget v1, p0, Landroid/bluetooth/BluetoothDevice;->mMyPid:I
    ...
    iget-object v1, p0, Landroid/bluetooth/BluetoothDevice;->mPackageName:Ljava/lang/String;
...
.method public connectGatt(Landroid/content/Context;ZLandroid/bluetooth/BluetoothGattCallback;IZILandroid/os/Handler;)Landroid/bluetooth/BluetoothGatt;
    ...
    invoke-virtual {v2}, Landroid/bluetooth/BluetoothAdapter;->isBleApiAvailable()Z
...
.method public createBond()Z
    ...
    const-string v3, "BluetoothDevice -- createBond(TRANSPORT_AUTO) for dev "
    ...
    iget v3, p0, Landroid/bluetooth/BluetoothDevice;->mMyPid:I
    ...
    iget-object v3, p0, Landroid/bluetooth/BluetoothDevice;->mPackageName:Ljava/lang/String;
...
.method public createBond(I)Z
    ...
    const-string v3, "BluetoothDevice -- createBond("

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, p1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v3, ") for dev "
...
.method public createInsecureL2capCocSocket(II)Landroid/bluetooth/BluetoothSocket;
    ...
    const-string v2, "createInsecureL2capCocSocket: Bluetooth is not enabled"
    ...
    new-instance v1, Landroid/bluetooth/BluetoothSocket;
    ...
    invoke-direct/range {v2 .. v9}, Landroid/bluetooth/BluetoothSocket;-><init>(IIZZLandroid/bluetooth/BluetoothDevice;ILandroid/os/ParcelUuid;)V
...
.method public createL2capCocSocket(II)Landroid/bluetooth/BluetoothSocket;
    ...
    const-string v2, "createL2capCocSocket: Bluetooth is not enabled"
...
.method public fetchUuidsWithSdp()Z
    ...
    const-string v4, "fetchUuidsWithSdp() for device "
    ...
    const-string v4, "BluetoothDevice -- fetchUuidsWithSdp() for dev "
    ...
    iget v4, p0, Landroid/bluetooth/BluetoothDevice;->mMyPid:I
    ...
    iget-object v4, p0, Landroid/bluetooth/BluetoothDevice;->mPackageName:Ljava/lang/String;
    ...
    invoke-interface {v0, p0, v4}, Landroid/bluetooth/IBluetooth;->fetchRemoteUuidsFiltered(Landroid/bluetooth/BluetoothDevice;Z)Z
    ...
    :cond_1
    invoke-interface {v0, p0, v1}, Landroid/bluetooth/IBluetooth;->fetchRemoteUuidsFiltered(Landroid/bluetooth/BluetoothDevice;Z)Z
...
.method public getConnectionTimeStamp()J
    ...
    invoke-interface {v0, p0}, Landroid/bluetooth/IBluetooth;->getConnectionTimeStamp(Landroid/bluetooth/BluetoothDevice;)J
...
.method public getInbandRingtoneSupport()Z
    .locals 5
    ...
    const-string v3, "Bluetooth disabled. Cannot get inbandrigntone support"
    ...
    invoke-interface {v1, p0}, Landroid/bluetooth/IBluetooth;->getInbandRingtoneSupport(Landroid/bluetooth/BluetoothDevice;)Z
...
.method public getVoiceRecognitionSupport()Z
    .locals 5
    ...
    const-string v3, "Bluetooth disabled. Cannot get voicerecognition support"
    ...
    invoke-interface {v1, p0}, Landroid/bluetooth/IBluetooth;->getVoiceRecognitionSupport(Landroid/bluetooth/BluetoothDevice;)Z
...
.method public getVolumeControlSupport()Z
    ...
    const-string v3, "Bluetooth disabled. Cannot get volumecontrol support"
    ...
    invoke-interface {v1, p0}, Landroid/bluetooth/IBluetooth;->getVolumeControlSupport(Landroid/bluetooth/BluetoothDevice;)Z
...
.method public logRfcommConnected(II)V
    .locals 3
    ...
    invoke-interface {v0, p0, p1, p2}, Landroid/bluetooth/IBluetooth;->logRfcommConnected(Landroid/bluetooth/BluetoothDevice;II)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public removeBond()Z
    ...
    const-string v3, "BluetoothDevice -- removeBond() for dev "
...
.method public semConnectGattByPublicAddress(Landroid/content/Context;Landroid/bluetooth/BluetoothGattCallback;)Landroid/bluetooth/BluetoothGatt;
    ...
    :cond_1
    new-instance v10, Landroid/bluetooth/BluetoothGatt;
    ...
    invoke-direct/range {v4 .. v9}, Landroid/bluetooth/BluetoothGatt;-><init>(Landroid/bluetooth/IBluetoothGatt;Landroid/bluetooth/BluetoothDevice;IZI)V

    move-object v4, v10

    invoke-virtual {v4, p2}, Landroid/bluetooth/BluetoothGatt;->connectUsePublicAddr(Landroid/bluetooth/BluetoothGattCallback;)Z
...
.method public semCreateBond(B)Z
    .locals 5
    ...
    const-string/jumbo v4, "semCreateBond() for device "
    ...
    const-string v3, "BluetoothDevice -- semCreateBond() for dev "
    ...
    invoke-interface {v2, p0, v1, p1}, Landroid/bluetooth/IBluetooth;->semCreateBond(Landroid/bluetooth/BluetoothDevice;IB)Z
...
.method public semGetAppearance()I
    ...
    invoke-interface {v0, p0}, Landroid/bluetooth/IBluetooth;->getRemoteAppearance(Landroid/bluetooth/BluetoothDevice;)I
...
.method public semGetManufacturerData()[B
    ...
    invoke-interface {v0, p0}, Landroid/bluetooth/IBluetooth;->getRemoteManufacturerData(Landroid/bluetooth/BluetoothDevice;)[B
...
.method public semIsGearConnected()Z
    ...
    invoke-interface {v0, p0}, Landroid/bluetooth/IBluetooth;->isSecSppConnected(Landroid/bluetooth/BluetoothDevice;)Z
...
.method public semMonitorRssi(III)Z
    ...
    const-string v2, "BT not enabled. Cannot read raw RSSI"
    ...
    invoke-interface {v0, p0, p1, p2, p3}, Landroid/bluetooth/IBluetooth;->semMonitorRssi(Landroid/bluetooth/BluetoothDevice;III)Z
...
.method public semReadRssi()Z
    ...
    invoke-interface {v0, p0}, Landroid/bluetooth/IBluetooth;->semReadRssi(Landroid/bluetooth/BluetoothDevice;)Z
...
.method public semSetManufacturerData([B)Z
    ...
    const-string v2, "BT not enabled. Cannot set Remote Device class"
...
.method public setBluetoothClass(I)Z
    ...
    invoke-interface {v0, p0, p1}, Landroid/bluetooth/IBluetooth;->setRemoteClass(Landroid/bluetooth/BluetoothDevice;I)Z
...
.method public setConnectionTimeStamp(Z)V
    .locals 3
    ...
    invoke-interface {v0, p0, p1}, Landroid/bluetooth/IBluetooth;->setConnectionTimeStamp(Landroid/bluetooth/BluetoothDevice;Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setInbandRingtoneSupport(Z)Z
    .locals 5
    ...
    const-string v3, "Bluetooth disabled. Cannot set inbandrigntone support"
    ...
    invoke-interface {v1, p0, p1}, Landroid/bluetooth/IBluetooth;->setInbandRingtoneSupport(Landroid/bluetooth/BluetoothDevice;Z)Z
...
.method public setPairingConfirmation(Z)Z
    ...
    const-string v1, "BluetoothDevice -- setPairingConfirmation("

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, p1}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v1, ") for dev "
...
.method public setPasskey(I)Z
    ...
    const-string v1, "BluetoothDevice -- setPasskey() for dev "
...
.method public setPin([B)Z
    ...
    const-string v1, "BluetoothDevice -- setPin() for dev "
...
.method public setRemoteOutOfBandData()Z
    ...
    const-string v1, "BluetoothDevice -- setRemoteOutOfBandData() for dev "
...
.method public setRfcommConnected(Z)V
    ...
    const-string v1, "BT not enabled. Cannot get Gear Manager name"
    ...
    invoke-interface {v0, p0, p1}, Landroid/bluetooth/IBluetooth;->setRfcommConnected(Landroid/bluetooth/BluetoothDevice;Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setVoiceRecognitionSupport(Z)Z
    .locals 5
    ...
    const-string v3, "Bluetooth disabled. Cannot set voicerecognition support"
    ...
    invoke-interface {v1, p0, p1}, Landroid/bluetooth/IBluetooth;->setVoiceRecognitionSupport(Landroid/bluetooth/BluetoothDevice;Z)Z
...
.method public setVolumeControlSupport(Z)Z
    .locals 5
    ...
    const-string v3, "Bluetooth disabled. Cannot set volumecontrol support"
    ...
    invoke-interface {v1, p0, p1}, Landroid/bluetooth/IBluetooth;->setVolumeControlSupport(Landroid/bluetooth/BluetoothDevice;Z)Z
