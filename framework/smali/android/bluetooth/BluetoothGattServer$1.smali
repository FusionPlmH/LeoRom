...
.method public onServerConnectionState(IIZLjava/lang/String;)V
    ...
    invoke-static {v2}, Landroid/bluetooth/BluetoothGattServer;->access$300(Landroid/bluetooth/BluetoothGattServer;)Z
    ...
    invoke-static {v1}, Landroid/bluetooth/BluetoothGattServer;->access$400(Landroid/bluetooth/BluetoothGattServer;)Ljava/lang/String;
    ...
    const-string v3, "Server connected, update device to list, address ="
    ...
    invoke-static {v1}, Landroid/bluetooth/BluetoothGattServer;->access$600(Landroid/bluetooth/BluetoothGattServer;)Ljava/util/List;
    ...
    invoke-static {v1, v0}, Landroid/bluetooth/BluetoothGattServer;->access$302(Landroid/bluetooth/BluetoothGattServer;Z)Z
    ...
    const-string v3, "Server disconnected, update device to list, address = "
    ...
    :goto_1
    invoke-virtual {v1, v2, p1, v0}, Landroid/bluetooth/BluetoothGattServerCallback;->onConnectionStateChange(Landroid/bluetooth/BluetoothDevice;II)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onServiceAdded(ILandroid/bluetooth/BluetoothGattService;)V
    ...
    invoke-static {v0}, Landroid/bluetooth/BluetoothGattServer;->access$700(Landroid/bluetooth/BluetoothGattServer;)Landroid/bluetooth/BluetoothGattService;
    ...
    invoke-static {v1, v2}, Landroid/bluetooth/BluetoothGattServer;->access$702(Landroid/bluetooth/BluetoothGattServer;Landroid/bluetooth/BluetoothGattService;)Landroid/bluetooth/BluetoothGattService;
    ...
    invoke-static {v3}, Landroid/bluetooth/BluetoothGattServer;->access$800(Landroid/bluetooth/BluetoothGattServer;)Ljava/util/List;
