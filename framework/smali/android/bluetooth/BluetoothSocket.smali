...
.field public static final TYPE_VENDOR_HCI:I = 0x5
...
.method constructor <init>(IIZZLandroid/bluetooth/BluetoothDevice;ILandroid/os/ParcelUuid;ZZ)V
    ...
    iput-object v0, p0, Landroid/bluetooth/BluetoothSocket;->mBluetoothAdapter:Landroid/bluetooth/BluetoothAdapter;

    if-nez p5, :cond_4

    iget-object v0, p0, Landroid/bluetooth/BluetoothSocket;->mBluetoothAdapter:Landroid/bluetooth/BluetoothAdapter;
...
.method private acceptSocket(Ljava/lang/String;)Landroid/bluetooth/BluetoothSocket;
    ...
    invoke-virtual {v2, v3}, Landroid/bluetooth/BluetoothDevice;->setRfcommConnected(Z)V
...
.method accept(I)Landroid/bluetooth/BluetoothSocket;
    ...
    invoke-virtual {v0, v1}, Landroid/bluetooth/BluetoothAdapter;->updateUidListForFreeze(Z)V
...
.method bindListen()I
    ...
    invoke-virtual {v0, v2}, Landroid/bluetooth/BluetoothAdapter;->getBluetoothService(Landroid/bluetooth/IBluetoothManagerCallback;)Landroid/bluetooth/IBluetooth;
    ...
    :cond_a
    invoke-static {v3}, Landroid/net/LocalSocket;->createConnectedLocalSocket(Ljava/io/FileDescriptor;)Landroid/net/LocalSocket;
    ...
    invoke-direct {p0, v3}, Landroid/bluetooth/BluetoothSocket;->readInt(Ljava/io/InputStream;)I
...
.method public close()V
    ...
    invoke-virtual {v0, v1}, Landroid/bluetooth/BluetoothDevice;->setRfcommConnected(Z)V
...
.method public connect()V
    ...
    const-string v1, "connect not allowed ; IT Policy HandsfreeOnly"
    ...
    iget-object v2, p0, Landroid/bluetooth/BluetoothSocket;->mBluetoothAdapter:Landroid/bluetooth/BluetoothAdapter;

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroid/bluetooth/BluetoothSocket;->mBluetoothAdapter:Landroid/bluetooth/BluetoothAdapter;

    invoke-virtual {v2, v3}, Landroid/bluetooth/BluetoothAdapter;->updateUidListForFreeze(Z)V
    ...
    invoke-static {v2, v3, v4, v5}, Landroid/sec/enterprise/BluetoothUtils;->bluetoothSocketLog(Ljava/lang/String;Landroid/bluetooth/BluetoothDevice;II)V
    ...
    invoke-virtual {v2, v3, v4}, Landroid/bluetooth/BluetoothDevice;->logRfcommConnected(II)V
    ...
    const-string v1, " is not allowed by MDM policy"
