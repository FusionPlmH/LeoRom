...
.field static final TRANSACTION_changeCodec:I = 0x21

.field static final TRANSACTION_commandForMonitoring:I = 0x8

.field static final TRANSACTION_connect:I = 0x1

.field static final TRANSACTION_disableOptionalCodecs:I = 0x17

.field static final TRANSACTION_disconnect:I = 0x2

.field static final TRANSACTION_enableOptionalCodecs:I = 0x16

.field static final TRANSACTION_getActiveDevice:I = 0xe

.field static final TRANSACTION_getActiveStreamDevice:I = 0x3

.field static final TRANSACTION_getCodecEnabled:I = 0x1f

.field static final TRANSACTION_getCodecStatus:I = 0x14

.field static final TRANSACTION_getConnectedDevices:I = 0xa

.field static final TRANSACTION_getConnectionState:I = 0xc

.field static final TRANSACTION_getDevicesMatchingConnectionStates:I = 0xb

.field static final TRANSACTION_getOptionalCodecsEnabled:I = 0x19

.field static final TRANSACTION_getPriority:I = 0x10

.field static final TRANSACTION_getSupportCodec:I = 0x1e

.field static final TRANSACTION_isA2dpPlaying:I = 0x13

.field static final TRANSACTION_isAbsoluteVolumeControl:I = 0x7

.field static final TRANSACTION_isAvrcpAbsoluteVolumeDeviceActive:I = 0x9

.field static final TRANSACTION_isAvrcpAbsoluteVolumeSupported:I = 0x11

.field static final TRANSACTION_isDualPlayEnabled:I = 0x5

.field static final TRANSACTION_isSbcScmst:I = 0x1d

.field static final TRANSACTION_registerA2dpDevCallBack:I = 0x23

.field static final TRANSACTION_semSetCodecDisabled:I = 0x1c

.field static final TRANSACTION_setAbsoluteVolumeControl:I = 0x6

.field static final TRANSACTION_setActiveDevice:I = 0xd

.field static final TRANSACTION_setAvrcpAbsoluteVolume:I = 0x12

.field static final TRANSACTION_setCodecConfigPreference:I = 0x15

.field static final TRANSACTION_setCodecEnabled:I = 0x20

.field static final TRANSACTION_setContentProtectionValue:I = 0x1b

.field static final TRANSACTION_setDualPlayMode:I = 0x4

.field static final TRANSACTION_setEnableLdacMode:I = 0x22

.field static final TRANSACTION_setOptionalCodecsEnabled:I = 0x1a

.field static final TRANSACTION_setPriority:I = 0xf

.field static final TRANSACTION_supportsOptionalCodecs:I = 0x18

.field static final TRANSACTION_unregisterA2dpDevCallBack:I = 0x24
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-static {v1}, Landroid/bluetooth/IBluetoothA2dpDevCallBack$Stub;->asInterface(Landroid/os/IBinder;)Landroid/bluetooth/IBluetoothA2dpDevCallBack;

    move-result-object v1

    invoke-virtual {p0, v1}, Landroid/bluetooth/IBluetoothA2dp$Stub;->registerA2dpDevCallBack(Landroid/bluetooth/IBluetoothA2dpDevCallBack;)Z
    ...
    :cond_1
    invoke-virtual {p0, v3, v1}, Landroid/bluetooth/IBluetoothA2dp$Stub;->setEnableLdacMode(Landroid/bluetooth/BluetoothDevice;Z)V
    ...
    invoke-virtual {p0, v1, v3}, Landroid/bluetooth/IBluetoothA2dp$Stub;->changeCodec(Landroid/bluetooth/BluetoothDevice;I)V
    ...
    invoke-virtual {p0, v1, v3, v4}, Landroid/bluetooth/IBluetoothA2dp$Stub;->setCodecEnabled(Landroid/bluetooth/BluetoothDevice;II)V
    ...
    invoke-virtual {p0, v1, v3}, Landroid/bluetooth/IBluetoothA2dp$Stub;->getCodecEnabled(Landroid/bluetooth/BluetoothDevice;I)I
    ...
    invoke-virtual {p0, v1, v3}, Landroid/bluetooth/IBluetoothA2dp$Stub;->getSupportCodec(Landroid/bluetooth/BluetoothDevice;I)I
    ...
    invoke-virtual {p0}, Landroid/bluetooth/IBluetoothA2dp$Stub;->isSbcScmst()Z
    ...
    :cond_6
    invoke-virtual {p0, v3, v1}, Landroid/bluetooth/IBluetoothA2dp$Stub;->semSetCodecDisabled(IZ)Z
    ...
    invoke-virtual {p0, v1}, Landroid/bluetooth/IBluetoothA2dp$Stub;->setContentProtectionValue(I)Z
    ...
    invoke-virtual {p0}, Landroid/bluetooth/IBluetoothA2dp$Stub;->isAvrcpAbsoluteVolumeDeviceActive()Z
    ...
    invoke-virtual {p0, v1}, Landroid/bluetooth/IBluetoothA2dp$Stub;->commandForMonitoring(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0}, Landroid/bluetooth/IBluetoothA2dp$Stub;->isAbsoluteVolumeControl()Z
    ...
    :cond_16
    invoke-virtual {p0, v1}, Landroid/bluetooth/IBluetoothA2dp$Stub;->setAbsoluteVolumeControl(Z)Z
    ...
    :cond_17
    invoke-virtual {p0, v1}, Landroid/bluetooth/IBluetoothA2dp$Stub;->setDualPlayMode(Z)Z
