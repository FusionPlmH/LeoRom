...
.field public static final CONNECTION_PRIORITY_SPEN_INTERVAL_120:I = 0x65

.field public static final CONNECTION_PRIORITY_SPEN_INTERVAL_150:I = 0x66

.field public static final CONNECTION_PRIORITY_SPEN_INTERVAL_60:I = 0x64
...
.field private mUsePublicAddr:Z
...
.method constructor <init>(Landroid/bluetooth/IBluetoothGatt;Landroid/bluetooth/BluetoothDevice;IZI)V
    ...
    new-instance v1, Landroid/bluetooth/BluetoothGatt$2;

    invoke-direct {v1, p0}, Landroid/bluetooth/BluetoothGatt$2;-><init>(Landroid/bluetooth/BluetoothGatt;)V

    iput-object v1, p0, Landroid/bluetooth/BluetoothGatt;->mBluetoothStateChangeCallback:Landroid/bluetooth/IBluetoothStateChangeCallback;
    ...
    iput-object v0, p0, Landroid/bluetooth/BluetoothGatt;->mAdapter:Landroid/bluetooth/BluetoothAdapter;
    ...
    :try_start_0
    iget-object v1, p0, Landroid/bluetooth/BluetoothGatt;->mBluetoothStateChangeCallback:Landroid/bluetooth/IBluetoothStateChangeCallback;
...
.method static synthetic access$1000(Landroid/bluetooth/BluetoothGatt;)Z
    ...
    iget-boolean v0, p0, Landroid/bluetooth/BluetoothGatt;->mUsePublicAddr:Z

    return v0
.end method

.method static synthetic access$1100(Landroid/bluetooth/BluetoothGatt;)Landroid/bluetooth/IBluetoothGatt;
    .locals 1
...
.method static synthetic access$1300(Landroid/bluetooth/BluetoothGatt;)Ljava/lang/Boolean;
    .locals 1
...
.method static synthetic access$1302(Landroid/bluetooth/BluetoothGatt;Ljava/lang/Boolean;)Ljava/lang/Boolean;
    .locals 0
...
.method static synthetic access$1400(Landroid/bluetooth/BluetoothGatt;)Ljava/util/List;
    .locals 1
...
.method static synthetic access$1500(Landroid/bluetooth/BluetoothGatt;)I
    .locals 1
...
.method static synthetic access$1502(Landroid/bluetooth/BluetoothGatt;I)I
    .locals 0
...
.method static synthetic access$1508(Landroid/bluetooth/BluetoothGatt;)I
    .locals 2
...
.method static synthetic access$1600(Landroid/bluetooth/BluetoothGatt;)Landroid/bluetooth/BluetoothAdapter;
    .locals 1
...
.method public close()V
    ...
    const-string v1, "BluetoothGatt close("
...
.method public connect()Z
    ...
    const-string v2, "connect BLE service is disabled; Security mode disables re initiate connection"
    ...
    iget v7, p0, Landroid/bluetooth/BluetoothGatt;->mTransport:I

    iget-boolean v8, p0, Landroid/bluetooth/BluetoothGatt;->mOpportunistic:Z

    iget v9, p0, Landroid/bluetooth/BluetoothGatt;->mPhy:I

    const/4 v10, 0x0

    const/4 v11, 0x0

    invoke-interface/range {v3 .. v11}, Landroid/bluetooth/IBluetoothGatt;->clientConnect(ILjava/lang/String;ZIZIZI)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method connect(Ljava/lang/Boolean;Landroid/bluetooth/BluetoothGattCallback;Landroid/os/Handler;)Z
    ...
    const-string v2, "connect BLE service is disabled; Security mode disables gatt connection"
    ...
    :try_start_0
    iget v2, p0, Landroid/bluetooth/BluetoothGatt;->mConnState:I
    ...
    iput-boolean v1, p0, Landroid/bluetooth/BluetoothGatt;->mUsePublicAddr:Z
...
.method connectUsePublicAddr(Landroid/bluetooth/BluetoothGattCallback;)Z
    ...
    const-string v2, "connectUsePublicAddr() - device: "
    ...
    const-string v2, "connect BLE service is disabled; Security mode disables gatt public address connection"
    ...
    iput-boolean v2, p0, Landroid/bluetooth/BluetoothGatt;->mUsePublicAddr:Z

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, Landroid/bluetooth/BluetoothGatt;->registerApp(Landroid/bluetooth/BluetoothGattCallback;Landroid/os/Handler;)Z
...
.method public semMonitorRssi(III)Z
    ...
    invoke-interface/range {v2 .. v7}, Landroid/bluetooth/IBluetoothGatt;->semMonitorRssi(ILjava/lang/String;III)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v1, "Illegal Rssi value"
