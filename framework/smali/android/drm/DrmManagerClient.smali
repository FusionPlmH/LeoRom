...
.field private static final isLogEnabled:Z = false
...
.method private releaseDvfsBooster()V
    ...
    iget-object v0, p0, Landroid/drm/DrmManagerClient;->mDvfsHelper:Lcom/samsung/android/os/SemDvfsManager;
...
.method private setDvfsBooster(Z)V
    ...
    const-string/jumbo v4, "mDvfsHelper initialize"

    invoke-static {v3, v4}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v3, p0, Landroid/drm/DrmManagerClient;->mContext:Landroid/content/Context;

    const-string v4, "CPU_DRMsecurePlayback"
    ...
    iput-object v3, p0, Landroid/drm/DrmManagerClient;->mDvfsHelper:Lcom/samsung/android/os/SemDvfsManager;
    ...
    const-string/jumbo v4, "mDvfsHelper acquire"
...
.method public acquireDrmInfo(Landroid/drm/DrmInfoRequest;)Landroid/drm/DrmInfo;
    ...
    invoke-virtual {p1, v6}, Landroid/drm/DrmInfoRequest;->get(Ljava/lang/String;)Ljava/lang/Object;
    ...
    const-string v8, "FileDescriptorKey"

    invoke-virtual {p1, v8, v7}, Landroid/drm/DrmInfoRequest;->put(Ljava/lang/String;Ljava/lang/Object;)V

    const-string v8, ".dm"

    const-string v10, ".dcf"

    invoke-virtual {v6, v8, v10}, Ljava/lang/String;->replace(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, Landroid/drm/DrmManagerClient;->setFD(Ljava/io/FileDescriptor;)Ljava/lang/String;

    move-result-object v10

    move-object v7, v10

    const-string v10, "OutFileDescriptorKey"

    invoke-virtual {p1, v10, v7}, Landroid/drm/DrmInfoRequest;->put(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v12, "Exception the file "
    ...
    const-string v10, "file extention is not dm or fl"
    ...
    invoke-virtual {p0, v5}, Landroid/drm/DrmManagerClient;->setFD(Ljava/io/FileDescriptor;)Ljava/lang/String;
    ...
    :cond_3
    :goto_3
    iget v8, p0, Landroid/drm/DrmManagerClient;->mUniqueId:I

    invoke-direct {p0, v8, p1}, Landroid/drm/DrmManagerClient;->_acquireDrmInfo(ILandroid/drm/DrmInfoRequest;)Landroid/drm/DrmInfo;
    ...
    const-string v9, "_acquireDrmInfo TYPE_CONVERT_DRM_FILE"
    ...
    const-string v10, "_acquireDrmInfo TYPE_CONVERT_DRM_FILE "
    ...
    const-string v9, "DM file delete DrmInfoRequest.SEM_SUCCESS"
    ...
    const-string v11, "DM file delete fail"
    ...
    const-string v9, "dcf file delete DrmInfoRequest.SEM_FAIL"
    ...
    const-string v11, "dcf file delete DrmInfoRequest.SEM_FAIL"
    ...
    const-string v11, "DrmManagerClient"

    const-string v12, "DM file delete fail"
...
.method public dpDRM(I)V
    ...
    invoke-static {v1, v0}, Landroid/drm/DrmManagerClient;->sysfsWrite(Ljava/lang/String;I)Z
    ...
    const-string v1, "DRM_DISPLAYPORT_ENABLE failed"
    ...
    invoke-static {v0, v1}, Landroid/drm/DrmManagerClient;->sysfsWrite(Ljava/lang/String;I)Z
    ...
    const-string v1, "DRM_DISPLAYPORT_DISABLE failed"
...
.method protected finalize()V
    ...
    iput-object v0, p0, Landroid/drm/DrmManagerClient;->mContext:Landroid/content/Context;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public saveDevID()V
    ...
    invoke-direct {p0, v1}, Landroid/drm/DrmManagerClient;->_saveIMEI(Ljava/lang/String;)Z
    ...
    const-string v3, "devID save failed"
    ...
    const-string v1, "Permission denied:You do not have READ_PHONE_STATE permission ."
