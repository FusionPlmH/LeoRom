...
.method public static createBitmap(Landroid/util/DisplayMetrics;IILandroid/graphics/Bitmap$Config;ZLandroid/graphics/ColorSpace;)Landroid/graphics/Bitmap;
    ...
    :cond_1
    instance-of v3, v2, Landroid/graphics/ColorSpace$Rgb;
    ...
    sget-object v3, Landroid/graphics/ColorSpace;->ILLUMINANT_D50:[F

    invoke-static {v13, v3}, Landroid/graphics/ColorSpace;->adapt(Landroid/graphics/ColorSpace;[F)Landroid/graphics/ColorSpace;
    ...
    iget v8, v12, Landroid/graphics/Bitmap$Config;->nativeInt:I
    ...
    invoke-static/range {v3 .. v11}, Landroid/graphics/Bitmap;->nativeCreate([IIIIIIZ[FLandroid/graphics/ColorSpace$Rgb$TransferParameters;)Landroid/graphics/Bitmap;
    ...
    const-string v4, "colorSpace must use an ICC parametric transfer function"
    ...
    const-string v4, "colorSpace must be an RGB color space"
...
.method public compress(Landroid/graphics/Bitmap$SemCompressFormat;ILjava/io/OutputStream;)Z
    ...
    sget-object v3, Landroid/graphics/Bitmap$SemCompressFormat;->Astc:Landroid/graphics/Bitmap$SemCompressFormat;
    ...
    iget v6, p1, Landroid/graphics/Bitmap$SemCompressFormat;->nativeInt:I
    ...
    invoke-static/range {v4 .. v9}, Landroid/graphics/Bitmap;->nativeCompress(JIILjava/io/OutputStream;[B)Z
...
.method public semCompress(Landroid/graphics/Bitmap$SemCompressFormat;ILjava/io/OutputStream;)Z
    ...
    const-string v2, "Bitmap.ExtendedCompress"
