...
.method public isAllowedToUseOrder(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    const-string v4, "SemExecutableWhitelist"
    ...
    :cond_3
    iget-object v5, p0, Lcom/samsung/android/app/SemExecutableWhitelist;->mWhiteList:Ljava/util/HashMap;
    ...
    const-string v6, "SemExecutableWhitelist"
    ...
    invoke-direct {p0, v4, v0}, Lcom/samsung/android/app/SemExecutableWhitelist;->isMatchedSignature([Landroid/content/pm/Signature;I)Z
    ...
    sget-boolean v0, Lcom/samsung/android/app/SemExecutableWhitelist;->DEBUG:Z

    if-eqz v0, :cond_6

    const-string v0, "SemExecutableWhitelist"

    const-string v6, "isAllowedToUse : executable manager white lists don\'t match this App"
    ...
    sget-boolean v2, Lcom/samsung/android/app/SemExecutableWhitelist;->DEBUG:Z

    if-eqz v2, :cond_7

    const-string v2, "SemExecutableWhitelist"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v4, "isNotAllowedToUse : "
