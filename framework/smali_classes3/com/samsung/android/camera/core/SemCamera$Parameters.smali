...
.method synthetic constructor <init>(Lcom/samsung/android/camera/core/SemCamera;Lcom/samsung/android/camera/core/SemCamera$1;)V
    .locals 0
...
.method private declared-synchronized set(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/samsung/android/camera/core/SemCamera$Parameters;->set(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v3, v2, Lcom/samsung/android/camera/core/SemCamera$Area;->rect:Landroid/graphics/Rect;
    ...
    iget v5, v2, Lcom/samsung/android/camera/core/SemCamera$Area;->weight:I
    ...
    invoke-virtual {p0, p1, v1}, Lcom/samsung/android/camera/core/SemCamera$Parameters;->set(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private splitArea(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v7, v5}, Lcom/samsung/android/camera/core/SemCamera$Parameters;->splitInt(Ljava/lang/String;[I)V
    ...
    new-instance v8, Lcom/samsung/android/camera/core/SemCamera$Area;

    const/4 v9, 0x4

    aget v9, v5, v9

    invoke-direct {v8, v7, v9}, Lcom/samsung/android/camera/core/SemCamera$Area;-><init>(Landroid/graphics/Rect;I)V
    ...
    check-cast v1, Lcom/samsung/android/camera/core/SemCamera$Area;

    iget-object v3, v1, Lcom/samsung/android/camera/core/SemCamera$Area;->rect:Landroid/graphics/Rect;
    ...
    iget v7, v1, Lcom/samsung/android/camera/core/SemCamera$Area;->weight:I
...
.method private splitRange(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v6, v4}, Lcom/samsung/android/camera/core/SemCamera$Parameters;->splitInt(Ljava/lang/String;[I)V
...
.method private splitSize(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v4}, Lcom/samsung/android/camera/core/SemCamera$Parameters;->strToSize(Ljava/lang/String;)Lcom/samsung/android/camera/core/SemCamera$Size;
...
.method public getSupportedPictureFormats()Ljava/util/List;
    ...
    invoke-direct {p0, v3}, Lcom/samsung/android/camera/core/SemCamera$Parameters;->pixelFormatForCameraFormat(Ljava/lang/String;)I
...
.method public same(Lcom/samsung/android/camera/core/SemCamera$Parameters;)Z
    ...
    iget-object v2, p1, Lcom/samsung/android/camera/core/SemCamera$Parameters;->mMap:Ljava/util/LinkedHashMap;
