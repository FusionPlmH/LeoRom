...
.method public run()V
    ...
    iget-wide v1, v0, Lcom/samsung/android/graphics/SemImageFilter;->mNativeImageFilter:J

    new-instance v3, Lcom/samsung/android/graphics/SemImageFilter$ImageFilterAnimator;
    ...
    invoke-direct {v3, v0, v4, v5, v6}, Lcom/samsung/android/graphics/SemImageFilter$ImageFilterAnimator;-><init>(Lcom/samsung/android/graphics/SemImageFilter;Lcom/samsung/android/graphics/SemImageFilter$Animator;Landroid/animation/TimeInterpolator;Lcom/samsung/android/graphics/SemImageFilter$AnimationListener;)V

    iget v4, p0, Lcom/samsung/android/graphics/SemImageFilter$2;->val$animationId:I

    iget-wide v5, p0, Lcom/samsung/android/graphics/SemImageFilter$2;->val$duration:J

    iget-wide v7, p0, Lcom/samsung/android/graphics/SemImageFilter$2;->val$delay:J

    invoke-static/range {v1 .. v8}, Lcom/samsung/android/graphics/SemImageFilter;->access$300(JLcom/samsung/android/graphics/SemImageFilter$ImageFilterAnimator;IJJ)V
