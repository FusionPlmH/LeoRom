...
.method static synthetic access$200(Lcom/samsung/android/graphics/SemImageFilter;I)V
    .locals 0
...
.method static synthetic access$300(JLcom/samsung/android/graphics/SemImageFilter$ImageFilterAnimator;IJJ)V
    .locals 0
...
.method static synthetic access$500(JLjava/lang/String;[FIII)V
    .locals 0
...
.method static synthetic access$600(JLjava/lang/String;[IIII)V
    .locals 0
...
.method static synthetic access$700(JIF)V
    .locals 0
...
.method static synthetic access$902(Lcom/samsung/android/graphics/SemImageFilter;Lcom/samsung/android/graphics/SemImageFilter$AnimationHandle;)Lcom/samsung/android/graphics/SemImageFilter$AnimationHandle;
    .locals 0
...
.method private killAnimation(I)V
    ...
    const-string v1, "Impossible to kill animation! SemImageFilter object is not attached to view or invalid!"
...
.method public addAnimation(Lcom/samsung/android/graphics/SemImageFilter$Animator;Landroid/animation/TimeInterpolator;Lcom/samsung/android/graphics/SemImageFilter$AnimationListener;JJ)Lcom/samsung/android/graphics/SemImageFilter$AnimationHandleNode;
    ...
    iget-wide v0, v10, Lcom/samsung/android/graphics/SemImageFilter;->mNativeImageFilter:J
    ...
    iget-object v0, v10, Lcom/samsung/android/graphics/SemImageFilter;->mView:Landroid/view/View;
    ...
    sput v0, Lcom/samsung/android/graphics/SemImageFilter;->mGlobalAnimationId:I

    move v11, v0

    invoke-virtual {v10}, Lcom/samsung/android/graphics/SemImageFilter;->invalidateView()V

    new-instance v12, Lcom/samsung/android/graphics/SemImageFilter$2;
    ...
    iget-object v1, v10, Lcom/samsung/android/graphics/SemImageFilter;->mView:Landroid/view/View;
    ...
    :cond_1
    invoke-direct {v10, v0}, Lcom/samsung/android/graphics/SemImageFilter;->postDelayedAnimationTask(Ljava/lang/Runnable;)V

    :goto_0
    new-instance v1, Lcom/samsung/android/graphics/SemImageFilter$AnimationHandleNode;

    invoke-direct {v1, v10, v11}, Lcom/samsung/android/graphics/SemImageFilter$AnimationHandleNode;-><init>(Lcom/samsung/android/graphics/SemImageFilter;I)V
    ...
    const-string v1, "Impossible to add animation! SemImageFilter object is not attached to view or invalid!"
...
.method public clone()Lcom/samsung/android/graphics/SemImageFilter;
    ...
    iget-wide v1, p0, Lcom/samsung/android/graphics/SemImageFilter;->mNativeImageFilter:J

    invoke-static {v1, v2}, Lcom/samsung/android/graphics/SemImageFilter;->native_copy(J)J

    move-result-wide v1

    iput-wide v1, v0, Lcom/samsung/android/graphics/SemImageFilter;->mNativeImageFilter:J
...
.method protected getBitmapPixelColor(Ljava/lang/String;II)I
    ...
    const-string v1, "SemImageFilter has no native object."
...
.method protected getUniformMatrix(Ljava/lang/String;II[F)V
    ...
    invoke-static/range {v2 .. v7}, Lcom/samsung/android/graphics/SemImageFilter;->native_getUniformMatrix(JLjava/lang/String;II[F)V
...
.method protected getUniformf(Ljava/lang/String;II[F)V
    ...
    invoke-static/range {v1 .. v6}, Lcom/samsung/android/graphics/SemImageFilter;->native_getUniformf(JLjava/lang/String;II[F)V
...
.method protected getUniformi(Ljava/lang/String;II[I)V
    ...
    invoke-static/range {v1 .. v6}, Lcom/samsung/android/graphics/SemImageFilter;->native_getUniformi(JLjava/lang/String;II[I)V
...
.method protected setBitmap(Ljava/lang/String;Landroid/graphics/Bitmap;)V
    ...
    const-string v2, " is unsupported format!"
    ...
    :goto_0
    invoke-static {v0, v1, p1, v2, v3}, Lcom/samsung/android/graphics/SemImageFilter;->native_setSamplerBitmap(JLjava/lang/String;J)V
...
.method protected setUniformMatrix(Ljava/lang/String;II[F)V
    ...
    invoke-static/range {v2 .. v7}, Lcom/samsung/android/graphics/SemImageFilter;->native_setUniformMatrix(JLjava/lang/String;II[F)V
...
.method protected setUniformf(Ljava/lang/String;II[F)V
    ...
    invoke-static/range {v1 .. v6}, Lcom/samsung/android/graphics/SemImageFilter;->native_setUniformf(JLjava/lang/String;II[F)V
...
.method protected setUniformi(Ljava/lang/String;II[I)V
    ...
    invoke-static/range {v1 .. v6}, Lcom/samsung/android/graphics/SemImageFilter;->native_setUniformi(JLjava/lang/String;II[I)V
...
.method protected setUpdateMargin(IIII)V
    ...
    invoke-static/range {v1 .. v6}, Lcom/samsung/android/graphics/SemImageFilter;->native_setUpdateMargin(JIIII)V
...
.method protected setupBlendFactor(Lcom/samsung/android/graphics/SemImageFilter$BlendFactor;Lcom/samsung/android/graphics/SemImageFilter$BlendFactor;)V
    ...
    invoke-static {p1}, Lcom/samsung/android/graphics/SemImageFilter$BlendFactor;->access$100(Lcom/samsung/android/graphics/SemImageFilter$BlendFactor;)F
    ...
    invoke-static {p2}, Lcom/samsung/android/graphics/SemImageFilter$BlendFactor;->access$100(Lcom/samsung/android/graphics/SemImageFilter$BlendFactor;)F
...
.method public startAnimation(Lcom/samsung/android/graphics/SemImageFilter$AnimationListener;)Lcom/samsung/android/graphics/SemImageFilter$AnimationHandle;
    ...
    new-instance v0, Lcom/samsung/android/graphics/SemImageFilter$4;

    invoke-direct {v0, p0, p1}, Lcom/samsung/android/graphics/SemImageFilter$4;-><init>(Lcom/samsung/android/graphics/SemImageFilter;Lcom/samsung/android/graphics/SemImageFilter$AnimationListener;)V

    iget-object v1, p0, Lcom/samsung/android/graphics/SemImageFilter;->mAnimationsParams:Ljava/util/LinkedHashSet;

    invoke-virtual {v1}, Ljava/util/LinkedHashSet;->size()I

    move-result v1

    new-array v1, v1, [Lcom/samsung/android/graphics/SemImageFilter$AnimationParamsBase;

    iget-object v2, p0, Lcom/samsung/android/graphics/SemImageFilter;->mAnimationsParams:Ljava/util/LinkedHashSet;
    ...
    :goto_0
    iget-object v3, p0, Lcom/samsung/android/graphics/SemImageFilter;->mAnimationsParams:Ljava/util/LinkedHashSet;
    ...
    iput-object v0, v3, Lcom/samsung/android/graphics/SemImageFilter$AnimationParamsBase;->mListener:Lcom/samsung/android/graphics/SemImageFilter$AnimationListener;

    iget-object v4, p0, Lcom/samsung/android/graphics/SemImageFilter;->mAnimationHandle:Lcom/samsung/android/graphics/SemImageFilter$AnimationHandle;

    invoke-virtual {v3}, Lcom/samsung/android/graphics/SemImageFilter$AnimationParamsBase;->getAnimator()Lcom/samsung/android/graphics/SemImageFilter$Animator;

    move-result-object v6

    iget-object v7, v3, Lcom/samsung/android/graphics/SemImageFilter$AnimationParamsBase;->mInterpolator:Landroid/animation/TimeInterpolator;

    iget-object v8, v3, Lcom/samsung/android/graphics/SemImageFilter$AnimationParamsBase;->mListener:Lcom/samsung/android/graphics/SemImageFilter$AnimationListener;

    iget-wide v9, v3, Lcom/samsung/android/graphics/SemImageFilter$AnimationParamsBase;->mDuration:J

    iget-wide v11, v3, Lcom/samsung/android/graphics/SemImageFilter$AnimationParamsBase;->mDelay:J

    move-object v5, p0

    invoke-virtual/range {v5 .. v12}, Lcom/samsung/android/graphics/SemImageFilter;->addAnimation(Lcom/samsung/android/graphics/SemImageFilter$Animator;Landroid/animation/TimeInterpolator;Lcom/samsung/android/graphics/SemImageFilter$AnimationListener;JJ)Lcom/samsung/android/graphics/SemImageFilter$AnimationHandleNode;

    move-result-object v5

    invoke-virtual {v4, v5}, Lcom/samsung/android/graphics/SemImageFilter$AnimationHandle;->add(Lcom/samsung/android/graphics/SemImageFilter$AnimationHandleNode;)V
    ...
    :cond_1
    iget-object v2, p0, Lcom/samsung/android/graphics/SemImageFilter;->mAnimationHandle:Lcom/samsung/android/graphics/SemImageFilter$AnimationHandle;
    ...
    const-string v1, "Animations have not been added or animations are being played"
