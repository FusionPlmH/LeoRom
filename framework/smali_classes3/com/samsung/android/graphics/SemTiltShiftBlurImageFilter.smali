...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;->mRadius:F

    iput v0, p0, Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;->mFocusedAreaTopY:F

    iput v0, p0, Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;->mFocusedAreaBottomY:F
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;->setRadius(F)V

    const/high16 v1, 0x3f800000    # 1.0f

    invoke-virtual {p0, v1, v0}, Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;->setFocusedAreaSize(FF)V

    return-void
.end method

.method static synthetic access$000(Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;F)V
    .locals 0
...
.method static synthetic access$100(Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;)F
    .locals 1
...
.method static synthetic access$200(Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;)F
    .locals 1
...
.method static synthetic access$300(Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;)F
    .locals 1
...
.method static synthetic access$302(Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;F)F
    .locals 0
...
.method static synthetic access$400(Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;)F
    .locals 1
...
.method static synthetic access$402(Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;F)F
    .locals 0
...
.method private calculateBlurRadiusParams(F)V
    ...
    iget-object v1, p0, Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;->mData1:[F

    iget-object v2, p0, Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;->mData2:[F

    iget-object v3, p0, Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;->mData1:[F

    array-length v3, v3

    invoke-static {v0, v1, v2, v3}, Lcom/samsung/android/graphics/SemMathUtils;->computeGaussianCoeffs(F[F[FI)I
...
.method private setupDownSampling()V
    ...
    invoke-virtual {p0, v2, v0, v1}, Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;->setSamplingRate(IFF)V

    const/4 v2, 0x1

    invoke-virtual {p0, v2, v0, v0}, Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;->setSamplingRate(IFF)V

    const/4 v2, 0x2

    invoke-virtual {p0, v2, v1, v1}, Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;->setSamplingRate(IFF)V
...
.method public setFocusedAreaSize(FF)V
    ...
    const-string v1, "Invalid parameters! Top edge must be gerater than bottom"
    ...
    invoke-virtual {p0, v0, v1}, Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;->setParam(IF)V
    ...
    invoke-virtual {p0, v0, v2}, Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;->setParam(IF)V
...
.method public setFocusedAreaSizeAnimation(FFFFJJLandroid/animation/TimeInterpolator;)V
    ...
    new-instance v11, Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter$FocusedAreaSizeAnimationParams;
    ...
    invoke-virtual {v1, v0}, Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter;->setAnimationParams(Lcom/samsung/android/graphics/SemImageFilter$AnimationParamsBase;)V
...
.method public setRadiusAnimation(FFJJLandroid/animation/TimeInterpolator;)V
    ...
    new-instance v9, Lcom/samsung/android/graphics/SemTiltShiftBlurImageFilter$RadiusAnimationParams;
