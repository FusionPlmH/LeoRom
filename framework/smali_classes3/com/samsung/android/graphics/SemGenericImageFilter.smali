...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/samsung/android/graphics/SemGenericImageFilter;->mPassNum:I

    const/16 v1, 0x10

    new-array v1, v1, [F

    iput-object v1, p0, Lcom/samsung/android/graphics/SemGenericImageFilter;->mParams:[F

    const/16 v1, 0x40

    new-array v2, v1, [F

    iput-object v2, p0, Lcom/samsung/android/graphics/SemGenericImageFilter;->mData1:[F

    new-array v1, v1, [F

    iput-object v1, p0, Lcom/samsung/android/graphics/SemGenericImageFilter;->mData2:[F
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, v1, v3}, Lcom/samsung/android/graphics/SemGenericImageFilter;->setup(I[Ljava/lang/String;[Ljava/lang/String;)V
...
.method public addAnimation(Lcom/samsung/android/graphics/SemImageFilter$Animator;Landroid/animation/TimeInterpolator;Lcom/samsung/android/graphics/SemImageFilter$AnimationListener;JJ)Lcom/samsung/android/graphics/SemImageFilter$AnimationHandleNode;
    ...
    iget v1, v0, Lcom/samsung/android/graphics/SemGenericImageFilter;->mPassNum:I
    ...
    iget-object v10, v0, Lcom/samsung/android/graphics/SemGenericImageFilter;->mFiltersSet:Lcom/samsung/android/graphics/SemImageFilterSet;

    new-instance v13, Lcom/samsung/android/graphics/SemGenericImageFilter$GenericAnimationListener;

    iget v1, v0, Lcom/samsung/android/graphics/SemGenericImageFilter;->mPassNum:I

    invoke-direct {v13, v1, v9}, Lcom/samsung/android/graphics/SemGenericImageFilter$GenericAnimationListener;-><init>(ILcom/samsung/android/graphics/SemImageFilter$AnimationListener;)V
    ...
    invoke-virtual/range {v10 .. v17}, Lcom/samsung/android/graphics/SemImageFilterSet;->addAnimation(Lcom/samsung/android/graphics/SemImageFilter$Animator;Landroid/animation/TimeInterpolator;Lcom/samsung/android/graphics/SemImageFilter$AnimationListener;JJ)Lcom/samsung/android/graphics/SemImageFilter$AnimationHandleNode;
    ...
    :cond_0
    iget-object v1, v0, Lcom/samsung/android/graphics/SemGenericImageFilter;->mFiltersSet:Lcom/samsung/android/graphics/SemImageFilterSet;
    ...
    invoke-virtual/range {v1 .. v8}, Lcom/samsung/android/graphics/SemImageFilterSet;->addAnimation(Lcom/samsung/android/graphics/SemImageFilter$Animator;Landroid/animation/TimeInterpolator;Lcom/samsung/android/graphics/SemImageFilter$AnimationListener;JJ)Lcom/samsung/android/graphics/SemImageFilter$AnimationHandleNode;
...
.method protected buildWorkerFilters()V
    ...
    invoke-virtual {v0}, Lcom/samsung/android/graphics/SemImageFilterSet;->clearFilters()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/samsung/android/graphics/SemGenericImageFilter;->mView:Landroid/view/View;
    ...
    invoke-virtual {v0, v1}, Lcom/samsung/android/graphics/SemImageFilterSet;->setView(Landroid/view/View;)V
...
.method protected getBitmapPixelColor(Ljava/lang/String;II)I
    ...
    const-string v1, "Methods is not applicable for SemImageFilterSet, use int getBitmapPixelColor(int filterId, String name, int x, int y) instead"
...
.method protected getUniformMatrix(Ljava/lang/String;II[F)V
    ...
    const-string v1, "Methods is not applicable for SemImageFilterSet, use void getUniformMatrix(int filterId, String name, int row, int col, float[] value instead"
...
.method protected getUniformf(Ljava/lang/String;II[F)V
    ...
    const-string v1, "Methods is not applicable for SemImageFilterSet, use void getUniformf(int filterId, String name, int vec, int count, float[] value) instead"
...
.method protected getUniformi(Ljava/lang/String;II[I)V
    ...
    const-string v1, "Methods is not applicable for SemImageFilterSet, use void getUniformi(int filterId, String name, int vec, int count, int[] value) instead"
...
.method protected getValue(Lcom/samsung/android/graphics/SemImageFilter$ValueIndex;)F
    ...
    const-string v1, "Methods is not applicable for SemImageFilterSet, use float getValue(int filterId, ValueIndex index) instead"
...
.method protected notifyWorkerFilters()V
    ...
    check-cast v1, Lcom/samsung/android/graphics/SemCustomFilter;
    ...
    iget-object v5, p0, Lcom/samsung/android/graphics/SemGenericImageFilter;->mParams:[F

    invoke-virtual {v1, v2, v3, v4, v5}, Lcom/samsung/android/graphics/SemCustomFilter;->setUniformfv(Ljava/lang/String;II[F)V
    ...
    iget-object v5, p0, Lcom/samsung/android/graphics/SemGenericImageFilter;->mData1:[F
    ...
    iget-object v5, p0, Lcom/samsung/android/graphics/SemGenericImageFilter;->mData2:[F
...
.method protected setup(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v1, p0, Lcom/samsung/android/graphics/SemGenericImageFilter;->mVert:[Ljava/lang/String;
