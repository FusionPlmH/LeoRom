...
.method public addAnimation(ILcom/samsung/android/graphics/SemImageFilter$Animator;Landroid/animation/TimeInterpolator;Lcom/samsung/android/graphics/SemImageFilter$AnimationListener;JJ)Lcom/samsung/android/graphics/SemImageFilter$AnimationHandleNode;
    ...
    iget-object v2, v0, Lcom/samsung/android/graphics/SemImageFilterSet;->mImageFilters:Ljava/util/ArrayList;
    ...
    invoke-virtual/range {v3 .. v10}, Lcom/samsung/android/graphics/SemImageFilter;->addAnimation(Lcom/samsung/android/graphics/SemImageFilter$Animator;Landroid/animation/TimeInterpolator;Lcom/samsung/android/graphics/SemImageFilter$AnimationListener;JJ)Lcom/samsung/android/graphics/SemImageFilter$AnimationHandleNode;
    ...
    const-string v3, "Filter with this ID does not listed in set!!!"
...
.method public addAnimation(Lcom/samsung/android/graphics/SemImageFilter$Animator;Landroid/animation/TimeInterpolator;Lcom/samsung/android/graphics/SemImageFilter$AnimationListener;JJ)Lcom/samsung/android/graphics/SemImageFilter$AnimationHandleNode;
    ...
    new-instance v0, Lcom/samsung/android/graphics/SemImageFilter$AnimationHandleNode;

    invoke-direct {v0}, Lcom/samsung/android/graphics/SemImageFilter$AnimationHandleNode;-><init>()V

    move-object v1, p0

    iget-object v2, v1, Lcom/samsung/android/graphics/SemImageFilterSet;->mImageFilters:Ljava/util/ArrayList;
    ...
    invoke-virtual/range {v4 .. v11}, Lcom/samsung/android/graphics/SemImageFilter;->addAnimation(Lcom/samsung/android/graphics/SemImageFilter$Animator;Landroid/animation/TimeInterpolator;Lcom/samsung/android/graphics/SemImageFilter$AnimationListener;JJ)Lcom/samsung/android/graphics/SemImageFilter$AnimationHandleNode;
    ...
    invoke-virtual {v4, v5}, Lcom/samsung/android/graphics/SemImageFilter$AnimationHandleNode;->getAnimationToken(I)Lcom/samsung/android/graphics/SemImageFilter$AnimationToken;

    move-result-object v5

    invoke-virtual {v0, v5}, Lcom/samsung/android/graphics/SemImageFilter$AnimationHandleNode;->addAnimationToken(Lcom/samsung/android/graphics/SemImageFilter$AnimationToken;)V

    :cond_0
    goto :goto_0

    :cond_1
    invoke-virtual {v0}, Lcom/samsung/android/graphics/SemImageFilter$AnimationHandleNode;->isEmpty()Z
...
.method public clone()Lcom/samsung/android/graphics/SemImageFilterSet;
    ...
    iput-object v1, v0, Lcom/samsung/android/graphics/SemImageFilterSet;->mImageFilters:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v2}, Lcom/samsung/android/graphics/SemImageFilterSet;->addFilter(Lcom/samsung/android/graphics/SemImageFilter;)V
...
.method protected getBitmapPixelColor(ILjava/lang/String;II)I
    ...
    const-string v1, "Filter with this ID does not listed in set!!!"
...
.method protected getBitmapPixelColor(Ljava/lang/String;II)I
    ...
    const-string v1, "Methods is not applicable for SemImageFilterSet, use int getBitmapPxelColor(int filterId, String name, int x, int y)) instead"
...
.method protected getUpdateMargin([I)V
    ...
    iget-object v4, p0, Lcom/samsung/android/graphics/SemImageFilterSet;->mImageFilters:Ljava/util/ArrayList;

    invoke-virtual {v4, v0}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Lcom/samsung/android/graphics/SemImageFilter;

    invoke-virtual {v4, v3}, Lcom/samsung/android/graphics/SemImageFilter;->getUpdateMargin([I)V
