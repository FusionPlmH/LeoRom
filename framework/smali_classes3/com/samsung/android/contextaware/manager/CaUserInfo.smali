...
.method public static getInstance()Lcom/samsung/android/contextaware/manager/CaUserInfo;
    ...
    const-class v0, Lcom/samsung/android/contextaware/manager/CaUserInfo;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/samsung/android/contextaware/manager/CaUserInfo;->instance:Lcom/samsung/android/contextaware/manager/CaUserInfo;

    if-nez v1, :cond_0

    new-instance v1, Lcom/samsung/android/contextaware/manager/CaUserInfo;

    invoke-direct {v1}, Lcom/samsung/android/contextaware/manager/CaUserInfo;-><init>()V

    sput-object v1, Lcom/samsung/android/contextaware/manager/CaUserInfo;->instance:Lcom/samsung/android/contextaware/manager/CaUserInfo;
