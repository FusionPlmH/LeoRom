.class public Lcom/samsung/android/globalactions/util/BixbyHandler;
...
.method public constructor <init>(Landroid/content/Context;Lcom/samsung/android/globalactions/util/LogWrapper;)V
    ...
    iput-object v0, p0, Lcom/samsung/android/globalactions/util/BixbyHandler;->TAG:Ljava/lang/String;

    const-string v0, "com.samsung.android.bixby.settings.action.POWER_KEY_SCREEN"

    iput-object v0, p0, Lcom/samsung/android/globalactions/util/BixbyHandler;->BIXBY_ACTION:Ljava/lang/String;

    const-string v0, "com.samsung.android.bixby.agent"

    iput-object v0, p0, Lcom/samsung/android/globalactions/util/BixbyHandler;->BIXBY_PACKAGE:Ljava/lang/String;

    const-string v0, "BIXBY_KEY_FW_VERSION"

    iput-object v0, p0, Lcom/samsung/android/globalactions/util/BixbyHandler;->COG_BIXBYVERSION:Ljava/lang/String;

    const-string v0, "RESULT_BY_POWER"

    iput-object v0, p0, Lcom/samsung/android/globalactions/util/BixbyHandler;->COG_BIXBY_RESULT_BY_POWER:Ljava/lang/String;

    const-string v0, "KEYEVENT"

    iput-object v0, p0, Lcom/samsung/android/globalactions/util/BixbyHandler;->COG_KEYEVENT:Ljava/lang/String;

    const/4 v0, 0x1

    iput v0, p0, Lcom/samsung/android/globalactions/util/BixbyHandler;->COG_BIXBY_RESULT_SUCCESS:I

    const/4 v0, 0x6

    iput v0, p0, Lcom/samsung/android/globalactions/util/BixbyHandler;->DEVICEID_POWERKEY:I

    iput-object p1, p0, Lcom/samsung/android/globalactions/util/BixbyHandler;->mContext:Landroid/content/Context;

    iput-object p2, p0, Lcom/samsung/android/globalactions/util/BixbyHandler;->mLogWrapper:Lcom/samsung/android/globalactions/util/LogWrapper;
...
.method public startBixbyGlobalSettingsActivity(Ljava/lang/String;I)V
    ...
    iget-object v1, p0, Lcom/samsung/android/globalactions/util/BixbyHandler;->mLogWrapper:Lcom/samsung/android/globalactions/util/LogWrapper;
    ...
    iget-object v1, p0, Lcom/samsung/android/globalactions/util/BixbyHandler;->mContext:Landroid/content/Context;
...
.method public startBixbyVoiceService()V
    ...
    iget-object v3, p0, Lcom/samsung/android/globalactions/util/BixbyHandler;->mContext:Landroid/content/Context;
    ...
    iget-object v3, p0, Lcom/samsung/android/globalactions/util/BixbyHandler;->mLogWrapper:Lcom/samsung/android/globalactions/util/LogWrapper;
