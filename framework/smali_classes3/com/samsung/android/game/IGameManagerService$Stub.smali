...
.field static final TRANSACTION_getGamePkgDataIncServer:I = 0x11

.field static final TRANSACTION_getMode:I = 0x7

.field static final TRANSACTION_getSosPolicy:I = 0x12

.field static final TRANSACTION_getTopActivityName:I = 0x13
...
.field static final TRANSACTION_setPackageConfigurations:I = 0x14

.field static final TRANSACTION_setPeformanceMode:I = 0x15
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, v1, v3}, Lcom/samsung/android/game/IGameManagerService$Stub;->setPeformanceMode(ILjava/lang/String;)Z
    ...
    sget-object v1, Lcom/samsung/android/game/SemPackageConfiguration;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, v1}, Landroid/os/Parcel;->createTypedArrayList(Landroid/os/Parcelable$Creator;)Ljava/util/ArrayList;

    move-result-object v1

    invoke-virtual {p0, v1}, Lcom/samsung/android/game/IGameManagerService$Stub;->setPackageConfigurations(Ljava/util/List;)Z
    ...
    invoke-virtual {p0, v1}, Lcom/samsung/android/game/IGameManagerService$Stub;->getSosPolicy(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lcom/samsung/android/game/IGameManagerService$Stub;->getGamePkgDataIncServer(Ljava/lang/String;)Lcom/samsung/android/game/GamePkgData;
    ...
    invoke-virtual {v4, p3, v2}, Lcom/samsung/android/game/GamePkgData;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-virtual {p0, v1}, Lcom/samsung/android/game/IGameManagerService$Stub;->cancelDeathRestart(Landroid/os/IBinder;)V
    ...
    :goto_1
    invoke-virtual {p0, v3, v1}, Lcom/samsung/android/game/IGameManagerService$Stub;->requestDeathRestart(Landroid/os/IBinder;Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, v1, v3}, Lcom/samsung/android/game/IGameManagerService$Stub;->requestWithJson(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_3
    invoke-virtual {p0, v1, v3}, Lcom/samsung/android/game/IGameManagerService$Stub;->notifyMultiWindowStyleChangedLocked(Landroid/content/ComponentName;Z)V
    ...
    invoke-virtual {p0, v1, v4}, Lcom/samsung/android/game/IGameManagerService$Stub;->initGameManager(ILjava/util/Map;)Z
    ...
    :cond_4
    invoke-virtual {p0, v1, v3}, Lcom/samsung/android/game/IGameManagerService$Stub;->addGame(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p0, v1}, Lcom/samsung/android/game/IGameManagerService$Stub;->setMode(I)Z
    ...
    invoke-static {v1}, Lcom/samsung/android/game/IGameManagerCallback$Stub;->asInterface(Landroid/os/IBinder;)Lcom/samsung/android/game/IGameManagerCallback;

    move-result-object v1

    invoke-virtual {p0, v1}, Lcom/samsung/android/game/IGameManagerService$Stub;->unregisterCallback(Lcom/samsung/android/game/IGameManagerCallback;)Z
    ...
    invoke-virtual {p0, v1}, Lcom/samsung/android/game/IGameManagerService$Stub;->registerCallback(Lcom/samsung/android/game/IGameManagerCallback;)Z
    ...
    invoke-virtual {p0, v1}, Lcom/samsung/android/game/IGameManagerService$Stub;->identifyGamePackage(Ljava/lang/String;)I
