...
.field private static final METADATA_COVER_MODE:Ljava/lang/String; = "com.sec.android.sdk.cover.MODE"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-wide v2, p0, Lcom/android/internal/policy/PhoneWindow;->mBackgroundFadeDurationMillis:J

    iput-object v1, p0, Lcom/android/internal/policy/PhoneWindow;->mActivityCurrentConfig:Landroid/content/res/Configuration;

    const/4 v1, -0x2

    iput v1, p0, Lcom/android/internal/policy/PhoneWindow;->mLastRequestedOrientation:I
...
.method private installDecor()V
    ...
    iget-object v6, p0, Lcom/android/internal/policy/PhoneWindow;->mContentParent:Landroid/view/ViewGroup;

    invoke-virtual {v4, v3, v6}, Landroid/transition/TransitionInflater;->inflateTransitionManager(ILandroid/view/ViewGroup;)Landroid/transition/TransitionManager;

    move-result-object v6

    iput-object v6, p0, Lcom/android/internal/policy/PhoneWindow;->mTransitionManager:Landroid/transition/TransitionManager;
    ...
    :cond_12
    :goto_6
    iget-object v3, p0, Lcom/android/internal/policy/PhoneWindow;->mEnterTransition:Landroid/transition/Transition;

    const/16 v4, 0x1c

    invoke-direct {p0, v3, v5, v4}, Lcom/android/internal/policy/PhoneWindow;->getTransition(Landroid/transition/Transition;Landroid/transition/Transition;I)Landroid/transition/Transition;

    move-result-object v3

    iput-object v3, p0, Lcom/android/internal/policy/PhoneWindow;->mEnterTransition:Landroid/transition/Transition;

    iget-object v3, p0, Lcom/android/internal/policy/PhoneWindow;->mReturnTransition:Landroid/transition/Transition;

    sget-object v4, Lcom/android/internal/policy/PhoneWindow;->USE_DEFAULT_TRANSITION:Landroid/transition/Transition;

    const/16 v6, 0x28

    invoke-direct {p0, v3, v4, v6}, Lcom/android/internal/policy/PhoneWindow;->getTransition(Landroid/transition/Transition;Landroid/transition/Transition;I)Landroid/transition/Transition;

    move-result-object v3

    iput-object v3, p0, Lcom/android/internal/policy/PhoneWindow;->mReturnTransition:Landroid/transition/Transition;

    iget-object v3, p0, Lcom/android/internal/policy/PhoneWindow;->mExitTransition:Landroid/transition/Transition;
    ...
    iget-object v3, p0, Lcom/android/internal/policy/PhoneWindow;->mReenterTransition:Landroid/transition/Transition;
    ...
    iget-object v3, p0, Lcom/android/internal/policy/PhoneWindow;->mSharedElementEnterTransition:Landroid/transition/Transition;
    ...
    iget-object v3, p0, Lcom/android/internal/policy/PhoneWindow;->mSharedElementReturnTransition:Landroid/transition/Transition;
    ...
    iget-object v3, p0, Lcom/android/internal/policy/PhoneWindow;->mSharedElementExitTransition:Landroid/transition/Transition;
    ...
    iget-object v3, p0, Lcom/android/internal/policy/PhoneWindow;->mSharedElementReenterTransition:Landroid/transition/Transition;

    sget-object v4, Lcom/android/internal/policy/PhoneWindow;->USE_DEFAULT_TRANSITION:Landroid/transition/Transition;

    const/16 v5, 0x2b

    invoke-direct {p0, v3, v4, v5}, Lcom/android/internal/policy/PhoneWindow;->getTransition(Landroid/transition/Transition;Landroid/transition/Transition;I)Landroid/transition/Transition;
    ...
    iget-object v3, p0, Lcom/android/internal/policy/PhoneWindow;->mAllowEnterTransitionOverlap:Ljava/lang/Boolean;
    ...
    iput-object v3, p0, Lcom/android/internal/policy/PhoneWindow;->mAllowEnterTransitionOverlap:Ljava/lang/Boolean;

    :cond_13
    iget-object v3, p0, Lcom/android/internal/policy/PhoneWindow;->mAllowReturnTransitionOverlap:Ljava/lang/Boolean;
    ...
    iput-object v3, p0, Lcom/android/internal/policy/PhoneWindow;->mAllowReturnTransitionOverlap:Ljava/lang/Boolean;
    ...
    :cond_15
    iget-object v3, p0, Lcom/android/internal/policy/PhoneWindow;->mSharedElementsUseOverlay:Ljava/lang/Boolean;
    ...
    iput-object v2, p0, Lcom/android/internal/policy/PhoneWindow;->mSharedElementsUseOverlay:Ljava/lang/Boolean;
    ...
    iput v3, v0, Landroid/view/WindowManager$LayoutParams;->coverMode:I
...
.method public static sendCloseSystemWindows(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, v1}, Lcom/samsung/android/multidisplay/MultiDisplayManager;->closeSystemDialogs(Ljava/lang/String;I)V

    :cond_0
    return-void
.end method

.method private setForceLightNavigationBarFlag(Z)V
    .locals 3
...
.method public dispatchRequestedOrientation(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/policy/DecorView;->dispatchRequestedOrientation(I)V
...
.method protected dispatchWindowAttributesChanged(Landroid/view/WindowManager$LayoutParams;)V
    ...
    invoke-virtual {v1}, Lcom/android/internal/policy/DecorView;->isDesktopMode()Z
    ...
    invoke-virtual {v4}, Lcom/android/internal/policy/DecorView;->getMultiWindowDecorSupport()Lcom/android/internal/policy/MultiWindowDecorSupport;

    move-result-object v4

    invoke-virtual {v4}, Lcom/android/internal/policy/MultiWindowDecorSupport;->isFullScreenFreeform()Z

    move-result v5

    invoke-virtual {v4}, Lcom/android/internal/policy/MultiWindowDecorSupport;->isFullWindow()Z
    ...
    invoke-virtual {v7}, Lcom/android/internal/policy/DecorView;->getSystemUiVisibility()I

    move-result v7

    iget-object v8, p0, Lcom/android/internal/policy/PhoneWindow;->mDecor:Lcom/android/internal/policy/DecorView;

    invoke-virtual {v8}, Lcom/android/internal/policy/DecorView;->getWindowSystemUiVisibility()I

    move-result v8

    or-int/2addr v7, v8

    invoke-virtual {v4}, Lcom/android/internal/policy/MultiWindowDecorSupport;->isTransientShowingDecorCaption()Z

    move-result v8

    if-nez v8, :cond_3

    invoke-virtual {v4, v7}, Lcom/android/internal/policy/MultiWindowDecorSupport;->isImmersiveMode(I)Z
    ...
    invoke-virtual {v2, v1}, Lcom/android/internal/widget/DecorCaptionView;->onConfigurationChanged(Z)V

    iget-object v2, p0, Lcom/android/internal/policy/PhoneWindow;->mDecor:Lcom/android/internal/policy/DecorView;

    invoke-virtual {v2, v1}, Lcom/android/internal/policy/DecorView;->enableCaption(Z)V
...
.method protected generateDecor(I)Lcom/android/internal/policy/DecorView;
    ...
    :cond_1
    new-instance v3, Lcom/android/internal/policy/DecorContext;

    invoke-virtual {p0}, Lcom/android/internal/policy/PhoneWindow;->getContext()Landroid/content/Context;

    move-result-object v4

    invoke-direct {v3, v1, v4}, Lcom/android/internal/policy/DecorContext;-><init>(Landroid/content/Context;Landroid/content/Context;)V
...
.method protected generateLayout(Lcom/android/internal/policy/DecorView;)Landroid/view/ViewGroup;
    ...
    invoke-virtual {v1, v4, v6}, Lcom/android/internal/policy/PhoneWindow;->setFlags(II)V

    goto :goto_0

    :cond_0
    invoke-virtual {v1, v5, v6}, Lcom/android/internal/policy/PhoneWindow;->setFlags(II)V
    ...
    invoke-virtual {v1, v7}, Lcom/android/internal/policy/PhoneWindow;->requestFeature(I)Z
    ...
    invoke-virtual {v3, v9, v4}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z
    ...
    invoke-virtual {v1, v9, v8}, Lcom/android/internal/policy/PhoneWindow;->setFlags(II)V
    ...
    invoke-virtual {v1, v8, v9}, Lcom/android/internal/policy/PhoneWindow;->setFlags(II)V
    ...
    iget-object v9, v1, Lcom/android/internal/policy/PhoneWindow;->mMinWidthMajor:Landroid/util/TypedValue;

    invoke-virtual {v3, v8, v9}, Landroid/content/res/TypedArray;->getValue(ILandroid/util/TypedValue;)Z

    const/16 v8, 0x14

    iget-object v9, v1, Lcom/android/internal/policy/PhoneWindow;->mMinWidthMinor:Landroid/util/TypedValue;
    ...
    iget-object v8, v1, Lcom/android/internal/policy/PhoneWindow;->mFixedWidthMajor:Landroid/util/TypedValue;
    ...
    iput-object v8, v1, Lcom/android/internal/policy/PhoneWindow;->mFixedWidthMajor:Landroid/util/TypedValue;

    :cond_d
    const/16 v8, 0x37

    iget-object v9, v1, Lcom/android/internal/policy/PhoneWindow;->mFixedWidthMajor:Landroid/util/TypedValue;
    ...
    iget-object v8, v1, Lcom/android/internal/policy/PhoneWindow;->mFixedWidthMinor:Landroid/util/TypedValue;
    ...
    iput-object v8, v1, Lcom/android/internal/policy/PhoneWindow;->mFixedWidthMinor:Landroid/util/TypedValue;

    :cond_f
    const/16 v8, 0x38

    iget-object v9, v1, Lcom/android/internal/policy/PhoneWindow;->mFixedWidthMinor:Landroid/util/TypedValue;
    ...
    iget-object v8, v1, Lcom/android/internal/policy/PhoneWindow;->mFixedHeightMajor:Landroid/util/TypedValue;
    ...
    iput-object v8, v1, Lcom/android/internal/policy/PhoneWindow;->mFixedHeightMajor:Landroid/util/TypedValue;

    :cond_11
    const/16 v8, 0x35

    iget-object v9, v1, Lcom/android/internal/policy/PhoneWindow;->mFixedHeightMajor:Landroid/util/TypedValue;
    ...
    iget-object v8, v1, Lcom/android/internal/policy/PhoneWindow;->mFixedHeightMinor:Landroid/util/TypedValue;
    ...
    iput-object v8, v1, Lcom/android/internal/policy/PhoneWindow;->mFixedHeightMinor:Landroid/util/TypedValue;

    :cond_13
    const/16 v8, 0x36

    iget-object v9, v1, Lcom/android/internal/policy/PhoneWindow;->mFixedHeightMinor:Landroid/util/TypedValue;
    ...
    iput-boolean v8, v1, Lcom/android/internal/policy/PhoneWindow;->mIsTranslucent:Z
    ...
    invoke-virtual {v1, v5}, Lcom/android/internal/policy/PhoneWindow;->hasFeature(I)Z

    move-result v15

    if-eqz v15, :cond_1b

    invoke-virtual {v1, v7}, Lcom/android/internal/policy/PhoneWindow;->hasFeature(I)Z
    ...
    :cond_1c
    invoke-virtual {v1, v5}, Lcom/android/internal/policy/PhoneWindow;->setNeedsMenuKey(I)V

    goto :goto_9

    :cond_1d
    :goto_8
    invoke-virtual {v1, v7}, Lcom/android/internal/policy/PhoneWindow;->setNeedsMenuKey(I)V

    :goto_9
    iget-boolean v10, v1, Lcom/android/internal/policy/PhoneWindow;->mForcedStatusBarColor:Z
    ...
    invoke-virtual {v3, v10, v5}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result v5

    iput v5, v1, Lcom/android/internal/policy/PhoneWindow;->mStatusBarColor:I

    :cond_1e
    iget-boolean v5, v1, Lcom/android/internal/policy/PhoneWindow;->mForcedNavigationBarColor:Z
    ...
    iput v5, v1, Lcom/android/internal/policy/PhoneWindow;->mNavigationBarColor:I
    ...
    iput v5, v1, Lcom/android/internal/policy/PhoneWindow;->mNavigationBarDividerColor:I
    ...
    iget v7, v1, Lcom/android/internal/policy/PhoneWindow;->mDeviceDefaultNavigationBarColor:I
    ...
    :goto_a
    iget v0, v1, Lcom/android/internal/policy/PhoneWindow;->mSettingsNavigationBarColor:I
    ...
    :cond_22
    iget v0, v1, Lcom/android/internal/policy/PhoneWindow;->mNavigationBarColor:I

    iget v4, v1, Lcom/android/internal/policy/PhoneWindow;->mDefaultNavigationBarColor:I
    ...
    :cond_23
    sget-boolean v0, Lcom/samsung/android/rune/CoreRune;->FW_SET_DRAWS_SYSTEM_BAR_BACKGROUNDS_IN_FACTORY_MODE:Z
    ...
    invoke-virtual {v1, v4, v0}, Lcom/android/internal/policy/PhoneWindow;->setFlags(II)V
    ...
    invoke-virtual {v4, v7, v0, v10}, Landroid/content/res/Resources$Theme;->resolveAttribute(ILandroid/util/TypedValue;Z)Z
    ...
    iget v7, v1, Lcom/android/internal/policy/PhoneWindow;->mNavigationBarColor:I

    iget v10, v1, Lcom/android/internal/policy/PhoneWindow;->mDefaultNavigationBarColor:I

    if-ne v7, v10, :cond_2b

    iget-boolean v7, v1, Lcom/android/internal/policy/PhoneWindow;->mForcedNavigationBarColor:Z

    if-nez v7, :cond_2b

    iput v4, v1, Lcom/android/internal/policy/PhoneWindow;->mNavigationBarColor:I

    invoke-direct {v1, v4}, Lcom/android/internal/policy/PhoneWindow;->needLightNavigationBar(I)Z
    ...
    :cond_2b
    iput v4, v1, Lcom/android/internal/policy/PhoneWindow;->mDefaultNavigationBarColor:I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget v4, v5, Landroid/view/WindowManager$LayoutParams;->softInputMode:I
    ...
    :goto_f
    iget v0, v5, Landroid/view/WindowManager$LayoutParams;->windowAnimations:I
    ...
    iget v0, v1, Lcom/android/internal/policy/PhoneWindow;->mBackgroundResource:I
    ...
    iget v4, v1, Lcom/android/internal/policy/PhoneWindow;->mBackgroundResource:I

    invoke-virtual {v0, v4}, Lcom/android/internal/policy/DecorView;->setLastBackgroundResource(I)V
    ...
    invoke-virtual {v1, v7}, Lcom/android/internal/policy/PhoneWindow;->setCloseOnSwipeEnabled(Z)V
    ...
    invoke-virtual {v7, v10, v4, v2}, Landroid/content/res/Resources$Theme;->resolveAttribute(ILandroid/util/TypedValue;Z)Z
    ...
    invoke-virtual {v1, v2}, Lcom/android/internal/policy/PhoneWindow;->removeFeature(I)V
    ...
    invoke-virtual {v4, v7, v2, v10}, Landroid/content/res/Resources$Theme;->resolveAttribute(ILandroid/util/TypedValue;Z)Z
    ...
    iget-object v7, v1, Lcom/android/internal/policy/PhoneWindow;->mLayoutInflater:Landroid/view/LayoutInflater;

    invoke-virtual {v4, v7, v2}, Lcom/android/internal/policy/DecorView;->onResourcesLoaded(Landroid/view/LayoutInflater;I)V
    ...
    invoke-direct {v1, v4}, Lcom/android/internal/policy/PhoneWindow;->registerSwipeCallbacks(Landroid/view/ViewGroup;)V
    ...
    iget v7, v1, Lcom/android/internal/policy/PhoneWindow;->mBackgroundResource:I
    ...
    iget v10, v1, Lcom/android/internal/policy/PhoneWindow;->mBackgroundResource:I
    ...
    :cond_46
    iget-object v7, v1, Lcom/android/internal/policy/PhoneWindow;->mBackgroundDrawable:Landroid/graphics/drawable/Drawable;

    :goto_15
    iget-object v10, v1, Lcom/android/internal/policy/PhoneWindow;->mDecor:Lcom/android/internal/policy/DecorView;

    invoke-virtual {v10, v7}, Lcom/android/internal/policy/DecorView;->setWindowBackground(Landroid/graphics/drawable/Drawable;)V

    iget v10, v1, Lcom/android/internal/policy/PhoneWindow;->mFrameResource:I
    ...
    invoke-virtual {v10, v0}, Lcom/android/internal/policy/DecorView;->setWindowFrame(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v10, v0}, Lcom/android/internal/policy/DecorView;->setElevation(F)V

    iget-object v0, v1, Lcom/android/internal/policy/PhoneWindow;->mDecor:Lcom/android/internal/policy/DecorView;

    iget-boolean v10, v1, Lcom/android/internal/policy/PhoneWindow;->mClipToOutline:Z

    invoke-virtual {v0, v10}, Lcom/android/internal/policy/DecorView;->setClipToOutline(Z)V
...
.method public getDeviceDefaultNavBarColor()I
    .locals 1
...
.method public setNavigationBarColor(I)V
    ...
    iget v0, p0, Lcom/android/internal/policy/PhoneWindow;->mDefaultNavigationBarColor:I

    if-eq p1, v0, :cond_0

    invoke-direct {p0, v2}, Lcom/android/internal/policy/PhoneWindow;->setForceLightNavigationBarFlag(Z)V

    goto :goto_0

    :cond_0
    invoke-direct {p0, p1}, Lcom/android/internal/policy/PhoneWindow;->needLightNavigationBar(I)Z

    move-result v0

    invoke-direct {p0, v0}, Lcom/android/internal/policy/PhoneWindow;->setForceLightNavigationBarFlag(Z)V
...
.method public setSettingsNavBarColor(I)V
    .locals 0
...
.method public updateDefaultNavigationBarColor()V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/internal/policy/DecorView;->updateColorViews(Landroid/view/WindowInsets;Z)Landroid/view/WindowInsets;
    ...
    invoke-direct {p0, v1}, Lcom/android/internal/policy/PhoneWindow;->setForceLightNavigationBarFlag(Z)V
