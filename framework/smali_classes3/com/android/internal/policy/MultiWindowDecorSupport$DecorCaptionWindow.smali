...
.method public constructor <init>(Lcom/android/internal/policy/MultiWindowDecorSupport;)V
    ...
    invoke-static {p1}, Lcom/android/internal/policy/MultiWindowDecorSupport;->access$1000(Lcom/android/internal/policy/MultiWindowDecorSupport;)Lcom/android/internal/policy/PhoneWindow;
    ...
    iput-object p1, p0, Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;->mWindowManager:Landroid/view/WindowManager;

    return-void
.end method

.method static synthetic access$1100(Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;->addWindow()V

    return-void
.end method

.method static synthetic access$800(Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;)Lcom/android/internal/policy/DecorView;
    .locals 1
...
.method static synthetic access$900(Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;)Landroid/view/Window;
    .locals 1
...
.method private addWindow()V
    ...
    iget-object v1, p0, Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;->mContext:Landroid/content/Context;

    invoke-direct {v0, v1}, Lcom/android/internal/policy/PhoneWindow;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;->mCaptionWindow:Landroid/view/Window;
    ...
    iget-object v3, p0, Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;->mWindowManager:Landroid/view/WindowManager;
    ...
    iget-object v3, p0, Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;->this$0:Lcom/android/internal/policy/MultiWindowDecorSupport;

    invoke-static {v3}, Lcom/android/internal/policy/MultiWindowDecorSupport;->access$1000(Lcom/android/internal/policy/MultiWindowDecorSupport;)Lcom/android/internal/policy/PhoneWindow;
    ...
    iget-object v3, p0, Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;->mDecorView:Lcom/android/internal/policy/DecorView;

    invoke-virtual {v1, v3}, Lcom/android/internal/policy/DecorView;->requestTransparentRegion(Landroid/view/View;)V
    ...
    iput-boolean v2, p0, Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;->mWindowAdded:Z
...
.method private generateLayoutParam()Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-static {v2}, Lcom/android/internal/policy/MultiWindowDecorSupport;->access$1000(Lcom/android/internal/policy/MultiWindowDecorSupport;)Lcom/android/internal/policy/PhoneWindow;
...
.method public onWindowDismissed(ZZ)V
    ...
    invoke-static {v0}, Lcom/android/internal/policy/MultiWindowDecorSupport;->access$1000(Lcom/android/internal/policy/MultiWindowDecorSupport;)Lcom/android/internal/policy/PhoneWindow;
