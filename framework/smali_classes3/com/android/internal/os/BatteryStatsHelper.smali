...
.method private addPowerSharingUsage()V
    .locals 10
    ...
    invoke-virtual {v0, v1, v2, v3}, Landroid/os/BatteryStats;->getTxPowerSharingTime(JI)J
    ...
    invoke-virtual {v2, v3}, Landroid/os/BatteryStats;->getTxSharingDrainCount(I)J
    ...
    sget-object v5, Lcom/android/internal/os/BatterySipper$DrainType;->POWERSHARING:Lcom/android/internal/os/BatterySipper$DrainType;
...
.method private processAppUsage(Landroid/util/SparseArray;)V
    ...
    iget-object v8, v0, Lcom/android/internal/os/BatteryStatsHelper;->mGpuPowerCalculator:Lcom/android/internal/os/PowerCalculator;
...
.method private processMiscUsage()V
    ...
    invoke-direct {p0}, Lcom/android/internal/os/BatteryStatsHelper;->addPowerSharingUsage()V
...
.method public refreshStats(ILandroid/util/SparseArray;JJ)V
    ...
    iget-object v1, v0, Lcom/android/internal/os/BatteryStatsHelper;->mGpuPowerCalculator:Lcom/android/internal/os/PowerCalculator;

    if-nez v1, :cond_3

    new-instance v1, Lcom/android/internal/os/GpuPowerCalculator;

    iget-object v2, v0, Lcom/android/internal/os/BatteryStatsHelper;->mPowerProfile:Lcom/android/internal/os/PowerProfile;

    invoke-direct {v1, v2}, Lcom/android/internal/os/GpuPowerCalculator;-><init>(Lcom/android/internal/os/PowerProfile;)V

    iput-object v1, v0, Lcom/android/internal/os/BatteryStatsHelper;->mGpuPowerCalculator:Lcom/android/internal/os/PowerCalculator;
...
.method public removeHiddenBatterySippers(Ljava/util/List;)D
    ...
    sget-object v6, Lcom/android/internal/os/BatterySipper$DrainType;->POWERSHARING:Lcom/android/internal/os/BatterySipper$DrainType;
...
.method public shouldHideSipper(Lcom/android/internal/os/BatterySipper;)Z
    ...
    sget-object v1, Lcom/android/internal/os/BatterySipper$DrainType;->POWERSHARING:Lcom/android/internal/os/BatterySipper$DrainType;
