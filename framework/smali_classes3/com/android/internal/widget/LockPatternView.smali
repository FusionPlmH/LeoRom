...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iget v7, p0, Lcom/android/internal/widget/LockPatternView;->mRegularColor:I

    iput v7, p0, Lcom/android/internal/widget/LockPatternView;->mOriginRegularColor:I

    iget v7, p0, Lcom/android/internal/widget/LockPatternView;->mSuccessColor:I

    iput v7, p0, Lcom/android/internal/widget/LockPatternView;->mOriginSuccessColor:I

    iput v5, p0, Lcom/android/internal/widget/LockPatternView;->mOriginPathColor:I

    iput-boolean v0, p0, Lcom/android/internal/widget/LockPatternView;->mUseActivateAlpha:Z

    const/4 v7, 0x7

    iget-boolean v8, p0, Lcom/android/internal/widget/LockPatternView;->mUseActivateAlpha:Z

    invoke-virtual {v3, v7, v8}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v7

    iput-boolean v7, p0, Lcom/android/internal/widget/LockPatternView;->mUseActivateAlpha:Z
    ...
    iput v7, p0, Lcom/android/internal/widget/LockPatternView;->mActivateAlpha:F

    const/4 v7, 0x5

    iget v8, p0, Lcom/android/internal/widget/LockPatternView;->mActivateAlpha:F
...
.method static synthetic access$600(Lcom/android/internal/widget/LockPatternView;)F
    .locals 1
...
.method static synthetic access$700(Lcom/android/internal/widget/LockPatternView;F)I
    .locals 1
...
.method static synthetic access$800(Lcom/android/internal/widget/LockPatternView;F)I
    .locals 1
...
.method private startCellStateAnimationHw(Lcom/android/internal/widget/LockPatternView$CellState;FFFFFFJJLandroid/view/animation/Interpolator;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v9, v0}, Lcom/android/internal/widget/LockPatternView;->getCenterYForRow(I)F
    ...
    invoke-virtual {v9, v0}, Lcom/android/internal/widget/LockPatternView;->getCenterXForColumn(I)F
    ...
    iget-boolean v0, v9, Lcom/android/internal/widget/LockPatternView;->mUseActivateAlpha:Z
...
.method protected handleActionMove(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {v0, v11}, Lcom/android/internal/widget/LockPatternView;->getCenterYForRow(I)F
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v7, v6}, Lcom/android/internal/widget/LockPatternView;->getCenterXForColumn(I)F

    move-result v6

    iget v14, v5, Lcom/android/internal/widget/LockPatternView$Cell;->row:I

    invoke-virtual {v7, v14}, Lcom/android/internal/widget/LockPatternView;->getCenterYForRow(I)F
    ...
    invoke-virtual {v7, v12}, Lcom/android/internal/widget/LockPatternView;->getCenterXForColumn(I)F
    ...
    invoke-virtual {v7, v13}, Lcom/android/internal/widget/LockPatternView;->getCenterYForRow(I)F
    ...
    :cond_5
    iget-boolean v0, v7, Lcom/android/internal/widget/LockPatternView;->mUseActivateAlpha:Z
    ...
    aget-boolean v5, v0, v19

    iget v6, v12, Lcom/android/internal/widget/LockPatternView$CellState;->alpha:F
    ...
    iget v2, v1, Lcom/android/internal/widget/LockPatternView$Cell;->row:I
    ...
    iget-object v2, v7, Lcom/android/internal/widget/LockPatternView;->mLineFadeStart:[J
    ...
    invoke-virtual {v7, v2}, Lcom/android/internal/widget/LockPatternView;->getCenterXForColumn(I)F

    move-result v2

    iget v3, v1, Lcom/android/internal/widget/LockPatternView$Cell;->row:I

    invoke-virtual {v7, v3}, Lcom/android/internal/widget/LockPatternView;->getCenterYForRow(I)F

    move-result v3

    if-eqz v0, :cond_e

    iget-object v4, v7, Lcom/android/internal/widget/LockPatternView;->mLineFadeStart:[J
    ...
    iget-object v11, v7, Lcom/android/internal/widget/LockPatternView;->mCellStates:[[Lcom/android/internal/widget/LockPatternView$CellState;

    iget v12, v1, Lcom/android/internal/widget/LockPatternView$Cell;->row:I

    aget-object v11, v11, v12

    iget v12, v1, Lcom/android/internal/widget/LockPatternView$Cell;->column:I
    ...
    iget v1, v11, Lcom/android/internal/widget/LockPatternView$CellState;->lineEndX:F
    ...
    iget v1, v11, Lcom/android/internal/widget/LockPatternView$CellState;->lineEndY:F
    ...
    iget v13, v11, Lcom/android/internal/widget/LockPatternView$CellState;->lineEndY:F

    invoke-virtual {v12, v1, v13}, Landroid/graphics/Path;->lineTo(FF)V
    ...
    :goto_8
    iget-boolean v1, v7, Lcom/android/internal/widget/LockPatternView;->mUseActivateAlpha:Z

    if-eqz v1, :cond_c

    iget v1, v7, Lcom/android/internal/widget/LockPatternView;->mActivateAlpha:F
    ...
    :goto_9
    iget-boolean v13, v7, Lcom/android/internal/widget/LockPatternView;->mFadePattern:Z
    ...
    invoke-virtual {v8, v12, v13}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V
    ...
    invoke-virtual {v7, v0}, Lcom/android/internal/widget/LockPatternView;->getCenterXForColumn(I)F

    move-result v4

    iget v0, v13, Lcom/android/internal/widget/LockPatternView$Cell;->row:I

    invoke-virtual {v7, v0}, Lcom/android/internal/widget/LockPatternView;->getCenterYForRow(I)F

    move-result v3

    iget-object v0, v7, Lcom/android/internal/widget/LockPatternView;->mCellStates:[[Lcom/android/internal/widget/LockPatternView$CellState;

    iget v1, v13, Lcom/android/internal/widget/LockPatternView$Cell;->row:I

    aget-object v0, v0, v1

    iget v1, v13, Lcom/android/internal/widget/LockPatternView$Cell;->column:I

    aget-object v2, v0, v1

    iget v1, v2, Lcom/android/internal/widget/LockPatternView$CellState;->translationY:F
    ...
    iget v4, v2, Lcom/android/internal/widget/LockPatternView$CellState;->radius:F
    ...
    iget v2, v7, Lcom/android/internal/widget/LockPatternView;->mInProgressY:F

    invoke-direct {v7, v1, v2, v10, v9}, Lcom/android/internal/widget/LockPatternView;->calculateLastSegmentAlpha(FFFF)F
