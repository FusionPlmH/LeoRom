...
.field private static mFirstApiVersion:I
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/server/SystemConfig;->mFirstApiVersion:I
...
.method constructor <init>()V
    ...
    iput-object v1, v0, Lcom/android/server/SystemConfig;->mSystemPermissions:Landroid/util/SparseArray;

    new-instance v1, Landroid/util/ArrayMap;

    invoke-direct {v1}, Landroid/util/ArrayMap;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mSharedLibraries:Landroid/util/ArrayMap;

    new-instance v1, Landroid/util/ArrayMap;

    invoke-direct {v1}, Landroid/util/ArrayMap;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mAvailableFeatures:Landroid/util/ArrayMap;

    new-instance v1, Landroid/util/ArraySet;

    invoke-direct {v1}, Landroid/util/ArraySet;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mUnavailableFeatures:Landroid/util/ArraySet;

    new-instance v1, Landroid/util/ArrayMap;

    invoke-direct {v1}, Landroid/util/ArrayMap;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mPermissions:Landroid/util/ArrayMap;

    new-instance v1, Landroid/util/ArraySet;

    invoke-direct {v1}, Landroid/util/ArraySet;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mAllowInPowerSaveExceptIdle:Landroid/util/ArraySet;

    new-instance v1, Landroid/util/ArraySet;

    invoke-direct {v1}, Landroid/util/ArraySet;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mAllowInPowerSave:Landroid/util/ArraySet;

    new-instance v1, Landroid/util/ArraySet;

    invoke-direct {v1}, Landroid/util/ArraySet;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mAllowInDataUsageSave:Landroid/util/ArraySet;

    new-instance v1, Landroid/util/ArraySet;

    invoke-direct {v1}, Landroid/util/ArraySet;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mAllowUnthrottledLocation:Landroid/util/ArraySet;

    new-instance v1, Landroid/util/ArraySet;

    invoke-direct {v1}, Landroid/util/ArraySet;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mAllowImplicitBroadcasts:Landroid/util/ArraySet;

    new-instance v1, Landroid/util/ArraySet;

    invoke-direct {v1}, Landroid/util/ArraySet;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mLinkedApps:Landroid/util/ArraySet;

    new-instance v1, Landroid/util/ArraySet;

    invoke-direct {v1}, Landroid/util/ArraySet;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mSystemUserWhitelistedApps:Landroid/util/ArraySet;

    new-instance v1, Landroid/util/ArraySet;

    invoke-direct {v1}, Landroid/util/ArraySet;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mSystemUserBlacklistedApps:Landroid/util/ArraySet;

    new-instance v1, Landroid/util/ArraySet;

    invoke-direct {v1}, Landroid/util/ArraySet;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mDefaultVrComponents:Landroid/util/ArraySet;

    new-instance v1, Landroid/util/ArraySet;

    invoke-direct {v1}, Landroid/util/ArraySet;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mBackupTransportWhitelist:Landroid/util/ArraySet;

    new-instance v1, Landroid/util/ArraySet;

    invoke-direct {v1}, Landroid/util/ArraySet;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mHiddenApiPackageWhitelist:Landroid/util/ArraySet;

    new-instance v1, Landroid/util/ArraySet;

    invoke-direct {v1}, Landroid/util/ArraySet;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mDisabledUntilUsedPreinstalledCarrierApps:Landroid/util/ArraySet;

    new-instance v1, Landroid/util/ArrayMap;

    invoke-direct {v1}, Landroid/util/ArrayMap;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mDisabledUntilUsedPreinstalledCarrierAssociatedApps:Landroid/util/ArrayMap;

    new-instance v1, Landroid/util/ArrayMap;

    invoke-direct {v1}, Landroid/util/ArrayMap;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mPrivAppPermissions:Landroid/util/ArrayMap;

    new-instance v1, Landroid/util/ArrayMap;

    invoke-direct {v1}, Landroid/util/ArrayMap;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mPrivAppDenyPermissions:Landroid/util/ArrayMap;

    new-instance v1, Landroid/util/ArrayMap;

    invoke-direct {v1}, Landroid/util/ArrayMap;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mVendorPrivAppPermissions:Landroid/util/ArrayMap;

    new-instance v1, Landroid/util/ArrayMap;

    invoke-direct {v1}, Landroid/util/ArrayMap;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mVendorPrivAppDenyPermissions:Landroid/util/ArrayMap;

    new-instance v1, Landroid/util/ArrayMap;

    invoke-direct {v1}, Landroid/util/ArrayMap;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mProductPrivAppPermissions:Landroid/util/ArrayMap;

    new-instance v1, Landroid/util/ArrayMap;

    invoke-direct {v1}, Landroid/util/ArrayMap;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mProductPrivAppDenyPermissions:Landroid/util/ArrayMap;

    new-instance v1, Landroid/util/ArrayMap;

    invoke-direct {v1}, Landroid/util/ArrayMap;-><init>()V

    iput-object v1, v0, Lcom/android/server/SystemConfig;->mOemPermissions:Landroid/util/ArrayMap;
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/SystemConfig;->readPermissions(Ljava/io/File;I)V
    ...
    invoke-virtual {v0, v3, v1}, Lcom/android/server/SystemConfig;->readPermissions(Ljava/io/File;I)V
    ...
    invoke-virtual {v0, v4, v3}, Lcom/android/server/SystemConfig;->readPermissions(Ljava/io/File;I)V
    ...
    invoke-virtual {v0, v5, v4}, Lcom/android/server/SystemConfig;->readPermissions(Ljava/io/File;I)V
    ...
    invoke-virtual {v0, v6, v5}, Lcom/android/server/SystemConfig;->readPermissions(Ljava/io/File;I)V
    ...
    invoke-virtual {v0, v6, v2}, Lcom/android/server/SystemConfig;->readPermissions(Ljava/io/File;I)V
    ...
    invoke-virtual {v0, v8, v2}, Lcom/android/server/SystemConfig;->readPermissions(Ljava/io/File;I)V
    ...
    :cond_2
    const-string/jumbo v9, "persist.sys.carrierid_etcpath"
    ...
    const-string/jumbo v11, "omcEtcPath_cid "
    ...
    const-string v10, "cid/sysconfig"
    ...
    invoke-virtual {v0, v10, v2}, Lcom/android/server/SystemConfig;->readPermissions(Ljava/io/File;I)V

    const-string v10, "cid/permissions"
    ...
    invoke-virtual {v0, v9, v14}, Lcom/android/server/SystemConfig;->readPermissions(Ljava/io/File;I)V

    const-string/jumbo v9, "ro.csc.omcnw_code2"
    ...
    invoke-static {v11, v10}, Landroid/os/Environment;->buildPath(Ljava/io/File;[Ljava/lang/String;)Ljava/io/File;

    move-result-object v10

    invoke-virtual {v0, v10, v14}, Lcom/android/server/SystemConfig;->readPermissions(Ljava/io/File;I)V
...
.method private isPreP()Z
    ...
    sget v0, Lcom/android/server/SystemConfig;->mFirstApiVersion:I
...
.method private readPermissionsFromXml(Ljava/io/File;I)V
    ...
    const-string v11, ", expected \'permissions\' or \'config\'"
    ...
    invoke-interface {v8, v0, v6}, Lorg/xmlpull/v1/XmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v6, "<group> without gid in "
    ...
    const-string v10, "<permission> without name in "
    ...
    invoke-virtual {v1, v8, v0}, Lcom/android/server/SystemConfig;->readPermission(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)V
    :try_end_8
    ...
    const-string v10, "<assign-permission> without name in "
    ...
    const-string v10, "<library> without name in "
    ...
    const-string v10, "<library> without file in "
    ...
    invoke-static {v8, v3, v4}, Lcom/android/internal/util/XmlUtils;->readIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)I
    ...
    :cond_18
    const-string/jumbo v4, "notLowRam"
    ...
    const-string v13, "<feature> without name in "
    ...
    const-string v6, "<unavailable-feature> without name in "
    ...
    const-string v6, "<allow-in-power-save-except-idle> without package in "
    ...
    const-string v6, "<allow-in-power-save> without package in "
    ...
    const-string v6, "<allow-in-data-usage-save> without package in "
    ...
    const-string v6, "<allow-unthrottled-location> without package in "
    ...
    const-string v6, "<allow-implicit-broadcast> without action in "
    ...
    const-string v6, "<app-link> without package in "
    ...
    :cond_29
    const-string/jumbo v0, "system-user-whitelisted-app"
    ...
    const-string v6, "<system-user-whitelisted-app> without package in "
    ...
    :cond_2b
    const-string/jumbo v0, "system-user-blacklisted-app"
    ...
    const-string v6, "<system-user-blacklisted-app without package in "
    ...
    const-string v10, "<default-enabled-vr-app without package in "
    ...
    const-string v10, "<default-enabled-vr-app without class in "
    ...
    const-string v6, "<backup-transport-whitelisted-service> without service in "
    ...
    const-string v10, "<backup-transport-whitelisted-service> with invalid service name "
    ...
    iget-object v6, v1, Lcom/android/server/SystemConfig;->mDisabledUntilUsedPreinstalledCarrierAssociatedApps:Landroid/util/ArrayMap;
    ...
    const-string v10, "<disabled-until-used-preinstalled-carrier-associated-app without package or carrierAppPackage in "
    ...
    const-string v6, "<disabled-until-used-preinstalled-carrier-app> without package in "
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/SystemConfig;->isPreP()Z
    ...
    invoke-interface {v4, v6}, Ljava/nio/file/Path;->startsWith(Ljava/nio/file/Path;)Z
    ...
    invoke-direct {v1, v8, v4, v6}, Lcom/android/server/SystemConfig;->readPrivAppPermissions(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/ArrayMap;Landroid/util/ArrayMap;)V
    ...
    invoke-virtual {v1, v8}, Lcom/android/server/SystemConfig;->readOemPermissions(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    const-string v10, "<hidden-api-whitelisted-app> without package in "
    ...
    const-string v6, " is unknown or not allowed in "
    ...
    :goto_29
    :try_start_11
    iget-object v0, v1, Lcom/android/server/SystemConfig;->mAvailableFeatures:Landroid/util/ArrayMap;
    ...
    invoke-virtual {v0}, Landroid/security/KeyStore;->isStrongBoxAvailable()Z
    ...
    invoke-direct {v1, v0}, Lcom/android/server/SystemConfig;->removeFeature(Ljava/lang/String;)V

    const-string v0, "SystemConfig"

    const-string v4, "StrongBox is blocked"
    ...
    const-string v6, "Got exception from keystore"
...
.method private readPrivAppPermissions(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/ArrayMap;Landroid/util/ArrayMap;)V
    ...
    const-string/jumbo v3, "package is required for <privapp-permissions> in "
...
.method readOemPermissions(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    const-string/jumbo v3, "package is required for <oem-permissions> in "
