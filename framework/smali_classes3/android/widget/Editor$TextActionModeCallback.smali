...
.method constructor <init>(Landroid/widget/Editor;I)V
    ...
    invoke-static {v1}, Landroid/widget/Editor$SelectionModifierCursorController;->access$4800(Landroid/widget/Editor$SelectionModifierCursorController;)Landroid/widget/Editor$SelectionHandleView;

    move-result-object v0

    if-nez v0, :cond_2

    invoke-static {v1}, Landroid/widget/Editor$SelectionModifierCursorController;->access$4900(Landroid/widget/Editor$SelectionModifierCursorController;)V

    invoke-static {v1}, Landroid/widget/Editor$SelectionModifierCursorController;->access$5000(Landroid/widget/Editor$SelectionModifierCursorController;)V
    ...
    invoke-static {p1}, Landroid/widget/Editor;->access$5100(Landroid/widget/Editor;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1}, Landroid/widget/Editor;->access$5200(Landroid/widget/Editor;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    invoke-static {p1}, Landroid/widget/Editor;->access$3200(Landroid/widget/Editor;)Landroid/widget/Editor$InsertionPointCursorController;

    move-result-object v1

    if-eqz v1, :cond_5

    invoke-static {v1}, Landroid/widget/Editor$InsertionPointCursorController;->access$5300(Landroid/widget/Editor$InsertionPointCursorController;)Landroid/widget/Editor$InsertionHandleView;

    invoke-static {p1}, Landroid/widget/Editor;->access$5400(Landroid/widget/Editor;)Landroid/graphics/drawable/Drawable;
...
.method private onAssistMenuItemClicked(Landroid/view/MenuItem;)Z
    ...
    invoke-static {v0}, Landroid/widget/Editor;->access$5600(Landroid/widget/Editor;)Landroid/widget/SelectionActionModeHelper;
...
.method private populateMenuWithItems(Landroid/view/Menu;)V
    ...
    invoke-static {v5}, Landroid/widget/Editor;->access$3300(Landroid/widget/Editor;)Z
    ...
    invoke-interface {p1, v1, v5, v0, v6}, Landroid/view/Menu;->add(IIII)Landroid/view/MenuItem;

    move-result-object v5

    iget-object v6, p0, Landroid/widget/Editor$TextActionModeCallback;->this$0:Landroid/widget/Editor;
    ...
    invoke-interface {p1, v1, v3, v0, v6}, Landroid/view/Menu;->add(IIII)Landroid/view/MenuItem;
    ...
    invoke-interface {p1, v1, v0, v5, v3}, Landroid/view/Menu;->add(IIII)Landroid/view/MenuItem;
    ...
    invoke-interface {p1, v1, v5, v3, v6}, Landroid/view/Menu;->add(IIII)Landroid/view/MenuItem;
    ...
    invoke-interface {p1, v1, v2, v0, v5}, Landroid/view/Menu;->add(IIII)Landroid/view/MenuItem;
    ...
    invoke-interface {p1, v1, v0, v3, v2}, Landroid/view/Menu;->add(IIII)Landroid/view/MenuItem;
...
.method private updateReplaceItem(Landroid/view/Menu;)V
    ...
    invoke-static {v0}, Landroid/widget/Editor;->access$5500(Landroid/widget/Editor;)Z
...
.method public onCreateActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    invoke-static {v4}, Landroid/widget/Editor;->access$3300(Landroid/widget/Editor;)Z
...
.method public onDestroyActionMode(Landroid/view/ActionMode;)V
    ...
    invoke-static {v1}, Landroid/widget/Editor;->access$5700(Landroid/widget/Editor;)Z
    ...
    invoke-static {v1, v2}, Landroid/widget/Editor;->access$5802(Landroid/widget/Editor;Z)Z
...
.method public onGetContentRect(Landroid/view/ActionMode;Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-static {v0}, Landroid/widget/Editor;->access$5900(Landroid/widget/Editor;)Landroid/text/Layout;
    ...
    invoke-static {v2, v3, v4}, Landroid/widget/Editor;->access$6000(Landroid/widget/Editor;Landroid/graphics/drawable/Drawable;F)I
