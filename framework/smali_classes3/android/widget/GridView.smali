...
.method static synthetic access$000(Landroid/widget/GridView;)Lcom/samsung/android/animation/SemDragAndDropGridAnimator;
    .locals 1
...
.method protected layoutChildren()V
    ...
    :try_start_b
    invoke-virtual {v3}, Landroid/view/ViewRootImpl;->getAccessibilityFocusedHost()Landroid/view/View;
    ...
    invoke-virtual {v1, v0}, Landroid/widget/GridView;->getAccessibilityFocusedChild(Landroid/view/View;)Landroid/view/View;
    ...
    invoke-virtual {v12}, Landroid/view/View;->hasTransientState()Z
    ...
    iget-boolean v13, v1, Landroid/widget/GridView;->mAdapterHasStableIds:Z
    ...
    invoke-virtual {v3}, Landroid/view/ViewRootImpl;->getAccessibilityFocusedVirtualView()Landroid/view/accessibility/AccessibilityNodeInfo;

    move-result-object v16

    :goto_3
    invoke-virtual {v1, v12}, Landroid/widget/GridView;->getPositionForView(Landroid/view/View;)I
    ...
    :try_start_d
    iget-object v2, v1, Landroid/widget/GridView;->mRecycler:Landroid/widget/AbsListView$RecycleBin;
    ...
    invoke-virtual {v2, v15, v14}, Landroid/widget/AbsListView$RecycleBin;->addScrapView(Landroid/view/View;I)V
    ...
    invoke-virtual {v2, v6, v12}, Landroid/widget/AbsListView$RecycleBin;->fillActiveViews(II)V
    ...
    iget-boolean v11, v1, Landroid/widget/GridView;->mStackFromBottom:Z
    ...
    :pswitch_4
    iget v11, v1, Landroid/widget/GridView;->mSyncPosition:I

    iget v15, v1, Landroid/widget/GridView;->mSpecificTop:I

    invoke-direct {v1, v11, v15}, Landroid/widget/GridView;->fillSpecific(II)Landroid/view/View;
    ...
    :pswitch_6
    iget v11, v1, Landroid/widget/GridView;->mItemCount:I

    const/4 v15, 0x1

    sub-int/2addr v11, v15

    invoke-direct {v1, v11, v5}, Landroid/widget/GridView;->fillUp(II)Landroid/view/View;
    ...
    invoke-direct {v1, v11, v4, v5}, Landroid/widget/GridView;->fillFromSelection(III)Landroid/view/View;
    ...
    iput v11, v1, Landroid/widget/GridView;->mFirstPosition:I
    ...
    iget-object v11, v1, Landroid/widget/GridView;->mAdapter:Landroid/widget/ListAdapter;
    ...
    :goto_a
    invoke-virtual {v1, v11}, Landroid/widget/GridView;->setSelectedPositionInt(I)V
    ...
    invoke-direct {v1, v11, v5}, Landroid/widget/GridView;->fillFromBottom(II)Landroid/view/View;
    ...
    :cond_17
    iget v11, v1, Landroid/widget/GridView;->mFirstPosition:I
    ...
    invoke-direct {v1, v11, v4}, Landroid/widget/GridView;->fillSpecific(II)Landroid/view/View;
    ...
    :goto_f
    invoke-virtual {v2}, Landroid/widget/AbsListView$RecycleBin;->scrapActiveViews()V

    if-eqz v11, :cond_1a

    invoke-virtual {v1, v14, v11}, Landroid/widget/GridView;->positionSelector(ILandroid/view/View;)V
    ...
    invoke-virtual {v1, v15, v2}, Landroid/widget/GridView;->positionSelector(ILandroid/view/View;)V
    ...
    invoke-virtual {v15, v2, v3, v0}, Landroid/view/accessibility/AccessibilityNodeProvider;->performAction(IILandroid/os/Bundle;)Z
    ...
    :goto_13
    invoke-virtual {v14}, Landroid/view/View;->isAccessibilityFocused()Z
    ...
    invoke-virtual {v14}, Landroid/view/View;->clearAccessibilityFocus()V
    ...
    iput-object v2, v1, Landroid/widget/GridView;->mPositionScrollAfterLayout:Ljava/lang/Runnable;
    ...
    invoke-virtual {v1, v2}, Landroid/widget/GridView;->setNextSelectedPositionInt(I)V
