...
.method private handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v0, v2}, Landroid/widget/HorizontalScrollView$HoverScrollHandler;->hasMessages(I)Z
    ...
    invoke-virtual {v0, v2}, Landroid/widget/HorizontalScrollView$HoverScrollHandler;->removeMessages(I)V
    ...
    iget-wide v3, p0, Landroid/widget/HorizontalScrollView;->mHoverRecognitionCurrentTime:J

    iget-wide v5, p0, Landroid/widget/HorizontalScrollView;->mHoverRecognitionStartTime:J
    ...
    iget-wide v5, p0, Landroid/widget/HorizontalScrollView;->mHoverScrollStartTime:J

    sub-long/2addr v3, v5

    iget-wide v5, p0, Landroid/widget/HorizontalScrollView;->mHoverScrollTimeInterval:J
    ...
    :cond_2
    iget-wide v3, p0, Landroid/widget/HorizontalScrollView;->mHoverRecognitionDurationTime:J
    ...
    iget v1, p0, Landroid/widget/HorizontalScrollView;->HOVERSCROLL_SPEED:I
    ...
    :cond_3
    iget-wide v5, p0, Landroid/widget/HorizontalScrollView;->mHoverRecognitionDurationTime:J
    ...
    iget v3, p0, Landroid/widget/HorizontalScrollView;->HOVERSCROLL_SPEED:I
    ...
    :goto_0
    iget v1, p0, Landroid/widget/HorizontalScrollView;->mHoverScrollDirection:I
    ...
    :cond_8
    invoke-virtual {p0, v1, v3}, Landroid/widget/HorizontalScrollView;->scrollBy(II)V
    ...
    invoke-virtual {v3, v2, v4, v5}, Landroid/widget/HorizontalScrollView$HoverScrollHandler;->sendEmptyMessageDelayed(IJ)Z
    ...
    invoke-virtual {v6, v4, v8}, Landroid/widget/EdgeEffect;->setSize(II)V
    ...
    iget-boolean v4, p0, Landroid/widget/HorizontalScrollView;->mIsHoverOverscrolled:Z
...
.method protected dispatchHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v6, v0, Landroid/widget/HorizontalScrollView;->mHoverScrollStateChanged:Z
    ...
    iput-boolean v4, v0, Landroid/widget/HorizontalScrollView;->mHoverScrollStateChanged:Z
    ...
    :cond_1
    iput-boolean v4, v0, Landroid/widget/HorizontalScrollView;->mNeedsHoverScroll:Z
    ...
    :cond_5
    iget-boolean v6, v0, Landroid/widget/HorizontalScrollView;->mNeedsHoverScroll:Z
    ...
    iput-wide v3, v0, Landroid/widget/HorizontalScrollView;->mHoverScrollStartTime:J
    ...
    :pswitch_0
    iget-object v3, v0, Landroid/widget/HorizontalScrollView;->mHoverHandler:Landroid/widget/HorizontalScrollView$HoverScrollHandler;

    invoke-virtual {v3, v5}, Landroid/widget/HorizontalScrollView$HoverScrollHandler;->hasMessages(I)Z
    ...
    invoke-virtual {v3, v5}, Landroid/widget/HorizontalScrollView$HoverScrollHandler;->removeMessages(I)V
    ...
    iput-boolean v3, v0, Landroid/widget/HorizontalScrollView;->mIsHoverOverscrolled:Z

    iput-boolean v3, v0, Landroid/widget/HorizontalScrollView;->mHoverAreaEnter:Z
    ...
    :pswitch_1
    iput-boolean v5, v0, Landroid/widget/HorizontalScrollView;->mHoverAreaEnter:Z

    if-ltz v6, :cond_13

    iget v3, v0, Landroid/widget/HorizontalScrollView;->mHoverAreaWidth:I
    ...
    iput-wide v3, v0, Landroid/widget/HorizontalScrollView;->mHoverRecognitionStartTime:J

    invoke-direct {v0, v1, v11}, Landroid/widget/HorizontalScrollView;->showPointerIcon(Landroid/view/MotionEvent;I)V

    iput v5, v0, Landroid/widget/HorizontalScrollView;->mHoverScrollDirection:I

    iget-object v3, v0, Landroid/widget/HorizontalScrollView;->mHoverHandler:Landroid/widget/HorizontalScrollView$HoverScrollHandler;

    invoke-virtual {v3, v5}, Landroid/widget/HorizontalScrollView$HoverScrollHandler;->sendEmptyMessage(I)Z
    ...
    iput v3, v0, Landroid/widget/HorizontalScrollView;->mHoverScrollDirection:I
    ...
    :cond_14
    iget-boolean v3, v0, Landroid/widget/HorizontalScrollView;->mHoverAreaEnter:Z
    ...
    iget-boolean v3, v0, Landroid/widget/HorizontalScrollView;->mIsHoverOverscrolled:Z

    if-eqz v3, :cond_16

    iget v3, v0, Landroid/widget/HorizontalScrollView;->mHoverScrollDirection:I
    ...
    iget-wide v3, v0, Landroid/widget/HorizontalScrollView;->mHoverScrollStartTime:J
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v5, v10, Landroid/widget/HorizontalScrollView;->mOverscrollDistance:I
