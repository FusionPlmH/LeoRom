...
.field private static final SEM_SET_ON_CHECKED_CHANGED_PENDING_INTENT_TAG:I = 0x21

.field private static final SEM_SET_ON_LONG_CLICK_DRAGABLE_TAG:I = 0x1f

.field private static final SEM_SET_ON_LONG_CLICK_PENDING_INTENT_TAG:I = 0x1d

.field private static final SEM_SET_ON_LONG_CLICK_PENDING_INTENT_TEMPLATE_TAG:I = 0x1e

.field private static final SEM_SET_ON_TOUCH_PENDING_INTENT_TAG:I = 0x20
...
.method protected constructor <init>(Landroid/content/pm/ApplicationInfo;I)V
    ...
    iput-object v1, p0, Landroid/widget/RemoteViews;->mActionsLock:Ljava/lang/Object;
...
.method private constructor <init>(Landroid/os/Parcel;Landroid/widget/RemoteViews$BitmapCache;Landroid/content/pm/ApplicationInfo;ILjava/util/Map;)V
    ...
    iput-object v2, p0, Landroid/widget/RemoteViews;->mActionsLock:Ljava/lang/Object;
...
.method private setBitmapCache(Landroid/widget/RemoteViews$BitmapCache;)V
    ...
    invoke-virtual {v3, p1}, Landroid/widget/RemoteViews$Action;->setBitmapCache(Landroid/widget/RemoteViews$BitmapCache;)V
...
.method private writeActionsToParcel(Landroid/os/Parcel;)V
    ...
    invoke-virtual {v4}, Landroid/widget/RemoteViews$Action;->getActionTag()I
    ...
    invoke-virtual {v4, v5}, Landroid/widget/RemoteViews$Action;->hasSameAppInfo(Landroid/content/pm/ApplicationInfo;)Z
    ...
    :goto_2
    invoke-virtual {v4, p1, v5}, Landroid/widget/RemoteViews$Action;->writeToParcel(Landroid/os/Parcel;I)V
...
.method public mergeRemoteViews(Landroid/widget/RemoteViews;)V
    ...
    :cond_2
    iget-object v5, v0, Landroid/widget/RemoteViews;->mActions:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v2}, Landroid/widget/RemoteViews;->setBitmapCache(Landroid/widget/RemoteViews$BitmapCache;)V
