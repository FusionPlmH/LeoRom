...
.method static synthetic access$4800(Landroid/widget/Editor$SelectionModifierCursorController;)Landroid/widget/Editor$SelectionHandleView;
    .locals 1
...
.method static synthetic access$4900(Landroid/widget/Editor$SelectionModifierCursorController;)V
    .locals 0
...
.method static synthetic access$5000(Landroid/widget/Editor$SelectionModifierCursorController;)V
    .locals 0
...
.method static synthetic access$6300(Landroid/widget/Editor$SelectionModifierCursorController;)Landroid/widget/Editor$SelectionHandleView;
    .locals 1
...
.method private initDrawables()V
    ...
    invoke-static {v0}, Landroid/widget/Editor;->access$5100(Landroid/widget/Editor;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, v1}, Landroid/widget/Editor;->access$5102(Landroid/widget/Editor;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method private initHandles()V
    ...
    invoke-static {v1}, Landroid/widget/Editor;->access$5100(Landroid/widget/Editor;)Landroid/graphics/drawable/Drawable;

    move-result-object v3

    iget-object v1, p0, Landroid/widget/Editor$SelectionModifierCursorController;->this$0:Landroid/widget/Editor;

    invoke-static {v1}, Landroid/widget/Editor;->access$5200(Landroid/widget/Editor;)Landroid/graphics/drawable/Drawable;
...
.method private selectCurrentParagraphAndStartDrag()Z
    ...
    invoke-static {v0}, Landroid/widget/Editor;->access$8400(Landroid/widget/Editor;)Ljava/lang/Runnable;
    ...
    invoke-static {v1}, Landroid/widget/Editor;->access$8400(Landroid/widget/Editor;)Ljava/lang/Runnable;
    ...
    invoke-static {v0}, Landroid/widget/Editor;->access$10200(Landroid/widget/Editor;)Z
...
.method private updateCharacterBasedSelectionAfterSelectWord(Landroid/view/MotionEvent;)V
    ...
    invoke-static {v3, v4}, Landroid/widget/Editor;->access$10400(Landroid/widget/Editor;I)I
    ...
    invoke-static {v4, v5}, Landroid/widget/Editor;->access$10300(Landroid/widget/Editor;I)I
...
.method private updateParagraphBasedSelection(Landroid/view/MotionEvent;)V
    ...
    invoke-static {v3, v1, v2}, Landroid/widget/Editor;->access$10500(Landroid/widget/Editor;II)J
...
.method private updateSelection(Landroid/view/MotionEvent;)V
    ...
    invoke-static {v1}, Landroid/widget/Editor;->access$8500(Landroid/widget/Editor;)I
...
.method private updateSelectionInternal(IIZ)V
    ...
    invoke-static {v0}, Landroid/widget/Editor;->access$6100(Landroid/widget/Editor;)Z
...
.method private updateWordBasedSelection(Landroid/view/MotionEvent;)V
    ...
    invoke-static {v5, v6, v7, v4}, Landroid/widget/Editor;->access$8700(Landroid/widget/Editor;Landroid/text/Layout;IF)I
    ...
    invoke-static {v6, v5}, Landroid/widget/Editor;->access$10300(Landroid/widget/Editor;I)I
    ...
    invoke-static {v6, v7}, Landroid/widget/Editor;->access$10400(Landroid/widget/Editor;I)I
    ...
    invoke-static {v6, v5}, Landroid/widget/Editor;->access$10400(Landroid/widget/Editor;I)I
    ...
    invoke-static {v6, v7}, Landroid/widget/Editor;->access$10300(Landroid/widget/Editor;I)I
    ...
    invoke-static {v7, v5, v8}, Landroid/widget/Editor;->access$9000(Landroid/widget/Editor;IZ)I
...
.method public enterDrag(I)V
    ...
    invoke-static {v1}, Landroid/widget/Editor;->access$9300(Landroid/widget/Editor;)F

    move-result v1

    iget-object v2, p0, Landroid/widget/Editor$SelectionModifierCursorController;->this$0:Landroid/widget/Editor;

    invoke-static {v2}, Landroid/widget/Editor;->access$9400(Landroid/widget/Editor;)F
    ...
    invoke-static {v1}, Landroid/widget/Editor;->access$9400(Landroid/widget/Editor;)F
...
.method public onTouchEvent(Landroid/view/MotionEvent;)V
    ...
    invoke-static {v5}, Landroid/widget/Editor;->access$9800(Landroid/widget/Editor;)V
    ...
    invoke-virtual {p0, v6}, Landroid/widget/Editor$SelectionModifierCursorController;->enterDrag(I)V

    iget-object v8, p0, Landroid/widget/Editor$SelectionModifierCursorController;->this$0:Landroid/widget/Editor;

    iput-boolean v6, v8, Landroid/widget/Editor;->mDiscardNextActionUp:Z
    ...
    invoke-virtual {v5}, Landroid/widget/Editor$SelectionHandleView;->isShowing()Z
    ...
    invoke-static {v5}, Landroid/widget/Editor;->access$9900(Landroid/widget/Editor;)Z
    ...
    invoke-static {v5, p1}, Landroid/widget/Editor;->access$10000(Landroid/widget/Editor;Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {v3}, Landroid/widget/TextView;->isShownSoftInput()Z
    ...
    invoke-virtual {v3, v6, v5, v7}, Landroid/view/inputmethod/InputMethodManager;->showSoftInput(Landroid/view/View;ILandroid/os/ResultReceiver;)Z
    ...
    invoke-virtual {v6, v4, v7}, Landroid/widget/TextView;->setWaitMode(IZ)V
    ...
    invoke-static {v3, v5}, Landroid/widget/Editor;->access$9902(Landroid/widget/Editor;Z)Z

    iget-object v3, p0, Landroid/widget/Editor$SelectionModifierCursorController;->this$0:Landroid/widget/Editor;

    invoke-static {v3}, Landroid/widget/Editor;->access$10100(Landroid/widget/Editor;)V
    ...
    invoke-static {}, Landroid/widget/Editor;->access$9500()Z
    ...
    invoke-static {v3}, Landroid/widget/Editor;->access$8500(Landroid/widget/Editor;)I
    ...
    invoke-static {v12, v0, v1}, Landroid/widget/Editor;->access$9600(Landroid/widget/Editor;FF)Z
    ...
    invoke-static {v12}, Landroid/widget/Editor;->access$8500(Landroid/widget/Editor;)I
    ...
    invoke-static {v4}, Landroid/widget/Editor;->access$9700(Landroid/widget/Editor;)Z
    ...
    invoke-static {v7}, Landroid/widget/Editor;->access$8500(Landroid/widget/Editor;)I
    ...
    iput-boolean v6, v4, Landroid/widget/Editor;->mDiscardNextActionUp:Z
    ...
    invoke-static {v4}, Landroid/widget/Editor;->access$9300(Landroid/widget/Editor;)F

    move-result v4

    iget-object v5, p0, Landroid/widget/Editor$SelectionModifierCursorController;->this$0:Landroid/widget/Editor;

    invoke-static {v5}, Landroid/widget/Editor;->access$9400(Landroid/widget/Editor;)F
