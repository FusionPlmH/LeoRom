...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IIILandroid/content/res/Resources$Theme;)V
    ...
    iput-object v0, v6, Landroid/widget/Spinner;->mTempRect:Landroid/graphics/Rect;

    const/4 v12, 0x0

    iput-boolean v12, v6, Landroid/widget/Spinner;->mIsThemeDeviceDefaultFamily:Z

    iput v12, v6, Landroid/widget/Spinner;->mDropdownHorizontalOffset:I
    ...
    invoke-direct {v0, v7, v11}, Landroid/view/ContextThemeWrapper;-><init>(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V

    iput-object v0, v6, Landroid/widget/Spinner;->mPopupContext:Landroid/content/Context;
    ...
    invoke-virtual {v13, v0, v12}, Landroid/content/res/TypedArray;->getResourceId(II)I
    ...
    iput-object v1, v6, Landroid/widget/Spinner;->mPopupContext:Landroid/content/Context;

    goto :goto_0

    :cond_1
    iput-object v7, v6, Landroid/widget/Spinner;->mPopupContext:Landroid/content/Context;
    ...
    :goto_2
    iput-boolean v0, v6, Landroid/widget/Spinner;->mIsThemeDeviceDefaultFamily:Z

    invoke-virtual/range {p0 .. p0}, Landroid/widget/Spinner;->getBackground()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, v6, Landroid/widget/Spinner;->mArchivedBackground:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, v6, Landroid/widget/Spinner;->mPopupContext:Landroid/content/Context;
    ...
    iget-object v1, v6, Landroid/widget/Spinner;->mPopupContext:Landroid/content/Context;

    sget-object v2, Lcom/android/internal/R$styleable;->Spinner:[I

    invoke-virtual {v1, v8, v2, v9, v10}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;
    ...
    iput v2, v6, Landroid/widget/Spinner;->mDropDownWidth:I

    invoke-virtual {v1, v12}, Landroid/content/res/TypedArray;->hasValueOrEmpty(I)Z
    ...
    iput v4, v6, Landroid/widget/Spinner;->mDropdownHorizontalOffset:I

    invoke-virtual {v2}, Landroid/content/res/TypedArray;->recycle()V

    iput-object v0, v6, Landroid/widget/Spinner;->mPopup:Landroid/widget/Spinner$SpinnerPopup;

    new-instance v3, Landroid/widget/Spinner$1;

    invoke-direct {v3, v6, v6, v0}, Landroid/widget/Spinner$1;-><init>(Landroid/widget/Spinner;Landroid/view/View;Landroid/widget/Spinner$DropdownPopup;)V

    iput-object v3, v6, Landroid/widget/Spinner;->mForwardingListener:Landroid/widget/ForwardingListener;
    ...
    invoke-direct {v0, v6, v1}, Landroid/widget/Spinner$DialogPopup;-><init>(Landroid/widget/Spinner;Landroid/widget/Spinner$1;)V

    iput-object v0, v6, Landroid/widget/Spinner;->mPopup:Landroid/widget/Spinner$SpinnerPopup;

    iget-object v0, v6, Landroid/widget/Spinner;->mPopup:Landroid/widget/Spinner$SpinnerPopup;
    ...
    iput v0, v6, Landroid/widget/Spinner;->mGravity:I
    ...
    iput-boolean v0, v6, Landroid/widget/Spinner;->mDisableChildrenWhenDisabled:Z

    invoke-virtual {v13}, Landroid/content/res/TypedArray;->recycle()V

    iget-object v0, v6, Landroid/widget/Spinner;->mTempAdapter:Landroid/widget/SpinnerAdapter;
    ...
    iput-object v1, v6, Landroid/widget/Spinner;->mTempAdapter:Landroid/widget/SpinnerAdapter;
...
.method measureContentWidth(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    iget-object v1, p0, Landroid/widget/Spinner;->mTempRect:Landroid/graphics/Rect;
