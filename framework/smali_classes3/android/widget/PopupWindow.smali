...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-virtual {v4, v3}, Landroid/content/res/TypedArray;->hasValueOrEmpty(I)Z
    ...
    invoke-direct {p0, v3}, Landroid/widget/PopupWindow;->getTransition(I)Landroid/transition/Transition;
...
.method public constructor <init>(Landroid/view/View;IIZ)V
    ...
    new-instance v1, Landroid/widget/-$$Lambda$PopupWindow$nV1HS3Nc6Ck5JRIbIHe3mkyHWzc;

    invoke-direct {v1, p0}, Landroid/widget/-$$Lambda$PopupWindow$nV1HS3Nc6Ck5JRIbIHe3mkyHWzc;-><init>(Landroid/widget/PopupWindow;)V
    ...
    new-instance v1, Landroid/widget/-$$Lambda$PopupWindow$8Gc2stI5cSJZbuKX7X4Qr_vU2nI;

    invoke-direct {v1, p0}, Landroid/widget/-$$Lambda$PopupWindow$8Gc2stI5cSJZbuKX7X4Qr_vU2nI;-><init>(Landroid/widget/PopupWindow;)V
    ...
    iput-boolean v0, p0, Landroid/widget/PopupWindow;->mFirstPositionSet:Z

    iput-boolean v0, p0, Landroid/widget/PopupWindow;->mIsFirstPositionBelow:Z
...
.method static synthetic access$1002(Landroid/widget/PopupWindow;Z)Z
    .locals 0
...
.method static synthetic access$902(Landroid/widget/PopupWindow;Z)Z
    .locals 0
...
.method private tryFitHorizontal(Landroid/view/WindowManager$LayoutParams;IIIIIIIZ)Z
    ...
    iget-boolean v0, v7, Landroid/widget/PopupWindow;->mIsDeviceDefault:Z
...
.method private tryFitVertical(Landroid/view/WindowManager$LayoutParams;IIIIIIIZ)Z
    ...
    iget-boolean v0, v10, Landroid/widget/PopupWindow;->mIsDeviceDefault:Z

    if-eqz v0, :cond_0

    iget-boolean v0, v10, Landroid/widget/PopupWindow;->mIsAutoCompleteTextPopup:Z
    ...
    invoke-direct/range {v0 .. v9}, Landroid/widget/PopupWindow;->tryFitVerticalForAutoCompleteTextPopup(Landroid/view/WindowManager$LayoutParams;IIIIIIIZ)Z
...
.method private tryFitVerticalForAutoCompleteTextPopup(Landroid/view/WindowManager$LayoutParams;IIIIIIIZ)Z
    ...
    iget-boolean v0, v8, Landroid/widget/PopupWindow;->mFirstPositionSet:Z
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/widget/PopupWindow;->getInputMethodMode()I
    ...
    iget-boolean v0, v8, Landroid/widget/PopupWindow;->mIsFirstPositionBelow:Z
    ...
    :cond_3
    iput-boolean v5, v8, Landroid/widget/PopupWindow;->mFirstPositionSet:Z

    iput-boolean v6, v8, Landroid/widget/PopupWindow;->mIsFirstPositionBelow:Z

    if-ltz v13, :cond_4

    if-gt v11, v7, :cond_4

    iput-boolean v5, v8, Landroid/widget/PopupWindow;->mIsFirstPositionBelow:Z
    ...
    iget-boolean v2, v8, Landroid/widget/PopupWindow;->mOverlapAnchor:Z
...
.method public dismiss()V
    ...
    iput-boolean v5, p0, Landroid/widget/PopupWindow;->mFirstPositionSet:Z

    iput-boolean v5, p0, Landroid/widget/PopupWindow;->mIsFirstPositionBelow:Z
...
.method protected findDropDownPosition(Landroid/view/View;Landroid/view/WindowManager$LayoutParams;IIIIIZ)Z
    ...
    iget-boolean v0, v10, Landroid/widget/PopupWindow;->mFirstPositionSet:Z

    if-eqz v0, :cond_3

    iget-boolean v0, v10, Landroid/widget/PopupWindow;->mIsFirstPositionBelow:Z
    ...
    iget v1, v12, Landroid/view/WindowManager$LayoutParams;->y:I
    ...
    iget v2, v12, Landroid/view/WindowManager$LayoutParams;->height:I
