...
.method public constructor <init>(Landroid/widget/ActionMenuPresenter;Landroid/content/Context;Lcom/android/internal/view/menu/SubMenuBuilder;Landroid/view/View;)V
    ...
    invoke-static {p1}, Landroid/widget/ActionMenuPresenter;->access$2300(Landroid/widget/ActionMenuPresenter;)Landroid/view/View;

    move-result-object v1

    if-nez v1, :cond_0

    invoke-static {p1}, Landroid/widget/ActionMenuPresenter;->access$2400(Landroid/widget/ActionMenuPresenter;)Lcom/android/internal/view/menu/MenuView;
...
.method protected onDismiss()V
    ...
    invoke-static {v0, v1}, Landroid/widget/ActionMenuPresenter;->access$2502(Landroid/widget/ActionMenuPresenter;Landroid/widget/ActionMenuPresenter$ActionButtonSubmenu;)Landroid/widget/ActionMenuPresenter$ActionButtonSubmenu;
