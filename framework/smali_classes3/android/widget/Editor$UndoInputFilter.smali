...
.method private canUndoEdit(Ljava/lang/CharSequence;IILandroid/text/Spanned;II)Z
    ...
    invoke-static {v0}, Landroid/widget/Editor;->access$10700(Landroid/widget/Editor;)Landroid/content/UndoManager;
    ...
    :cond_1
    invoke-static {p1, p2, p3}, Landroid/widget/Editor;->access$11300(Ljava/lang/CharSequence;II)Z

    move-result v0

    if-eqz v0, :cond_4

    invoke-static {p4, p5, p6}, Landroid/widget/Editor;->access$11300(Ljava/lang/CharSequence;II)Z
...
.method private getLastEdit()Landroid/widget/Editor$EditOperation;
    ...
    invoke-static {v2}, Landroid/widget/Editor;->access$11100(Landroid/widget/Editor;)Landroid/content/UndoOwner;
...
.method private handleEdit(Ljava/lang/CharSequence;IILandroid/text/Spanned;IIZ)V
    ...
    invoke-static {v3}, Landroid/widget/Editor$EditOperation;->access$10900(Landroid/widget/Editor$EditOperation;)Ljava/lang/String;

    move-result-object v4

    invoke-static {v3}, Landroid/widget/Editor$EditOperation;->access$11000(Landroid/widget/Editor$EditOperation;)Ljava/lang/String;
...
.method private recordEdit(Landroid/widget/Editor$EditOperation;I)V
    ...
    invoke-static {v3}, Landroid/widget/Editor;->access$11100(Landroid/widget/Editor;)Landroid/content/UndoOwner;
    ...
    invoke-static {v1, p1}, Landroid/widget/Editor$EditOperation;->access$11200(Landroid/widget/Editor$EditOperation;Landroid/widget/Editor$EditOperation;)Z
...
.method freezeLastEdit()V
    ...
    invoke-static {v0, v1}, Landroid/widget/Editor$EditOperation;->access$10802(Landroid/widget/Editor$EditOperation;Z)Z

    :cond_0
    iget-object v1, p0, Landroid/widget/Editor$UndoInputFilter;->mEditor:Landroid/widget/Editor;

    invoke-static {v1}, Landroid/widget/Editor;->access$10700(Landroid/widget/Editor;)Landroid/content/UndoManager;
