...
.field private static final SYSTEM_KGCLIENT:Ljava/lang/String; = "com.samsung.android.kgclient"
...
.method public destroy(Ljava/lang/String;[B[B[B)I
    ...
    const-string v4, "destroy : if hmac is exist, it should be 32 Bytes. but now("
    ...
    const-string v3, "destroy : if cert is exist, it should contain value."
    ...
    const-string v4, "destroy : if signature is exist, it should be 256, but "
    ...
    const-string v3, "destroy : cert is null"
    ...
    const-string v3, "destroy : sig is null"
