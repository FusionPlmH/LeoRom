...
.method public constructor <init>(Landroid/content/Context;Landroid/app/IActivityManager;Landroid/os/INetworkManagementService;Landroid/content/pm/IPackageManager;Ljava/time/Clock;Ljava/io/File;Z)V
    ...
    iput v3, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mActiveNetworkType:I
...
.method static synthetic access$2500(Lcom/android/server/net/NetworkPolicyManagerService;)I
    ...
    iget v0, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mActiveNetworkType:I
...
.method private isUidNetworkingBlockedInternal(IZ)Z
    ...
    :try_start_0
    iget v5, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mActiveNetworkType:I

    if-nez v5, :cond_0

    iget-object v5, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mFirewallRules:Landroid/util/SparseIntArray;
    ...
    invoke-static {v5, v4}, Lcom/android/server/net/NetworkPolicyManagerService;->hasRule(II)Z
    ...
    invoke-virtual {v1, p1, v2}, Lcom/android/server/net/NetworkPolicyLogger;->networkBlocked(II)V
    ...
    :cond_6
    invoke-static {v5, v2}, Lcom/android/server/net/NetworkPolicyManagerService;->hasRule(II)Z
    ...
    :cond_7
    invoke-static {v5, v1}, Lcom/android/server/net/NetworkPolicyManagerService;->hasRule(II)Z
    ...
    invoke-virtual {v1, p1, v4}, Lcom/android/server/net/NetworkPolicyLogger;->networkBlocked(II)V
...
.method private readPolicyAL()V
    ...
    :try_start_0
    iget-object v0, v1, Lcom/android/server/net/NetworkPolicyManagerService;->mFirewallRules:Landroid/util/SparseIntArray;
    ...
    invoke-virtual {v1, v0, v6}, Lcom/android/server/net/NetworkPolicyManagerService;->setRoamingReduction(II)V
    ...
    iget-object v10, v1, Lcom/android/server/net/NetworkPolicyManagerService;->mFirewallPoliciesLock:Ljava/lang/Object;
    ...
    :try_start_2
    invoke-direct {v1, v6, v7, v0}, Lcom/android/server/net/NetworkPolicyManagerService;->setFirewallPolicyNL(IIZ)V
    ...
    :try_start_3
    invoke-direct {v1, v6, v7}, Lcom/android/server/net/NetworkPolicyManagerService;->applyFirewallRules(II)V
    :try_end_3
...
.method writePolicyAL()V
    ...
    :goto_7
    :try_start_1
    iget-object v6, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mFirewallRules:Landroid/util/SparseIntArray;
    ...
    iget-object v7, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mFirewallRules:Landroid/util/SparseIntArray;
    ...
    :cond_a
    const-string/jumbo v8, "firewall-policy"
    ...
    invoke-static {v2, v8, v7}, Lcom/android/internal/util/XmlUtils;->writeIntAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;I)V
