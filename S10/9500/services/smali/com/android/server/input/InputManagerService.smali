...
.method private deliverInputDevicesChanged([Landroid/view/InputDevice;)V
    ...
    invoke-virtual {v2}, Lcom/android/internal/inputmethod/InputMethodSubtypeHandle;->getSubtypeId()I
    ...
    iget-object v10, v1, Lcom/android/server/input/InputManagerService;->mEnabledSubtypeIds:Ljava/util/List;

    invoke-static {v2, v10}, Lcom/android/server/input/KeyboardLayoutUtils;->isSubtypeInEnabledList(Ljava/lang/String;Ljava/util/List;)Z

    move-result v10

    if-eqz v10, :cond_c

    iget-object v10, v1, Lcom/android/server/input/InputManagerService;->mCurrentImeSubtype:Landroid/view/inputmethod/InputMethodSubtype;

    iget-object v11, v1, Lcom/android/server/input/InputManagerService;->mKeyboardLayouts:Ljava/util/ArrayList;

    invoke-static {v10, v11}, Lcom/android/server/input/KeyboardLayoutUtils;->getDefaultKeyboardLayoutForSubtype(Landroid/view/inputmethod/InputMethodSubtype;Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    invoke-direct {v1, v10, v11, v0}, Lcom/android/server/input/InputManagerService;->setKeyboardLayoutForInputDeviceInner(Landroid/hardware/input/InputDeviceIdentifier;Lcom/android/internal/inputmethod/InputMethodSubtypeHandle;Ljava/lang/String;)V
