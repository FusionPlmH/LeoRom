...
.field mLaunchingRequestedFromNotification:Z
...
.method private reportLaunchTimeLocked(J)V
    ...
    invoke-static {v0}, Lcom/android/server/am/SluggishInfo;->addEndLaunchLog(Ljava/lang/String;)V
    ...
    invoke-static {v7, v9, v10}, Lcom/android/server/am/SluggishDetector;->reportLaunch(Lcom/android/server/am/ActivityRecord;J)V
...
.method final deliverNewIntentLocked(ILandroid/content/Intent;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/am/ActivityRecord;->setLaunchingRequestFromNotification(Z)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_2
    invoke-static {v5, v1}, Landroid/app/servertransaction/NewIntentItem;->obtain(Ljava/util/List;Z)Landroid/app/servertransaction/NewIntentItem;

    move-result-object v1

    invoke-virtual {v6, v7, v8, v1}, Lcom/android/server/am/ClientLifecycleManager;->scheduleTransaction(Landroid/app/IApplicationThread;Landroid/os/IBinder;Landroid/app/servertransaction/ClientTransactionItem;)V
    :try_end_1
...
.method isLaunchRequestedFromNotification()Z
    ...
    iget-boolean v0, p0, Lcom/android/server/am/ActivityRecord;->mLaunchingRequestedFromNotification:Z
...
.method setLaunchingRequestFromNotification(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/server/am/ActivityRecord;->mLaunchingRequestedFromNotification:Z
