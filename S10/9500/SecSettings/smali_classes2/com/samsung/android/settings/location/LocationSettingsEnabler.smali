...
.method public onLocationModeChanged(IZ)V
    ...
    iget-object v3, p0, Lcom/samsung/android/settings/location/LocationSettingsEnabler;->mLocationEnabler:Lcom/android/settings/location/LocationEnabler;
    ...
    invoke-virtual {v4, v2}, Lcom/android/settings/location/LocationEnabler;->hasShareLocationRestriction(I)Z
    ...
    invoke-virtual {v5, v3}, Lcom/android/settings/widget/SwitchBar;->setDisabledByAdmin(Lcom/android/settingslib/RestrictedLockUtils$EnforcedAdmin;)V
    ...
    iget-boolean v5, p0, Lcom/samsung/android/settings/location/LocationSettingsEnabler;->mValidListener:Z
    ...
    invoke-virtual {v5, p0}, Lcom/android/settings/widget/SwitchBar;->removeOnSwitchChangeListener(Lcom/android/settings/widget/SwitchBar$OnSwitchChangeListener;)V
    ...
    :cond_4
    iget-object v5, p0, Lcom/samsung/android/settings/location/LocationSettingsEnabler;->mSwitchPref:Landroid/support/v7/preference/SwitchPreferenceCompat;
    ...
    const-string v10, "isGPSStateChangeAllowed"

    invoke-static {v8, v9, v10, v7}, Lcom/android/settings/Utils;->getEnterprisePolicyEnabled(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-static {v9, v10, v11, v5}, Lcom/android/settings/Utils;->getEnterprisePolicyEnabled(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-virtual {v0, v10}, Landroid/support/v7/preference/SwitchPreferenceCompat;->setEnabled(Z)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/preference/SwitchPreferenceCompat;->setOnPreferenceChangeListener(Landroid/support/v7/preference/Preference$OnPreferenceChangeListener;)V
