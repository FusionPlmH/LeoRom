...
.method private updateLockAfterPreferenceSummary()V
    ...
    const-string v8, "revisedValues.size() : "
    ...
    invoke-direct {v0, v1, v2}, Lcom/samsung/android/settings/lockscreen/SecuredLockSettingsMenu;->getTimeoutNewEntry(J)Ljava/lang/String;
    ...
    invoke-virtual {v0, v9, v13}, Lcom/samsung/android/settings/lockscreen/SecuredLockSettingsMenu;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    const-string v12, "SecuredLockSettingsMenu"

    const-string v13, "updateLockAfterPreferenceSummary, Long.valueOf(values[best].toString()) < maxTimeout && maxTimeout < currentTimeout"

    invoke-static {v12, v13}, Landroid/util/secutil/Log;->secD(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v12, v0, Lcom/samsung/android/settings/lockscreen/SecuredLockSettingsMenu;->mLockAfter:Lcom/samsung/android/settings/widget/SecRestrictedPreference;
    ...
    invoke-virtual {v12, v3}, Lcom/samsung/android/settings/widget/SecRestrictedPreference;->setSummary(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v3, v12}, Lcom/samsung/android/settings/widget/SecRestrictedPreference;->setSummary(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v0, v12, v13}, Lcom/samsung/android/settings/lockscreen/SecuredLockSettingsMenu;->isInDefaultTimeoutList(J)Z
    ...
    invoke-virtual {v0, v7, v6}, Lcom/samsung/android/settings/lockscreen/SecuredLockSettingsMenu;->getString(I[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v3, v6}, Lcom/samsung/android/settings/widget/SecRestrictedPreference;->setSummary(Ljava/lang/CharSequence;)V
...
.method public onPreferenceChange(Landroid/support/v7/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v1, v3, v4}, Lcom/android/internal/widget/LockPatternUtils;->setPowerButtonInstantlyLocks(ZI)V
    ...
    invoke-virtual {v1, v3, v4}, Lcom/android/internal/widget/LockPatternUtils;->setDirectionShowEnabled(ZI)V
    ...
    const-string v3, "universal_lock_visible"
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/internal/widget/LockPatternUtils;->setDirectionShowEnabled(ZI)V
    ...
    invoke-virtual {v1, v3, v4}, Lcom/android/internal/widget/LockPatternUtils;->setDirectionVibrationEnabled(ZI)V
    ...
    const-string v3, "universal_lock_vibration"
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/internal/widget/LockPatternUtils;->setDirectionVibrationEnabled(ZI)V
    ...
    invoke-virtual {v1, v3, v4}, Lcom/android/internal/widget/LockPatternUtils;->setDirectionSoundEnabled(ZI)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/internal/widget/LockPatternUtils;->setDirectionSoundEnabled(ZI)V
    ...
    invoke-virtual {v1, v3, v4}, Lcom/android/internal/widget/LockPatternUtils;->setDirectionVoiceEnabled(ZI)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/internal/widget/LockPatternUtils;->setDirectionVoiceEnabled(ZI)V
