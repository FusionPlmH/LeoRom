...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/samsung/android/settings/lockscreen/LockScreenSettings$4;

    invoke-direct {v0}, Lcom/samsung/android/settings/lockscreen/LockScreenSettings$4;-><init>()V
    ...
    new-instance v0, Lcom/samsung/android/settings/lockscreen/LockScreenSettings$5;

    invoke-direct {v0}, Lcom/samsung/android/settings/lockscreen/LockScreenSettings$5;-><init>()V
...
.method private showSmartLockDialog(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-direct {v5, p0, v3, v0}, Lcom/samsung/android/settings/lockscreen/LockScreenSettings$3;-><init>(Lcom/samsung/android/settings/lockscreen/LockScreenSettings;Landroid/widget/CheckBox;Landroid/content/Intent;)V
    ...
    new-instance v5, Lcom/samsung/android/settings/lockscreen/LockScreenSettings$2;

    invoke-direct {v5, p0}, Lcom/samsung/android/settings/lockscreen/LockScreenSettings$2;-><init>(Lcom/samsung/android/settings/lockscreen/LockScreenSettings;)V
    ...
    new-instance v5, Lcom/samsung/android/settings/lockscreen/LockScreenSettings$1;

    invoke-direct {v5, p0}, Lcom/samsung/android/settings/lockscreen/LockScreenSettings$1;-><init>(Lcom/samsung/android/settings/lockscreen/LockScreenSettings;)V
...
.method public onPreferenceChange(Landroid/support/v7/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v5, v2}, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreferenceScreen;->setChecked(Z)V
    ...
    :goto_0
    invoke-virtual {v5, v6}, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreferenceScreen;->setSummary(I)V

    iget-object v5, p0, Lcom/samsung/android/settings/lockscreen/LockScreenSettings;->mLockscreenSecNotification:Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreferenceScreen;

    invoke-virtual {v5, v2}, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreferenceScreen;->semSetSummaryColorToColorPrimaryDark(Z)V
    ...
    invoke-direct {p0, v5, v4}, Lcom/samsung/android/settings/lockscreen/LockScreenSettings;->getOnOffstatus(Landroid/content/Context;I)Ljava/lang/String;
    ...
    sget v5, Lcom/samsung/android/settings/lockscreen/LockScreenSettings;->MY_USER_ID:I
...
.method public onPreferenceTreeClick(Landroid/support/v7/preference/Preference;)Z
    ...
    const-string v8, "com.android.settings.password.ChooseLockGeneric$ChooseLockGenericFragment"
    ...
    invoke-direct/range {v6 .. v11}, Lcom/samsung/android/settings/lockscreen/LockScreenSettings;->startFragment(Landroid/app/Fragment;Ljava/lang/String;IILandroid/os/Bundle;)Z
    ...
    invoke-virtual {v3, v4, v6}, Lcom/android/settings/password/ChooseLockSettingsHelper;->launchConfirmationActivity(ILjava/lang/CharSequence;)Z

    move-result v4

    if-nez v4, :cond_7

    iget-object v6, p0, Lcom/samsung/android/settings/lockscreen/LockScreenSettings;->mTrustAgentClickIntent:Landroid/content/Intent;

    if-eqz v6, :cond_7

    const/4 v6, 0x0

    iput-object v6, p0, Lcom/samsung/android/settings/lockscreen/LockScreenSettings;->mTrustAgentClickIntent:Landroid/content/Intent;
    ...
    invoke-virtual {v4, p0, v6}, Landroid/app/DialogFragment;->setTargetFragment(Landroid/app/Fragment;I)V
    ...
    const-string v6, "About Lock screen ActivityNotFoundException"
