...
.method private createPreferenceHierarchy()Landroid/support/v7/preference/PreferenceScreen;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->getPreferenceManager()Landroid/support/v7/preference/PreferenceManager;

    move-result-object v0

    invoke-virtual {p0}, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->getActivity()Landroid/app/Activity;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->getPrefContext()Landroid/content/Context;
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->getContext()Landroid/content/Context;
    ...
    invoke-static {v1, v2, v3}, Lcom/samsung/android/settings/inputmethod/PhysicalKeyboardFragment$KeyboardInfoPreference;->getDisplayName(Landroid/content/Context;Landroid/view/inputmethod/InputMethodInfo;Landroid/view/inputmethod/InputMethodSubtype;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/support/v7/preference/PreferenceScreen;->setTitle(Ljava/lang/CharSequence;)V
...
.method private removeBKB10KeyboardLayout()V
    ...
    iput-object v1, p0, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->mKeyboardLayouts:[Landroid/hardware/input/KeyboardLayout;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->getArguments()Landroid/os/Bundle;
    ...
    iput-object v2, p0, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceIdentifier:Landroid/hardware/input/InputDeviceIdentifier;

    const-string v2, "input_method_info"
    ...
    iput-object v2, p0, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->mImi:Landroid/view/inputmethod/InputMethodInfo;

    const-string v2, "input_method_subtype"
    ...
    iput-object v2, p0, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->mSubtype:Landroid/view/inputmethod/InputMethodSubtype;

    :cond_0
    iget-object v2, p0, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceIdentifier:Landroid/hardware/input/InputDeviceIdentifier;
    ...
    iput-object v2, p0, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;

    iget-object v2, p0, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;

    iget-object v3, p0, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceIdentifier:Landroid/hardware/input/InputDeviceIdentifier;

    invoke-virtual {v2, v3}, Landroid/hardware/input/InputManager;->getKeyboardLayoutsForInputDevice(Landroid/hardware/input/InputDeviceIdentifier;)[Landroid/hardware/input/KeyboardLayout;

    move-result-object v2

    iput-object v2, p0, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->mKeyboardLayouts:[Landroid/hardware/input/KeyboardLayout;

    invoke-direct {p0}, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->removeBKB10KeyboardLayout()V

    iget-object v2, p0, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->mKeyboardLayouts:[Landroid/hardware/input/KeyboardLayout;

    invoke-static {v2}, Ljava/util/Arrays;->sort([Ljava/lang/Object;)V

    invoke-direct {p0}, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->createPreferenceHierarchy()Landroid/support/v7/preference/PreferenceScreen;

    move-result-object v2

    invoke-virtual {p0, v2}, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->setPreferenceScreen(Landroid/support/v7/preference/PreferenceScreen;)V
...
.method public onPreferenceTreeClick(Landroid/support/v7/preference/Preference;)Z
    ...
    iget-object v1, p0, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;

    iget-object v2, p0, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceIdentifier:Landroid/hardware/input/InputDeviceIdentifier;

    iget-object v3, p0, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->mImi:Landroid/view/inputmethod/InputMethodInfo;

    iget-object v4, p0, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->mSubtype:Landroid/view/inputmethod/InputMethodSubtype;
...
.method public onResume()V
    ...
    iput v1, p0, Lcom/samsung/android/settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceId:I
