...
.method protected updateServicePreferences()V
    ...
    check-cast v2, Lcom/samsung/android/settings/widget/SecNoItemView;

    if-nez v2, :cond_11

    const-string v3, "layout_inflater"

    invoke-virtual {v0, v3}, Lcom/samsung/android/settings/accessibility/SecInstalledServices;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    check-cast v4, Lcom/samsung/android/settings/widget/SecNoItemView;
    ...
    invoke-direct {v0, v6}, Lcom/samsung/android/settings/accessibility/SecInstalledServices;->getAppLable(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v4, v5, v6}, Lcom/samsung/android/settings/widget/SecNoItemView;->setSubText(ILjava/lang/String;)V
