...
.field private final mEnableHideCamera:Ljava/lang/Runnable;
...
.field private mHideCamera:Landroid/support/v14/preference/SecSwitchPreference;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Lcom/samsung/android/settings/display/FullScreenAppsSettings$5;-><init>()V
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->mList:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->mEnableHideCamera:Ljava/lang/Runnable;
...
.method static synthetic access$000(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Z
    .locals 1
...
.method static synthetic access$100(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Landroid/support/v14/preference/SecSwitchPreference;
    .locals 1

    iget-object v0, p0, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->mHideCamera:Landroid/support/v14/preference/SecSwitchPreference;

    return-object v0
.end method

.method static synthetic access$1000(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Z
    .locals 1
...
.method static synthetic access$1300(Lcom/samsung/android/settings/display/FullScreenAppsSettings;Ljava/util/List;)Ljava/util/List;
    .locals 1
...
.method static synthetic access$1400(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Landroid/support/v7/preference/SecPreferenceCategory;
    .locals 1
...
.method static synthetic access$1500(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Lcom/samsung/android/settings/widget/SecInsetCategoryPreference;
    .locals 1
...
.method static synthetic access$1600(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Landroid/app/ProgressDialog;
    .locals 1
...
.method static synthetic access$1700(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Ljava/lang/Runnable;
    .locals 1

    iget-object v0, p0, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->mEnableHideCamera:Ljava/lang/Runnable;

    return-object v0
.end method

.method static synthetic access$1800(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic access$200(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Lcom/samsung/android/settings/display/FullScreenAppsShowTypePreference;
    .locals 1
...
.method static synthetic access$2000(Lcom/samsung/android/settings/display/FullScreenAppsSettings;Ljava/lang/String;IZ)V
    .locals 0
...
.method static synthetic access$302(Lcom/samsung/android/settings/display/FullScreenAppsSettings;Z)Z
    .locals 0
...
.method static synthetic access$400(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Z
    .locals 1
...
.method static synthetic access$402(Lcom/samsung/android/settings/display/FullScreenAppsSettings;Z)Z
    .locals 0
...
.method static synthetic access$500(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)V
    .locals 0
...
.method static synthetic access$600(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Landroid/util/ArrayMap;
    .locals 1
...
.method static synthetic access$700(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Landroid/content/pm/LauncherApps;
    .locals 1
...
.method static synthetic access$800(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Landroid/content/Context;
    .locals 1
...
.method static synthetic access$900(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Ljava/util/ArrayList;
    .locals 1
...
.method private changeListVisible(Z)V
    ...
    iget-object v1, p0, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->mEnableHideCamera:Ljava/lang/Runnable;
...
.method private initSorting()V
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->setHasOptionsMenu(Z)V
...
.method private refreshDisplayedItems(Ljava/util/List;)Ljava/util/List;
    ...
    iput-object p1, p0, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->mList:Ljava/util/List;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->mList:Ljava/util/List;
    ...
    :goto_0
    iget-object v1, p0, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->mList:Ljava/util/List;
    ...
    instance-of v2, v1, Lcom/samsung/android/settings/display/FullScreenAppsDropDownPreference;

    if-eqz v2, :cond_1

    move-object v2, v1

    check-cast v2, Lcom/samsung/android/settings/display/FullScreenAppsDropDownPreference;

    invoke-virtual {v2}, Lcom/samsung/android/settings/display/FullScreenAppsDropDownPreference;->getmSpinner()Landroid/widget/Spinner;

    move-result-object v2

    invoke-virtual {v2}, Landroid/widget/Spinner;->semDismissPopup()V
    ...
    invoke-virtual {v0}, Lcom/samsung/android/settings/display/FullScreenAppsShowTypePreference;->getmSpinner()Landroid/widget/Spinner;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->mHideCamera:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    invoke-virtual {v0, v3}, Lcom/samsung/android/settings/widget/SecUnclickablePreference;->setPositionMode(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->removePreference(Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v4}, Lcom/samsung/android/settings/widget/SecInsetCategoryPreference;-><init>(Landroid/content/Context;)V
    ...
    const-string v4, "empty_category"

    invoke-virtual {v0, v4}, Lcom/samsung/android/settings/widget/SecInsetCategoryPreference;->setKey(Ljava/lang/String;)V
...
.method public onPreferenceChange(Landroid/support/v7/preference/Preference;Ljava/lang/Object;)Z
    ...
    iget-object v1, p0, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->mHideCamera:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    const-string v5, "onPreferenceChange hide camera "
    ...
    iget-object v3, p0, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->mHideCamera:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    :goto_0
    invoke-static {v3, v5, v6, v4}, Landroid/provider/Settings$Secure;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z

    invoke-virtual {p0}, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v3

    const-string v5, "default_display_cutout_hide_notch"
    ...
    invoke-direct {p0, v3}, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->setLastOutlineStrokeEnabled(Z)V
...
.method public onResume()V
    ...
    :goto_0
    iget-object v2, p0, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->mHideCamera:Landroid/support/v14/preference/SecSwitchPreference;
