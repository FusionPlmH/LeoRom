...
.method private fillUI(Z)V
    ...
    iget-object v2, p0, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings;->mApn:Landroid/preference/EditTextPreference;

    iget-object v3, p0, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings;->mApnData:Lcom/samsung/android/settings/cpa/CpaAdvancedSettings$ApnData;

    const/4 v4, 0x2

    invoke-virtual {v3, v4}, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings$ApnData;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {v3, v5}, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings$ApnData;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {v3, v6}, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings$ApnData;->getString(I)Ljava/lang/String;
    ...
    iput-object v4, p0, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings;->mCurMnc:Ljava/lang/String;

    iput-object v3, p0, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings;->mCurMcc:Ljava/lang/String;

    :cond_0
    iget-object v2, p0, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings;->mApnData:Lcom/samsung/android/settings/cpa/CpaAdvancedSettings$ApnData;
    ...
    invoke-virtual {v2, v3, v5}, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings$ApnData;->getInteger(ILjava/lang/Integer;)Ljava/lang/Integer;
    ...
    iget-object v3, p0, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings;->mAuthType:Landroid/preference/ListPreference;
    ...
    const-string v4, "kddi_cpa_static_dns1"
    ...
    iget-object v2, p0, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings;->mDns1:Landroid/preference/EditTextPreference;
    ...
    invoke-direct {p0, v2}, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings;->checkNull(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v4, v1}, Landroid/preference/EditTextPreference;->setEnabled(Z)V
...
.method private validateAndSaveApnData()Z
    ...
    invoke-virtual {p0, v2}, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings;->showDialog(I)V
    ...
    iget-object v5, p0, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings;->mProxy:Landroid/preference/EditTextPreference;
    ...
    iget-object v5, p0, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings;->mUser:Landroid/preference/EditTextPreference;
    ...
    iget-object v5, p0, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings;->mPassword:Landroid/preference/EditTextPreference;
    ...
    const-string/jumbo v8, "validateAndSaveApnData numeric = "
    ...
    iput-object v7, p0, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings;->mCurMcc:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings;->mCurMnc:Ljava/lang/String;

    const/4 v8, 0x1

    if-eqz v2, :cond_3

    iget-object v2, p0, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings;->mCurMcc:Ljava/lang/String;
    ...
    invoke-virtual {v3, v2, v9}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Integer;)V

    :cond_3
    iget-object v2, p0, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings;->mApnData:Lcom/samsung/android/settings/cpa/CpaAdvancedSettings$ApnData;

    invoke-virtual {v2}, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings$ApnData;->getUri()Landroid/net/Uri;

    move-result-object v2

    if-nez v2, :cond_4

    iget-object v2, p0, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings;->mCarrierUri:Landroid/net/Uri;
    ...
    :goto_0
    invoke-direct {p0, v2, v3}, Lcom/samsung/android/settings/cpa/CpaAdvancedSettings;->updateApnDataToDatabase(Landroid/net/Uri;Landroid/content/ContentValues;)V
