...
.method public postEnrollForIris()V
    .locals 2
    ...
    const-string v1, "SemIrisManager is NOT Null & mIrisManager.postEnroll called"
...
.method public switchToSwipe()V
    ...
    sget-object v1, Lcom/samsung/android/settings/accessibility/directionlock/DirectionLockSettingsHelper;->userPasswordForBiometrics:Ljava/lang/String;

    if-nez v1, :cond_0

    iget-object v1, p0, Lcom/samsung/android/settings/accessibility/directionlock/DirectionLockSettingsHelper;->mChooseLockGenericFragment:Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;

    if-eqz v1, :cond_1

    iget-object v1, p0, Lcom/samsung/android/settings/accessibility/directionlock/DirectionLockSettingsHelper;->mChooseLockGenericFragment:Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;

    invoke-virtual {v1}, Lcom/android/settings/password/ChooseLockGeneric$ChooseLockGenericFragment;->getPasswordForDirectionLock()Ljava/lang/String;
