...
.method private doMigration()V
    ...
    const-string v2, "doMigration mContext is null"
    ...
    invoke-virtual {v1, v6, v7}, Lcom/samsung/android/settings/datausage/trafficmanager/trafficdata/TrafficPresenter;->getBoolean(Ljava/lang/String;Z)Z
    ...
    const-string v7, " doMigration key is enabled "
    ...
    const-string/jumbo v8, "switch_traffic_settings"
    ...
    const-string v7, " doMigration KEY_SWITCH_TRAFFIC_SETTINGS is off "
    ...
    const-string/jumbo v14, "switch_traffic_settings"
    ...
    invoke-static {v2, v13, v7}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    :goto_1
    invoke-virtual {v1, v12, v13}, Lcom/samsung/android/settings/datausage/trafficmanager/trafficdata/TrafficPresenter;->putBoolean(Ljava/lang/String;Z)V

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string v13, "restrict_data_check_box"
    ...
    const-string v15, "restrict_data_check_box"
    ...
    const-string/jumbo v13, "set_package_start_date"
    ...
    invoke-static {v2, v13, v14}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v13

    invoke-virtual {v1, v12, v13}, Lcom/samsung/android/settings/datausage/trafficmanager/trafficdata/TrafficPresenter;->putInt(Ljava/lang/String;I)V

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v13, "warning_progress"
    ...
    const-string/jumbo v14, "warning_progress"
    ...
    invoke-virtual {v1, v12, v7}, Lcom/samsung/android/settings/datausage/trafficmanager/trafficdata/TrafficPresenter;->putInt(Ljava/lang/String;I)V

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v12, "total_used"
    ...
    const-string/jumbo v13, "total_used"
    ...
    invoke-static {v2, v12, v13, v14}, Landroid/provider/Settings$System;->getLong(Landroid/content/ContentResolver;Ljava/lang/String;J)J

    move-result-wide v3

    invoke-virtual {v1, v7, v3, v4}, Lcom/samsung/android/settings/datausage/trafficmanager/trafficdata/TrafficPresenter;->putLong(Ljava/lang/String;J)V
    ...
    invoke-static {v2, v4, v13, v14}, Landroid/provider/Settings$System;->getLong(Landroid/content/ContentResolver;Ljava/lang/String;J)J

    move-result-wide v6

    invoke-virtual {v1, v3, v6, v7}, Lcom/samsung/android/settings/datausage/trafficmanager/trafficdata/TrafficPresenter;->putLong(Ljava/lang/String;J)V
    ...
    const-string v6, "middle_real_value"
    ...
    const-string v4, "data_used_by_check_time"
    ...
    :goto_3
    invoke-virtual {v1, v4, v6}, Lcom/samsung/android/settings/datausage/trafficmanager/trafficdata/TrafficPresenter;->putString(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, "TrafficPresenter"

    const-string v3, "doMigration cause exception"
...
.method private initTrafficPreset()V
    ...
    const-string v0, "migrate_traffic_settings"
    ...
    invoke-direct {p0}, Lcom/samsung/android/settings/datausage/trafficmanager/trafficdata/TrafficPresenter;->doMigration()V

    const-string v0, "migrate_traffic_settings"

    const/4 v1, 0x1

    invoke-virtual {p0, v0, v1}, Lcom/samsung/android/settings/datausage/trafficmanager/trafficdata/TrafficPresenter;->putBoolean(Ljava/lang/String;Z)V
...
.method public updateLimitBytes(J)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/samsung/android/settings/datausage/trafficmanager/trafficdata/TrafficMode;->setmTotalDataBytes(J)V
