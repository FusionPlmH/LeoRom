...
.method private initPreferences()V
    ...
    invoke-virtual {v3, v1}, Lcom/samsung/android/settings/widget/SecClickableDescriptionPreference;->setTitle(Ljava/lang/CharSequence;)V

    iget-object v3, p0, Lcom/samsung/android/settings/accessibility/directionlock/DirectionLockSplashActivity;->mShowDescription:Lcom/samsung/android/settings/widget/SecClickableDescriptionPreference;

    invoke-virtual {v3, v1}, Lcom/samsung/android/settings/widget/SecClickableDescriptionPreference;->setDescription(Ljava/lang/String;)V
    ...
    const-string v4, "lock_screen_options_category"

    invoke-virtual {p0, v4}, Lcom/samsung/android/settings/accessibility/directionlock/DirectionLockSplashActivity;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;

    move-result-object v4

    check-cast v4, Landroid/support/v7/preference/PreferenceCategory;

    iput-object v4, p0, Lcom/samsung/android/settings/accessibility/directionlock/DirectionLockSplashActivity;->mFeedback:Landroid/support/v7/preference/PreferenceCategory;

    iget-object v4, p0, Lcom/samsung/android/settings/accessibility/directionlock/DirectionLockSplashActivity;->mFeedback:Landroid/support/v7/preference/PreferenceCategory;
    ...
    invoke-virtual {v4, v5}, Landroid/support/v7/preference/PreferenceCategory;->setTitle(Ljava/lang/CharSequence;)V

    const-string v4, "lock_screen_security_category"
    ...
    iput-object v4, p0, Lcom/samsung/android/settings/accessibility/directionlock/DirectionLockSplashActivity;->mLockScreenType:Landroid/support/v7/preference/PreferenceCategory;

    iget-object v4, p0, Lcom/samsung/android/settings/accessibility/directionlock/DirectionLockSplashActivity;->mLockScreenType:Landroid/support/v7/preference/PreferenceCategory;

    const/4 v5, 0x3

    invoke-virtual {v4, v5}, Landroid/support/v7/preference/PreferenceCategory;->seslSetSubheaderRoundedBg(I)V
