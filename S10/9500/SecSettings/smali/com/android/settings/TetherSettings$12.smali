...
.method constructor <init>(Lcom/android/settings/TetherSettings;Landroid/content/SharedPreferences$Editor;Landroid/widget/CheckBox;)V
    ...
    iput-object p2, p0, Lcom/android/settings/TetherSettings$12;->val$edit:Landroid/content/SharedPreferences$Editor;

    iput-object p3, p0, Lcom/android/settings/TetherSettings$12;->val$dnsCheckBox:Landroid/widget/CheckBox;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object v0, p0, Lcom/android/settings/TetherSettings$12;->val$edit:Landroid/content/SharedPreferences$Editor;

    const-string v1, "pref_dns_usb_tether_wifi_on"

    iget-object v2, p0, Lcom/android/settings/TetherSettings$12;->val$dnsCheckBox:Landroid/widget/CheckBox;
    ...
    invoke-virtual {v1, v2}, Lcom/android/settings/TetherSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Landroid/net/wifi/WifiManager;

    invoke-static {v0, v1}, Lcom/android/settings/TetherSettings;->access$602(Lcom/android/settings/TetherSettings;Landroid/net/wifi/WifiManager;)Landroid/net/wifi/WifiManager;

    iget-object v0, p0, Lcom/android/settings/TetherSettings$12;->this$0:Lcom/android/settings/TetherSettings;

    invoke-static {v0}, Lcom/android/settings/TetherSettings;->access$600(Lcom/android/settings/TetherSettings;)Landroid/net/wifi/WifiManager;
