...
.method private getNonIndexableKeysFromProvider(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/settings/search/SettingsSearchIndexablesProvider;->getNonIndexableKeysFromProvider(Landroid/content/Context;Landroid/os/Bundle;)Ljava/util/List;
...
.method private getNonIndexableKeysFromProvider(Landroid/content/Context;Landroid/os/Bundle;)Ljava/util/List;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v8, v9}, Lcom/samsung/android/settings/Log;->v(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v8, v9, v7}, Lcom/samsung/android/settings/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method private getSearchIndexableRawFromProvider(Landroid/content/Context;)Ljava/util/List;
    ...
    iget-object v8, v7, Lcom/android/settings/search/SearchIndexableRaw;->className:Ljava/lang/String;
...
.method private getSearchIndexableResourcesFromProvider(Landroid/content/Context;)Ljava/util/List;
    ...
    const-class v6, Lcom/android/settings/accounts/AccountDashboardFragment;
    ...
    const-class v6, Lcom/samsung/android/settings/CloudAccountSettings;
    ...
    const-class v6, Lcom/android/settings/applications/DefaultAppSettings;
    ...
    const-class v6, Lcom/android/settings/applications/SpecialAccessSettings;
...
.method private getSearchVariableRawFromProvider(Landroid/content/Context;)Ljava/util/List;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-class v4, Lcom/samsung/android/settings/search/SecIndexable;
    ...
    const-string v6, "Not SecIndexable: "
    ...
    check-cast v4, Lcom/samsung/android/settings/search/SecIndexable$SecSearchIndexProvider;
    ...
    invoke-interface {v4, p1, v5}, Lcom/samsung/android/settings/search/SecIndexable$SecSearchIndexProvider;->secGetVariableRawDataToIndex(Landroid/content/Context;Z)Ljava/util/List;
    ...
    check-cast v7, Lcom/samsung/android/settings/search/SecSearchIndexableVariableRaw;

    invoke-virtual {v3}, Ljava/lang/Class;->getName()Ljava/lang/String;

    move-result-object v8

    iput-object v8, v7, Lcom/samsung/android/settings/search/SecSearchIndexableVariableRaw;->className:Ljava/lang/String;
...
.method public secQueryNonIndexableKeys([Ljava/lang/String;Landroid/os/Bundle;)Landroid/database/Cursor;
    ...
    invoke-direct {p0, v1, p2}, Lcom/android/settings/search/SettingsSearchIndexablesProvider;->getNonIndexableKeysFromProvider(Landroid/content/Context;Landroid/os/Bundle;)Ljava/util/List;
...
.method public secQueryVariableRawData([Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-direct {p0, v1}, Lcom/android/settings/search/SettingsSearchIndexablesProvider;->getSearchVariableRawFromProvider(Landroid/content/Context;)Ljava/util/List;
    ...
    check-cast v3, Lcom/samsung/android/settings/search/SecSearchIndexableVariableRaw;
    ...
    iget-object v6, v3, Lcom/samsung/android/settings/search/SecSearchIndexableVariableRaw;->title:Ljava/lang/String;

    aput-object v6, v4, v5

    const/4 v5, 0x2

    iget-object v6, v3, Lcom/samsung/android/settings/search/SecSearchIndexableVariableRaw;->summary:Ljava/lang/String;

    aput-object v6, v4, v5

    const/4 v5, 0x4

    iget-object v6, v3, Lcom/samsung/android/settings/search/SecSearchIndexableVariableRaw;->entries:Ljava/lang/String;

    aput-object v6, v4, v5

    const/4 v5, 0x5

    iget-object v6, v3, Lcom/samsung/android/settings/search/SecSearchIndexableVariableRaw;->keywords:Ljava/lang/String;

    aput-object v6, v4, v5

    const/4 v5, 0x6

    iget-object v6, v3, Lcom/samsung/android/settings/search/SecSearchIndexableVariableRaw;->screenTitle:Ljava/lang/String;

    aput-object v6, v4, v5

    const/4 v5, 0x7

    iget-object v6, v3, Lcom/samsung/android/settings/search/SecSearchIndexableVariableRaw;->className:Ljava/lang/String;

    aput-object v6, v4, v5

    iget v5, v3, Lcom/samsung/android/settings/search/SecSearchIndexableVariableRaw;->iconResId:I

    invoke-static {v5}, Ljava/lang/String;->valueOf(I)Ljava/lang/String;

    move-result-object v5

    iget-object v6, v3, Lcom/samsung/android/settings/search/SecSearchIndexableVariableRaw;->iconUri:Ljava/lang/String;
    ...
    iget-object v5, v3, Lcom/samsung/android/settings/search/SecSearchIndexableVariableRaw;->iconUri:Ljava/lang/String;
    ...
    iget-object v7, v3, Lcom/samsung/android/settings/search/SecSearchIndexableVariableRaw;->intentAction:Ljava/lang/String;

    aput-object v7, v4, v6

    const/16 v6, 0xa

    iget-object v7, v3, Lcom/samsung/android/settings/search/SecSearchIndexableVariableRaw;->intentTargetPackage:Ljava/lang/String;

    aput-object v7, v4, v6

    const/16 v6, 0xb

    iget-object v7, v3, Lcom/samsung/android/settings/search/SecSearchIndexableVariableRaw;->intentTargetClass:Ljava/lang/String;

    aput-object v7, v4, v6

    const/16 v6, 0xc

    iget-object v7, v3, Lcom/samsung/android/settings/search/SecSearchIndexableVariableRaw;->key:Ljava/lang/String;

    aput-object v7, v4, v6

    const/16 v6, 0xd

    iget v7, v3, Lcom/samsung/android/settings/search/SecSearchIndexableVariableRaw;->userId:I
