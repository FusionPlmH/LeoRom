...
.method static synthetic access$000(Lcom/android/settings/notification/NotificationSettingsBase;Landroid/app/NotificationChannel;)Ljava/lang/String;
    .locals 1

    invoke-direct {p0, p1}, Lcom/android/settings/notification/NotificationSettingsBase;->getImportanceSummary(Landroid/app/NotificationChannel;)Ljava/lang/String;
...
.method private getImportanceSummary(Landroid/app/NotificationChannel;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lcom/android/settings/notification/NotificationSettingsBase;->hasValidSound(Landroid/app/NotificationChannel;)Z
...
.method protected isChannelBlockable(Landroid/app/NotificationChannel;)Z
    ...
    invoke-static {v0, v1, p1}, Lcom/android/settingslib/SecNotificationBlockManager;->isBlockableNotificationChannel(Landroid/content/Context;Ljava/lang/String;Landroid/app/NotificationChannel;)Z
...
.method protected populateSingleChannelPrefs(Landroid/support/v7/preference/PreferenceGroup;Landroid/app/NotificationChannel;Z)Lcom/android/settings/widget/MasterSwitchPreference;
    .locals 5
    ...
    const-string v2, "miscellaneous channel exception :"
    ...
    :goto_0
    invoke-virtual {v0, v1}, Lcom/android/settings/widget/MasterSwitchPreference;->setSwitchEnabled(Z)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/settings/widget/MasterSwitchPreference;->setIntent(Landroid/content/Intent;)V

    new-instance v2, Lcom/android/settings/notification/NotificationSettingsBase$1;

    invoke-direct {v2, p0, p2, v0}, Lcom/android/settings/notification/NotificationSettingsBase$1;-><init>(Lcom/android/settings/notification/NotificationSettingsBase;Landroid/app/NotificationChannel;Lcom/android/settings/widget/MasterSwitchPreference;)V

    invoke-virtual {v0, v2}, Lcom/android/settings/widget/MasterSwitchPreference;->setOnPreferenceChangeListener(Landroid/support/v7/preference/Preference$OnPreferenceChangeListener;)V

    invoke-direct {p0, p2}, Lcom/android/settings/notification/NotificationSettingsBase;->getImportanceSummary(Landroid/app/NotificationChannel;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, v2}, Lcom/android/settings/widget/MasterSwitchPreference;->setSummary(Ljava/lang/CharSequence;)V
