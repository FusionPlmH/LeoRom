...
# instance fields
.field private final META_DATA_DEXMODE_QUICK_PACEL:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    const-string v0, "android.service.quicksettings.SEM_DEFAULT_TILE_DEXMODE_ONLY"

    iput-object v0, p0, Lcom/android/settings/development/qstile/DevelopmentTilePreferenceController;->META_DATA_DEXMODE_QUICK_PACEL:Ljava/lang/String;
...
.method public displayPreference(Landroid/support/v7/preference/PreferenceScreen;)V
    ...
    iget-boolean v9, v5, Landroid/content/pm/ServiceInfo;->enabled:Z
    ...
    const-string v10, "android.service.quicksettings.SEM_DEFAULT_TILE_DEXMODE_ONLY"
    ...
    iget-object v10, p0, Lcom/android/settings/development/qstile/DevelopmentTilePreferenceController;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    invoke-virtual {v7, v10}, Landroid/support/v14/preference/SwitchPreference;->setTitle(Ljava/lang/CharSequence;)V

    iget v10, v5, Landroid/content/pm/ServiceInfo;->icon:I

    invoke-virtual {v7, v10}, Landroid/support/v14/preference/SwitchPreference;->setIcon(I)V

    iget-object v10, v5, Landroid/content/pm/ServiceInfo;->name:Ljava/lang/String;

    invoke-virtual {v7, v10}, Landroid/support/v14/preference/SwitchPreference;->setKey(Ljava/lang/String;)V

    invoke-virtual {v7, v8}, Landroid/support/v14/preference/SwitchPreference;->setChecked(Z)V

    iget-object v10, p0, Lcom/android/settings/development/qstile/DevelopmentTilePreferenceController;->mOnChangeHandler:Lcom/android/settings/development/qstile/DevelopmentTilePreferenceController$OnChangeHandler;
    ...
    invoke-virtual {p1, v7}, Landroid/support/v7/preference/PreferenceScreen;->addPreference(Landroid/support/v7/preference/Preference;)Z
