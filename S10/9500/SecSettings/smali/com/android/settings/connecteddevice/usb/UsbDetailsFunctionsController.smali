...
.method protected refresh(ZJII)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/preference/PreferenceCategory;->setEnabled(Z)V
    ...
    invoke-direct {p0, v6, v5}, Lcom/android/settings/connecteddevice/usb/UsbDetailsFunctionsController;->getProfilePreference(Ljava/lang/String;I)Lcom/samsung/android/settings/widget/SecRadioButtonPreference;
    ...
    :goto_3
    invoke-virtual {v6, v7}, Lcom/samsung/android/settings/widget/SecRadioButtonPreference;->setChecked(Z)V
