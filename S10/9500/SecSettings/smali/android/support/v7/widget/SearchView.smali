...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget v4, Landroid/support/v7/appcompat/R$layout;->sesl_search_view:I
    ...
    sget v5, Landroid/support/v7/appcompat/R$id;->search_more_btn:I
    ...
    iput-object v5, p0, Landroid/support/v7/widget/SearchView;->mMoreButton:Landroid/widget/ImageView;

    sget v5, Landroid/support/v7/appcompat/R$id;->search_back_btn:I
    ...
    iput-object v5, p0, Landroid/support/v7/widget/SearchView;->mBackButton:Landroid/widget/ImageView;
    ...
    invoke-virtual {v5, v6}, Landroid/widget/ImageView;->setTooltipText(Ljava/lang/CharSequence;)V
    ...
    iget-object v6, p0, Landroid/support/v7/widget/SearchView;->mGoButton:Landroid/widget/ImageView;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/SearchView;->mVoiceButton:Landroid/widget/ImageView;
    ...
    iget-object v5, p0, Landroid/support/v7/widget/SearchView;->mMoreButton:Landroid/widget/ImageView;

    iget-object v6, p0, Landroid/support/v7/widget/SearchView;->mMoreButton:Landroid/widget/ImageView;
    ...
    iget-object v5, p0, Landroid/support/v7/widget/SearchView;->mBackButton:Landroid/widget/ImageView;

    iget-object v6, p0, Landroid/support/v7/widget/SearchView;->mBackButton:Landroid/widget/ImageView;
    ...
    sget v6, Landroid/support/v7/appcompat/R$layout;->sesl_search_dropdown_item_icons_2line:I
    ...
    iput v5, p0, Landroid/support/v7/widget/SearchView;->mSuggestionCommitIconResId:I

    iget-object v5, p0, Landroid/support/v7/widget/SearchView;->mSearchButton:Landroid/widget/ImageView;

    iget-object v6, p0, Landroid/support/v7/widget/SearchView;->mOnClickListener:Landroid/view/View$OnClickListener;
    ...
    invoke-virtual {v5, v6}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v5, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    iget-object v6, p0, Landroid/support/v7/widget/SearchView;->mTextWatcher:Landroid/text/TextWatcher;

    invoke-virtual {v5, v6}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->addTextChangedListener(Landroid/text/TextWatcher;)V

    iget-object v5, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    iget-object v6, p0, Landroid/support/v7/widget/SearchView;->mOnEditorActionListener:Landroid/widget/TextView$OnEditorActionListener;

    invoke-virtual {v5, v6}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->setOnEditorActionListener(Landroid/widget/TextView$OnEditorActionListener;)V

    iget-object v5, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    iget-object v6, p0, Landroid/support/v7/widget/SearchView;->mOnItemClickListener:Landroid/widget/AdapterView$OnItemClickListener;

    invoke-virtual {v5, v6}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v5, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    iget-object v6, p0, Landroid/support/v7/widget/SearchView;->mOnItemSelectedListener:Landroid/widget/AdapterView$OnItemSelectedListener;

    invoke-virtual {v5, v6}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V

    iget-object v5, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    iget-object v6, p0, Landroid/support/v7/widget/SearchView;->mTextKeyListener:Landroid/view/View$OnKeyListener;

    invoke-virtual {v5, v6}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->setOnKeyListener(Landroid/view/View$OnKeyListener;)V

    iget-object v5, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    new-instance v6, Landroid/support/v7/widget/SearchView$3;

    invoke-direct {v6, p0}, Landroid/support/v7/widget/SearchView$3;-><init>(Landroid/support/v7/widget/SearchView;)V

    invoke-virtual {v5, v6}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->setOnFocusChangeListener(Landroid/view/View$OnFocusChangeListener;)V

    sget v5, Landroid/support/v7/appcompat/R$styleable;->SearchView_iconifiedByDefault:I

    invoke-virtual {v0, v5, v4}, Landroid/support/v7/widget/TintTypedArray;->getBoolean(IZ)Z

    move-result v4

    invoke-virtual {p0, v4}, Landroid/support/v7/widget/SearchView;->setIconifiedByDefault(Z)V

    sget v4, Landroid/support/v7/appcompat/R$styleable;->SearchView_android_maxWidth:I
    ...
    invoke-virtual {p0, v4}, Landroid/support/v7/widget/SearchView;->setMaxWidth(I)V

    :cond_1
    sget v6, Landroid/support/v7/appcompat/R$styleable;->SearchView_defaultQueryHint:I

    invoke-virtual {v0, v6}, Landroid/support/v7/widget/TintTypedArray;->getText(I)Ljava/lang/CharSequence;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/SearchView;->mDefaultQueryHint:Ljava/lang/CharSequence;

    sget v6, Landroid/support/v7/appcompat/R$styleable;->SearchView_queryHint:I

    invoke-virtual {v0, v6}, Landroid/support/v7/widget/TintTypedArray;->getText(I)Ljava/lang/CharSequence;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/SearchView;->mQueryHint:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0, v7, v5}, Landroid/support/v7/widget/TintTypedArray;->getInt(II)I
    ...
    invoke-virtual {v0, v8, v5}, Landroid/support/v7/widget/TintTypedArray;->getBoolean(IZ)Z

    move-result v5

    invoke-virtual {p0, v5}, Landroid/support/v7/widget/SearchView;->setFocusable(Z)V

    iget-object v8, p0, Landroid/support/v7/widget/SearchView;->mCollapsedIcon:Landroid/widget/ImageView;

    sget v9, Landroid/support/v7/appcompat/R$styleable;->SearchView_searchIcon:I

    invoke-virtual {v0, v9}, Landroid/support/v7/widget/TintTypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v8, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;
    ...
    iput-object v8, p0, Landroid/support/v7/widget/SearchView;->mImm:Landroid/view/inputmethod/InputMethodManager;

    iget-object v8, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    invoke-static {v8}, Landroid/support/v4/widget/SeslTextViewReflector;->getField_SEM_AUTOFILL_ID(Landroid/widget/TextView;)I

    move-result v8

    if-eqz v8, :cond_5

    iget-object v9, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    invoke-static {v9, v8, v1}, Landroid/support/v4/widget/SeslTextViewReflector;->semSetActionModeMenuItemEnabled(Landroid/widget/TextView;IZ)V
...
.method adjustDropDownSizeAndPosition()V
    ...
    invoke-virtual {v5, v4}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->setDropDownHorizontalOffset(I)V

    iget-object v5, p0, Landroid/support/v7/widget/SearchView;->mDropDownAnchor:Landroid/view/View;
    ...
    invoke-virtual {v6}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->showDropDown()V
...
.method onCloseClicked()V
    ...
    invoke-static {v2, v3}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->access$000(Landroid/support/v7/widget/SearchView$SearchAutoComplete;Z)V
    ...
    invoke-static {v3, v2}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->access$000(Landroid/support/v7/widget/SearchView$SearchAutoComplete;Z)V
...
.method onSearchClicked()V
    ...
    invoke-static {v2, v0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->access$000(Landroid/support/v7/widget/SearchView$SearchAutoComplete;Z)V
