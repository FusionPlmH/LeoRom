...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/MenuBuilder;Landroid/view/View;IIZ)V
    ...
    iput v3, p0, Landroid/support/v7/view/menu/StandardMenuPopup;->mPopupMaxWidth:I

    iput-object p3, p0, Landroid/support/v7/view/menu/StandardMenuPopup;->mAnchorView:Landroid/view/View;

    new-instance v3, Landroid/support/v7/widget/MenuPopupWindow;
    ...
    iput-object v3, p0, Landroid/support/v7/view/menu/StandardMenuPopup;->mPopup:Landroid/support/v7/widget/MenuPopupWindow;

    iget-object v3, p0, Landroid/support/v7/view/menu/StandardMenuPopup;->mContext:Landroid/content/Context;

    invoke-virtual {p2, p0, v3}, Landroid/support/v7/view/menu/MenuBuilder;->addMenuPresenter(Landroid/support/v7/view/menu/MenuPresenter;Landroid/content/Context;)V
...
.method private tryShow()Z
    ...
    sget v7, Landroid/support/v7/appcompat/R$layout;->sesl_popup_menu_header_item_layout:I
