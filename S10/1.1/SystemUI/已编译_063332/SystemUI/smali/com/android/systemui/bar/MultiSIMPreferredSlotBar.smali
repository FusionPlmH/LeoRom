...
.method private getBarVisibility()Z
    ...
    invoke-virtual {p0}, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;->isMultiSimEnabled()Z
...
.method private initBarViews(Landroid/view/ViewGroup;)V
    ...
    sget-boolean v4, Lcom/android/systemui/Rune;->QPANEL_SUPPORT_CTC_SIM_CARD_MANAGER:Z
    ...
    invoke-static {v4}, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar$PrefferedSlotButton;->access$3100(Lcom/android/systemui/bar/MultiSIMPreferredSlotBar$PrefferedSlotButton;)Landroid/view/ViewGroup;
    ...
    new-instance v4, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar$9;

    invoke-direct {v4, p0}, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar$9;-><init>(Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;)V

    invoke-virtual {v3, v4}, Landroid/widget/LinearLayout;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    new-instance v4, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar$10;

    invoke-direct {v4, p0}, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar$10;-><init>(Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;)V
    ...
    iput-object v4, p0, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;->SimState_1:Ljava/lang/String;
    ...
    invoke-static {v4, v7, v8}, Landroid/telephony/TelephonyManager;->getTelephonyProperty(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iput-object v4, p0, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;->SimState_2:Ljava/lang/String;
    ...
    iput v4, p0, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;->mPopupWindowTopMargin:I
    ...
    iput v4, p0, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;->mPopupNormalTextColor:I
    ...
    iput v4, p0, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;->mPopupSelectedTextColor:I
...
.method private selectNetworkMode(I)V
    ...
    iget-object v11, p0, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;->SimState_1:Ljava/lang/String;
    ...
    iget-object v11, p0, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;->SimState_2:Ljava/lang/String;
    ...
    invoke-static {v0, v11}, Lcom/android/systemui/util/MultiSimMgrUtils;->isEnabledSim(Landroid/content/Context;I)Z
    ...
    const-string v4, "CTC card set to GSM only so need force off , except CTC + CTC"

    invoke-static {v0, v4}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    iput-boolean v9, p0, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;->mCTCforceoff:Z

    iget v0, p0, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;->simSlotIndex:I

    invoke-direct {p0, v9, v0}, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;->setPreferredNetworkMode(II)V

    iget-object v0, p0, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;->mHandler:Landroid/os/Handler;

    iget-object v4, p0, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;->mHandler:Landroid/os/Handler;
    ...
    const-string v2, "4G+4G set N/W mode: "
    ...
    invoke-virtual {v11, v7, v10, p1}, Landroid/os/Handler;->obtainMessage(III)Landroid/os/Message;

    move-result-object v7

    invoke-virtual {v1, v8, v2, v3, v7}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/os/Handler;->sendMessage(Landroid/os/Message;)Z

    iput-boolean v9, p0, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;->Netchangefinished:Z
    ...
    iget-object v9, p0, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;->mHandler:Landroid/os/Handler;

    iget v11, p0, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;->simSlotIndex:I

    invoke-virtual {v9, v7, v10, v11}, Landroid/os/Handler;->obtainMessage(III)Landroid/os/Message;
    ...
    iput-boolean v10, p0, Lcom/android/systemui/bar/MultiSIMPreferredSlotBar;->Netchangefinished:Z
    ...
    const-string v2, "handleSetPreferredNetworkTypeResponse set slave slot"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, p1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v2, " by Mojito conditoin"
    ...
    invoke-virtual {v4, v5, v10, v6}, Landroid/os/Handler;->obtainMessage(III)Landroid/os/Message;
...
.method private updateSlotButtonState()V
    .locals 2
...
.method public isMultiSimEnabled()Z
    ...
    sget-boolean v0, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoQsMultiSIMBarEnabled:Z
