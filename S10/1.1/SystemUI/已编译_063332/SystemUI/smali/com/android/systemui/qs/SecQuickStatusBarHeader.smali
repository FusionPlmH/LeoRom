...
.field private mLeoDeviceInfo:Lcom/android/systemui/fusionleo/LeoDeviceInformation;
...
.method private updateColors()V
    ...
    :cond_5
    invoke-virtual {p0, v0}, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->updateLeoBatteryColors(Z)V
    ...
    :cond_7
    const-string/jumbo v0, "status_bar_date_clock_color"

    invoke-static {v0}, Lcom/fusionleo/LeoX/systemui/LeoConfig;->getLeoColor(Ljava/lang/String;)I

    move-result v0

    invoke-virtual {p0, v0}, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->updateLeoDeviceInfoColors(I)V
...
.method private updateResources()V
    ...
    invoke-virtual {v5, v3, v2, v4, v2}, Landroid/view/View;->setPadding(IIII)V

    :cond_3
    iget-object v3, p0, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->mHeaderQsPanel:Lcom/android/systemui/qs/QuickQSPanel;
    ...
    iget-boolean v5, p0, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->mQsDisabled:Z
    ...
    invoke-virtual {p0, v4}, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
...
.method private updateSidePadding()V
    ...
    :goto_0
    iget-object v4, p0, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->mSystemIconsView:Landroid/view/View;

    const/4 v5, 0x0

    invoke-virtual {v4, v1, v5, v2, v5}, Landroid/view/View;->setPaddingRelative(IIII)V
    ...
    const-string/jumbo v6, "updateResources: startPadding = "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v5, v1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v6, " endPadding = "
...
.method public getQuickQsPanel()Landroid/view/ViewGroup;
    .locals 1
...
.method public updateLeoBatteryColors(Z)V
    .locals 3
    ...
    check-cast v0, Lcom/android/systemui/fusionleo/LeoMainBattery;
    ...
    :goto_0
    invoke-virtual {v0, v1, v2}, Lcom/android/systemui/fusionleo/LeoMainBattery;->setForceQsTintColor(ZF)V

    :cond_1
    return-void
.end method

.method public updateLeoDeviceInfoColors(I)V
    .locals 2

    iget-object v0, p0, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->mLeoDeviceInfo:Lcom/android/systemui/fusionleo/LeoDeviceInformation;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p1}, Lcom/android/systemui/fusionleo/LeoDeviceInformation;->setTextColor(I)V

    iget-object v0, p0, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->mLeoDeviceInfo:Lcom/android/systemui/fusionleo/LeoDeviceInformation;

    const v1, 0x3f333333    # 0.7f

    invoke-virtual {v0, v1}, Lcom/android/systemui/fusionleo/LeoDeviceInformation;->setAlpha(F)V
...
.method public updateQSColoringResources(Landroid/view/View;)V
    ...
    invoke-virtual {p0, v5}, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->updateLeoBatteryColors(Z)V
...
.method public updateSecQuickStatusBar()V
    ...
    sget v1, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoUesrStatusbarNetworkState:I

    if-lez v1, :cond_0

    const/16 v2, 0x8

    invoke-virtual {v0, v2}, Lcom/android/systemui/statusbar/policy/NetspeedView;->setVisibility(I)V
    ...
    :cond_1
    :goto_0
    const-string v2, "leo_qs_battery_view"

    invoke-virtual {p0, v2}, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->findViewWithTag(Ljava/lang/Object;)Landroid/view/View;
    ...
    invoke-virtual {p0, v2, v3, v3}, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->setViewSize(Landroid/widget/ImageView;II)V

    const-string v4, "id/battery"

    invoke-static {v4}, Lcom/fusionleo/LeoProvider/LeoManages;->getLeoUIResource(Ljava/lang/String;)I

    move-result v4

    invoke-virtual {p0, v4}, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->findViewById(I)Landroid/view/View;

    move-result-object v4

    check-cast v4, Lcom/android/systemui/BatteryMeterView;

    iput-object v4, p0, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->mBatteryMeterView:Lcom/android/systemui/BatteryMeterView;

    invoke-virtual {v2}, Lcom/android/systemui/fusionleo/LeoMainBattery;->updateSettings()V

    iget-object v4, p0, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->mBatteryMeterView:Lcom/android/systemui/BatteryMeterView;

    invoke-virtual {v4}, Lcom/android/systemui/BatteryMeterView;->updateSettings()V

    const-string v4, "leo_qs_device_info_view"

    invoke-virtual {p0, v4}, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->findViewWithTag(Ljava/lang/Object;)Landroid/view/View;

    move-result-object v4

    check-cast v4, Lcom/android/systemui/fusionleo/LeoDeviceInformation;

    iput-object v4, p0, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->mLeoDeviceInfo:Lcom/android/systemui/fusionleo/LeoDeviceInformation;

    iget-object v4, p0, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->mLeoDeviceInfo:Lcom/android/systemui/fusionleo/LeoDeviceInformation;

    const/4 v5, 0x1

    invoke-virtual {v4, v5}, Lcom/android/systemui/fusionleo/LeoDeviceInformation;->setFocusable(Z)V

    iget-object v4, p0, Lcom/android/systemui/qs/SecQuickStatusBarHeader;->mLeoDeviceInfo:Lcom/android/systemui/fusionleo/LeoDeviceInformation;

    invoke-virtual {v4}, Lcom/android/systemui/fusionleo/LeoDeviceInformation;->updateQSDeviceInfo()V
