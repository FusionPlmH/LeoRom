...
# interfaces
.implements Lcom/android/systemui/statusbar/SecStatusBarIconBugDetectorInterface;
...
# static fields
.field private static final AIRPLANE_DEBUG:Z
...
.field private mLayoutBugDetector:Lcom/android/systemui/statusbar/SecStatusBarIconBugDetector;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/systemui/statusbar/StatusBarIconView;->AIRPLANE_DEBUG:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    new-instance v1, Lcom/android/systemui/statusbar/SecStatusBarIconBugDetector;

    invoke-direct {v1, p0}, Lcom/android/systemui/statusbar/SecStatusBarIconBugDetector;-><init>(Landroid/view/View;)V

    iput-object v1, p0, Lcom/android/systemui/statusbar/StatusBarIconView;->mLayoutBugDetector:Lcom/android/systemui/statusbar/SecStatusBarIconBugDetector;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/service/notification/StatusBarNotification;Z)V
    ...
    const-string v0, "Airplane Icon is applied FIT_CENTER"

    invoke-direct {p0, v0}, Lcom/android/systemui/statusbar/StatusBarIconView;->printAirplaneIconBugLog(Ljava/lang/String;)V
...
.method private isAirplaneIcon()Z
    .locals 2
...
.method public static synthetic lambda$setDark$2(Lcom/android/systemui/statusbar/StatusBarIconView;Ljava/lang/Float;)V
    .locals 1
...
.method public static synthetic lambda$setVisibility$1(Lcom/android/systemui/statusbar/StatusBarIconView;I)V
    .locals 2
    ...
    const-string v1, ") mOnVisibilityChangedListener is null ? "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v1, p0, Lcom/android/systemui/statusbar/StatusBarIconView;->mOnVisibilityChangedListener:Lcom/android/systemui/statusbar/StatusBarIconView$OnVisibilityChangedListener;
...
.method private printAirplaneIconBugLog(Ljava/lang/String;)V
    .locals 3

    sget-boolean v0, Lcom/android/systemui/statusbar/StatusBarIconView;->AIRPLANE_DEBUG:Z

    if-eqz v0, :cond_2

    invoke-direct {p0}, Lcom/android/systemui/statusbar/StatusBarIconView;->isAirplaneIcon()Z
    ...
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/StatusBarIconView;->isLayoutRequested()Z
    ...
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/StatusBarIconView;->getPivotX()F

    move-result v2

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    const-string v2, ", drawable.IntrW:"
    ...
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/StatusBarIconView;->getPivotY()F

    move-result v2

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    const-string v2, ", drawable.IntrH:"
...
.method private reloadDimens()V
    ...
    const-string/jumbo v2, "reloadDimens() mDotRadius:"
    ...
    const-string v2, ", mStaticDotRadius:"
    ...
    invoke-direct {p0, v1}, Lcom/android/systemui/statusbar/StatusBarIconView;->printAirplaneIconBugLog(Ljava/lang/String;)V
...
.method private updateDrawable(Z)Z
    ...
    const-string/jumbo v1, "updateDrawable(withClear:"
...
.method public needRelayout()Z
    .locals 1

    invoke-virtual {p0}, Lcom/android/systemui/statusbar/StatusBarIconView;->isIconVisible()Z
...
.method public requestLayoutToFixLayoutBug()V
    .locals 1

    iget-object v0, p0, Lcom/android/systemui/statusbar/StatusBarIconView;->mLayoutBugDetector:Lcom/android/systemui/statusbar/SecStatusBarIconBugDetector;

    invoke-virtual {v0}, Lcom/android/systemui/statusbar/SecStatusBarIconBugDetector;->requestLayoutToFixLayoutBugFromExternal()V
...
.method public setDark(ZZJ)V
    ...
    new-instance v1, Lcom/android/systemui/statusbar/-$$Lambda$StatusBarIconView$mR9jHXvYES3oc1DSUDz5-t-pZlg;

    invoke-direct {v1, p0}, Lcom/android/systemui/statusbar/-$$Lambda$StatusBarIconView$mR9jHXvYES3oc1DSUDz5-t-pZlg;-><init>(Lcom/android/systemui/statusbar/StatusBarIconView;)V
...
.method public setVisibility(I)V
    ...
    :cond_0
    new-instance v0, Lcom/android/systemui/statusbar/-$$Lambda$StatusBarIconView$Gn9wT17tDgOt2Vv1jizJdOCYxRc;

    invoke-direct {v0, p0, p1}, Lcom/android/systemui/statusbar/-$$Lambda$StatusBarIconView$Gn9wT17tDgOt2Vv1jizJdOCYxRc;-><init>(Lcom/android/systemui/statusbar/StatusBarIconView;I)V

    invoke-virtual {p0, v0}, Lcom/android/systemui/statusbar/StatusBarIconView;->post(Ljava/lang/Runnable;)Z
