...
# instance fields
.field private final INITIAL_SCREEN:I

.field private final NOT_SET:I

.field private final SET_BIXBY_DIALOG:I

.field private final SET_GLOBALACTION_DIALOG:I
...
# direct methods
.method public constructor <init>(Lcom/samsung/android/globalactions/presentation/SecGlobalActions;Lcom/samsung/android/globalactions/presentation/viewmodel/ActionViewModelFactory;Lcom/samsung/android/globalactions/util/ConditionChecker;Lcom/samsung/android/globalactions/util/BixbyHandler;Lcom/samsung/android/globalactions/util/SettingsWrapper;Lcom/samsung/android/globalactions/util/ThemeChecker;Lcom/samsung/android/globalactions/util/LogWrapper;)V
    .locals 1
    ...
    iput v0, p0, Lcom/android/systemui/globalactions/features/BixbyOnPowerKeyStrategy;->NOT_SET:I

    const/4 v0, 0x0

    iput v0, p0, Lcom/android/systemui/globalactions/features/BixbyOnPowerKeyStrategy;->INITIAL_SCREEN:I

    const/4 v0, 0x1

    iput v0, p0, Lcom/android/systemui/globalactions/features/BixbyOnPowerKeyStrategy;->SET_GLOBALACTION_DIALOG:I
    ...
    iput-object p6, p0, Lcom/android/systemui/globalactions/features/BixbyOnPowerKeyStrategy;->mThemeChecker:Lcom/samsung/android/globalactions/util/ThemeChecker;

    iput-object p7, p0, Lcom/android/systemui/globalactions/features/BixbyOnPowerKeyStrategy;->mLogWrapper:Lcom/samsung/android/globalactions/util/LogWrapper;
...
.method public onInitialize(Z)V
    ...
    iget-object v2, p0, Lcom/android/systemui/globalactions/features/BixbyOnPowerKeyStrategy;->mSettingsWrapper:Lcom/samsung/android/globalactions/util/SettingsWrapper;

    invoke-virtual {v2, v1}, Lcom/samsung/android/globalactions/util/SettingsWrapper;->setBixbySettings(I)V
    ...
    iget-object v3, p0, Lcom/android/systemui/globalactions/features/BixbyOnPowerKeyStrategy;->mThemeChecker:Lcom/samsung/android/globalactions/util/ThemeChecker;

    invoke-virtual {v3}, Lcom/samsung/android/globalactions/util/ThemeChecker;->getState()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, v3}, Lcom/samsung/android/globalactions/util/BixbyHandler;->startInitialScreenActivity(Ljava/lang/String;)V
    ...
    sget-object v3, Lcom/android/systemui/globalactions/util/SystemUIConditions;->IS_BIXBY_ACTIVITY_SHOWS_ON_TOP:Lcom/android/systemui/globalactions/util/SystemUIConditions;
    ...
    invoke-virtual {v2, v3}, Lcom/samsung/android/globalactions/util/SettingsWrapper;->setBixbySettings(I)V
