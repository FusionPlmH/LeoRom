...
.field private mQSTileLayoutTop:I

.field private mQsDisabled:Z

.field private mQsPanel:Lcom/android/systemui/qs/QSPanel;

.field private mQuickQSPanelTop:I
...
.field private mUselessHiddenExpandedBarsHeight:I
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/phone/StatusBar;Lcom/android/systemui/statusbar/phone/ScrimController;)V
    ...
    iput v0, p0, Lcom/android/systemui/bar/BarController;->mUselessHiddenExpandedBarsHeight:I

    iput-boolean v0, p0, Lcom/android/systemui/bar/BarController;->mShowButtonBackground:Z
...
.method static synthetic access$200(Lcom/android/systemui/bar/BarController;)Lcom/android/systemui/qs/QSPanel;
    .locals 1

    iget-object v0, p0, Lcom/android/systemui/bar/BarController;->mQsPanel:Lcom/android/systemui/qs/QSPanel;

    return-object v0
.end method

.method static synthetic access$300(Lcom/android/systemui/bar/BarController;)Lcom/android/systemui/qs/SecQuickStatusBarHeader;
    .locals 1

    iget-object v0, p0, Lcom/android/systemui/bar/BarController;->mHeader:Lcom/android/systemui/qs/SecQuickStatusBarHeader;

    return-object v0
.end method

.method static synthetic access$400(Lcom/android/systemui/bar/BarController;)I
    .locals 1

    iget v0, p0, Lcom/android/systemui/bar/BarController;->mQSTileLayoutTop:I

    return v0
.end method

.method static synthetic access$402(Lcom/android/systemui/bar/BarController;I)I
    .locals 0

    iput p1, p0, Lcom/android/systemui/bar/BarController;->mQSTileLayoutTop:I

    return p1
.end method

.method static synthetic access$500(Lcom/android/systemui/bar/BarController;)I
    .locals 1

    iget v0, p0, Lcom/android/systemui/bar/BarController;->mQuickQSPanelTop:I

    return v0
.end method

.method static synthetic access$502(Lcom/android/systemui/bar/BarController;I)I
    .locals 0

    iput p1, p0, Lcom/android/systemui/bar/BarController;->mQuickQSPanelTop:I

    return p1
.end method

.method static synthetic access$600(Lcom/android/systemui/bar/BarController;)I
    .locals 1
...
.method static synthetic access$700(Lcom/android/systemui/bar/BarController;)I
    .locals 1

    iget v0, p0, Lcom/android/systemui/bar/BarController;->mUselessHiddenExpandedBarsHeight:I

    return v0
.end method

.method static synthetic access$800(Lcom/android/systemui/bar/BarController;)Landroid/content/Context;
    .locals 1
...
.method static synthetic access$900(Lcom/android/systemui/bar/BarController;)Ljava/util/LinkedHashMap;
    .locals 1
...
.method private addAllBarItems(Ljava/lang/String;Z)V
    ...
    iget-object v3, p0, Lcom/android/systemui/bar/BarController;->mQsPanel:Lcom/android/systemui/qs/QSPanel;
...
.method private calculateHiddenExpandedBarsHeight()V
    ...
    iget-object v3, p0, Lcom/android/systemui/bar/BarController;->mBars:Ljava/util/LinkedHashMap;
    ...
    instance-of v5, v4, Lcom/android/systemui/bar/QSBarItem;
    ...
    invoke-virtual {v5}, Lcom/android/systemui/bar/QSBarItem;->getBarHeight()I

    move-result v6

    add-int/2addr v0, v6

    iget-object v6, p0, Lcom/android/systemui/bar/BarController;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v6, v7, v1}, Lcom/android/systemui/tuner/TunerService;->getValue(Ljava/lang/String;I)I
    ...
    instance-of v6, v4, Lcom/android/systemui/bar/MediaQuickControlBar;

    if-nez v6, :cond_1

    instance-of v6, v4, Lcom/android/systemui/bar/HandlerBar;
    ...
    iput v2, p0, Lcom/android/systemui/bar/BarController;->mUselessHiddenExpandedBarsHeight:I
...
.method public onConfigChanged(Landroid/content/res/Configuration;)V
    ...
    :cond_2
    iget-boolean v0, p0, Lcom/android/systemui/bar/BarController;->mShowButtonBackground:Z
    ...
    :cond_4
    iput-boolean v2, p0, Lcom/android/systemui/bar/BarController;->mShowButtonBackground:Z
    ...
    iget-boolean v3, p0, Lcom/android/systemui/bar/BarController;->mShowButtonBackground:Z

    invoke-virtual {v2, v3}, Lcom/android/systemui/bar/QSBarItem;->updateShowButtonBackground(Z)V
...
.method public onPanelHeightUpdated(FI)V
    ...
    check-cast v4, Lcom/android/systemui/bar/QSBarItem;

    invoke-virtual {v4, v1}, Lcom/android/systemui/bar/QSBarItem;->updateAlphaForAfterImages(F)V
...
.method public setQSPanel(Landroid/view/ViewGroup;)V
    ...
    iput-object v0, p0, Lcom/android/systemui/bar/BarController;->mQsPanel:Lcom/android/systemui/qs/QSPanel;
    ...
    invoke-virtual {v0, v1}, Lcom/android/systemui/qs/QSPanel;->addOnLayoutChangeListener(Landroid/view/View$OnLayoutChangeListener;)V
