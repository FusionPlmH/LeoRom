...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v1, p0, Lcom/android/systemui/BatteryMeterView;->mLayoutBugDetector:Lcom/android/systemui/statusbar/SecStatusBarIconBugDetector;
...
.method private updateShowPercent(Z)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/systemui/BatteryMeterView;->updateLeoBatteryPercentView(Landroid/widget/TextView;)V
...
# virtual methods
.method public addLeoBatteryIconView()V
    .locals 4
    ...
    sget v1, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoStatusbarMainBatteryEnabled:I
...
.method public isBatteryPercentHole()Z
    .locals 6

    const/4 v0, 0x0

    invoke-virtual {p0}, Lcom/android/systemui/BatteryMeterView;->isBatteryPercentVisible()Z
    ...
    const-string v5, "isBatteryIconHole : viewEllipsisBug = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v4, v1}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v5, ", viewHasHole = "
    ...
    invoke-virtual {p0}, Lcom/android/systemui/BatteryMeterView;->getWidth()I
    ...
    const-string v2, "isBatteryIconHole : invisible viewHasHole"
...
.method public onAttachedToWindow()V
    ...
    iget-object v0, p0, Lcom/android/systemui/BatteryMeterView;->mLayoutBugDetector:Lcom/android/systemui/statusbar/SecStatusBarIconBugDetector;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/systemui/BatteryMeterView;->mLayoutBugDetector:Lcom/android/systemui/statusbar/SecStatusBarIconBugDetector;

    invoke-virtual {v0}, Lcom/android/systemui/statusbar/SecStatusBarIconBugDetector;->init()V

    iget-object v0, p0, Lcom/android/systemui/BatteryMeterView;->mLayoutBugDetector:Lcom/android/systemui/statusbar/SecStatusBarIconBugDetector;

    invoke-virtual {v0}, Lcom/android/systemui/statusbar/SecStatusBarIconBugDetector;->addOnGlobalLayoutListener()V
...
.method public onLeoChange(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/systemui/BatteryMeterView;->setLeoBatteryPercentView(Landroid/widget/TextView;)V
...
.method public setLeoBatteryPercentView(Landroid/widget/TextView;)V
    .locals 6
    ...
    sget v1, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoStatusBarBatteryPercentSize:I

    sget v2, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoStatusBarBatteryPercentFont:I

    const-string v3, "sec-roboto-light"

    const/4 v4, 0x0

    invoke-static {v0, v2, v3, v4}, Lcom/fusionleo/LeoX/systemui/LeoConfig;->setLeoFonts(Landroid/content/Context;ILjava/lang/String;I)Landroid/graphics/Typeface;
...
.method public updateLeoBatteryPercentView(Landroid/widget/TextView;)V
    .locals 8

    invoke-virtual {p0, p1}, Lcom/android/systemui/BatteryMeterView;->setLeoBatteryPercentView(Landroid/widget/TextView;)V
...
.method public updateSettings()V
    ...
    invoke-virtual {p0}, Lcom/android/systemui/BatteryMeterView;->addLeoBatteryIconView()V
