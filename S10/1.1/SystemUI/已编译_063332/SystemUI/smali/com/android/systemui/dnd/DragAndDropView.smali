...
.method private updateDropTargetInfo(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v6, v0}, Lcom/android/systemui/dnd/DragAndDropView;->scaleRectCenter(Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-virtual {v6, v2}, Lcom/android/systemui/dnd/DragAndDropView;->scaleRectCenter(Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-virtual {v6, v8}, Lcom/android/systemui/dnd/DragAndDropView;->scaleRectCenter(Landroid/graphics/Rect;)Landroid/graphics/Rect;

    invoke-direct {v6, v9, v13}, Lcom/android/systemui/dnd/DragAndDropView;->isStackVisible(II)Z

    move-result v14

    invoke-direct {v6, v13, v9}, Lcom/android/systemui/dnd/DragAndDropView;->isStackVisible(II)Z
    ...
    :cond_1
    iget-object v13, v6, Lcom/android/systemui/dnd/DragAndDropView;->mDropTargets:Landroid/util/ArrayMap;
    ...
    iget-object v2, v6, Lcom/android/systemui/dnd/DragAndDropView;->mPrimaryView:Landroid/widget/TextView;
    ...
    invoke-virtual {v13, v9, v7}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    goto/16 :goto_3

    :cond_2
    :goto_2
    iget-object v7, v6, Lcom/android/systemui/dnd/DragAndDropView;->mDropTargets:Landroid/util/ArrayMap;
    ...
    iget-object v2, v6, Lcom/android/systemui/dnd/DragAndDropView;->mFullscreenView:Landroid/widget/TextView;
    ...
    iget-object v2, v6, Lcom/android/systemui/dnd/DragAndDropView;->mSecondaryView:Landroid/widget/TextView;
    ...
    invoke-virtual {v7, v13, v9}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const/4 v0, 0x0

    const/16 v1, 0x65

    invoke-direct {v6, v1, v0}, Lcom/android/systemui/dnd/DragAndDropView;->isStackVisible(II)Z
    ...
    iget-object v2, v6, Lcom/android/systemui/dnd/DragAndDropView;->mSidescreenView:Landroid/widget/TextView;
