...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->sConfigured:Z
...
.method private init()V
    ...
    invoke-virtual {v0, v2}, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity$ConvertingDialogUpdateTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;

    new-instance v0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity$EncodingThread;

    iget-object v5, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mVEConverter:Lcom/samsung/android/veconverter/EncodeAniGIFImage;

    iget-object v6, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mConvertingDialogUpdateTask:Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity$ConvertingDialogUpdateTask;

    iget-object v7, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mGifParameters:Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity$GifParameters;
    ...
    :goto_0
    iget-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mSettingDescriptionTextView:Landroid/widget/TextView;

    invoke-virtual {v2, v0}, Landroid/widget/TextView;->setText(I)V

    iget-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mPreviewContainer:Landroid/widget/FrameLayout;
    ...
    iget-object v4, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mContext:Landroid/content/Context;

    invoke-direct {v3, v4, v1}, Landroid/widget/LinearLayout$LayoutParams;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iget-object v1, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mPreviewContainer:Landroid/widget/FrameLayout;
...
.method private sendAnalyticsEventLogs()V
    ...
    iget-object v5, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mThemePkgName:Ljava/lang/String;
    ...
    invoke-static {v0, v5, v4}, Lcom/android/systemui/util/SystemUIAnalytics;->sendEventLog(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v5, "0020"

    const/16 v6, 0x8

    invoke-static {v6}, Lcom/android/systemui/wallpaper/WallpaperUtils;->getWallpaperTypeToString(I)Ljava/lang/String;

    move-result-object v6

    invoke-static {v0, v5, v6}, Lcom/android/systemui/util/SystemUIAnalytics;->sendEventLog(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v5, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mWallpaperManager:Landroid/app/WallpaperManager;

    iget v6, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mCurrentWhich:I

    invoke-virtual {v5, v6}, Landroid/app/WallpaperManager;->semGetWallpaperType(I)I

    move-result v5

    invoke-static {v5}, Lcom/android/systemui/wallpaper/WallpaperUtils;->getWallpaperTypeToString(I)Ljava/lang/String;

    move-result-object v6

    iget-object v7, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mContext:Landroid/content/Context;

    const-string v8, "wallpaper_pref"
...
.method private setupVideoPreview()V
    ...
    :cond_6
    invoke-direct {p0, v3}, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->updateButtonState(Z)V
    ...
    iget-object v6, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mOriginGifFilePath:Ljava/lang/String;
    ...
    const-string v7, "decode gif first frame"
    ...
    iget-object v7, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mBgBlendingImageView:Landroid/widget/ImageView;

    invoke-virtual {v7, v6}, Landroid/widget/ImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    iget-object v7, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mFakeImageView:Landroid/widget/ImageView;

    invoke-virtual {v7, v6}, Landroid/widget/ImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    sget-object v7, Lcom/samsung/android/graphics/SemImageFilter$BlurFilterType;->GAUSSIAN:Lcom/samsung/android/graphics/SemImageFilter$FilterType;

    invoke-static {v7}, Lcom/samsung/android/graphics/SemGaussianBlurImageFilter;->createImageFilter(Lcom/samsung/android/graphics/SemImageFilter$FilterType;)Lcom/samsung/android/graphics/SemImageFilter;

    move-result-object v7

    check-cast v7, Lcom/samsung/android/graphics/SemGaussianBlurImageFilter;

    const/high16 v8, 0x428c0000    # 70.0f

    invoke-virtual {v7, v8}, Lcom/samsung/android/graphics/SemGaussianBlurImageFilter;->setRadius(F)V
    ...
    invoke-virtual {v8, v7}, Landroid/widget/ImageView;->semSetImageFilter(Lcom/samsung/android/graphics/SemImageFilter;)Z
    ...
    const-string v6, "background image is null"
...
.method private updateButtonState(Z)V
    ...
    iget-object v1, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mEditButton:Landroid/widget/Button;
    ...
    iget-object v7, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mEditButton:Landroid/widget/Button;
    ...
    invoke-direct {v9, p0, v8}, Landroid/view/ViewGroup$LayoutParams;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iget-object v8, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mSetAsWallpaperButton:Landroid/widget/Button;
    ...
    invoke-virtual {v8, v2, v9}, Landroid/widget/Button;->setTextSize(IF)V
    ...
    iget-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mEditButton:Landroid/widget/Button;
    ...
    invoke-static {v2}, Lcom/android/systemui/wallpaper/WallpaperUtils;->scaleMiddleDensityViewIfNeeded(Landroid/view/View;)Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mRootView:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mPreviewContainer:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mSettingDescriptionTextView:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mWallpaperManager:Landroid/app/WallpaperManager;
    ...
    sget-boolean v3, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->sConfigured:Z

    if-nez v3, :cond_3

    nop

    invoke-virtual {p0}, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->getApplication()Landroid/app/Application;

    move-result-object v3

    invoke-static {v3}, Lcom/android/systemui/util/SystemUIAnalytics;->initSystemUIAnalyticsStates(Landroid/app/Application;)V

    sput-boolean v2, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->sConfigured:Z
