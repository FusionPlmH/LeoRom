...
.method onVolumeChangedW(II)Z
    ...
    iput v14, v0, Lcom/android/systemui/volume/VolumeDialogControllerImpl;->mSmartViewFlag:I
    ...
    invoke-direct {v0, v13}, Lcom/android/systemui/volume/VolumeDialogControllerImpl;->updateActiveStreamW(I)Z

    move-result v15

    or-int/2addr v14, v15

    invoke-direct {v0, v13}, Lcom/android/systemui/volume/VolumeDialogControllerImpl;->checkRoutedToBluetoothW(I)Z
    ...
    :cond_b
    invoke-virtual {v0, v13}, Lcom/android/systemui/volume/VolumeDialogControllerImpl;->getAudioManagerStreamVolume(I)I

    move-result v15

    invoke-direct {v0, v13, v15}, Lcom/android/systemui/volume/VolumeDialogControllerImpl;->updateStreamLevelW(II)Z
    ...
    const-string v11, "onVolumeChangedW stream = "
    ...
    const-string v11, ", lastAudibleStreamVolume = "
    ...
    const-string v11, ", showUI = "

    invoke-virtual {v5, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v5, v2}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v11, ", gameMode="
    ...
    iput-boolean v8, v3, Lcom/android/systemui/plugins/VolumeDialogController$State;->gameMode:Z
    ...
    invoke-virtual {v3, v5}, Lcom/android/systemui/volume/VolumeDialogControllerImpl$C;->onStateChanged(Lcom/android/systemui/plugins/VolumeDialogController$State;)V
    ...
    invoke-virtual {v3}, Lcom/android/systemui/volume/VolumeDialogControllerImpl$C;->onPlaySound()V
    ...
    invoke-virtual {v3}, Lcom/android/systemui/volume/VolumeDialogControllerImpl$C;->onStopSound()V
    ...
    invoke-static {v3, v11, v5}, Lcom/android/systemui/volume/Events;->writeEvent(Landroid/content/Context;I[Ljava/lang/Object;)V
