...
.field final mWindowManager:Lcom/samsung/android/systemui/sidescreen/SideScreenMenuWindowManager;
...
.method private handleSwipe(II)V
    ...
    iget v0, p0, Lcom/samsung/android/systemui/sidescreen/SideScreenMenuController;->mDockSide:I
    ...
    iget v0, p0, Lcom/samsung/android/systemui/sidescreen/SideScreenMenuController;->mStartY:I
    ...
    :goto_2
    invoke-virtual {v1, v2}, Lcom/android/systemui/stackdivider/multiwindow/MultiWindowManagerProxy;->showSideScreenRecentsActivity(I)V
...
.method private setSubWindowHandlerVisibility(Z)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lcom/samsung/android/systemui/sidescreen/SideScreenMenuView;->setSubWindowHandlerVisibility(Z)V
...
.method private updateTouchable(I)V
    ...
    iget-object v0, p0, Lcom/samsung/android/systemui/sidescreen/SideScreenMenuController;->mWindowManager:Lcom/samsung/android/systemui/sidescreen/SideScreenMenuWindowManager;

    iget-object v1, p0, Lcom/samsung/android/systemui/sidescreen/SideScreenMenuController;->mView:Lcom/samsung/android/systemui/sidescreen/SideScreenMenuView;
    ...
    :goto_1
    invoke-virtual {v0, v1, p1, v2}, Lcom/samsung/android/systemui/sidescreen/SideScreenMenuWindowManager;->setTouchable(Landroid/view/View;IZ)V
...
.method enterFocusMode()V
    ...
    invoke-direct {p0, v0}, Lcom/samsung/android/systemui/sidescreen/SideScreenMenuController;->setSubWindowHandlerVisibility(Z)V
...
.method onTouch(Landroid/view/MotionEvent;)Z
    ...
    iget v4, p0, Lcom/samsung/android/systemui/sidescreen/SideScreenMenuController;->mWindowingMode:I
    ...
    :pswitch_1
    iget-boolean v2, p0, Lcom/samsung/android/systemui/sidescreen/SideScreenMenuController;->mMoving:Z
    ...
    invoke-virtual {p0, v2, v5, v4}, Lcom/samsung/android/systemui/sidescreen/SideScreenMenuController;->startMovingTopTask(III)V

    :cond_0
    iput-boolean v3, p0, Lcom/samsung/android/systemui/sidescreen/SideScreenMenuController;->mMoving:Z

    iget-object v2, p0, Lcom/samsung/android/systemui/sidescreen/SideScreenMenuController;->mH:Lcom/samsung/android/systemui/sidescreen/SideScreenMenuController$H;

    invoke-virtual {v2, v4}, Lcom/samsung/android/systemui/sidescreen/SideScreenMenuController$H;->removeMessages(I)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/samsung/android/systemui/sidescreen/SideScreenMenuController;->handleSwipe(II)V
    ...
    iput v1, p0, Lcom/samsung/android/systemui/sidescreen/SideScreenMenuController;->mStartY:I
    ...
    invoke-virtual {v2, v4, v5, v6}, Lcom/samsung/android/systemui/sidescreen/SideScreenMenuController$H;->sendEmptyMessageDelayed(IJ)Z
...
.method showDragAndDropGuide(Landroid/view/View;)V
    ...
    new-instance v2, Lcom/samsung/android/systemui/sidescreen/SideScreenMenuController$1;

    invoke-direct {v2, p0, v0}, Lcom/samsung/android/systemui/sidescreen/SideScreenMenuController$1;-><init>(Lcom/samsung/android/systemui/sidescreen/SideScreenMenuController;Landroid/app/ActivityManager$RecentTaskInfo;)V
