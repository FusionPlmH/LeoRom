...
.method public updateAODWindowLayoutParams()V
    ...
    invoke-interface {v2, v0, v3, v1}, Lcom/samsung/systemui/splugins/aod/PluginAOD;->applyAODFlags(Landroid/view/WindowManager$LayoutParams;ZZ)V

    iget-object v2, p0, Lcom/android/systemui/aod/AODService;->mAODWindowDelegate:Lcom/android/systemui/aod/AODWindowDelegate;

    invoke-virtual {v2, v0}, Lcom/android/systemui/aod/AODWindowDelegate;->setLayoutParams(Landroid/view/WindowManager$LayoutParams;)V
