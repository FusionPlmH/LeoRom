...
.field private mMediaQuickBoard:Landroid/view/MenuItem;
.field private mLeoButton:Landroid/widget/ImageView;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    new-instance v0, Lcom/android/systemui/qs/QSServiceBox$3;

    new-instance v1, Landroid/os/Handler;

    invoke-direct {v1}, Landroid/os/Handler;-><init>()V

    invoke-direct {v0, p0, v1}, Lcom/android/systemui/qs/QSServiceBox$3;-><init>(Lcom/android/systemui/qs/QSServiceBox;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/android/systemui/qs/QSServiceBox;->mSettingsObserver:Landroid/database/ContentObserver;
...
.method static synthetic access$500(Lcom/android/systemui/qs/QSServiceBox;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/systemui/qs/QSServiceBox;->updateMediaQuickControl()V
...
.method private updateMediaQuickControl()V
    .locals 4
    ...
    const-string/jumbo v2, "qspanel_media_quickcontrol_bar_available"
...
.method public onAttachedToWindow()V
    ...
    :cond_1
    sget-boolean v2, Lcom/android/systemui/Rune;->QPANEL_SUPPORT_BIXBY_ON_POWER_KEY:Z
    ...
    const-string/jumbo v4, "power_key_mapping"

    invoke-static {v4}, Landroid/provider/Settings$Global;->getUriFor(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v4

    iget-object v5, p0, Lcom/android/systemui/qs/QSServiceBox;->mSettingsObserver:Landroid/database/ContentObserver;
...
.method public onClick(Landroid/view/View;)V
    ...
    sget v0, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoQsSearchActionStyle:I

    invoke-direct {p0, v0}, Lcom/android/systemui/qs/QSServiceBox;->setLeoStartAction(I)V
    ...
    :cond_2
    sget v0, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoQsSettingActionStyle:I
    ...
    invoke-virtual {v0}, Lcom/android/systemui/qs/QSPanel;->shouldShowEdit()Z
 ...
 goto :goto_0
    :cond_5
    iget-object v0, p0, Lcom/android/systemui/qs/QSServiceBox;->mLeoButton:Landroid/widget/ImageView;

    if-ne p1, v0, :cond_5leo

    sget v0, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoQsLeoButtonActionStyle:I

    invoke-virtual {p0, v0}, Lcom/android/systemui/qs/QSServiceBox;->setLeoClickAction(I)V
...
.method public onColorChanged(Landroid/content/res/Configuration;)V
    ...
    const-string v2, "drawable/qs_ripple_drawable"
    ...
    const-string v2, "color/status_bar_header_setting_tint_color"
    ...
    invoke-virtual {v0, v1}, Lcom/android/systemui/statusbar/phone/MultiUserSwitch;->setForeground(Landroid/graphics/drawable/Drawable;)V
...
.method public onDetachedFromWindow()V
    ...
    iget-object v1, p0, Lcom/android/systemui/qs/QSServiceBox;->mSettingsObserver:Landroid/database/ContentObserver;
...
.method protected onFinishInflate()V
    ...
    iput-boolean v0, p0, Lcom/android/systemui/qs/QSServiceBox;->mInflated:Z
  invoke-virtual {p0}, Lcom/android/systemui/qs/QSServiceBox;->upLeoButton()V
    return-void
.end method
...
.method public setLeoClickAction(I)V
    ...
    invoke-static {v0, v1, p1}, Lcom/fusionleo/LeoX/systemui/LeoConfig;->setLeoAction(Landroid/content/Context;Ljava/lang/String;I)V

    sget v1, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoQLeoButtonActionCollapsePanels:I
...
.method public showQSPopupMenu()V
    ...
    iput-object v1, p0, Lcom/android/systemui/qs/QSServiceBox;->mMediaQuickBoard:Landroid/view/MenuItem;

    iget-object v1, p0, Lcom/android/systemui/qs/QSServiceBox;->mContext:Landroid/content/Context;

    invoke-static {v1}, Lcom/android/systemui/util/DeviceState;->isMediaQuickControlBarAvailable(Landroid/content/Context;)Z
    ...
    :goto_0
    iget-object v2, p0, Lcom/android/systemui/qs/QSServiceBox;->mMediaQuickBoard:Landroid/view/MenuItem;
    ...
    :cond_3
    iget-object v1, p0, Lcom/android/systemui/qs/QSServiceBox;->mMediaQuickBoard:Landroid/view/MenuItem;
    ...
    new-instance v2, Lcom/android/systemui/qs/QSServiceBox$4;

    invoke-direct {v2, p0}, Lcom/android/systemui/qs/QSServiceBox$4;-><init>(Lcom/android/systemui/qs/QSServiceBox;)V
...
.method public upLeoButton()V
    ...
    const-string v1, "leo_button_container"

    invoke-virtual {p0, v1}, Lcom/android/systemui/qs/QSServiceBox;->findViewWithTag(Ljava/lang/Object;)Landroid/view/View;

    move-result-object v1

    iput-object v1, p0, Lcom/android/systemui/qs/QSServiceBox;->mLeoButtonContainer:Landroid/view/View;

    const-string v1, "leo_button"
    ...
    iput-object v1, p0, Lcom/android/systemui/qs/QSServiceBox;->mLeoButton:Landroid/widget/ImageView;

    iget-object v1, p0, Lcom/android/systemui/qs/QSServiceBox;->mLeoButton:Landroid/widget/ImageView;

    invoke-virtual {v1, p0}, Landroid/widget/ImageView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    sget v1, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoQsLeoButtonActionStyle:I

    if-nez v1, :cond_0

    const-string v2, "ic_leo"

    invoke-static {v0, v2}, Lcom/fusionleo/LeoX/systemui/LeoConfig;->getCustomDrawable(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v4, p0, Lcom/android/systemui/qs/QSServiceBox;->mLeoButton:Landroid/widget/ImageView;
    ...
    sget-boolean v4, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoQSSettingButtonActionEnabled:Z

    sget-boolean v5, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoQSSearchButtonActionEnabled:Z

    sget-boolean v6, Lcom/fusionleo/LeoProvider/LeoManages;->setLeoQLeoButtonActionEnabled:Z

    iget-object v7, p0, Lcom/android/systemui/qs/QSServiceBox;->mLeoButton:Landroid/widget/ImageView;
    ...
    iget-object v7, p0, Lcom/android/systemui/qs/QSServiceBox;->mLeoButtonContainer:Landroid/view/View;
    ...
    iget-object v7, p0, Lcom/android/systemui/qs/QSServiceBox;->mSettingsContainer:Landroid/view/View;
    ...
    iget-object v7, p0, Lcom/android/systemui/qs/QSServiceBox;->mSearchButtonContainer:Landroid/view/View;
    ...
    iget-object v7, p0, Lcom/android/systemui/qs/QSServiceBox;->mSettingsButton:Landroid/widget/ImageButton;
    ...
    iget-object v7, p0, Lcom/android/systemui/qs/QSServiceBox;->mSearchButton:Landroid/widget/ImageButton;
...
.method public updateQSColoringResources(Landroid/view/View;)V
    ...
    iget-object v3, p0, Lcom/android/systemui/qs/QSServiceBox;->mSearchButton:Landroid/widget/ImageButton;

    if-eqz v3, :cond_1

    iget-object v3, p0, Lcom/android/systemui/qs/QSServiceBox;->mSearchButton:Landroid/widget/ImageButton;

    invoke-virtual {v3, v0}, Landroid/widget/ImageButton;->setColorFilter(I)V

    :cond_1
    iget-object v3, p0, Lcom/android/systemui/qs/QSServiceBox;->mSettingsButton:Landroid/widget/ImageButton;
    ...
    :cond_2
    iget-object v3, p0, Lcom/android/systemui/qs/QSServiceBox;->mMoreButton:Landroid/widget/ImageButton;
    ...
    :cond_3
      iget-object v3, p0, Lcom/android/systemui/qs/QSServiceBox;->mLeoButton:Landroid/widget/ImageView;
    ...
    :cond_1leo
    iget-object v3, p0, Lcom/android/systemui/qs/QSServiceBox;->mPowerButton:Landroid/widget/ImageButton;
    ...
    invoke-virtual {p0, v6}, Lcom/android/systemui/qs/QSServiceBox;->findViewById(I)Landroid/view/View;
    ...
    invoke-virtual {v8}, Lcom/android/systemui/coloring/QSColoringServiceManager;->getQSColoringBackgroundColor()I
    ...
    iget-object v10, p0, Lcom/android/systemui/qs/QSServiceBox;->mBadgeText:Landroid/widget/TextView;
    ...
    invoke-virtual {v7, v1, v10}, Landroid/graphics/drawable/Drawable;->setColorFilter(ILandroid/graphics/PorterDuff$Mode;)V
    ...
    :cond_a
    iget-object v10, p0, Lcom/android/systemui/qs/QSServiceBox;->mMoreButtonBadge:Landroid/widget/TextView;
...
.method protected updateVisibilities()V
    ...
    iget-object v2, p0, Lcom/android/systemui/qs/QSServiceBox;->mSettingsContainer:Landroid/view/View;
    ...
    iget-object v2, p0, Lcom/android/systemui/qs/QSServiceBox;->mSearchButtonContainer:Landroid/view/View;

    sget-boolean v3, Lcom/android/systemui/Rune;->QPANEL_SUPPORT_BIXBY_ON_POWER_KEY:Z

    const/16 v6, 0x8

    if-eqz v3, :cond_1

    iget-boolean v3, p0, Lcom/android/systemui/qs/QSServiceBox;->mExpanded:Z
    ...
    iget-object v2, p0, Lcom/android/systemui/qs/QSServiceBox;->mPowerButtonContainer:Landroid/view/View;
    ...
    const-string v7, "getCurrentBixbySettings: "
    ...
    iget-object v2, p0, Lcom/android/systemui/qs/QSServiceBox;->mMoreButtonContainer:Landroid/view/View;
    ...
    :cond_5
    iget-boolean v7, p0, Lcom/android/systemui/qs/QSServiceBox;->mExpanded:Z
    ...
    iget-object v2, p0, Lcom/android/systemui/qs/QSServiceBox;->mMoreButtonBadge:Landroid/widget/TextView;

    if-eqz v2, :cond_9

    if-nez v0, :cond_7

    iget-object v2, p0, Lcom/android/systemui/qs/QSServiceBox;->mMoreButtonBadgeText:Ljava/lang/String;
    ...
    :cond_9
    iget-object v2, p0, Lcom/android/systemui/qs/QSServiceBox;->mMultiUserSwitch:Lcom/android/systemui/statusbar/phone/MultiUserSwitch;
    ...
    sget-boolean v2, Lcom/android/systemui/Rune;->QPANEL_IS_LDU_POPUP:Z
    ...
    invoke-virtual {v2}, Lcom/android/systemui/util/DesktopManager;->isDualView()Z

    move-result v2

    if-nez v2, :cond_a

    iget-boolean v2, p0, Lcom/android/systemui/qs/QSServiceBox;->mIsDexEnabling:Z
    ...
    invoke-virtual {v2}, Lcom/android/systemui/KnoxStateMonitor;->isUsersEnabled()Z
    ...
    const-string v3, "QSServiceBox"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "mMultiUserSwitch -> visible:"
    ...
    invoke-static {v7}, Lcom/android/systemui/util/DeviceState;->isDesktopMode(Landroid/content/Context;)Z

    move-result v7

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v7, ", isDualView?"
    ...
    invoke-virtual {v7}, Lcom/android/systemui/util/DesktopManager;->isDualView()Z

    move-result v7

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v7, ", mIsDexEnabling:"

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v7, p0, Lcom/android/systemui/qs/QSServiceBox;->mIsDexEnabling:Z
    ...
    iget-object v3, p0, Lcom/android/systemui/qs/QSServiceBox;->mMultiUserSwitch:Lcom/android/systemui/statusbar/phone/MultiUserSwitch;
