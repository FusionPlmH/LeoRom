...
.method private startActivity(Landroid/app/IApplicationThread;Landroid/content/Intent;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/content/pm/ResolveInfo;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;Landroid/os/IBinder;Ljava/lang/String;IIILjava/lang/String;IIILcom/android/server/am/SafeActivityOptions;ZZ[Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/TaskRecord;Z)I
    ...
    iput-object v12, v3, Lcom/android/server/am/ActivityRecord;->resultTo:Lcom/android/server/am/ActivityRecord;
    ...
    invoke-virtual {v2, v8, v0}, Lcom/android/server/am/PendingRemoteAnimationRegistry;->overrideOptionsIfNeeded(Ljava/lang/String;Landroid/app/ActivityOptions;)Landroid/app/ActivityOptions;
    ...
    invoke-virtual {v1, v4, v9}, Landroid/content/pm/PackageManagerInternal;->isPermissionsReviewRequired(Ljava/lang/String;I)Z
    ...
    invoke-direct {v12, v1}, Landroid/content/IntentSender;-><init>(Landroid/content/IIntentSender;)V

    invoke-virtual {v4, v8, v12}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    ...
    iget-object v12, v15, Lcom/android/server/am/ActivityStarter;->mSupervisor:Lcom/android/server/am/ActivityStackSupervisor;

    const/16 v20, 0x0

    iget-object v14, v15, Lcom/android/server/am/ActivityStarter;->mRequest:Lcom/android/server/am/ActivityStarter$Request;

    iget v14, v14, Lcom/android/server/am/ActivityStarter$Request;->filterCallingUid:I

    move/from16 v66, v6

    move/from16 v6, p16

    invoke-static {v11, v6, v14}, Lcom/android/server/am/ActivityStarter;->computeResolveFilterUid(III)I
    ...
    invoke-virtual {v12, v8, v2, v14, v1}, Lcom/android/server/am/ActivityStackSupervisor;->resolveActivity(Landroid/content/Intent;Landroid/content/pm/ResolveInfo;ILandroid/app/ProfilerInfo;)Landroid/content/pm/ActivityInfo;
    ...
    invoke-virtual {v3, v9}, Lcom/android/server/am/ActivityStackSupervisor;->getUserInfo(I)Landroid/content/pm/UserInfo;
    ...
    invoke-virtual {v12, v0}, Lcom/android/server/am/ActivityManagerService;->isAppLockedPackage(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v12}, Lcom/android/server/am/ActivityManagerService;->isAppLockedVerifying(Ljava/lang/String;)Z
    ...
    invoke-static {v0, v12, v8}, Lcom/android/internal/app/AppLockPolicy;->skipLockWhenStart(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)Z
    ...
    const-string v2, "AppLocked pkgName:"
    ...
    const-string v2, " skipLockWhenStart:"
    ...
    invoke-virtual {v3}, Lcom/android/server/am/ActivityManagerService;->getAppLockedCheckAction()Ljava/lang/String;
    ...
    invoke-virtual {v12, v2, v5}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    ...
    invoke-virtual {v12, v2, v1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    ...
    const-string v2, "LOCKED_PACKAGE_USERID"

    invoke-virtual {v12, v2, v9}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;
    ...
    invoke-static {v11, v6, v10}, Lcom/android/server/am/ActivityStarter;->computeResolveFilterUid(III)I
    ...
    invoke-virtual {v10, v12, v5, v4, v1}, Lcom/android/server/am/ActivityStackSupervisor;->resolveActivity(Landroid/content/Intent;Landroid/content/pm/ResolveInfo;ILandroid/app/ProfilerInfo;)Landroid/content/pm/ActivityInfo;
    ...
    invoke-virtual {v10, v1, v0, v4, v5}, Lcom/android/server/am/ActivityStackSupervisor;->resolveActivity(Landroid/content/Intent;Landroid/content/pm/ResolveInfo;ILandroid/app/ProfilerInfo;)Landroid/content/pm/ActivityInfo;
    ...
    iget-object v8, v10, Lcom/android/server/am/ActivityRecord;->requestedVrComponent:Landroid/content/ComponentName;
    ...
    iget v1, v10, Lcom/android/server/am/ActivityRecord;->vrActivityType:I
    ...
    iget v5, v10, Lcom/android/server/am/ActivityRecord;->userId:I
    ...
    iget-object v3, v14, Landroid/content/pm/ActivityInfo;->name:Ljava/lang/String;
    ...
    iget-object v7, v15, Lcom/android/server/am/ActivityStarter;->mController:Lcom/android/server/am/ActivityStartController;

    new-instance v6, Lcom/android/server/am/ActivityStackSupervisor$PendingActivityLaunch;
    ...
    invoke-virtual {v7, v8}, Lcom/android/server/am/ActivityStartController;->addPendingActivityLaunch(Lcom/android/server/am/ActivityStackSupervisor$PendingActivityLaunch;)V
