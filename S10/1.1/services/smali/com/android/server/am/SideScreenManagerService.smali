...
.method private getSideScreenStacksMovementAnimator(ILandroid/graphics/Rect;Landroid/graphics/Rect;Ljava/lang/Runnable;)Landroid/animation/ValueAnimator;
    ...
    new-instance v1, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$DI_t7krU4mPb9W3-a2lT3dIiFiE;

    invoke-direct {v1, p0, v0, p1}, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$DI_t7krU4mPb9W3-a2lT3dIiFiE;-><init>(Lcom/android/server/am/SideScreenManagerService;Landroid/animation/ValueAnimator;I)V
...
.method private getSideScreenStacksMovementAnimator(Landroid/graphics/Rect;Landroid/graphics/Rect;Ljava/lang/Runnable;)Landroid/animation/ValueAnimator;
    ...
    new-instance v1, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$SGAA9vkj63j5UStmmP05uHtKhSw;

    invoke-direct {v1, p0, v0}, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$SGAA9vkj63j5UStmmP05uHtKhSw;-><init>(Lcom/android/server/am/SideScreenManagerService;Landroid/animation/ValueAnimator;)V
...
.method public static synthetic lambda$getSideScreenStacksMovementAnimator$5(Lcom/android/server/am/SideScreenManagerService;Landroid/animation/ValueAnimator;Landroid/animation/ValueAnimator;)V
    .locals 1
...
.method public static synthetic lambda$getSideScreenStacksMovementAnimator$7(Lcom/android/server/am/SideScreenManagerService;Landroid/animation/ValueAnimator;ILandroid/animation/ValueAnimator;)V
    .locals 2
...
.method public static synthetic lambda$notifySideScreenImeVisibilityChanged$13(Lcom/android/server/am/SideScreenManagerService;I)V
    .locals 1
...
.method public static synthetic lambda$notifySideScreenImeVisibilityChanged$14(Lcom/android/server/am/SideScreenManagerService;)V
    .locals 3
...
.method public static synthetic lambda$onSideScreenSplitModeDeactivatedLocked$4(Lcom/android/server/am/SideScreenManagerService;)V
    .locals 0
...
.method public static synthetic lambda$resizeSideScreenLocked$6(Lcom/android/server/am/SideScreenManagerService;Landroid/graphics/Rect;)V
    .locals 0
...
.method public static synthetic lambda$resizeSideScreenStackAndOtherStacksLocked$10(Lcom/android/server/am/SideScreenManagerService;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    .locals 13
...
.method public static synthetic lambda$resizeSideScreenStackWithScale$11(Lcom/android/server/am/SideScreenManagerService;IZ)V
    .locals 0
...
.method public static synthetic lambda$resizeSideScreenStackWithScale$12(Lcom/android/server/am/SideScreenManagerService;ZILcom/android/server/am/ActivityDisplay;Landroid/graphics/Rect;)V
    .locals 8
...
.method public static synthetic lambda$swapTaskWindowingModeFromSubWindowHandler$8(Lcom/android/server/am/SideScreenManagerService;ZLcom/android/server/am/ActivityDisplay;ILcom/android/server/am/ActivityRecord;)V
    .locals 2
...
.method public static synthetic lambda$swapTaskWindowingModeFromSubWindowHandler$9(Lcom/android/server/am/SideScreenManagerService;ZLcom/android/server/am/ActivityDisplay;ILcom/android/server/am/ActivityRecord;)V
    ...
    new-instance v8, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$55x4WFFfwL66Bv6bxepM9OosnpE;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$55x4WFFfwL66Bv6bxepM9OosnpE;-><init>(Lcom/android/server/am/SideScreenManagerService;ZLcom/android/server/am/ActivityDisplay;ILcom/android/server/am/ActivityRecord;)V
...
.method private startSideScreenRecentsActivity(IZ)V
    .locals 10
...
.method notifySideScreenImeVisibilityChanged(ILandroid/graphics/Rect;)V
    ...
    new-instance v0, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$2DlysxY0Uhy-9Xx-QfXPVYa8Hf0;

    invoke-direct {v0, p0, p1}, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$2DlysxY0Uhy-9Xx-QfXPVYa8Hf0;-><init>(Lcom/android/server/am/SideScreenManagerService;I)V
    ...
    new-instance v3, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$OdyBYrhSGOXsGYz5PgYn13vRgAo;

    invoke-direct {v3, p0}, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$OdyBYrhSGOXsGYz5PgYn13vRgAo;-><init>(Lcom/android/server/am/SideScreenManagerService;)V
...
.method onSideScreenSplitModeDeactivatedLocked()V
    ...
    new-instance v1, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$B2U7xhQzEgVsjYM5VmMqnHpV-18;

    invoke-direct {v1, p0}, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$B2U7xhQzEgVsjYM5VmMqnHpV-18;-><init>(Lcom/android/server/am/SideScreenManagerService;)V
...
.method resizeSideScreenLocked(Landroid/graphics/Rect;)V
    ...
    new-instance v1, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$Bd8QRRVf5d94yEZ6BebziT770dY;

    invoke-direct {v1, p0, p1}, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$Bd8QRRVf5d94yEZ6BebziT770dY;-><init>(Lcom/android/server/am/SideScreenManagerService;Landroid/graphics/Rect;)V
...
.method public resizeSideScreenStackAndOtherStacksLocked(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    new-instance v1, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$UOp3u8oUvn1q0yITX522OELB9rY;

    invoke-direct {v1, p0, p1, p2}, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$UOp3u8oUvn1q0yITX522OELB9rY;-><init>(Lcom/android/server/am/SideScreenManagerService;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method resizeSideScreenStackWithScale(IZ)Z
    ...
    new-instance v0, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$oahN1F5C5i3PWy_xWEGCdYyBWH4;

    invoke-direct {v0, p0, p1, p2}, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$oahN1F5C5i3PWy_xWEGCdYyBWH4;-><init>(Lcom/android/server/am/SideScreenManagerService;IZ)V
    ...
    new-instance v12, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$ORWVPo4VDYFNY0-rTF5E7aKwq7s;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$ORWVPo4VDYFNY0-rTF5E7aKwq7s;-><init>(Lcom/android/server/am/SideScreenManagerService;ZILcom/android/server/am/ActivityDisplay;Landroid/graphics/Rect;)V
...
.method setSideScreenMode(IZ)V
    ...
    invoke-virtual {p0, p2}, Lcom/android/server/am/SideScreenManagerService;->dockSideScreen(Z)V
...
.method showSideScreen(Z)V
    ...
    invoke-direct {p0, v3, v2}, Lcom/android/server/am/SideScreenManagerService;->startSideScreenRecentsActivity(IZ)V
...
.method showSideScreenRecentsActivity(I)V
    .locals 14
    ...
    const-string v2, "Default display isn\'t exsited. abort to show SideScreenRecentsActivity"
    ...
    invoke-virtual {v1}, Lcom/android/server/am/ActivityStack;->isTopActivityVisible()Z
    ...
    :cond_1
    iget v2, v6, Lcom/android/server/am/TaskRecord;->taskId:I
    ...
    invoke-virtual {v8, v2, v7}, Lcom/android/server/am/MultiWindowManagerService;->swapWindowingMode(II)V
    ...
    invoke-virtual {v12}, Lcom/android/server/am/TaskRecord;->getActivityType()I

    move-result v6

    invoke-virtual {v0, v5, v6, v4}, Lcom/android/server/am/ActivityDisplay;->getOrCreateStack(IIZ)Lcom/android/server/am/ActivityStack;
    ...
    const-string/jumbo v11, "swapWindowingMode"
    ...
    :cond_3
    invoke-direct {p0, p1, v4}, Lcom/android/server/am/SideScreenManagerService;->startSideScreenRecentsActivity(IZ)V
...
.method swapTaskWindowingModeFromSubWindowHandler(II)V
    ...
    :goto_1
    new-instance v16, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$D5s5qrMkr45fYI5qh2miq_sNHjY;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/server/am/-$$Lambda$SideScreenManagerService$D5s5qrMkr45fYI5qh2miq_sNHjY;-><init>(Lcom/android/server/am/SideScreenManagerService;ZLcom/android/server/am/ActivityDisplay;ILcom/android/server/am/ActivityRecord;)V
