...
.method isInBelowHomeStackLocked(Lcom/android/server/am/ActivityStack;)Z
    .locals 6
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/am/ActivityDisplay;->getIndexOf(Lcom/android/server/am/ActivityStack;)I
...
.method minimizeAllTasksInFreeformLocked(IZI)Z
    ...
    invoke-virtual {v1, v13}, Lcom/android/server/am/FreeformController;->isInBelowHomeStackLocked(Lcom/android/server/am/ActivityStack;)Z
...
.method startFreeformAtCornerGesture(ILandroid/graphics/Rect;)V
    ...
    :try_start_0
    iget-object v6, v1, Lcom/android/server/am/FreeformController;->mActivityManager:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-virtual {v8, v9, v10, v14}, Lcom/android/server/am/ActivityDisplay;->getOrCreateStack(IIZ)Lcom/android/server/am/ActivityStack;
    ...
    const-string/jumbo v17, "resizeTask"
    ...
    sget-boolean v7, Lcom/samsung/android/rune/CoreRune;->MW_FREEFORM_USAGE_LOGGING:Z

    if-eqz v7, :cond_4

    const-string v7, "FFBY"

    const-string v8, "FFEP"
    ...
    iget-object v9, v0, Lcom/android/server/am/TaskRecord;->realActivity:Landroid/content/ComponentName;
    ...
    iget-object v9, v1, Lcom/android/server/am/FreeformController;->mActivityManager:Lcom/android/server/am/ActivityManagerService;

    iget-object v9, v9, Lcom/android/server/am/ActivityManagerService;->mContext:Landroid/content/Context;

    invoke-static {v9, v7, v8}, Lcom/samsung/android/multiwindow/MultiWindowLogger;->insertLogForMW(Landroid/content/Context;[Ljava/lang/String;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v3, v14, v7, v7}, Lcom/android/server/am/TaskRecord;->resize(Landroid/graphics/Rect;IZZ)Z
