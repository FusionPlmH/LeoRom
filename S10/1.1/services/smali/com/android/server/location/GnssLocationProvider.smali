...
.method static synthetic access$1100(Lcom/android/server/location/GnssLocationProvider;Z)V
    .locals 0
...
.method private startNavigating(Z)V
    ...
    iget-boolean v4, p0, Lcom/android/server/location/GnssLocationProvider;->mNetworkAvailable:Z

    invoke-virtual {p0, v3, v4, p1}, Lcom/android/server/location/GnssLocationProvider;->extension_setStartNavigatingModes(IZZ)I
    ...
    iget-object v7, p0, Lcom/android/server/location/GnssLocationProvider;->mTimeoutIntent:Landroid/app/PendingIntent;

    invoke-virtual {v1, v4, v5, v6, v7}, Landroid/app/AlarmManager;->set(IJLandroid/app/PendingIntent;)V
...
.method private updateRequirements()V
    ...
    iget-boolean v5, p0, Lcom/android/server/location/GnssLocationProvider;->mStarted:Z

    invoke-virtual {v3, v5}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v5, ", mDisableGps = "

    invoke-virtual {v3, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v5, p0, Lcom/android/server/location/GnssLocationProvider;->mDisableGps:Z
    ...
    iget-wide v7, v1, Lcom/android/internal/location/ProviderRequest;->interval:J
    ...
    invoke-virtual {p0, v3, v5, v6}, Lcom/android/server/location/GnssLocationProvider;->getBundle(III)Landroid/os/Bundle;

    move-result-object v3

    invoke-virtual {p0, v1, v3}, Lcom/android/server/location/GnssLocationProvider;->sendInfoToNsflp(ILandroid/os/Bundle;)V

    iget-boolean v1, p0, Lcom/android/server/location/GnssLocationProvider;->mIzatServiceEnabled:Z

    if-eqz v1, :cond_8

    iget v1, p0, Lcom/android/server/location/GnssLocationProvider;->nsFlpFeatureLevel:I

    const/16 v3, 0x136

    if-lt v1, v3, :cond_6

    iget v1, p0, Lcom/android/server/location/GnssLocationProvider;->mCurrentEngineOnlyMode:I
    ...
    const-string v3, "acquire wakelock for navigating"
    ...
    invoke-direct {p0, v6, v2, v1}, Lcom/android/server/location/GnssLocationProvider;->sendMessage(IILjava/lang/Object;)V
    ...
    invoke-direct {p0, v6, v4, v1}, Lcom/android/server/location/GnssLocationProvider;->sendMessage(IILjava/lang/Object;)V
