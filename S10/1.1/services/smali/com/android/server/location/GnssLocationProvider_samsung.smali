...
.field private prevAgpsCpMask:I
...
.method public constructor <init>()V
    ...
    iput v2, p0, Lcom/android/server/location/GnssLocationProvider_samsung;->prevAgpsCpMask:I
...
.method private configurationUpdate_setAgpsCpSupport(I)V
    .locals 3
    ...
    const-string v2, "configurationUpdate_setAgpsCpSupport, CP_AGPS_ENABLE_PROFILE="
...
.method private getAgpsCpBitmask()I
    .locals 9
    ...
    const-string/jumbo v5, "subscriptionInfoList.size() is 0. return prevAgpsCpMask."

    invoke-static {v4, v5}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget v4, p0, Lcom/android/server/location/GnssLocationProvider_samsung;->prevAgpsCpMask:I
    ...
    invoke-virtual {v8, v5}, Landroid/telephony/TelephonyManager;->getSimOperatorName(I)Ljava/lang/String;
    ...
    invoke-virtual {v7, v5}, Landroid/telephony/TelephonyManager;->getSimOperatorName(I)Ljava/lang/String;
    ...
    const-string v7, "airtel operator : AGPS CP"
    ...
    sget-object v5, Lcom/android/server/location/GnssLocationProvider_samsung$Vendor;->NO_OPERATOR:Lcom/android/server/location/GnssLocationProvider_samsung$Vendor;
    ...
    const-string v5, "No Operator AGPS CP Disable"
...
.method private getLppBitmask()I
    ...
    const-string v2, "CscFeature_GPS_ConfigLppBitmask"
    ...
    const-string v8, "JIO 4G/airtel operator : LPP"
    ...
    const-string v5, "US market operator: LPP enable"
...
.method public static getVendor()Lcom/android/server/location/GnssLocationProvider_samsung$Vendor;
    ...
    sget-object v0, Lcom/android/server/location/GnssLocationProvider_samsung$Vendor;->ARG_UFN:Lcom/android/server/location/GnssLocationProvider_samsung$Vendor;
...
.method private static isUSAMarket()Z
    ...
    const-string/jumbo v3, "isUSAMarket : code/countryCode = "
...
.method private setAgpsCpSupport(ZI)V
    .locals 3
    ...
    const-string/jumbo v2, "setAgpsCpSupport("
    ...
    invoke-direct {p0, p2}, Lcom/android/server/location/GnssLocationProvider_samsung;->configurationUpdate_setAgpsCpSupport(I)V
...
.method private setDcmSuplIot(Z)V
    ...
    const-string/jumbo v4, "dcm-supl.com"
...
.method private setLppSupport(ZI)V
    ...
    invoke-direct {p0, v2, v1, v3}, Lcom/android/server/location/GnssLocationProvider_samsung;->sendMessage(IILjava/lang/Object;)V
...
.method private setSktSuplVer()V
    ...
    const-string v1, "AGPS_SUPL_VER_2_0_1_AGNSS,  server = wpde.nate.com"
...
.method extension_checkSmsSuplInit()V
    ...
    invoke-virtual {p0}, Lcom/android/server/location/GnssLocationProvider_samsung;->extension_setSuplSetting()V
...
.method extension_checkWapPushMsg(Z)Z
    ...
    sget-object v1, Lcom/android/server/location/GnssLocationProvider_samsung$Vendor;->ARG_UFN:Lcom/android/server/location/GnssLocationProvider_samsung$Vendor;
...
.method extension_mBroadcastReceiver(Landroid/content/Intent;Z)Landroid/os/Bundle;
    ...
    invoke-virtual {v12, v0, v1}, Landroid/os/Bundle;->putByteArray(Ljava/lang/String;[B)V
    ...
    sget-object v3, Lcom/android/server/location/GnssLocationProvider_samsung;->simOperatorKOR:Ljava/lang/String;
    ...
    :cond_8
    invoke-direct/range {p0 .. p0}, Lcom/android/server/location/GnssLocationProvider_samsung;->getAgpsCpBitmask()I

    move-result v3

    iget v4, v15, Lcom/android/server/location/GnssLocationProvider_samsung;->prevAgpsCpMask:I
    ...
    const-string v6, "cpMask : "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v5, v3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v6, " prevAgpsCpMask : "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v6, v15, Lcom/android/server/location/GnssLocationProvider_samsung;->prevAgpsCpMask:I
    ...
    iput v3, v15, Lcom/android/server/location/GnssLocationProvider_samsung;->prevAgpsCpMask:I

    invoke-direct {v15, v14, v3}, Lcom/android/server/location/GnssLocationProvider_samsung;->setAgpsCpSupport(ZI)V
    ...
    const-string v4, " prevLppMask : "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v4, v15, Lcom/android/server/location/GnssLocationProvider_samsung;->prevLppMask:I
    ...
    invoke-direct {v15, v14, v1}, Lcom/android/server/location/GnssLocationProvider_samsung;->setLppSupport(ZI)V
    ...
    const-string/jumbo v5, "dial up emergency call"
    ...
    iput-boolean v5, v4, Lcom/android/server/location/GnssLocationProvider_samsung;->isEmergencyNumber:Z
    ...
    iget v1, v4, Lcom/android/server/location/GnssLocationProvider_samsung;->emergencyCallState:I

    if-eqz v1, :cond_15

    iget-boolean v1, v4, Lcom/android/server/location/GnssLocationProvider_samsung;->mIzatServiceEnabled:Z
    ...
    sget-object v5, Lcom/android/server/location/GnssLocationProvider_samsung$Vendor;->USA_VZW:Lcom/android/server/location/GnssLocationProvider_samsung$Vendor;
    ...
    const-string/jumbo v5, "native cleanup because ECBM is ended during location off"
    ...
    :cond_15
    iput v6, v4, Lcom/android/server/location/GnssLocationProvider_samsung;->emergencyCallState:I
    ...
    const-string/jumbo v5, "native init because enter ECBM during location off."
    ...
    iput v1, v4, Lcom/android/server/location/GnssLocationProvider_samsung;->emergencyCallState:I
...
.method extension_reloadMakeAutoSuplUrl(Z)V
    ...
    sget-object v2, Lcom/android/server/location/GnssLocationProvider_samsung$Vendor;->ARG_UFN:Lcom/android/server/location/GnssLocationProvider_samsung$Vendor;
...
.method extension_sendExtraCommand(Ljava/lang/String;Landroid/os/Bundle;Z)Z
    ...
    :cond_7
    const-string/jumbo v0, "deactivateGPS"
    ...
    const-string/jumbo v2, "deactivateGPS is not supported"
    ...
    :cond_9
    const-string/jumbo v0, "deactivateNLP"
    ...
    const-string/jumbo v2, "deactivateNLP is not supported"
    ...
    :cond_b
    const-string/jumbo v0, "deactivateAGPS"
    ...
    const-string/jumbo v3, "deactivateAGPS"
...
.method extension_setStartNavigatingModes(IZZ)I
    ...
    iget-object v0, p0, Lcom/android/server/location/GnssLocationProvider_samsung;->mTelephonyManager:Landroid/telephony/TelephonyManager;
...
.method extension_setSuplSetting()V
    ...
    const-string/jumbo v1, "extension_setSuplSetting()"
...
.method sendExtraConfigurationString()V
    ...
    iget v1, p0, Lcom/android/server/location/GnssLocationProvider_samsung;->prevAgpsCpMask:I

    if-ltz v1, :cond_1

    const-string v1, "CP_AGPS_ENABLE_PROFILE"

    iget v2, p0, Lcom/android/server/location/GnssLocationProvider_samsung;->prevAgpsCpMask:I
