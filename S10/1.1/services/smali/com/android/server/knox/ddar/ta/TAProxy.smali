...
.method private setupTARequest(Landroid/os/Bundle;)Z
    ...
    iget-object v5, p0, Lcom/android/server/knox/ddar/ta/TAProxy;->mTAMap:Ljava/util/Map;
    ...
    new-instance v5, Lcom/android/server/knox/ddar/ta/TAProxy$TAInfo;

    const/4 v6, 0x0

    invoke-direct {v5, v6}, Lcom/android/server/knox/ddar/ta/TAProxy$TAInfo;-><init>(Lcom/android/server/knox/ddar/ta/TAProxy$1;)V

    iput v4, v5, Lcom/android/server/knox/ddar/ta/TAProxy$TAInfo;->taId:I

    const-string v6, "TA_TECHNOLOGY"

    invoke-virtual {v3, v6}, Landroid/os/Bundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    iput-object v6, v5, Lcom/android/server/knox/ddar/ta/TAProxy$TAInfo;->taTechnology:Ljava/lang/String;

    const-string v6, "TA_ROOT_NAME"

    invoke-virtual {v3, v6}, Landroid/os/Bundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    iput-object v6, v5, Lcom/android/server/knox/ddar/ta/TAProxy$TAInfo;->taRootName:Ljava/lang/String;

    const-string v6, "TA_PROCESS_NAME"

    invoke-virtual {v3, v6}, Landroid/os/Bundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    iput-object v6, v5, Lcom/android/server/knox/ddar/ta/TAProxy$TAInfo;->taProcessName:Ljava/lang/String;

    const-string v6, "TA_SEND_CMD_SIZE"

    invoke-virtual {v3, v6}, Landroid/os/Bundle;->getInt(Ljava/lang/String;)I

    move-result v6

    iput v6, v5, Lcom/android/server/knox/ddar/ta/TAProxy$TAInfo;->maxSendCmdSize:I

    const-string v6, "TA_RECV_RESP_SIZE"

    invoke-virtual {v3, v6}, Landroid/os/Bundle;->getInt(Ljava/lang/String;)I

    move-result v6

    iput v6, v5, Lcom/android/server/knox/ddar/ta/TAProxy$TAInfo;->maxRecvRespSize:I

    new-instance v6, Lcom/android/server/knox/ddar/ta/TZNative;

    iget v8, v5, Lcom/android/server/knox/ddar/ta/TAProxy$TAInfo;->taId:I

    iget-object v9, v5, Lcom/android/server/knox/ddar/ta/TAProxy$TAInfo;->taTechnology:Ljava/lang/String;

    iget-object v10, v5, Lcom/android/server/knox/ddar/ta/TAProxy$TAInfo;->taRootName:Ljava/lang/String;

    iget-object v11, v5, Lcom/android/server/knox/ddar/ta/TAProxy$TAInfo;->taProcessName:Ljava/lang/String;

    iget v12, v5, Lcom/android/server/knox/ddar/ta/TAProxy$TAInfo;->maxSendCmdSize:I

    iget v13, v5, Lcom/android/server/knox/ddar/ta/TAProxy$TAInfo;->maxRecvRespSize:I

    move-object v7, v6

    invoke-direct/range {v7 .. v13}, Lcom/android/server/knox/ddar/ta/TZNative;-><init>(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;II)V

    iput-object v6, v5, Lcom/android/server/knox/ddar/ta/TAProxy$TAInfo;->ta:Lcom/android/server/knox/ddar/ta/TZNative;

    iget-object v7, p0, Lcom/android/server/knox/ddar/ta/TAProxy;->mTAMap:Ljava/util/Map;
...
.method public loadTA(ILandroid/os/ParcelFileDescriptor;JJ)Z
    ...
    iget-object v1, p0, Lcom/android/server/knox/ddar/ta/TAProxy;->mTAMap:Ljava/util/Map;
