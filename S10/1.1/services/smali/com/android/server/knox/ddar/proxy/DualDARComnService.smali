...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    new-instance v0, Lcom/android/server/knox/ddar/proxy/DualDARComnService$4;

    invoke-direct {v0, p0}, Lcom/android/server/knox/ddar/proxy/DualDARComnService$4;-><init>(Lcom/android/server/knox/ddar/proxy/DualDARComnService;)V
    ...
    iput-object v1, p0, Lcom/android/server/knox/ddar/proxy/DualDARComnService;->mBackgroundHandler:Landroid/os/Handler;

    return-void
.end method

.method static synthetic access$000(Lcom/android/server/knox/ddar/proxy/DualDARComnService;)Landroid/content/Context;
    .locals 1
...
.method static synthetic access$100(Lcom/android/server/knox/ddar/proxy/DualDARComnService;I)V
    .locals 0
...
.method static synthetic access$200(Lcom/android/server/knox/ddar/proxy/DualDARComnService;Ljava/lang/String;)V
    .locals 0
...
.method private connectProxyAgentASync(Lcom/android/server/knox/ddar/proxy/ProxyAgentInfo;)Lcom/android/server/knox/ddar/proxy/ProxyAgentWrapper;
    ...
    invoke-static {v3, v4, v2}, Lcom/android/server/knox/ddar/DDLog;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
...
.method private connectProxyAgentSync(Lcom/android/server/knox/ddar/proxy/ProxyAgentInfo;)Lcom/android/server/knox/ddar/proxy/ProxyAgentWrapper;
    ...
    invoke-static {v0, v3, v2}, Lcom/android/server/knox/ddar/DDLog;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    const-string v4, "Bind Pending. So just wait"
...
.method private findProxyAgentByMetaData(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)Lcom/android/server/knox/ddar/proxy/ProxyAgentInfo;
    ...
    invoke-static {v7, v8, v4}, Lcom/android/server/knox/ddar/DDLog;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    invoke-direct {v4, p1, p2, v7}, Lcom/android/server/knox/ddar/proxy/ProxyAgentInfo;-><init>(Ljava/lang/String;ILandroid/content/ComponentName;)V
...
.method public static synthetic lambda$relayAsync$0(Lcom/android/server/knox/ddar/proxy/DualDARComnService;Lcom/android/server/knox/ddar/proxy/ProxyAgentInfo;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
    .locals 5
    ...
    const-string/jumbo v3, "relayAsync from bg thread, relay start to agent : "
    ...
    const-string/jumbo v4, "relayAsync from bg thread, relay end to agent : "
...
.method private reConnectAgentsByPkgName(Ljava/lang/String;)V
    ...
    invoke-virtual {v5}, Lcom/android/server/knox/ddar/proxy/ProxyAgentWrapper;->enableReconnectionFlag()V
...
.method public handleAgentDied(Lcom/android/server/knox/ddar/proxy/ProxyAgentInfo;)V
    ...
    invoke-virtual {v1}, Lcom/android/server/knox/ddar/proxy/ProxyAgentWrapper;->enableReconnectionFlag()V
    :try_end_1
...
.method public relay(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    const-string/jumbo v4, "relay: Agent not found, agent: "
    ...
    invoke-virtual {v2, v3, p2, p3, p4}, Lcom/android/server/knox/ddar/proxy/ProxyAgentWrapper;->relay(ILjava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
...
.method public relayAsync(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    iget-object v0, p0, Lcom/android/server/knox/ddar/proxy/DualDARComnService;->mBackgroundHandler:Landroid/os/Handler;

    new-instance v8, Lcom/android/server/knox/ddar/proxy/DualDARComnService$2;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/server/knox/ddar/proxy/DualDARComnService$2;-><init>(Lcom/android/server/knox/ddar/proxy/DualDARComnService;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    :cond_1
    iget-object v2, p0, Lcom/android/server/knox/ddar/proxy/DualDARComnService;->mBackgroundHandler:Landroid/os/Handler;

    new-instance v10, Lcom/android/server/knox/ddar/proxy/-$$Lambda$DualDARComnService$F7EFR5LW0TpExehCilzQrTiAHYw;
