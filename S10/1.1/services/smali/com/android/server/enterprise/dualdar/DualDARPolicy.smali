...
.method static constructor <clinit>()V
    ...
    sget-boolean v0, Lcom/android/server/enterprise/dualdar/DualDARPolicy;->IS_USER_DEVICE:Z
    ...
    const-string v1, "com.samsung.android.knox.kpu.demo"

    invoke-interface {v0, v1}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    sget-object v0, Lcom/android/server/enterprise/dualdar/DualDARPolicy;->DUAL_DAR_DEFAULT_WHITELIST_PKGS:Ljava/util/Set;

    const-string v1, "com.samsung.android.knox.kpu.poc"
...
.method private getClientAndProfileOwnerApps(Lcom/samsung/android/knox/ContextInfo;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-interface {v4, v1, v3, v5}, Landroid/content/pm/IPackageManager;->getPackagesHoldingPermissions([Ljava/lang/String;II)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-direct {p0, v3, v4}, Lcom/android/server/enterprise/dualdar/DualDARPolicy;->getConfigFromDb(II)Landroid/os/Bundle;

    move-result-object v3

    const-string/jumbo v4, "dualdar-config-client-package"

    invoke-virtual {v3, v4}, Landroid/os/Bundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    const-string/jumbo v5, "dualdar-config-client-signature"
...
.method private logDualDarAnalytics(Lcom/samsung/android/knox/ContextInfo;Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    :cond_1
    const-string/jumbo v2, "de_access_restriction"
...
.method private setDataLockTimeout(Lcom/samsung/android/knox/ContextInfo;Landroid/os/Bundle;)I
    ...
    const-string/jumbo v5, "setDataLockTimeout Invalid datalock timeout. It should be in range [60000, 9223372036854775807] ms"
...
.method private setDeRestriction(Lcom/samsung/android/knox/ContextInfo;Landroid/os/Bundle;)I
    ...
    const-string/jumbo v2, "deRestriction"
    ...
    const-string/jumbo v4, "de_access_restriction"
...
.method private setDefaultWhitelistedApps(Lcom/samsung/android/knox/ContextInfo;)V
    ...
    const-string/jumbo v1, "setDefaultWhitelistedApps called "
    ...
    const-string v5, "Adding default apps to whitelist:"
    ...
    invoke-direct {v7, v8, v9}, Lcom/samsung/android/knox/AppIdentity;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v6, "setDualDARDefaultPolicy(), Unable to get installed packages list"
    ...
    const-string/jumbo v6, "setDefaultWhitelistedApps called, whitelistAppCount: "
    ...
    invoke-virtual {v5, v6, v7, v8, v4}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->putValues(IILjava/lang/String;Landroid/content/ContentValues;)Z
    ...
    const-string/jumbo v7, "successfully added whitelist packages"
    ...
    const-string/jumbo v7, "failed to write new whitelist packages to persistent storage"

    new-array v2, v2, [Ljava/lang/Object;

    invoke-static {v6, v7, v2}, Lcom/android/server/knox/ddar/DDLog;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
