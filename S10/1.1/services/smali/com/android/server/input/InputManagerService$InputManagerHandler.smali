...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v0}, Lcom/android/server/input/InputManagerService;->access$2900(Lcom/android/server/input/InputManagerService;)Landroid/view/inputmethod/InputMethodManager;
    ...
    invoke-static {v4}, Lcom/android/server/input/InputManagerService;->access$3000(Lcom/android/server/input/InputManagerService;)Ljava/util/List;
    ...
    invoke-static {v5}, Lcom/android/server/input/InputManagerService;->access$3000(Lcom/android/server/input/InputManagerService;)Ljava/util/List;
    ...
    invoke-static {v7, v4}, Lcom/android/server/input/InputManagerService;->access$3002(Lcom/android/server/input/InputManagerService;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v8}, Lcom/android/server/input/InputManagerService;->access$3000(Lcom/android/server/input/InputManagerService;)Ljava/util/List;

    move-result-object v8

    invoke-static {v7, v8}, Lcom/android/server/input/InputManagerService;->access$3100(Lcom/android/server/input/InputManagerService;Ljava/util/List;)V
    ...
    invoke-static {v9}, Lcom/android/server/input/InputManagerService;->access$2900(Lcom/android/server/input/InputManagerService;)Landroid/view/inputmethod/InputMethodManager;
    ...
    invoke-static {v10}, Lcom/android/server/input/InputManagerService;->access$3000(Lcom/android/server/input/InputManagerService;)Ljava/util/List;

    move-result-object v10

    invoke-static {v9, v1, v8, v10}, Lcom/android/server/input/InputManagerService;->access$3200(Lcom/android/server/input/InputManagerService;Landroid/hardware/input/InputDeviceIdentifier;Landroid/view/inputmethod/InputMethodInfo;Ljava/util/List;)V
    ...
    invoke-static {v0, v1}, Lcom/android/server/input/InputManagerService;->access$2800(Lcom/android/server/input/InputManagerService;I)V
    ...
    invoke-static {v4, v0, v2, v3}, Lcom/android/server/input/InputManagerService;->access$2700(Lcom/android/server/input/InputManagerService;ILandroid/view/inputmethod/InputMethodInfo;Landroid/view/inputmethod/InputMethodSubtype;)V
    ...
    invoke-static {v4, v1, v2, v3}, Lcom/android/server/input/InputManagerService;->access$2600(Lcom/android/server/input/InputManagerService;JZ)V
    ...
    invoke-static {v2, v0, v1}, Lcom/android/server/input/InputManagerService;->access$2500(Lcom/android/server/input/InputManagerService;ILandroid/view/PointerIcon;)V
