...
.method static synthetic access$3200(Lcom/android/server/SdpManagerService$SecureFileSystemManager;I)Z
    .locals 1
...
.method static synthetic access$3300(Lcom/android/server/SdpManagerService$SecureFileSystemManager;ILjava/lang/String;)Z
    .locals 1
...
.method static synthetic access$5500(Lcom/android/server/SdpManagerService$SecureFileSystemManager;)Z
    .locals 1
...
.method static synthetic access$5600(Lcom/android/server/SdpManagerService$SecureFileSystemManager;)Z
    .locals 1
...
.method static synthetic access$5700(Lcom/android/server/SdpManagerService$SecureFileSystemManager;)Z
    .locals 1
...
.method private createPartition()Z
    ...
    invoke-static {v2, v3, v4}, Lcom/android/server/SdpManagerService$SecureFileSystemManager$SecureFileSystemDatabase;->access$4400(Lcom/android/server/SdpManagerService$SecureFileSystemManager$SecureFileSystemDatabase;ILjava/lang/String;)I
...
.method static synthetic lambda$prepare$1(ILcom/android/server/pm/PackageManagerService;)Ljava/lang/Boolean;
    .locals 1
...
.method private prepare(I)Z
    ...
    invoke-static {v0}, Lcom/android/server/SdpManagerService;->access$4500(Lcom/android/server/SdpManagerService;)Z
    ...
    invoke-static {v0, p1}, Lcom/android/server/SdpManagerService;->access$4700(Lcom/android/server/SdpManagerService;I)Z
    ...
    invoke-static {v6}, Lcom/android/server/SdpManagerService;->access$4800(Lcom/android/server/SdpManagerService;)Ljava/util/Optional;

    move-result-object v6

    new-instance v7, Lcom/android/server/-$$Lambda$SdpManagerService$SecureFileSystemManager$6UuPYpOf9inG1RfNFU7V85ZKbsY;

    invoke-direct {v7, p1}, Lcom/android/server/-$$Lambda$SdpManagerService$SecureFileSystemManager$6UuPYpOf9inG1RfNFU7V85ZKbsY;-><init>(I)V
...
.method private setBaseDataUserDir(I)Z
    ...
    const-string/jumbo v3, "setBaseDataUserDir :: Error - SecureFileSysstem not activated... "
    ...
    iget-object v3, p0, Lcom/android/server/SdpManagerService$SecureFileSystemManager;->this$0:Lcom/android/server/SdpManagerService;

    invoke-static {v3}, Lcom/android/server/SdpManagerService;->access$4500(Lcom/android/server/SdpManagerService;)Z
    ...
    invoke-static {v3}, Lcom/android/server/SdpManagerService;->access$4600(Lcom/android/server/SdpManagerService;)Ljava/util/Optional;

    move-result-object v3

    new-instance v4, Lcom/android/server/-$$Lambda$SdpManagerService$SecureFileSystemManager$ggL7SuJvSHOCvWVR9jp0S6Kokjc;

    invoke-direct {v4, p1, v2}, Lcom/android/server/-$$Lambda$SdpManagerService$SecureFileSystemManager$ggL7SuJvSHOCvWVR9jp0S6Kokjc;-><init>(ILjava/io/File;)V
    ...
    :cond_3
    :goto_1
    const-string v1, "SecureFileSystem"
