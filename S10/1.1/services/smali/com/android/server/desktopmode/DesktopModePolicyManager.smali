...
.field private static mLaunchPolicyDatabaseBlocker:Lcom/android/server/desktopmode/LaunchPolicyDatabaseBlocker;
...
.method public static clearLaunchPolicyDatabaseCache()V
    ...
    const-string v2, "clearLaunchPolicyDatabaseCache(), size="
...
.method private static getLaunchPolicyDatabase(Landroid/content/Context;)Landroid/os/Bundle;
    ...
    :goto_0
    invoke-virtual {v1, v2}, Lcom/android/server/desktopmode/DesktopModePolicyManager$LaunchPolicyDatabaseHelper;->getLaunchPolicyDatabase(I)Landroid/util/ArrayMap;
    ...
    invoke-virtual {v0, v9, v7}, Landroid/os/Bundle;->putStringArray(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    invoke-virtual {v9}, Lcom/samsung/android/desktopmode/DesktopModeManagerInternal;->getDesktopModeState()Lcom/samsung/android/desktopmode/SemDesktopModeState;
...
.method public static getLaunchPolicyForPackage(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;Landroid/content/pm/ActivityInfo;)I
    ...
    const-string v3, "Developer Mode is true, return "
    ...
    const-string v3, "No appInfo. return "
    ...
    const-string v4, "No packageName. return "
    ...
    const-string v4, ", isNotSupportedDeclared true, return "
    ...
    const-string v4, ", isNotSupportedListed package true, return "
    ...
    const-string v4, ", getLaunchPolicyFromDatabaseCache:"
    ...
    const-string v5, ", activityInfo not null"

    invoke-virtual {v2, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-static {p0, v3, v4}, Lcom/android/server/desktopmode/DesktopModePolicyManager;->isTouchScreenDeclared(Landroid/content/Context;Ljava/lang/String;I)Z
    ...
    const-string v5, ", isTouchScreenDeclared true, return "
    ...
    :cond_e
    invoke-static {p0, v3, v4}, Lcom/android/server/desktopmode/DesktopModePolicyManager;->isCategoryHomeDeclared(Landroid/content/Context;Ljava/lang/String;I)Z
    ...
    const-string v5, ", isCategoryHomeDeclared true, return "
    ...
    :cond_10
    invoke-static {p0, v3, v4}, Lcom/android/server/desktopmode/DesktopModePolicyManager;->hasBindInputMethodService(Landroid/content/Context;Ljava/lang/String;I)Z
    ...
    const-string v5, ", hasBindInputMethodService true, return "
    ...
    const-string v5, ", isGameFromGameManager true"
    ...
    const-string v5, ", isForcedFreeformDeclared true, return "
    ...
    const-string v6, ", getLaunchPolicyFromResizeMode:"
    ...
    const-string v6, ", isPreloadedAppResizeable true, return "
    ...
    :cond_1b
    const-string v6, ", FromDatabaseCache, return "
...
.method private static getLaunchPolicyFromDatabaseCache(Landroid/content/Context;Ljava/lang/String;)I
    ...
    :goto_0
    invoke-static {p0, v1}, Lcom/android/server/desktopmode/DesktopModePolicyManager;->initLaunchPolicyDatabaseCache(Landroid/content/Context;I)V
...
.method public static getLaunchPolicyRunnable(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;)Z
    ...
    const-string/jumbo v3, "getLaunchPolicyRunnable(), runnable="
    ...
    const-string/jumbo v2, "getLaunchPolicyRunnable(), runnable=true, no appInfo)"
...
.method private static hasBindInputMethodService(Landroid/content/Context;Ljava/lang/String;I)Z
    ...
    const-string/jumbo v4, "hasBindInputMethodService(false, except, "
    ...
    const-string/jumbo v5, "hasBindInputMethodService(false, "
    ...
    const-string/jumbo v3, "hasBindInputMethodService(true, "
...
.method public static initLaunchPolicyDatabase(Landroid/content/Context;Lcom/android/server/desktopmode/IStateManager;I)V
    .locals 2
    ...
    invoke-interface {p1, v0}, Lcom/android/server/desktopmode/IStateManager;->setLaunchPolicyDatabaseCreated(Z)V

    invoke-static {p0, p2}, Lcom/android/server/desktopmode/DesktopModePolicyManager;->initLaunchPolicyDatabaseCache(Landroid/content/Context;I)V
    ...
    const-string/jumbo v1, "initLaunchPolicyDatabase(), LaunchPolicyDatabase does not exist."
    ...
    sget-object v0, Lcom/android/server/desktopmode/DesktopModePolicyManager;->mLaunchPolicyDatabaseBlocker:Lcom/android/server/desktopmode/LaunchPolicyDatabaseBlocker;

    if-nez v0, :cond_2

    new-instance v0, Lcom/android/server/desktopmode/LaunchPolicyDatabaseBlocker;

    invoke-direct {v0, p0, p1}, Lcom/android/server/desktopmode/LaunchPolicyDatabaseBlocker;-><init>(Landroid/content/Context;Lcom/android/server/desktopmode/IStateManager;)V

    sput-object v0, Lcom/android/server/desktopmode/DesktopModePolicyManager;->mLaunchPolicyDatabaseBlocker:Lcom/android/server/desktopmode/LaunchPolicyDatabaseBlocker;

    :cond_2
    sget-object v0, Lcom/android/server/desktopmode/DesktopModePolicyManager;->mLaunchPolicyDatabaseBlocker:Lcom/android/server/desktopmode/LaunchPolicyDatabaseBlocker;

    invoke-virtual {v0}, Lcom/android/server/desktopmode/LaunchPolicyDatabaseBlocker;->registerBlocker()V

    :goto_0
    return-void
.end method

.method private static initLaunchPolicyDatabaseCache(Landroid/content/Context;I)V
    .locals 5
    ...
    sget-object v4, Lcom/android/server/desktopmode/DesktopModePolicyManager;->mLaunchPolicyDatabaseUpdatedReason:Ljava/lang/String;
    ...
    sput-object v4, Lcom/android/server/desktopmode/DesktopModePolicyManager;->mLaunchPolicyDatabaseVersion:Ljava/lang/String;
    ...
    const-string/jumbo v4, "initLaunchPolicyDatabaseCache(), size="
    ...
    const-string/jumbo v2, "initLaunchPolicyDatabaseCache(), size="
    ...
    const-string v2, ", cache already exists"
...
.method private static isCategoryHomeDeclared(Landroid/content/Context;Ljava/lang/String;I)Z
    ...
    const-string/jumbo v3, "isCategoryHomeDeclared(false, except, "
    ...
    const-string/jumbo v5, "isCategoryHomeDeclared(true, "
...
.method private static isForcedFreeformDeclared(Landroid/content/Context;Ljava/lang/String;Landroid/content/pm/ApplicationInfo;)Z
    ...
    const-string/jumbo v4, "isForcedFreeformDeclared(true, "
...
.method private static isGameFromGameManager(Ljava/lang/String;)Z
    ...
    const-string/jumbo v7, "isGameFromGameManager(true, "
    ...
    const-string/jumbo v4, "isGameFromGameManager()"
...
.method public static isLaunchPolicyDatabaseCreated()Z
    .locals 1
...
.method private static isNotSupportedDeclared(Landroid/content/Context;Ljava/lang/String;Landroid/content/pm/ApplicationInfo;)Z
    .locals 5
    ...
    const-string/jumbo v4, "isNotSupportedDeclared(true, "
...
.method private static isTouchScreenDeclared(Landroid/content/Context;Ljava/lang/String;I)Z
    ...
    const-string/jumbo v6, "isTouchScreenDeclared DISPLAY_TYPE_STANDALONE(false, standalone, "
    ...
    const-string/jumbo v6, "isTouchScreenDeclared(false, except, "
    ...
    invoke-virtual {v3, p1, v5, p2}, Landroid/content/pm/PackageManager;->getPackageInfoAsUser(Ljava/lang/String;II)Landroid/content/pm/PackageInfo;

    move-result-object v3

    if-eqz v3, :cond_8

    iget-object v5, v3, Landroid/content/pm/PackageInfo;->reqFeatures:[Landroid/content/pm/FeatureInfo;
    ...
    const-string v9, "android.hardware.touchscreen"
    ...
    const-string/jumbo v5, "isTouchScreenDeclared(true, "
