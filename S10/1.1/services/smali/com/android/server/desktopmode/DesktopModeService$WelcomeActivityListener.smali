...
.method static synthetic access$4100(Lcom/android/server/desktopmode/DesktopModeService$WelcomeActivityListener;ZZ)V
    .locals 0
...
.method static synthetic access$4200(Lcom/android/server/desktopmode/DesktopModeService$WelcomeActivityListener;ZII)V
    .locals 0
...
.method private setDesktopModeState(ZII)V
    ...
    invoke-static {v0}, Lcom/android/server/desktopmode/DesktopModeService;->access$1300(Lcom/android/server/desktopmode/DesktopModeService;)Lcom/android/server/desktopmode/StandaloneModeChanger;
    ...
    invoke-static {v0}, Lcom/android/server/desktopmode/DesktopModeService;->access$1400(Lcom/android/server/desktopmode/DesktopModeService;)Lcom/android/server/desktopmode/DualModeChanger;
...
.method private showOrDismissPresentation(ZZ)V
    ...
    invoke-static {v2}, Lcom/android/server/desktopmode/DesktopModeService;->access$4300(Lcom/android/server/desktopmode/DesktopModeService;)Lcom/android/server/desktopmode/CoverStateManager;

    move-result-object v2

    invoke-virtual {v2}, Lcom/android/server/desktopmode/CoverStateManager;->isFlipTypeCoverClosed()Z
    ...
    const-string/jumbo v2, "showOrDismissPresentation(), show=true, isCoverSupportStatePartial="

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, p2}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v2, ", skip showing external presentation since cover is closed"
    ...
    const-string/jumbo v4, "showOrDismissPresentation(), show=true, isCoverSupportStatePartial="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, p2}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v4, ", showing external presentation"
    ...
    invoke-static {v3}, Lcom/android/server/desktopmode/DesktopModeService;->access$3800(Lcom/android/server/desktopmode/DesktopModeService;)Lcom/android/server/desktopmode/UiManager;
    ...
    invoke-static {v3}, Lcom/android/server/desktopmode/DesktopModeService;->access$4300(Lcom/android/server/desktopmode/DesktopModeService;)Lcom/android/server/desktopmode/CoverStateManager;
    ...
    const-string/jumbo v4, "showOrDismissPresentation(), show=false, isCoverSupportStatePartial="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, p2}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v4, ", dismissing external presentation"
...
.method onClickButtonPositive()V
    ...
    invoke-static {v0}, Lcom/android/server/desktopmode/DesktopModeService;->access$3600(Lcom/android/server/desktopmode/DesktopModeService;)V
    ...
    invoke-static {v1}, Lcom/android/server/desktopmode/DesktopModeService;->access$200(Lcom/android/server/desktopmode/DesktopModeService;)Landroid/content/ContentResolver;
...
.method onDismiss()V
    ...
    invoke-static {v0}, Lcom/android/server/desktopmode/DesktopModeService;->access$4400(Lcom/android/server/desktopmode/DesktopModeService;)Landroid/os/Handler;
