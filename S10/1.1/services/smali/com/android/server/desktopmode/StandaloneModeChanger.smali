...
.method private handleStopLoadingScreen(ZI)V
    ...
    const-string v4, "Loading screen dismissed by timeout enter="
    ...
    invoke-virtual {p0, v1, v2, v0}, Lcom/android/server/desktopmode/StandaloneModeChanger;->hasPackageTask(ILjava/lang/String;I)Z
    ...
    const-string v3, "DesktopLauncher Task does not exist"
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/desktopmode/StandaloneModeChanger;->startHome(Lcom/android/server/desktopmode/State;)V
...
.method private scheduleStopLoadingScreenIfPossible()V
    ...
    const-string/jumbo v4, "scheduleStopLoadingScreenIfPossible(), mWallpaperShown="
    ...
    const-string v4, ", mStandaloneModeEnabled="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v4, p0, Lcom/android/server/desktopmode/StandaloneModeChanger;->mStandaloneModeEnabled:Z

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v4, ", mIsLaunchPolicyDatabaseCreated="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, v1}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v4, ", InternalPresentation="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v4, p0, Lcom/android/server/desktopmode/StandaloneModeChanger;->mUiManager:Lcom/android/server/desktopmode/UiManager;

    const/16 v5, 0x66

    invoke-virtual {v4, v5}, Lcom/android/server/desktopmode/UiManager;->getCurrentPresentationType(I)I

    move-result v4

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v4, ", ExternalPresentation="
    ...
    :cond_0
    iget-boolean v2, p0, Lcom/android/server/desktopmode/StandaloneModeChanger;->mWallpaperShown:Z
    ...
    invoke-virtual {v2, v4, v3}, Lcom/android/server/desktopmode/UiManager;->hasPresentation(II)Z

    move-result v2

    if-eqz v2, :cond_1

    iget-boolean v2, p0, Lcom/android/server/desktopmode/StandaloneModeChanger;->mStandaloneModeEnabled:Z
...
.method getConfigurationState(Landroid/content/res/Configuration;)I
    ...
    invoke-virtual {v5}, Lcom/android/server/desktopmode/MultiResolutionManager;->getStandaloneModeDensity()I
    ...
    invoke-virtual {v6, v1}, Lcom/android/server/desktopmode/MultiResolutionManager;->getStandaloneModeOriginalDensity(I)I
...
.method setDesktopMode(Lcom/android/server/desktopmode/State;ZLcom/android/server/desktopmode/ModeChanger$ModeToModeChangeInfo;)Lcom/android/server/desktopmode/ModeChanger$ModeToModeChangeInfo;
    ...
    invoke-virtual {v0, v1}, Landroid/app/ActivityManagerInternal;->getForegroundTaskId(I)I
