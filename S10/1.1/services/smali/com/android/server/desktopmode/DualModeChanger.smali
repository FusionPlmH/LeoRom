...
.field private mDisplayUnsupportDialogShown:Z
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/desktopmode/ModeChangerService;Lcom/android/server/desktopmode/IStateManager;Lcom/android/server/desktopmode/SemDesktopModeStateNotifier;Landroid/os/Handler;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/desktopmode/DualModeChanger;->mDisplayUnsupportDialogShown:Z
    ...
    iput v0, p0, Lcom/android/server/desktopmode/DualModeChanger;->mTopTaskId:I
...
.method static synthetic access$1600(Lcom/android/server/desktopmode/DualModeChanger;)Z
    .locals 1
...
.method static synthetic access$1700(Lcom/android/server/desktopmode/DualModeChanger;Lcom/android/server/desktopmode/State;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/desktopmode/DualModeChanger;->showDisplayUnsupportDialogIfNeeded(Lcom/android/server/desktopmode/State;)V
...
.method static synthetic access$400(Lcom/android/server/desktopmode/DualModeChanger;Lcom/android/server/desktopmode/State;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/desktopmode/DualModeChanger;->startSecuredAppLearnMore(Lcom/android/server/desktopmode/State;)V

    return-void
.end method

.method static synthetic access$500(Lcom/android/server/desktopmode/DualModeChanger;Lcom/android/server/desktopmode/State;)V
    .locals 0
...
.method static synthetic access$602(Lcom/android/server/desktopmode/DualModeChanger;Z)Z
    .locals 0
...
.method static synthetic access$700(Lcom/android/server/desktopmode/DualModeChanger;Z)V
    .locals 0
...
.method private handleStartLoadingScreen(Lcom/android/server/desktopmode/State;Z)V
    .locals 4
    ...
    new-instance v3, Lcom/android/server/desktopmode/DualModeChanger$3;

    invoke-direct {v3, p0}, Lcom/android/server/desktopmode/DualModeChanger$3;-><init>(Lcom/android/server/desktopmode/DualModeChanger;)V
    ...
    invoke-interface {v0, p2}, Lcom/android/server/desktopmode/IStateManager;->notifyDualModeStartLoadingScreen(Z)V

    invoke-direct {p0, p2}, Lcom/android/server/desktopmode/DualModeChanger;->setDesktopModeInternal(Z)V
...
.method private handleStopLoadingScreen(ZI)V
    ...
    invoke-virtual {p0, v2, v3, v1}, Lcom/android/server/desktopmode/DualModeChanger;->hasPackageTask(ILjava/lang/String;I)Z
    ...
    const-string v3, "DesktopLauncher task does not exist in DeX display"
    ...
    iget-object v2, p0, Lcom/android/server/desktopmode/DualModeChanger;->mActivityManagerInternal:Landroid/app/ActivityManagerInternal;
    ...
    invoke-virtual {v2, v3, v4, v5}, Landroid/app/ActivityManagerInternal;->bringStackToForeground(III)V

    :cond_6
    const-string/jumbo v2, "dex_enabled_font"

    invoke-static {v2, p1}, Lcom/android/server/desktopmode/DesktopModeSettings;->setSystemProperties(Ljava/lang/String;Z)V
    ...
    iput-boolean v2, p0, Lcom/android/server/desktopmode/DualModeChanger;->mDisplayUnsupportDialogShown:Z
    ...
    :cond_7
    invoke-direct {p0, v2}, Lcom/android/server/desktopmode/DualModeChanger;->setModeChangeLock(Z)V
    ...
    :cond_8
    invoke-virtual {p0, v1, v2}, Lcom/android/server/desktopmode/DualModeChanger;->setDesktopModeState(II)V
    ...
    invoke-interface {v1, p1}, Lcom/android/server/desktopmode/IStateManager;->notifyDualModeStopLoadingScreen(Z)V
    ...
    invoke-static {v1}, Lcom/android/server/desktopmode/DualModeChanger$ModeChangeReceiver;->access$800(Lcom/android/server/desktopmode/DualModeChanger$ModeChangeReceiver;)V
    ...
    iget-object v1, p0, Lcom/android/server/desktopmode/DualModeChanger;->mResolver:Landroid/content/ContentResolver;
...
.method private scheduleStartLoadingScreen(Lcom/android/server/desktopmode/State;Z)V
    .locals 6
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/desktopmode/DualModeChanger;->handleStartLoadingScreen(Lcom/android/server/desktopmode/State;Z)V
...
.method private scheduleStopLoadingScreenIfPossible(Z)V
    ...
    invoke-interface {v1}, Lcom/android/server/desktopmode/State;->isLaunchPolicyDatabaseCreated()Z
    ...
    const-string/jumbo v4, "scheduleStopLoadingScreenIfPossible(), enter="
    ...
    iget-boolean v4, p0, Lcom/android/server/desktopmode/DualModeChanger;->mWallpaperShown:Z

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v4, ", mLoadingScreenAnimationComplete="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v4, p0, Lcom/android/server/desktopmode/DualModeChanger;->mLoadingScreenAnimationComplete:Z

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v4, ", isLaunchPolicyDatabaseCreated="
    ...
    invoke-virtual {v0, v3, v4, v5}, Lcom/samsung/android/desktopmode/SemDesktopModeState;->compareTo(III)Z
    ...
    iget-object v3, p0, Lcom/android/server/desktopmode/DualModeChanger;->mHandler:Landroid/os/Handler;
    ...
    invoke-virtual {v3, v2, v5, v5, v4}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method private showInitialSPenDialog(Lcom/android/server/desktopmode/State;)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/android/server/desktopmode/DualModeChanger$2;-><init>(Lcom/android/server/desktopmode/DualModeChanger;Lcom/android/server/desktopmode/State;)V
...
.method private showSecuredAppLaunchedDialog()V
    .locals 5
    ...
    new-instance v1, Lcom/android/server/desktopmode/DualModeChanger$1;

    invoke-direct {v1, p0, v0}, Lcom/android/server/desktopmode/DualModeChanger$1;-><init>(Lcom/android/server/desktopmode/DualModeChanger;Lcom/android/server/desktopmode/State;)V
    ...
    invoke-virtual {v2, v3, v4, v1}, Lcom/android/server/desktopmode/UiManager;->showDialog(IILcom/android/server/desktopmode/UiManager$InternalUiCallback;)V
...
.method private startSecuredAppLearnMore(Lcom/android/server/desktopmode/State;)V
    .locals 3
    ...
    const-string/jumbo v1, "startSecuredAppLearnMore()"
    ...
    invoke-static {}, Lcom/android/server/desktopmode/Utils;->getPostDataForSecuredAppLearnMore()Ljava/lang/String;

    move-result-object v2

    invoke-static {v1, v2}, Lcom/android/server/desktopmode/Utils;->getMuseUrl(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
...
.method dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    const-string/jumbo v0, "mTopTaskId"
...
.method getModeToModeChangeType()I
    .locals 1

    iget-object v0, p0, Lcom/android/server/desktopmode/DualModeChanger;->mModeToModeChangeInfo:Lcom/android/server/desktopmode/ModeChanger$ModeToModeChangeInfo;
...
.method public onLaunchPolicyDatabaseCreated()V
    .locals 1

    const/4 v0, 0x1

    invoke-direct {p0, v0}, Lcom/android/server/desktopmode/DualModeChanger;->scheduleStopLoadingScreenIfPossible(Z)V

    return-void
.end method

.method onSecuredAppLaunched(ILjava/lang/String;)V
    .locals 5

    iget-object v0, p0, Lcom/android/server/desktopmode/DualModeChanger;->mResolver:Landroid/content/ContentResolver;

    const-string/jumbo v1, "secured_app_dialog_shown"
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/server/desktopmode/DualModeChanger;->showSecuredAppLaunchedDialog()V
    ...
    const-string v4, "com.samsung.android.desktopmode.action.SECURED_APP_LAUNCHED"
    ...
    const-string v4, "com.samsung.android.desktopmode.extra.TASK_ID"

    invoke-virtual {v3, v4, p1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    move-result-object v3

    const-string v4, "com.samsung.android.desktopmode.extra.PACKAGE_NAME"
...
.method setDesktopMode(Lcom/android/server/desktopmode/State;ZLcom/android/server/desktopmode/ModeChanger$ModeToModeChangeInfo;)Lcom/android/server/desktopmode/ModeChanger$ModeToModeChangeInfo;
    ...
    iput v4, p0, Lcom/android/server/desktopmode/DualModeChanger;->mTopTaskId:I
    ...
    :goto_1
    invoke-virtual {v4, v5}, Landroid/app/ActivityManagerInternal;->getForegroundTaskId(I)I
    ...
    iget v4, p0, Lcom/android/server/desktopmode/DualModeChanger;->mTopTaskId:I

    invoke-virtual {p3, v4}, Lcom/android/server/desktopmode/ModeChanger$ModeToModeChangeInfo;->setTopTaskId(I)V
    ...
    invoke-static {v0, v1, v2}, Lcom/android/server/desktopmode/DesktopModePolicyManager;->initLaunchPolicyDatabase(Landroid/content/Context;Lcom/android/server/desktopmode/IStateManager;I)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/desktopmode/DualModeChanger;->scheduleStartLoadingScreen(Lcom/android/server/desktopmode/State;Z)V
