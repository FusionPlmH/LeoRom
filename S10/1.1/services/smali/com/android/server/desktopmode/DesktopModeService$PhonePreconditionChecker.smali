...
.method public cancelOngoingNotification()V
    ...
    invoke-static {v0, v1}, Lcom/android/server/desktopmode/DesktopModeService;->access$2600(Lcom/android/server/desktopmode/DesktopModeService;I)V
...
.method public isAllowed(Lcom/android/server/desktopmode/State;ZZ)Z
    ...
    invoke-static {p1}, Lcom/android/server/desktopmode/DesktopModeService;->access$3100(Lcom/android/server/desktopmode/State;)Z
...
.method public isDesktopModeAvailableEx(ZZ)Z
    ...
    invoke-static {v0}, Lcom/android/server/desktopmode/DesktopModeService;->access$3400(Lcom/android/server/desktopmode/State;)Z
...
.method public updateDesktopMode(Lcom/android/server/desktopmode/State;Z)Z
    ...
    invoke-static {p1}, Lcom/android/server/desktopmode/DesktopModeService;->access$3400(Lcom/android/server/desktopmode/State;)Z
    ...
    invoke-static {v1}, Lcom/android/server/desktopmode/DesktopModeService;->access$3500(Lcom/android/server/desktopmode/DesktopModeService;)I
    ...
    invoke-static {v2}, Lcom/android/server/desktopmode/DesktopModeService;->access$2500(Lcom/android/server/desktopmode/DesktopModeService;)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/desktopmode/DesktopModeService;->setHdmiSettings(Z)V
    ...
    invoke-static {v2}, Lcom/android/server/desktopmode/DesktopModeService;->access$1400(Lcom/android/server/desktopmode/DesktopModeService;)Lcom/android/server/desktopmode/DualModeChanger;

    move-result-object v2

    invoke-virtual {v2, p1, v3}, Lcom/android/server/desktopmode/DualModeChanger;->setDesktopMode(Lcom/android/server/desktopmode/State;Z)V
    ...
    invoke-static {v4}, Lcom/android/server/desktopmode/DesktopModeService;->access$3600(Lcom/android/server/desktopmode/DesktopModeService;)V
...
.method public declared-synchronized updateOngoingNotification()V
    ...
    invoke-static {v0}, Lcom/android/server/desktopmode/DesktopModeService;->access$3100(Lcom/android/server/desktopmode/State;)Z
    ...
    :cond_3
    invoke-interface {v0}, Lcom/android/server/desktopmode/State;->isDexStationConnectedWithFlipCover()Z
    ...
    invoke-static {v2, v3}, Lcom/android/server/desktopmode/DesktopModeService;->access$3700(Lcom/android/server/desktopmode/DesktopModeService;I)V
    ...
    invoke-static {v2, v8}, Lcom/android/server/desktopmode/DesktopModeService;->access$3700(Lcom/android/server/desktopmode/DesktopModeService;I)V
    ...
    invoke-static {v2, v3}, Lcom/android/server/desktopmode/DesktopModeService;->access$2600(Lcom/android/server/desktopmode/DesktopModeService;I)V
    :try_end_1
