...
.field private final mHandler:Lcom/android/server/desktopmode/UiManager$UiCommandHandler;
...
.method constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    new-instance v0, Lcom/android/server/desktopmode/UiManager$UiCommandHandler;

    invoke-virtual {p2}, Landroid/os/Handler;->getLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/android/server/desktopmode/UiManager$UiCommandHandler;-><init>(Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/android/server/desktopmode/UiManager;->mHandler:Lcom/android/server/desktopmode/UiManager$UiCommandHandler;
...
.method static synthetic access$300(Lcom/android/server/desktopmode/UiManager;)Lcom/android/server/desktopmode/UiManager$UiCommandHandler;
    .locals 1
...
.method private postUnbindServiceRunnable()V
    ...
    iget-object v1, p0, Lcom/android/server/desktopmode/UiManager;->mHandler:Lcom/android/server/desktopmode/UiManager$UiCommandHandler;

    iget-object v2, p0, Lcom/android/server/desktopmode/UiManager;->mUnbindServiceRunnable:Ljava/lang/Runnable;

    const-wide/16 v3, 0xbb8

    invoke-virtual {v1, v2, v3, v4}, Lcom/android/server/desktopmode/UiManager$UiCommandHandler;->postDelayed(Ljava/lang/Runnable;J)Z
...
.method private resetUnbindServiceRunnable()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/desktopmode/UiManager$UiCommandHandler;->removeCallbacks(Ljava/lang/Runnable;)V
...
.method setCurrentUserId(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/desktopmode/UiManager$UiCommandHandler;->post(Ljava/lang/Runnable;)Z
