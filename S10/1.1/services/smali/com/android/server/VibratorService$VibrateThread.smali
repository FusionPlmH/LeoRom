...
.method constructor <init>(Lcom/android/server/VibratorService;Lcom/android/server/VibratorService$Vibration;)V
    ...
    invoke-static {p2}, Lcom/android/server/VibratorService$Vibration;->access$1500(Lcom/android/server/VibratorService$Vibration;)I

    move-result v0

    iput v0, p0, Lcom/android/server/VibratorService$VibrateThread;->mFrequency:I

    invoke-static {p2}, Lcom/android/server/VibratorService$Vibration;->access$2000(Lcom/android/server/VibratorService$Vibration;)Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/server/VibratorService$VibrateThread;->mCommonUse:Z

    invoke-static {p1}, Lcom/android/server/VibratorService;->access$2200(Lcom/android/server/VibratorService;)Landroid/os/WorkSource;
    ...
    invoke-static {p1}, Lcom/android/server/VibratorService;->access$2300(Lcom/android/server/VibratorService;)Landroid/os/PowerManager$WakeLock;
...
.method private delayLocked(J)J
    ...
    const-string/jumbo v0, "delayLocked"
...
.method private playCommonPattern()V
    ...
    invoke-static {v0}, Lcom/android/server/VibratorService$Vibration;->access$1300(Lcom/android/server/VibratorService$Vibration;)[J
    ...
    invoke-static {v4}, Lcom/android/server/VibratorService$Vibration;->access$1600(Lcom/android/server/VibratorService$Vibration;)I

    move-result v11

    iget-object v4, v1, Lcom/android/server/VibratorService$VibrateThread;->mVibration:Lcom/android/server/VibratorService$Vibration;

    invoke-static {v4}, Lcom/android/server/VibratorService$Vibration;->access$1400(Lcom/android/server/VibratorService$Vibration;)I

    move-result v12

    move-wide/from16 v6, v25

    invoke-static/range {v5 .. v12}, Lcom/android/server/VibratorService;->access$2800(Lcom/android/server/VibratorService;JIIIII)V
    ...
    invoke-static/range {v16 .. v22}, Lcom/android/server/VibratorService;->access$2900(Lcom/android/server/VibratorService;JIIII)V
    ...
    invoke-static {v5}, Lcom/android/server/VibratorService$Vibration;->access$1400(Lcom/android/server/VibratorService$Vibration;)I
    ...
    invoke-static/range {v16 .. v24}, Lcom/android/server/VibratorService;->access$3000(Lcom/android/server/VibratorService;JII[IIII)V
...
.method public cancel()V
    ...
    invoke-static {v0}, Lcom/android/server/VibratorService;->access$2400(Lcom/android/server/VibratorService;)Lcom/android/server/VibratorService$VibrateThread;
...
.method public playWaveform()V
    ...
    invoke-static/range {v13 .. v20}, Lcom/android/server/VibratorService;->access$2600(Lcom/android/server/VibratorService;JIIIII)V
    ...
    invoke-static {v2, v12}, Lcom/android/server/VibratorService;->access$2700(Lcom/android/server/VibratorService;I)V
...
.method public run()V
    ...
    invoke-static {v0}, Lcom/android/server/VibratorService;->access$2300(Lcom/android/server/VibratorService;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-static {v1}, Lcom/android/server/VibratorService;->access$2400(Lcom/android/server/VibratorService;)Lcom/android/server/VibratorService$VibrateThread;
    ...
    invoke-static {v1, v2}, Lcom/android/server/VibratorService;->access$2402(Lcom/android/server/VibratorService;Lcom/android/server/VibratorService$VibrateThread;)Lcom/android/server/VibratorService$VibrateThread;
    ...
    invoke-static {v1, v2}, Lcom/android/server/VibratorService;->access$2500(Lcom/android/server/VibratorService;Lcom/android/server/VibratorService$Vibration;)V
    ...
    invoke-static {v1}, Lcom/android/server/VibratorService;->access$2300(Lcom/android/server/VibratorService;)Landroid/os/PowerManager$WakeLock;
