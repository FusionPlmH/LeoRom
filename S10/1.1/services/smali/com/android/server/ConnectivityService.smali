...
.method private dumpExtras(Ljava/io/FileDescriptor;Lcom/android/internal/util/IndentingPrintWriter;[Ljava/lang/String;)V
    ...
    :try_start_1
    iget-object v0, p0, Lcom/android/server/ConnectivityService;->mDiagnosticHisotry:Ljava/util/Deque;
...
.method private getActiveNetworkForUidInternal(IZ)Landroid/net/Network;
    ...
    const-string v3, "Vpn: getActiveNetworkForUidInternal: "
    ...
    iget-object v3, p0, Lcom/android/server/ConnectivityService;->mVpnState:Landroid/net/NetworkInfo$State;
    ...
    iget-object v2, p0, Lcom/android/server/ConnectivityService;->mVpnState:Landroid/net/NetworkInfo$State;
...
.method private isNetworkWithLinkPropertiesBlocked(Landroid/net/LinkProperties;IZ)Z
    ...
    const-string/jumbo v1, "isNetworkWithLinkPropertiesBlocked: uid="
    ...
    iget-object v1, p0, Lcom/android/server/ConnectivityService;->mVpnState:Landroid/net/NetworkInfo$State;
    ...
    iget-object v0, p0, Lcom/android/server/ConnectivityService;->mVpnState:Landroid/net/NetworkInfo$State;
    ...
    invoke-virtual {v5, p2, v0}, Lcom/android/server/net/NetworkPolicyManagerInternal;->isUidNetworkingBlocked(ILjava/lang/String;)Z

    move-result v6

    new-instance v5, Lcom/android/server/ConnectivityService$NetworkBlockedPerUidParams;

    invoke-direct {v5, v2, v3, v6}, Lcom/android/server/ConnectivityService$NetworkBlockedPerUidParams;-><init>(JZ)V
...
.method private recordBlockHistory(ILjava/lang/String;)V
    ...
    const-string/jumbo v5, "mDiagnosticHisotry added: "
...
.method private updateNetworkInfo(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkInfo;)V
    ...
    iput-object v3, p0, Lcom/android/server/ConnectivityService;->mVpnState:Landroid/net/NetworkInfo$State;
    ...
    iput-object v0, p0, Lcom/android/server/ConnectivityService;->mVpnState:Landroid/net/NetworkInfo$State;

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "Update the connection status of VPN -> "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v7, p0, Lcom/android/server/ConnectivityService;->mVpnState:Landroid/net/NetworkInfo$State;
