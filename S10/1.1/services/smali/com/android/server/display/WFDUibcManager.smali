...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/display/WFDUibcManager$DeXonPCConnectionState;
    }
.end annotation
...
.field private mButtonStateForDeXonPC:I

.field private mContext:Landroid/content/Context;

.field private mDeXonPCConnectionState:I
...
.field private mIsSupportDeXonPC:Z
...
.field private mSettingSourceConnectDeXonPCObserver:Landroid/database/ContentObserver;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/server/display/WFDUibcManager;->mUIBCMode:Lcom/android/server/display/WFDUibcManager$UIBCMode;

    const/4 v1, 0x0

    iput v1, p0, Lcom/android/server/display/WFDUibcManager;->mPrimaryDisplayWidth:F

    iput v1, p0, Lcom/android/server/display/WFDUibcManager;->mPrimaryDisplayHeight:F

    iput v1, p0, Lcom/android/server/display/WFDUibcManager;->mPrimaryDisplayRatio:F

    iput v1, p0, Lcom/android/server/display/WFDUibcManager;->mExternalDisplayWidth:F

    iput v1, p0, Lcom/android/server/display/WFDUibcManager;->mExternalDisplayHeight:F

    iput v1, p0, Lcom/android/server/display/WFDUibcManager;->mExternalDisplayRatio:F

    const/4 v1, -0x1

    iput v1, p0, Lcom/android/server/display/WFDUibcManager;->mExternalDisplayID:I

    iput v1, p0, Lcom/android/server/display/WFDUibcManager;->mPresentDisplayID:I
    ...
    iput-boolean v1, p0, Lcom/android/server/display/WFDUibcManager;->mIsSupportDeXonPC:Z

    iput-object v0, p0, Lcom/android/server/display/WFDUibcManager;->mSettingSourceConnectDeXonPCObserver:Landroid/database/ContentObserver;

    iput-boolean v1, p0, Lcom/android/server/display/WFDUibcManager;->mMouseLeftButtonDownPressed:Z

    iput v1, p0, Lcom/android/server/display/WFDUibcManager;->mButtonStateForDeXonPC:I

    const-string/jumbo v0, "dexonpc_connection_state"

    iput-object v0, p0, Lcom/android/server/display/WFDUibcManager;->SETTING_SOURCE_CONNECT_DEX_ON_PC:Ljava/lang/String;

    iput v1, p0, Lcom/android/server/display/WFDUibcManager;->mDeXonPCConnectionState:I

    new-instance v0, Lcom/android/server/display/WFDUibcManager$2;

    invoke-direct {v0, p0}, Lcom/android/server/display/WFDUibcManager$2;-><init>(Lcom/android/server/display/WFDUibcManager;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/display/WFDUibcManager;->mIsSupportDeXonPC:Z
...
.method static synthetic access$000(Lcom/android/server/display/WFDUibcManager;)I
    ...
    iget v0, p0, Lcom/android/server/display/WFDUibcManager;->mDeXonPCConnectionState:I
...
.method static synthetic access$002(Lcom/android/server/display/WFDUibcManager;I)I
    ...
    iput p1, p0, Lcom/android/server/display/WFDUibcManager;->mDeXonPCConnectionState:I

    return p1
.end method

.method static synthetic access$100(Lcom/android/server/display/WFDUibcManager;)Landroid/content/Context;
    .locals 1
...
.method static synthetic access$1500(Lcom/android/server/display/WFDUibcManager;)F
    .locals 1
...
.method static synthetic access$1600(Lcom/android/server/display/WFDUibcManager;)I
    .locals 1
...
.method static synthetic access$1800(Lcom/android/server/display/WFDUibcManager;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/display/WFDUibcManager;->mMouseLeftButtonDownPressed:Z

    return v0
.end method

.method static synthetic access$1802(Lcom/android/server/display/WFDUibcManager;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/display/WFDUibcManager;->mMouseLeftButtonDownPressed:Z

    return p1
.end method

.method static synthetic access$1900(Lcom/android/server/display/WFDUibcManager;)I
    .locals 1

    iget v0, p0, Lcom/android/server/display/WFDUibcManager;->mButtonStateForDeXonPC:I

    return v0
.end method

.method static synthetic access$1902(Lcom/android/server/display/WFDUibcManager;I)I
    .locals 0

    iput p1, p0, Lcom/android/server/display/WFDUibcManager;->mButtonStateForDeXonPC:I

    return p1
.end method

.method static synthetic access$200(Lcom/android/server/display/WFDUibcManager;)V
    .locals 0
...
.method static synthetic access$2000(Lcom/android/server/display/WFDUibcManager;)J
    .locals 2

    iget-wide v0, p0, Lcom/android/server/display/WFDUibcManager;->mTouchDownTime:J

    return-wide v0
.end method

.method static synthetic access$2002(Lcom/android/server/display/WFDUibcManager;J)J
    .locals 0

    iput-wide p1, p0, Lcom/android/server/display/WFDUibcManager;->mTouchDownTime:J

    return-wide p1
.end method

.method static synthetic access$300(Lcom/android/server/display/WFDUibcManager;)I
    .locals 1
...
.method static synthetic access$302(Lcom/android/server/display/WFDUibcManager;I)I
    .locals 0
...
.method static synthetic access$400(Lcom/android/server/display/WFDUibcManager;)Z
    .locals 1
...
.method static synthetic access$402(Lcom/android/server/display/WFDUibcManager;Z)Z
    .locals 0
...
.method static synthetic access$500(Lcom/android/server/display/WFDUibcManager;)Z
    .locals 1
...
.method static synthetic access$502(Lcom/android/server/display/WFDUibcManager;Z)Z
    .locals 0
...
.method static synthetic access$800(Lcom/android/server/display/WFDUibcManager;)I
    .locals 1
...
.method static synthetic access$900(Lcom/android/server/display/WFDUibcManager;)Lcom/android/server/display/WFDUibcManager$UIBCMode;
    .locals 1
...
.method private updateDisplayInfos()V
    ...
    iget-boolean v5, p0, Lcom/android/server/display/WFDUibcManager;->mIsSupportDeXonPC:Z

    if-eqz v5, :cond_4

    iget v5, p0, Lcom/android/server/display/WFDUibcManager;->mDeXonPCConnectionState:I
    ...
    const-string v5, "Update DeX Display ID after DeX is enabled"

    invoke-static {v2, v5}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    const/4 v2, 0x2

    iput v2, p0, Lcom/android/server/display/WFDUibcManager;->mExternalDisplayID:I

    sget-object v2, Lcom/android/server/display/WFDUibcManager$UIBCMode;->DEXONPC:Lcom/android/server/display/WFDUibcManager$UIBCMode;
    ...
    :cond_4
    iget-object v5, p0, Lcom/android/server/display/WFDUibcManager;->mContext:Landroid/content/Context;
    ...
    :cond_5
    iget-boolean v5, p0, Lcom/android/server/display/WFDUibcManager;->mIsKDDIServiceConnected:Z
...
.method public start()Z
    ...
    iget-boolean v1, p0, Lcom/android/server/display/WFDUibcManager;->mIsSupportDeXonPC:Z
    ...
    iget v1, p0, Lcom/android/server/display/WFDUibcManager;->mDeXonPCConnectionState:I
    ...
    :cond_0
    new-instance v1, Lcom/android/server/display/WFDUibcManager$1;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lcom/android/server/display/WFDUibcManager$1;-><init>(Lcom/android/server/display/WFDUibcManager;Landroid/os/Handler;)V

    iput-object v1, p0, Lcom/android/server/display/WFDUibcManager;->mSettingSourceConnectDeXonPCObserver:Landroid/database/ContentObserver;
    ...
    iget-object v3, p0, Lcom/android/server/display/WFDUibcManager;->mSettingSourceConnectDeXonPCObserver:Landroid/database/ContentObserver;
