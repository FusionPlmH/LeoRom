...
.method private handleKeyEvent()V
    ...
    invoke-static {}, Lcom/android/server/display/WFDUibcManager;->access$700()Z
    ...
    invoke-static {v1}, Lcom/android/server/display/WFDUibcManager;->access$800(Lcom/android/server/display/WFDUibcManager;)I
    ...
    invoke-static {v1}, Lcom/android/server/display/WFDUibcManager;->access$200(Lcom/android/server/display/WFDUibcManager;)V
    ...
    invoke-static {v9}, Lcom/android/server/display/WFDUibcManager;->access$800(Lcom/android/server/display/WFDUibcManager;)I
...
.method private handleRotationEvent()V
    ...
    invoke-static {v0}, Lcom/android/server/display/WFDUibcManager;->access$100(Lcom/android/server/display/WFDUibcManager;)Landroid/content/Context;
    ...
    invoke-static {v2}, Lcom/android/server/display/WFDUibcManager;->access$500(Lcom/android/server/display/WFDUibcManager;)Z
    ...
    invoke-static {v2}, Lcom/android/server/display/WFDUibcManager;->access$100(Lcom/android/server/display/WFDUibcManager;)Landroid/content/Context;
...
.method private handleScrollEvent()V
    ...
    invoke-static {v6}, Lcom/android/server/display/WFDUibcManager;->access$800(Lcom/android/server/display/WFDUibcManager;)I
...
.method private handleTouchEvent()V
    ...
    invoke-static {v0}, Lcom/android/server/display/WFDUibcManager;->access$800(Lcom/android/server/display/WFDUibcManager;)I
    ...
    invoke-static {v0}, Lcom/android/server/display/WFDUibcManager;->access$300(Lcom/android/server/display/WFDUibcManager;)I
    ...
    invoke-static {v4}, Lcom/android/server/display/WFDUibcManager;->access$300(Lcom/android/server/display/WFDUibcManager;)I
    ...
    invoke-static {v4}, Lcom/android/server/display/WFDUibcManager;->access$900(Lcom/android/server/display/WFDUibcManager;)Lcom/android/server/display/WFDUibcManager$UIBCMode;
    ...
    invoke-static {v2}, Lcom/android/server/display/WFDUibcManager;->access$900(Lcom/android/server/display/WFDUibcManager;)Lcom/android/server/display/WFDUibcManager$UIBCMode;
    ...
    invoke-static {v2}, Lcom/android/server/display/WFDUibcManager;->access$300(Lcom/android/server/display/WFDUibcManager;)I
    ...
    invoke-static {v2}, Lcom/android/server/display/WFDUibcManager;->access$200(Lcom/android/server/display/WFDUibcManager;)V
    ...
    sget-object v8, Lcom/android/server/display/WFDUibcManager$3;->$SwitchMap$com$android$server$display$WFDUibcManager$UIBCMode:[I
    ...
    invoke-static {v12}, Lcom/android/server/display/WFDUibcManager;->access$900(Lcom/android/server/display/WFDUibcManager;)Lcom/android/server/display/WFDUibcManager$UIBCMode;
    ...
    invoke-static {v8}, Lcom/android/server/display/WFDUibcManager;->access$1400(Lcom/android/server/display/WFDUibcManager;)F
    ...
    invoke-static {v9}, Lcom/android/server/display/WFDUibcManager;->access$1500(Lcom/android/server/display/WFDUibcManager;)F
    ...
    invoke-static {v13}, Lcom/android/server/display/WFDUibcManager;->access$1500(Lcom/android/server/display/WFDUibcManager;)F
    ...
    invoke-static {v12}, Lcom/android/server/display/WFDUibcManager;->access$1200(Lcom/android/server/display/WFDUibcManager;)F
    ...
    invoke-static {v12}, Lcom/android/server/display/WFDUibcManager;->access$1400(Lcom/android/server/display/WFDUibcManager;)F
    ...
    invoke-static {v8}, Lcom/android/server/display/WFDUibcManager;->access$1000(Lcom/android/server/display/WFDUibcManager;)F
    ...
    invoke-static {v8}, Lcom/android/server/display/WFDUibcManager;->access$1200(Lcom/android/server/display/WFDUibcManager;)F
    ...
    invoke-static {v8}, Lcom/android/server/display/WFDUibcManager;->access$100(Lcom/android/server/display/WFDUibcManager;)Landroid/content/Context;
    ...
    const-string v9, "UIBCMode is DEXONPC"
    ...
    invoke-static {v8}, Lcom/android/server/display/WFDUibcManager;->access$1500(Lcom/android/server/display/WFDUibcManager;)F
    ...
    iget-object v6, v1, Lcom/android/server/display/WFDUibcManager$EventDispatcher;->this$0:Lcom/android/server/display/WFDUibcManager;

    invoke-static {v6}, Lcom/android/server/display/WFDUibcManager;->access$1300(Lcom/android/server/display/WFDUibcManager;)F
    ...
    iget-object v7, v1, Lcom/android/server/display/WFDUibcManager$EventDispatcher;->mTouchInput:Lcom/android/server/display/WFDUibcManager$TouchInput;

    iget-object v7, v7, Lcom/android/server/display/WFDUibcManager$TouchInput;->pointer:[Lcom/android/server/display/WFDUibcManager$TouchPointer;

    aget-object v7, v7, v0

    iput v8, v7, Lcom/android/server/display/WFDUibcManager$TouchPointer;->x:F
    ...
    iput v6, v7, Lcom/android/server/display/WFDUibcManager$TouchPointer;->y:F
    ...
    invoke-static {v8}, Lcom/android/server/display/WFDUibcManager;->access$1600(Lcom/android/server/display/WFDUibcManager;)I
    ...
    invoke-static {v8}, Lcom/android/server/display/WFDUibcManager;->access$900(Lcom/android/server/display/WFDUibcManager;)Lcom/android/server/display/WFDUibcManager$UIBCMode;

    move-result-object v8

    sget-object v9, Lcom/android/server/display/WFDUibcManager$UIBCMode;->DEXONPC:Lcom/android/server/display/WFDUibcManager$UIBCMode;
    ...
    const-string v8, "Out of Range Dex screen, Skip Event"
    ...
    sget-object v15, Lcom/android/server/display/WFDUibcManager$UIBCMode;->DEXONPC:Lcom/android/server/display/WFDUibcManager$UIBCMode;
    ...
    invoke-static {v0}, Lcom/android/server/display/WFDUibcManager;->access$900(Lcom/android/server/display/WFDUibcManager;)Lcom/android/server/display/WFDUibcManager$UIBCMode;

    move-result-object v0

    sget-object v4, Lcom/android/server/display/WFDUibcManager$UIBCMode;->DEXONPC:Lcom/android/server/display/WFDUibcManager$UIBCMode;
    ...
    invoke-static {v0}, Lcom/android/server/display/WFDUibcManager;->access$1800(Lcom/android/server/display/WFDUibcManager;)Z
    ...
    invoke-static {v0, v10}, Lcom/android/server/display/WFDUibcManager;->access$1902(Lcom/android/server/display/WFDUibcManager;I)I
    ...
    invoke-static {v0, v11}, Lcom/android/server/display/WFDUibcManager;->access$1902(Lcom/android/server/display/WFDUibcManager;I)I

    iget-object v0, v1, Lcom/android/server/display/WFDUibcManager$EventDispatcher;->this$0:Lcom/android/server/display/WFDUibcManager;

    const/4 v4, 0x0

    invoke-static {v0, v4}, Lcom/android/server/display/WFDUibcManager;->access$1802(Lcom/android/server/display/WFDUibcManager;Z)Z
    ...
    invoke-static {v0, v11}, Lcom/android/server/display/WFDUibcManager;->access$1802(Lcom/android/server/display/WFDUibcManager;Z)Z
    ...
    invoke-static {v0, v9, v10}, Lcom/android/server/display/WFDUibcManager;->access$2002(Lcom/android/server/display/WFDUibcManager;J)J
    ...
    const-string v9, "FROM DEXONPC SINK TOUCH EVENT!!! : "
    ...
    invoke-static {v9}, Lcom/android/server/display/WFDUibcManager;->access$1900(Lcom/android/server/display/WFDUibcManager;)I
    ...
    invoke-static/range {v16 .. v32}, Landroid/view/MotionEvent;->obtain(JJII[Landroid/view/MotionEvent$PointerProperties;[Landroid/view/MotionEvent$PointerCoords;IIIFFIIII)Landroid/view/MotionEvent;

    move-result-object v0

    const/4 v4, 0x0

    invoke-virtual {v0, v4}, Landroid/view/MotionEvent;->setActionButton(I)V
    ...
    iget-object v4, v1, Lcom/android/server/display/WFDUibcManager$EventDispatcher;->mPointerProp:[Landroid/view/MotionEvent$PointerProperties;

    iget-object v9, v1, Lcom/android/server/display/WFDUibcManager$EventDispatcher;->mPointerCoords:[Landroid/view/MotionEvent$PointerCoords;

    iget-object v10, v1, Lcom/android/server/display/WFDUibcManager$EventDispatcher;->this$0:Lcom/android/server/display/WFDUibcManager;

    invoke-static {v10}, Lcom/android/server/display/WFDUibcManager;->access$1900(Lcom/android/server/display/WFDUibcManager;)I

    move-result v25

    iget-object v10, v1, Lcom/android/server/display/WFDUibcManager$EventDispatcher;->this$0:Lcom/android/server/display/WFDUibcManager;

    invoke-static {v10}, Lcom/android/server/display/WFDUibcManager;->access$800(Lcom/android/server/display/WFDUibcManager;)I
    ...
    invoke-virtual {v4, v9}, Landroid/view/MotionEvent;->setActionButton(I)V
    ...
    const-string v12, "InjectTouchEvent: "
    ...
    invoke-virtual {v9, v0, v10}, Landroid/hardware/input/InputManager;->injectInputEvent(Landroid/view/InputEvent;I)Z
    ...
    invoke-virtual {v9, v4, v10}, Landroid/hardware/input/InputManager;->injectInputEvent(Landroid/view/InputEvent;I)Z
    ...
    invoke-static {v0}, Lcom/android/server/display/WFDUibcManager;->access$2000(Lcom/android/server/display/WFDUibcManager;)J
    ...
    invoke-static {v4}, Lcom/android/server/display/WFDUibcManager;->access$1900(Lcom/android/server/display/WFDUibcManager;)I
    ...
    invoke-static {v4}, Lcom/android/server/display/WFDUibcManager;->access$2000(Lcom/android/server/display/WFDUibcManager;)J
    ...
    invoke-static {v9, v10}, Lcom/android/server/display/WFDUibcManager;->access$1902(Lcom/android/server/display/WFDUibcManager;I)I
    ...
    const-string v10, "InjectTouchEvent: "
    ...
    invoke-virtual {v4, v0, v9}, Landroid/hardware/input/InputManager;->injectInputEvent(Landroid/view/InputEvent;I)Z
    ...
    const-string v9, "Remove Pointer, Action : "
    ...
    iget-object v9, v1, Lcom/android/server/display/WFDUibcManager$EventDispatcher;->mPointerProp:[Landroid/view/MotionEvent$PointerProperties;
    ...
    sget-object v4, Lcom/android/server/display/WFDUibcManager$UIBCMode;->SIDESYNC:Lcom/android/server/display/WFDUibcManager$UIBCMode;

    if-eq v0, v4, :cond_43

    iget-object v0, v1, Lcom/android/server/display/WFDUibcManager$EventDispatcher;->this$0:Lcom/android/server/display/WFDUibcManager;

    invoke-static {v0}, Lcom/android/server/display/WFDUibcManager;->access$400(Lcom/android/server/display/WFDUibcManager;)Z
    ...
    iget-wide v11, v1, Lcom/android/server/display/WFDUibcManager$EventDispatcher;->mLastBroadcastTime:J
    ...
    const-string v4, "Send intent (com.samsung.intent.action.SEC_UIBC_GET_FOCUS)"
    ...
    const-string v4, "com.samsung.intent.action.SEC_UIBC_GET_FOCUS"
    ...
    iget-object v11, v1, Lcom/android/server/display/WFDUibcManager$EventDispatcher;->this$0:Lcom/android/server/display/WFDUibcManager;

    invoke-static {v11}, Lcom/android/server/display/WFDUibcManager;->access$800(Lcom/android/server/display/WFDUibcManager;)I
    ...
    invoke-static {v4}, Lcom/android/server/display/WFDUibcManager;->access$100(Lcom/android/server/display/WFDUibcManager;)Landroid/content/Context;
    ...
    const-string v11, "Exception sendBroadcast(com.samsung.intent.action.SEC_UIBC_GET_FOCUS): "

    invoke-static {v4, v11, v0}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    :goto_e
    iput-wide v9, v1, Lcom/android/server/display/WFDUibcManager$EventDispatcher;->mLastBroadcastTime:J
