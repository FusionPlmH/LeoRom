...
.method static synthetic access$200(FFF)F
    .locals 1
...
.method static synthetic access$300([FF)I
    .locals 1
...
.method public static create(Landroid/content/res/Resources;)Lcom/android/server/display/BrightnessMappingStrategy;
    ...
    invoke-static {v7}, Lcom/android/server/display/BrightnessMappingStrategy;->getDynamicAutoBrightnessLevels([I)[F

    move-result-object v7

    const v8, 0x1070083

    invoke-virtual {p0, v8}, Landroid/content/res/Resources;->getIntArray(I)[I
    ...
    sput v9, Lcom/android/server/display/BrightnessMappingStrategy;->sScreenExtendedBrightnessRangeMaximum:I
    ...
    sput v9, Lcom/android/server/display/BrightnessMappingStrategy;->sHbmLux:F

    sget v9, Lcom/android/server/display/BrightnessMappingStrategy;->sHbmLux:F
    ...
    sget-boolean v9, Lcom/android/server/power/PowerManagerUtil;->USE_PERSONAL_AUTO_BRIGHTNESS:Z
    ...
    const-string v9, "Use SecMappingStrategy"

    invoke-static {v3, v9}, Lcom/android/server/power/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v3, Lcom/android/server/display/BrightnessMappingStrategy$SecMappingStrategy;

    invoke-direct {v3, v0, v2, v5, v6}, Lcom/android/server/display/BrightnessMappingStrategy$SecMappingStrategy;-><init>([F[F[F[I)V
    ...
    invoke-static {v3, v11}, Lcom/android/server/power/Slog;->w(Ljava/lang/String;Ljava/lang/String;)I

    :cond_3
    const-string v3, "BrightnessMappingStrategy"

    const-string v11, "Use PhysicalMappingStrategy"

    invoke-static {v3, v11}, Lcom/android/server/power/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-direct {v11, v12, v5, v6, v4}, Lcom/android/server/display/BrightnessMappingStrategy$PhysicalMappingStrategy;-><init>(Landroid/hardware/display/BrightnessConfiguration;[F[IF)V
    ...
    const-string v9, "Use SimpleMappingStrategy"
    ...
    const-string/jumbo v9, "not found. null"

    invoke-static {v3, v9}, Lcom/android/server/power/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    const-string/jumbo v3, "nitsRange"

    invoke-static {v5, v3}, Lcom/android/server/power/PowerManagerUtil;->printArray([FLjava/lang/String;)V

    const-string v3, "backlightRange"

    invoke-static {v6, v3}, Lcom/android/server/power/PowerManagerUtil;->printArray([ILjava/lang/String;)V

    const-string/jumbo v3, "luxLevels"

    invoke-static {v0, v3}, Lcom/android/server/power/PowerManagerUtil;->printArray([FLjava/lang/String;)V

    const-string v3, "brightnessLevelsNits"

    invoke-static {v2, v3}, Lcom/android/server/power/PowerManagerUtil;->printArray([FLjava/lang/String;)V

    const-string v3, "brightnessLevelsBacklight"

    invoke-static {v1, v3}, Lcom/android/server/power/PowerManagerUtil;->printArray([ILjava/lang/String;)V

    const-string/jumbo v3, "dynamicAutoBrightnessLevels"

    invoke-static {v1, v3}, Lcom/android/server/power/PowerManagerUtil;->printArray([ILjava/lang/String;)V

    const-string/jumbo v3, "dynamicAutoBrightnessValues"
