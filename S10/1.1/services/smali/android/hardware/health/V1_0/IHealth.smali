...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/health/V1_0/IHealth;
    ...
    check-cast v0, Landroid/hardware/health/V1_0/IHealth;

    return-object v0

    :cond_1
    new-instance v2, Landroid/hardware/health/V1_0/IHealth$Proxy;

    invoke-direct {v2, p0}, Landroid/hardware/health/V1_0/IHealth$Proxy;-><init>(Landroid/os/IHwBinder;)V

    :try_start_0
    invoke-interface {v2}, Landroid/hardware/health/V1_0/IHealth;->interfaceChain()Ljava/util/ArrayList;
    ...
    const-string v5, "android.hardware.health@1.0::IHealth"
...
.method public static castFrom(Landroid/os/IHwInterface;)Landroid/hardware/health/V1_0/IHealth;
    ...
    invoke-static {v0}, Landroid/hardware/health/V1_0/IHealth;->asInterface(Landroid/os/IHwBinder;)Landroid/hardware/health/V1_0/IHealth;
