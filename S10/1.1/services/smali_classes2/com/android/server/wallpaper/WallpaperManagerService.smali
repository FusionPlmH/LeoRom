...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/wallpaper/WallpaperManagerService$WhichChecker;,
...
.field final mRestoreFileSaver:Landroid/util/SparseArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/SparseArray<",
            "Landroid/os/AsyncTask<",
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/server/wallpaper/WallpaperManagerService;->mRestoreFileSaver:Landroid/util/SparseArray;
...
.method static synthetic access$2600(Lcom/android/server/wallpaper/WallpaperManagerService;Z)V
    .locals 0
...
.method static synthetic access$2700(Lcom/android/server/wallpaper/WallpaperManagerService;ILcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;)V
    .locals 0
...
.method static synthetic access$2800(Lcom/android/server/wallpaper/WallpaperManagerService;Ljava/io/InputStream;Ljava/io/FileOutputStream;)V
    .locals 0
...
.method static synthetic access$3000(Lcom/android/server/wallpaper/WallpaperManagerService;)I
    .locals 1
...
.method static synthetic access$3002(Lcom/android/server/wallpaper/WallpaperManagerService;I)I
    .locals 0
...
.method static synthetic access$3102(Lcom/android/server/wallpaper/WallpaperManagerService;Z)Z
    .locals 0
...
.method static synthetic access$3400(Lcom/android/server/wallpaper/WallpaperManagerService;)V
    .locals 0
...
.method static synthetic access$3500(Lcom/android/server/wallpaper/WallpaperManagerService;)V
    .locals 0
...
.method static synthetic access$3600(Lcom/android/server/wallpaper/WallpaperManagerService;Ljava/lang/String;)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$3900(Lcom/android/server/wallpaper/WallpaperManagerService;)Z
    .locals 1
...
.method static synthetic access$4002(Lcom/android/server/wallpaper/WallpaperManagerService;Ljava/lang/Thread;)Ljava/lang/Thread;
    .locals 0
...
.method static synthetic access$4200(Lcom/android/server/wallpaper/WallpaperManagerService;III)Ljava/io/File;
    .locals 1
...
.method static synthetic access$4300(Lcom/android/server/wallpaper/WallpaperManagerService;Ljava/io/File;)V
    .locals 0
...
.method static synthetic access$4400(Lcom/android/server/wallpaper/WallpaperManagerService;II)Lcom/android/server/wallpaper/WallpaperManagerService$BackupWallpaperData;
    .locals 1
...
.method static synthetic access$4500(Lcom/android/server/wallpaper/WallpaperManagerService;ILcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;I)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/wallpaper/WallpaperManagerService;->setWallpaperData(ILcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;I)V

    return-void
.end method

.method static synthetic access$4600(Lcom/android/server/wallpaper/WallpaperManagerService;Ljava/io/File;Ljava/io/File;)Z
    .locals 1

    invoke-direct {p0, p1, p2}, Lcom/android/server/wallpaper/WallpaperManagerService;->saveFile(Ljava/io/File;Ljava/io/File;)Z
...
.method static synthetic access$4700(Lcom/android/server/wallpaper/WallpaperManagerService;Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;)Z
    .locals 1

    invoke-direct {p0, p1}, Lcom/android/server/wallpaper/WallpaperManagerService;->isLiveWallpaper(Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;)Z
...
.method static synthetic access$4800(Lcom/android/server/wallpaper/WallpaperManagerService;II)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/wallpaper/WallpaperManagerService;->updateSettingValue(II)V

    return-void
.end method

.method static synthetic access$4900(Lcom/android/server/wallpaper/WallpaperManagerService;II)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/wallpaper/WallpaperManagerService;->removeBackupWallpaperData(II)V
...
.method static synthetic access$5000(Lcom/android/server/wallpaper/WallpaperManagerService;I)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/wallpaper/WallpaperManagerService;->saveSettingsLockedForBackupData(I)V
...
.method private cleanUpKWPFiles(II)V
    ...
    iput-object v2, v0, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->videoPkgName:Ljava/lang/String;
    ...
    const-string v4, "delete animated information, wpType="
    ...
    iput-object v2, v0, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->animatedPkgName:Ljava/lang/String;
...
.method private generateResizedBitmap(Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;I)V
    ...
    const-string v2, "bitmap size must be > 0"
...
.method private getRestoreFileSaver(III)Landroid/os/AsyncTask;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(III)",
    ...
    iget-object v0, p0, Lcom/android/server/wallpaper/WallpaperManagerService;->mRestoreFileSaver:Landroid/util/SparseArray;
    ...
    const-string/jumbo v2, "restore saver cancel"
    ...
    iget-object v1, p0, Lcom/android/server/wallpaper/WallpaperManagerService;->mRestoreFileSaver:Landroid/util/SparseArray;

    invoke-virtual {v1, p3}, Landroid/util/SparseArray;->remove(I)V

    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/wallpaper/WallpaperManagerService;->makeRestoreFileSaver(III)Landroid/os/AsyncTask;
...
.method private getWallpaperSafeLocked(II)Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;
    ...
    const-string v6, "getWallpaperSafeLocked, didn\'t find wallpaper."
    ...
    const-string v5, "getWallpaperSafeLocked, didn\'t find yet."
...
.method private getWallpaperSafeLockedByMode(II)Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;
    .locals 1
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/wallpaper/WallpaperManagerService;->getWallpaperSafeLocked(II)Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;
    ...
    iget v0, p0, Lcom/android/server/wallpaper/WallpaperManagerService;->mCurrentFolderState:I
...
.method private loadSettingsLocked(IZI)V
    ...
    invoke-interface {v0, v13, v6}, Lorg/xmlpull/v1/XmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_5
    iput-object v13, v7, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->nextWallpaperComponent:Landroid/content/ComponentName;

    iget-object v13, v7, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->nextWallpaperComponent:Landroid/content/ComponentName;
    ...
    const-string/jumbo v10, "wallpaper_desktop_lock"
    :try_end_6
    ...
    const-string v10, "legacyCallingPackage: "
...
.method private makeRestoreFileSaver(III)Landroid/os/AsyncTask;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(III)",
    ...
    new-instance v0, Lcom/android/server/wallpaper/WallpaperManagerService$14;

    invoke-direct {v0, p0, p3, p1, p2}, Lcom/android/server/wallpaper/WallpaperManagerService$14;-><init>(Lcom/android/server/wallpaper/WallpaperManagerService;III)V
...
.method private needToStartMultipleWallpaper(Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;I)Z
    .locals 5
    ...
    :cond_1
    invoke-virtual {p1}, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->getCallingPackage()Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/android/server/wallpaper/WallpaperManagerService$WhichChecker;->isSubDisplay(I)Z

    move-result v4

    if-eqz v4, :cond_2

    sget-boolean v4, Landroid/app/WallpaperManager;->DEFAULT_WALLPAPER_TYPE_MULTIPLE_SUB:Z

    goto :goto_0

    :cond_2
    sget-boolean v4, Landroid/app/WallpaperManager;->DEFAULT_WALLPAPER_TYPE_MULTIPLE:Z
...
.method private parseWallpaperAttributes(Lorg/xmlpull/v1/XmlPullParser;Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;Z)V
    ...
    iput-object v2, p2, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->lastCallingPackage:Ljava/lang/String;
...
.method private saveBackupWallpaperFile(IIILcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;)Z
    ...
    const-string v3, "backupWallpaperFile, origFile="
    ...
    const-string/jumbo v3, "need not to copy the file."
    ...
    const-string/jumbo v3, "need not to copy the file. origFile doesn\'t exist"
    ...
    const-string v5, "backupWallpaperFile, backupFile = "
    ...
    invoke-direct {p0, v0, v2}, Lcom/android/server/wallpaper/WallpaperManagerService;->saveFile(Ljava/io/File;Ljava/io/File;)Z
...
.method private saveRestoreWallpaperFile(IILjava/lang/String;)Z
    ...
    const-string/jumbo v3, "saveRestoreWallpaperFile, backup data is null"
    ...
    const-string/jumbo v7, "saveRestoreWallpaperFile, which = "
    ...
    invoke-virtual {v0, v4}, Lcom/android/server/wallpaper/WallpaperManagerService$BackupWallpaperData;->getWallpaperData(I)Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;
    ...
    const-string v6, "backupData is null. Fail"
    ...
    invoke-direct {p0, p1, p2, v4}, Lcom/android/server/wallpaper/WallpaperManagerService;->getRestoreFileSaver(III)Landroid/os/AsyncTask;
...
.method private startMultipleWallpaper(IZZ)V
    .locals 6
...
.method private writeWallpaperAttributes(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;)V
    ...
    :cond_8
    iget-object v3, p3, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->lastCallingPackage:Ljava/lang/String;

    if-eqz v3, :cond_9

    const-string v3, "lastCallingPackage"

    iget-object v4, p3, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->lastCallingPackage:Ljava/lang/String;
...
.method bindWallpaperComponentLocked(Landroid/content/ComponentName;ZZLcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;Landroid/os/IRemoteCallback;)Z
    ...
    const-string/jumbo v12, "mLastWallpaper wallpaperComponent="
...
.method clearWallpaperLocked(ZIILandroid/os/IRemoteCallback;)V
    ...
    :try_start_0
    invoke-virtual {v12}, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->getWallpaperFile()Ljava/io/File;
    ...
    invoke-direct {v7, v9, v8}, Lcom/android/server/wallpaper/WallpaperManagerService;->getWallpaperSafeLocked(II)Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;
...
.method protected getFolderStateBasedWhich(I)I
    .locals 2
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/server/wallpaper/WallpaperManagerService;->getFolderStateBasedWhich(II)I
...
.method protected getFolderStateBasedWhich(II)I
    .locals 3
    ...
    const-string v2, "Reset which state = "
...
.method protected getWallpaperDataMap(I)Landroid/util/SparseArray;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)",
    ...
    invoke-static {p1}, Lcom/android/server/wallpaper/WallpaperManagerService$WhichChecker;->isDex(I)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p1}, Lcom/android/server/wallpaper/WallpaperManagerService$WhichChecker;->isLock(I)Z
    ...
    :cond_1
    invoke-static {p1}, Lcom/android/server/wallpaper/WallpaperManagerService$WhichChecker;->isSubDisplay(I)Z
...
.method public getWallpaperIndexOf(Landroid/app/IWallpaperManagerCallback;ILandroid/os/Bundle;IIIZ)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-static {v11}, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->access$2900(Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;)Landroid/os/RemoteCallbackList;
...
.method public makeBackupWallpaper(II)I
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/wallpaper/WallpaperManagerService;->getWallpaperSafeLocked(II)Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;
...
.method public onUnlockUser(I)V
    ...
    :cond_2
    iget-boolean v1, p0, Lcom/android/server/wallpaper/WallpaperManagerService;->mIsUserUnlocked:Z
    ...
    invoke-direct {p0, v1, v3}, Lcom/android/server/wallpaper/WallpaperManagerService;->needToStartMultipleWallpaper(Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;I)Z
    ...
    invoke-direct {p0, p1, v2, v2}, Lcom/android/server/wallpaper/WallpaperManagerService;->startMultipleWallpaper(IZZ)V
    ...
    invoke-direct {p0, v3, v4}, Lcom/android/server/wallpaper/WallpaperManagerService;->needToStartMultipleWallpaper(Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;I)Z
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->setCallingPackage(Ljava/lang/String;)V

    invoke-direct {p0, p1, v2, v5}, Lcom/android/server/wallpaper/WallpaperManagerService;->startMultipleWallpaper(IZZ)V

    :cond_4
    iput-boolean v5, p0, Lcom/android/server/wallpaper/WallpaperManagerService;->mIsUserUnlocked:Z
...
.method switchUser(ILandroid/os/IRemoteCallback;)V
    ...
    :goto_0
    iget v6, v1, Lcom/android/server/wallpaper/WallpaperManagerService;->mCurrentUserId:I
    ...
    iput v6, v1, Lcom/android/server/wallpaper/WallpaperManagerService;->mCurrentFolderState:I
    ...
    const-string/jumbo v9, "switchUser userId = "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v8, v2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v9, ", mCurrentFolderState = "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v9, v1, Lcom/android/server/wallpaper/WallpaperManagerService;->mCurrentFolderState:I
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/wallpaper/WallpaperManagerService;->isDesktopSingleMode()Z

    move-result v7

    if-eqz v7, :cond_2

    invoke-direct {v1, v2, v9}, Lcom/android/server/wallpaper/WallpaperManagerService;->getWallpaperSafeLocked(II)Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;
    ...
    iget v7, v1, Lcom/android/server/wallpaper/WallpaperManagerService;->mCurrentFolderState:I

    if-nez v7, :cond_3

    invoke-direct {v1, v2, v8}, Lcom/android/server/wallpaper/WallpaperManagerService;->getWallpaperSafeLocked(II)Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;
    ...
    :cond_3
    invoke-direct {v1, v2, v5}, Lcom/android/server/wallpaper/WallpaperManagerService;->getWallpaperSafeLocked(II)Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;
    ...
    invoke-direct {v7, v1, v6}, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperObserver;-><init>(Lcom/android/server/wallpaper/WallpaperManagerService;Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;)V

    iput-object v7, v1, Lcom/android/server/wallpaper/WallpaperManagerService;->mWallpaperObserver:Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperObserver;

    iget-object v7, v6, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->wallpaperObserver:Landroid/os/FileObserver;

    if-nez v7, :cond_4

    iget-object v7, v1, Lcom/android/server/wallpaper/WallpaperManagerService;->mWallpaperObserver:Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperObserver;

    iget-object v7, v7, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperObserver;->mWallpaperFileObserver:Landroid/os/FileObserver;

    iput-object v7, v6, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->wallpaperObserver:Landroid/os/FileObserver;
    ...
    invoke-direct {v1, v2, v14}, Lcom/android/server/wallpaper/WallpaperManagerService;->getWallpaperSafeLocked(II)Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;
    ...
    invoke-direct {v1, v2, v13}, Lcom/android/server/wallpaper/WallpaperManagerService;->getWallpaperSafeLocked(II)Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;
    ...
    :goto_3
    iget-object v10, v8, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->themeSettingsObserver:Lcom/android/server/wallpaper/WallpaperManagerService$ThemeSettingsObserver;

    if-nez v10, :cond_8

    new-instance v10, Lcom/android/server/wallpaper/WallpaperManagerService$ThemeSettingsObserver;

    const/4 v11, 0x0

    invoke-direct {v10, v1, v11}, Lcom/android/server/wallpaper/WallpaperManagerService$ThemeSettingsObserver;-><init>(Lcom/android/server/wallpaper/WallpaperManagerService;Landroid/os/Handler;)V

    iput-object v10, v8, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->themeSettingsObserver:Lcom/android/server/wallpaper/WallpaperManagerService$ThemeSettingsObserver;

    iget-object v10, v8, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->themeSettingsObserver:Lcom/android/server/wallpaper/WallpaperManagerService$ThemeSettingsObserver;

    iget-object v11, v1, Lcom/android/server/wallpaper/WallpaperManagerService;->mContext:Landroid/content/Context;

    invoke-virtual {v10, v11}, Lcom/android/server/wallpaper/WallpaperManagerService$ThemeSettingsObserver;->startObserving(Landroid/content/Context;)V
    ...
    const-string/jumbo v11, "theme_mode"

    invoke-static {v10, v11, v4}, Landroid/provider/Settings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v10

    iput v10, v1, Lcom/android/server/wallpaper/WallpaperManagerService;->mThemeMode:I

    iget-object v10, v9, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->wallpaperObserver:Landroid/os/FileObserver;

    if-nez v10, :cond_9

    iget-object v10, v1, Lcom/android/server/wallpaper/WallpaperManagerService;->mWallpaperObserver:Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperObserver;

    iget-object v10, v10, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperObserver;->mLockWallpaperFileObserver:Landroid/os/FileObserver;

    iput-object v10, v9, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->wallpaperObserver:Landroid/os/FileObserver;
    ...
    :try_start_1
    invoke-virtual {v1, v6, v10}, Lcom/android/server/wallpaper/WallpaperManagerService;->switchWallpaper(Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;Landroid/os/IRemoteCallback;)V

    iget-boolean v11, v1, Lcom/android/server/wallpaper/WallpaperManagerService;->mIsUserUnlocked:Z

    if-eqz v11, :cond_d

    sget-boolean v11, Landroid/app/WallpaperManager;->DEFAULT_WALLPAPER_TYPE_MULTIPLE:Z

    if-eqz v11, :cond_b

    invoke-virtual {v9}, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->getCallingPackage()Ljava/lang/String;
    ...
    const-string v15, "com.samsung.android.keyguardwallpaperupdator"
    ...
    const-string v13, "com.samsung.android.keyguardwallpaperupdator"

    invoke-virtual {v9, v13}, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->setCallingPackage(Ljava/lang/String;)V

    invoke-direct {v1, v2, v5, v4}, Lcom/android/server/wallpaper/WallpaperManagerService;->startMultipleWallpaper(IZZ)V
    ...
    invoke-direct {v1, v2, v4, v4}, Lcom/android/server/wallpaper/WallpaperManagerService;->startMultipleWallpaper(IZZ)V

    :cond_b
    :goto_4
    sget-boolean v11, Landroid/app/WallpaperManager;->DEFAULT_WALLPAPER_TYPE_MULTIPLE_SUB:Z

    if-eqz v11, :cond_d

    invoke-direct {v1, v2, v14}, Lcom/android/server/wallpaper/WallpaperManagerService;->getWallpaperSafeLockedByMode(II)Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;

    move-result-object v11

    invoke-virtual {v11}, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->getCallingPackage()Ljava/lang/String;
    ...
    const-string v14, "com.samsung.android.keyguardwallpaperupdator"
    ...
    invoke-virtual {v11, v15}, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->setCallingPackage(Ljava/lang/String;)V

    invoke-direct {v1, v2, v5, v5}, Lcom/android/server/wallpaper/WallpaperManagerService;->startMultipleWallpaper(IZZ)V
    ...
    invoke-direct {v1, v2, v4, v5}, Lcom/android/server/wallpaper/WallpaperManagerService;->startMultipleWallpaper(IZZ)V

    :cond_d
    :goto_5
    iget v11, v1, Lcom/android/server/wallpaper/WallpaperManagerService;->mCurrentFolderState:I
    ...
    invoke-direct {v1, v8, v5}, Lcom/android/server/wallpaper/WallpaperManagerService;->notifyWallpaperColorsChanged(Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;I)V

    const/4 v5, 0x2

    or-int/2addr v5, v4

    invoke-direct {v1, v9, v5}, Lcom/android/server/wallpaper/WallpaperManagerService;->notifyWallpaperColorsChanged(Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;I)V

    invoke-direct {v1, v0}, Lcom/android/server/wallpaper/WallpaperManagerService;->migrateOldKeyguardWallpaper(Z)V

    if-eqz v0, :cond_f

    iget-object v5, v1, Lcom/android/server/wallpaper/WallpaperManagerService;->mHandler:Landroid/os/Handler;
