...
.method private getPackageChannels()Ljava/util/Map;
    ...
    instance-of v7, v7, Landroid/app/NotificationChannel;
    ...
    const-string v9, "channels has non NotificationChannel!! -"

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v9, v4, Lcom/android/server/notification/RankingHelper$Record;->channels:Landroid/util/ArrayMap;
...
.method public deleteNotificationChannelGroup(Ljava/lang/String;ILjava/lang/String;)Ljava/util/List;
    ...
    instance-of v4, v4, Landroid/app/NotificationChannel;
    ...
    const-string v6, "channels has non NotificationChannel!! -"
...
.method public getNotificationChannelGroupWithChannels(Ljava/lang/String;ILjava/lang/String;Z)Landroid/app/NotificationChannelGroup;
    ...
    iget-object v6, v0, Lcom/android/server/notification/RankingHelper$Record;->channels:Landroid/util/ArrayMap;
...
.method public getNotificationChannelGroups(Ljava/lang/String;IZZZ)Landroid/content/pm/ParceledListSlice;
    ...
    instance-of v6, v6, Landroid/app/NotificationChannel;

    if-nez v6, :cond_1

    const-string v6, "RankingHelper"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "channels has non NotificationChannel!! -"

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v8, v1, Lcom/android/server/notification/RankingHelper$Record;->channels:Landroid/util/ArrayMap;
...
.method public writeXml(Lorg/xmlpull/v1/XmlSerializer;Z)V
    ...
    :goto_4
    iget-object v9, v6, Lcom/android/server/notification/RankingHelper$Record;->channels:Landroid/util/ArrayMap;
    ...
    instance-of v9, v9, Landroid/app/NotificationChannel;
    ...
    const-string v11, "channels has non NotificationChannel!! -"

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v11, v6, Lcom/android/server/notification/RankingHelper$Record;->channels:Landroid/util/ArrayMap;
