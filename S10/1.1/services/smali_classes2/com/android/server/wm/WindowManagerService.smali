...
.field mWaitingForHideDisplayCutout:Z
...
.method private constructor <init>(Landroid/content/Context;Lcom/android/server/input/InputManagerService;ZZZLcom/android/server/policy/WindowManagerPolicy;)V
    ...
    iput-boolean v13, v11, Lcom/android/server/wm/WindowManagerService;->mWaitingForHideDisplayCutout:Z
...
.method static synthetic access$1200(Lcom/android/server/wm/WindowManagerService;)I
    .locals 1
...
.method public onDisplayRemoved(I)V
    ...
    const-string v3, " orientationChangeComplete="

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v3, p0, Lcom/android/server/wm/WindowManagerService;->mRoot:Lcom/android/server/wm/RootWindowContainer;

    iget-boolean v3, v3, Lcom/android/server/wm/RootWindowContainer;->mOrientationChangeComplete:Z

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v3, " hasMessages="
    ...
    invoke-virtual {v3, v4, v5}, Lcom/android/server/wm/WindowManagerService$H;->hasMessages(ILjava/lang/Object;)Z

    move-result v3

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v3, " DisplayFrozenReason="

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v3, p0, Lcom/android/server/wm/WindowManagerService;->mDisplayFrozenReasonForDebug:Ljava/lang/String;
...
.method public relayoutWindow(Lcom/android/server/wm/Session;Landroid/view/IWindow;ILandroid/view/WindowManager$LayoutParams;IIIIJLandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/DisplayCutout$ParcelableWrapper;Landroid/util/MergedConfiguration;Landroid/view/Surface;Landroid/graphics/PointF;Lcom/samsung/android/view/ConventionalModeBar$Info;)I
    ...
    iget-object v8, v1, Lcom/android/server/wm/WindowManagerService;->mDisplayFrozenReasonForDebug:Ljava/lang/String;
    ...
    const-string v9, " FrozenReason="

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v9, v1, Lcom/android/server/wm/WindowManagerService;->mDisplayFrozenReasonForDebug:Ljava/lang/String;
...
.method stopFreezingDisplayLocked()V
    ...
    iget-boolean v1, v0, Lcom/android/server/wm/WindowManagerService;->mWaitingForHideDisplayCutout:Z
    ...
    iget-boolean v5, v0, Lcom/android/server/wm/WindowManagerService;->mWaitingForHideDisplayCutout:Z

    if-eqz v5, :cond_d

    const-string v5, ", mWaitingForHideDisplayCutout=true"
