...
# static fields
.field private static final DOCKING_THRESHOLD:I = 0x12c
...
.method onDragEnded()V
    ...
    iget-object v2, p0, Lcom/android/server/wm/SideScreenFixedStackPositioner;->mWindowDragBounds:Landroid/graphics/Rect;
    ...
    invoke-virtual {v0, v2, v3, v4}, Lcom/samsung/android/internal/policy/SideSnapAlgorithm;->calculateSnapTarget(IFZ)Lcom/samsung/android/internal/policy/SideSnapAlgorithm$SideSnapTarget;
    ...
    iget-object v2, p0, Lcom/android/server/wm/SideScreenFixedStackPositioner;->mTmpRect:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Lcom/android/server/wm/SideScreenFixedStackPositioner;->mTmpRect2:Landroid/graphics/Rect;

    invoke-virtual {v0, v2}, Lcom/samsung/android/internal/policy/SideSnapAlgorithm$SideSnapTarget;->getSideScreenBounds(Landroid/graphics/Rect;)V
    ...
    :goto_1
    iget-object v2, p0, Lcom/android/server/wm/SideScreenFixedStackPositioner;->mTaskDragBounds:Landroid/graphics/Rect;

    iget-object v3, p0, Lcom/android/server/wm/SideScreenFixedStackPositioner;->mTmpRect:Landroid/graphics/Rect;

    invoke-virtual {p0, v2, v3, v1}, Lcom/android/server/wm/SideScreenFixedStackPositioner;->animateMoveStack(Landroid/graphics/Rect;Landroid/graphics/Rect;Ljava/lang/Runnable;)V
