...
.method private updateBaseDisplayMetricsIfNeeded()V
    ...
    iget-object v13, p0, Lcom/android/server/wm/DisplayContent;->mService:Lcom/android/server/wm/WindowManagerService;
    ...
    invoke-virtual {v13, p0, v4, v5}, Lcom/android/server/wm/SamsungWindowManagerService;->updateForcedDisplaySizeForInitialDisplayChanged(Lcom/android/server/wm/DisplayContent;II)Z

    iget v13, p0, Lcom/android/server/wm/DisplayContent;->mBaseDisplayDensity:I

    iget v14, p0, Lcom/android/server/wm/DisplayContent;->mInitialDisplayDensity:I
...
.method computeScreenConfiguration(Landroid/content/res/Configuration;)V
    ...
    iget v5, v12, Landroid/view/DisplayInfo;->rotation:I

    iget v6, v11, Landroid/content/res/Configuration;->uiMode:I

    iget v7, v10, Lcom/android/server/wm/DisplayContent;->mDisplayId:I

    iget-object v8, v12, Landroid/view/DisplayInfo;->displayCutout:Landroid/view/DisplayCutout;
    ...
    iget v2, v12, Landroid/view/DisplayInfo;->appWidth:I

    add-int/2addr v2, v8

    iget v3, v12, Landroid/view/DisplayInfo;->appHeight:I

    add-int/2addr v3, v7

    invoke-virtual {v0, v8, v7, v2, v3}, Landroid/app/WindowConfiguration;->setAppBounds(IIII)V
...
.method isUnderHomeStack(Lcom/android/server/wm/TaskStack;)Z
    .locals 3
    ...
    iget-object v1, v1, Lcom/android/server/wm/DisplayContent$TaskStackContainers;->mChildren:Lcom/android/server/wm/WindowList;
