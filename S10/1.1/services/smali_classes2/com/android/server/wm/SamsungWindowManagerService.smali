...
.method static synthetic access$500(Lcom/android/server/wm/SamsungWindowManagerService;I)V
    .locals 0
...
.method private clearForcedHideNotch()Z
    ...
    invoke-direct {p0, v3, v0}, Lcom/android/server/wm/SamsungWindowManagerService;->updateForcedHideNotchIfNeededLocked(Lcom/android/server/wm/DisplayContent;Z)V
...
.method private setForcedHideNotch(IIIIZZ)Z
    .locals 8
    ...
    const-string v7, "display_cutout_hide_notch"

    invoke-static {v6, v7, p1, v4}, Landroid/provider/Settings$Secure;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
    ...
    iput-object v3, p0, Lcom/android/server/wm/SamsungWindowManagerService;->mPendingHideDisplayCutout:Lcom/android/server/wm/SamsungWindowManagerService$PendingHideDisplayCutout;

    goto :goto_5

    :cond_3
    iget-object v6, p0, Lcom/android/server/wm/SamsungWindowManagerService;->mPendingHideDisplayCutout:Lcom/android/server/wm/SamsungWindowManagerService$PendingHideDisplayCutout;

    if-nez v6, :cond_4

    new-instance v6, Lcom/android/server/wm/SamsungWindowManagerService$PendingHideDisplayCutout;

    invoke-direct {v6, p0, v3}, Lcom/android/server/wm/SamsungWindowManagerService$PendingHideDisplayCutout;-><init>(Lcom/android/server/wm/SamsungWindowManagerService;Lcom/android/server/wm/SamsungWindowManagerService$1;)V
    ...
    :goto_4
    invoke-static {v3, v6, v7, v4}, Lcom/android/server/wm/SamsungWindowManagerService$PendingHideDisplayCutout;->access$400(Lcom/android/server/wm/SamsungWindowManagerService$PendingHideDisplayCutout;III)V
    ...
    const-string/jumbo v6, "setForcedHideNotch: shouldChangeHideNotch="
    ...
    invoke-direct {p0, v2, v0}, Lcom/android/server/wm/SamsungWindowManagerService;->updateForcedHideNotchIfNeededLocked(Lcom/android/server/wm/DisplayContent;Z)V
...
.method private updateForcedHideNotchIfNeededLocked(Lcom/android/server/wm/DisplayContent;Z)V
    .locals 4
    ...
    iput-boolean v1, v0, Lcom/android/server/wm/WindowManagerService;->mWaitingForHideDisplayCutout:Z

    iget-object v0, p0, Lcom/android/server/wm/SamsungWindowManagerService;->mService:Lcom/android/server/wm/WindowManagerService;

    const/4 v1, 0x0

    invoke-virtual {v0, v1, v1, p1}, Lcom/android/server/wm/WindowManagerService;->startFreezingDisplayLocked(IILcom/android/server/wm/DisplayContent;)V
...
.method calculateStartingWinExitAnimDuration(Lcom/android/server/wm/WindowState;I)J
    .locals 16
    ...
    invoke-interface {v3}, Lcom/android/server/wm/AnimationAdapter;->getAnimationStartTime()J
    ...
    sget-boolean v13, Lcom/android/server/wm/WindowManagerDebugConfig;->DEBUG_ANIM:Z
    ...
    const-string v15, "calculateStartingWinExitAnimDuration, appAnimDuration="

    invoke-virtual {v14, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v14, v5, v6}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    const-string v15, ", appAnimStartTime="
    ...
    const-string v15, ", remainingDuration="
    ...
    const-string v13, "calculateStartingWinExitAnimDuration, duration is set to zero, appAnimDuration="

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v12, v5, v6}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    const-string v13, ", appAnimStartTime="
...
.method public setForcedDisplaySizeDensity(IIIIZZI)V
    ...
    iget-object v0, v8, Lcom/android/server/wm/SamsungWindowManagerService;->mContext:Landroid/content/Context;
    ...
    :goto_1
    iget-object v3, v8, Lcom/android/server/wm/SamsungWindowManagerService;->mService:Lcom/android/server/wm/WindowManagerService;
    ...
    iget-object v4, v8, Lcom/android/server/wm/SamsungWindowManagerService;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-object v4, v4, Lcom/android/server/wm/WindowManagerService;->mRoot:Lcom/android/server/wm/RootWindowContainer;

    invoke-virtual {v4, v9}, Lcom/android/server/wm/RootWindowContainer;->getDisplayContent(I)Lcom/android/server/wm/DisplayContent;
    ...
    const-string v13, " is not attached"
    ...
    :try_start_1
    iget v5, v4, Lcom/android/server/wm/DisplayContent;->mBaseDisplayWidth:I
    :try_end_1
    ...
    :try_start_2
    iget v5, v4, Lcom/android/server/wm/DisplayContent;->mBaseDisplayHeight:I
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    invoke-direct {v8, v1, v2, v10}, Lcom/android/server/wm/SamsungWindowManagerService;->checkSizeDensity(III)Z
    ...
    const-string/jumbo v5, "setForcedDisplaySizeDensity w="
    ...
    const-string v14, " forcedHideNotch="
    ...
    iget-object v3, v8, Lcom/android/server/wm/SamsungWindowManagerService;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v14, v3}, Landroid/app/ActivityManager;->getPackageFromAppProcesses(I)Ljava/lang/String;

    move-result-object v3

    iput-object v3, v8, Lcom/android/server/wm/SamsungWindowManagerService;->mLastChangedDisplaySize:Ljava/lang/String;

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v4, v8, Lcom/android/server/wm/SamsungWindowManagerService;->mLastChangedDisplaySize:Ljava/lang/String;
    ...
    iget-object v15, v3, Lcom/android/server/wm/WindowManagerService;->mWindowMap:Lcom/android/server/wm/WindowHashMap;
    ...
    iget v13, v3, Lcom/android/server/wm/DisplayContent;->mInitialDisplayWidth:I
    ...
    iget v1, v3, Lcom/android/server/wm/DisplayContent;->mInitialDisplayHeight:I
    ...
    :try_start_8
    invoke-direct/range {v1 .. v7}, Lcom/android/server/wm/SamsungWindowManagerService;->setForcedHideNotch(IIIIZZ)Z
    ...
    :try_start_9
    invoke-direct {v8, v0, v13, v3, v10}, Lcom/android/server/wm/SamsungWindowManagerService;->updateForcedDisplaySizeDensityLocked(Lcom/android/server/wm/DisplayContent;III)V
    ...
    invoke-direct {v8, v4, v1, v4, v5}, Lcom/android/server/wm/SamsungWindowManagerService;->updateDisplaySettings(ZLjava/lang/String;ZLjava/lang/String;)V
    :try_end_9
    ...
    invoke-direct {v8, v5, v1, v5, v4}, Lcom/android/server/wm/SamsungWindowManagerService;->updateDisplaySettings(ZLjava/lang/String;ZLjava/lang/String;)V
    :try_end_a
    ...
    :cond_6
    :try_start_b
    iget v1, v0, Lcom/android/server/wm/DisplayContent;->mPrevDisplayWidth:I

    iget v4, v0, Lcom/android/server/wm/DisplayContent;->mBaseDisplayWidth:I

    if-ne v1, v4, :cond_7

    iget v1, v0, Lcom/android/server/wm/DisplayContent;->mPrevDisplayHeight:I
    ...
    iget-boolean v4, v1, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->hasDensity:Z

    if-eqz v4, :cond_7

    iget v4, v1, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->density:I
    :try_end_b
    ...
    invoke-direct {v8, v1, v3, v5, v4}, Lcom/android/server/wm/SamsungWindowManagerService;->updateDisplaySettings(ZLjava/lang/String;ZLjava/lang/String;)V
    ...
    :goto_5
    invoke-direct {v8, v0}, Lcom/android/server/wm/SamsungWindowManagerService;->updateTouchableArea(Lcom/android/server/wm/DisplayContent;)V
    :try_end_c
    ...
    const-string v3, "input illegalArgument"
    ...
    const-string v3, "Must hold permission android.permission.WRITE_SECURE_SETTINGS"
...
.method updateForcedDisplaySizeForInitialDisplayChanged(Lcom/android/server/wm/DisplayContent;II)Z
    ...
    iget-object v4, v0, Lcom/android/server/wm/SamsungWindowManagerService;->mService:Lcom/android/server/wm/WindowManagerService;

    const/4 v5, 0x0

    iput-boolean v5, v4, Lcom/android/server/wm/WindowManagerService;->mWaitingForHideDisplayCutout:Z

    iget v4, v1, Lcom/android/server/wm/DisplayContent;->mInitialDisplayWidth:I

    iget v6, v1, Lcom/android/server/wm/DisplayContent;->mInitialDisplayHeight:I
    ...
    iget-boolean v11, v10, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->hasSize:Z

    if-eqz v11, :cond_0

    iget v7, v10, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->width:I

    iget v8, v10, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->height:I

    :cond_0
    iget-boolean v11, v10, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->hasDensity:Z

    if-eqz v11, :cond_1

    iget v9, v10, Lcom/android/server/wm/SamsungWindowManagerService$DisplaySettings;->density:I
    ...
    iget v10, v1, Lcom/android/server/wm/DisplayContent;->mBaseDisplayDensity:I
    ...
    invoke-direct {v0, v10, v11, v10, v14}, Lcom/android/server/wm/SamsungWindowManagerService;->updateDisplaySettings(ZLjava/lang/String;ZLjava/lang/String;)V
    ...
    iput v13, v1, Lcom/android/server/wm/DisplayContent;->mBaseDisplayHeight:I

    if-eqz v18, :cond_7

    iput v9, v1, Lcom/android/server/wm/DisplayContent;->mBaseDisplayDensity:I

    :cond_7
    invoke-virtual/range {p1 .. p1}, Lcom/android/server/wm/DisplayContent;->resetPrevDisplaySizeIfNeeded()V

    iget-object v10, v0, Lcom/android/server/wm/SamsungWindowManagerService;->mPendingHideDisplayCutout:Lcom/android/server/wm/SamsungWindowManagerService$PendingHideDisplayCutout;

    if-eqz v10, :cond_a

    iget-object v10, v0, Lcom/android/server/wm/SamsungWindowManagerService;->mPendingHideDisplayCutout:Lcom/android/server/wm/SamsungWindowManagerService$PendingHideDisplayCutout;

    iget v10, v10, Lcom/android/server/wm/SamsungWindowManagerService$PendingHideDisplayCutout;->width:I

    if-lez v10, :cond_8

    iget-object v10, v0, Lcom/android/server/wm/SamsungWindowManagerService;->mPendingHideDisplayCutout:Lcom/android/server/wm/SamsungWindowManagerService$PendingHideDisplayCutout;

    iget v10, v10, Lcom/android/server/wm/SamsungWindowManagerService$PendingHideDisplayCutout;->height:I
    ...
    iput v10, v1, Lcom/android/server/wm/DisplayContent;->mBaseDisplayWidth:I

    iget-object v10, v0, Lcom/android/server/wm/SamsungWindowManagerService;->mPendingHideDisplayCutout:Lcom/android/server/wm/SamsungWindowManagerService$PendingHideDisplayCutout;

    iget v10, v10, Lcom/android/server/wm/SamsungWindowManagerService$PendingHideDisplayCutout;->height:I

    iput v10, v1, Lcom/android/server/wm/DisplayContent;->mBaseDisplayHeight:I

    :cond_8
    iget-object v10, v0, Lcom/android/server/wm/SamsungWindowManagerService;->mPendingHideDisplayCutout:Lcom/android/server/wm/SamsungWindowManagerService$PendingHideDisplayCutout;

    iget v10, v10, Lcom/android/server/wm/SamsungWindowManagerService$PendingHideDisplayCutout;->density:I
    ...
    iput v10, v1, Lcom/android/server/wm/DisplayContent;->mBaseDisplayDensity:I
    ...
    const-string/jumbo v14, "updateForcedDisplaySizeForInitialDisplayChanged: newBaseSize="
    ...
    const-string v14, " newForcedSize="
    ...
    const-string v14, " oldForcedSize="
    ...
    const-string v14, " newBaseDensity="

    invoke-virtual {v11, v14}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v14, v1, Lcom/android/server/wm/DisplayContent;->mBaseDisplayDensity:I

    invoke-virtual {v11, v14}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v14, " oldBaseDensity="
    ...
    const-string v1, " forcedDisplayChanged="
    ...
    iget-object v1, v0, Lcom/android/server/wm/SamsungWindowManagerService;->mPendingHideDisplayCutout:Lcom/android/server/wm/SamsungWindowManagerService$PendingHideDisplayCutout;
    ...
    iput-object v1, v0, Lcom/android/server/wm/SamsungWindowManagerService;->mPendingHideDisplayCutout:Lcom/android/server/wm/SamsungWindowManagerService$PendingHideDisplayCutout;
    ...
    const-string/jumbo v10, "updateForcedDisplaySizeForInitialDisplayChanged: skip newInitSize="
    ...
    const-string v10, " newForcedSize="
    ...
    const-string v10, " oldForcedSize="
