...
.method public interceptKeyBeforeDispatching(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    invoke-virtual {v1, v7}, Lcom/android/server/policy/PhoneWindowManager;->LongPressOnHome(I)V
...
.method public layoutWindowLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/wm/DisplayFrames;)V
    ...
    iget-object v8, v15, Lcom/android/server/wm/DisplayFrames;->mStable:Landroid/graphics/Rect;
    ...
    iget-object v8, v15, Lcom/android/server/wm/DisplayFrames;->mCurrent:Landroid/graphics/Rect;
    ...
    const-string v2, "layoutWindowLw("
    ...
    if-lt v14, v0, :cond_4a

    const/16 v0, 0x7cf

    if-gt v14, v0, :cond_4a
    ...
    invoke-direct {v12, v14, v13, v9, v15}, Lcom/android/server/policy/PhoneWindowManager;->applyStableConstraints(IILandroid/graphics/Rect;Lcom/android/server/wm/DisplayFrames;)V
    ...
    :cond_63
    invoke-virtual {v7, v2}, Landroid/graphics/Rect;->intersectUnchecked(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v12, v8, v13}, Lcom/android/server/policy/PhoneWindowManager;->shouldUseOutsets(Landroid/view/WindowManager$LayoutParams;I)Z
    ...
    :goto_39
    iget-object v2, v15, Lcom/android/server/wm/DisplayFrames;->mDisplayCutout:Lcom/android/server/wm/utils/WmDisplayCutout;
    ...
    invoke-direct {v12, v1, v15}, Lcom/android/server/policy/PhoneWindowManager;->offsetInputMethodWindowLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/wm/DisplayFrames;)V
    ...
    invoke-direct {v12, v1, v15}, Lcom/android/server/policy/PhoneWindowManager;->offsetVoiceInputWindowLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/wm/DisplayFrames;)V
