...
.method private handleDualDARDeviceLockedChangedForUser(IZ)V
    ...
    sget-object v2, Lcom/samsung/android/knox/ddar/fsm/Event;->DEVICE_LOCKED:Lcom/samsung/android/knox/ddar/fsm/Event;

    invoke-static {v0, v2}, Lcom/samsung/android/knox/ddar/fsm/StateMachine;->processEvent(ILcom/samsung/android/knox/ddar/fsm/Event;)Z
    ...
    invoke-virtual {v1, v0}, Landroid/os/UserManager;->isUserRunning(I)Z
    ...
    invoke-virtual {v1, v0, p2}, Landroid/app/trust/TrustManager;->setDeviceLockedForUser(IZ)V
    ...
    const-string v4, "Attempting to (un)lock DualDAR user: "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, v0}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v4, " upon SYSTEM (un)lock"
...
.method private updateDualDARStateAndUnlockIfNeeded(I)V
    ...
    sget-object v2, Lcom/samsung/android/knox/ddar/fsm/Event;->DEVICE_AUTH_SUCCESS:Lcom/samsung/android/knox/ddar/fsm/Event;

    invoke-static {v1, v2}, Lcom/samsung/android/knox/ddar/fsm/StateMachine;->processEvent(ILcom/samsung/android/knox/ddar/fsm/Event;)Z
    ...
    invoke-virtual {v3, v1}, Landroid/os/UserManager;->isUserUnlockingOrUnlocked(I)Z

    move-result v3

    if-nez v3, :cond_3

    invoke-virtual {v2, v5}, Landroid/app/KeyguardManager;->isDeviceLocked(I)Z
    ...
    const-string v4, "Trying to unlock DualDAR user "
    ...
    invoke-direct {p0, v1, v3}, Lcom/android/server/trust/TrustManagerService;->onPassword2Auth(ILjava/lang/String;)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    invoke-direct {p0, v1}, Lcom/android/server/trust/TrustManagerService;->fetchOuterLayerKey(I)[B

    move-result-object v6

    new-instance v7, Lcom/android/server/locksettings/EncryptedPasswordManager;

    invoke-direct {v7}, Lcom/android/server/locksettings/EncryptedPasswordManager;-><init>()V

    invoke-static {}, Landroid/app/ActivityManager;->getService()Landroid/app/IActivityManager;

    move-result-object v8

    invoke-virtual {v7, v6}, Lcom/android/server/locksettings/EncryptedPasswordManager;->encryptPassword([B)Ljava/lang/String;
    ...
    invoke-interface {v8, v1, v3, v9, v3}, Landroid/app/IActivityManager;->unlockUser(I[B[BLandroid/os/IProgressListener;)Z
    :try_end_0
    ...
    const-string v8, "Failed to unlock DualDAR user !"
    ...
    invoke-static {v3, v6, v5}, Lcom/android/server/knox/ddar/DDLog;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
