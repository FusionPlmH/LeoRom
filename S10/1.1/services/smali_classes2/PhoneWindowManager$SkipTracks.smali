...
.method public constructor <init>(Lcom/android/server/policy/PhoneWindowManager;Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->mDoubleClickPlayStop:Z
    ...
    iput-wide v2, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->mDoubleTapTimeOut:J
    ...
    iput v1, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->mNumTaps:I
...
.method private doNextPreviousTrack()V
    ...
    iget v1, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->mVolKeyCode:I
    ...
    :try_start_0
    invoke-interface {v4}, Landroid/media/IAudioService;->getCurrentAudioFocusPackageName()Ljava/lang/String;
    ...
    const-string v7, "GRX: Long press failed"
    ...
    :goto_2
    invoke-direct {p0, v2}, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->sendMediaButton(I)V
    ...
    const-string v5, "com.spotify.mobile.android.ui.widget.NEXT"

    goto :goto_3

    :cond_5
    const-string v5, "com.spotify.mobile.android.ui.widget.PREVIOUS"
    ...
    iget-object v5, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->mContext:Landroid/content/Context;
...
.method private sendMediaButton(I)V
    ...
    invoke-virtual {v2, v1}, Lcom/android/server/policy/PhoneWindowManager;->dispatchMediaKeyWithWakeLockToAudioService(Landroid/view/KeyEvent;)V
...
.method public handleVolKeyUp()V
    ...
    iget-boolean v1, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->mDoubleClickPlayStop:Z

    if-eqz v1, :cond_1

    iget v1, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->mNumTaps:I
    ...
    iget-boolean v1, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->mDoubleTapPending:Z

    if-nez v1, :cond_0

    iget-object v1, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->mHandler:Landroid/os/Handler;

    iget-object v3, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->mDoubleTapRunnable:Ljava/lang/Runnable;

    invoke-virtual {v1, v3}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iput-boolean v2, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->mDoubleTapPending:Z

    iget-object v1, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->mHandler:Landroid/os/Handler;

    iget-object v2, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->mDoubleTapRunnable:Ljava/lang/Runnable;

    iget-wide v3, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->mDoubleTapTimeOut:J
...
.method public increaseVolume(I)V
    ...
    iget-object v3, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->this$0:Lcom/android/server/policy/PhoneWindowManager;

    iget-object v3, v3, Lcom/android/server/policy/PhoneWindowManager;->mBroadcastWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method public shouldKeyBeStopped(Landroid/view/KeyEvent;)Z
    ...
    iget-object v2, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->mLongPressRunnable:Ljava/lang/Runnable;

    invoke-virtual {v0, v2}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-boolean v0, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->mIsLongVol:Z
    ...
    iget-wide v3, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->mLongPressTime:J
...
.method public startStopMusic()V
    ...
    const-string v4, "Casque Double Tap"
    ...
    invoke-direct {p0, v3}, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->sendMediaButton(I)V
    ...
    const-string v4, "com.spotify.mobile.android.ui.widget.PLAY"
    ...
    iget-object v4, p0, Lcom/android/server/policy/PhoneWindowManager$SkipTracks;->mContext:Landroid/content/Context;
...
.method public updateSkipTracksOptions()V
    ...
    invoke-static {v0, v2, v1}, Lcom/fusionleo/LeoX/server/LeoConfig;->getLeoInt(Landroid/content/Context;Ljava/lang/String;I)I
    ...
    invoke-static {v0, v3, v1}, Lcom/fusionleo/LeoX/server/LeoConfig;->getLeoInt(Landroid/content/Context;Ljava/lang/String;I)I
...
.method public vibrate()V
    ...
    invoke-static {v0, v1, v2}, Lcom/fusionleo/LeoX/server/LeoConfig;->getLeoInt(Landroid/content/Context;Ljava/lang/String;I)I
    ...
    invoke-static {v2, v3, v4}, Lcom/fusionleo/LeoX/server/LeoConfig;->getLeoInt(Landroid/content/Context;Ljava/lang/String;I)I

    move-result v2

    invoke-static {v0, v1, v2}, Lcom/fusionleo/LeoX/server/LeoConfig;->setLeoHaptics(Landroid/content/Context;II)V
