...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput v4, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->req_type:I
    ...
    iput v4, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->extra_type:I

    const-string v4, "WifiWarning"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "Try to enable "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v6, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->req_type:I
    ...
    iget v6, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->extra_type:I
    ...
    sget-object v4, Lcom/samsung/android/net/wifi/OpBrandingLoader$Vendor;->VZW:Lcom/samsung/android/net/wifi/OpBrandingLoader$Vendor;

    sget-object v5, Lcom/samsung/android/settings/wifi/WifiWarning;->mOpBranding:Lcom/samsung/android/net/wifi/OpBrandingLoader$Vendor;
    ...
    iget v4, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->extra_type:I

    if-ne v4, v9, :cond_3

    const-string v4, "HOTSPOT_WIFI_ENABLE_WARNING_DO_NOTSHOW_AGAIN"

    invoke-direct {v0, v4}, Lcom/samsung/android/settings/wifi/WifiWarning;->getBoolSharedPref(Ljava/lang/String;)Z
    ...
    iget-object v4, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->mWifiManager:Landroid/net/wifi/WifiManager;

    if-eqz v4, :cond_2

    iget-object v4, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->mWifiManager:Landroid/net/wifi/WifiManager;

    invoke-virtual {v4, v3, v8}, Landroid/net/wifi/WifiManager;->semSetWifiApEnabled(Landroid/net/wifi/WifiConfiguration;Z)Z
    ...
    const-string v4, "USBTETHER_WIFI_ENABLE_WARNING_DO_NOTSHOW_AGAIN"
    ...
    const-string v4, "wifi_enablewarning_check_mode"

    invoke-virtual {v1, v4}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;)Z

    move-result v4

    iput-boolean v4, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->mWifiEnableCheck:Z
    ...
    iput v7, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->mDialogTheme:I
    ...
    invoke-direct {v8, v0, v10}, Landroid/app/AlertDialog$Builder;-><init>(Landroid/content/Context;I)V
    ...
    const v13, 0x7f121e9a

    const v14, 0x7f121e9b    # 1.942262E38f

    const v15, 0x7f121e1a
    ...
    iget-boolean v6, v0, Lcom/samsung/android/settings/wifi/WifiWarning;->mWifiEnableCheck:Z
    ...
    invoke-virtual {v8, v15}, Landroid/app/AlertDialog$Builder;->setMessage(I)Landroid/app/AlertDialog$Builder;
    ...
    invoke-virtual {v8, v13}, Landroid/app/AlertDialog$Builder;->setMessage(I)Landroid/app/AlertDialog$Builder;
    ...
    invoke-virtual {v8, v3, v5}, Landroid/app/AlertDialog$Builder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
    ...
    invoke-virtual {v8, v3, v5}, Landroid/app/AlertDialog$Builder;->setNegativeButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
