...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mScreenIsLarge:Z

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mOldBounds:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Canvas;

    invoke-direct {v1}, Landroid/graphics/Canvas;-><init>()V

    iput-object v1, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mCanvas:Landroid/graphics/Canvas;
    ...
    iput v2, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mIconWidth:I
    ...
    iput v2, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mIconHeight:I
...
.method public createIconThumbnail(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    iget v0, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mIconWidth:I

    iget v1, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mIconHeight:I
    ...
    iget v6, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mIconWidth:I

    iget v7, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mIconHeight:I
    ...
    iget-object v7, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mCanvas:Landroid/graphics/Canvas;

    invoke-virtual {v7, v6}, Landroid/graphics/Canvas;->setBitmap(Landroid/graphics/Bitmap;)V

    iget-object v8, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mOldBounds:Landroid/graphics/Rect;
    ...
    iget-object v10, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mOldBounds:Landroid/graphics/Rect;
    ...
    :goto_2
    iget v7, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mIconWidth:I

    iget v8, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mIconHeight:I
    ...
    iget-object v8, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mCanvas:Landroid/graphics/Canvas;

    invoke-virtual {v8, v7}, Landroid/graphics/Canvas;->setBitmap(Landroid/graphics/Bitmap;)V

    iget-object v9, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mOldBounds:Landroid/graphics/Rect;
    ...
    iget v9, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mIconWidth:I

    sub-int/2addr v9, v0

    div-int/lit8 v9, v9, 0x2

    iget v10, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mIconHeight:I
    ...
    iget-object v12, p0, Lcom/samsung/android/settings/iris/IrisIconResizer;->mContext:Landroid/content/Context;
