...
.method public onCreateLoader(ILandroid/os/Bundle;)Landroid/content/Loader;
    ...
    new-instance v0, Lcom/samsung/android/settings/inputmethod/PhysicalKeyboardFragment$KeyboardLayoutLoader;

    iget-object v1, p0, Lcom/samsung/android/settings/inputmethod/PhysicalKeyboardFragment$Callbacks;->mContext:Landroid/content/Context;

    iget-object v2, p0, Lcom/samsung/android/settings/inputmethod/PhysicalKeyboardFragment$Callbacks;->mHardKeyboards:Ljava/util/List;

    invoke-direct {v0, v1, v2}, Lcom/samsung/android/settings/inputmethod/PhysicalKeyboardFragment$KeyboardLayoutLoader;-><init>(Landroid/content/Context;Ljava/util/List;)V
...
.method public bridge synthetic onLoadFinished(Landroid/content/Loader;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/settings/inputmethod/PhysicalKeyboardFragment$Callbacks;->onLoadFinished(Landroid/content/Loader;Ljava/util/List;)V
...
.method public onLoadFinished(Landroid/content/Loader;Ljava/util/List;)V
    ...
    iget-object v0, p0, Lcom/samsung/android/settings/inputmethod/PhysicalKeyboardFragment$Callbacks;->mPhysicalKeyboardFragment:Lcom/samsung/android/settings/inputmethod/PhysicalKeyboardFragment;

    invoke-virtual {p1}, Landroid/content/Loader;->getId()I

    move-result v1

    invoke-static {v0, v1, p2}, Lcom/samsung/android/settings/inputmethod/PhysicalKeyboardFragment;->access$500(Lcom/samsung/android/settings/inputmethod/PhysicalKeyboardFragment;ILjava/util/List;)V
