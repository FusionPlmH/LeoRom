...
.method constructor <init>(Lcom/samsung/android/settings/lockscreen/LockAppShortcutSettings;Landroid/widget/CheckedTextView;Landroid/widget/CheckedTextView;)V
    ...
    iput-object p2, p0, Lcom/samsung/android/settings/lockscreen/LockAppShortcutSettings$2;->val$titleView1:Landroid/widget/CheckedTextView;

    iput-object p3, p0, Lcom/samsung/android/settings/lockscreen/LockAppShortcutSettings$2;->val$titleView:Landroid/widget/CheckedTextView;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lcom/samsung/android/settings/lockscreen/LockAppShortcutSettings$2;->val$titleView1:Landroid/widget/CheckedTextView;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/widget/CheckedTextView;->setChecked(Z)V

    iget-object v0, p0, Lcom/samsung/android/settings/lockscreen/LockAppShortcutSettings$2;->val$titleView:Landroid/widget/CheckedTextView;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Landroid/widget/CheckedTextView;->setChecked(Z)V

    iget-object v0, p0, Lcom/samsung/android/settings/lockscreen/LockAppShortcutSettings$2;->this$0:Lcom/samsung/android/settings/lockscreen/LockAppShortcutSettings;

    invoke-static {v0}, Lcom/samsung/android/settings/lockscreen/LockAppShortcutSettings;->access$100(Lcom/samsung/android/settings/lockscreen/LockAppShortcutSettings;)Landroid/content/ContentResolver;
