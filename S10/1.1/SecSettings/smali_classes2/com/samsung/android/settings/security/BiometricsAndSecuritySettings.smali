...
.method public constructor <init>()V
    ...
    iput-boolean v1, p0, Lcom/samsung/android/settings/security/BiometricsAndSecuritySettings;->isKioskContainer:Z

    iput-boolean v1, p0, Lcom/samsung/android/settings/security/BiometricsAndSecuritySettings;->mKnoxCustomIsProKioskMode:Z

    iput-object v0, p0, Lcom/samsung/android/settings/security/BiometricsAndSecuritySettings;->mLocationPolicy:Lcom/samsung/android/knox/location/LocationPolicy;

    iput-object v0, p0, Lcom/samsung/android/settings/security/BiometricsAndSecuritySettings;->mEDM:Lcom/samsung/android/knox/EnterpriseDeviceManager;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Lcom/samsung/android/settings/security/BiometricsAndSecuritySettings;->mEDM:Lcom/samsung/android/knox/EnterpriseDeviceManager;
    ...
    iget-object v0, p0, Lcom/samsung/android/settings/security/BiometricsAndSecuritySettings;->mLocationPolicy:Lcom/samsung/android/knox/location/LocationPolicy;

    invoke-virtual {v0}, Lcom/samsung/android/knox/location/LocationPolicy;->isGPSStateChangeAllowed()Z
    ...
    const-string v1, "Blocked by MDM for location"

    invoke-static {v0, v1}, Lcom/samsung/android/settings/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-virtual {p0}, Lcom/samsung/android/settings/security/BiometricsAndSecuritySettings;->getPreferenceScreen()Landroid/support/v7/preference/PreferenceScreen;
...
.method public onResume()V
    ...
    iget-object v1, p0, Lcom/samsung/android/settings/security/BiometricsAndSecuritySettings;->mLocationSettingsEnabler:Lcom/samsung/android/settings/location/LocationSettingsEnabler;
    ...
    :cond_1
    iget-object v1, p0, Lcom/samsung/android/settings/security/BiometricsAndSecuritySettings;->mLocationPolicy:Lcom/samsung/android/knox/location/LocationPolicy;

    if-eqz v1, :cond_2

    iget-object v1, p0, Lcom/samsung/android/settings/security/BiometricsAndSecuritySettings;->mLocationPolicy:Lcom/samsung/android/knox/location/LocationPolicy;

    invoke-virtual {v1}, Lcom/samsung/android/knox/location/LocationPolicy;->isGPSStateChangeAllowed()Z
    ...
    iget-object v0, p0, Lcom/samsung/android/settings/security/BiometricsAndSecuritySettings;->mLocationPreference:Landroid/support/v14/preference/SecSwitchPreferenceScreen;
    ...
    iget-object v1, p0, Lcom/samsung/android/settings/security/BiometricsAndSecuritySettings;->mLocationPreference:Landroid/support/v14/preference/SecSwitchPreferenceScreen;
