...
.method public constructor <init>(Landroid/content/Context;Landroid/net/wifi/hotspot2/PasspointConfiguration;)V
    ...
    iput-object v0, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mFqdn:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mProviderFriendlyName:Ljava/lang/String;

    iput-object p2, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mPasspointConfiguration:Landroid/net/wifi/hotspot2/PasspointConfiguration;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/android/settingslib/wifi/AccessPoint;->loadConfig(Landroid/net/wifi/WifiConfiguration;)V
    :try_end_0
    ...
    const-string v2, "can\'t load Wi-Fi configuration"
    ...
    iget-object v1, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mScanResultCache:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v3, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mScanResultCache:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mScoredNetworkCache:Ljava/util/Map;
    ...
    iget-object v3, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mScoredNetworkCache:Ljava/util/Map;
    ...
    iput-object v0, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mPasspointConfiguration:Landroid/net/wifi/hotspot2/PasspointConfiguration;
    ...
    iget-object v3, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mSecFlags:Ljava/util/BitSet;
    ...
    iget-object v2, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mNetworkInfo:Landroid/net/NetworkInfo;

    invoke-virtual {p0, v0, v1, v2}, Lcom/samsung/android/settingslib/wifi/AccessPoint;->update(Landroid/net/wifi/WifiConfiguration;Landroid/net/wifi/WifiInfo;Landroid/net/NetworkInfo;)Z

    invoke-direct {p0}, Lcom/samsung/android/settingslib/wifi/AccessPoint;->updateRssi()V
...
.method private getSettingsSummary(Landroid/net/wifi/WifiConfiguration;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v10}, Landroid/net/NetworkInfo$DetailedState;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v6, v1, Landroid/net/wifi/WifiConfiguration;->providerFriendlyName:Ljava/lang/String;

    invoke-static {v3, v5, v9, v6}, Lcom/samsung/android/settingslib/wifi/AccessPoint;->getSummary(Landroid/content/Context;Landroid/net/NetworkInfo$DetailedState;ZLjava/lang/String;)Ljava/lang/String;
    ...
    const-string v10, "SettingsLib.AccessPoint"

    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "getSettingsSummary: ssid: "
    ...
    const-string v12, ", getNetworkSelectionDisableReason "
    ...
    iget-object v5, v0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mContext:Landroid/content/Context;
    ...
    invoke-static {v5, v6, v9, v7}, Lcom/samsung/android/settingslib/wifi/AccessPoint;->getSummary(Landroid/content/Context;Landroid/net/NetworkInfo$DetailedState;ZLjava/lang/String;)Ljava/lang/String;
    ...
    sget v6, Lcom/android/settingslib/R$string;->wifi_disabled_no_internet:I
    ...
    sget v6, Lcom/android/settingslib/R$string;->wifi_tips_ap_guide_couldnt_get_ip_address:I
    ...
    sget v6, Lcom/android/settingslib/R$string;->wifi_tips_ap_guide_couldnt_authenticate_connection:I
    ...
    iget v5, v1, Landroid/net/wifi/WifiConfiguration;->semAutoReconnect:I
    ...
    sget v6, Lcom/android/settingslib/R$string;->wifi_tips_ap_guide_connection_blocked:I
    ...
    sget v6, Lcom/android/settingslib/R$string;->wifi_tips_ap_guide_keeps_disconnecting:I
    ...
    iget-object v6, v0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mCarrierName:Ljava/lang/String;
    ...
    :goto_1
    invoke-static {v3, v5, v6, v1}, Lcom/samsung/android/settingslib/wifi/AccessPoint;->getSummary(Landroid/content/Context;Landroid/net/NetworkInfo$DetailedState;ZLandroid/net/wifi/WifiConfiguration;)Ljava/lang/String;
    ...
    const-string v10, "CscFeature_Wifi_ConfigSnsStatus"
    ...
    iget-boolean v6, v0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mIsWifiOnly:Z
    ...
    invoke-static {v6}, Lcom/samsung/android/settingslib/wifi/AccessPoint;->getSnsEverQualityTested(Landroid/content/Context;)Z

    move-result v6

    iget-object v7, v0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mContext:Landroid/content/Context;

    invoke-static {v7}, Lcom/samsung/android/settingslib/wifi/AccessPoint;->isValidated(Landroid/content/Context;)Z

    move-result v7

    iget-object v10, v0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mContext:Landroid/content/Context;

    invoke-static {v10}, Lcom/samsung/android/settingslib/wifi/AccessPoint;->getSnsCurrentMode(Landroid/content/Context;)I
    ...
    :cond_b
    sget-object v6, Lcom/samsung/android/net/wifi/OpBrandingLoader$Vendor;->VZW:Lcom/samsung/android/net/wifi/OpBrandingLoader$Vendor;

    sget-object v7, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mOpBranding:Lcom/samsung/android/net/wifi/OpBrandingLoader$Vendor;

    if-ne v6, v7, :cond_c

    iget v6, v0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->security:I
    ...
    sget v7, Lcom/android/settingslib/R$string;->wifi_open_network_summary:I
    ...
    sget v6, Lcom/android/settingslib/R$string;->wifi_disabled_captive_portal:I
    ...
    sget v6, Lcom/android/settingslib/R$string;->wifi_tips_ap_guide_incorrect_password:I
    ...
    sget v5, Lcom/android/settingslib/R$string;->wifi_auto_reconnect_disabled:I
    ...
    sget-object v5, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mOpBranding:Lcom/samsung/android/net/wifi/OpBrandingLoader$Vendor;
    ...
    iget-object v3, v1, Landroid/net/wifi/WifiConfiguration;->semMhsUserName:Ljava/lang/String;
    ...
    const-string v6, "getSettingsSummary: ssid: "
    ...
    const-string v6, ", config.semMhsUserName "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v6, v1, Landroid/net/wifi/WifiConfiguration;->semMhsUserName:Ljava/lang/String;
    ...
    iget-object v5, v0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mInfo:Landroid/net/wifi/WifiInfo;
    ...
    invoke-virtual {v3, v5}, Landroid/net/wifi/WifiManager;->getSmartApConnectedStatus(Ljava/lang/String;)I
    ...
    iget-object v7, v1, Landroid/net/wifi/WifiConfiguration;->semMhsUserName:Ljava/lang/String;
    ...
    invoke-virtual {v2, v9, v4}, Ljava/lang/StringBuilder;->insert(ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    sget v4, Lcom/android/settingslib/R$string;->wifi_auto_reconnect_disabled:I
    ...
    sget v4, Lcom/android/settingslib/R$string;->wifi_risk_ap_warning:I
    ...
    iget-object v4, v0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mInfo:Landroid/net/wifi/WifiInfo;
    ...
    invoke-virtual {v7}, Landroid/net/wifi/WifiConfiguration$NetworkSelectionStatus;->getDisableTime()J
...
.method private updateRssi()V
    ...
    iput v1, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mRssi:I
...
.method public getBadge()I
    ...
    iget v0, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mBadge:I
...
.method public getConfigName()Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mFqdn:Ljava/lang/String;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mProviderFriendlyName:Ljava/lang/String;
...
.method public getPasspointConfig()Landroid/net/wifi/hotspot2/PasspointConfiguration;
    ...
    iget-object v0, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mPasspointConfiguration:Landroid/net/wifi/hotspot2/PasspointConfiguration;
...
.method public getSecFlags()Ljava/util/BitSet;
    ...
    const-string v2, " mSecFlags is null obj:"
    ...
    const-string v2, "has mSecFlags size:"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v2, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mSecFlags:Ljava/util/BitSet;
...
.method public getSecurityString(Z)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/settingslib/wifi/AccessPoint;->isPasspointConfig()Z
    ...
    sget v1, Lcom/android/settingslib/R$string;->wifi_security_short_wpa3:I
    ...
    :cond_1
    sget v1, Lcom/android/settingslib/R$string;->wifi_security_wpa3:I
    ...
    sget v3, Lcom/android/settingslib/R$string;->wifi_security_short_eap:I
    ...
    :cond_2
    sget v3, Lcom/android/settingslib/R$string;->wifi_security_eap:I
    ...
    iget v3, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->eapType:I
    ...
    :pswitch_9
    iget-object v1, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mConfig:Landroid/net/wifi/WifiConfiguration;
    ...
    sget v1, Lcom/android/settingslib/R$string;->wifi_security_short_ft_wpa2_psk:I
    ...
    :cond_7
    sget v1, Lcom/android/settingslib/R$string;->wifi_security_ft_wpa2_psk:I
    ...
    sget v1, Lcom/android/settingslib/R$string;->wifi_security_short_ft_psk:I
    ...
    :cond_8
    sget v1, Lcom/android/settingslib/R$string;->wifi_security_ft_psk:I
...
.method public getStrongSignalBssid()Ljava/lang/String;
    ...
    iget v1, v3, Landroid/net/wifi/ScanResult;->level:I
...
.method public getTag()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mTag:Ljava/lang/Object;
...
.method public getWeChatBssid()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mWeChatApBssid:Ljava/lang/String;

    if-nez v0, :cond_0

    const-string v0, "SettingsLib.AccessPoint"

    const-string v1, "getWeChatBssid(), mWeChatApBssid is null."
...
.method public isChanged()Z
    ...
    iget-boolean v0, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mIsActiveStateChanged:Z
...
.method public isTencentRiskAp()Z
    .locals 1
    ...
    iget-boolean v0, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mIsTencentRiskAp:Z
...
.method public matches(Lcom/samsung/android/settingslib/wifi/AccessPoint;)Z
    .locals 3
    ...
    iget-object v2, p1, Lcom/samsung/android/settingslib/wifi/AccessPoint;->ssid:Ljava/lang/String;
    ...
    iget v2, p1, Lcom/samsung/android/settingslib/wifi/AccessPoint;->security:I
...
.method public saveWifiState(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mScoredNetworkCache:Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mNetworkInfo:Landroid/net/NetworkInfo;
    ...
    iget-object v1, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mFqdn:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mProviderFriendlyName:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mPasspointConfiguration:Landroid/net/wifi/hotspot2/PasspointConfiguration;
    ...
    :cond_9
    const-string v1, "key_samsung_flags"
    ...
    iget-boolean v1, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mIsCarrierAp:Z

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v0, "key_carrier_ap_eap_type"

    iget v1, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mCarrierApEapType:I

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    const-string v0, "key_carrier_name"

    iget-object v1, p0, Lcom/samsung/android/settingslib/wifi/AccessPoint;->mCarrierName:Ljava/lang/String;
