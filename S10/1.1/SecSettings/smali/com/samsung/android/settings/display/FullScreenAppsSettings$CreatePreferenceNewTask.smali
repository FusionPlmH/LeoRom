...
.method protected varargs doInBackground([Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {v1, v0}, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->access$1100(Lcom/samsung/android/settings/display/FullScreenAppsSettings;Ljava/util/List;)Ljava/util/List;
...
.method protected onPostExecute(Ljava/util/List;)V
    ...
    invoke-static {v0}, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->access$1200(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Z
    ...
    invoke-static {v0}, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->access$1300(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Landroid/support/v7/preference/SecPreferenceCategory;
    ...
    invoke-static {v0}, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->access$1400(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Lcom/samsung/android/settings/widget/SecInsetCategoryPreference;
    ...
    invoke-static {v1}, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->access$1400(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Lcom/samsung/android/settings/widget/SecInsetCategoryPreference;
    ...
    invoke-static {v4}, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->access$1300(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Landroid/support/v7/preference/SecPreferenceCategory;
    ...
    invoke-static {v5}, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->access$600(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Landroid/content/Context;
    ...
    invoke-static {v3}, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->access$1300(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Landroid/support/v7/preference/SecPreferenceCategory;
    ...
    invoke-static {v2}, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->access$1400(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Lcom/samsung/android/settings/widget/SecInsetCategoryPreference;
    ...
    invoke-static {v0}, Lcom/samsung/android/settings/display/FullScreenAppsSettings;->access$1500(Lcom/samsung/android/settings/display/FullScreenAppsSettings;)Landroid/app/ProgressDialog;
