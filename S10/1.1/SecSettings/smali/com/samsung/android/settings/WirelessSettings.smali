...
.method static synthetic access$000(Lcom/samsung/android/settings/WirelessSettings;)Landroid/support/v14/preference/SecSwitchPreferenceScreen;
    .locals 1

    iget-object v0, p0, Lcom/samsung/android/settings/WirelessSettings;->mSmartBonding:Landroid/support/v14/preference/SecSwitchPreferenceScreen;
...
.method static synthetic access$200(Lcom/samsung/android/settings/WirelessSettings;)Lcom/android/settings/network/PrivateDnsModeDialogPreference;
    .locals 1
...
.method static synthetic access$300(Lcom/samsung/android/settings/WirelessSettings;)Landroid/content/ContentResolver;
    .locals 1
...
.method static synthetic access$400(Lcom/samsung/android/settings/WirelessSettings;Ljava/lang/String;)V
    .locals 0
...
.method static synthetic access$502(Lcom/samsung/android/settings/WirelessSettings;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method static synthetic access$600(Lcom/samsung/android/settings/WirelessSettings;)Landroid/support/v7/preference/SecPreferenceScreen;
    .locals 1
...
.method static synthetic access$602(Lcom/samsung/android/settings/WirelessSettings;Landroid/support/v7/preference/SecPreferenceScreen;)Landroid/support/v7/preference/SecPreferenceScreen;
    .locals 0
...
.method static synthetic access$700(Lcom/samsung/android/settings/WirelessSettings;)Landroid/support/v7/preference/PreferenceScreen;
    .locals 1
...
.method static synthetic access$800(Lcom/samsung/android/settings/WirelessSettings;)Landroid/content/Context;
    .locals 1
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const-string v6, "ethernet_settings"

    invoke-virtual {v1, v6}, Lcom/samsung/android/settings/WirelessSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;
    ...
    :goto_6
    invoke-virtual {v6, v14}, Landroid/support/v7/preference/Preference;->setEnabled(Z)V
    ...
    iget-object v14, v1, Lcom/samsung/android/settings/WirelessSettings;->mSmartBonding:Landroid/support/v14/preference/SecSwitchPreferenceScreen;

    invoke-direct {v0, v6, v14}, Lcom/samsung/android/settings/smartbonding/SmartBondingEnabler;-><init>(Landroid/content/Context;Landroid/support/v7/preference/SwitchPreferenceCompat;)V
    ...
    iget-object v6, v1, Lcom/samsung/android/settings/WirelessSettings;->mSmartBondingEnabler:Lcom/samsung/android/settings/smartbonding/SmartBondingEnabler;
    ...
    invoke-virtual {v14}, Landroid/support/v14/preference/SecSwitchPreferenceScreen;->isChecked()Z

    move-result v14

    xor-int/2addr v5, v14

    invoke-virtual {v6, v5}, Lcom/samsung/android/settings/smartbonding/SmartBondingEnabler;->onWidgetChanged(Z)Z
    ...
    invoke-static {v5, v6}, Lcom/samsung/android/settings/ConnectionsUtils;->isPackageEnabled(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-virtual {v5, v6}, Landroid/support/v7/preference/SecDropDownPreference;->setValue(Ljava/lang/String;)V
    ...
    iget-object v6, v1, Lcom/samsung/android/settings/WirelessSettings;->mNetUnlock:Landroid/support/v7/preference/SecPreferenceScreen;
    ...
    iget-object v10, v1, Lcom/samsung/android/settings/WirelessSettings;->mEthernetStateReceiver:Landroid/database/ContentObserver;

    const/4 v14, 0x0

    const/4 v15, -0x2

    invoke-virtual {v5, v6, v14, v10, v15}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    new-instance v2, Lcom/samsung/android/settings/WirelessSettings$5;

    invoke-direct {v2, p0}, Lcom/samsung/android/settings/WirelessSettings$5;-><init>(Lcom/samsung/android/settings/WirelessSettings;)V
...
.method public onResume()V
    ...
    iget-object v8, p0, Lcom/samsung/android/settings/WirelessSettings;->mSmartBonding:Landroid/support/v14/preference/SecSwitchPreferenceScreen;

    invoke-virtual {v7}, Landroid/telephony/TelephonyManager;->getDataEnabled()Z

    move-result v9

    invoke-virtual {v8, v9}, Landroid/support/v14/preference/SecSwitchPreferenceScreen;->setEnabled(Z)V

    iget-object v8, p0, Lcom/samsung/android/settings/WirelessSettings;->mDataStateListener:Lcom/android/settings/datausage/CellDataPreference$DataStateListener;

    iget-object v9, p0, Lcom/samsung/android/settings/WirelessSettings;->mContext:Landroid/content/Context;

    invoke-static {v9}, Lcom/android/settings/datausage/DataUsageUtils;->getDefaultSubscriptionId(Landroid/content/Context;)I

    move-result v9

    iget-object v10, p0, Lcom/samsung/android/settings/WirelessSettings;->mContext:Landroid/content/Context;

    invoke-virtual {v8, v4, v9, v10}, Lcom/android/settings/datausage/CellDataPreference$DataStateListener;->setListener(ZILandroid/content/Context;)V

    :cond_f
    const-string v4, "multi_path"

    invoke-virtual {p0, v4}, Lcom/samsung/android/settings/WirelessSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;
    ...
    :cond_10
    invoke-virtual {v4, v2}, Landroid/support/v7/preference/SecPreferenceScreen;->setSummary(I)V
    ...
    const-string v8, "isWifiEnabled"

    invoke-static {v3, v7, v8, v2}, Lcom/android/settings/Utils;->getEnterprisePolicyEnabled(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string v9, "isCellularDataAllowed"
    ...
    :cond_15
    iget-object v2, p0, Lcom/samsung/android/settings/WirelessSettings;->mSmartBondingEnabler:Lcom/samsung/android/settings/smartbonding/SmartBondingEnabler;

    if-eqz v2, :cond_16

    iget-object v2, p0, Lcom/samsung/android/settings/WirelessSettings;->mSmartBondingEnabler:Lcom/samsung/android/settings/smartbonding/SmartBondingEnabler;

    invoke-virtual {v2}, Lcom/samsung/android/settings/smartbonding/SmartBondingEnabler;->resume()V
    ...
    invoke-static {v7, v8, v0}, Lcom/samsung/android/settings/ConnectionsUtils;->getIntFromDeXSettings(Landroid/content/ContentResolver;Ljava/lang/String;I)I
