...
.field public static mImsManagerConnected:[Z

.field public static mImsManagers:[Lcom/sec/ims/ImsManager;
...
.method static constructor <clinit>()V
    ...
    sput v2, Lcom/samsung/android/settings/ConnectionsUtils;->mCpaApnKey:I
    ...
    new-array v4, v3, [Lcom/sec/ims/ImsManager;

    aput-object v0, v4, v2

    aput-object v0, v4, v1

    sput-object v4, Lcom/samsung/android/settings/ConnectionsUtils;->mImsManagers:[Lcom/sec/ims/ImsManager;

    new-array v0, v3, [Z

    fill-array-data v0, :array_0

    sput-object v0, Lcom/samsung/android/settings/ConnectionsUtils;->mImsManagerConnected:[Z

    sput-boolean v2, Lcom/samsung/android/settings/ConnectionsUtils;->mIsConnected:Z

    new-instance v0, Lcom/samsung/android/settings/ConnectionsUtils$3;

    invoke-direct {v0}, Lcom/samsung/android/settings/ConnectionsUtils$3;-><init>()V
...
.method public static getDualImsManager(Landroid/content/Context;I)V
    .locals 5
    ...
    :goto_0
    sget-object v2, Lcom/samsung/android/settings/ConnectionsUtils;->mImsManagers:[Lcom/sec/ims/ImsManager;

    if-nez v2, :cond_1

    new-array v2, v0, [Lcom/sec/ims/ImsManager;

    sput-object v2, Lcom/samsung/android/settings/ConnectionsUtils;->mImsManagers:[Lcom/sec/ims/ImsManager;

    :cond_1
    sget-object v2, Lcom/samsung/android/settings/ConnectionsUtils;->mImsManagers:[Lcom/sec/ims/ImsManager;

    new-instance v3, Lcom/sec/ims/ImsManager;

    new-instance v4, Lcom/samsung/android/settings/ConnectionsUtils$2;

    invoke-direct {v4, v1}, Lcom/samsung/android/settings/ConnectionsUtils$2;-><init>(I)V

    invoke-direct {v3, p0, v4, v1}, Lcom/sec/ims/ImsManager;-><init>(Landroid/content/Context;Lcom/sec/ims/ImsManager$ConnectionListener;I)V
    ...
    const-string v4, "getImsManager creat imsmanager ["
...
.method public static getIsInCallState(Landroid/content/Context;)Z
    .locals 2
...
.method public static isAisSIMValid(Landroid/content/Context;)Z
    ...
    const-string v8, "isAisSIMValid() getSimOperator : "
...
.method public static isVoLTEVideoCallSupportedSIM(Landroid/content/Context;I)Z
    .locals 7
    ...
    invoke-static {p0, p1}, Lcom/samsung/android/settings/ConnectionsUtils;->getDualImsManager(Landroid/content/Context;I)V
    ...
    invoke-virtual {v0, v3}, Lcom/sec/ims/ImsManager;->isServiceAvailable(Ljava/lang/String;)Z

    move-result v0

    sget-object v3, Lcom/samsung/android/settings/ConnectionsUtils;->mImsManagers:[Lcom/sec/ims/ImsManager;
...
.method public static removeDualImsManager()V
    .locals 3
...
.method public static skipApn(Landroid/content/Context;Landroid/database/Cursor;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    const-string v11, "APN Edit information : "
    ...
    :cond_0
    const-string v9, "ril.ICC_TYPE0"

    const-string v11, ""

    invoke-static {v9, v5, v11}, Lcom/samsung/android/settings/ConnectionsUtils;->getTelephonyProperty(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v5}, Lcom/samsung/android/settings/ConnectionsUtils;->isCTCSimInserted(Landroid/content/Context;I)Z
    ...
    invoke-static {v13, v14, v8}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    sput v8, Lcom/samsung/android/settings/ConnectionsUtils;->mCpaApnKey:I
    ...
    const-string v8, "EHRPD - Verizon Internet"
    ...
    :cond_16
    invoke-static {v0, v5}, Lcom/samsung/android/settings/ConnectionsUtils;->isVoLTEVideoCallSupportedSIM(Landroid/content/Context;I)Z
    ...
    const-string v13, "if not ISIM, remove ims apn"
    ...
    const-string v10, "SPR sprint sim show ims always"
    ...
    const-string/jumbo v12, "skip live.vodafone.com or truphone.com, apn="
