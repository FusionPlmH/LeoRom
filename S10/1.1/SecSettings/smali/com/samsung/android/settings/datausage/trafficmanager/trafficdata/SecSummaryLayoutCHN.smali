...
.method private setColorOnStatus(F)V
    ...
    invoke-virtual {v0}, Lcom/samsung/android/settings/datausage/trafficmanager/trafficdata/TrafficPresenter;->getWarningPercent()I
...
.method public showWarningDialog(Landroid/os/Bundle;Z)V
    ...
    new-instance v2, Lcom/samsung/android/settings/datausage/trafficmanager/ui/DoNotShowAgainDialogFragment;

    iget-object v3, p0, Lcom/samsung/android/settings/datausage/trafficmanager/trafficdata/SecSummaryLayoutCHN;->mDataUsageSummary:Lcom/samsung/android/settings/datausage/DataUsageSummaryCHN;

    invoke-direct {v2, v3}, Lcom/samsung/android/settings/datausage/trafficmanager/ui/DoNotShowAgainDialogFragment;-><init>(Lcom/samsung/android/settings/datausage/DataUsageSummaryCHN;)V
    ...
    const-string v4, "bodyResId"

    const v5, 0x7f1201df

    invoke-virtual {v3, v4, v5}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    const-string v4, "isneedsendsms"

    invoke-virtual {v3, v4, p2}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    invoke-virtual {v2, v3}, Lcom/samsung/android/settings/datausage/trafficmanager/ui/DoNotShowAgainDialogFragment;->setArguments(Landroid/os/Bundle;)V

    iget-object v4, p0, Lcom/samsung/android/settings/datausage/trafficmanager/trafficdata/SecSummaryLayoutCHN;->mDataUsageSummary:Lcom/samsung/android/settings/datausage/DataUsageSummaryCHN;

    invoke-virtual {v4}, Lcom/samsung/android/settings/datausage/DataUsageSummaryCHN;->getFragmentManager()Landroid/app/FragmentManager;

    move-result-object v4

    invoke-virtual {v2, v4, v0}, Lcom/samsung/android/settings/datausage/trafficmanager/ui/DoNotShowAgainDialogFragment;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
