...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-static {v3}, Lcom/samsung/android/settings/ConnectionsUtils;->isAveaSIMValid(Landroid/content/Context;)Z
    ...
    invoke-static {v3}, Lcom/samsung/android/settings/ConnectionsUtils;->isVodafoneSIMValid(Landroid/content/Context;)Z
    ...
    invoke-static {v3}, Lcom/samsung/android/settings/ConnectionsUtils;->isAisSIMValid(Landroid/content/Context;)Z
    ...
    invoke-static {v3}, Lcom/samsung/android/settings/ConnectionsUtils;->isFastWebSIMValid(Landroid/content/Context;)Z
    ...
    :cond_4
    :goto_0
    invoke-virtual {p0, v2}, Lcom/samsung/android/settings/GigaLteSettings;->getString(I)Ljava/lang/String;

    move-result-object v3

    invoke-direct {p0, v3}, Lcom/samsung/android/settings/GigaLteSettings;->getChangedText(Ljava/lang/String;)Ljava/lang/String;
...
.method public onSwitchChanged(Landroid/widget/Switch;Z)V
    ...
    iget-boolean v10, p0, Lcom/samsung/android/settings/GigaLteSettings;->mIsKTtestOnly:Z

    if-nez v10, :cond_b

    iget-object v10, p0, Lcom/samsung/android/settings/GigaLteSettings;->mContext:Landroid/content/Context;

    invoke-virtual {v10}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v10

    const-string/jumbo v11, "smart_bonding"

    invoke-static {v10, v11, v2}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v10

    const v11, 0x7f120ab7
    ...
    new-instance v5, Lcom/samsung/android/settings/GigaLteSettings$3;

    invoke-direct {v5, p0}, Lcom/samsung/android/settings/GigaLteSettings$3;-><init>(Lcom/samsung/android/settings/GigaLteSettings;)V
    ...
    invoke-static {v10}, Lcom/samsung/android/settings/ConnectionsUtils;->isWifiEnabled(Landroid/content/Context;)Z
    ...
    invoke-static {v10}, Lcom/samsung/android/settings/ConnectionsUtils;->isMobileNetworkEnabled(Landroid/content/Context;)Z
    ...
    invoke-direct {p0, v1}, Lcom/samsung/android/settings/GigaLteSettings;->getChangedText(Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v5, Lcom/samsung/android/settings/GigaLteSettings$5;

    invoke-direct {v5, p0}, Lcom/samsung/android/settings/GigaLteSettings$5;-><init>(Lcom/samsung/android/settings/GigaLteSettings;)V
    ...
    new-instance v5, Lcom/samsung/android/settings/GigaLteSettings$11;

    invoke-direct {v5, p0}, Lcom/samsung/android/settings/GigaLteSettings$11;-><init>(Lcom/samsung/android/settings/GigaLteSettings;)V

    invoke-virtual {v4, v12, v5}, Landroid/app/AlertDialog$Builder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
    ...
    new-instance v5, Lcom/samsung/android/settings/GigaLteSettings$13;

    invoke-direct {v5, p0, v3}, Lcom/samsung/android/settings/GigaLteSettings$13;-><init>(Lcom/samsung/android/settings/GigaLteSettings;Landroid/net/UrspManager;)V
    ...
    invoke-static {v10}, Lcom/samsung/android/settings/ConnectionsUtils;->isAisSIMValid(Landroid/content/Context;)Z
    ...
    const v11, 0x7f1200e4

    const v12, 0x7f121f90
    ...
    invoke-virtual {p0, v5}, Lcom/samsung/android/settings/GigaLteSettings;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v4, v6}, Lcom/samsung/android/settings/GigaLteSettings;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    new-instance v5, Lcom/samsung/android/settings/GigaLteSettings$15;

    invoke-direct {v5, p0}, Lcom/samsung/android/settings/GigaLteSettings$15;-><init>(Lcom/samsung/android/settings/GigaLteSettings;)V
    ...
    invoke-static {v7}, Lcom/samsung/android/settings/ConnectionsUtils;->isWifiEnabled(Landroid/content/Context;)Z
    ...
    invoke-static {v7}, Lcom/samsung/android/settings/ConnectionsUtils;->isMobileNetworkEnabled(Landroid/content/Context;)Z
    ...
    new-instance v5, Lcom/samsung/android/settings/GigaLteSettings$17;

    invoke-direct {v5, p0}, Lcom/samsung/android/settings/GigaLteSettings$17;-><init>(Lcom/samsung/android/settings/GigaLteSettings;)V
    ...
    invoke-static {v6}, Lcom/samsung/android/settings/ConnectionsUtils;->isWifiEnabled(Landroid/content/Context;)Z
    ...
    invoke-static {v5}, Lcom/samsung/android/settings/ConnectionsUtils;->isMobileNetworkEnabled(Landroid/content/Context;)Z
    ...
    iput-object v5, p0, Lcom/samsung/android/settings/GigaLteSettings;->mAlertDialog:Landroid/app/AlertDialog$Builder;
    ...
    invoke-virtual {v1, v8, v4}, Landroid/app/AlertDialog$Builder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
    ...
    const-string v6, "Connected Wi-Fi SSID = "
    ...
    const-string v5, "Connected Wi-Fi SSID = null"
    ...
    invoke-virtual {v11, v6}, Landroid/app/AlertDialog$Builder;->setTitle(I)Landroid/app/AlertDialog$Builder;
    ...
    invoke-virtual {v8, v4, v11}, Landroid/app/AlertDialog$Builder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
    ...
    invoke-virtual {v8, v5, v11}, Landroid/app/AlertDialog$Builder;->setNegativeButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
    ...
    invoke-virtual {v11, v8, v12}, Landroid/app/AlertDialog$Builder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
