...
.method private createScreenModeView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-direct {v0, v3}, Lcom/samsung/android/settings/display/ScreenModePreviewPagerAdapter;-><init>(Landroid/content/Context;)V
    ...
    iget-object v3, p0, Lcom/samsung/android/settings/display/NewModePreview;->mViewPagerAdapter:Lcom/samsung/android/settings/display/ScreenModePreviewPagerAdapter;

    invoke-virtual {v0, v3}, Lcom/samsung/android/settings/WrapContentHeightViewPager;->setAdapter(Landroid/support/v4/view/PagerAdapter;)V

    iget-object v0, p0, Lcom/samsung/android/settings/display/NewModePreview;->mViewPager:Lcom/samsung/android/settings/WrapContentHeightViewPager;

    iget-object v3, p0, Lcom/samsung/android/settings/display/NewModePreview;->mViewPagerAdapter:Lcom/samsung/android/settings/display/ScreenModePreviewPagerAdapter;

    invoke-virtual {v3}, Lcom/samsung/android/settings/display/ScreenModePreviewPagerAdapter;->getCount()I

    move-result v3

    invoke-virtual {v0, v3}, Lcom/samsung/android/settings/WrapContentHeightViewPager;->setOffscreenPageLimit(I)V

    iget-object v0, p0, Lcom/samsung/android/settings/display/NewModePreview;->mViewPager:Lcom/samsung/android/settings/WrapContentHeightViewPager;

    new-instance v3, Lcom/samsung/android/settings/display/NewModePreview$1;

    invoke-direct {v3, p0}, Lcom/samsung/android/settings/display/NewModePreview$1;-><init>(Lcom/samsung/android/settings/display/NewModePreview;)V

    invoke-virtual {v0, v3}, Lcom/samsung/android/settings/WrapContentHeightViewPager;->setOnPageChangeListener(Landroid/support/v4/view/ViewPager$OnPageChangeListener;)V
    ...
    invoke-virtual {v0, v2}, Landroid/widget/RelativeLayout;->semSetRoundedCorners(I)V
    ...
    invoke-virtual {v0, v2, v3}, Landroid/widget/RelativeLayout;->semSetRoundedCornerColor(II)V
    ...
    invoke-virtual {p1, v9, v1}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v9

    check-cast v9, Landroid/widget/ImageView;

    iget-object v10, p0, Lcom/samsung/android/settings/display/NewModePreview;->mContext:Landroid/content/Context;

    invoke-virtual {v10}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v10

    const v11, 0x7f12106f
    ...
    new-instance v6, Lcom/samsung/android/settings/display/NewModePreview$2;

    invoke-direct {v6, p0, v8}, Lcom/samsung/android/settings/display/NewModePreview$2;-><init>(Lcom/samsung/android/settings/display/NewModePreview;I)V

    invoke-virtual {v9, v6}, Landroid/widget/ImageView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v6, p0, Lcom/samsung/android/settings/display/NewModePreview;->mPointArea:Landroid/widget/LinearLayout;
    ...
    iput-object v1, p0, Lcom/samsung/android/settings/display/NewModePreview;->mMdnie:Lcom/samsung/android/hardware/display/SemMdnieManager;
    ...
    iput-boolean v1, p0, Lcom/samsung/android/settings/display/NewModePreview;->mSupportWcgModeOnAmoled:Z
    ...
    iput-object v1, p0, Lcom/samsung/android/settings/display/NewModePreview;->mScreenModeList:Landroid/support/v7/widget/RecyclerView;
    ...
    const-string v8, "ModePreview"

    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "onCreate() selectedMode: "
    ...
    new-instance v8, Lcom/samsung/android/settings/display/NewModePreview$ScreenModeAdapter;

    iget-object v9, p0, Lcom/samsung/android/settings/display/NewModePreview;->mContext:Landroid/content/Context;

    iget-object v10, p0, Lcom/samsung/android/settings/display/NewModePreview;->mScreenModeItems:Lcom/samsung/android/settings/display/NewModePreview$ScreenModeItems;

    invoke-direct {v8, p0, v9, v10, v1}, Lcom/samsung/android/settings/display/NewModePreview$ScreenModeAdapter;-><init>(Lcom/samsung/android/settings/display/NewModePreview;Landroid/content/Context;Lcom/samsung/android/settings/display/NewModePreview$ScreenModeItems;I)V

    iput-object v8, p0, Lcom/samsung/android/settings/display/NewModePreview;->mAdapter:Lcom/samsung/android/settings/display/NewModePreview$ScreenModeAdapter;
    ...
    iget-object v9, p0, Lcom/samsung/android/settings/display/NewModePreview;->mAdapter:Lcom/samsung/android/settings/display/NewModePreview$ScreenModeAdapter;
    ...
    invoke-virtual {v8, v7}, Landroid/support/v7/widget/RecyclerView;->setSelected(Z)V

    iget-object v8, p0, Lcom/samsung/android/settings/display/NewModePreview;->mScreenModeList:Landroid/support/v7/widget/RecyclerView;

    invoke-virtual {v8, v7}, Landroid/support/v7/widget/RecyclerView;->setClickable(Z)V

    new-instance v8, Landroid/support/v7/widget/LinearLayoutManager;

    iget-object v9, p0, Lcom/samsung/android/settings/display/NewModePreview;->mContext:Landroid/content/Context;

    invoke-direct {v8, v9, v7, v3}, Landroid/support/v7/widget/LinearLayoutManager;-><init>(Landroid/content/Context;IZ)V

    invoke-virtual {v8, v7}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->setAutoMeasureEnabled(Z)V

    iget-object v9, p0, Lcom/samsung/android/settings/display/NewModePreview;->mScreenModeList:Landroid/support/v7/widget/RecyclerView;
    ...
    invoke-virtual {v9, v7}, Landroid/support/v7/widget/RecyclerView;->setHasFixedSize(Z)V

    iget-object v9, p0, Lcom/samsung/android/settings/display/NewModePreview;->mScreenModeList:Landroid/support/v7/widget/RecyclerView;

    invoke-virtual {v9, v3}, Landroid/support/v7/widget/RecyclerView;->setNestedScrollingEnabled(Z)V

    new-instance v9, Lcom/samsung/android/settings/display/NewModePreview$VerticalLineItemDecoration;

    iget-object v10, p0, Lcom/samsung/android/settings/display/NewModePreview;->mContext:Landroid/content/Context;

    invoke-direct {v9, p0, v10}, Lcom/samsung/android/settings/display/NewModePreview$VerticalLineItemDecoration;-><init>(Lcom/samsung/android/settings/display/NewModePreview;Landroid/content/Context;)V

    iput-object v9, p0, Lcom/samsung/android/settings/display/NewModePreview;->mItemDecoration:Lcom/samsung/android/settings/display/NewModePreview$VerticalLineItemDecoration;

    iget-object v9, p0, Lcom/samsung/android/settings/display/NewModePreview;->mScreenModeList:Landroid/support/v7/widget/RecyclerView;

    iget-object v10, p0, Lcom/samsung/android/settings/display/NewModePreview;->mItemDecoration:Lcom/samsung/android/settings/display/NewModePreview$VerticalLineItemDecoration;
    ...
    invoke-virtual {v9, v2}, Landroid/support/v7/widget/RecyclerView;->semSetRoundedCorners(I)V
    ...
    invoke-virtual {v9, v2, v10}, Landroid/support/v7/widget/RecyclerView;->semSetRoundedCornerColor(II)V
    ...
    invoke-virtual {v9, v10}, Landroid/support/v7/widget/RecyclerView;->setForeground(Landroid/graphics/drawable/Drawable;)V

    iget-object v9, p0, Lcom/samsung/android/settings/display/NewModePreview;->mScreenModeView:Landroid/view/View;

    const v10, 0x7f0a08ec
    ...
    iput-object v9, p0, Lcom/samsung/android/settings/display/NewModePreview;->mVividContainer:Landroid/widget/LinearLayout;
    ...
    iget-object v5, p0, Lcom/samsung/android/settings/display/NewModePreview;->mScreenModeView:Landroid/view/View;
    ...
    invoke-virtual {v5, v2}, Landroid/support/v4/widget/NestedScrollView;->semSetRoundedCorners(I)V
    ...
    invoke-virtual {v5, v2, v7}, Landroid/support/v4/widget/NestedScrollView;->semSetRoundedCornerColor(II)V
    ...
    iput-object v5, p0, Lcom/samsung/android/settings/display/NewModePreview;->mSeekBarLayout:Landroid/widget/LinearLayout;

    iget-object v5, p0, Lcom/samsung/android/settings/display/NewModePreview;->mSeekBarLayout:Landroid/widget/LinearLayout;
    ...
    invoke-virtual {v5, v2, v4}, Landroid/widget/LinearLayout;->semSetRoundedCornerColor(II)V

    iget-object v2, p0, Lcom/samsung/android/settings/display/NewModePreview;->mSeekBarLayout:Landroid/widget/LinearLayout;
    ...
    invoke-virtual {v2, v4}, Landroid/widget/LinearLayout;->setForeground(Landroid/graphics/drawable/Drawable;)V

    :cond_8
    iget-object v2, p0, Lcom/samsung/android/settings/display/NewModePreview;->mScreenModeView:Landroid/view/View;
    ...
    iput-object v2, p0, Lcom/samsung/android/settings/display/NewModePreview;->mPresetCool:Landroid/widget/TextView;
    ...
    iput-object v2, p0, Lcom/samsung/android/settings/display/NewModePreview;->mPresetWarm:Landroid/widget/TextView;
    ...
    iput-object v2, p0, Lcom/samsung/android/settings/display/NewModePreview;->mPresetSeekBar:Landroid/widget/SeekBar;
    ...
    new-instance v4, Lcom/samsung/android/settings/display/NewModePreview$3;

    invoke-direct {v4, p0}, Lcom/samsung/android/settings/display/NewModePreview$3;-><init>(Lcom/samsung/android/settings/display/NewModePreview;)V
    ...
    invoke-static {v2, v4, v6, v3}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    iput-object v2, p0, Lcom/samsung/android/settings/display/NewModePreview;->mAdvancedSettingButton:Lcom/samsung/android/settings/widget/RoundButtonView;

    iget-object v2, p0, Lcom/samsung/android/settings/display/NewModePreview;->mAdvancedSettingButton:Lcom/samsung/android/settings/widget/RoundButtonView;
