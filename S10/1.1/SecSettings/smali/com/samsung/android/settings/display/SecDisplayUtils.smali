...
.method public static ApplyForcedDisplayDensity(Landroid/content/Context;I)V
    ...
    const-string v5, "setForcedDisplaySizeDensity() exception"
...
.method public static getProperTabletDensities(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    const-string v14, "convertedDensity["
...
.method public static getScreenZoomInfo(Landroid/content/Context;)[I
    ...
    sget-object v3, Lcom/samsung/android/settings/display/FontPreview;->DENSITY_BASE_PIXEL:[F
...
.method public static setDualDisplayEasyModeDensity(Landroid/content/Context;I)V
    ...
    const-string v6, "easymode)defaultDensity = "
    ...
    const-string/jumbo v5, "standardmode_protecting)defaultDensity = "
    ...
    const-string v5, "setDualDisplayEasyModeDensity / set width -1, height -1, density : "
    ...
    invoke-interface/range {v5 .. v11}, Landroid/view/IWindowManager;->setForcedDisplaySizeDensity(IIIIZZ)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v5, "setForcedDisplaySizeDensityEx() exception!!!"
...
.method public static setScreenZoomInfo(Landroid/content/Context;[I)V
    ...
    sget-object v1, Lcom/samsung/android/settings/display/FontPreview;->DENSITY_BASE_PIXEL:[F
...
.method public static supportEdgeColorBalanceSettings(Landroid/content/Context;)Z
    ...
    const-string v1, "isSupportPocSettings false by feature"
    ...
    new-instance v1, Lcom/samsung/android/settings/policy/SecSCPMHelper;

    invoke-direct {v1, p0}, Lcom/samsung/android/settings/policy/SecSCPMHelper;-><init>(Landroid/content/Context;)V

    const-string v2, "edge_color_balance"

    invoke-virtual {v1, v0, v2}, Lcom/samsung/android/settings/policy/SecSCPMHelper;->isSupportedMenu(Ljava/lang/String;Ljava/lang/String;)Z
