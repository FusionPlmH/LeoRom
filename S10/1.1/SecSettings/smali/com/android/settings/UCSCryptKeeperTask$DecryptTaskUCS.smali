...
.method protected varargs doInBackground([Ljava/lang/String;)[I
    ...
    const-string v8, "DecryptTask isUcsOdeEnabled : true"

    invoke-static {v7, v8}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    const-string v7, ""

    iget-object v8, p0, Lcom/android/settings/UCSCryptKeeperTask$DecryptTaskUCS;->this$0:Lcom/android/settings/UCSCryptKeeperTask;
    ...
    invoke-static {v7}, Lcom/samsung/android/settings/ucm/UCMUtils;->generatePassword(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-interface {v0, v4}, Landroid/os/storage/IStorageManager;->decryptStorage(Ljava/lang/String;)I
    ...
    const-string v10, "decryptStorage return "
    ...
    const-string v4, "DecryptTask Not able to verify Pin, no use of decrypt op"
