...
.method static getVpnApps(Landroid/content/Context;Z)Ljava/util/List;
    ...
    const-string v2, "context null exit!"
    ...
    invoke-static {p0, v9}, Lcom/android/settings/vpn2/VpnSettings;->isSecureWifiPackage(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    const-string v6, "context null exit!"
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-direct {v0, v4}, Lcom/android/internal/net/VpnProfile;-><init>(Ljava/lang/String;)V

    const/4 v4, 0x1

    invoke-static {p0, v0, v4, v1}, Lcom/android/settings/vpn2/ConfigDialogFragment;->show(Lcom/android/settings/vpn2/VpnSettings;Lcom/android/internal/net/VpnProfile;ZZ)V
    ...
    invoke-static {v1, v5}, Lcom/samsung/android/settings/logging/LoggingHelper;->insertEventLogging(II)V
...
.method public onPreferenceClick(Landroid/support/v7/preference/Preference;)Z
    ...
    const-string v7, "Starting config intent failed"
    ...
    invoke-virtual {v6, v7, v3, v5}, Landroid/app/Activity;->createPackageContextAsUser(Ljava/lang/String;ILandroid/os/UserHandle;)Landroid/content/Context;
    ...
    const-string v8, "VPN provider does not exist: "
    ...
    invoke-static {p0, v5, v6, v3, v2}, Lcom/android/settings/vpn2/AppDialogFragment;->show(Landroid/app/Fragment;Landroid/content/pm/PackageInfo;Ljava/lang/String;ZZ)V
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)V
    ...
    invoke-static {v2, v3, v4}, Lcom/android/settingslib/RestrictedLockUtils;->setMenuItemAsDisabledByAdmin(Landroid/content/Context;Landroid/view/MenuItem;Lcom/android/settingslib/RestrictedLockUtils$EnforcedAdmin;)V
...
.method public onResume()V
    ...
    iget-object v1, p0, Lcom/android/settings/vpn2/VpnSettings;->mConnectivityManager:Landroid/net/ConnectivityManager;

    sget-object v2, Lcom/android/settings/vpn2/VpnSettings;->VPN_REQUEST:Landroid/net/NetworkRequest;

    iget-object v3, p0, Lcom/android/settings/vpn2/VpnSettings;->mNetworkCallback:Landroid/net/ConnectivityManager$NetworkCallback;
    ...
    iget-object v1, p0, Lcom/android/settings/vpn2/VpnSettings;->mUpdater:Landroid/os/Handler;
    ...
    invoke-virtual {p0}, Lcom/android/settings/vpn2/VpnSettings;->finish()V
