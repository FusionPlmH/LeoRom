...
.method private exitActivityWithLoggig()V
    ...
    invoke-virtual {v0}, Lcom/android/settings/wifi/details/TempWifiConfiguration;->getPhase2Method()I
    ...
    invoke-virtual {v0}, Lcom/android/settings/wifi/details/TempWifiConfiguration;->getPhase1Method()I
    ...
    invoke-virtual {v1, v0}, Landroid/net/wifi/WifiEnterpriseConfig;->setPhase1Method(I)V

    :cond_1
    iget-object v0, p0, Lcom/android/settings/wifi/details/WifiIpSettingsController;->mScreen:Landroid/support/v7/preference/PreferenceScreen;

    const-string v1, "eap_anonymous"
    ...
    invoke-virtual {v0}, Lcom/android/settings/wifi/details/TempWifiConfiguration;->getAnonymousIdentity()Ljava/lang/String;
...
.method public static synthetic lambda$onResume$0(Lcom/android/settings/wifi/details/WifiIpSettingsController;Landroid/view/View;)V
    .locals 0
...
.method public static synthetic lambda$onResume$1(Lcom/android/settings/wifi/details/WifiIpSettingsController;Landroid/view/View;)V
    .locals 0
...
.method public onResume()V
    ...
    :cond_3
    iget-object v1, p0, Lcom/android/settings/wifi/details/WifiIpSettingsController;->mActivity:Landroid/app/Activity;
    ...
    iput-object v1, p0, Lcom/android/settings/wifi/details/WifiIpSettingsController;->mSaveButton:Lcom/samsung/android/settings/widget/SecBottomBarButton;

    iget-object v1, p0, Lcom/android/settings/wifi/details/WifiIpSettingsController;->mSaveButton:Lcom/samsung/android/settings/widget/SecBottomBarButton;

    if-eqz v1, :cond_4

    iget-object v1, p0, Lcom/android/settings/wifi/details/WifiIpSettingsController;->mSaveButton:Lcom/samsung/android/settings/widget/SecBottomBarButton;

    new-instance v2, Lcom/android/settings/wifi/details/-$$Lambda$WifiIpSettingsController$WGOEZTCusyDtBoBRDfLhHRizanE;

    invoke-direct {v2, p0}, Lcom/android/settings/wifi/details/-$$Lambda$WifiIpSettingsController$WGOEZTCusyDtBoBRDfLhHRizanE;-><init>(Lcom/android/settings/wifi/details/WifiIpSettingsController;)V

    invoke-virtual {v1, v2}, Lcom/samsung/android/settings/widget/SecBottomBarButton;->setOnClickListener(Landroid/view/View$OnClickListener;)V
    ...
    iput-object v1, p0, Lcom/android/settings/wifi/details/WifiIpSettingsController;->mCancelButton:Lcom/samsung/android/settings/widget/SecBottomBarButton;

    iget-object v1, p0, Lcom/android/settings/wifi/details/WifiIpSettingsController;->mCancelButton:Lcom/samsung/android/settings/widget/SecBottomBarButton;

    if-eqz v1, :cond_5

    iget-object v1, p0, Lcom/android/settings/wifi/details/WifiIpSettingsController;->mCancelButton:Lcom/samsung/android/settings/widget/SecBottomBarButton;

    new-instance v2, Lcom/android/settings/wifi/details/-$$Lambda$WifiIpSettingsController$_4ENQgSwlcYN02ZH9lp15dwXJfs;

    invoke-direct {v2, p0}, Lcom/android/settings/wifi/details/-$$Lambda$WifiIpSettingsController$_4ENQgSwlcYN02ZH9lp15dwXJfs;-><init>(Lcom/android/settings/wifi/details/WifiIpSettingsController;)V
