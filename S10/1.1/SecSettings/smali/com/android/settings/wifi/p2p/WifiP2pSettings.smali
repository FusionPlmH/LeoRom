...
.field private static mPauseIsRunning:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mPauseIsRunning:Z
    ...
    new-instance v0, Lcom/android/settings/wifi/p2p/WifiP2pSettings$14;

    invoke-direct {v0}, Lcom/android/settings/wifi/p2p/WifiP2pSettings$14;-><init>()V
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mItemDecoration:Lcom/samsung/android/settings/wifi/p2p/WifiP2pDividerItemDecorator;

    iput-object v1, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mDefaultDivider:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mMotionListener:Landroid/hardware/motion/MRListener;

    iput-boolean v0, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mIsRegisteredMotionListener:Z
...
.method static synthetic access$1200()Landroid/net/wifi/p2p/WifiP2pDeviceList;
    .locals 1
...
.method static synthetic access$1300(Lcom/android/settings/wifi/p2p/WifiP2pSettings;)V
    .locals 0
...
.method static synthetic access$1602(Landroid/net/wifi/p2p/WifiP2pDevice;)Landroid/net/wifi/p2p/WifiP2pDevice;
    .locals 0
...
.method static synthetic access$1800(Lcom/android/settings/wifi/p2p/WifiP2pSettings;)Landroid/net/wifi/p2p/WifiP2pDeviceList;
    .locals 1
...
.method static synthetic access$1900(Lcom/android/settings/wifi/p2p/WifiP2pSettings;)Landroid/os/CountDownTimer;
    .locals 1
...
.method static synthetic access$2000(Lcom/android/settings/wifi/p2p/WifiP2pSettings;Z)V
    .locals 0
...
.method static synthetic access$2100(Lcom/android/settings/wifi/p2p/WifiP2pSettings;Z)V
    .locals 0
...
.method static synthetic access$2200(Lcom/android/settings/wifi/p2p/WifiP2pSettings;)Landroid/support/v7/preference/Preference;
    .locals 1
...
.method static synthetic access$2202(Lcom/android/settings/wifi/p2p/WifiP2pSettings;Landroid/support/v7/preference/Preference;)Landroid/support/v7/preference/Preference;
    .locals 0
...
.method static synthetic access$2400(Lcom/android/settings/wifi/p2p/WifiP2pSettings;Ljava/lang/String;)Ljava/lang/Object;
    .locals 1
...
.method static synthetic access$2500(Lcom/android/settings/wifi/p2p/WifiP2pSettings;)Landroid/speech/tts/TextToSpeech;
    .locals 1
...
.method static synthetic access$2600(Lcom/android/settings/wifi/p2p/WifiP2pSettings;)Landroid/os/CountDownTimer;
    .locals 1
...
.method private setDivider()V
    ...
    new-instance v0, Lcom/samsung/android/settings/wifi/p2p/WifiP2pDividerItemDecorator;

    invoke-direct {v0, v2}, Lcom/samsung/android/settings/wifi/p2p/WifiP2pDividerItemDecorator;-><init>(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v3, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mItemDecoration:Lcom/samsung/android/settings/wifi/p2p/WifiP2pDividerItemDecorator;
...
.method private updateDivider()V
    ...
    invoke-virtual {v3}, Lcom/samsung/android/settings/wifi/p2p/WifiP2pDividerItemDecorator;->getDivider()Landroid/graphics/drawable/Drawable;

    move-result-object v3

    iput-object v3, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mDefaultDivider:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v4, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mItemDecoration:Lcom/samsung/android/settings/wifi/p2p/WifiP2pDividerItemDecorator;
    ...
    iget-object v5, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mItemDecoration:Lcom/samsung/android/settings/wifi/p2p/WifiP2pDividerItemDecorator;

    iget-object v6, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mDefaultDivider:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v5, v6, v2, v4}, Lcom/samsung/android/settings/wifi/p2p/WifiP2pDividerItemDecorator;->setDivider(Landroid/graphics/drawable/Drawable;II)V
    ...
    invoke-virtual {v5, v6, v4, v2}, Lcom/samsung/android/settings/wifi/p2p/WifiP2pDividerItemDecorator;->setDivider(Landroid/graphics/drawable/Drawable;II)V
    ...
    invoke-virtual {v4, v3}, Lcom/samsung/android/settings/wifi/p2p/WifiP2pDividerItemDecorator;->setDividerHeight(I)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    sget-boolean v0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mPauseIsRunning:Z
    ...
    const-string v2, "onCreate: mPauseIsRunning: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    sget-boolean v2, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mPauseIsRunning:Z

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v2, "This is a duplicate creation case. Call the selFinish()"
...
.method public onDestroy()V
    ...
    sput-boolean v0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mPauseIsRunning:Z
...
.method public onPause()V
    ...
    sput-boolean v2, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mPauseIsRunning:Z
    ...
    sget-boolean v6, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mInvited:Z
    ...
    iget-boolean v2, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mTalkback:Z

    if-eqz v2, :cond_3

    iget-object v2, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mTextToSpeech:Landroid/speech/tts/TextToSpeech;
    ...
    sget-object v5, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mPeers:Landroid/net/wifi/p2p/WifiP2pDeviceList;
    ...
    iget-object v6, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mWifiP2pManager:Landroid/net/wifi/p2p/WifiP2pManager;

    iget-object v7, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mChannel:Landroid/net/wifi/p2p/WifiP2pManager$Channel;
    ...
    invoke-virtual/range {v6 .. v12}, Landroid/net/wifi/p2p/WifiP2pManager;->setListenOffloading(Landroid/net/wifi/p2p/WifiP2pManager$Channel;IIIILandroid/net/wifi/p2p/WifiP2pManager$ActionListener;)V
    ...
    invoke-virtual {v5, v6, v2}, Landroid/net/wifi/p2p/WifiP2pManager;->setListenOffloadingTimer(Landroid/net/wifi/p2p/WifiP2pManager$Channel;Z)V
    ...
    invoke-virtual {v2, v5}, Landroid/app/Activity;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V
    ...
    iget-boolean v2, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mIsRegisteredMotionListener:Z

    if-eqz v2, :cond_5

    sget-object v2, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mMotionSensorManager:Landroid/hardware/motion/MotionRecognitionManager;

    iget-object v5, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mMotionListener:Landroid/hardware/motion/MRListener;

    invoke-virtual {v2, v5}, Landroid/hardware/motion/MotionRecognitionManager;->unregisterListener(Landroid/hardware/motion/MRListener;)V
