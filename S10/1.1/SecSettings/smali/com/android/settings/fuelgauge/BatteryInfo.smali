...
.method public static getBatteryInfo(Landroid/content/Context;Landroid/content/Intent;Landroid/os/BatteryStats;Lcom/android/settings/fuelgauge/Estimate;JZ)Lcom/android/settings/fuelgauge/BatteryInfo;
    ...
    invoke-static {v13, v12, v14, v7, v10}, Lcom/android/settings/fuelgauge/BatteryInfo;->updateBatteryInfoDischarging(Landroid/content/Context;Landroid/content/res/Resources;ZLcom/android/settings/fuelgauge/Estimate;Lcom/android/settings/fuelgauge/BatteryInfo;)V
    ...
    const-string/jumbo v1, "time for getBatteryInfo"
...
.method public static getBatteryInfo(Landroid/content/Context;Lcom/android/settings/fuelgauge/BatteryInfo$Callback;Z)V
    ...
    const-string/jumbo v4, "time to make batteryStatsHelper"
...
.method private static updateBatteryInfoCharging(Landroid/content/Context;Landroid/content/Intent;Landroid/os/BatteryStats;JLcom/android/settings/fuelgauge/BatteryInfo;)V
    ...
    invoke-static {v0, v11, v12}, Lcom/android/settings/fuelgauge/BatteryInfo;->formatElapsedTime(Landroid/content/Context;J)Ljava/lang/String;

    move-result-object v9

    const v11, 0x7f1210b0

    const v12, 0x7f1210be
...
.method private static updateBatteryInfoDischarging(Landroid/content/Context;Landroid/content/res/Resources;ZLcom/android/settings/fuelgauge/Estimate;Lcom/android/settings/fuelgauge/BatteryInfo;)V
    .locals 20
    ...
    iget-wide v3, v2, Lcom/android/settings/fuelgauge/Estimate;->estimateMillis:J
    ...
    const-string v9, "sem_perfomance_mode"
    ...
    invoke-virtual {v10, v6}, Landroid/os/CustomFrequencyManager;->getBatteryRemainingUsageTime(I)I
    ...
    iput-wide v8, v1, Lcom/android/settings/fuelgauge/BatteryInfo;->remainingTimeUs:J

    mul-long/2addr v13, v11

    mul-long v13, v13, v17

    invoke-static {v0, v13, v14}, Lcom/android/settings/fuelgauge/BatteryInfo;->formatElapsedTime(Landroid/content/Context;J)Ljava/lang/String;
    ...
    const-string v14, "getTimeString. time = "

    invoke-virtual {v13, v14}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v13, v11, v12}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    const-string v14, " timeString "
    ...
    iput-object v9, v1, Lcom/android/settings/fuelgauge/BatteryInfo;->chargeLabel:Ljava/lang/CharSequence;
    ...
    iput-object v8, v1, Lcom/android/settings/fuelgauge/BatteryInfo;->remainingLabel:Ljava/lang/CharSequence;

    iget-object v8, v1, Lcom/android/settings/fuelgauge/BatteryInfo;->batteryPercentString:Ljava/lang/String;

    iput-object v8, v1, Lcom/android/settings/fuelgauge/BatteryInfo;->chargeLabel:Ljava/lang/CharSequence;
...
.method public varargs bindHistory(Lcom/android/settings/graph/UsageView;[Lcom/android/settings/fuelgauge/BatteryInfo$BatteryDataParser;)V
    ...
    invoke-static {v0, v7, v8}, Lcom/android/settings/fuelgauge/BatteryInfo;->formatElapsedTime(Landroid/content/Context;J)Ljava/lang/String;
    ...
    invoke-static {v0, v9, v10}, Lcom/android/settings/fuelgauge/BatteryInfo;->formatElapsedTime(Landroid/content/Context;J)Ljava/lang/String;
    ...
    invoke-static {v8}, Lcom/android/settings/Utils;->formatPercentage(I)Ljava/lang/String;
    ...
    invoke-virtual {p1, v7}, Lcom/android/settings/graph/UsageView;->setSideLabels([Ljava/lang/CharSequence;)V
