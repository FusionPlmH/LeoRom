...
.method static startBatteryDetailPage(Landroid/app/Activity;Lcom/android/settings/fuelgauge/BatteryUtils;Lcom/android/settings/core/InstrumentedPreferenceFragment;Lcom/android/internal/os/BatteryStatsHelper;ILcom/android/settings/fuelgauge/BatteryEntry;Ljava/lang/String;Ljava/util/List;)V
    ...
    :cond_1
    iget-wide v10, v4, Lcom/android/internal/os/BatterySipper;->usageTimeMs:J
    ...
    :cond_5
    :goto_3
    iget-object v7, v4, Lcom/android/internal/os/BatterySipper;->packageWithHighestDrain:Ljava/lang/String;
    ...
    invoke-static {v8}, Lcom/android/settingslib/applications/ApplicationsState;->getInstance(Landroid/app/Application;)Lcom/android/settingslib/applications/ApplicationsState;
    ...
    invoke-virtual {v8, v7, v9}, Lcom/android/settingslib/applications/ApplicationsState;->getEntry(Ljava/lang/String;I)Lcom/android/settingslib/applications/ApplicationsState$AppEntry;

    move-result-object v8

    if-eqz v8, :cond_6

    const-string v8, "extra_package_name"
    ...
    invoke-virtual {v3, v7, v12, v13}, Landroid/os/Bundle;->putLong(Ljava/lang/String;J)V
    ...
    iget-wide v14, v4, Lcom/android/internal/os/BatterySipper;->totalPowerMah:D
    ...
    invoke-virtual {v3, v7, v9}, Landroid/os/Bundle;->putParcelableList(Ljava/lang/String;Ljava/util/List;)V
...
.method initHeader()V
    ...
    :cond_1
    invoke-virtual {v3, v6}, Lcom/android/settings/widget/EntityHeaderController;->setIcon(Landroid/graphics/drawable/Drawable;)Lcom/android/settings/widget/EntityHeaderController;
    ...
    invoke-virtual {v5, v6}, Lcom/android/settingslib/applications/ApplicationsState;->ensureIcon(Lcom/android/settingslib/applications/ApplicationsState$AppEntry;)V

    iget-object v5, p0, Lcom/android/settings/fuelgauge/AdvancedPowerUsageDetail;->mAppEntry:Lcom/android/settingslib/applications/ApplicationsState$AppEntry;

    invoke-virtual {v3, v5}, Lcom/android/settings/widget/EntityHeaderController;->setLabel(Lcom/android/settingslib/applications/ApplicationsState$AppEntry;)Lcom/android/settings/widget/EntityHeaderController;

    iget-object v5, p0, Lcom/android/settings/fuelgauge/AdvancedPowerUsageDetail;->mAppEntry:Lcom/android/settingslib/applications/ApplicationsState$AppEntry;

    invoke-virtual {v3, v5}, Lcom/android/settings/widget/EntityHeaderController;->setIcon(Lcom/android/settingslib/applications/ApplicationsState$AppEntry;)Lcom/android/settings/widget/EntityHeaderController;

    :try_start_0
    iget-object v5, p0, Lcom/android/settings/fuelgauge/AdvancedPowerUsageDetail;->mPackageManager:Landroid/content/pm/PackageManager;

    iget-object v6, p0, Lcom/android/settings/fuelgauge/AdvancedPowerUsageDetail;->mPackageName:Ljava/lang/String;
...
.method initPreference()V
    ...
    invoke-static {v1, v12, v13}, Lcom/android/settingslib/utils/PowerUtil;->formatElapsedTime(Landroid/content/Context;D)Ljava/lang/CharSequence;
    ...
    invoke-static {v1, v11, v12}, Lcom/android/settingslib/utils/PowerUtil;->formatElapsedTime(Landroid/content/Context;D)Ljava/lang/CharSequence;

    move-result-object v11

    aput-object v11, v10, v13

    const v11, 0x7f120240
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/fuelgauge/AdvancedPowerUsageDetail;->setAutoRemoveInsetCategory(Z)V
