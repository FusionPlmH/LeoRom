...
.method private static buildPreferenceControllers(Landroid/content/Context;Lcom/android/settings/location/LocationSettings;Lcom/android/settingslib/core/lifecycle/Lifecycle;)Ljava/util/List;
    ...
    new-instance v1, Lcom/samsung/android/settings/location/LocationUseInBackgroundPreferenceController;

    invoke-direct {v1, p0}, Lcom/samsung/android/settings/location/LocationUseInBackgroundPreferenceController;-><init>(Landroid/content/Context;)V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v1, Lcom/samsung/android/settings/location/ImproveAccuracyPreferenceController;

    invoke-direct {v1, p0, p2}, Lcom/samsung/android/settings/location/ImproveAccuracyPreferenceController;-><init>(Landroid/content/Context;Lcom/android/settingslib/core/lifecycle/Lifecycle;)V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v1, Lcom/samsung/android/settings/location/CmccAgpsPreferenceCategoryController;

    invoke-direct {v1, p0}, Lcom/samsung/android/settings/location/CmccAgpsPreferenceCategoryController;-><init>(Landroid/content/Context;)V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v1, Lcom/samsung/android/settings/location/ClockSyncPreferenceController;

    invoke-direct {v1, p0}, Lcom/samsung/android/settings/location/ClockSyncPreferenceController;-><init>(Landroid/content/Context;)V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v1, Lcom/samsung/android/settings/location/LocationCmccAgpsPreferenceController;

    invoke-direct {v1, p0}, Lcom/samsung/android/settings/location/LocationCmccAgpsPreferenceController;-><init>(Landroid/content/Context;)V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v1, Lcom/samsung/android/settings/location/SatelliteViewPreferenceController;

    invoke-direct {v1, p0}, Lcom/samsung/android/settings/location/SatelliteViewPreferenceController;-><init>(Landroid/content/Context;)V
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    new-instance v2, Lcom/samsung/android/settings/location/LocationSettingsEnabler;

    invoke-virtual {p0}, Lcom/android/settings/location/LocationSettings;->getLifecycle()Lcom/android/settingslib/core/lifecycle/Lifecycle;

    move-result-object v3

    invoke-direct {v2, v0, v1, v3}, Lcom/samsung/android/settings/location/LocationSettingsEnabler;-><init>(Landroid/content/Context;Lcom/android/settings/widget/SwitchBar;Lcom/android/settingslib/core/lifecycle/Lifecycle;)V

    iput-object v2, p0, Lcom/android/settings/location/LocationSettings;->mLocationSettingsEnabler:Lcom/samsung/android/settings/location/LocationSettingsEnabler;
